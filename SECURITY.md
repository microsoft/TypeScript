...
Please refer to [TypeSecript Security Properties](https://github.com/microsoft/TypeScript/wiki/tsc-Security-Properties) prior to submitting a security report.
Specifically, **crashes, stack overflows, nonlinear performance, and hangs** are generally not considered a security boundary unless they result in arbitrary code execution, and should be reported through the [normal issue flow](https://github.com/microsoft/TypeScript/issues/new/choose) instead.
