...
(function (ts) {
    ...
    var NodeObject = (function () {
        ...
        NodeObject.prototype.getTextPos = function () {
            return ts.getTokenPosOfNode(this);
        };
        NodeObject.prototype.getFullWidth = function () {
            return this.end - this.pos;
        };
        NodeObject.prototype.getTriviaWidth = function () {
            return ts.getTokenPosOfNode(this) - this.pos;
        };
    ...
    function createLanguageService(host) {
        ...
        function createCompilerHost() {
            return {
                getSourceFile: function (filename, languageVersion) {
                    ...
                    return ts.createSourceFile(filename, hostFile.sourceText.getText(0, hostFile.sourceText.getLength()), languageVersion);
                },
                ...
                getCancellationToken: function () { return undefined; },
        ...
        function synchronizeHostData() {
            ...
            program = ts.createProgram(files, options, createCompilerHost());
...
(function (ts) {
    var ScriptSnapshotShimAdapter = (function () {
        ...
        ScriptSnapshotShimAdapter.prototype.getChangeRange = function (scriptSnapshot) {
            function createTextRange(start, length) {
                function createSpan(start, length) {
                    return {
                        start: function () { return start; },
                        end: function () { return start + length; },
                        lenth: function () { return length; },
                        isEmpty: function () { return length === 0; }
                    };
                }
                return {
                    span: function () { return createSpan(start, length); },
                    newLength: function () { return length; },
                    newSpan: function () { return createSpan(start, length); },
                    isUnchanged: function () { return length === 0; }
                };
            }
            var encoded = this.scriptSnapshotShim.getChangeRange(scriptSnapshot.scriptSnapshotShim);
            if (encoded == null) {
                return null;
            }
