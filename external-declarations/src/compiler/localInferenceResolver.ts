import {
    HasInferredType,
    Node,
    ExportAssignment, SourceFile, TypeNode, VisitResult,
    EntityNameOrEntityNameExpression, ParameterDeclaration,
    factory, EntityName, isIdentifier, setTextRange,
    isPropertyAccessExpression, isQualifiedName, isTypeNode, NodeFlags,
    forEachChildRecursively, visitNode, NodeArray, ObjectLiteralElementLike,
    SetAccessorDeclaration, GetAccessorDeclaration, isGetAccessorDeclaration,
    isSetAccessorDeclaration, SyntaxKind, ParenthesizedExpression, QualifiedName,
    Identifier, CallExpression, NewExpression, visitNodes, FunctionExpression,
    ArrowFunction, isTypeParameterDeclaration, SatisfiesExpression, AsExpression,
    TypeAssertion, isTypeReferenceNode, isLiteralTypeNode, isNoSubstitutionTemplateLiteral,
    isStringLiteral, PrefixUnaryExpression, TemplateExpression, TemplateLiteralTypeSpan,
    ArrayLiteralExpression, isSpreadElement, isOmittedExpression, ObjectLiteralExpression,
    TypeElement, isComputedPropertyName, isPropertyName, isMethodDeclaration,
    isPropertyAssignment, isShorthandPropertyAssignment, isSpreadAssignment,
    Modifier, getTokenPosOfNode, setCommentRange, ConditionalExpression, LiteralExpression,
    KeywordTypeSyntaxKind, TypeReferenceNode, MethodSignature, PropertySignature, isNumericLiteral,
    LiteralTypeNode, TypeLiteralNode, isMethodSignature, isPropertySignature, SignatureDeclaration,
    NodeWithTypeArguments, isArrayTypeNode, isTypeLiteralNode, isFunctionTypeNode, isConstructorTypeNode,
    isTypeQueryNode, PropertyName, ModifierFlags, FunctionLikeDeclaration, ReturnStatement,
    YieldExpression, isBlock, forEachChild, isReturnStatement, isYieldExpression, isClassLike,
...
import { findIndex } from "./lang-utils";
import { createDiagnosticForNode, setParent, isEntityNameExpression, getNodeId, getSyntacticModifierFlags, getEffectiveModifierFlags } from "./utils";
