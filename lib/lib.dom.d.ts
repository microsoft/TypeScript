...
interface SubtleCrypto {
    ...
    wrapKey(format: string, key: CryptoKey, wrappingKey: CryptoKey, wrapAlgorithm: string | Algorithm | RsaHashedImportParams | AesCbcParams | AesCtrParams | AesGcmParams): PromiseLike<ArrayBuffer>;
}
