...
(function (ts) {
    ...
    ts.Diagnostics = {
        ...
        Infer_type_of_0_from_usage: diag(95009, ts.DiagnosticCategory.Message, "Infer_type_of_0_from_usage_95009", "Infer type of '{0}' from usage."),
        Infer_parameter_types_from_usage: diag(95010, ts.DiagnosticCategory.Message, "Infer_parameter_types_from_usage_95010", "Infer parameter types from usage."),
    };
})(ts || (ts = {}));
var ts;
(function (ts) {
