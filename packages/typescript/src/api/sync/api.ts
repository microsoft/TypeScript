...
export class API<FromLSP extends boolean = false> implements FormatDiagnosticsHost {
    ...
    batchRequests<const Requests extends readonly APIRequest[]>(requests: Requests): { responses: APIResponseTuple<Requests>; } {
        const response = this.client.apiRequest("batchRequests", { requests });
