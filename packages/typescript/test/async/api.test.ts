...
describe("Program - diagnostics", () => {
    ...
    test("formatDiagnostics and formatDiagnosticsWithColorAndContext", async () => {
        ...
        try {
            ...
            const zeroWidthColor = await project.program.formatDiagnosticsWithColorAndContext([zeroWidth], host);
            ...
            const relatedColor = await project.program.formatDiagnosticsWithColorAndContext([withRelated], host);
