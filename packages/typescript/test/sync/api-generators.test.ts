    ...
    test("keeps every publicly reachable generator-backed method in sync", () => {
        ...
        try {
            ...
            const cases: ParityCase[] = [
                ...
                parityCase("Checker", "getNegatedType", checker.getNegatedType, assertTypesEquivalent, interfaceType),
                ...
                parityCase("Type", "getNegatedType", interfaceType.getNegatedType, assertTypesEquivalent),
