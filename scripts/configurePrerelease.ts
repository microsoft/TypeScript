...
function main(): void {
    ...
    const packageJsonValue: PackageJson = JSON.parse(readFile(packageJsonFilePath).toString());
    ...
    const tsFileContents = readFile(tsFilePath).toString();
    ...
    writeFile(packageJsonFilePath, JSON.stringify(packageJsonValue, /*replacer:*/ undefined, /*space:*/ 4))
    writeFile(tsFilePath, modifiedTsFileContents);
}
