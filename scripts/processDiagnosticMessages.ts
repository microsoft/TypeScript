...
function buildUniqueNameMap(names: string[]): ts.SMap<string> {
    var uniqueNames = NameGenerator.ensureUniqueness(names, /* isCaseSensitive */ false, /* isFixed */ undefined);
    return ts.createMapFromKeysAndValues(names, uniqueNames);
}

function buildInfoFileOutput(messageTable: InputDiagnosticMessageTable, nameMap: ts.SMap<string>): string {
    var result =
        '// <auto-generated />\r\n' +
...
function buildDiagnosticMessageOutput(messageTable: InputDiagnosticMessageTable, nameMap: ts.SMap<string>): string {
    var result =
        '{';
    var names = Utilities.getObjectKeys(messageTable);
    for (var i = 0; i < names.length; i++) {
