...
export class AstSourceFileData extends AstData {
    ...
    originalFileName = "";
    languageVersion: ts.ScriptTarget = ScriptTarget.ES5;
...
/** @internal */
export function isAstOuterExpression(node: AstNode, kinds: ts.OuterExpressionKinds = ts.OuterExpressionKinds.All): node is AstOuterExpression {
    switch (node.kind) {
...
/** @internal */
export function skipAstOuterExpressions(node: AstNode, kinds: ts.OuterExpressionKinds = ts.OuterExpressionKinds.All): AstNode {
