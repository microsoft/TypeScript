import {
    ...
    performance, PostfixUnaryExpression, PrefixUnaryExpression, PrivateIdentifier, PropertyAccessChain,
    PropertyAccessExpression, PropertyDeclaration, PropertySignature, removeFileExtension, ReturnStatement,
    ScriptTarget, Set, SetAccessorDeclaration, setParent, setParentRecursive, setValueDeclaration,
