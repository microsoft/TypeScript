...
namespace ts {
    ...
    function createBinder(): (file: SourceFile, options: CompilerOptions) => void {
        ...
        function delayedBindJSDocTypedefTag() {
            ...
            const saveCurrentFlow = currentFlow;
            // const saveSkipTransformFlagAggregation = skipTransformFlagAggregation;
            ...
            parent = saveParent;
            currentFlow = saveCurrentFlow;
            // skipTransformFlagAggregation = saveSkipTransformFlagAggregation;
        }
        ...
        function bindJSDoc(node: Node) {
            if (hasJSDocNodes(node)) {
                // const savedSkipTransformFlagAggregation = skipTransformFlagAggregation;
                // skipTransformFlagAggregation = true;
                if (isInJSFile(node)) {
                ...
                // skipTransformFlagAggregation = savedSkipTransformFlagAggregation;
            }
        }
