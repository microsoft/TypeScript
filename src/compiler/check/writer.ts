...
namespace ts {
    export function createWriter({
        ...
        getQualifiedLeftMeaning: (rightMeaning: SymbolFlags) => SymbolFlags,
        hasExternalModuleSymbol: (declaration: Node) => boolean,
        isTypeAny: (type: Type) => boolean,
        getNothingType: () => ResolvedType,
        isReservedMemberName: (name: string) => boolean,
        emptyArray: any[],
        getGlobalArrayType: () => GenericType,
        getParentSymbolOfTypeParameter: (typeParameter: TypeParameter) => Symbol,
        isReadonlySymbol: (symbol: Symbol) => boolean,
        resolveStructuredTypeMembers: (type: ObjectType) => ResolvedType,
        getTypeOfSymbol: (symbol: Symbol) => Type,
        getPropertiesOfObjectType: (type: Type) => Symbol[],
        getSignaturesOfType: (type: Type, kind: SignatureKind) => Signature[],
        getTargetSymbol: (s: Symbol) => Symbol,
        ...
        return { writeKeyword, writePunctuation, writeSpace, typeToString, getSymbolDisplayBuilder, symbolToString, signatureToString, typePredicateToString, visibilityToString };
        ...
        function getSymbolDisplayBuilder(): SymbolDisplayBuilder {
            const nothingType = getNothingType();
