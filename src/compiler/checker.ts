...
module ts {
    ...
    export function createTypeChecker(program: Program, fullTypeCheck: boolean): TypeChecker {
        ...
        function checkParameter(parameterDeclaration: ParameterDeclaration) {
            ...
            // Grammar checking
            checkGrammarModifiers(parameterDeclaration) || checkGrammarEvalOrArgumentsInStrictMode(parameterDeclaration, <Identifier>parameterDeclaration.name)
        ...
        function checkGrammarObjectLiteralExpression(node: ObjectLiteralExpression) {
            ...
            for (var i = 0, n = node.properties.length; i < n; i++) {
                ...
                else if ( prop.kind === SyntaxKind.Method) {
                    currentKind = Property;
                }
