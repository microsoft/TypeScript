...
export interface OptionsNameMap {
    optionsNameMap: ts.Map<CommandLineOption>;
 ...
 */
export function getParsedCommandLineOfConfigFile(configFileName: string, optionsToExtend: CompilerOptions, host: ParseConfigFileHost, extendedConfigCache?: ts.Map<ExtendedConfigCacheEntry>, watchOptionsToExtend?: WatchOptions): ParsedCommandLine | undefined {
...
let commandLineCompilerOptionsMapCache: ts.Map<CommandLineOption>;
...
let commandLineWatchOptionsMapCache: ts.Map<CommandLineOption>;
function getCommandLineWatchOptionsMap() {
    return commandLineWatchOptionsMapCache || (commandLineWatchOptionsMapCache = commandLineOptionsToMap(optionsForWatch));
}
let commandLineTypeAcquisitionMapCache: ts.Map<CommandLineOption>;
...
export function convertToObjectWorker(sourceFile: JsonSourceFile, errors: Push<Diagnostic>, returnValue: boolean, knownRootOptions: CommandLineOption | undefined, jsonConversionNotifier: JsonConversionNotifier | undefined): any {
    ...
    function isRootOptionMap(knownOptions: ts.Map<CommandLineOption> | undefined) {
        return knownRootOptions && (knownRootOptions as TsConfigOnlyOption).elementOptions === knownOptions;
    }
    function convertObjectLiteralExpressionToJson(node: ObjectLiteralExpression, knownOptions: ts.Map<CommandLineOption> | undefined, extraKeyDiagnostics: DidYouMeanOptionsDiagnostics | undefined, parentOption: string | undefined): any {
...
function optionMapToObject(optionMap: ts.Map<CompilerOptionsValue>): object {
    return {
...
function getCustomTypeMapOfCommandLineOption(optionDefinition: CommandLineOption): ts.Map<string | number> | undefined {
...
function getNameOfCompilerOptionValue(value: CompilerOptionsValue, customTypeMap: ts.Map<string | number>): string | undefined {
 ...
 */
function parseConfig(json: any, sourceFile: TsConfigSourceFile | undefined, host: ParseConfigHost, basePath: string, configFileName: string | undefined, resolutionStack: string[], errors: Push<Diagnostic>, extendedConfigCache?: ts.Map<ExtendedConfigCacheEntry>): ParsedTsconfig {
...
function getExtendedConfig(sourceFile: TsConfigSourceFile | undefined, extendedConfigPath: string, host: ParseConfigHost, basePath: string, resolutionStack: string[], errors: Push<Diagnostic>, extendedConfigCache?: ts.Map<ExtendedConfigCacheEntry>): ParsedTsconfig | undefined {
...
function convertOptionsFromJson(optionsNameMap: ts.Map<CommandLineOption>, jsonOptions: any, basePath: string, defaultOptions: undefined, diagnostics: DidYouMeanOptionsDiagnostics, errors: Push<Diagnostic>): WatchOptions | undefined;
function convertOptionsFromJson(optionsNameMap: ts.Map<CommandLineOption>, jsonOptions: any, basePath: string, defaultOptions: CompilerOptions | TypeAcquisition, diagnostics: DidYouMeanOptionsDiagnostics, errors: Push<Diagnostic>): CompilerOptions | TypeAcquisition;
function convertOptionsFromJson(optionsNameMap: ts.Map<CommandLineOption>, jsonOptions: any, basePath: string, defaultOptions: CompilerOptions | TypeAcquisition | WatchOptions | undefined, diagnostics: DidYouMeanOptionsDiagnostics, errors: Push<Diagnostic>) {
    if (!jsonOptions) {
        return;
    }
 ...
 */
function matchFileNames(filesSpecs: readonly string[] | undefined, includeSpecs: readonly string[] | undefined, excludeSpecs: readonly string[] | undefined, basePath: string, options: CompilerOptions, host: ParseConfigHost, errors: Push<Diagnostic>, extraFileExtensions: readonly FileExtensionInfo[], jsonSourceFile: TsConfigSourceFile | undefined): ExpandResult {
