import {
    ...
    Debug, DeprecationPhase, DeprecationPhaseToVersionMap, Diagnostic, DiagnosticMessage, Diagnostics, DidYouMeanOptionsDiagnostics, directorySeparator, emptyArray,
