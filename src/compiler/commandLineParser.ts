...
export const commonOptionsWithBuild: CommandLineOption[] = [
    ...
    // AI Diagnostics options
    {
        ...
        description: Diagnostics.Enable_AI_enhanced_visual_diagnostic_output,
        defaultValueDescription: false,
    },
    {
        ...
        type: "boolean",
        category: Diagnostics.Compiler_Diagnostics,
        description: Diagnostics.Output_comprehensive_JSON_format_for_AI_tools,
        defaultValueDescription: false,
    },
    {
        ...
        type: "boolean",
        category: Diagnostics.Compiler_Diagnostics,
        description: Diagnostics.Output_parseable_text_format_for_automation,
        defaultValueDescription: false,
    },
    {
        name: "aiContext",
        type: "boolean",
        category: Diagnostics.Compiler_Diagnostics,
        description: Diagnostics.Include_additional_semantic_context_for_AI_diagnostics,
        defaultValueDescription: false,
    },
    {
        ...
        type: "number",
        category: Diagnostics.Compiler_Diagnostics,
        description: Diagnostics.Filter_suggestions_by_confidence_0_1,
        defaultValueDescription: 0.7,
    },
    {
        name: "aiErrorSummary",
        type: "boolean",
        category: Diagnostics.Compiler_Diagnostics,
        description: Diagnostics.Generate_intelligent_error_summaries,
        defaultValueDescription: false,
    },
    {
        name: "semanticHints",
        type: "boolean",
        category: Diagnostics.Compiler_Diagnostics,
        description: Diagnostics.Include_AST_and_semantic_information_in_diagnostics,
        defaultValueDescription: false,
    },
    {
        name: "patternSuggestions",
        type: "boolean",
        category: Diagnostics.Compiler_Diagnostics,
        description: Diagnostics.Enable_pattern_based_fix_recommendations,
        defaultValueDescription: false,
    },
    {
        name: "help",
