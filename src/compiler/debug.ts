...
const kDebugDescription = typeof globalThis === "object" ? globalThis.Symbol.for("debug.description") : "__tsDebuggerDisplay";
...
export namespace Debug {
    ...
    function flowNodeDebugDescription(this: FlowNodeBase) {
    ...
    function attachFlowNodeDebugInfoWorker(flowNode: FlowNodeBase) {
        if (!("__debugFlowFlags" in flowNode)) { // eslint-disable-line local/no-in-operator
            Object.defineProperties(flowNode, {
                [kDebugDescription]: { value: flowNodeDebugDescription },
                // for use with vscode-js-debug's new customDescriptionGenerator in launch.json
                // __tsDebuggerDisplay: { value: flowNodeDebugDescription, },
                __debugFlowFlags: {
    ...
    export function enableDebugInfo() {
        ...
        function symbolDebugDescription(this: Symbol) {
        ...
        Object.defineProperties(objectAllocator.getSymbolConstructor().prototype, {
            [kDebugDescription]: { value: symbolDebugDescription },
            // for use with vscode-js-debug's new customDescriptionGenerator in launch.json
            // __tsDebuggerDisplay: { value: symbolDebugDescription, },
            __debugFlags: {
                get(this: Symbol) {
        ...
        function typeDebugDescription(this: Type) {
        ...
        Object.defineProperties(objectAllocator.getTypeConstructor().prototype, {
            [kDebugDescription]: { value: typeDebugDescription },
            // for use with vscode-js-debug's new customDescriptionGenerator in launch.json
            // __tsDebuggerDisplay: { value: typeDebugDescription },
        ...
        function nodeDebugDescription(this: Node) {
        ...
        for (const ctor of nodeConstructors) {
            if (!hasProperty(ctor.prototype, "__debugKind")) {
                Object.defineProperties(ctor.prototype, {
                    [kDebugDescription]: { value: nodeDebugDescription },
                    // for use with vscode-js-debug's new customDescriptionGenerator in launch.json
                    // __tsDebuggerDisplay: { value: nodeDebugDescription, },
                    __debugKind: {
                        get(this: Node) {
