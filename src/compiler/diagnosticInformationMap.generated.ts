...
module ts {
    export var Diagnostics = {
        ...
        _0_modifier_cannot_be_used_with_an_interface_declaration: { code: 1045, category: DiagnosticCategory.Error, key: "'{0}' modifier cannot be used with an interface declaration." },
        ...
        _0_modifier_cannot_be_used_with_an_import_declaration: { code: 1079, category: DiagnosticCategory.Error, key: "'{0}' modifier cannot be used with an import declaration." },
        ...
        A_parameter_property_may_not_be_a_binding_pattern: { code: 1188, category: DiagnosticCategory.Error, key: "A parameter property may not be a binding pattern." },
        ...
        Emit_async_functions_when_ECMAScript_target_version_is_lower_than_ES6_experimental: { code: 6057, category: DiagnosticCategory.Message, key: "Emit async functions when ECMAScript target version is lower than 'ES6' (experimental)." },
        Do_not_emit_runtime_helper_functions_e_g_extends_awaiter_Assumes_manual_reference_to_tslib_js_experimental: { code: 6058, category: DiagnosticCategory.Message, key: "Do not emit runtime helper functions (e.g. '__extends', '__awaiter'). Assumes manual reference to tslib.js (experimental)." },
