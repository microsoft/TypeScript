...
namespace ts {
    export var Diagnostics = {
        ...
        const_enum_can_only_be_used_in_property_or_index_access_expressions_the_right_hand_side_of_an_import_declaration_or_export_assignment_a_typeof_query: { code: 2475, category: DiagnosticCategory.Error, key: "'const' enum can only be used in property or index access expressions, the right hand side of an import declaration or export assignment, a typeof query." },
