...
module ts {
    ...
    export interface DiagnosticMessageTable {
        ...
        Catch_clause_parameter_cannot_have_a_type_annotation: DiagnosticMessage;
        ...
        A_class_or_interface_declaration_can_only_have_one_extends_clause: DiagnosticMessage;
        An_extends_clause_must_precede_an_implements_clause: DiagnosticMessage;
        A_class_can_only_extend_a_single_class: DiagnosticMessage;
        A_class_declaration_can_only_have_one_implements_clause: DiagnosticMessage;
        ...
        An_interface_declaration_cannot_have_an_implements_clause: DiagnosticMessage;
        ...
        A_function_implementation_cannot_be_declared_in_an_ambient_context: DiagnosticMessage;
        ...
        _0_modifier_cannot_appear_on_a_module_element: DiagnosticMessage;
        A_declare_modifier_cannot_be_used_with_an_interface_declaration: DiagnosticMessage;
        ...
        An_export_assignment_cannot_be_used_in_an_internal_module: DiagnosticMessage;
        Ambient_enum_elements_can_only_have_integer_literal_initializers: DiagnosticMessage;
        Unexpected_token_A_constructor_method_accessor_or_property_was_expected: DiagnosticMessage;
        A_declare_modifier_cannot_be_used_with_an_import_declaration: DiagnosticMessage;
        Invalid_reference_directive_syntax: DiagnosticMessage;
        Octal_literals_are_not_available_when_targeting_ECMAScript_5_and_higher: DiagnosticMessage;
        ...
        A_constructor_implementation_cannot_be_declared_in_an_ambient_context: DiagnosticMessage;
        A_class_member_cannot_be_declared_optional: DiagnosticMessage;
        ...
        Type_reference_expected: DiagnosticMessage;
        ...
        Block_or_expected: DiagnosticMessage;
        Modifiers_not_permitted_on_index_signature_members: DiagnosticMessage;
        Declaration_expected: DiagnosticMessage;
        Import_declarations_in_an_internal_module_cannot_reference_an_external_module: DiagnosticMessage;
        Cannot_compile_external_modules_unless_the_module_flag_is_provided: DiagnosticMessage;
        Filename_0_differs_from_already_included_filename_1_only_in_casing: DiagnosticMessage;
        ...
        File_0_is_not_an_external_module: DiagnosticMessage;
        Cannot_find_external_module_0: DiagnosticMessage;
        A_module_cannot_have_more_than_one_export_assignment: DiagnosticMessage;
        ...
        Constraint_of_a_type_parameter_cannot_reference_any_type_parameter_from_the_same_type_parameter_list: DiagnosticMessage;
        ...
        Named_properties_0_of_types_1_and_2_are_not_identical: DiagnosticMessage;
        Interface_0_cannot_simultaneously_extend_types_1_and_2_Colon: DiagnosticMessage;
        Excessive_stack_depth_comparing_types_0_and_1: DiagnosticMessage;
        Type_0_is_not_assignable_to_type_1_Colon: DiagnosticMessage;
        Type_0_is_not_assignable_to_type_1: DiagnosticMessage;
        Property_0_is_missing_in_type_1: DiagnosticMessage;
        Private_property_0_cannot_be_reimplemented: DiagnosticMessage;
        Types_of_property_0_are_incompatible_Colon: DiagnosticMessage;
        Required_property_0_cannot_be_reimplemented_with_optional_property_in_1: DiagnosticMessage;
        Types_of_parameters_0_and_1_are_incompatible_Colon: DiagnosticMessage;
        Index_signature_is_missing_in_type_0: DiagnosticMessage;
        Index_signatures_are_incompatible_Colon: DiagnosticMessage;
        this_cannot_be_referenced_in_a_module_body: DiagnosticMessage;
        ...
        Only_public_methods_of_the_base_class_are_accessible_via_the_super_keyword: DiagnosticMessage;
        Property_0_is_inaccessible: DiagnosticMessage;
        An_index_expression_argument_must_be_of_type_string_number_or_any: DiagnosticMessage;
        Type_0_does_not_satisfy_the_constraint_1_Colon: DiagnosticMessage;
        ...
        Supplied_parameters_do_not_match_any_signature_of_call_target: DiagnosticMessage;
        ...
        Cannot_invoke_an_expression_whose_type_lacks_a_call_signature: DiagnosticMessage;
        ...
        Neither_type_0_nor_type_1_is_assignable_to_the_other: DiagnosticMessage;
        Neither_type_0_nor_type_1_is_assignable_to_the_other_Colon: DiagnosticMessage;
        No_best_common_type_exists_among_return_expressions: DiagnosticMessage;
        A_function_whose_declared_type_is_neither_void_nor_any_must_return_a_value_or_consist_of_a_single_throw_statement: DiagnosticMessage;
        An_arithmetic_operand_must_be_of_type_any_number_or_an_enum_type: DiagnosticMessage;
        The_operand_of_an_increment_or_decrement_operator_must_be_a_variable_property_or_indexer: DiagnosticMessage;
        ...
        The_left_hand_side_of_an_in_expression_must_be_of_types_any_string_or_number: DiagnosticMessage;
        ...
        Invalid_left_hand_side_of_assignment_expression: DiagnosticMessage;
        Operator_0_cannot_be_applied_to_types_1_and_2: DiagnosticMessage;
        No_best_common_type_exists_between_0_1_and_2: DiagnosticMessage;
        No_best_common_type_exists_between_0_and_1: DiagnosticMessage;
        ...
        A_get_accessor_must_return_a_value_or_consist_of_a_single_throw_statement: DiagnosticMessage;
        ...
        Overload_signatures_must_all_be_exported_or_not_exported: DiagnosticMessage;
        Overload_signatures_must_all_be_ambient_or_non_ambient: DiagnosticMessage;
        Overload_signatures_must_all_be_public_or_private: DiagnosticMessage;
        ...
        Duplicate_identifier_i_Compiler_uses_i_to_initialize_rest_parameter: DiagnosticMessage;
        Expression_resolves_to_variable_declaration_i_that_compiler_uses_to_initialize_rest_parameter: DiagnosticMessage;
        ...
        Invalid_left_hand_side_in_for_in_statement: DiagnosticMessage;
        ...
        All_symbols_within_a_with_block_will_be_resolved_to_any: DiagnosticMessage;
        ...
        Class_0_incorrectly_extends_base_class_1_Colon: DiagnosticMessage;
        Class_static_side_0_incorrectly_extends_base_class_static_side_1: DiagnosticMessage;
        Class_static_side_0_incorrectly_extends_base_class_static_side_1_Colon: DiagnosticMessage;
        Type_name_0_in_extends_clause_does_not_reference_constructor_function_for_0: DiagnosticMessage;
        Class_0_incorrectly_implements_interface_1: DiagnosticMessage;
        Class_0_incorrectly_implements_interface_1_Colon: DiagnosticMessage;
        ...
        All_declarations_of_an_interface_must_have_identical_type_parameters: DiagnosticMessage;
        Interface_0_incorrectly_extends_interface_1_Colon: DiagnosticMessage;
        ...
        A_module_declaration_cannot_be_in_a_different_file_from_a_class_or_function_with_which_it_is_merged: DiagnosticMessage;
        A_module_declaration_cannot_be_located_prior_to_a_class_or_function_with_which_it_is_merged: DiagnosticMessage;
        Ambient_external_modules_cannot_be_nested_in_other_modules: DiagnosticMessage;
        Ambient_external_module_declaration_cannot_specify_relative_module_name: DiagnosticMessage;
        Module_0_is_hidden_by_a_local_declaration_with_the_same_name: DiagnosticMessage;
        Import_name_cannot_be_0: DiagnosticMessage;
        Import_declaration_in_an_ambient_external_module_declaration_cannot_reference_external_module_through_relative_external_module_name: DiagnosticMessage;
        Import_declaration_conflicts_with_local_declaration_of_0: DiagnosticMessage;
        Import_declaration_0_is_using_private_name_1: DiagnosticMessage;
        Type_parameter_0_of_exported_class_has_or_is_using_name_1_from_private_module_2: DiagnosticMessage;
        Type_parameter_0_of_exported_class_has_or_is_using_private_name_1: DiagnosticMessage;
        Type_parameter_0_of_exported_interface_has_or_is_using_name_1_from_private_module_2: DiagnosticMessage;
        Type_parameter_0_of_exported_interface_has_or_is_using_private_name_1: DiagnosticMessage;
        Type_parameter_0_of_constructor_signature_from_exported_interface_has_or_is_using_name_1_from_private_module_2: DiagnosticMessage;
        Type_parameter_0_of_constructor_signature_from_exported_interface_has_or_is_using_private_name_1: DiagnosticMessage;
        Type_parameter_0_of_call_signature_from_exported_interface_has_or_is_using_name_1_from_private_module_2: DiagnosticMessage;
        Type_parameter_0_of_call_signature_from_exported_interface_has_or_is_using_private_name_1: DiagnosticMessage;
        Type_parameter_0_of_public_static_method_from_exported_class_has_or_is_using_name_1_from_private_module_2: DiagnosticMessage;
        Type_parameter_0_of_public_static_method_from_exported_class_has_or_is_using_private_name_1: DiagnosticMessage;
        Type_parameter_0_of_public_method_from_exported_class_has_or_is_using_name_1_from_private_module_2: DiagnosticMessage;
        Type_parameter_0_of_public_method_from_exported_class_has_or_is_using_private_name_1: DiagnosticMessage;
        Type_parameter_0_of_method_from_exported_interface_has_or_is_using_name_1_from_private_module_2: DiagnosticMessage;
        Type_parameter_0_of_method_from_exported_interface_has_or_is_using_private_name_1: DiagnosticMessage;
        Type_parameter_0_of_exported_function_has_or_is_using_name_1_from_private_module_2: DiagnosticMessage;
        Type_parameter_0_of_exported_function_has_or_is_using_private_name_1: DiagnosticMessage;
        Implements_clause_of_exported_class_0_has_or_is_using_name_1_from_private_module_2: DiagnosticMessage;
        Extends_clause_of_exported_class_0_has_or_is_using_name_1_from_private_module_2: DiagnosticMessage;
        ...
        Extends_clause_of_exported_interface_0_has_or_is_using_name_1_from_private_module_2: DiagnosticMessage;
        ...
        Unsupported_file_encoding: DiagnosticMessage;
        Unknown_compiler_option_0: DiagnosticMessage;
        Could_not_write_file_0_Colon_1: DiagnosticMessage;
        Option_mapRoot_cannot_be_specified_without_specifying_sourcemap_option: DiagnosticMessage;
        Option_sourceRoot_cannot_be_specified_without_specifying_sourcemap_option: DiagnosticMessage;
        Concatenate_and_emit_output_to_single_file: DiagnosticMessage;
        Generates_corresponding_d_ts_file: DiagnosticMessage;
        Specifies_the_location_where_debugger_should_locate_map_files_instead_of_generated_locations: DiagnosticMessage;
        Specifies_the_location_where_debugger_should_locate_TypeScript_files_instead_of_source_locations: DiagnosticMessage;
        ...
        Specify_ECMAScript_target_version_Colon_ES3_default_or_ES5: DiagnosticMessage;
        Specify_module_code_generation_Colon_commonjs_or_amd: DiagnosticMessage;
        ...
        File_change_detected_Compiling: DiagnosticMessage;
        ...
        Argument_for_module_option_must_be_commonjs_or_amd: DiagnosticMessage;
        Argument_for_target_option_must_be_es3_or_es5: DiagnosticMessage;
        ...
        Warn_on_expressions_and_declarations_with_an_implied_any_type: DiagnosticMessage;
        File_0_not_found: DiagnosticMessage;
        File_0_must_have_extension_ts_or_d_ts: DiagnosticMessage;
        ...
        Property_0_implicitly_has_type_any_because_its_set_accessor_lacks_a_type_annotation: DiagnosticMessage;
        Index_signature_of_object_type_implicitly_has_an_any_type: DiagnosticMessage;
