...
module ts {
    export var Diagnostics = {
        ...
        The_codepage_option_has_been_deprecated_Please_use_charset: { code: 6055, category: DiagnosticCategory.Warning, key: "The '--codepage' option has been deprecated. Please use '--charset'." },
        The_codepage_option_cannot_be_used_with_charset_Please_use_charset_only: { code: 6056, category: DiagnosticCategory.Error, key: "The '--codepage' option cannot be used with '--charset'. Please use '--charset' only." },
