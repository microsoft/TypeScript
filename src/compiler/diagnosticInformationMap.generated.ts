...
module ts {
    export var Diagnostics = {
        ...
        _0_modifier_cannot_be_used_on_a_1_accessor: { code: 1042, category: DiagnosticCategory.Error, key: "'{0}' modifier cannot be used on a '{1}' accessor." },
        ...
        _0_modifier_cannot_be_used_with_an_import_declaration: { code: 1177, category: DiagnosticCategory.Error, key: "'{0}' modifier cannot be used with an import declaration." },
        ...
        with_statements_are_not_allowed_in_an_async_function_block: { code: 1170, category: DiagnosticCategory.Error, key: "'with' statements are not allowed in an async function block." },
        _0_modifier_cannot_be_used_with_a_generator: { code: 1171, category: DiagnosticCategory.Error, key: "'{0}' modifier cannot be used with a generator." },
        _0_modifier_cannot_be_used_with_a_module_declaration: { code: 1172, category: DiagnosticCategory.Error, key: "'{0}' modifier cannot be used with a module declaration." },
        _0_modifier_cannot_be_used_with_an_enum_declaration: { code: 1173, category: DiagnosticCategory.Error, key: "'{0}' modifier cannot be used with an enum declaration." },
        _0_modifier_cannot_be_used_with_an_export_assignment_declaration: { code: 1174, category: DiagnosticCategory.Error, key: "'{0}' modifier cannot be used with an export assignment declaration." },
        _0_modifier_cannot_be_used_on_a_variable_statement: { code: 1175, category: DiagnosticCategory.Error, key: "'{0}' modifier cannot be used on a variable statement." },
        _0_modifier_cannot_be_used_with_a_type_declaration: { code: 1176, category: DiagnosticCategory.Error, key: "'{0}' modifier cannot be used with a type declaration." },
        _0_modifier_cannot_be_used_with_a_parameter_declaration: { code: 1178, category: DiagnosticCategory.Error, key: "'{0}' modifier cannot be used with a parameter declaration." },
