...
module ts {
    export var Diagnostics = {
        ...
        _0_modifier_cannot_be_used_with_an_interface_declaration: { code: 1045, category: DiagnosticCategory.Error, key: "'{0}' modifier cannot be used with an interface declaration.", isEarly: true },
        ...
        An_async_function_or_method_must_have_a_valid_awaitable_return_type: { code: 1057, category: DiagnosticCategory.Error, key: "An async function or method must have a valid awaitable return type.", isEarly: true },
        Type_for_await_does_not_have_a_valid_callable_then_member: { code: 1058, category: DiagnosticCategory.Error, key: "Type for 'await' does not have a valid callable 'then' member.", isEarly: true },
        ...
        _0_modifier_cannot_be_used_with_an_import_declaration: { code: 1079, category: DiagnosticCategory.Error, key: "'{0}' modifier cannot be used with an import declaration.", isEarly: true },
        ...
        yield_expression_must_be_contained_within_a_generator_declaration: { code: 1163, category: DiagnosticCategory.Error, key: "'yield' expression must be contained within a generator declaration.", isEarly: true },
        ...
        Merge_conflict_marker_encountered: { code: 1186, category: DiagnosticCategory.Error, key: "Merge conflict marker encountered." },
        A_rest_element_cannot_have_an_initializer: { code: 1187, category: DiagnosticCategory.Error, key: "A rest element cannot have an initializer." },
        ...
        A_parameter_property_may_not_be_a_binding_pattern: { code: 1310, category: DiagnosticCategory.Error, key: "A parameter property may not be a binding pattern." },
        _0_expression_is_not_allowed_in_an_initializer: { code: 1311, category: DiagnosticCategory.Error, key: "'{0}' expression is not allowed in an initializer.", isEarly: true },
        Async_functions_are_only_available_when_targeting_ECMAScript_6_and_higher: { code: 1312, category: DiagnosticCategory.Error, key: "Async functions are only available when targeting ECMAScript 6 and higher.", isEarly: true },
        ...
        Duplicate_identifier_0_Compiler_uses_declaration_1_to_support_async_functions: { code: 2500, category: DiagnosticCategory.Error, key: "Duplicate identifier '{0}'. Compiler uses declaration '{1}' to support async functions." },
        Expression_resolves_to_variable_declaration_0_that_compiler_uses_to_support_async_functions: { code: 2501, category: DiagnosticCategory.Error, key: "Expression resolves to variable declaration '{0}' that compiler uses to support async functions." },
        Duplicate_identifier_arguments_Compiler_uses_variable_declaration_arguments_to_capture_arguments_reference: { code: 2502, category: DiagnosticCategory.Error, key: "Duplicate identifier '_arguments'. Compiler uses variable declaration '_arguments' to capture 'arguments' reference." },
        Expression_resolves_to_variable_declaration_arguments_that_compiler_uses_to_capture_arguments_reference: { code: 2503, category: DiagnosticCategory.Error, key: "Expression resolves to variable declaration '_arguments' that compiler uses to capture 'arguments' reference." },
        ...
        Emit_async_functions_when_ECMAScript_target_version_is_lower_than_ES6_experimental: { code: 6056, category: DiagnosticCategory.Message, key: "Emit async functions when ECMAScript target version is lower than 'ES6' (experimental)." },
        Do_not_emit_runtime_helper_functions_e_g_extends_awaiter_Assumes_manual_reference_to_tslib_js_experimental: { code: 6057, category: DiagnosticCategory.Message, key: "Do not emit runtime helper functions (e.g. '__extends', '__awaiter'). Assumes manual reference to tslib.js (experimental)." },
