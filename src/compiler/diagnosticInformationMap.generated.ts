...
namespace ts {
    export var Diagnostics = {
        ...
        Cannot_compile_modules_into_commonjs_amd_system_or_umd_when_targeting_ES6_or_higher_unless_bundle_is_specified: { code: 1204, category: DiagnosticCategory.Error, key: "Cannot compile modules into 'commonjs', 'amd', 'system' or 'umd' when targeting 'ES6' or higher unless --bundle is specified." },
        ...
        Option_0_requires_both_1_and_2: { code: 5055, category: DiagnosticCategory.Error, key: "Option '{0}' requires both '{1}' and '{2}'." },
        ...
        Specifies_entrypoint_file_for_bundling: { code: 6073, category: DiagnosticCategory.Message, key: "Specifies entrypoint file for bundling." },
