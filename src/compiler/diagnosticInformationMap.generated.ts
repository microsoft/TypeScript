...
module ts {
    export var Diagnostics = {
        ...
        Emit_async_functions_when_ECMAScript_target_version_is_lower_than_ES6: { code: 6057, category: DiagnosticCategory.Message, key: "Emit async functions when ECMAScript target version is lower than 'ES6'." },
        Do_not_emit_runtime_helper_functions_e_g_extends_awaiter_Assumes_manual_reference_to_tslib_js: { code: 6058, category: DiagnosticCategory.Message, key: "Do not emit runtime helper functions (e.g. '__extends', '__awaiter'). Assumes manual reference to tslib.js." },
