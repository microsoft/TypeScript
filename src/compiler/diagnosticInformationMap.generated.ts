...
module ts {
    export var Diagnostics = {
        ...
        Duplicate_identifier_0_Compiler_uses_variable_declaration_0_to_capture_1_reference: { code: 2399, category: DiagnosticCategory.Error, key: "Duplicate identifier '{0}'. Compiler uses variable declaration '{0}' to capture '{1}' reference." },
        Expression_resolves_to_variable_declaration_0_that_compiler_uses_to_capture_1_reference: { code: 2400, category: DiagnosticCategory.Error, key: "Expression resolves to variable declaration '{0}' that compiler uses to capture '{1}' reference." },
