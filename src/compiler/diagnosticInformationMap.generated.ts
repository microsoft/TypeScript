...
module ts {
    export var Diagnostics = {
        ...
        Non_ambient_decorators_are_only_supported_on_class_members_when_targeting_ECMAScript_5_or_higher: { code: 1189, category: DiagnosticCategory.Error, key: "Non-ambient decorators are only supported on class members when targeting ECMAScript 5 or higher." },
        ...
        Decorator_0_is_not_valid_on_this_declaration_type: { code: 1191, category: DiagnosticCategory.Error, key: "Decorator '{0}' is not valid on this declaration type." },
        Decorator_is_not_valid_on_this_declaration_type: { code: 1192, category: DiagnosticCategory.Error, key: "Decorator is not valid on this declaration type." },
        Argument_to_ambient_decorator_must_be_constant_expression: { code: 1193, category: DiagnosticCategory.Error, key: "Argument to ambient decorator must be constant expression." },
        _0_is_obsolete: { code: 1194, category: DiagnosticCategory.Error, key: "'{0}' is obsolete." },
        _0_is_obsolete_Colon_1: { code: 1195, category: DiagnosticCategory.Error, key: "'{0}' is obsolete: '{1}'" },
        ...
        Cannot_find_global_decorator_function_0: { code: 2478, category: DiagnosticCategory.Error, key: "Cannot find global decorator function '{0}'." },
