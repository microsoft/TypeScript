...
module ts {
    export var Diagnostics = {
        ...
        _0_modifier_cannot_be_used_on_a_1_accessor: { code: 1042, category: DiagnosticCategory.Error, key: "'{0}' modifier cannot be used on a '{1}' accessor.", isEarly: true },
        ...
        Duplicate_identifier_0_Compiler_uses_variable_declaration_0_to_support_async_functions: { code: 2500, category: DiagnosticCategory.Error, key: "Duplicate identifier '{0}'. Compiler uses variable declaration '{0}' to support async functions." },
