...
module ts {
    export var Diagnostics = {
        ...
        An_implementation_cannot_be_declared_in_ambient_contexts: { code: 1177, category: DiagnosticCategory.Error, key: "An implementation cannot be declared in ambient contexts.", isEarly: true },
