...
namespace ts {
    export var Diagnostics = {
        ...
        Import_declaration_0_references_inaccessible_name_1: { code: 4000, category: DiagnosticCategory.Error, key: "Import declaration '{0}' references inaccessible name '{1}'." },
        Constraint_of_type_parameter_0_references_inaccessible_name_1: { code: 4002, category: DiagnosticCategory.Error, key: "Constraint of type parameter '{0}' references inaccessible name '{1}'." },
        ...
        Option_out_cannot_be_specified_with_option_outDir: { code: 5052, category: DiagnosticCategory.Error, key: "Option 'out' cannot be specified with option 'outDir'." },
        Option_out_cannot_be_used_when_option_module_is_CommonJS_or_UMD: { code: 5053, category: DiagnosticCategory.Error, key: "Option 'out' cannot be used when option 'module' is 'CommonJS` or `UMD`." },
        Option_out_cannot_be_used_with_module_files_when_option_target_is_ES6_or_higher: { code: 5054, category: DiagnosticCategory.Error, key: "Option 'out' cannot be used with module files when option 'target' is 'ES6' or higher." },
        Option_declarationOut_cannot_be_specified_without_option_declaration: { code: 5055, category: DiagnosticCategory.Error, key: "Option 'declarationOut' cannot be specified without option 'declaration'." },
        ...
        Concatenate_and_emit_declarations_to_single_file: { code: 6069, category: DiagnosticCategory.Message, key: "Concatenate and emit declarations to single file." },
