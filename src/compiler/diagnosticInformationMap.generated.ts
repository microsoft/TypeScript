...
namespace ts {
    export var Diagnostics = {
        ...
        Constructor_0_1_is_protected_and_only_accessible_within_class_0_and_its_subclasses: { code: 2654, category: DiagnosticCategory.Error, key: "Constructor '{0}{1}' is protected and only accessible within class '{0}' and its subclasses." },
        Constructor_0_1_is_private_and_only_accessible_within_class_0: { code: 2655, category: DiagnosticCategory.Error, key: "Constructor '{0}{1}' is private and only accessible within class '{0}'." },
