...
module ts {
    export var Diagnostics = {
        ...
        Decorators_are_only_supported_on_class_members_when_targeting_ECMAScript_5_or_higher: { code: 1201, category: DiagnosticCategory.Error, key: "Decorators are only supported on class members when targeting ECMAScript 5 or higher." },
        Decorators_are_not_valid_on_this_declaration_type: { code: 1202, category: DiagnosticCategory.Error, key: "Decorators are not valid on this declaration type." },
        Argument_to_ambient_decorator_must_be_constant_expression: { code: 1203, category: DiagnosticCategory.Error, key: "Argument to ambient decorator must be constant expression." },
        Decorators_may_not_change_the_type_of_a_member: { code: 1204, category: DiagnosticCategory.Error, key: "Decorators may not change the type of a member." },
        Decorators_may_not_change_the_type_of_a_class: { code: 1205, category: DiagnosticCategory.Error, key: "Decorators may not change the type of a class." },
