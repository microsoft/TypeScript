...
namespace ts {
    export var Diagnostics = {
        ...
        Cannot_create_an_instance_of_the_abstract_class_0_: { code: 2506, category: DiagnosticCategory.Error, key: "Cannot create an instance of the abstract class '{0}'." },
        Overload_signatures_must_all_match_with_respect_to_modifier_0_: { code: 2507, category: DiagnosticCategory.Error, key: "Overload sigantures must all match with respect to modifier '{0}'."},
