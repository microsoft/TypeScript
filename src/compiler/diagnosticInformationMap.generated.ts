...
module ts {
    export var Diagnostics = {
        ...
        External_module_0_has_no_default_export_or_export_assignment: { code: 2467, category: DiagnosticCategory.Error, key: "External module '{0}' has no default export or export assignment." },
        External_module_0_does_not_contain_any_named_exports: { code: 2468, category: DiagnosticCategory.Error, key: "External module '{0}' does not contain any named exports." },
        Import_declaration_without_import_clause_references_external_module_0_that_is_not_instantiated: { code: 2469, category: DiagnosticCategory.Error, key: "Import declaration without import clause references external module '{0}' that is not instantiated." },
