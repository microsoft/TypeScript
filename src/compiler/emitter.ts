...
export function createPrinter(printerOptions: PrinterOptions = {}, handlers: PrintHandlers = {}): Printer {
    ...
    function emitLiteral(node: PseudoLiteralToken | LiteralLikeNode, jsxAttributeEscape: boolean) {
    ...
    function getLiteralTextOfNode(node: PseudoLiteralToken | LiteralLikeNode, neverAsciiEscape: boolean | undefined, jsxAttributeEscape: boolean): string {
    ...
    function generateNames(node: Node | undefined) {
        ...
        switch (node.kind) {
            ...
            case SyntaxKind.BindingElement:
            case SyntaxKind.ClassDeclaration:
                generateNameIfNeeded((node as NamedDeclarationBase).name);
                break;
            case SyntaxKind.FunctionDeclaration:
                generateNameIfNeeded(node.name);
