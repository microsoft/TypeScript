...
export function createPrinter(printerOptions: PrinterOptions = {}, handlers: PrintHandlers = {}): Printer {
    ...
    function isUniqueName(name: string): boolean {
        return isFileLevelUniqueNameHelper(name)
     ...
     */
    function isFileLevelUniqueNameHelper(name: string) {
    ...
    function makeFileLevelOptimisticUniqueName(name: string) {
        return makeUniqueName(name, isFileLevelUniqueNameHelper, /*optimistic*/ true, /*scoped*/ false, /*privateName*/ false, /*prefix*/ "", /*suffix*/ "");
    }
    ...
    function makeName(name: GeneratedIdentifier | GeneratedPrivateIdentifier) {
        ...
        switch (name.autoGenerateFlags & GeneratedIdentifierFlags.KindMask) {
            ...
            case GeneratedIdentifierFlags.Unique:
                return makeUniqueName(
                    idText(name),
                    (name.autoGenerateFlags & GeneratedIdentifierFlags.FileLevel) ? isFileLevelUniqueNameHelper : isUniqueName,
