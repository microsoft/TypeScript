namespace ts {
    ...
    export function createPrinter(printerOptions: PrinterOptions = {}, handlers: PrintHandlers = {}): Printer {
        ...
        let generatedNames: Map<string, true>; // Set of names generated by the NameGenerator.
        ...
        let reservedNamesStack: Map<string, true>[]; // Stack of TempFlags reserved in enclosing name generation scopes.
        let reservedNames: Map<string, true>; // TempFlags to reserve in nested name generation scopes.
         ...
         */
        function emitPrologueDirectives(statements: readonly Node[], sourceFile?: SourceFile, seenPrologueDirectives?: Map<string, true>, recordBundleFileSection?: true): number {
        ...
        function emitUnparsedPrologues(prologues: readonly UnparsedPrologue[], seenPrologueDirectives: Map<string, true>) {
