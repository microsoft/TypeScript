...
namespace ts {
    ...
    export function updateMethodDeclaration(node: MethodDeclaration, decorators: Array<Decorator>, modifiers: Array<Node>, name: PropertyName
        , typeParameters: Array<TypeParameterDeclaration>, parameters: Array<ParameterDeclaration>, type: TypeNode, body: Block): MethodDeclaration {
        if (decorators !== node.decorators || modifiers !== node.modifiers || name !== node.name || typeParameters !== node.typeParameters || 
    ...
    export function createGetAccessor(decorators?: Array<Decorator>, modifiers?: Array<Node>, name?: PropertyName, 
        parameters?: Array<ParameterDeclaration>, type?: TypeNode, body?: Block, location?: TextRange, flags?: NodeFlags): GetAccessorDeclaration {
    ...
    export function createSetAccessor(decorators?: Array<Decorator>, modifiers?: Array<Node>, name?: PropertyName, 
        parameters?: Array<ParameterDeclaration>, type?: TypeNode, body?: Block, location?: TextRange, flags?: NodeFlags): SetAccessorDeclaration {
    ...
    export function createCallSignature(typeParameters?: Array<TypeParameterDeclaration>, parameters?: Array<ParameterDeclaration>, type?: TypeNode, 
        questionToken?: Node, location?: TextRange, flags?: NodeFlags): CallSignatureDeclaration {
    ...
    export function createFunctionType(typeParameters?: Array<TypeParameterDeclaration>, parameters?: Array<ParameterDeclaration>, type?: TypeNode, 
        location?: TextRange, flags?: NodeFlags): FunctionTypeNode {
    ...
    export function createBindingElement(decorators?: Array<Decorator>, modifiers?: Array<Node>, propertyName?: Identifier, dotDotDotToken?: Node, 
        name?: BindingPattern | Identifier, initializer?: Expression, location?: TextRange, flags?: NodeFlags): BindingElement {
    ...
    export function createObjectLiteralExpression(decorators?: Array<Decorator>, modifiers?: Array<Node>, properties?: Array<ObjectLiteralElement>, 
        location?: TextRange, flags?: NodeFlags): ObjectLiteralExpression {
    ...
    export function updateElementAccessExpression(node: ElementAccessExpression, expression: LeftHandSideExpression, argumentExpression: Expression
    ...
    export function updateClassExpression(node: ClassExpression, decorators: Array<Decorator>, modifiers: Array<Node>, name: Identifier
        , typeParameters: Array<TypeParameterDeclaration>, heritageClauses: Array<HeritageClause>, members: Array<ClassElement>): ClassExpression {
        if (decorators !== node.decorators || modifiers !== node.modifiers || name !== node.name || typeParameters !== node.typeParameters || 
    ...
    export function updateVariableDeclaration(node: VariableDeclaration, name: BindingPattern | Identifier, type: TypeNode, initializer: Expression
        ): VariableDeclaration {
    ...
    export function updateClassDeclaration(node: ClassDeclaration, decorators: Array<Decorator>, modifiers: Array<Node>, name: Identifier
        , typeParameters: Array<TypeParameterDeclaration>, heritageClauses: Array<HeritageClause>, members: Array<ClassElement>): ClassDeclaration {
        if (decorators !== node.decorators || modifiers !== node.modifiers || name !== node.name || typeParameters !== node.typeParameters || 
            heritageClauses !== node.heritageClauses || members !== node.members) {
    ...
    export function updateImportDeclaration(node: ImportDeclaration, decorators: Array<Decorator>, modifiers: Array<Node>, importClause: ImportClause
    ...
    export function updateExportDeclaration(node: ExportDeclaration, decorators: Array<Decorator>, modifiers: Array<Node>, exportClause: NamedExports
    ...
    export function updateMissingDeclaration(node: MissingDeclaration, decorators: Array<Decorator>, modifiers: Array<Node>): MissingDeclaration {
    ...
    export function createSourceFileNode(statements?: Array<Statement>, endOfFileToken?: Node, location?: TextRange, flags?: NodeFlags): SourceFile {
        let node = createNode<SourceFile>(SyntaxKind.SourceFile, location, flags);
        if (statements || endOfFileToken) {
            node.statements = statements && createNodeArray(statements)
    ...
    export function updateSourceFileNode(node: SourceFile, statements: Array<Statement>, endOfFileToken: Node): SourceFile {
        if (statements !== node.statements || endOfFileToken !== node.endOfFileToken) {
            let newNode = createSourceFileNode(statements, endOfFileToken);
            return updateFrom(node, newNode);
        }
        return node;
    }
    ...
    export function cloneNode(node: Node, location?: TextRange, flags: NodeFlags = node.flags): Node {
        ...
        switch (node.kind) {
            ...
            case SyntaxKind.TypeParameter:
                return createTypeParameter((<TypeParameterDeclaration>node).name, (<TypeParameterDeclaration>node).constraint, 
                    (<TypeParameterDeclaration>node).expression, location, flags);
            case SyntaxKind.Parameter:
                return createParameter((<ParameterDeclaration>node).decorators, (<ParameterDeclaration>node).modifiers, 
            ...
            case SyntaxKind.PropertySignature:
                return createPropertySignature((<PropertySignature>node).decorators, (<PropertySignature>node).modifiers, 
                    (<PropertySignature>node).name, (<PropertySignature>node).questionToken, (<PropertySignature>node).type, location, flags);
            case SyntaxKind.PropertyDeclaration:
                return createPropertyDeclaration((<PropertyDeclaration>node).decorators, (<PropertyDeclaration>node).modifiers, 
                    (<PropertyDeclaration>node).name, (<PropertyDeclaration>node).type, (<PropertyDeclaration>node).initializer, location, flags);
            case SyntaxKind.MethodSignature:
                return createMethodSignature((<MethodSignature>node).decorators, (<MethodSignature>node).modifiers, (<MethodSignature>node).name, 
                    (<MethodSignature>node).questionToken, (<MethodSignature>node).typeParameters, (<MethodSignature>node).parameters, 
                    (<MethodSignature>node).type, location, flags);
            case SyntaxKind.MethodDeclaration:
                return createMethodDeclaration((<MethodDeclaration>node).decorators, (<MethodDeclaration>node).modifiers, 
            ...
            case SyntaxKind.Constructor:
                return createConstructor((<ConstructorDeclaration>node).decorators, (<ConstructorDeclaration>node).modifiers, 
                    (<ConstructorDeclaration>node).parameters, (<ConstructorDeclaration>node).type, (<ConstructorDeclaration>node).body, 
                    location, flags);
            case SyntaxKind.GetAccessor:
                return createGetAccessor((<GetAccessorDeclaration>node).decorators, (<GetAccessorDeclaration>node).modifiers, 
            ...
            case SyntaxKind.SetAccessor:
                return createSetAccessor((<SetAccessorDeclaration>node).decorators, (<SetAccessorDeclaration>node).modifiers, 
            ...
            case SyntaxKind.CallSignature:
                return createCallSignature((<CallSignatureDeclaration>node).typeParameters, (<CallSignatureDeclaration>node).parameters, 
                    (<CallSignatureDeclaration>node).type, (<CallSignatureDeclaration>node).questionToken, location, flags);
            case SyntaxKind.ConstructSignature:
                return createConstructSignature((<ConstructSignatureDeclaration>node).typeParameters, 
            ...
            case SyntaxKind.IndexSignature:
                return createIndexSignature((<IndexSignatureDeclaration>node).decorators, (<IndexSignatureDeclaration>node).modifiers, 
            ...
            case SyntaxKind.FunctionType:
                return createFunctionType((<FunctionTypeNode>node).typeParameters, (<FunctionTypeNode>node).parameters, 
                    (<FunctionTypeNode>node).type, location, flags);
            case SyntaxKind.ConstructorType:
                return createConstructorType((<ConstructorTypeNode>node).typeParameters, (<ConstructorTypeNode>node).parameters, 
            ...
            case SyntaxKind.BindingElement:
                return createBindingElement((<BindingElement>node).decorators, (<BindingElement>node).modifiers, (<BindingElement>node).propertyName, 
                    (<BindingElement>node).dotDotDotToken, (<BindingElement>node).name, (<BindingElement>node).initializer, location, flags);
            case SyntaxKind.ArrayLiteralExpression:
                return createArrayLiteralExpression((<ArrayLiteralExpression>node).elements, location, flags);
            case SyntaxKind.ObjectLiteralExpression:
                return createObjectLiteralExpression((<ObjectLiteralExpression>node).decorators, (<ObjectLiteralExpression>node).modifiers, 
                    (<ObjectLiteralExpression>node).properties, location, flags);
            case SyntaxKind.PropertyAccessExpression:
                return createPropertyAccessExpression((<PropertyAccessExpression>node).expression, (<PropertyAccessExpression>node).dotToken, 
                    (<PropertyAccessExpression>node).name, location, flags);
            case SyntaxKind.ElementAccessExpression:
                return createElementAccessExpression((<ElementAccessExpression>node).expression, (<ElementAccessExpression>node).argumentExpression, 
                    location, flags);
            case SyntaxKind.CallExpression:
                return createCallExpression((<CallExpression>node).expression, (<CallExpression>node).typeArguments, 
                    (<CallExpression>node).arguments, location, flags);
            case SyntaxKind.NewExpression:
                return createNewExpression((<NewExpression>node).expression, (<NewExpression>node).typeArguments, (<NewExpression>node).arguments, 
                    location, flags);
            case SyntaxKind.TaggedTemplateExpression:
                return createTaggedTemplateExpression((<TaggedTemplateExpression>node).tag, (<TaggedTemplateExpression>node).template, 
                    location, flags);
            ...
            case SyntaxKind.FunctionExpression:
                return createFunctionExpression((<FunctionExpression>node).decorators, (<FunctionExpression>node).modifiers, 
            ...
            case SyntaxKind.ArrowFunction:
                return createArrowFunction((<ArrowFunction>node).decorators, (<ArrowFunction>node).modifiers, (<ArrowFunction>node).typeParameters, 
                    (<ArrowFunction>node).parameters, (<ArrowFunction>node).type, (<ArrowFunction>node).equalsGreaterThanToken, 
                    (<ArrowFunction>node).body, location, flags);
            ...
            case SyntaxKind.PostfixUnaryExpression:
                return createPostfixUnaryExpression((<PostfixUnaryExpression>node).operand, (<PostfixUnaryExpression>node).operator, 
                    location, flags);
            case SyntaxKind.BinaryExpression:
                return createBinaryExpression((<BinaryExpression>node).left, (<BinaryExpression>node).operatorToken, (<BinaryExpression>node).right, 
                    location, flags);
            case SyntaxKind.ConditionalExpression:
                return createConditionalExpression((<ConditionalExpression>node).condition, (<ConditionalExpression>node).questionToken, 
            ...
            case SyntaxKind.ClassExpression:
                return createClassExpression((<ClassExpression>node).decorators, (<ClassExpression>node).modifiers, (<ClassExpression>node).name, 
                    (<ClassExpression>node).typeParameters, (<ClassExpression>node).heritageClauses, (<ClassExpression>node).members, 
                    location, flags);
            case SyntaxKind.OmittedExpression:
                return createOmittedExpression(location, flags);
            case SyntaxKind.ExpressionWithTypeArguments:
                return createExpressionWithTypeArguments((<ExpressionWithTypeArguments>node).expression, 
            ...
            case SyntaxKind.VariableStatement:
                return createVariableStatement((<VariableStatement>node).decorators, (<VariableStatement>node).modifiers, 
            ...
            case SyntaxKind.IfStatement:
                return createIfStatement((<IfStatement>node).expression, (<IfStatement>node).thenStatement, (<IfStatement>node).elseStatement, 
                    location, flags);
            ...
            case SyntaxKind.ForStatement:
                return createForStatement((<ForStatement>node).initializer, (<ForStatement>node).condition, (<ForStatement>node).incrementor, 
                    (<ForStatement>node).statement, location, flags);
            case SyntaxKind.ForInStatement:
                return createForInStatement((<ForInStatement>node).initializer, (<ForInStatement>node).expression, (<ForInStatement>node).statement, 
                    location, flags);
            case SyntaxKind.ForOfStatement:
                return createForOfStatement((<ForOfStatement>node).initializer, (<ForOfStatement>node).expression, (<ForOfStatement>node).statement, 
                    location, flags);
            ...
            case SyntaxKind.TryStatement:
                return createTryStatement((<TryStatement>node).tryBlock, (<TryStatement>node).catchClause, (<TryStatement>node).finallyBlock, 
                    location, flags);
            case SyntaxKind.DebuggerStatement:
                return createDebuggerStatement(location, flags);
            case SyntaxKind.VariableDeclaration:
                return createVariableDeclaration((<VariableDeclaration>node).name, (<VariableDeclaration>node).type, 
            ...
            case SyntaxKind.FunctionDeclaration:
                return createFunctionDeclaration((<FunctionDeclaration>node).decorators, (<FunctionDeclaration>node).modifiers, 
            ...
            case SyntaxKind.ClassDeclaration:
                return createClassDeclaration((<ClassDeclaration>node).decorators, (<ClassDeclaration>node).modifiers, (<ClassDeclaration>node).name, 
                    (<ClassDeclaration>node).typeParameters, (<ClassDeclaration>node).heritageClauses, (<ClassDeclaration>node).members, 
                    location, flags);
            case SyntaxKind.InterfaceDeclaration:
                return createInterfaceDeclaration((<InterfaceDeclaration>node).decorators, (<InterfaceDeclaration>node).modifiers, 
            ...
            case SyntaxKind.TypeAliasDeclaration:
                return createTypeAliasDeclaration((<TypeAliasDeclaration>node).decorators, (<TypeAliasDeclaration>node).modifiers, 
                    (<TypeAliasDeclaration>node).name, (<TypeAliasDeclaration>node).typeParameters, (<TypeAliasDeclaration>node).type, 
                    location, flags);
            case SyntaxKind.EnumDeclaration:
                return createEnumDeclaration((<EnumDeclaration>node).decorators, (<EnumDeclaration>node).modifiers, (<EnumDeclaration>node).name, 
                    (<EnumDeclaration>node).members, location, flags);
            case SyntaxKind.ModuleDeclaration:
                return createModuleDeclaration((<ModuleDeclaration>node).decorators, (<ModuleDeclaration>node).modifiers, 
            ...
            case SyntaxKind.ImportEqualsDeclaration:
                return createImportEqualsDeclaration((<ImportEqualsDeclaration>node).decorators, (<ImportEqualsDeclaration>node).modifiers, 
                    (<ImportEqualsDeclaration>node).name, (<ImportEqualsDeclaration>node).moduleReference, location, flags);
            case SyntaxKind.ImportDeclaration:
                return createImportDeclaration((<ImportDeclaration>node).decorators, (<ImportDeclaration>node).modifiers, 
            ...
            case SyntaxKind.ExportAssignment:
                return createExportAssignment((<ExportAssignment>node).decorators, (<ExportAssignment>node).modifiers, 
                    (<ExportAssignment>node).expression, location, flags);
            case SyntaxKind.ExportDeclaration:
                return createExportDeclaration((<ExportDeclaration>node).decorators, (<ExportDeclaration>node).modifiers, 
            ...
            case SyntaxKind.MissingDeclaration:
                return createMissingDeclaration((<MissingDeclaration>node).decorators, (<MissingDeclaration>node).modifiers, 
            ...
            case SyntaxKind.JsxElement:
                return createJsxElement((<JsxElement>node).openingElement, (<JsxElement>node).children, (<JsxElement>node).closingElement, 
                    location, flags);
            ...
            case SyntaxKind.SourceFile:
                return createSourceFileNode((<SourceFile>node).statements, (<SourceFile>node).endOfFileToken, location, flags);
            ...
            case SyntaxKind.JSDocParameterTag:
                return createJSDocParameterTag((<JSDocParameterTag>node).preParameterName, (<JSDocParameterTag>node).typeExpression, 
                    (<JSDocParameterTag>node).postParameterName, (<JSDocParameterTag>node).atToken, (<JSDocParameterTag>node).tagName, 
                    location, flags);
            case SyntaxKind.JSDocReturnTag:
                return createJSDocReturnTag((<JSDocReturnTag>node).typeExpression, (<JSDocReturnTag>node).atToken, (<JSDocReturnTag>node).tagName, 
                    location, flags);
            case SyntaxKind.JSDocTypeTag:
                return createJSDocTypeTag((<JSDocTypeTag>node).typeExpression, (<JSDocTypeTag>node).atToken, (<JSDocTypeTag>node).tagName, 
                    location, flags);
            case SyntaxKind.JSDocTemplateTag:
                return createJSDocTemplateTag((<JSDocTemplateTag>node).typeParameters, (<JSDocTemplateTag>node).atToken, 
