import {
    ...
    hasStaticModifier, hasSyntacticModifier, HeritageClause, Identifier, idText, IfStatement, ImportCall, ImportClause,
    ImportDeclaration, ImportEqualsDeclaration, ImportExpression, ImportSpecifier, ImportTypeAssertionContainer, ImportTypeNode,
