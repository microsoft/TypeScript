import {
    AccessorDeclaration, addEmitFlags, addInternalEmitFlags, AdditiveOperator, AdditiveOperatorOrHigher, AssertionLevel,
    ...
    compareStringsCaseSensitive, CompilerOptions, ComputedPropertyName, Debug, Declaration, DefaultKeyword, EmitFlags, EmitHelperFactory, EmitHost,
    EmitResolver, EntityName, EqualityOperator, EqualityOperatorOrHigher, EqualsToken, ExclamationToken, ExponentiationOperator,
    ExportDeclaration, ExportKeyword, Expression, ExpressionStatement, externalHelpersModuleNameText, first, firstOrUndefined,
    ...
    InternalEmitFlags,
    isAssignmentExpression, isAssignmentOperator, isBlock, isCommaListExpression, isComputedPropertyName, isDeclarationBindingElement,
    ...
    isLiteralExpression, isMemberName, isMinusToken, isModifierKind, isObjectLiteralElementLike, isParenthesizedExpression, isPlusToken,
    ...
    MethodDeclaration, MinusToken, Modifier, ModifiersArray, ModuleKind, ModuleName, MultiplicativeOperator,
    MultiplicativeOperatorOrHigher, Mutable, NamedImportBindings, Node, NodeArray, NodeFactory, nodeIsSynthesized, NullLiteral,
    NumericLiteral, ObjectLiteralElementLike, ObjectLiteralExpression, or, OuterExpression, OuterExpressionKinds,
    outFile, ParenthesizedExpression, parseNodeFactory, PlusToken, PostfixUnaryExpression, PrefixUnaryExpression, PrivateIdentifier,
