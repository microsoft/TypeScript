import {
    ...
    getEmitModuleResolutionKind, getModeForResolutionAtIndex, getNormalizedAbsolutePath, getOwnKeys, getPathComponents,
    ...
    hasTSFileExtension, hostGetCanonicalFileName, isArray, isExternalModuleNameRelative, isRootedDiskPath, isString,
    lastOrUndefined, length, Map, MapLike, matchedText, MatchingKeys, matchPatternOrExact, ModuleKind,
