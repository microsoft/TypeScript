import {
    append, appendIfUnique, arrayFrom, arrayIsEqualTo, changeAnyExtension, CharacterCodes, combinePaths, comparePaths, Comparison,
    CompilerOptions, concatenate, contains, containsPath, createCompilerDiagnostic, Debug, deduplicate, Diagnostic, DiagnosticMessage,
    ...
    getRelativePathFromDirectory, getResolveJsonModule, getRootLength, hasJSFileExtension, hasProperty, hasTrailingDirectorySeparator,
    hostGetCanonicalFileName, isArray, isDeclarationFileName, isExternalModuleNameRelative, isRootedDiskPath, isString,
    ...
    StringLiteralLike, supportedDeclarationExtensions, supportedTSExtensionsFlat, supportedTSImplementationExtensions, toFileNameLowerCase, toPath, tryExtractTSExtension, tryGetExtensionFromPath,
