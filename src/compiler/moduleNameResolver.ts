        ...
        if (result) {
            ...
            switch (moduleResolution) {
                ...
                case ModuleResolutionKind.Classic:
                    ...
                    break;
                default:
                    throw Debug.fail(`Unexpected moduleResolution: ${moduleResolution}`);
            }
        ...
        function tryResolve(extensions: Extensions): SearchResult<{ resolved: Resolved, isExternalLibraryImport: boolean }> {
            ...
            if (!isExternalModuleNameRelative(moduleName)) {
                ...
                if (!compilerOptions.preserveSymlinks) {
                    // TODO: This looks like a bug in type inference. Cast shouldn't be needed.
                    resolvedValue = resolvedValue && { ...resolved.value, path: realPath(resolvedValue.path, host, traceEnabled), extension: resolvedValue.extension } as Resolved;
                }
