    ...
    namespace Parser {
        ...
        function computeNodeFlags() {
            ...
            if (parseErrorBeforeNextFinishedNode) {
                parseErrorBeforeNextFinishedNode = false;
                flags |= NodeFlags.ThisNodeHasError;
            }
            return flags;
        }
        ...
        function finishNode<T extends Node>(node: T, pos: number, end?: number): T {
            ...
            (node as Mutable<T>).flags |= computeNodeFlags();
            return node;
        }
        ...
        function createMissingList<T extends Node>() {
            const list = createNodeArray<T>([], getNodePos());
            (list as MutableNodeArray<T>).isMissingList = true;
            return list;
        }
        ...
        function typeHasArrowFunctionBlockingParseError(node: TypeNode): boolean {
            switch (node.kind) {
                ...
                case SyntaxKind.ConstructorType: {
                    ...
                    return parameters.isMissingList || typeHasArrowFunctionBlockingParseError(type);
                }
        ...
        function parseSuperExpression(): MemberExpression {
            ...
            return finishNode(factory.createPropertyAccess(expression, parseRightSideOfDot(/*allowIdentifierNames*/ true, /*allowPrivateIdentifiers*/ true)), pos);
        }
        ...
        function parseJsxElementName(): JsxTagNameExpression {
            ...
            while (parseOptional(SyntaxKind.DotToken)) {
                expression = finishNode(factory.createPropertyAccess(expression, parseRightSideOfDot(/*allowIdentifierNames*/ true, /*allowPrivateIdentifiers*/ false)), pos) as JsxTagNamePropertyAccess;
            }
            return expression;
        }
