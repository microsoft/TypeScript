...
namespace Parser {
    ...
    let privateIdentifiers: ts.Map<string>;
    ...
    function parseNamedImportsOrExports(kind: SyntaxKind): NamedImportsOrExports {
        ...
        node.elements = (<NodeArray<ImportSpecifier> | NodeArray<ExportSpecifier>>parseBracketedList(ParsingContext.ImportOrExportSpecifiers, kind === SyntaxKind.NamedImports ? parseImportSpecifier : parseExportSpecifier, SyntaxKind.OpenBraceToken, SyntaxKind.CloseBraceToken));
        return finishNode(node);
    }
