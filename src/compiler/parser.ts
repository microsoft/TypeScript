...
namespace ts {
    ...
    namespace Parser {
        ...
        function parseSignatureMember(kind: SyntaxKind): CallSignatureDeclaration | ConstructSignatureDeclaration {
            let node = <CallSignatureDeclaration | ConstructSignatureDeclaration>createNode(kind);
        ...
        function parsePropertyOrMethodSignature(): PropertySignature | MethodSignature {
            ...
            if (token === SyntaxKind.OpenParenToken || token === SyntaxKind.LessThanToken) {
                let method = <MethodSignature>createNode(SyntaxKind.MethodSignature, fullStart);
                method.name = name;
                ...
                let property = <PropertySignature>createNode(SyntaxKind.PropertySignature, fullStart);
                property.name = name;
