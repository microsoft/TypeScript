namespace ts {
    ...
    export function forEachChild<T>(node: Node, cbNode: (node: Node) => T | undefined, cbNodes?: (nodes: NodeArray<Node>) => T | undefined): T | undefined {
        ...
        switch (node.kind) {
            case SyntaxKind.QualifiedName:
                return (
                    visitNode(cbNode, (node as QualifiedName).left) ||
            ...
            case SyntaxKind.TypeParameter:
                return (
                    visitNode(
                        cbNode,
                        (node as TypeParameterDeclaration).name
                    ) ||
                    visitNode(
                        cbNode,
                        (node as TypeParameterDeclaration).constraint
                    ) ||
                    visitNode(
                        cbNode,
                        (node as TypeParameterDeclaration).default
                    ) ||
                    visitNode(
                        cbNode,
            ...
            case SyntaxKind.ShorthandPropertyAssignment:
                return (
                    ...
                    visitNode(
                        cbNode,
                        (node as ShorthandPropertyAssignment).questionToken
                    ) ||
                    visitNode(
                        cbNode,
                        (node as ShorthandPropertyAssignment).exclamationToken
                    ) ||
                    visitNode(
                        cbNode,
                        (node as ShorthandPropertyAssignment).equalsToken
                    ) ||
                    visitNode(
                        cbNode,
            ...
            case SyntaxKind.Parameter:
                return (
                    ...
                    visitNode(
                        cbNode,
                        (node as ParameterDeclaration).questionToken
                    ) ||
                    visitNode(cbNode, (node as ParameterDeclaration).type) ||
                    visitNode(
                        cbNode,
                        (node as ParameterDeclaration).initializer
                    )
                );
            ...
            case SyntaxKind.PropertySignature:
                return (
                    ...
                    visitNode(
                        cbNode,
                        (node as PropertySignature).questionToken
                    ) ||
            ...
            case SyntaxKind.PropertyAssignment:
                return (
                    ...
                    visitNode(
                        cbNode,
                        (node as PropertyAssignment).questionToken
                    ) ||
            ...
            case SyntaxKind.VariableDeclaration:
                return (
                    ...
                    visitNode(
                        cbNode,
                        (node as VariableDeclaration).exclamationToken
                    ) ||
            ...
            case SyntaxKind.IndexSignature:
                return (
                    ...
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as SignatureDeclaration).typeParameters
                    ) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as SignatureDeclaration).parameters
                    ) ||
            ...
            case SyntaxKind.ArrowFunction:
                return (
                    ...
                    visitNode(
                        cbNode,
                        (node as FunctionLikeDeclaration).questionToken
                    ) ||
                    visitNode(
                        cbNode,
                        (node as FunctionLikeDeclaration).exclamationToken
                    ) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as FunctionLikeDeclaration).typeParameters
                    ) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as FunctionLikeDeclaration).parameters
                    ) ||
            ...
            case SyntaxKind.ClassStaticBlockDeclaration:
                return (
                    ...
                    visitNode(
                        cbNode,
                        (node as ClassStaticBlockDeclaration).body
                    )
                );
            case SyntaxKind.TypeReference:
                return (
                    visitNode(cbNode, (node as TypeReferenceNode).typeName) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
            ...
            case SyntaxKind.TypePredicate:
                return (
                    ...
                    visitNode(
                        cbNode,
                        (node as TypePredicateNode).parameterName
                    ) ||
            ...
            case SyntaxKind.TypeLiteral:
                return visitNodes(
                    cbNode,
                    cbNodes,
                    (node as TypeLiteralNode).members
                );
            ...
            case SyntaxKind.TupleType:
                return visitNodes(
                    cbNode,
                    cbNodes,
                    (node as TupleTypeNode).elements
                );
            ...
            case SyntaxKind.ImportType:
                return (
                    visitNode(cbNode, (node as ImportTypeNode).argument) ||
                    visitNode(cbNode, (node as ImportTypeNode).qualifier) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as ImportTypeNode).typeArguments
                    )
                );
            ...
            case SyntaxKind.TypeOperator:
                return visitNode(
                    cbNode,
                    (node as ParenthesizedTypeNode | TypeOperatorNode).type
                );
            ...
            case SyntaxKind.MappedType:
                return (
                    visitNode(cbNode, (node as MappedTypeNode).readonlyToken) ||
            ...
            case SyntaxKind.NamedTupleMember:
                return (
                    visitNode(
                        cbNode,
                        (node as NamedTupleMember).dotDotDotToken
                    ) ||
                    visitNode(cbNode, (node as NamedTupleMember).name) ||
                    visitNode(
                        cbNode,
                        (node as NamedTupleMember).questionToken
                    ) ||
            ...
            case SyntaxKind.ArrayBindingPattern:
                return visitNodes(
                    cbNode,
                    cbNodes,
                    (node as BindingPattern).elements
                );
            ...
            case SyntaxKind.PropertyAccessExpression:
                return (
                    ...
                    visitNode(
                        cbNode,
                        (node as PropertyAccessExpression).questionDotToken
                    ) ||
            ...
            case SyntaxKind.ElementAccessExpression:
                return (
                    visitNode(
                        cbNode,
                        (node as ElementAccessExpression).expression
                    ) ||
                    visitNode(
                        cbNode,
                        (node as ElementAccessExpression).questionDotToken
                    ) ||
                    visitNode(
                        cbNode,
            ...
            case SyntaxKind.NewExpression:
                return (
                    visitNode(cbNode, (node as CallExpression).expression) ||
                    visitNode(
                        cbNode,
                        (node as CallExpression).questionDotToken
                    ) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
            ...
            case SyntaxKind.TaggedTemplateExpression:
                return (
                    visitNode(cbNode, (node as TaggedTemplateExpression).tag) ||
                    visitNode(
                        cbNode,
                        (node as TaggedTemplateExpression).questionDotToken
                    ) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
            ...
            case SyntaxKind.TypeAssertionExpression:
                return (
                    visitNode(cbNode, (node as TypeAssertion).type) ||
            ...
            case SyntaxKind.YieldExpression:
                return (
                    visitNode(
                        cbNode,
                        (node as YieldExpression).asteriskToken
            ...
            case SyntaxKind.BinaryExpression:
                return (
                    visitNode(cbNode, (node as BinaryExpression).left) ||
                    visitNode(
                        cbNode,
            ...
            case SyntaxKind.AsExpression:
                return (
                    visitNode(cbNode, (node as AsExpression).expression) ||
                    visitNode(cbNode, (node as AsExpression).type)
                );
            case SyntaxKind.NonNullExpression:
                return visitNode(
                    cbNode,
                    (node as NonNullExpression).expression
                );
            ...
            case SyntaxKind.ConditionalExpression:
                return (
                    visitNode(
                        cbNode,
                        (node as ConditionalExpression).condition
                    ) ||
                    visitNode(
                        cbNode,
            ...
            case SyntaxKind.VariableDeclarationList:
                return visitNodes(
                    cbNode,
                    cbNodes,
                    (node as VariableDeclarationList).declarations
                );
            ...
            case SyntaxKind.BreakStatement:
                return visitNode(
                    cbNode,
                    (node as BreakOrContinueStatement).label
                );
            case SyntaxKind.ReturnStatement:
                return visitNode(cbNode, (node as ReturnStatement).expression);
            case SyntaxKind.WithStatement:
                return (
                    visitNode(cbNode, (node as WithStatement).expression) ||
                    visitNode(cbNode, (node as WithStatement).statement)
                );
            case SyntaxKind.SwitchStatement:
                return (
                    visitNode(cbNode, (node as SwitchStatement).expression) ||
            ...
            case SyntaxKind.CaseClause:
                return (
                    visitNode(cbNode, (node as CaseClause).expression) ||
            ...
            case SyntaxKind.DefaultClause:
                return visitNodes(
                    cbNode,
                    cbNodes,
                    (node as DefaultClause).statements
                );
            case SyntaxKind.LabeledStatement:
                return (
                    visitNode(cbNode, (node as LabeledStatement).label) ||
            ...
            case SyntaxKind.TryStatement:
                return (
                    visitNode(cbNode, (node as TryStatement).tryBlock) ||
            ...
            case SyntaxKind.CatchClause:
                return (
                    visitNode(
                        cbNode,
                        (node as CatchClause).variableDeclaration
            ...
            case SyntaxKind.ClassExpression:
                return (
                    ...
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as ClassLikeDeclaration).typeParameters
                    ) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as ClassLikeDeclaration).heritageClauses
                    ) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as ClassLikeDeclaration).members
                    )
                );
            case SyntaxKind.InterfaceDeclaration:
                return (
                    ...
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as InterfaceDeclaration).typeParameters
                    ) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
                    ...
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as InterfaceDeclaration).members
                    )
                );
            case SyntaxKind.TypeAliasDeclaration:
                return (
                    ...
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as TypeAliasDeclaration).typeParameters
                    ) ||
            ...
            case SyntaxKind.EnumDeclaration:
                return (
                    ...
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as EnumDeclaration).members
                    )
                );
            case SyntaxKind.EnumMember:
                return (
                    visitNode(cbNode, (node as EnumMember).name) ||
            ...
            case SyntaxKind.ImportDeclaration:
                return (
                    ...
                    visitNode(
                        cbNode,
                        (node as ImportDeclaration).moduleSpecifier
                    )
                );
            case SyntaxKind.ImportClause:
                return (
                    visitNode(cbNode, (node as ImportClause).name) ||
                    visitNode(cbNode, (node as ImportClause).namedBindings)
                );
            case SyntaxKind.NamespaceExportDeclaration:
                return visitNode(
                    cbNode,
                    (node as NamespaceExportDeclaration).name
                );
            ...
            case SyntaxKind.NamedExports:
                return visitNodes(
                    cbNode,
                    cbNodes,
                    (node as NamedImportsOrExports).elements
                );
            ...
            case SyntaxKind.ExportSpecifier:
                return (
                    visitNode(
                        cbNode,
                        (node as ImportOrExportSpecifier).propertyName
                    ) ||
            ...
            case SyntaxKind.TemplateExpression:
                return (
                    visitNode(cbNode, (node as TemplateExpression).head) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as TemplateExpression).templateSpans
                    )
                );
            case SyntaxKind.TemplateSpan:
                return (
                    visitNode(cbNode, (node as TemplateSpan).expression) ||
                    visitNode(cbNode, (node as TemplateSpan).literal)
                );
            case SyntaxKind.TemplateLiteralType:
                return (
                    visitNode(cbNode, (node as TemplateLiteralTypeNode).head) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as TemplateLiteralTypeNode).templateSpans
                    )
                );
            case SyntaxKind.TemplateLiteralTypeSpan:
                return (
                    visitNode(cbNode, (node as TemplateLiteralTypeSpan).type) ||
            ...
            case SyntaxKind.HeritageClause:
                return visitNodes(
                    cbNode,
                    cbNodes,
                    (node as HeritageClause).types
                );
            case SyntaxKind.ExpressionWithTypeArguments:
                return (
                    visitNode(
                        cbNode,
                        (node as ExpressionWithTypeArguments).expression
                    ) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as ExpressionWithTypeArguments).typeArguments
                    )
                );
            case SyntaxKind.ExternalModuleReference:
                return visitNode(
                    cbNode,
                    (node as ExternalModuleReference).expression
                );
            ...
            case SyntaxKind.CommaListExpression:
                return visitNodes(
                    cbNode,
                    cbNodes,
                    (node as CommaListExpression).elements
                );

            case SyntaxKind.JsxElement:
                return (
                    visitNode(cbNode, (node as JsxElement).openingElement) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
            ...
            case SyntaxKind.JsxFragment:
                return (
                    visitNode(cbNode, (node as JsxFragment).openingFragment) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
            ...
            case SyntaxKind.JsxOpeningElement:
                return (
                    visitNode(
                        cbNode,
                        (node as JsxOpeningLikeElement).tagName
                    ) ||
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as JsxOpeningLikeElement).typeArguments
                    ) ||
                    visitNode(
                        cbNode,
                        (node as JsxOpeningLikeElement).attributes
                    )
                );
            ...
            case SyntaxKind.JsxAttribute:
                return (
                    visitNode(cbNode, (node as JsxAttribute).name) ||
                    visitNode(cbNode, (node as JsxAttribute).initializer)
                );
            case SyntaxKind.JsxSpreadAttribute:
                return visitNode(
                    cbNode,
                    (node as JsxSpreadAttribute).expression
                );
            ...
            case SyntaxKind.JSDocFunctionType:
                return (
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as JSDocFunctionType).parameters
                    ) || visitNode(cbNode, (node as JSDocFunctionType).type)
                );
            case SyntaxKind.JSDocComment:
                return (
                    (typeof (node as JSDoc).comment === "string"
                        ? undefined
                        : visitNodes(
                              cbNode,
                              cbNodes,
                              (node as JSDoc).comment as
            ...
            case SyntaxKind.JSDocSeeTag:
                return (
                    visitNode(cbNode, (node as JSDocSeeTag).tagName) ||
            ...
            case SyntaxKind.JSDocMemberName:
                return (
                    visitNode(cbNode, (node as JSDocMemberName).left) ||
            ...
            case SyntaxKind.JSDocPropertyTag:
                return (
                    ...
                    ((node as JSDocPropertyLikeTag).isNameFirst
                        ? visitNode(
                              cbNode,
                              (node as JSDocPropertyLikeTag).name
                          ) ||
                          visitNode(
                              cbNode,
                              (node as JSDocPropertyLikeTag).typeExpression
                          ) ||
                          (typeof (node as JSDoc).comment === "string"
                              ? undefined
                              : visitNodes(
            ...
            case SyntaxKind.JSDocTemplateTag:
                return (
                    ...
                    visitNodes(
                        cbNode,
                        cbNodes,
                        (node as JSDocTemplateTag).typeParameters
                    ) ||
                    (typeof (node as JSDoc).comment === "string"
                        ? undefined
                        : visitNodes(
                ...
                return (
                    ...
                    (node as JSDocTypedefTag).typeExpression!.kind ===
                        ...
                        ? visitNode(
                          ...
                          visitNode(
                              cbNode,
                              (node as JSDocTypedefTag).fullName
                          ) ||
                          (typeof (node as JSDoc).comment === "string"
                              ? undefined
                              : visitNodes(
            ...
            case SyntaxKind.JSDocCallbackTag:
                return (
                    ...
                    visitNode(
                        cbNode,
                        (node as JSDocCallbackTag).typeExpression
                    ) ||
                    (typeof (node as JSDoc).comment === "string"
                        ? undefined
                        : visitNodes(
            ...
            case SyntaxKind.JSDocSignature:
                return (
                    forEach((node as JSDocSignature).typeParameters, cbNode) ||
            ...
            case SyntaxKind.JSDocLinkPlain:
                return visitNode(
                    cbNode,
                    (node as JSDocLink | JSDocLinkCode | JSDocLinkPlain).name
                );
            case SyntaxKind.JSDocTypeLiteral:
                return forEach(
                    (node as JSDocTypeLiteral).jsDocPropertyTags,
                    cbNode
                );
            ...
            case SyntaxKind.PartiallyEmittedExpression:
                return visitNode(
                    cbNode,
                    (node as PartiallyEmittedExpression).expression
                );
        }
    }
    ...
    namespace Parser {
        ...
        function parseConcurrentStatement(diagnosticMessage?: DiagnosticMessage): ConcurrentStatement {
            const pos = getNodePos();
            const hasJSDoc = hasPrecedingJSDocComment();
