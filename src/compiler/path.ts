import { CharacterCodes, stringContains, endsWith, Path, startsWith, equateStringsCaseInsensitive, equateStringsCaseSensitive, lastOrUndefined, some, Comparison, compareStringsCaseInsensitive, compareValues, compareStringsCaseSensitive, getStringComparer, GetCanonicalFileName, Debug, identity } from "./ts";
/* @internal */
/**
