...
namespace ts {
    ...
    export function createPrinter(writer: EmitTextWriter, compilerOptions: CompilerOptions, printerOptions: PrinterOptions = {}): Printer {
        ...
        function resetGeneratedNames() {
            nodeIdToGeneratedName = undefined;
            autoGeneratedIdToGeneratedName = undefined;
            generatedNames = undefined;
            tempFlagsStack = undefined;
            tempFlags = TempFlags.Auto;
        }

        function ensureNameGeneration() {
            if (generatedNames === undefined) {
