...
import {
    ...
    CustomTransformers, Debug, DeprecationPhase, DeprecationPhaseToVersionMap, DeclarationWithTypeParameterChildren, Diagnostic, DiagnosticCategory,
    ...
    VariableStatement, Version, versionMajorMinor, walkUpParenthesizedExpressions, WriteFileCallback, WriteFileCallbackData,
