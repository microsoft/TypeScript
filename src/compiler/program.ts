...
import {
    ...
    writeFileEnsuringDirectories, zipToModeAwareCache, moduleResolutionSupportsResolvingTsExtensions, getResolveJsonModule, moduleResolutionSupportsPackageJsonExportsAndImports,
} from "./_namespaces/ts";
