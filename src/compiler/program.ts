...
import {
    ...
    writeFileEnsuringDirectories, zipToModeAwareCache, moduleResolutionSupportsResolvingTsExtensions, getResolveJsonModule, moduleResolutionSupportsPackageJsonExportsAndImports, TypeReferenceDirectiveResolutionInfo, getResolvedTypeReferenceDirective, ResolutionMode,
} from "./_namespaces/ts";
