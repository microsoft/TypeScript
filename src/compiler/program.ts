...
import {
    __String, addRange, append, arrayFrom, arrayIsEqualTo, AsExpression, AssertClause, BuilderProgram,
    ...
    DiagnosticWithLocation, directorySeparator, DirectoryStructureHost, emitFiles, EmitHost, EmitOnly,
    ...
    writeFileEnsuringDirectories, zipToModeAwareCache, addInternalEmitFlags, InternalEmitFlags, ResolutionMode,
    TypeReferenceDirectiveResolutionInfo, getResolvedTypeReferenceDirective,
} from "./_namespaces/ts";
