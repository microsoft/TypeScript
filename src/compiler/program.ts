...
import {
    getCommonSourceDirectory as _getCommonSourceDirectory,
    emitFiles,
    forEachEmittedFile,
...
import { canHaveModifiers } from "./factory/utilitiesPublic";
import {
...
import {
    getDeclarationDiagnostics as _getDeclarationDiagnostics,
} from "./transformers/declarations";
...
export function createProgram(rootNamesOrOptions: readonly string[] | CreateProgramOptions, _options?: CompilerOptions, _host?: CompilerHost, _oldProgram?: Program, _configFileParsingDiagnostics?: readonly Diagnostic[]): Program {
    ...
    function getCommonSourceDirectory() {
        if (commonSourceDirectory === undefined) {
            ...
            commonSourceDirectory = _getCommonSourceDirectory(
                options,
    ...
    function getDeclarationDiagnosticsForFileNoCache(sourceFile: SourceFile | undefined, cancellationToken: CancellationToken | undefined): readonly DiagnosticWithLocation[] {
        return runWithCancellationToken(() => {
            ...
            return _getDeclarationDiagnostics(getEmitHost(noop), resolver, sourceFile) || emptyArray;
        });
    }
