namespace ts {
    ...
    export function createProgram(rootNamesOrOptions: ReadonlyArray<string> | CreateProgramOptions, _options?: CompilerOptions, _host?: CompilerHost, _oldProgram?: Program, _configFileParsingDiagnostics?: ReadonlyArray<Diagnostic>): Program {
        ...
        program = {
            ...
            getAssignabilityCacheSize: () => getDiagnosticsProducingTypeChecker().getAssignabilityCacheSize(),
            getIdentityCacheSize: () => getDiagnosticsProducingTypeChecker().getIdentityCacheSize(),
            getSubtypeCacheSize: () => getDiagnosticsProducingTypeChecker().getSubtypeCacheSize(),
