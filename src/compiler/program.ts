    ...
    export function createProgram(rootNames: ReadonlyArray<string>, options: CompilerOptions, host?: CompilerHost, oldProgram?: Program): Program {
        ...
        if (structuralIsReused !== StructureIsReused.Completely) {
            ...
            if (!skipDefaultLib) {
                ...
                if (!options.lib) {
                    processRootFile(getDefaultLibraryFileName(), /*isDefaultLib*/ true, /*ignoreNoDefaultLib*/ false);
                }
                else {
        ...
        function processLibReferenceDirectives(file: SourceFile) {
            forEach(file.libReferenceDirectives, libReference => {
                ...
                if (libFileName) {
                    ...
                    const suggestion = getSpellingSuggestion(unqualifiedLibName, libs, /*exclusions*/ undefined, identity);
