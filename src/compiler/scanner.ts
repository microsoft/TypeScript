namespace ts {
    ...
    /** @internal */
    export let textToKeywordObj: () => MapLike<KeywordSyntaxKind> = () => {
        const result: MapLike<KeywordSyntaxKind> = {
        ...
        textToKeywordObj = () => result;
        return result;
    }

    let textToKeyword: () => ESMap<string, KeywordSyntaxKind> = () => {
        const result = new Map(getEntries(textToKeywordObj()));
        // Reassign the function, so we do not have an if statement in this lazy evaluation.
        textToKeyword = () => result;
        return result;
    };

    let textToToken: () => ESMap<string, SyntaxKind> = () => {
        const result = new Map(getEntries({
            ...textToKeywordObj(),
    ...
    */
    ...
    let tokenStrings: () => string[] = () => {
        const result = makeReverseMap(textToToken());
        // Reassign the function, so we do not have an if statement in this lazy evaluation.
        tokenStrings = () => result;
        return result;
    }
