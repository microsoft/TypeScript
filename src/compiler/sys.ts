...
export let sys: System = (() => {
    ...
    function getNodeSystem(): System {
        ...
        const nodeSystem: System = {
            ...
            realpath,
            debugMode: !!process.env.NODE_INSPECTOR_IPC || !!process.env.VSCODE_INSPECTOR_OPTIONS || some(process.execArgv, arg => /^--(inspect|debug)(-brk)?(=\d+)?$/i.test(arg)) || ((process as any).recordreplay && typeof (process as any).recordreplay.currentPointURL === "function"),
