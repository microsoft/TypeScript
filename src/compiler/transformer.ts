import {
    ...
    EmitHelper, EmitHint, EmitHost, EmitResolver, EmitTransformers, emptyArray, factory, FunctionDeclaration,
    ...
    noop, notImplemented, performance, returnUndefined, ScriptTarget, setEmitFlags, some, SourceFile, Statement,
    SyntaxKind, tracing, TransformationContext, TransformationResult, transformClassFields, transformDeclarations,
