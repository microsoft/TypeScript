import {
    ...
    AssignmentPattern, AutoAccessorPropertyDeclaration, BinaryExpression, CallExpression,
    ...
    GeneratedIdentifierFlags, GeneratedNamePart, GetAccessorDeclaration, getCommentRange,
    getEffectiveBaseTypeNode, getEmitFlags, getEmitScriptTarget, getNameOfDeclaration,
    getNonAssignmentOperatorForCompoundAssignment, getOriginalNode,
    getOriginalNodeId, getProperties, getSourceMapRange, getStaticPropertiesAndClassStaticBlock,
    getUseDefineForClassFields, hasAbstractModifier, hasAccessorModifier,
    ...
    isNonStaticMethodOrAccessorWithPrivateName, isObjectLiteralElementLike,
    ...
    TransformationContext, TransformFlags, tryGetTextOfPropertyName, unescapeLeadingUnderscores,
...
export function transformClassFields(context: TransformationContext): (x: SourceFile | Bundle) => SourceFile | Bundle {
    ...
    function visitPropertyDeclaration(node: PropertyDeclaration) {
        ...
        if (isAutoAccessorPropertyDeclaration(node) && (shouldTransformAutoAccessors ||
