import {
    ...
    InterfaceDeclaration, isAnyImportSyntax, isArray, isArrayBindingElement, isBindingElement, isBindingPattern, isClassDeclaration, isClassElement, isDeclaration, isEntityName,
    isEntityNameExpression, isExportAssignment, isExportDeclaration, isExpressionWithTypeArguments, isExternalModule, isExternalModuleAugmentation,
    ...
    isTypeElement,
    isTypeNode, isTypeParameterDeclaration, isTypeQueryNode, isUnparsedSource, isVariableDeclaration, last, LateBoundDeclaration,
