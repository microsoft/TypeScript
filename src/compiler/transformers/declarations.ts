...
export function transformDeclarations(context: TransformationContext) {
    ...
    let necessaryTypeReferences: Set<[specifier: string, mode: ResolutionMode | undefined]> | undefined;
    ...
    function recordTypeReferenceDirectivesIfNecessary(typeReferenceDirectives: readonly [specifier: string, mode: ResolutionMode | undefined][] | undefined): void {
    ...
    function transformRoot(node: SourceFile | Bundle) {
        ...
        function getFileReferenceForSpecifierModeTuple([typeName, mode]: [specifier: string, mode: ResolutionMode | undefined]): FileReference | undefined {
