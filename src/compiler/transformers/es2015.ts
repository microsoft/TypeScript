                ...
                setTextRange(
                    factory.createNodeArray(
                        [
                            ...existingPrologue,
                            ...prologue,
                            ...(superStatementIndex <= existingPrologue.length ? [] : visitNodes(constructor.body.statements, visitor, isStatement, existingPrologue.length, superStatementIndex - existingPrologue.length)),
                            ...statements
                        ]
                    ),
