...
export function transformES2015(context: TransformationContext) {
    ...
    function visitReturnStatement(node: ReturnStatement): Statement {
        if (convertedLoopState) {
            ...
            return createReturn(createObjectLiteral([
                createPropertyAssignment(createIdentifier("value"), node.expression
    ...
    function visitClassDeclaration(node: ClassDeclaration): VisitResult<Statement> {
        ...
        //          return C;
        //      }());
        const variable = createVariableDeclaration(getLocalName(node, /*allowComments*/ true), 
    ...
    function transformClassLikeDeclarationToExpression(node: ClassExpression | ClassDeclaration): Expression {
        ...
        /*name*/ undefined, 
        /*typeParameters*/ undefined, extendsClauseElement ? [createParameter(/*decorators*/ undefined, /*modifiers*/ undefined, /*dotDotDotToken*/ undefined, createFileLevelUniqueName("_super"))] : [], 
        ...
        const result = createParen(createCall(outer, 
    ...
    function addExtendsHelperIfNeeded(statements: Statement[], node: ClassExpression | ClassDeclaration, extendsClauseElement: ExpressionWithTypeArguments | undefined): void {
        if (extendsClauseElement) {
            statements.push(setTextRange(createExpressionStatement(createExtendsHelper(context, getInternalName(node))), 
    ...
    function addConstructor(statements: Statement[], node: ClassExpression | ClassDeclaration, extendsClauseElement: ExpressionWithTypeArguments | undefined): void {
        ...
        /*modifiers*/ undefined, 
        /*asteriskToken*/ undefined, getInternalName(node), 
     ...
     *                            synthesized `super` call.
     */
    function transformConstructorBody(constructor: (ConstructorDeclaration & {
        body: FunctionBody;
    }) | undefined, node: ClassDeclaration | ClassExpression, extendsClauseElement: ExpressionWithTypeArguments | undefined, hasSynthesizedSuper: boolean) {
        ...
        if (!hasSynthesizedSuper)
            statementOffset = addStandardPrologue(prologue, constructor.body.statements, /*ensureUseStrict*/ false);
        ...
        const block = createBlock(setTextRange(createNodeArray(concatenate(prologue, statements)), 
    ...
    function visitParameter(node: ParameterDeclaration): ParameterDeclaration | undefined {
        if (node.dotDotDotToken) {
            ...
            return setOriginalNode(setTextRange(createParameter(
            /*decorators*/ undefined, 
            /*modifiers*/ undefined, 
            /*dotDotDotToken*/ undefined, getGeneratedNameForNode(node), 
    ...
    function insertDefaultValueAssignmentForBindingPattern(statements: Statement[], parameter: ParameterDeclaration, name: BindingPattern, initializer: Expression | undefined): boolean {
        ...
        if (name.elements.length > 0) {
            insertStatementAfterCustomPrologue(statements, setEmitFlags(createVariableStatement(
            /*modifiers*/ undefined, createVariableDeclarationList(flattenDestructuringBinding(parameter, visitor, context, FlattenLevel.All, getGeneratedNameForNode(parameter)))), EmitFlags.CustomPrologue));
            return true;
        }
        else if (initializer) {
    ...
    function insertDefaultValueAssignmentForInitializer(statements: Statement[], parameter: ParameterDeclaration, name: Identifier, initializer: Expression): void {
        ...
        const statement = createIf(createTypeCheck(getSynthesizedClone(name), "undefined"), setEmitFlags(setTextRange(createBlock([
            createExpressionStatement(setEmitFlags(setTextRange(createAssignment(setEmitFlags(getMutableClone(name), EmitFlags.NoSourceMap), setEmitFlags(initializer, EmitFlags.NoSourceMap | getEmitFlags(initializer) | EmitFlags.NoComments)), parameter), EmitFlags.NoComments))
    ...
    function addRestParameterIfNeeded(statements: Statement[], node: FunctionLikeDeclaration, inConstructorWithSynthesizedSuper: boolean): boolean {
        ...
        // var param = [];
        prologueStatements.push(setEmitFlags(setTextRange(createVariableStatement(
        ...
        // }
        const forStatement = createFor(setTextRange(createVariableDeclarationList([
            createVariableDeclaration(temp, /*type*/ undefined, createLiteral(restIndex))
        ]), parameter), setTextRange(createLessThan(temp, createPropertyAccess(createIdentifier("arguments"), "length")), parameter), setTextRange(createPostfixIncrement(temp), parameter), createBlock([
            startOnNewLine(setTextRange(createExpressionStatement(createAssignment(createElementAccess(expressionName, restIndex === 0
                ? temp
                : createSubtract(temp, createLiteral(restIndex))), createElementAccess(createIdentifier("arguments"), temp))), 
            /*location*/ parameter))
        ]));
        ...
        if (parameter.name.kind !== SyntaxKind.Identifier) {
            ...
            prologueStatements.push(setEmitFlags(setTextRange(createVariableStatement(
            /*modifiers*/ undefined, createVariableDeclarationList(flattenDestructuringBinding(parameter, visitor, context, FlattenLevel.All, expressionName))), parameter), EmitFlags.CustomPrologue));
        }
    ...
    function insertCaptureThisForNode(statements: Statement[], node: Node, initializer: Expression | undefined): void {
        ...
        /*modifiers*/ undefined, createVariableDeclarationList([
            createVariableDeclaration(createFileLevelUniqueName("_this"), 
        ...
        if (hierarchyFacts & HierarchyFacts.NewTarget) {
            ...
            switch (node.kind) {
                ...
                case SyntaxKind.FunctionExpression:
                    ...
                    newTarget = createConditional(createLogicalAnd(setEmitFlags(createThis(), EmitFlags.NoSubstitution), createBinary(setEmitFlags(createThis(), EmitFlags.NoSubstitution), SyntaxKind.InstanceOfKeyword, getLocalName(node))), createPropertyAccess(setEmitFlags(createThis(), EmitFlags.NoSubstitution), "constructor"), createVoidZero());
                    break;
                default:
            ...
            /*modifiers*/ undefined, createVariableDeclarationList([
                createVariableDeclaration(createFileLevelUniqueName("_newTarget"), 
    ...
    function transformAccessorsToExpression(receiver: LeftHandSideExpression, { firstAccessor, getAccessor, setAccessor }: AllAccessorDeclarations, container: Node, startsOnNewLine: boolean): Expression {
        ...
        const call = createCall(createPropertyAccess(createIdentifier("Object"), "defineProperty"), 
    ...
    function visitFunctionDeclaration(node: FunctionDeclaration): FunctionDeclaration {
        ...
        /*decorators*/ undefined, visitNodes(node.modifiers, visitor, isModifier), node.asteriskToken, name, 
        /*typeParameters*/ undefined, parameters, 
        /*type*/ undefined, body);
    }
    /**
    ...
    function transformFunctionLikeToExpression(node: FunctionLikeDeclaration, location: TextRange | undefined, name: Identifier | undefined, container: Node | undefined): FunctionExpression {
        ...
        exitSubtree(ancestorFacts, HierarchyFacts.FunctionSubtreeExcludes, HierarchyFacts.None);
        convertedLoopState = savedConvertedLoopState;
        return setOriginalNode(setTextRange(createFunctionExpression(
        /*modifiers*/ undefined, node.asteriskToken, name, 
        /*typeParameters*/ undefined, parameters, 
    ...
    function convertForOfStatementHead(node: ForOfStatement, boundValue: Expression, convertedLoopBodyStatements: Statement[]) {
        ...
        if (isVariableDeclarationList(initializer)) {
            ...
            if (firstOriginalDeclaration && isBindingPattern(firstOriginalDeclaration.name)) {
                ...
                statements.push(setTextRange(createVariableStatement(
                /*modifiers*/ undefined, setOriginalNode(setTextRange(createVariableDeclarationList([
    ...
    function createSyntheticBlockForConvertedStatements(statements: Statement[]) {
        return setEmitFlags(createBlock(createNodeArray(statements), 
    ...
    function convertForOfStatementForArray(node: ForOfStatement, outermostLabeledStatement: LabeledStatement, convertedLoopBodyStatements: Statement[]): Statement {
        ...
        const forStatement = setTextRange(createFor(
    ...
    function convertForOfStatementForIterable(node: ForOfStatement, outermostLabeledStatement: LabeledStatement, convertedLoopBodyStatements: Statement[], ancestorFacts: HierarchyFacts): Statement {
        ...
        const initializer = ancestorFacts & HierarchyFacts.IterationContainer
            ...
            : values;
        const forStatement = setEmitFlags(setTextRange(createFor(
        /*initializer*/ setEmitFlags(setTextRange(createVariableDeclarationList([
        ...
        return createTry(createBlock([
            restoreEnclosingLabel(forStatement, outermostLabeledStatement, convertedLoopState && resetLabel)
        ]), createCatchClause(createVariableDeclaration(catchVariable), setEmitFlags(createBlock([
            createExpressionStatement(createAssignment(errorRecord, createObjectLiteral([
                createPropertyAssignment("error", catchVariable)
            ])))
        ]), EmitFlags.SingleLine)), createBlock([
            createTry(
            /*tryBlock*/ createBlock([
                setEmitFlags(createIf(createLogicalAnd(createLogicalAnd(result, createLogicalNot(createPropertyAccess(result, "done"))), createAssignment(returnMethod, createPropertyAccess(iterator, "return"))), createExpressionStatement(createFunctionCall(returnMethod, iterator, []))), EmitFlags.SingleLine),
            ]), 
            /*catchClause*/ undefined, 
            /*finallyBlock*/ setEmitFlags(createBlock([
                setEmitFlags(createIf(errorRecord, createThrow(createPropertyAccess(errorRecord, "error"))), EmitFlags.SingleLine)
    ...
    function convertForOfStatement(node: ForOfStatement, convertedLoopBody: Statement) {
        ...
        /*awaitModifier*/ undefined, visitNode(node.initializer, visitor, isForInitializer), visitNode(node.expression, visitor, isExpression), convertedLoopBody);
    }
    ...
    function addExtraDeclarationsForConvertedLoop(statements: Statement[], state: ConvertedLoopState, outerState: ConvertedLoopState | undefined) {
        ...
        if (state.argumentsName) {
            ...
            if (outerState) {
                ...
                (extraVariableDeclarations || (extraVariableDeclarations = [])).push(createVariableDeclaration(state.argumentsName, 
                /*type*/ undefined, createIdentifier("arguments")));
            }
        }
        if (state.thisName) {
            ...
            if (outerState) {
                ...
                (extraVariableDeclarations || (extraVariableDeclarations = [])).push(createVariableDeclaration(state.thisName, 
                /*type*/ undefined, createIdentifier("this")));
            }
        }
        if (state.hoistedLocalVariables) {
        ...
        if (extraVariableDeclarations) {
            statements.push(createVariableStatement(
            /*modifiers*/ undefined, createVariableDeclarationList(extraVariableDeclarations)));
        }
    }
    ...
    function createFunctionForInitializerOfForStatement(node: ForStatementWithConvertibleInitializer, currentState: ConvertedLoopState): IterationStatementPartFunction<VariableDeclarationList> {
        ...
        /*modifiers*/ undefined, setEmitFlags(createVariableDeclarationList([
            createVariableDeclaration(functionName, 
            /*type*/ undefined, setEmitFlags(createFunctionExpression(
            /*modifiers*/ undefined, containsYield ? createToken(SyntaxKind.AsteriskToken) : undefined, 
            /*name*/ undefined, 
            /*typeParameters*/ undefined, 
            /*parameters*/ undefined, 
            /*type*/ undefined, visitNode(createBlock(statements, /*multiLine*/ true), visitor, isBlock)), emitFlags))
    ...
    function generateCallToConvertedLoopInitializer(initFunctionExpressionName: Identifier, containsYield: boolean): Statement {
        ...
        const callResult = containsYield
            ? createYield(createToken(SyntaxKind.AsteriskToken), setEmitFlags(call, EmitFlags.Iterator))
            : call;
    ...
    function generateCallToConvertedLoop(loopFunctionExpressionName: Identifier, state: ConvertedLoopState, outerState: ConvertedLoopState | undefined, containsYield: boolean): Statement[] {
        ...
        if (isSimpleLoop) {
            ...
            /*modifiers*/ undefined, createVariableDeclarationList([createVariableDeclaration(loopResultName, /*type*/ undefined, callResult)]));
    ...
    function processLabeledJumps(table: ts.Map<string>, isBreak: boolean, loopResultName: Identifier, outerLoop: ConvertedLoopState | undefined, caseClauses: CaseClause[]): void {
        if (!table) {
            return;
        }
    ...
    function visitMethodDeclaration(node: MethodDeclaration): ObjectLiteralElementLike {
        ...
        return setTextRange(createPropertyAssignment(node.name, functionExpression), 
        /*location*/ node);
    }
    /**
    ...
    function visitShorthandPropertyAssignment(node: ShorthandPropertyAssignment): ObjectLiteralElementLike {
        return setTextRange(createPropertyAssignment(node.name, getSynthesizedClone(node.name)), 
        /*location*/ node);
    }
    ...
    function visitCallExpression(node: CallExpression) {
        ...
        return updateCall(node, visitNode(node.expression, callExpressionVisitor, isExpression), 
    ...
    function visitTypeScriptClassWrapper(node: CallExpression) {
        ...
        return recreateOuterExpressions(node.expression, recreateOuterExpressions(variable.initializer, recreateOuterExpressions(aliasAssignment && aliasAssignment.right, updateCall(call, recreateOuterExpressions(call.expression, updateFunctionExpression(func, 
        /*modifiers*/ undefined, 
        /*asteriskToken*/ undefined, 
        /*name*/ undefined, 
        /*typeParameters*/ undefined, func.parameters, 
        /*type*/ undefined, updateBlock(func.body, statements))), 
    ...
    function visitCallExpressionWithPotentialCapturedThisAssignment(node: CallExpression, assignToCapturedThis: boolean): CallExpression | BinaryExpression {
        ...
        if (node.transformFlags & TransformFlags.ContainsRestOrSpread ||
            ...
            if (node.transformFlags & TransformFlags.ContainsRestOrSpread) {
                ...
                resultingCall = createFunctionApply(visitNode(target, callExpressionVisitor, isExpression), node.expression.kind === SyntaxKind.SuperKeyword ? thisArg : visitNode(thisArg, visitor, isExpression), transformAndSpreadElements(node.arguments, /*needsUniqueCopy*/ false, /*multiLine*/ false, /*hasTrailingComma*/ false));
            }
            else {
                // [source]
                //      super(a)
                ...
                resultingCall = createFunctionCall(visitNode(target, callExpressionVisitor, isExpression), node.expression.kind === SyntaxKind.SuperKeyword ? thisArg : visitNode(thisArg, visitor, isExpression), visitNodes(node.arguments, visitor, isExpression), 
                /*location*/ node);
            }
            if (node.expression.kind === SyntaxKind.SuperKeyword) {
    ...
    function visitNewExpression(node: NewExpression): LeftHandSideExpression {
        if (some(node.arguments, isSpreadElement)) {
            ...
            return createNew(createFunctionApply(visitNode(target, visitor, isExpression), thisArg, transformAndSpreadElements(createNodeArray([createVoidZero(), ...node.arguments!]), /*needsUniqueCopy*/ false, /*multiLine*/ false, /*hasTrailingComma*/ false)), 
            /*typeArguments*/ undefined, []);
        }
        return visitEachChild(node, visitor, context);
    }
    ...
    function onEmitNode(hint: EmitHint, node: Node, emitCallback: (hint: EmitHint, node: Node) => void) {
        if (enabledSubstitutions & ES2015SubstitutionFlags.CapturedThis && isFunctionLike(node)) {
            ...
            const ancestorFacts = enterSubtree(HierarchyFacts.FunctionExcludes, getEmitFlags(node) & EmitFlags.CapturesThis
...
function createExtendsHelper(context: TransformationContext, name: Identifier) {
    ...
    return createCall(getUnscopedHelperName("__extends"), 
    /*typeArguments*/ undefined, [
        name,
        createFileLevelUniqueName("_super")
    ]);
