import { TransformationContext, chainBundle, SourceFile, visitEachChild, Node, VisitResult, TransformFlags, SyntaxKind, BinaryExpression, Expression, visitNode, isExpression, isElementAccessExpression, createTempVariable, setTextRange, createElementAccess, createAssignment, isPropertyAccessExpression, createPropertyAccess, createMathPow } from "../ts";
/*@internal*/
