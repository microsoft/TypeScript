import {
    ...
    isEffectiveStrictModeSourceFile, isEntityName, isExpression, isForInitializer, isFunctionLike, isIdentifier,
    isModifierLike, isNodeWithPossibleHoistedDeclaration, isOmittedExpression, isPropertyAccessExpression, isStatement,
    isSuperProperty, isToken, isVariableDeclarationList, LeftHandSideExpression, map, MethodDeclaration, Node,
    NodeCheckFlags, NodeFactory, NodeFlags, ParameterDeclaration, PropertyAccessExpression, PropertyAssignment,
    ScriptTarget, Set, SetAccessorDeclaration, setEmitFlags, setOriginalNode, setSourceMapRange, setTextRange, some,
    SourceFile, Statement, SyntaxKind, TextRange, TransformationContext, TransformFlags, TypeNode,
