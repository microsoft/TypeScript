import { TransformationContext, getEmitScriptTarget, FunctionFlags, NodeCheckFlags, SourceFile, VariableDeclaration, UnderscoreEscapedMap, chainBundle, Identifier, append, createVariableDeclaration, addEmitHelpers, Node, VisitResult, SyntaxKind, visitEachChild, TransformFlags, AwaitExpression, YieldExpression, ReturnStatement, LabeledStatement, ObjectLiteralExpression, BinaryExpression, CatchClause, VariableStatement, ForOfStatement, ForStatement, VoidExpression, ConstructorDeclaration, MethodDeclaration, GetAccessorDeclaration, SetAccessorDeclaration, FunctionDeclaration, FunctionExpression, ArrowFunction, ParameterDeclaration, ExpressionStatement, ParenthesizedExpression, TaggedTemplateExpression, isPropertyAccessExpression, ElementAccessExpression, Expression, setOriginalNode, setTextRange, createYield, visitNode, isExpression, updateYield, createVoidZero, updateReturn, unwrapInnermostStatementOfLabel, restoreEnclosingLabel, ObjectLiteralElementLike, createObjectLiteral, createPropertyAssignment, isObjectLiteralElementLike, isEffectiveStrictModeSourceFile, concatenate, createVariableStatement, createVariableDeclarationList, updateSourceFileNode, createNodeArray, processTaggedTemplateExpression, ProcessLevel, isDestructuringAssignment, flattenDestructuringAssignment, FlattenLevel, updateBinary, isBindingPattern, getGeneratedNameForNode, updateVariableDeclaration, flattenDestructuringBinding, isBlock, some, updateBlock, updateCatchClause, hasModifier, ModifierFlags, Statement, updateFor, isForInitializer, isStatement, skipParentheses, ForInitializer, isVariableDeclarationList, isAssignmentPattern, TextRange, createTempVariable, createForOfBindingStatement, addRange, updateForOf, NodeFlags, createBlock, setEmitFlags, EmitFlags, createAwait, isIdentifier, createUniqueName, createCall, createPropertyAccess, createFunctionCall, createFor, createComma, createAssignment, createLogicalNot, createTry, createCatchClause, createExpressionStatement, createIf, createLogicalAnd, createThrow, updateParameter, updateConstructor, visitParameterList, updateGetAccessor, isPropertyName, updateSetAccessor, getFunctionFlags, updateMethod, visitNodes, isModifier, Token, isToken, updateFunctionDeclaration, updateArrowFunction, updateFunctionExpression, AccessorDeclaration, FunctionBody, addPrologue, createUnderscoreEscapedMap, createReturn, createFunctionExpression, createToken, visitLexicalEnvironment, ScriptTarget, createSuperAccessVariableStatement, getNodeId, insertStatementsAfterStandardPrologue, addEmitHelper, advancedAsyncSuperHelper, asyncSuperHelper, ConciseBody, FunctionLikeDeclaration, isConciseBody, convertToFunctionBody, EmitHint, PropertyAccessExpression, CallExpression, createFileLevelUniqueName, isSuperProperty, createThis, LeftHandSideExpression, createIdentifier, UnscopedEmitHelper, getUnscopedHelperName, EmitNode } from "../ts";
/*@internal*/
...
export function transformES2018(context: TransformationContext) {
    ...
    function visitAwaitExpression(node: AwaitExpression): Expression {
        if (enclosingFunctionFlags & FunctionFlags.Async && enclosingFunctionFlags & FunctionFlags.Generator) {
            return setOriginalNode(setTextRange(createYield(createAwaitHelper(context, visitNode(node.expression, visitor, isExpression))), 
            /*location*/ node), node);
        }
        return visitEachChild(node, visitor, context);
    }
    function visitYieldExpression(node: YieldExpression) {
        if (enclosingFunctionFlags & FunctionFlags.Async && enclosingFunctionFlags & FunctionFlags.Generator) {
            ...
            return setOriginalNode(setTextRange(createYield(createDownlevelAwait(node.expression
                ? visitNode(node.expression, visitor, isExpression)
                : createVoidZero())), node), node);
        }
        return visitEachChild(node, visitor, context);
    }
    ...
    function transformForOfStatementWithObjectRest(node: ForOfStatement) {
        ...
        if (isVariableDeclarationList(initializerWithoutParens) || isAssignmentPattern(initializerWithoutParens)) {
            ...
            return updateForOf(node, node.awaitModifier, setTextRange(createVariableDeclarationList([
                setTextRange(createVariableDeclaration(temp), node.initializer)
            ], NodeFlags.Let), node.initializer), node.expression, setTextRange(createBlock(setTextRange(createNodeArray(statements), statementsLocation), 
    ...
    function convertForOfStatementHead(node: ForOfStatement, boundValue: Expression) {
        ...
        return setEmitFlags(setTextRange(createBlock(setTextRange(createNodeArray(statements), statementsLocation), 
        /*multiLine*/ true), bodyLocation), EmitFlags.NoSourceMap | EmitFlags.NoTokenSourceMaps);
    }
    ...
    function transformForAwaitOfStatement(node: ForOfStatement, outermostLabeledStatement: LabeledStatement | undefined) {
        ...
        return createTry(createBlock([
            restoreEnclosingLabel(forStatement, outermostLabeledStatement)
            ...
            /*tryBlock*/ createBlock([
                setEmitFlags(createIf(createLogicalAnd(createLogicalAnd(result, createLogicalNot(getDone)), createAssignment(returnMethod, createPropertyAccess(iterator, "return"))), createExpressionStatement(createDownlevelAwait(callReturn))), EmitFlags.SingleLine)
            ]), 
    ...
    function visitParameter(node: ParameterDeclaration): ParameterDeclaration {
        if (node.transformFlags & TransformFlags.ContainsObjectRestOrSpread) {
            ...
            /*modifiers*/ undefined, node.dotDotDotToken, getGeneratedNameForNode(node), 
    ...
    function visitConstructorDeclaration(node: ConstructorDeclaration) {
        ...
        const updated = updateConstructor(node, 
        /*decorators*/ undefined, node.modifiers, visitParameterList(node.parameters, visitor, context), transformFunctionBody(node));
    ...
    function visitGetAccessorDeclaration(node: GetAccessorDeclaration) {
        ...
        /*decorators*/ undefined, node.modifiers, visitNode(node.name, visitor, isPropertyName), visitParameterList(node.parameters, visitor, context), 
    ...
    function visitSetAccessorDeclaration(node: SetAccessorDeclaration) {
        ...
        /*decorators*/ undefined, node.modifiers, visitNode(node.name, visitor, isPropertyName), visitParameterList(node.parameters, visitor, context), transformFunctionBody(node));
        enclosingFunctionFlags = savedEnclosingFunctionFlags;
        return updated;
    }
    function visitMethodDeclaration(node: MethodDeclaration) {
        ...
        /*decorators*/ undefined, enclosingFunctionFlags & FunctionFlags.Generator
            ? visitNodes(node.modifiers, visitorNoAsyncModifier, isModifier)
            : node.modifiers, enclosingFunctionFlags & FunctionFlags.Async
            ? undefined
            : node.asteriskToken, visitNode(node.name, visitor, isPropertyName), visitNode<Token<SyntaxKind.QuestionToken>>(/*questionToken*/ undefined, visitor, isToken), 
    ...
    function visitArrowFunction(node: ArrowFunction) {
        const savedEnclosingFunctionFlags = enclosingFunctionFlags;
        enclosingFunctionFlags = getFunctionFlags(node);
        const updated = updateArrowFunction(node, node.modifiers, 
        /*typeParameters*/ undefined, visitParameterList(node.parameters, visitor, context), 
    ...
    function visitFunctionExpression(node: FunctionExpression) {
        const savedEnclosingFunctionFlags = enclosingFunctionFlags;
        enclosingFunctionFlags = getFunctionFlags(node);
        const updated = updateFunctionExpression(node, enclosingFunctionFlags & FunctionFlags.Generator
            ? visitNodes(node.modifiers, visitorNoAsyncModifier, isModifier)
            : node.modifiers, enclosingFunctionFlags & FunctionFlags.Async
            ? undefined
            : node.asteriskToken, node.name, 
    ...
    function transformAsyncGeneratorFunctionBody(node: MethodDeclaration | AccessorDeclaration | FunctionDeclaration | FunctionExpression): FunctionBody {
        ...
        const returnStatement = createReturn(createAsyncGeneratorHelper(context, createFunctionExpression(
        /*modifiers*/ undefined, createToken(SyntaxKind.AsteriskToken), node.name && getGeneratedNameForNode(node.name), 
        /*typeParameters*/ undefined, 
        /*parameters*/ [], 
        /*type*/ undefined, updateBlock((node.body!), visitLexicalEnvironment(node.body!.statements, visitor, context, statementOffset))), hasLexicalThis));
    ...
    function appendObjectRestAssignmentsIfNeeded(statements: Statement[] | undefined, node: FunctionLikeDeclaration): Statement[] | undefined {
        for (const parameter of node.parameters) {
            if (parameter.transformFlags & TransformFlags.ContainsObjectRestOrSpread) {
                ...
                const declarations = flattenDestructuringBinding(parameter, visitor, context, FlattenLevel.ObjectRest, temp, 
                /*doNotRecordTempVariablesInLine*/ false, 
                /*skipInitializer*/ true);
                if (some(declarations)) {
                    const statement = createVariableStatement(
                    /*modifiers*/ undefined, createVariableDeclarationList(declarations));
    ...
    function createSuperElementAccessInAsyncMethod(argumentExpression: Expression, location: TextRange): LeftHandSideExpression {
        if (enclosingSuperContainerFlags & NodeCheckFlags.AsyncMethodWithSuperBinding) {
            return setTextRange(createPropertyAccess(createCall(createIdentifier("_superIndex"), 
            /*typeArguments*/ undefined, [argumentExpression]), "value"), location);
        }
        else {
            return setTextRange(createCall(createIdentifier("_superIndex"), 
...
export function createAssignHelper(context: TransformationContext, attributesSegments: Expression[]) {
    ...
    return createCall(getUnscopedHelperName("__assign"), 
...
function createAsyncGeneratorHelper(context: TransformationContext, generatorFunc: FunctionExpression, hasLexicalThis: boolean) {
    ...
    return createCall(getUnscopedHelperName("__asyncGenerator"), 
    /*typeArguments*/ undefined, [
...
function createAsyncDelegatorHelper(context: TransformationContext, expression: Expression, location?: TextRange) {
    ...
    return setTextRange(createCall(getUnscopedHelperName("__asyncDelegator"), 
...
function createAsyncValuesHelper(context: TransformationContext, expression: Expression, location?: TextRange) {
    ...
    return setTextRange(createCall(getUnscopedHelperName("__asyncValues"), 
    /*typeArguments*/ undefined, [expression]), location);
}
