import {
    ...
    isPropertyAccessExpression, isPropertyName, isStatement, isSuperProperty, isVariableDeclarationList,
    ...
    TransformationContext, TransformFlags, unwrapInnermostStatementOfLabel, VariableDeclaration,
    VariableStatement, visitEachChild, visitIterationBody, visitLexicalEnvironment, visitNode, visitNodes,
    visitParameterList, VisitResult, VoidExpression, YieldExpression, Bundle, isQuestionToken,
} from "../_namespaces/ts";
