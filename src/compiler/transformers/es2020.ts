import { TransformationContext, chainBundle, SourceFile, visitEachChild, Node, VisitResult, TransformFlags, SyntaxKind, NodeFlags, OptionalChain, Debug, isSyntheticReference, BinaryExpression, DeleteExpression, isTaggedTemplateExpression, cast, isOptionalChain, ParenthesizedExpression, Expression, createSyntheticReferenceExpression, updateParen, AccessExpression, visitNode, isExpression, createTempVariable, createAssignment, updatePropertyAccess, isIdentifier, updateElementAccess, CallExpression, isCallChain, createPropertyAccess, createElementAccess, createFunctionCall, createThis, visitNodes, createCall, setOriginalNode, createConditional, createTrue, createDelete, createVoidZero, createBinary, createToken, createNull, skipParentheses, updateDelete } from "../ts";
/*@internal*/
            ...
            switch (segment.kind) {
                ...
                case SyntaxKind.CallExpression:
                    if (i === 0 && leftThisArg) {
                        ...
                        rightExpression = createCall(rightExpression, 
