import { TransformationContext, EmitHint, Node, JsxEmit, SyntaxKind, chainBundle, SourceFile, JsxOpeningElement, JsxClosingElement, JsxSelfClosingElement, getOriginalNodeId, isPropertyAccessExpression, isPropertyAssignment, PropertyAccessExpression, Expression, isPrivateIdentifier, setTextRange, createElementAccess, PropertyAssignment, isIdentifier, updatePropertyAssignment, Identifier, nodeIsSynthesized, stringToToken, idText, createLiteral } from "../ts";
/*@internal*/
/**
