import {
    ...
    getHeritageClause, getNonAssignmentOperatorForCompoundAssignment, getOrCreateEmitNode, getOriginalNode,
    getSourceMapRange, hasAccessorModifier, hasDecorators, hasStaticModifier, hasSyntacticModifier, HeritageClause,
    Identifier, idText, InternalEmitFlags, isAmbientPropertyDeclaration, isArrayLiteralExpression, isArrowFunction,
    isAssignmentExpression, isAutoAccessorPropertyDeclaration, isBindingName, isBlock, isClassElement,
    isClassExpression, isClassLike, isClassStaticBlockDeclaration, isCompoundAssignment, isComputedPropertyName,
    ...
    PrivateIdentifierMethodDeclaration, PrivateIdentifierPropertyDeclaration, PrivateIdentifierSetAccessorDeclaration,
    PropertyAccessExpression, PropertyAssignment, PropertyDeclaration, PropertyName, ScriptTarget,
    SetAccessorDeclaration, setCommentRange, setEmitFlags, setInternalEmitFlags, setOriginalNode, setSourceMapRange,
    setTextRange, ShorthandPropertyAssignment, skipOuterExpressions, skipParentheses, some, SourceFile,
    SpreadAssignment, SpreadElement, Statement, SyntaxKind, TaggedTemplateExpression, ThisExpression,
    TransformationContext, TransformFlags, tryCast, VariableDeclaration, visitCommaListElements, visitEachChild,
    visitIterationBody, visitNode, visitNodes, Visitor, VisitResult
} from "../_namespaces/ts";
