import { TransformationContext, SourceFile, chainBundle, visitEachChild, addEmitHelpers, Node, VisitResult, TransformFlags, SyntaxKind, JsxElement, JsxSelfClosingElement, JsxFragment, JsxExpression, JsxChild, Expression, Debug, JsxOpeningLikeElement, TextRange, createNull, flatten, ObjectLiteralExpression, spanMap, isJsxSpreadAttribute, map, createObjectLiteral, singleOrUndefined, createAssignHelper, createExpressionForJsxElement, mapDefined, startOnNewLine, JsxOpeningFragment, createExpressionForJsxFragment, JsxSpreadAttribute, visitNode, isExpression, JsxAttribute, createPropertyAssignment, StringLiteral, createTrue, createLiteral, isStringDoubleQuoted, setTextRange, JsxText, isLineBreak, isWhiteSpaceSingleLine, utf16EncodeAsString, isIdentifier, isIntrinsicJsxName, idText, createExpressionFromEntityName, Identifier, createMapFromTemplate } from "../ts";
/*@internal*/
export function transformJsx(context: TransformationContext) {
    ...
    function visitJsxOpeningLikeElement(node: JsxOpeningLikeElement, children: readonly JsxChild[] | undefined, isChild: boolean, location: TextRange) {
        ...
        const element = createExpressionForJsxElement(context.getEmitResolver().getJsxFactoryEntity(currentSourceFile), (compilerOptions.reactNamespace!), // TODO: GH#18217
        tagName, objectProperties, mapDefined(children, transformJsxChildToExpression), node, location);
        if (isChild) {
    ...
    function visitJsxOpeningFragment(node: JsxOpeningFragment, children: readonly JsxChild[], isChild: boolean, location: TextRange) {
        const element = createExpressionForJsxFragment(context.getEmitResolver().getJsxFactoryEntity(currentSourceFile), (compilerOptions.reactNamespace!), // TODO: GH#18217
