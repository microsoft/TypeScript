import { TransformationContext, SyntaxKind, Identifier, chainBundle, SourceFile, isExternalModule, createExternalHelpersImportDeclarationIfNeeded, Statement, addPrologue, append, addRange, visitNodes, isStatement, updateSourceFileNode, setTextRange, createNodeArray, visitEachChild, Node, VisitResult, ExportAssignment, ExportDeclaration, ModuleKind, isNamespaceExport, getGeneratedNameForNode, createImportDeclaration, createImportClause, createNamespaceImport, setOriginalNode, createExportDeclaration, createNamedExports, createExportSpecifier, EmitHint, isSourceFile, createMap, isIdentifier, getEmitFlags, EmitFlags, Expression, idText, createFileLevelUniqueName } from "../../ts";
...
export function transformECMAScriptModule(context: TransformationContext) {
    ...
    let helperNameSubstitutions: ts.Map<Identifier> | undefined;
    ...
    function visitExportDeclaration(node: ExportDeclaration) {
        ...
        /*modifiers*/ undefined, createImportClause(/*name*/ undefined, createNamespaceImport(synthName)), node.moduleSpecifier);
        setOriginalNode(importDecl, node.exportClause);
        const exportDecl = createExportDeclaration(
        /*decorators*/ undefined, 
        /*modifiers*/ undefined, createNamedExports([createExportSpecifier(synthName, oldIdentifier)]));
