    ...
    export function transformModule(context: TransformationContext) {
                                ...
                                [
                                    ...
                                    jsonSourceFile ?
                                        ...
                                        factory.createFunctionExpression(
                                            ...
                                            [
                                                factory.createParameterDeclaration(/*decorators*/ RESERVED, /*modifiers*/ undefined, /*dotDotDotToken*/ undefined, "require"),
                                                factory.createParameterDeclaration(/*decorators*/ RESERVED, /*modifiers*/ undefined, /*dotDotDotToken*/ undefined, "exports"),
                                                ...importAliasNames
                                            ],
                                            /*type*/ undefined,
        ...
        function transformUMDModule(node: SourceFile) {
            ...
            const umdHeader = factory.createFunctionExpression(
                ...
                /*name*/ undefined,
                /*typeParameters*/ undefined,
                [factory.createParameterDeclaration(/*decorators*/ RESERVED, /*modifiers*/ undefined, /*dotDotDotToken*/ undefined, "factory")],
                /*type*/ undefined,
                setTextRange(
                    factory.createBlock(
                        [
        ...
        function collectAsynchronousDependencies(node: SourceFile, includeNonAmdDependencies: boolean): AsynchronousDependencies {
            ...
            for (const amdDependency of node.amdDependencies) {
                if (amdDependency.name) {
                    ...
                    importAliasNames.push(factory.createParameterDeclaration(/*decorators*/ RESERVED, /*modifiers*/ undefined, /*dotDotDotToken*/ undefined, amdDependency.name));
                }
                else {
            ...
            for (const importNode of currentModuleInfo.externalImports) {
                ...
                if (externalModuleName) {
                    if (includeNonAmdDependencies && importAliasName) {
                        ...
                        importAliasNames.push(factory.createParameterDeclaration(/*decorators*/ RESERVED, /*modifiers*/ undefined, /*dotDotDotToken*/ undefined, importAliasName));
                    }
                    else {
        ...
        function createImportCallExpressionAMD(arg: Expression | undefined, containsLexicalThis: boolean): Expression {
            ...
            const parameters = [
                factory.createParameterDeclaration(/*decorators*/ RESERVED, /*modifiers*/ undefined, /*dotDotDotToken*/ undefined, /*name*/ resolve),
                factory.createParameterDeclaration(/*decorators*/ RESERVED, /*modifiers*/ undefined, /*dotDotDotToken*/ undefined, /*name*/ reject)
            ];
