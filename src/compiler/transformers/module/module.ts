import { TransformationContext, Expression, ParameterDeclaration, ModuleKind, SourceFile, getEmitScriptTarget, getEmitModuleKind, SyntaxKind, ExternalModuleInfo, Statement, chainBundle, isEffectiveExternalModule, TransformFlags, isJsonSourceFile, hasJsonModuleEmitEnabled, collectExternalModuleInfo, getOriginalNodeId, aggregateTransformFlags, isExternalModule, getStrictOptionValue, addPrologue, append, length, createExpressionStatement, reduceLeft, createAssignment, createPropertyAccess, createIdentifier, idText, createVoidZero, visitNode, isStatement, addRange, visitNodes, insertStatementsAfterStandardPrologue, updateSourceFileNode, setTextRange, createNodeArray, addEmitHelpers, tryGetModuleNameFromFile, createCall, createArrayLiteral, emptyArray, createLiteral, createObjectLiteral, createFunctionExpression, createParameter, createBlock, createIf, createLogicalAnd, createTypeCheck, createVariableStatement, createVariableDeclaration, setEmitFlags, createStrictInequality, EmitFlags, getExternalModuleNameLiteral, getLocalNameForExternalImport, ImportDeclaration, ExportDeclaration, ImportEqualsDeclaration, isImportEqualsDeclaration, isExportDeclaration, mapDefined, addEmitHelper, createReturn, Node, VisitResult, ExportAssignment, VariableStatement, FunctionDeclaration, ClassDeclaration, MergeDeclarationMarker, EndOfDeclarationMarker, visitEachChild, isImportCall, isDestructuringAssignment, isObjectLiteralExpression, Debug, isArrayLiteralExpression, isSpreadElement, isIdentifier, isExportName, DestructuringAssignment, flattenDestructuringAssignment, FlattenLevel, ImportCall, firstOrUndefined, isSimpleCopiableExpression, isGeneratedIdentifier, isStringLiteral, getSynthesizedClone, createConditional, createTempVariable, createComma, createUniqueName, createOmittedExpression, FunctionExpression, ArrowFunction, ScriptTarget, createArrowFunction, createNew, getUnscopedHelperName, getEmitFlags, getExportNeedsImportStarHelper, getImportNeedsImportStarHelper, getImportNeedsImportDefaultHelper, getNamespaceDeclarationNode, setOriginalNode, VariableDeclaration, isDefaultImport, getGeneratedNameForNode, createVariableDeclarationList, NodeFlags, singleOrMany, isExternalModuleImportEqualsDeclaration, hasModifier, ModifierFlags, getExportName, getLocalName, isNamedExports, createFunctionDeclaration, isModifier, getDeclarationName, createClassDeclaration, NodeArray, Modifier, isLocalName, updateVariableStatement, updateVariableDeclarationList, inlineExpressions, Identifier, TextRange, isBindingPattern, BindingElement, isOmittedExpression, Declaration, createPropertyAssignment, startOnNewLine, EmitHint, isShorthandPropertyAssignment, ShorthandPropertyAssignment, ObjectLiteralElementLike, BinaryExpression, PrefixUnaryExpression, PostfixUnaryExpression, getExternalHelpersModuleName, isImportClause, isImportSpecifier, isAssignmentOperator, isDeclarationNameOfEnumOrNamespace, getNodeId, createBinary, createToken, UnscopedEmitHelper, EmitHelper } from "../../ts";
/*@internal*/
export function transformModule(context: TransformationContext) {
    ...
    function transformAMDModule(node: SourceFile) {
        ...
        const updated = updateSourceFileNode(node, setTextRange(createNodeArray([
            createExpressionStatement(createCall(define, 
    ...
    function transformUMDModule(node: SourceFile) {
        ...
        /*asteriskToken*/ undefined, 
        /*name*/ undefined, 
        /*typeParameters*/ undefined, [createParameter(/*decorators*/ undefined, /*modifiers*/ undefined, /*dotDotDotToken*/ undefined, "factory")], 
        /*type*/ undefined, setTextRange(createBlock([
            createIf(createLogicalAnd(createTypeCheck(createIdentifier("module"), "object"), createTypeCheck(createPropertyAccess(createIdentifier("module"), "exports"), "object")), createBlock([
                createVariableStatement(
                /*modifiers*/ undefined, [
                    createVariableDeclaration("v", 
                    /*type*/ undefined, createCall(createIdentifier("factory"), 
                    /*typeArguments*/ undefined, [
                        createIdentifier("require"),
                        createIdentifier("exports")
                    ]))
                ]),
                setEmitFlags(createIf(createStrictInequality(createIdentifier("v"), createIdentifier("undefined")), createExpressionStatement(createAssignment(createPropertyAccess(createIdentifier("module"), "exports"), createIdentifier("v")))), EmitFlags.SingleLine)
            ]), createIf(createLogicalAnd(createTypeCheck(createIdentifier("define"), "function"), createPropertyAccess(createIdentifier("define"), "amd")), createBlock([
                createExpressionStatement(createCall(createIdentifier("define"), 
                /*typeArguments*/ undefined, [
                    // Add the module name (if provided).
                    ...(moduleName ? [moduleName] : []),
                    createArrayLiteral([
        ...
        //  })(function ...)
        const updated = updateSourceFileNode(node, setTextRange(createNodeArray([
            createExpressionStatement(createCall(umdHeader, 
            /*typeArguments*/ undefined, [
                // Add the module body function argument:
                //
    ...
    function createImportCallExpressionAMD(arg: Expression | undefined, containsLexicalThis: boolean): Expression {
        ...
        const body = createBlock([
            createExpressionStatement(createCall(createIdentifier("require"), 
            /*typeArguments*/ undefined, [createArrayLiteral([arg || createOmittedExpression()]), resolve, reject]))
        ]);
    ...
    function createImportCallExpressionCommonJS(arg: Expression | undefined, containsLexicalThis: boolean): Expression {
        ...
        if (languageVersion >= ScriptTarget.ES2015) {
            ...
            /*typeParameters*/ undefined, 
            /*parameters*/ [], 
            /*type*/ undefined, createBlock([createReturn(requireCall)]));
            // if there is a lexical 'this' in the import call arguments, ensure we indicate
            // that this new function expression indicates it captures 'this' so that the
            // es2015 transformer will properly substitute 'this' with '_this'.
            if (containsLexicalThis) {
        ...
        if (moduleKind !== ModuleKind.AMD) {
            if (!node.importClause) {
                ...
                if (namespaceDeclaration && !isDefaultImport(node)) {
                    ...
                    variables.push(createVariableDeclaration(getSynthesizedClone(namespaceDeclaration.name), 
                    ...
                    variables.push(createVariableDeclaration(getGeneratedNameForNode(node), 
                    /*type*/ undefined, getHelperExpressionForImport(node, createRequireCall(node))));
                    if (namespaceDeclaration && isDefaultImport(node)) {
                        variables.push(createVariableDeclaration(getSynthesizedClone(namespaceDeclaration.name), 
                        /*type*/ undefined, getGeneratedNameForNode(node)));
                    }
                }
                statements = append(statements, setOriginalNode(setTextRange(createVariableStatement(
                /*modifiers*/ undefined, createVariableDeclarationList(variables, languageVersion >= ScriptTarget.ES2015 ? NodeFlags.Const : NodeFlags.None)), 
                /*location*/ node), 
                /*original*/ node));
            }
        }
            ...
            // import d, * as n from "mod";
            statements = append(statements, createVariableStatement(
            /*modifiers*/ undefined, createVariableDeclarationList([
                setOriginalNode(setTextRange(createVariableDeclaration(getSynthesizedClone(namespaceDeclaration.name), 
                /*type*/ undefined, getGeneratedNameForNode(node)), 
                /*location*/ node), 
                /*original*/ node)
    ...
    function visitImportEqualsDeclaration(node: ImportEqualsDeclaration): VisitResult<Statement> {
        ...
        if (moduleKind !== ModuleKind.AMD) {
            if (hasModifier(node, ModifierFlags.Export)) {
                ...
                statements = append(statements, setOriginalNode(setTextRange(createVariableStatement(
                /*modifiers*/ undefined, createVariableDeclarationList([
                    createVariableDeclaration(getSynthesizedClone(node.name), 
    ...
    function visitExportDeclaration(node: ExportDeclaration): VisitResult<Statement> {
        ...
        if (node.exportClause && isNamedExports(node.exportClause)) {
            ...
            // export { x, y } from "mod";
            if (moduleKind !== ModuleKind.AMD) {
                statements.push(setOriginalNode(setTextRange(createVariableStatement(
                /*modifiers*/ undefined, createVariableDeclarationList([
                    createVariableDeclaration(generatedName, 
                    /*type*/ undefined, createRequireCall(node))
                ])), 
                /*location*/ node), 
                /* original */ node));
            ...
            for (const specifier of node.exportClause.elements) {
                if (languageVersion === ScriptTarget.ES3) {
                    ...
                    statements.push(setOriginalNode(setTextRange(createExpressionStatement(createExportExpression(getExportName(specifier), exportedValue, /* location */ undefined, /* liveBinding */ true)), specifier), specifier));
                }
            }
            return singleOrMany(statements);
        }
            ...
            statements.push(setOriginalNode(setTextRange(createExpressionStatement(createExportExpression(getSynthesizedClone(node.exportClause.name), moduleKind !== ModuleKind.AMD ?
                getHelperExpressionForExport(node, createRequireCall(node)) :
                createIdentifier(idText(node.exportClause.name)))), node), node));
            return singleOrMany(statements);
        }
        else {
            // export * from "mod";
    ...
    function visitFunctionDeclaration(node: FunctionDeclaration): VisitResult<Statement> {
        let statements: Statement[] | undefined;
        if (hasModifier(node, ModifierFlags.Export)) {
            statements = append(statements, setOriginalNode(setTextRange(createFunctionDeclaration(
            /*decorators*/ undefined, visitNodes(node.modifiers, modifierVisitor, isModifier), node.asteriskToken, getDeclarationName(node, /*allowComments*/ true, /*allowSourceMaps*/ true), 
            /*typeParameters*/ undefined, visitNodes(node.parameters, moduleExpressionElementVisitor), 
            /*type*/ undefined, visitEachChild(node.body, moduleExpressionElementVisitor, context)), 
            /*location*/ node), 
            /*original*/ node));
        }
        else {
    ...
    function visitClassDeclaration(node: ClassDeclaration): VisitResult<Statement> {
        ...
        if (hasModifier(node, ModifierFlags.Export)) {
            ...
            /*decorators*/ undefined, visitNodes(node.modifiers, modifierVisitor, isModifier), getDeclarationName(node, /*allowComments*/ true, /*allowSourceMaps*/ true), 
            /*typeParameters*/ undefined, visitNodes(node.heritageClauses, moduleExpressionElementVisitor), visitNodes(node.members, moduleExpressionElementVisitor)), node), node));
        }
        else {
            statements = append(statements, visitEachChild(node, moduleExpressionElementVisitor, context));
        }
    ...
    function transformInitializedVariable(node: VariableDeclaration): Expression {
        if (isBindingPattern(node.name)) {
            return flattenDestructuringAssignment(visitNode(node, moduleExpressionElementVisitor), 
            /*visitor*/ undefined, context, FlattenLevel.All, 
            /*needsValue*/ false, createAllExportExpressions);
        }
        else {
            return createAssignment(setTextRange(createPropertyAccess(createIdentifier("exports"), node.name), 
            /*location*/ node.name), node.initializer ? visitNode(node.initializer, moduleExpressionElementVisitor) : createVoidZero());
        }
    }
    /**
    ...
    function createUnderscoreUnderscoreESModule() {
        ...
        if (languageVersion === ScriptTarget.ES3) {
            ...
            statement = createExpressionStatement(createCall(createPropertyAccess(createIdentifier("Object"), "defineProperty"), 
            /*typeArguments*/ undefined, [
                createIdentifier("exports"),
    ...
    function createExportExpression(name: Identifier, value: Expression, location?: TextRange, liveBinding?: boolean) {
        return setTextRange(liveBinding && languageVersion !== ScriptTarget.ES3 ? createCall(createPropertyAccess(createIdentifier("Object"), "defineProperty"), 
        /*typeArguments*/ undefined, [
            createIdentifier("exports"),
            createLiteral(name),
            createObjectLiteral([
                ...
                /*typeParameters*/ undefined, 
                /*parameters*/ [], 
                /*type*/ undefined, createBlock([createReturn(value)])))
            ])
        ]) : createAssignment(createPropertyAccess(createIdentifier("exports"), getSynthesizedClone(name)), value), location);
    }
    //
    // Modifier Visitors
    //
    ...
    function substituteExpressionIdentifier(node: Identifier): Expression {
        ...
        if (!isGeneratedIdentifier(node) && !isLocalName(node)) {
            ...
            if (exportContainer && exportContainer.kind === SyntaxKind.SourceFile) {
                return setTextRange(createPropertyAccess(createIdentifier("exports"), getSynthesizedClone(node)), 
                /*location*/ node);
            }
            const importDeclaration = resolver.getReferencedImportDeclaration(node);
            if (importDeclaration) {
                if (isImportClause(importDeclaration)) {
                    return setTextRange(createPropertyAccess(getGeneratedNameForNode(importDeclaration.parent), createIdentifier("default")), 
                    /*location*/ node);
                }
                else if (isImportSpecifier(importDeclaration)) {
                    const name = importDeclaration.propertyName || importDeclaration.name;
                    return setTextRange(createPropertyAccess(getGeneratedNameForNode(importDeclaration.parent.parent.parent), getSynthesizedClone(name)), 
                    /*location*/ node);
                }
            }
        }
        ...
        if ((node.operator === SyntaxKind.PlusPlusToken || node.operator === SyntaxKind.MinusMinusToken)
            ...
            if (exportedNames) {
                let expression: Expression = node.kind === SyntaxKind.PostfixUnaryExpression
                    ? setTextRange(createBinary(node.operand, createToken(node.operator === SyntaxKind.PlusPlusToken ? SyntaxKind.PlusEqualsToken : SyntaxKind.MinusEqualsToken), createLiteral(1)), 
                    /*location*/ node)
                    : node;
                for (const exportName of exportedNames) {
                    // Mark the node to prevent triggering this rule again.
