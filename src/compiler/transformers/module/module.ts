import {
    ...
    isPrefixUnaryExpression, isShorthandPropertyAssignment, isSimpleCopiableExpression, isSpreadElement, isStatement,
    isStringLiteral, length, mapDefined, MergeDeclarationMarker, Modifier, ModifierFlags, ModuleKind, Node, NodeArray,
    NodeFlags, ObjectLiteralElementLike, outFile, ParameterDeclaration, ParenthesizedExpression,
    PartiallyEmittedExpression, PostfixUnaryExpression, PrefixUnaryExpression, reduceLeft, removeAllComments,
    ScriptTarget, setEmitFlags, setOriginalNode, setTextRange, ShorthandPropertyAssignment, singleOrMany, SourceFile,
