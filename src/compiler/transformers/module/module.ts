import {
    ...
    isArrayLiteralExpression, isArrowFunction, isAssignmentOperator, isBindingPattern, isClassElement, isClassExpression,
    ...
    isHeritageClause,
    isIdentifier, isImportCall, isImportClause, isImportEqualsDeclaration, isImportSpecifier, isInitializedVariable, isJsonSourceFile,
