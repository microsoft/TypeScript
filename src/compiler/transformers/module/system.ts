import { TransformationContext, StringLiteral, ImportDeclaration, ImportEqualsDeclaration, ExportDeclaration, SyntaxKind, ExternalModuleInfo, Statement, Identifier, SourceFile, Node, chainBundle, isEffectiveExternalModule, TransformFlags, getOriginalNodeId, collectExternalModuleInfo, createUniqueName, createFunctionExpression, createParameter, tryGetModuleNameFromFile, createArrayLiteral, map, setEmitFlags, updateSourceFileNode, setTextRange, createNodeArray, createExpressionStatement, createCall, createPropertyAccess, createIdentifier, EmitFlags, moveEmitHelpers, aggregateTransformFlags, createMap, getExternalModuleNameLiteral, getStrictOptionValue, isExternalModule, addPrologue, createVariableStatement, createVariableDeclarationList, createVariableDeclaration, createLogicalAnd, visitNode, isStatement, visitNodes, addRange, insertStatementsAfterStandardPrologue, createModifiersFromModifierFlags, ModifierFlags, createObjectLiteral, createPropertyAssignment, createBlock, createReturn, ObjectLiteralElementLike, createLiteral, createTrue, isNamedExports, idText, Expression, createStrictInequality, createLogicalNot, createFunctionDeclaration, createForIn, createIf, createAssignment, createElementAccess, forEach, getLocalNameForExternalImport, getGeneratedNameForNode, Debug, PropertyAssignment, VisitResult, ExportAssignment, singleOrMany, isExternalModuleImportEqualsDeclaration, isExpression, FunctionDeclaration, hasModifier, append, updateFunctionDeclaration, isModifier, getDeclarationName, isParameterDeclaration, isBlock, visitEachChild, ClassDeclaration, getLocalName, createClassExpression, isHeritageClause, isClassElement, VariableStatement, inlineExpressions, VariableDeclaration, BindingElement, isBindingPattern, isOmittedExpression, getSynthesizedClone, VariableDeclarationList, getEmitFlags, getOriginalNode, NodeFlags, flattenDestructuringAssignment, FlattenLevel, TextRange, MergeDeclarationMarker, EndOfDeclarationMarker, isModuleOrEnumDeclaration, isGeneratedIdentifier, getTextOfIdentifierOrLiteral, Declaration, startOnNewLine, isIdentifier, setCommentRange, ForStatement, ForInStatement, ForOfStatement, DoStatement, WhileStatement, LabeledStatement, WithStatement, SwitchStatement, CaseBlock, CaseClause, DefaultClause, TryStatement, CatchClause, Block, updateFor, updateForIn, liftToBlock, updateForOf, ForInitializer, isVariableDeclarationList, createOmittedExpression, updateDo, updateWhile, updateLabel, updateWith, updateSwitch, isCaseBlock, updateCaseBlock, isCaseOrDefaultClause, CaseOrDefaultClause, updateCaseClause, updateCatchClause, isDestructuringAssignment, isImportCall, ImportCall, some, DestructuringAssignment, isAssignmentExpression, isSpreadElement, isObjectLiteralExpression, isArrayLiteralExpression, isShorthandPropertyAssignment, isPropertyAssignment, EmitHint, ShorthandPropertyAssignment, isLocalName, isImportClause, isImportSpecifier, BinaryExpression, PrefixUnaryExpression, PostfixUnaryExpression, MetaProperty, getExternalHelpersModuleName, isAssignmentOperator, isDeclarationNameOfEnumOrNamespace, createPrefix, createSubtract, createAdd, isImportMeta, getNodeId } from "../../ts";
/*@internal*/
export function transformSystemModule(context: TransformationContext) {
    ...
    function transformSourceFile(node: SourceFile) {
        ...
        const updated = setEmitFlags(updateSourceFileNode(node, setTextRange(createNodeArray([
            createExpressionStatement(createCall(createPropertyAccess(createIdentifier("System"), "register"), 
    ...
    function createSystemModuleBody(node: SourceFile, dependencyGroups: DependencyGroup[]) {
        ...
        /*modifiers*/ undefined, createVariableDeclarationList([
            createVariableDeclaration("__moduleName", 
            /*type*/ undefined, createLogicalAnd(contextObject, createPropertyAccess(contextObject, "id")))
        ])));
        ...
        const moduleObject = createObjectLiteral([
            ...
            createPropertyAssignment("execute", createFunctionExpression(modifiers, 
            /*asteriskToken*/ undefined, 
            /*name*/ undefined, 
            /*typeParameters*/ undefined, 
            /*parameters*/ [], 
            /*type*/ undefined, createBlock(executeStatements, /*multiLine*/ true)))
        ]);
    ...
    function addExportStarIfNeeded(statements: Statement[]) {
        ...
        statements.push(createVariableStatement(
        /*modifiers*/ undefined, createVariableDeclarationList([
            createVariableDeclaration(exportedNamesStorageRef, 
            /*type*/ undefined, createObjectLiteral(exportedNames, /*multiline*/ true))
        ])));
    ...
    function createExportStarFunction(localNames: Identifier | undefined) {
        ...
        if (localNames) {
            condition = createLogicalAnd(condition, createLogicalNot(createCall(createPropertyAccess(localNames, "hasOwnProperty"), 
        ...
        /*typeParameters*/ undefined, [createParameter(/*decorators*/ undefined, /*modifiers*/ undefined, /*dotDotDotToken*/ undefined, m)], 
        /*type*/ undefined, createBlock([
            createVariableStatement(
            /*modifiers*/ undefined, createVariableDeclarationList([
                createVariableDeclaration(exports, 
                /*type*/ undefined, createObjectLiteral([]))
            ])),
            createForIn(createVariableDeclarationList([
                createVariableDeclaration(n, /*type*/ undefined)
            ]), m, createBlock([
                setEmitFlags(createIf(condition, createExpressionStatement(createAssignment(createElementAccess(exports, n), createElementAccess(m, n)))), EmitFlags.SingleLine)
            ])),
            createExpressionStatement(createCall(exportFunction, 
                    ...
                    case SyntaxKind.ExportDeclaration:
                        ...
                        if (entry.exportClause) {
                            if (isNamedExports(entry.exportClause)) {
                                ...
                                statements.push(createExpressionStatement(createCall(exportFunction, 
                                /*typeArguments*/ undefined, [createObjectLiteral(properties, /*multiline*/ true)])));
                            }
                            else {
                                statements.push(createExpressionStatement(createCall(exportFunction, 
                            ...
                            //
                            //  exportStar(foo_1_1);
                            statements.push(createExpressionStatement(createCall(exportStarFunction, 
                            /*typeArguments*/ undefined, [parameterName])));
                        }
                        break;
                }
            }
            setters.push(createFunctionExpression(
            /*modifiers*/ undefined, 
            /*asteriskToken*/ undefined, 
            /*name*/ undefined, 
            /*typeParameters*/ undefined, [createParameter(/*decorators*/ undefined, /*modifiers*/ undefined, /*dotDotDotToken*/ undefined, parameterName)], 
    ...
    function visitFunctionDeclaration(node: FunctionDeclaration): VisitResult<Statement> {
        if (hasModifier(node, ModifierFlags.Export)) {
            hoistedStatements = append(hoistedStatements, updateFunctionDeclaration(node, node.decorators, visitNodes(node.modifiers, modifierVisitor, isModifier), node.asteriskToken, getDeclarationName(node, /*allowComments*/ true, /*allowSourceMaps*/ true), 
            /*typeParameters*/ undefined, visitNodes(node.parameters, destructuringAndImportCallVisitor, isParameterDeclaration), 
            /*type*/ undefined, visitNode(node.body, destructuringAndImportCallVisitor, isBlock)));
        }
        else {
    ...
    function visitClassDeclaration(node: ClassDeclaration): VisitResult<Statement> {
        ...
        statements = append(statements, setTextRange(createExpressionStatement(createAssignment(name, setTextRange(createClassExpression(
        /*modifiers*/ undefined, node.name, 
        /*typeParameters*/ undefined, visitNodes(node.heritageClauses, destructuringAndImportCallVisitor, isHeritageClause), visitNodes(node.members, destructuringAndImportCallVisitor, isClassElement)), node))), node));
        if (hasAssociatedEndOfDeclarationMarker(node)) {
            // Defer exports until we encounter an EndOfDeclarationMarker node
            const id = getOriginalNodeId(node);
            deferredExports[id] = appendExportsOfHoistedDeclaration(deferredExports[id], node);
    ...
    function transformInitializedVariable(node: VariableDeclaration, isExportedDeclaration: boolean): Expression {
        ...
        return isBindingPattern(node.name)
            ? flattenDestructuringAssignment(node, destructuringAndImportCallVisitor, context, FlattenLevel.All, 
    ...
    function visitImportCallExpression(node: ImportCall): Expression {
        ...
        //     };
        // });
        return createCall(createPropertyAccess(contextObject, createIdentifier("import")), 
        /*typeArguments*/ undefined, some(node.arguments) ? [visitNode(node.arguments[0], destructuringAndImportCallVisitor)] : []);
    }
    /**
    ...
    function visitDestructuringAssignment(node: DestructuringAssignment): VisitResult<Expression> {
        if (hasExportedReferenceInDestructuringTarget(node.left)) {
            return flattenDestructuringAssignment(node, destructuringAndImportCallVisitor, context, FlattenLevel.All, 
            /*needsValue*/ true);
        }
        return visitEachChild(node, destructuringAndImportCallVisitor, context);
    }
        ...
        if (!isGeneratedIdentifier(name) && !isLocalName(name)) {
            ...
            if (importDeclaration) {
                if (isImportClause(importDeclaration)) {
                    return setTextRange(createPropertyAssignment(getSynthesizedClone(name), createPropertyAccess(getGeneratedNameForNode(importDeclaration.parent), createIdentifier("default"))), 
                    /*location*/ node);
                }
                else if (isImportSpecifier(importDeclaration)) {
                    return setTextRange(createPropertyAssignment(getSynthesizedClone(name), createPropertyAccess(getGeneratedNameForNode(importDeclaration.parent.parent.parent), getSynthesizedClone(importDeclaration.propertyName || importDeclaration.name))), 
                    /*location*/ node);
                }
            }
        }
        ...
        if (!isGeneratedIdentifier(node) && !isLocalName(node)) {
            ...
            if (importDeclaration) {
                if (isImportClause(importDeclaration)) {
                    ...
                    return setTextRange(createPropertyAccess(getGeneratedNameForNode(importDeclaration.parent.parent.parent), getSynthesizedClone(importDeclaration.propertyName || importDeclaration.name)), 
                    /*location*/ node);
                }
            }
        }
        ...
        if ((node.operator === SyntaxKind.PlusPlusToken || node.operator === SyntaxKind.MinusMinusToken)
            ...
            if (exportedNames) {
                let expression: Expression = node.kind === SyntaxKind.PostfixUnaryExpression
                    ? setTextRange(createPrefix(node.operator, node.operand), node)
                    : node;
                for (const exportName of exportedNames) {
                    expression = createExportExpression(exportName, preventSubstitution(expression));
                }
