import {
    ...
    isGeneratedIdentifier, isHeritageClause, isIdentifier, isImportClause, isImportSpecifier, isInstantiatedModule,
    isJsonSourceFile, isJsxAttributes, isJsxTagNameExpression, isLeftHandSideExpression, isLocalName, isModifier,
    isModifierLike, isModuleDeclaration, isNamedExportBindings, isNamedImportBindings, isNamespaceExport,
    isObjectLiteralElement, isParameterPropertyDeclaration, isPrivateIdentifier, isPropertyAccessExpression,
    isPropertyName, isShorthandPropertyAssignment, isSimpleInlineableExpression, isSourceFile, isStatement,
    JsxOpeningElement, JsxSelfClosingElement, lastOrUndefined, LeftHandSideExpression, map, Map, mapDefined,
    MethodDeclaration, ModifierFlags, ModifierLike, modifierToFlag, ModuleBlock, ModuleDeclaration, ModuleKind,
    moveRangePastDecorators, moveRangePastModifiers, moveRangePos, NamedExportBindings, NamedExports,
