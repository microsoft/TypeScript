import {
    ...
    isNamespaceExport, isParameterPropertyDeclaration, isPrivateIdentifier,
    ...
    visitNode, visitNodes, visitParameterList, VisitResult, isObjectLiteralElementLike, isTemplateLiteral,
} from "../_namespaces/ts";
