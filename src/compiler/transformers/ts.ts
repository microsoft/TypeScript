import {
    __String, AccessorDeclaration, addEmitFlags, addEmitHelpers, addRange, addSyntheticTrailingComment,
    ...
    isSourceFile, isStatement, JsxOpeningElement, JsxSelfClosingElement, LeftHandSideExpression, map,
    ...
    setTypeNode, ShorthandPropertyAssignment, shouldPreserveConstEnums, skipOuterExpressions,
    skipPartiallyEmittedExpressions, skipTrivia, some, SourceFile, startOnNewLine, Statement,
    SyntaxKind, TaggedTemplateExpression, TextRange, TransformationContext, TransformFlags, UnderscoreEscapedMap,
    VariableDeclaration, VariableStatement, visitEachChild, visitFunctionBody, visitLexicalEnvironment,
    visitNode, visitNodes, visitParameterList, VisitResult, classElementOrClassElementParameterIsDecorated,
    InternalEmitFlags, isExportOrDefaultModifier, NodeArray, setInternalEmitFlags, skipWhile, takeWhile,
} from "../_namespaces/ts";
...
export function transformTypeScript(context: TransformationContext) {
    ...
    function decoratorElidingVisitor(node: Node): VisitResult<Node> {
        return isDecorator(node) ? undefined : visitor(node);
    }

    function modifierElidingVisitor(node: Node): VisitResult<Node> {
