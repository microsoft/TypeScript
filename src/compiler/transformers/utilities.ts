import { Node, getOriginalNode, getNodeId, ImportDeclaration, ImportEqualsDeclaration, ExportDeclaration, ExportSpecifier, Identifier, ExportAssignment, NamedImportBindings, isNamedImports, some, ImportSpecifier, InternalSymbolName, SourceFile, Bundle, SyntaxKind, createBundle, map, getNamespaceDeclarationNode, isDefaultImport, EmitResolver, CompilerOptions, createMultiMap, createMap, cast, isNamedExports, idText, append, hasModifier, ModifierFlags, VariableStatement, getDeclarationName, FunctionDeclaration, ClassDeclaration, createExternalHelpersImportDeclarationIfNeeded, VariableDeclaration, BindingElement, isBindingPattern, isOmittedExpression, isGeneratedIdentifier, Expression, isStringLiteralLike, isKeyword, isIdentifier, isWellKnownSymbolSyntactically, BinaryOperator, CompoundAssignmentOperator, BitwiseOperatorOrHigher, ConstructorDeclaration, Statement, Visitor, addPrologue, findIndex, isExpressionStatement, isSuperCall, visitNode, isStatement, EmitHelperUniqueNameCallback, ClassExpression, PropertyDeclaration, filter, ClassElement, isPropertyDeclaration, hasStaticModifier } from "../ts";
...
export interface ExternalModuleInfo {
    ...
    exportSpecifiers: ts.Map<ExportSpecifier[]>; // export specifiers by name
...
/* @internal */
function collectExportedVariableInfo(decl: VariableDeclaration | BindingElement, uniqueExports: ts.Map<boolean>, exportedNames: Identifier[] | undefined) {
