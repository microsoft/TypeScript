...
/*@internal*/
namespace ts {
    export function toES5(transformer: Transformer, statements: NodeArray<Statement>) {
        let { 
            accept,
            visitNode, 
            visitNodes, 
        ...
        let currentSourceFile = transformer.getRootNode();
        ...
        */
        ...
        function transformFunctionLikeExpressionToFunctionExpression(node: FunctionLikeDeclaration, name: Identifier, location: TextRange): FunctionExpression {
            ...
            emitNode(node, transformFunctionBody, statements, PipelineFlags.LexicalEnvironment);
