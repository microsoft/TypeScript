...
export const enum NodeCheckFlags {
    ...
    ContainsConstructorReference             = 1 << 20,  // Class or class element that contains a binding that references the class constructor.
    ConstructorReference                     = 1 << 21,  // Binding to a class constructor inside of the class's body.
