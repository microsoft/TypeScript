import { MultiMap, ProgramBuildInfo, Pattern, MapLike } from "./ts";
...
export const enum NodeFlags {
    ...
    JSDoc = 1 << 22,
    /* @internal */ Ambient = 1 << 23,
    /* @internal */ InWithStatement = 1 << 24,
    JsonFile = 1 << 25,
    /* @internal */ TypeCached = 1 << 26,
...
export type BindingOrAssignmentElement = VariableDeclaration | ParameterDeclaration | BindingElement | PropertyAssignment // AssignmentProperty
...
;
export type BindingOrAssignmentElementRestIndicator = DotDotDotToken // from BindingElement
 | SpreadElement // AssignmentRestElement
 | SpreadAssignment // AssignmentRestProperty
;
...
export interface SourceFile extends Declaration {
    ...
    /* @internal */
    renamedDependencies?: ts.ReadonlyMap<string>;
    /**
    ...
    /* @internal */ identifiers: ts.Map<string>; // Map from a string to an interned string
    ...
    /* @internal */ resolvedModules?: ts.Map<ResolvedModuleFull | undefined>;
    /* @internal */ resolvedTypeReferenceDirectiveNames: ts.Map<ResolvedTypeReferenceDirective | undefined>;
...
export interface Program extends ScriptReferenceHost {
    ...
    /* @internal */
    getFilesByNameMap(): ts.Map<SourceFile | false | undefined>;
    /**
    ...
    /* @internal */ getResolvedTypeReferenceDirectives(): ts.Map<ResolvedTypeReferenceDirective | undefined>;
    ...
    /* @internal */ sourceFileToPackageName: ts.Map<string>;
    ...
    /*@internal*/ getProbableSymlinks(): ts.ReadonlyMap<string>;
}
/* @internal */
export type RedirectTargetsMap = ts.ReadonlyMap<readonly string[]>;
...
export interface TypeCheckerHost extends ModuleSpecifierResolutionHost {
    ...
    getSourceFiles(): readonly SourceFile[];
    getSourceFile(fileName: string): SourceFile | undefined;
    getResolvedTypeReferenceDirectives(): ts.ReadonlyMap<ResolvedTypeReferenceDirective | undefined>;
...
export interface TypeChecker {
    ...
    /* @internal */ signatureToSignatureDeclaration(signature: Signature, kind: SyntaxKind, enclosingDeclaration?: Node, flags?: NodeBuilderFlags, tracker?: SymbolTracker): SignatureDeclaration & {
        typeArguments?: NodeArray<TypeNode>;
    ...
    /* @internal */ createSignature(declaration: SignatureDeclaration, typeParameters: TypeParameter[] | undefined, thisParameter: Symbol | undefined, parameters: Symbol[], resolvedReturnType: Type, typePredicate: TypePredicate | undefined, minArgumentCount: number, flags: SignatureFlags): Signature;
...
export const enum NodeBuilderFlags {
    ...
    /* @internal */ DoNotIncludeSymbolChain = 1 << 27,
...
export interface Symbol {
    ...
    /* @internal */ assignmentDeclarationMembers?: ts.Map<Declaration>; // detected late-bound assignment declarations associated with the symbol
}
/* @internal */
export interface SymbolLinks {
    ...
    instantiations?: ts.Map<Type>; // Instantiations of generic type alias (undefined if non-generic)
    inferredClassSymbol?: ts.Map<TransientSymbol>; // Symbol of an inferred ES5 constructor function
    ...
    specifierCache?: ts.Map<string>; // For symbols corresponding to external modules, a cache of incoming path -> module specifier name mappings
    extendedContainers?: Symbol[]; // Containers (other than the parent) which this symbol is aliased in
    extendedContainersByFile?: ts.Map<Symbol[]>; // Containers (other than the parent) which this symbol is aliased in
...
export interface ReadonlyUnderscoreEscapedMap<T> {
    ...
    keys(): ts.Iterator<__String>;
    values(): ts.Iterator<T>;
    entries(): ts.Iterator<[__String, T]>;
}
...
export interface NodeLinks {
    ...
    deferredNodes?: ts.Map<Node>; // Set of nodes whose checking has been deferred
...
export interface GenericType extends InterfaceType, TypeReference {
    /* @internal */
    instantiations: ts.Map<TypeReference>; // Generic instantiation cache
    /* @internal */
...
export interface Signature {
    ...
    optionalCallSignatureCache?: {
        inner?: Signature;
        outer?: Signature;
    }; // Optional chained call version of signature (deferred)
    /* @internal */
    isolatedSignatureType?: ObjectType; // A manufactured type that just contains the signature for purposes of signature comparison
    /* @internal */
    instantiations?: ts.Map<Signature>; // Generic signature instantiation cache
}
...
export interface CommandLineOptionBase {
    name: string;
    type: "string" | "number" | "boolean" | "object" | "list" | ts.Map<number | string>; // a value of a primitive type, or an object literal mapping named values to actual values
...
export interface CommandLineOptionOfCustomType extends CommandLineOptionBase {
    type: ts.Map<number | string>; // an object literal mapping named values to actual values
}
/* @internal */
...
export interface TsConfigOnlyOption extends CommandLineOptionBase {
    type: "object";
    elementOptions?: ts.Map<CommandLineOption>;
...
export interface CompilerHost extends ModuleResolutionHost {
    ...
    /*@internal*/ getSymlinks?(): ts.ReadonlyMap<string>;
}
...
export const enum EmitFlags {
    ...
    /*@internal*/ TypeScriptClassWrapper = 1 << 25,
    /*@internal*/ NeverApplyImportHelper = 1 << 26
}
...
/* @internal */
export interface ReadonlyPragmaMap extends ts.ReadonlyMap<PragmaPseudoMap[keyof PragmaPseudoMap] | PragmaPseudoMap[keyof PragmaPseudoMap][]> {
 ...
 */
/* @internal */
export interface PragmaMap extends ts.Map<PragmaPseudoMap[keyof PragmaPseudoMap] | PragmaPseudoMap[keyof PragmaPseudoMap][]>, ReadonlyPragmaMap {
