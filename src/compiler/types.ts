namespace ts {
     ...
     */
    export interface OperatorListExpression extends Expression {
        kind: SyntaxKind.OperatorListExpression;
        operatorToken: BinaryOperatorToken; // TODOO: Probably actually need to retain all of the tokens (or none)
        elements: NodeArray<Expression>;
    }
    ...
    export const enum ListFormat {
        ...
        OperatorDelimited = 1 << 5,     // Each list item is delimited by an operator that needs to be provided
        DelimitersMask = BarDelimited | AmpersandDelimited | CommaDelimited | OperatorDelimited,
        ...
        OperatorListElements = OperatorDelimited | SpaceBetweenSiblings | SingleLine,
