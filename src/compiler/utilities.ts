import {
    ...
    hasJSDocNodes, HasType, HasTypeArguments, HeritageClause, Identifier, IdentifierTypePredicate, identity, idText,
    ...
    InterfaceDeclaration, isAccessor, isAnyDirectorySeparator, isArray, isArrayLiteralExpression, isArrowFunction,
    isBigIntLiteral, isBinaryExpression, isBindingPattern, isCallExpression, isClassDeclaration, isClassElement,
    isClassExpression, isClassLike, isClassStaticBlockDeclaration, isCommaListExpression, isComputedPropertyName,
    isConstructorDeclaration, isDeclaration, isDecorator, isElementAccessExpression, isEnumMember, isExportAssignment,
