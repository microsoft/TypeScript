import {
    ...
    getLineAndCharacterOfPosition, getLinesBetweenPositions, getLineStarts, getModeForFileReference,
    getModeForResolutionAtIndex, getNameOfDeclaration, getNormalizedAbsolutePath, getNormalizedPathComponents,
    ...
    hasInitializer, HasInitializer, HasJSDoc, hasJSDocNodes, HasModifiers, hasProperty, HasType, HasTypeArguments,
    HeritageClause, Identifier, IdentifierTypePredicate, identity, idText, IfStatement, ignoredPaths, ImportCall,
    ImportClause, ImportDeclaration, ImportEqualsDeclaration, ImportMetaProperty, ImportSpecifier, ImportTypeNode,
    IndexInfo, indexOfAnyCharCode, InitializedVariableDeclaration, insertSorted, InterfaceDeclaration, isAccessor,
