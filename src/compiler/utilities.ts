import {
    ...
    canHaveDecorators, canHaveModifiers, CaseBlock, CaseClause, CaseOrDefaultClause,
    ...
    WriteFileCallbackData, YieldExpression, ResolutionMode, ClassExpression, InternalEmitFlags, isMethodDeclaration,
