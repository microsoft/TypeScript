import { createMap, ReadonlyPragmaMap, ReadonlyUnderscoreEscapedMap, Declaration, UnderscoreEscapedMap, SymbolTable, TransientSymbol, SymbolFlags, EmitTextWriter, isWhiteSpaceLike, noop, CompilerOptions, moduleResolutionOptionDeclarations, isSourceFile, __String, arrayToMap, returnTrue, SourceFile, ResolvedModuleFull, ResolvedTypeReferenceDirective, ProjectReference, PackageId, Debug, NodeFlags, forEachChild, SyntaxKind, SourceFileLike, getLineStarts, getLineAndCharacterOfPosition, isLineBreak, PrintHandlers, Statement, EmitFlags, CharacterCodes, isJSDocNode, skipTrivia, hasJSDocNodes, SyntaxList, isJSDocTypeExpression, binarySearch, compareValues, LiteralLikeNode, isNumericLiteral, TokenFlags, isBigIntLiteral, StringLiteral, TemplateLiteralLikeNode, isString, getBaseFileName, getCombinedNodeFlags, AmbientModuleDeclaration, isModuleDeclaration, ModuleDeclaration, isStringLiteral, isIdentifier, isFunctionLike, isExternalModule, find, ModuleKind, ScriptKind, startsWithUseStrict, DeclarationWithTypeParameters, assertType, DeclarationWithTypeParameterChildren, AnyImportSyntax, LateVisibilityPaintedStatement, AnyImportOrReExport, isExportDeclaration, DeclarationName, QualifiedName, IndexInfo, PropertyName, NoSubstitutionTemplateLiteral, escapeLeadingUnderscores, EntityNameOrEntityNameExpression, JsxTagNameExpression, PrivateIdentifier, idText, isPrivateIdentifier, DiagnosticMessage, DiagnosticWithLocation, NodeArray, DiagnosticMessageChain, DiagnosticRelatedInformation, TextSpan, createScanner, createTextSpanFromBounds, ArrowFunction, createTextSpan, NamedDeclaration, CaseOrDefaultClause, isJSDoc, isJsxText, JsonSourceFile, EnumDeclaration, getCombinedModifierFlags, ModifierFlags, isParameterPropertyDeclaration, VariableDeclaration, VariableDeclarationList, SuperCall, CallExpression, ImportCall, ImportMetaProperty, isMetaProperty, LiteralImportTypeNode, isImportTypeNode, isLiteralTypeNode, PrologueDirective, ExpressionStatement, getLeadingCommentRanges, concatenate, getTrailingCommentRanges, filter, PropertyAccessExpression, ImportTypeNode, TypeParameterDeclaration, JSDocTemplateTag, HasType, FunctionLikeDeclaration, SignatureDeclaration, TypeAssertion, contains, Block, ReturnStatement, YieldExpression, TypeNode, ArrayTypeNode, singleOrUndefined, TypeReferenceNode, ClassElement, TypeElement, ObjectLiteralElement, ObjectTypeDeclaration, ObjectLiteralExpression, VariableLikeDeclaration, AccessorDeclaration, isAccessor, PropertyDeclaration, isVariableDeclaration, isPropertyDeclaration, isPropertySignature, LabeledStatement, MethodDeclaration, TypePredicate, IdentifierTypePredicate, TypePredicateKind, ThisTypePredicate, PropertyAssignment, TsConfigSourceFile, tryCast, isObjectLiteralExpression, firstDefined, isArrayLiteralExpression, emptyArray, isFunctionLikeDeclaration, ClassLikeDeclaration, isClassLike, isClassElement, SuperExpression, SuperProperty, ElementAccessExpression, ExpressionWithTypeArguments, EntityNameExpression, EntityName, CallLikeExpression, Expression, ClassDeclaration, isNamedDeclaration, some, JsxOpeningLikeElement, HasInitializer, ForStatement, ForInStatement, ForOfStatement, AssertionExpression, TemplateSpan, ComputedPropertyName, ShorthandPropertyAssignment, ImportEqualsDeclaration, ExternalModuleReference, isTypeReferenceNode, RequireOrImportCall, StringLiteralLike, isStringLiteralLike, RequireVariableDeclaration, VariableStatement, isVariableStatement, every, BindingName, isBinaryExpression, isCallExpression, HasExpressionInitializer, forEach, isPropertyAssignment, BinaryExpression, LiteralLikeElementAccessExpression, isPropertyAccessExpression, AssignmentDeclarationKind, BindableObjectDefinePropertyCall, length, isElementAccessExpression, BindableStaticAccessExpression, BindableStaticElementAccessExpression, BindableStaticNameExpression, AccessExpression, NumericLiteral, getJSDocTypeTag, AnyValidImportOrReExport, ValidImportTypeNode, ImportDeclaration, ExportDeclaration, NamespaceImport, NamespaceExport, isNamespaceImport, isNamespaceExport, ImportClause, ImportSpecifier, ParameterDeclaration, isJSDocFunctionType, firstOrUndefined, JSDocTypedefTag, JSDocCallbackTag, JSDocEnumTag, TypeAliasDeclaration, isTypeAliasDeclaration, isExpressionStatement, JSDoc, JSDocTag, hasInitializer, append, last, HasJSDoc, addRange, getJSDocParameterTags, getJSDocTypeParameterTags, JSDocParameterTag, InterfaceDeclaration, JSDocSignature, lastOrUndefined, isJSDocParameterTag, HasTypeArguments, PrefixUnaryExpression, PostfixUnaryExpression, ForInOrOfStatement, WithStatement, IfStatement, SwitchStatement, CaseBlock, CaseClause, DefaultClause, DoStatement, WhileStatement, TryStatement, CatchClause, FunctionDeclaration, ConstructorDeclaration, FunctionExpression, isFunctionExpression, isArrowFunction, isMethodOrAccessor, isFunctionDeclaration, isConstructorDeclaration, ParenthesizedExpression, isBindingPattern, isDeclaration, isComputedPropertyName, isQualifiedName, getNameOfDeclaration, BindingElement, ExportAssignment, isClassExpression, isExportAssignment, getJSDocAugmentsTag, getJSDocImplementsTags, isInterfaceDeclaration, singleElementArray, HeritageClause, stringToToken, isPrefixUnaryExpression, DynamicNamedDeclaration, DynamicNamedBinaryExpression, WellKnownSymbolExpression, isIdentifierOrPrivateIdentifier, getSymbolId, startsWith, TextRange, getParseTreeNode, NewExpression, DiagnosticCollection, Diagnostic, SortedArray, identity, insertSorted, compareStringsCaseSensitive, flatMapToMutable, TemplateLiteral, isNoSubstitutionTemplateLiteral, createMapFromTemplate, stringContains, computeLineStarts, EmitResolver, toPath, getDirectoryPath, getNormalizedAbsolutePath, getRelativePathToDirectoryOrUrl, ensurePathIsNonModuleName, EmitHost, GetCanonicalFileName, Extension, SourceFileMayBeEmittedHost, combinePaths, WriteFileCallback, Diagnostics, getRootLength, normalizePath, computeLineAndCharacterOfPosition, FunctionBody, SetAccessorDeclaration, isJSDocSignature, AllAccessorDeclarations, GetAccessorDeclaration, isJSDocPropertyLikeTag, getJSDocType, getJSDocReturnType, flatMap, getJSDocTags, isJSDocTemplateTag, CommentRange, isWhiteSpaceSingleLine, getJSDocPublicTag, getJSDocPrivateTag, getJSDocProtectedTag, getJSDocReadonlyTag, isExpressionWithTypeArguments, isHeritageClause, AssignmentExpression, EqualsToken, AssignmentOperatorToken, isLeftHandSideExpression, DestructuringAssignment, PropertyAccessEntityNameExpression, unescapeLeadingUnderscores, ArrayLiteralExpression, fileExtensionIs, parseConfigFileTextToJson, PrinterOptions, NewLineKind, sys, tokenToString, FileWatcher, CheckFlags, TypeChecker, ObjectFlags, TypeFlags, ObjectFlagsType, SignatureKind, forEachAncestorDirectory, isNamespaceExportDeclaration, isTypeLiteralNode, BundleFileSection, BundleFileTextLike, BundleFileSectionKind, createNode, DotToken, NamedImportsOrExports, SignatureFlags, TransformFlags, MapLike, Comparison, ScriptTarget, ModuleResolutionKind, semanticDiagnosticsOptionDeclarations, affectsEmitOptionDeclarations, CommandLineOption, flatten, mapDefined, compact, arrayFrom, mapIterator, getPathComponents, getPathFromPathComponents, isAnyDirectorySeparator, tryRemovePrefix, getNormalizedPathComponents, removeTrailingDirectorySeparator, directorySeparator, map, createGetCanonicalFileName, sort, fileExtensionIsOneOf, findIndex, isRootedDiskPath, getStringComparer, containsPath, indexOfAnyCharCode, hasExtension, FileExtensionInfo, deduplicate, equateStringsCaseSensitive, Path, changeAnyExtension, Pattern, findBestPatternMatch, getNodeId, equalOwnProperties, PseudoBigInt } from "./ts";
import * as ts from "./ts";
/* @internal */
export const resolvingEmptyArray: never[] = [] as never[];
/* @internal */
export const emptyMap = (createMap<never>() as ts.ReadonlyMap<never> & ReadonlyPragmaMap);
/* @internal */
...
export function createUnderscoreEscapedMap<T>(): UnderscoreEscapedMap<T> {
    return new ts.Map<T>() as UnderscoreEscapedMap<T>;
}
/* @internal */
...
export function createSymbolTable(symbols?: readonly ts.Symbol[]): SymbolTable {
    const result = (createMap<ts.Symbol>() as SymbolTable);
    if (symbols) {
...
/* @internal */
export function forEachEntry<T, U>(map: ReadonlyUnderscoreEscapedMap<T> | ts.ReadonlyMap<T>, callback: (value: T, key: (string & __String)) => U | undefined): U | undefined {
...
/* @internal */
export function forEachKey<T>(map: ReadonlyUnderscoreEscapedMap<{}> | ts.ReadonlyMap<{}>, callback: (key: string & __String) => T | undefined): T | undefined {
...
/* @internal */
export function copyEntries<T, U extends UnderscoreEscapedMap<T> | ts.Map<T>>(source: U, target: U): void {
...
/* @internal */
export function arrayToSet(array: readonly any[], makeKey?: (value: any) => string | __String | undefined): ts.Map<true> | UnderscoreEscapedMap<true> {
...
/* @internal */
export function cloneMap<T>(map: ts.ReadonlyMap<T> | ReadonlyUnderscoreEscapedMap<T> | SymbolTable): ts.Map<T> | UnderscoreEscapedMap<T> | SymbolTable {
...
/* @internal */
export function isObjectLiteralOrClassExpressionMethod(node: ts.Node): node is MethodDeclaration {
...
export function getEntityNameFromTypeNode(node: TypeNode): EntityNameOrEntityNameExpression | undefined {
    switch (node.kind) {
        ...
        case SyntaxKind.Identifier:
        case SyntaxKind.QualifiedName:
            return (<EntityName><ts.Node>node);
    }
    return undefined;
}
/* @internal */
 ...
 */
/* @internal */
export function isRequireVariableDeclaration(node: ts.Node, requireStringLiteralLikeArgument: true): node is RequireVariableDeclaration;
/* @internal */
export function isRequireVariableDeclaration(node: ts.Node, requireStringLiteralLikeArgument: boolean): node is VariableDeclaration;
/* @internal */
export function isRequireVariableDeclaration(node: ts.Node, requireStringLiteralLikeArgument: boolean): node is VariableDeclaration {
    return isVariableDeclaration(node) && !!node.initializer && isRequireCall(node.initializer, requireStringLiteralLikeArgument);
}
/* @internal */
export function isRequireVariableDeclarationStatement(node: ts.Node, requireStringLiteralLikeArgument = true): node is VariableStatement {
...
/* @internal */
function getSingleVariableOfVariableStatement(node: ts.Node): VariableDeclaration | undefined {
...
/* @internal */
export function getJSDocCommentsAndTags(hostNode: ts.Node): readonly (JSDoc | JSDocTag)[] {
...
/* @internal */
export function getJSDocHost(node: ts.Node): HasJSDoc {
 ...
 */
/* @internal */
export function isWellKnownSymbolSyntactically(node: ts.Node): node is WellKnownSymbolExpression {
...
export function isESSymbolIdentifier(node: ts.Node): boolean {
    return node.kind === SyntaxKind.Identifier && (<ts.Identifier>node).escapedText === "Symbol";
}
/* @internal */
...
/* @internal */
export function hasModifier(node: ts.Node, flags: ModifierFlags): boolean {
...
/* @internal */
export function getSelectedModifierFlags(node: ts.Node, flags: ModifierFlags): ModifierFlags {
    return getModifierFlags(node) & flags;
}
/* @internal */
export function getModifierFlags(node: ts.Node): ModifierFlags {
...
/* @internal */
export function getModifierFlagsNoCache(node: ts.Node): ModifierFlags {
    ...
    if (node.flags & NodeFlags.NestedNamespace || (node.kind === SyntaxKind.Identifier && (<ts.Identifier>node).isInJSDocNamespace)) {
...
/* @internal */
export function getDeclarationModifierFlagsFromSymbol(s: ts.Symbol): ModifierFlags {
...
/* @internal */
function Node(this: ts.Node, kind: SyntaxKind, pos: number, end: number) {
    this.pos = pos;
    this.end = end;
    this.kind = kind;
    this.id = 0;
...
/* @internal */
function Token(this: ts.Node, kind: SyntaxKind, pos: number, end: number) {
    this.pos = pos;
    this.end = end;
    this.kind = kind;
    this.id = 0;
...
/* @internal */
function Identifier(this: ts.Node, kind: SyntaxKind, pos: number, end: number) {
    this.pos = pos;
    this.end = end;
    this.kind = kind;
    this.id = 0;
...
/* @internal */
export function discoverProbableSymlinks(files: readonly SourceFile[], getCanonicalFileName: GetCanonicalFileName, cwd: string): ts.ReadonlyMap<string> {
...
/* @internal */
export function typeOnlyDeclarationIsExport(typeOnlyDeclaration: ts.Node) {
...
/* @internal */
function isFirstIdentifierOfNonEmittingHeritageClause(node: ts.Node): boolean {
