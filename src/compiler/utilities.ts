...
namespace ts {
    ...
    export function isFutureReservedWord(token: SyntaxKind): boolean {
        return isKeyword(token) && SyntaxKind.FirstFutureReservedWord <= token && token <= SyntaxKind.LastFutureReservedWord;
    }
