import {
    ...
    getJSDocTypeParameterDeclarations, hasAccessorModifier, hasDecorators, HasDecorators, HasExpressionInitializer,
    HasInitializer, HasJSDoc, HasModifiers, hasProperty, hasSyntacticModifier, HasType, Identifier, ImportClause,
    ImportEqualsDeclaration, ImportOrExportSpecifier, ImportSpecifier, ImportTypeNode, isAccessExpression,
    isAmbientModule, isAnyImportOrReExport, isArrowFunction, isBinaryExpression,
