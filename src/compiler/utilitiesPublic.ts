import { pathIsRelative, isRootedDiskPath, Diagnostic, SortedReadonlyArray, sortAndDeduplicate, compareDiagnostics, CompilerOptions, ScriptTarget, TextSpan, TextRange, TextChangeRange, Declaration, SyntaxKind, Node, ParameterDeclaration, ConstructorDeclaration, Identifier, hasModifier, ModifierFlags, BindingName, BindingPattern, every, BindingElement, VariableDeclaration, getModifierFlags, NodeFlags, Push, createCompilerDiagnostic, Diagnostics, setUILocale, normalizePath, getDirectoryPath, combinePaths, setLocalizedDiagnosticMessages, __String, CharacterCodes, PrivateIdentifier, Symbol, JSDocTypedefTag, JSDocEnumTag, BinaryExpression, PropertyAccessExpression, ElementAccessExpression, Expression, some, NamedDeclaration, DeclarationName, JSDocPropertyLikeTag, CallExpression, getAssignmentDeclarationKind, AssignmentDeclarationKind, getElementOrPropertyAccessArgumentExpressionOrName, AccessExpression, BindableObjectDefinePropertyCall, ExportAssignment, isBindableStaticElementAccessExpression, isAccessExpression, JSDocParameterTag, Debug, emptyArray, TypeParameterDeclaration, JSDocTemplateTag, FunctionLikeDeclaration, SignatureDeclaration, JSDocAugmentsTag, JSDocImplementsTag, JSDocClassTag, JSDocPublicTag, JSDocPrivateTag, JSDocProtectedTag, JSDocReadonlyTag, JSDocThisTag, JSDocReturnTag, JSDocTypeTag, TypeNode, find, JSDocTag, JSDocContainer, getJSDocCommentsAndTags, flatMap, DeclarationWithTypeParameters, isJSDocTypeAlias, isInJSFile, getJSDocTypeParameterDeclarations, NumericLiteral, BigIntLiteral, StringLiteral, JsxText, RegularExpressionLiteral, NoSubstitutionTemplateLiteral, TemplateHead, TemplateMiddle, TemplateTail, QualifiedName, ComputedPropertyName, Decorator, PropertySignature, PropertyDeclaration, MethodSignature, MethodDeclaration, GetAccessorDeclaration, SetAccessorDeclaration, CallSignatureDeclaration, ConstructSignatureDeclaration, IndexSignatureDeclaration, AccessorDeclaration, TypePredicateNode, TypeReferenceNode, FunctionTypeNode, ConstructorTypeNode, TypeQueryNode, TypeLiteralNode, ArrayTypeNode, TupleTypeNode, UnionTypeNode, IntersectionTypeNode, ConditionalTypeNode, InferTypeNode, ParenthesizedTypeNode, ThisTypeNode, TypeOperatorNode, IndexedAccessTypeNode, MappedTypeNode, LiteralTypeNode, ImportTypeNode, ObjectBindingPattern, ArrayBindingPattern, ArrayLiteralExpression, ObjectLiteralExpression, PropertyAccessChain, ElementAccessChain, CallChain, OptionalChainRoot, OptionalChain, NewExpression, TaggedTemplateExpression, TypeAssertion, ParenthesizedExpression, PartiallyEmittedExpression, FunctionExpression, ArrowFunction, DeleteExpression, TypeOfExpression, VoidExpression, AwaitExpression, PrefixUnaryExpression, PostfixUnaryExpression, ConditionalExpression, TemplateExpression, YieldExpression, SpreadElement, ClassExpression, OmittedExpression, ExpressionWithTypeArguments, AsExpression, NonNullExpression, MetaProperty, TemplateSpan, SemicolonClassElement, Block, VariableStatement, EmptyStatement, ExpressionStatement, IfStatement, DoStatement, WhileStatement, ForStatement, ForInStatement, ForOfStatement, ContinueStatement, BreakStatement, BreakOrContinueStatement, ReturnStatement, WithStatement, SwitchStatement, LabeledStatement, ThrowStatement, TryStatement, DebuggerStatement, VariableDeclarationList, FunctionDeclaration, ClassDeclaration, InterfaceDeclaration, TypeAliasDeclaration, EnumDeclaration, ModuleDeclaration, ModuleBlock, CaseBlock, NamespaceExportDeclaration, ImportEqualsDeclaration, ImportDeclaration, ImportClause, NamespaceImport, NamespaceExport, NamedExportBindings, NamedImports, ImportSpecifier, ExportDeclaration, NamedExports, ExportSpecifier, MissingDeclaration, ExternalModuleReference, JsxElement, JsxSelfClosingElement, JsxOpeningElement, JsxClosingElement, JsxFragment, JsxOpeningFragment, JsxClosingFragment, JsxAttribute, JsxAttributes, JsxSpreadAttribute, JsxExpression, CaseClause, DefaultClause, HeritageClause, CatchClause, PropertyAssignment, ShorthandPropertyAssignment, SpreadAssignment, EnumMember, SourceFile, Bundle, UnparsedSource, UnparsedPrepend, UnparsedTextLike, UnparsedNode, JSDocTypeExpression, JSDocAllType, JSDocUnknownType, JSDocNullableType, JSDocNonNullableType, JSDocOptionalType, JSDocFunctionType, JSDocVariadicType, JSDoc, JSDocAuthorTag, JSDocPropertyTag, JSDocTypeLiteral, JSDocCallbackTag, JSDocSignature, SyntaxList, NodeArray, LiteralExpression, TypeOnlyCompatibleAliasDeclaration, ImportOrExportSpecifier, GeneratedIdentifier, GeneratedIdentifierFlags, PrivateIdentifierPropertyDeclaration, PrivateIdentifierPropertyAccessExpression, Modifier, modifierToFlag, EntityName, PropertyName, ClassElement, ClassLikeDeclaration, TypeElement, ObjectLiteralElementLike, isTypeNodeKind, AssignmentPattern, ArrayBindingElement, BindingOrAssignmentElement, BindingOrAssignmentElementTarget, BindingOrAssignmentPattern, ObjectBindingOrAssignmentPattern, ArrayBindingOrAssignmentPattern, CallLikeExpression, TemplateLiteral, LeftHandSideExpression, UnaryExpression, AssertionExpression, NotEmittedStatement, SyntheticReferenceExpression, IterationStatement, Statement, isAnyImportOrReExport, isAmbientModule, ForInOrOfStatement, ConciseBody, FunctionBody, ForInitializer, ModuleBody, NamespaceBody, JSDocNamespaceBody, NamedImportBindings, DeclarationStatement, isFunctionBlock, ModuleReference, JsxTagNameExpression, JsxChild, JsxAttributeLike, JsxOpeningLikeElement, CaseOrDefaultClause, HasJSDoc, HasType, HasInitializer, HasExpressionInitializer, ObjectLiteralElement, TypeReferenceType, isWhiteSpaceLike, StringLiteralLike } from "./ts";
...
export function getJSDocTypeParameterTags(param: TypeParameterDeclaration): readonly JSDocTemplateTag[] {
    const name = param.name.escapedText;
    return getJSDocTags(param.parent).filter((tag): tag is JSDocTemplateTag => isJSDocTemplateTag(tag) && tag.typeParameters.some(tp => tp.name.escapedText === name));
}
/**
