import { Node, NodeArray, reduceLeft, SyntaxKind, QualifiedName, ComputedPropertyName, ParameterDeclaration, Decorator, PropertySignature, PropertyDeclaration, MethodDeclaration, ConstructorDeclaration, GetAccessorDeclaration, BindingPattern, BindingElement, ArrayLiteralExpression, ObjectLiteralExpression, PropertyAccessExpression, ElementAccessExpression, CallExpression, NewExpression, TaggedTemplateExpression, TypeAssertion, FunctionExpression, ArrowFunction, ParenthesizedExpression, DeleteExpression, TypeOfExpression, VoidExpression, AwaitExpression, YieldExpression, SpreadElement, NonNullExpression, PrefixUnaryExpression, PostfixUnaryExpression, BinaryExpression, ConditionalExpression, TemplateExpression, ClassExpression, ExpressionWithTypeArguments, AsExpression, TemplateSpan, Block, VariableStatement, ExpressionStatement, IfStatement, DoStatement, WhileStatement, WithStatement, ForStatement, ForInOrOfStatement, ReturnStatement, SwitchStatement, LabeledStatement, TryStatement, VariableDeclaration, VariableDeclarationList, FunctionDeclaration, ClassDeclaration, EnumDeclaration, ModuleDeclaration, ModuleBlock, CaseBlock, ImportEqualsDeclaration, ImportDeclaration, ImportClause, NamespaceImport, NamespaceExport, NamedImports, NamedExports, ImportSpecifier, ExportSpecifier, ExportAssignment, ExportDeclaration, ExternalModuleReference, JsxElement, JsxFragment, JsxSelfClosingElement, JsxOpeningElement, JsxAttributes, JsxClosingElement, JsxAttribute, JsxSpreadAttribute, JsxExpression, CaseClause, DefaultClause, HeritageClause, CatchClause, PropertyAssignment, ShorthandPropertyAssignment, SpreadAssignment, EnumMember, SourceFile, PartiallyEmittedExpression, CommaListExpression, Statement, some, isNodeArray, setTextRange, createNodeArray, insertStatementsAfterStandardPrologue, Debug, every, isStatement, singleOrUndefined, createBlock, TransformFlags, getTransformFlagsSubtreeExclusions, computeTransformFlagsForNode, hasModifier, ModifierFlags, isTypeNode } from "./ts";
/* @internal */
