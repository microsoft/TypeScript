namespace ts {
     ...
     */
    export function visitLexicalEnvironment(statements: NodeArray<Statement>, visitor: Visitor, context: CoreTransformationContext, start?: number, ensureUseStrict?: boolean) {
        const { factory, startLexicalEnvironment, endLexicalEnvironment } = context;
    ...
    export function visitFunctionBody(node: ConciseBody | undefined, visitor: Visitor, context: CoreTransformationContext): ConciseBody | undefined {
        const { factory, resumeLexicalEnvironment, endLexicalEnvironment } = context;
    ...
    export function visitEachChild(node: Node | undefined, visitor: Visitor, context: CoreTransformationContext, nodesVisitor = visitNodes, tokenVisitor?: Visitor): Node | undefined {
        if (node === undefined) {
            return undefined;
        }
        ...
        switch (kind) {
            ...
            case SyntaxKind.Block:
                return factory.updateBlock(<Block>node,
                    nodesVisitor((<Block>node).statements, visitor, isStatementOrBlock));
            ...
            case SyntaxKind.IfStatement:
                return factory.updateIf(<IfStatement>node,
                    ...
                    visitNode((<IfStatement>node).thenStatement, visitor, isStatementOrBlock, factory.liftToBlock),
                    visitNode((<IfStatement>node).elseStatement, visitor, isStatementOrBlock, factory.liftToBlock));

            case SyntaxKind.DoStatement:
                return factory.updateDo(<DoStatement>node,
                    visitNode((<DoStatement>node).statement, visitor, isStatementOrBlock, factory.liftToBlock),
            ...
            case SyntaxKind.WhileStatement:
                return factory.updateWhile(<WhileStatement>node,
                    ...
                    visitNode((<WhileStatement>node).statement, visitor, isStatementOrBlock, factory.liftToBlock));
            ...
            case SyntaxKind.ForStatement:
                return factory.updateFor(<ForStatement>node,
                    ...
                    visitNode((<ForStatement>node).statement, visitor, isStatementOrBlock, factory.liftToBlock));
            ...
            case SyntaxKind.ForInStatement:
                return factory.updateForIn(<ForInStatement>node,
                    ...
                    visitNode((<ForInStatement>node).statement, visitor, isStatementOrBlock, factory.liftToBlock));
            ...
            case SyntaxKind.ForOfStatement:
                return factory.updateForOf(<ForOfStatement>node,
                    ...
                    visitNode((<ForOfStatement>node).statement, visitor, isStatementOrBlock, factory.liftToBlock));
            ...
            case SyntaxKind.WithStatement:
                return factory.updateWith(<WithStatement>node,
                    ...
                    visitNode((<WithStatement>node).statement, visitor, isStatementOrBlock, factory.liftToBlock));
            ...
            case SyntaxKind.LabeledStatement:
                return factory.updateLabel(<LabeledStatement>node,
                    ...
                    visitNode((<LabeledStatement>node).statement, visitor, isStatementOrBlock, factory.liftToBlock));
            ...
            case SyntaxKind.ModuleBlock:
                return factory.updateModuleBlock(<ModuleBlock>node,
                    nodesVisitor((<ModuleBlock>node).statements, visitor, isStatementOrBlock));
            ...
            case SyntaxKind.CaseClause:
                return factory.updateCaseClause(<CaseClause>node,
                    ...
                    nodesVisitor((<CaseClause>node).statements, visitor, isStatementOrBlock));

            case SyntaxKind.DefaultClause:
                return factory.updateDefaultClause(<DefaultClause>node,
                    nodesVisitor((<DefaultClause>node).statements, visitor, isStatementOrBlock));
