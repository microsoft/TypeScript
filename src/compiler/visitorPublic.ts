namespace ts {
    ...
    const visitEachChildTable: VisitEachChildTable = {
        ...
        [SyntaxKind.DoExpression]: function visitEachChildOfDoExpression(node, visitor, context, _nodesVisitor, nodeVisitor, _tokenVisitor) {
            return context.factory.updateDoExpression(node,
            node.async, nodeVisitor(node.block, visitor, isBlock));
        },
