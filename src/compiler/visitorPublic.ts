import { or, isTypeNode, isTypeParameterDeclaration, Node, Visitor, NodeArray, aggregateTransformFlags, isArray, Debug, MutableNodeArray, createNodeArray, setTextRange, Statement, TransformationContext, isStatement, mergeLexicalEnvironment, ParameterDeclaration, isParameterDeclaration, FunctionBody, ConciseBody, isConciseBody, some, convertToFunctionBody, updateBlock, SyntaxKind, updateIdentifier, Identifier, updateQualifiedName, QualifiedName, isEntityName, isIdentifier, updateComputedPropertyName, ComputedPropertyName, isExpression, updateTypeParameterDeclaration, TypeParameterDeclaration, updateParameter, isDecorator, isModifier, isToken, isBindingName, updateDecorator, Decorator, updatePropertySignature, PropertySignature, isPropertyName, updateProperty, PropertyDeclaration, updateMethodSignature, MethodSignature, updateMethod, MethodDeclaration, updateConstructor, ConstructorDeclaration, updateGetAccessor, GetAccessorDeclaration, updateSetAccessor, SetAccessorDeclaration, updateCallSignature, CallSignatureDeclaration, updateConstructSignature, ConstructSignatureDeclaration, updateIndexSignature, IndexSignatureDeclaration, updateTypePredicateNodeWithModifier, TypePredicateNode, updateTypeReferenceNode, TypeReferenceNode, updateFunctionTypeNode, FunctionTypeNode, updateConstructorTypeNode, ConstructorTypeNode, updateTypeQueryNode, TypeQueryNode, updateTypeLiteralNode, TypeLiteralNode, isTypeElement, updateArrayTypeNode, ArrayTypeNode, updateTupleTypeNode, TupleTypeNode, updateOptionalTypeNode, OptionalTypeNode, updateRestTypeNode, RestTypeNode, updateUnionTypeNode, UnionTypeNode, updateIntersectionTypeNode, IntersectionTypeNode, updateConditionalTypeNode, ConditionalTypeNode, updateInferTypeNode, InferTypeNode, updateImportTypeNode, ImportTypeNode, updateParenthesizedType, ParenthesizedTypeNode, updateTypeOperatorNode, TypeOperatorNode, updateIndexedAccessTypeNode, IndexedAccessTypeNode, updateMappedTypeNode, MappedTypeNode, updateLiteralTypeNode, LiteralTypeNode, updateObjectBindingPattern, ObjectBindingPattern, isBindingElement, updateArrayBindingPattern, ArrayBindingPattern, isArrayBindingElement, updateBindingElement, BindingElement, updateArrayLiteral, ArrayLiteralExpression, updateObjectLiteral, ObjectLiteralExpression, isObjectLiteralElementLike, NodeFlags, updatePropertyAccessChain, PropertyAccessChain, updatePropertyAccess, PropertyAccessExpression, isIdentifierOrPrivateIdentifier, updateElementAccessChain, ElementAccessChain, updateElementAccess, ElementAccessExpression, updateCallChain, CallChain, updateCall, CallExpression, updateNew, NewExpression, updateTaggedTemplate, TaggedTemplateExpression, isTemplateLiteral, updateTypeAssertion, TypeAssertion, updateParen, ParenthesizedExpression, updateFunctionExpression, FunctionExpression, updateArrowFunction, ArrowFunction, updateDelete, DeleteExpression, updateTypeOf, TypeOfExpression, updateVoid, VoidExpression, updateAwait, AwaitExpression, updatePrefix, PrefixUnaryExpression, updatePostfix, PostfixUnaryExpression, updateBinary, BinaryExpression, updateConditional, ConditionalExpression, updateTemplateExpression, TemplateExpression, isTemplateHead, isTemplateSpan, updateYield, YieldExpression, updateSpread, SpreadElement, updateClassExpression, ClassExpression, isHeritageClause, isClassElement, updateExpressionWithTypeArguments, ExpressionWithTypeArguments, updateAsExpression, AsExpression, updateNonNullExpression, NonNullExpression, updateMetaProperty, MetaProperty, updateTemplateSpan, TemplateSpan, isTemplateMiddleOrTemplateTail, Block, updateVariableStatement, VariableStatement, isVariableDeclarationList, updateExpressionStatement, ExpressionStatement, updateIf, IfStatement, liftToBlock, updateDo, DoStatement, updateWhile, WhileStatement, updateFor, ForStatement, isForInitializer, updateForIn, ForInStatement, updateForOf, ForOfStatement, updateContinue, ContinueStatement, updateBreak, BreakStatement, updateReturn, ReturnStatement, updateWith, WithStatement, updateSwitch, SwitchStatement, isCaseBlock, updateLabel, LabeledStatement, updateThrow, ThrowStatement, updateTry, TryStatement, isBlock, isCatchClause, updateTypeScriptVariableDeclaration, VariableDeclaration, updateVariableDeclarationList, VariableDeclarationList, isVariableDeclaration, updateFunctionDeclaration, FunctionDeclaration, updateClassDeclaration, ClassDeclaration, updateInterfaceDeclaration, InterfaceDeclaration, updateTypeAliasDeclaration, TypeAliasDeclaration, updateEnumDeclaration, EnumDeclaration, isEnumMember, updateModuleDeclaration, ModuleDeclaration, isModuleBody, updateModuleBlock, ModuleBlock, updateCaseBlock, CaseBlock, isCaseOrDefaultClause, updateNamespaceExportDeclaration, NamespaceExportDeclaration, updateImportEqualsDeclaration, ImportEqualsDeclaration, isModuleReference, updateImportDeclaration, ImportDeclaration, isImportClause, updateImportClause, ImportClause, isNamedImportBindings, updateNamespaceImport, NamespaceImport, updateNamespaceExport, NamespaceExport, updateNamedImports, NamedImports, isImportSpecifier, updateImportSpecifier, ImportSpecifier, updateExportAssignment, ExportAssignment, updateExportDeclaration, ExportDeclaration, isNamedExportBindings, updateNamedExports, NamedExports, isExportSpecifier, updateExportSpecifier, ExportSpecifier, updateExternalModuleReference, ExternalModuleReference, updateJsxElement, JsxElement, isJsxOpeningElement, isJsxChild, isJsxClosingElement, updateJsxSelfClosingElement, JsxSelfClosingElement, isJsxTagNameExpression, isJsxAttributes, updateJsxOpeningElement, JsxOpeningElement, updateJsxClosingElement, JsxClosingElement, updateJsxFragment, JsxFragment, isJsxOpeningFragment, isJsxClosingFragment, updateJsxAttribute, JsxAttribute, isStringLiteralOrJsxExpression, updateJsxAttributes, JsxAttributes, isJsxAttributeLike, updateJsxSpreadAttribute, JsxSpreadAttribute, updateJsxExpression, JsxExpression, updateCaseClause, CaseClause, updateDefaultClause, DefaultClause, updateHeritageClause, HeritageClause, isExpressionWithTypeArguments, updateCatchClause, CatchClause, updatePropertyAssignment, PropertyAssignment, updateShorthandPropertyAssignment, ShorthandPropertyAssignment, updateSpreadAssignment, SpreadAssignment, updateEnumMember, EnumMember, updateSourceFileNode, SourceFile, updatePartiallyEmittedExpression, PartiallyEmittedExpression, updateCommaList, CommaListExpression, singleOrUndefined } from "./ts";
...
export function visitEachChild(node: Node | undefined, visitor: Visitor, context: TransformationContext, nodesVisitor = visitNodes, tokenVisitor?: Visitor): Node | undefined {
    ...
    switch (kind) {
        ...
        case SyntaxKind.PropertyDeclaration:
            return updateProperty((<PropertyDeclaration>node), nodesVisitor((<PropertyDeclaration>node).decorators, visitor, isDecorator), nodesVisitor((<PropertyDeclaration>node).modifiers, visitor, isModifier), visitNode((<PropertyDeclaration>node).name, visitor, isPropertyName), 
            // QuestionToken and ExclamationToken is uniqued in Property Declaration and the signature of 'updateProperty' is that too
            visitNode((<PropertyDeclaration>node).questionToken || (<PropertyDeclaration>node).exclamationToken, tokenVisitor, isToken), visitNode((<PropertyDeclaration>node).type, visitor, isTypeNode), visitNode((<PropertyDeclaration>node).initializer, visitor, isExpression));
        ...
        case SyntaxKind.TupleType:
            return updateTupleTypeNode((<TupleTypeNode>node), nodesVisitor((<TupleTypeNode>node).elementTypes, visitor, isTypeNode));
        ...
        case SyntaxKind.PropertyAccessExpression:
            if (node.flags & NodeFlags.OptionalChain) {
                return updatePropertyAccessChain((<PropertyAccessChain>node), visitNode((<PropertyAccessChain>node).expression, visitor, isExpression), visitNode((<PropertyAccessChain>node).questionDotToken, visitor, isToken), visitNode((<PropertyAccessChain>node).name, visitor, isIdentifier));
            }
        ...
        case SyntaxKind.ElementAccessExpression:
            if (node.flags & NodeFlags.OptionalChain) {
                return updateElementAccessChain((<ElementAccessChain>node), visitNode((<ElementAccessChain>node).expression, visitor, isExpression), visitNode((<ElementAccessChain>node).questionDotToken, visitor, isToken), visitNode((<ElementAccessChain>node).argumentExpression, visitor, isExpression));
            }
        ...
        case SyntaxKind.CallExpression:
            if (node.flags & NodeFlags.OptionalChain) {
                return updateCallChain((<CallChain>node), visitNode((<CallChain>node).expression, visitor, isExpression), visitNode((<CallChain>node).questionDotToken, visitor, isToken), nodesVisitor((<CallChain>node).typeArguments, visitor, isTypeNode), nodesVisitor((<CallChain>node).arguments, visitor, isExpression));
            }
        ...
        case SyntaxKind.BinaryExpression:
            return updateBinary((<BinaryExpression>node), visitNode((<BinaryExpression>node).left, visitor, isExpression), visitNode((<BinaryExpression>node).right, visitor, isExpression), visitNode((<BinaryExpression>node).operatorToken, visitor, isToken));
        case SyntaxKind.ConditionalExpression:
            return updateConditional((<ConditionalExpression>node), visitNode((<ConditionalExpression>node).condition, visitor, isExpression), visitNode((<ConditionalExpression>node).questionToken, visitor, isToken), visitNode((<ConditionalExpression>node).whenTrue, visitor, isExpression), visitNode((<ConditionalExpression>node).colonToken, visitor, isToken), visitNode((<ConditionalExpression>node).whenFalse, visitor, isExpression));
        ...
        case SyntaxKind.ForOfStatement:
            return updateForOf((<ForOfStatement>node), visitNode((<ForOfStatement>node).awaitModifier, visitor, isToken), visitNode((<ForOfStatement>node).initializer, visitor, isForInitializer), visitNode((<ForOfStatement>node).expression, visitor, isExpression), visitNode((<ForOfStatement>node).statement, visitor, isStatement, liftToBlock));
