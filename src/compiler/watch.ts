import { FormatDiagnosticsHost, sys, createGetCanonicalFileName, System, DiagnosticReporter, formatDiagnostic, Diagnostic, formatDiagnosticsWithColorAndContext, CompilerOptions, contains, Diagnostics, WatchStatusReporter, formatColorAndReset, ForegroundColorEscapeSequences, flattenDiagnosticMessageText, WatchOptions, ParseConfigFileHost, getParsedCommandLineOfConfigFile, countWhere, DiagnosticCategory, createCompilerDiagnostic, SourceFile, CancellationToken, DiagnosticWithLocation, WriteFileCallback, CustomTransformers, EmitResult, forEach, ReportEmitErrorSummary, addRange, emptyArray, sortAndDeduplicateDiagnostics, getNormalizedAbsolutePath, ExitStatus, FileWatcher, noop, WatchHost, maybeBind, WatchLogLevel, getWatchFactory, ProgramHost, DirectoryStructureHost, CompilerHost, memoize, createSourceFile, getNewLineCharacter, writeFileEnsuringDirectories, generateDjb2Hash, BuilderProgram, EmitAndSemanticDiagnosticsBuilderProgram, CreateProgram, getDirectoryPath, normalizePath, combinePaths, getDefaultLibFileName, createEmitAndSemanticDiagnosticsBuilderProgram, WatchCompilerHost, copyProperties, WatchCompilerHostOfConfigFile, ProjectReference, WatchCompilerHostOfFilesAndCompilerOptions, createIncrementalCompilerHost, createIncrementalProgram } from "./ts";
