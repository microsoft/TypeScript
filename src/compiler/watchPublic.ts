import { CompilerOptions, getTsBuildInfoEmitOutputFilePath, getBuildInfo, version, createBuildProgramUsingProgramBuildInfo, sys, CompilerHost, createCompilerHostWorker, maybeBind, setGetSourceFileAsHashVersioned, changeCompilerHostLikeToUseCache, toPath, BuilderProgram, Diagnostic, ProjectReference, EmitAndSemanticDiagnosticsBuilderProgram, createEmitAndSemanticDiagnosticsBuilderProgram, FileWatcherCallback, FileWatcher, DirectoryWatcherCallback, ResolvedProjectReference, ResolvedModule, ResolvedTypeReferenceDirective, CachedDirectoryStructureHost, WatchOptions, ConfigFileDiagnosticsReporter, ParsedCommandLine, System, DiagnosticReporter, isArray, createWatchCompilerHostOfFilesAndCompilerOptions, createWatchCompilerHostOfConfigFile, SourceFile, ConfigFileProgramReloadLevel, WildcardDirectoryWatcher, createMap, Path, ConfigFileSpecs, createCachedDirectoryStructureHost, DirectoryStructureHost, parseConfigHostFromCompilerHostLike, Diagnostics, getNewLineCharacter, Debug, createWatchFactory, createGetCanonicalFileName, PollingInterval, WatchType, createCompilerHostFromProgramHost, ResolutionCacheHost, returnFalse, createResolutionCache, getDirectoryPath, getNormalizedAbsolutePath, clearMap, closeFileWatcherOf, closeFileWatcher, changesAffectModuleResolution, isProgramUptoDate, HasInvalidatedResolution, updateMissingFilePathsWatch, ScriptTarget, DiagnosticMessage, createCompilerDiagnostic, perfLogger, getFileNamesFromConfigSpecs, updateErrorForNoInputFiles, getParsedCommandLineOfConfigFile, getConfigFileParsingDiagnostics, canJsonReportNoInutFiles, FileWatcherEventKind, updateWatchingWildcardDirectories, createMapFromTemplate, WatchDirectoryFlags, removeIgnoredPath, hasExtension, isSupportedSourceFileName } from "./ts";
...
export function createWatchProgram<T extends BuilderProgram>(host: WatchCompilerHostOfFilesAndCompilerOptions<T> & WatchCompilerHostOfConfigFile<T>): WatchOfFilesAndCompilerOptions<T> | WatchOfConfigFile<T> {
    ...
    let missingFilesMap: ts.Map<FileWatcher>; // Map of file watchers for the missing files
    let watchedWildcardDirectories: ts.Map<WildcardDirectoryWatcher>; // map of watchers for the wild card directories in the config file
