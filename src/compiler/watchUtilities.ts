import { Path, FileWatcherEventKind, createMap, createGetCanonicalFileName, ensureTrailingDirectorySeparator, getDirectoryPath, getBaseFileName, normalizePath, map, Debug, some, filterMutate, matchFiles, FileSystemEntries, emptyFileSystemEntries, Program, FileWatcher, arrayToSet, mutateMap, closeFileWatcher, WatchDirectoryFlags, FileWatcherCallback, WatchOptions, DirectoryWatcherCallback, PollingInterval, sysLog, noop, setSysLog, timestamp, WatchFileKind } from "./ts";
 ...
 */
/* @internal */
export function updateMissingFilePathsWatch(program: Program, missingFileWatches: ts.Map<FileWatcher>, createMissingFileWatch: (missingFilePath: Path) => FileWatcher) {
 ...
 */
/* @internal */
export function updateWatchingWildcardDirectories(existingWatchedForWildcards: ts.Map<WildcardDirectoryWatcher>, wildcardDirectories: ts.Map<WatchDirectoryFlags>, watchDirectory: (directory: string, flags: WatchDirectoryFlags) => FileWatcher) {
...
/* @internal */
function getWatchFactoryWith<X, Y = undefined>(watchLogLevel: WatchLogLevel, log: (s: string) => void, getDetailWatchInfo: GetDetailWatchInfo<X, Y> | undefined, watchFile: (host: WatchFileHost, file: string, callback: FileWatcherCallback, watchPriority: PollingInterval, options: WatchOptions | undefined) => FileWatcher, watchDirectory: (host: WatchDirectoryHost, directory: string, callback: DirectoryWatcherCallback, flags: WatchDirectoryFlags, options: WatchOptions | undefined) => FileWatcher): WatchFactory<X, Y> {
