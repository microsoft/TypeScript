import {
    ...
    ModuleBody, ModuleDeclaration, ModuleName, ModuleReference, NamedExportBindings, Node, NodeFactory, NodeFlags,
    ParameterDeclaration, PropertyDeclaration, PropertyName, QuestionToken, SetAccessorDeclaration,
