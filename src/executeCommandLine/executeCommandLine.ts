import { Program, forEach, getLineStarts, System, DiagnosticReporter, CompilerOptions, BuildOptions, createDiagnosticReporter, ParsedCommandLine, sort, optionDeclarations, compareStringsCaseInsensitive, filter, getDiagnosticText, Diagnostics, version, CommandLineOption, createMap, CommandLineOptionOfListType, arrayFrom, createCompilerDiagnostic, ExitStatus, validateLocaleAndSetLanguage, normalizePath, combinePaths, findConfigFile, convertToOptionsWithAbsolutePaths, getNormalizedAbsolutePath, parseConfigFileWithSystem, convertToTSConfig, isWatchSet, isIncrementalCompilation, CharacterCodes, EmitAndSemanticDiagnosticsBuilderProgram, parseBuildCommand, parseCommandLine, WatchOptions, Diagnostic, buildOpts, createSolutionBuilderWithWatchHost, createBuilderStatusReporter, createSolutionBuilderWithWatch, createSolutionBuilderHost, createSolutionBuilder, ReportEmitErrorSummary, getErrorSummaryText, createCompilerHostWorker, createGetCanonicalFileName, changeCompilerHostLikeToUseCache, toPath, CreateProgramOptions, getConfigFileParsingDiagnostics, createProgram, emitFilesAndReportErrorsAndGetExitStatus, createIncrementalCompilerHost, SolutionBuilderHostBase, BuilderProgram, CreateProgram, Debug, WatchCompilerHost, createWatchCompilerHostOfConfigFile, createWatchProgram, createWatchCompilerHostOfFilesAndCompilerOptions, sys, performance, padRight, padLeft, generateTSConfig } from "./ts";
...
function executeCommandLineWorker(sys: System, cb: ExecuteCommandLineCallbacks, commandLine: ParsedCommandLine, maxNumberOfFilesToIterateForInvalidation: number | undefined) {
...
export function executeCommandLine(system: System, cb: ExecuteCommandLineCallbacks, commandLineArgs: readonly string[], maxNumberOfFilesToIterateForInvalidation?: number) {
    ...
    if (commandLine.options.generateCpuProfile && system.enableCPUProfiler) {
        system.enableCPUProfiler(commandLine.options.generateCpuProfile, () => executeCommandLineWorker(system, cb, commandLine, maxNumberOfFilesToIterateForInvalidation));
    }
    else {
...
function updateWatchCompilationHost(sys: System, cb: ExecuteCommandLineCallbacks, watchCompilerHost: WatchCompilerHost<EmitAndSemanticDiagnosticsBuilderProgram>, maxNumberOfFilesToIterateForInvalidation: number | undefined) {
...
function createWatchOfConfigFile(sys: System, cb: ExecuteCommandLineCallbacks, reportDiagnostic: DiagnosticReporter, configParseResult: ParsedCommandLine, optionsToExtend: CompilerOptions, watchOptionsToExtend: WatchOptions | undefined, maxNumberOfFilesToIterateForInvalidation: number | undefined) {
    const watchCompilerHost = createWatchCompilerHostOfConfigFile((configParseResult.options.configFilePath!), optionsToExtend, watchOptionsToExtend, sys, 
...
function createWatchOfFilesAndCompilerOptions(sys: System, cb: ExecuteCommandLineCallbacks, reportDiagnostic: DiagnosticReporter, rootFiles: string[], options: CompilerOptions, watchOptions: WatchOptions | undefined, maxNumberOfFilesToIterateForInvalidation: number | undefined) {
    const watchCompilerHost = createWatchCompilerHostOfFilesAndCompilerOptions(rootFiles, options, watchOptions, sys, 
