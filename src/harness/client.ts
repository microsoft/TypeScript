namespace ts.server {
    ...
    export class SessionClient implements LanguageService {
        ...
        getRenameInfo(fileName: string, position: number, _preferences: UserPreferences, _options?: RenameInfoOptions, findInStrings?: boolean, findInComments?: boolean): RenameInfo {
        ...
        findRenameLocations(fileName: string, position: number, findInStrings: boolean, findInComments: boolean, providePrefixAndSuffixTextForRename?: boolean): RenameLocation[] {
            if (!this.lastRenameEntry ||
                ...
                if (providePrefixAndSuffixTextForRename !== undefined) {
                    ...
                    this.getRenameInfo(fileName, position, /*preferences*/{}, /*options*/{}, findInStrings, findInComments);
