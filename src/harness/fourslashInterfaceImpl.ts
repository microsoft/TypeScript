...
import { TextSpan, createTextSpan, Symbol, MapLike, LineAndCharacter, SignatureHelpTriggerReason, JsxClosingTagInfo, IndentStyle, OutputFile, ReferenceEntry, SymbolDisplayPart, FormatCodeSettings, UserPreferences, RenameInfoOptions, JSDocTagInfo, FormatCodeOptions, ClassificationTypeNames, SyntaxKind, tokenToString, contains, Completions, CompletionsTriggerCharacter, ScriptElementKind, PatternMatchKind, CodeActionCommand, ApplicableRefactorInfo } from "./ts";
...
export class Verify extends VerifyNegatable {
    ...
    public goToDefinition(startsAndEnds: [ArrayOrSingle<string>, ArrayOrSingle<string>][] | {
    ...
    public goToType(startsAndEnds: [ArrayOrSingle<string>, ArrayOrSingle<string>][] | {
        [startMarkerName: string]: ArrayOrSingle<string>;
    }): void;
    ...
    public referenceGroups(starts: ArrayOrSingle<string> | ArrayOrSingle<Range>, parts: ReferenceGroup[]) {
        this.state.verifyReferenceGroups(starts, parts);
    }
    public noReferences(markerNameOrRange?: string | Range) {
        this.state.verifyNoReferences(markerNameOrRange);
    }
    public getReferencesForServerTest(expected: readonly ReferenceEntry[]) {
    ...
    public docCommentTemplateAt(marker: string | Marker, expectedOffset: number, expectedText: string) {
...
export namespace Completion {
    ...
    export const typeKeywords: readonly ExpectedCompletionEntryObject[] = ["false", "null", "true", "void", "asserts", "any", "boolean", "keyof", "never", "readonly", "number", "object", "string", "symbol", "undefined", "unique", "unknown", "bigint"].map(keywordEntry);
    ...
    export const classElementKeywords: readonly ExpectedCompletionEntryObject[] = ["private", "protected", "public", "static", "abstract", "async", "constructor", "declare", "get", "readonly", "set"].map(keywordEntry);
    export const classElementInJsKeywords = getInJsKeywords(classElementKeywords);
    export const constructorParameterKeywords: readonly ExpectedCompletionEntryObject[] = ["private", "protected", "public", "readonly"].map((name): ExpectedCompletionEntryObject => ({
        name,
        kind: "keyword",
        sortText: SortText.GlobalsOrKeywords
    }));
