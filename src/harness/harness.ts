...
namespace Harness {
    ...
    export function getDefaultLibraryFile(io: Harness.IO, fileName = Harness.Compiler.defaultLibFileName): Harness.Compiler.TestFile {
        const libFile = Harness.userSpecifiedRoot + Harness.libFolder + fileName;
