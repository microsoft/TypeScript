...
import { LanguageService, TextChangeRange, computeLineStarts, createTextChangeRange, createTextSpanFromBounds, unchangedTextChangeRange, collapseTextChangeRangesAcrossMultipleVersions, IScriptSnapshot, ScriptSnapshotShim, HostCancellationToken, Classifier, PreProcessedFileInfo, getDefaultCompilerOptions, getDirectoryPath, getPathUpdater, createGetCanonicalFileName, LineAndCharacter, computeLineAndCharacterOfPosition, computePositionOfLineAndCharacter, LanguageServiceHost, notImplemented, isAnySupportedFileExtension, ScriptKind, noop, CompilerOptions, createLanguageService, createClassifier, preProcessFile, hasJSFileExtension, LanguageServiceShimHost, CoreServicesShimHost, ModuleResolutionHost, MapLike, resolveModuleName, ResolvedTypeReferenceDirective, resolveTypeReferenceDirective, getSnapshotText, ClassifierShim, EndOfLineState, Classifications, ClassificationResult, ClassificationInfo, OperationCanceledException, LanguageServiceShim, DiagnosticWithLocation, Diagnostic, TextSpan, ClassifiedSpan, UserPreferences, CompletionInfo, FormatCodeOptions, CompletionEntryDetails, Symbol, QuickInfo, SignatureHelpItemsOptions, SignatureHelpItems, RenameInfoOptions, RenameInfo, SelectionRange, RenameLocation, DefinitionInfo, DefinitionInfoAndBoundSpan, ImplementationLocation, ReferenceEntry, ReferencedSymbol, DocumentHighlights, NavigateToItem, NavigationBarItem, NavigationTree, OutliningSpan, TodoCommentDescriptor, TodoComment, EditorOptions, TextChange, TextInsertion, RefactorEditInfo, ApplicableRefactorInfo, OrganizeImportsScope, FormatCodeSettings, FileTextChanges, EmitOutput, Program, SourceFile, TypeScriptServicesFactory, ShimsFileReference, forEach, server, stringContains, sys, FileWatcher, RequireResult, toPath, DiagnosticCategory, Debug } from "./ts";
