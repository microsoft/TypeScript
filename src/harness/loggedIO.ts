...
import { System, combinePaths, createGetCanonicalFileName, toPath, normalizeSlashes, startsWith, forEach, createMap, CompilerOptions, parseCommandLine, isRootedDiskPath, normalizePath, flatMap, AnyFunction } from "./ts";
...
function initWrapper(wrapper: PlaybackIO, underlying: IO): void;
function initWrapper(wrapper: PlaybackSystem | PlaybackIO, underlying: System | IO): void {
