...
class ProjectRunner extends RunnerBase {
    ...
    private runProjectTestCase(testCaseFileName: string) {
        ...
        try {
            ...
            throw new Error("Unable to open testcase file: " + testCaseFileName + ": " + e.message);
        }
        ...
        try {
            ...
            throw new Error("Testcase: " + testCaseFileName + " does not contain valid json format: " + e.message);
        }
