    ...
    describe("matchFiles", () => {
        ...
        describe("with literal include list", () => {
            ...
            it("with non .ts file extensions are excluded", () => {
                ...
                validateMatches(expected, json, caseInsensitiveHost, caseInsensitiveBasePath, undefined, caseInsensitiveTsconfigPath);
            });
        ...
        describe("with files or folders that begin with a .", () => {
            ...
            describe("that are explicitly included", () => {
                ...
                it("with wildcard excludes that implicitly exclude dotted files", () => {
                    ...
                    validateMatches(expected, json, caseInsensitiveDottedFoldersHost, caseInsensitiveBasePath, undefined, caseInsensitiveTsconfigPath);
                });
            });
        });
    });
