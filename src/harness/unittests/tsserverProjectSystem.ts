...
namespace ts.projectSystem {
    ...
    describe("tsserverProjectSystem", () => {
        ...
        it("reload regular file after closing", () => {
            ...
            const completions1 = service.externalProjects[0].getLanguageService().getCompletionsAtPosition(f1.path, 2, { includeCompletionsWithActions: false });
            // should contain completions for string
            assert.isTrue(completions1.entries.some(e => e.name === "charAt"), "should contain 'charAt'");
            assert.isFalse(completions1.entries.some(e => e.name === "toExponential"), "should not contain 'toExponential'");

            service.closeClientFile(f2.path);
            const completions2 = service.externalProjects[0].getLanguageService().getCompletionsAtPosition(f1.path, 2, { includeCompletionsWithActions: false });
            // should contain completions for string
        ...
        it("clear mixed content file after closing", () => {
            ...
            const completions1 = service.externalProjects[0].getLanguageService().getCompletionsAtPosition(f1.path, 0, { includeCompletionsWithActions: false });
            assert.isTrue(completions1.entries.some(e => e.name === "somelongname"), "should contain 'somelongname'");

            service.closeClientFile(f2.path);
            const completions2 = service.externalProjects[0].getLanguageService().getCompletionsAtPosition(f1.path, 0, { includeCompletionsWithActions: false });
        ...
        it("tsconfig script block support", () => {
            ...
            const project = configuredProjectAt(projectService, 0);
            let completions = project.getLanguageService().getCompletionsAtPosition(file1.path, 1, { includeCompletionsWithActions: false });
            ...
            completions = project.getLanguageService().getCompletionsAtPosition(file1.path, 5, { includeCompletionsWithActions: false });
