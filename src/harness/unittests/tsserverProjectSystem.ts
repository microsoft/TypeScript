...
namespace ts.projectSystem {
    ...
    function isFolder(s: FSEntry | undefined): s is Folder {
        return s && isArray((<Folder>s).entries);
    }

    function isFile(s: FSEntry | undefined): s is File {
    ...
    function checkWatchedDirectories(host: TestServerHost, expectedDirectories: string[], recursive = false) {
