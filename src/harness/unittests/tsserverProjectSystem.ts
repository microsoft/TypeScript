...
namespace ts.projectSystem {
    ...
    export function openFilesForSession(files: string[], session: server.Session) {
        for (const file of files) {
            const request = makeSessionRequest<protocol.OpenRequestArgs>(CommandNames.Open, { file });
    ...
    function createServerHost(files: FileOrFolder[], options?: Partial<fakes.FakeServerHostOptions>) {
        return new fakes.FakeServerHost(options, files.reduce((map, file) => (map[file.path] = isString(file.content) ? file.content : {}, map), {} as vfs.FileSet));
    }
        ...
        describe("general functionality", () => {
            describe("general", () => {
                ...
                it("add and then remove a config file in a folder with loose files", () => {
                    ...
                    host.vfs.unlinkSync(configFile.path);
                ...
                it("handle recreated files correctly", () => {
                    ...
                    // delete commonFile2
                    host.vfs.unlinkSync(commonFile2.path);
                    host.checkTimeoutQueueLengthAndRun(2);
                    checkProjectRootFiles(project, [commonFile1.path]);
                ...
                it("should disable features when the files are too large", () => {
                    ...
                    const getFileSizeSpy = spy(host, "getFileSize")
                        .setup(_ => _(file1.path), { return: file1.fileSize })
                        .setup(_ => _(file2.path), { return: file2.fileSize })
                        .setup(_ => _(file3.path), { return: file3.fileSize });
                ...
                it("should use only one inferred project if 'useOneInferredProject' is set", () => {
                    ...
                    checkNumberOfConfiguredProjects(projectService, 0);
                    checkNumberOfInferredProjects(projectService, 1);
                    checkProjectActualFiles(projectService.inferredProjects[0], [file1.path, file2.path, file3.path, fakes.FakeServerHost.libPath]);
                    ...
                    checkNumberOfConfiguredProjects(projectService, 1);
                    checkNumberOfInferredProjects(projectService, 1);
                    checkProjectActualFiles(projectService.inferredProjects[0], [file2.path, file3.path, fakes.FakeServerHost.libPath]);
                });
                ...
                it("should not close configured project after closing last open file, but should be closed on next file open if its not the file from same project", () => {
                    ...
                    projectService.openClientFile(fakes.FakeServerHost.libPath);
                    checkNumberOfConfiguredProjects(projectService, 0);
        ...
        it("external project for dynamic file", () => {
            ...
            const completions2 = service.externalProjects[0].getLanguageService().getCompletionsAtPosition(f1.path, 2, { includeExternalModuleExports: false, includeInsertTextCompletions: false });
                ...
                it("changes in closed files are reflected in project structure", () => {
                    ...
                    host.writeFile(modifiedFile2.path, modifiedFile2.content);
                    host.checkTimeoutQueueLengthAndRun(2);
                    checkNumberOfInferredProjects(projectService, 1);
                ...
                it("deleted files affect project structure", () => {
                    ...
                    host.vfs.unlinkSync(file2.path);
                    host.checkTimeoutQueueLengthAndRun(2);
                ...
                it("can correctly update configured project when set of root files has changed (new file in list of files)", () => {
                    ...
                    host.writeFile(modifiedConfigFile.path, modifiedConfigFile.content);
                ...
                it("config file is deleted", () => {
                    ...
                    host.vfs.unlinkSync(config.path);
                    host.checkTimeoutQueueLengthAndRun(1);
                    checkNumberOfProjects(projectService, { inferredProjects: 2 });
                    checkProjectActualFiles(projectService.inferredProjects[0], [file1.path]);
            ...
            completions = project.getLanguageService().getCompletionsAtPosition(file1.path, 5, { includeExternalModuleExports: false, includeInsertTextCompletions: false });
                ...
                it("no tsconfig script block diagnostic errors", () => {
                    ...
                    let host = createServerHost([file1, file2, config1, libFile], { executingFilePath: combinePaths(getDirectoryPath(fakes.FakeServerHost.libPath), "tsc.js") });
                    ...
                    host = createServerHost([file1, file2, config2, libFile], { executingFilePath: combinePaths(getDirectoryPath(fakes.FakeServerHost.libPath), "tsc.js") });
                    ...
                    host = createServerHost([file1, file2, config3, libFile], { executingFilePath: combinePaths(getDirectoryPath(fakes.FakeServerHost.libPath), "tsc.js") });
                    session = createSession(host);
                    ...
                    host = createServerHost([file1, file2, config4, libFile], { executingFilePath: combinePaths(getDirectoryPath(fakes.FakeServerHost.libPath), "tsc.js") });
                    session = createSession(host);
                    ...
                    host = createServerHost([file1, file2, config5, libFile], { executingFilePath: combinePaths(getDirectoryPath(fakes.FakeServerHost.libPath), "tsc.js") });
                    session = createSession(host);
            ...
            const actualText2 = getSnapshotText(scriptInfo2.getSnapshot());
                ...
                it("deleting config file opened from the external project works", () => {
                    ...
                    checkProjectActualFiles(configProject, [fakes.FakeServerHost.libPath, configFile.path]);
                    ...
                    checkProjectActualFiles(projectService.externalProjects[0], [site.path, fakes.FakeServerHost.libPath]);
                });
                ...
                it("Properly handle Windows-style outDir", () => {
                    ...
                    const host = createServerHost([file1, configFile], { dos: true });
                    const projectService = createProjectService(host);
            ...
            describe("Proper errors", () => {
                ...
                it("folder rename updates project structure and reports no errors", () => {
                    ...
                    host.vfs.renameSync(`${projectDir}/foo`, `${projectDir}/foo2`);
                    host.runQueuedTimeoutCallbacks();
                    host.runQueuedTimeoutCallbacks();
                    verifyErrorsInApp();
            ...
            describe("extra resolution pass in lshost", () => {
                it("can load typings that are proper modules", () => {
                    ...
                    const host: fakes.FakeServerHost & ModuleResolutionHost = createServerHost([file1, lib]);
            ...
            describe("external projects", () => {
                it("correctly handling add/remove tsconfig - 1", () => {
                    ...
                    host.vfs.renameSync(f2.path, tsconfig.path);
                    projectService.openExternalProject({
                        projectFileName: projectName,
                    ...
                    host.vfs.renameSync(tsconfig.path, f2.path);
                    projectService.openExternalProject({
                        projectFileName: projectName,
                        rootFiles: toExternalFiles([f1.path, f2.path]),
                        options: {}
            ...
            describe("Open-file", () => {
                ...
                it("uses existing project even if project refresh is pending", () => {
                    ...
                    const files = [libFile, aFile, configFile];
                    const host = createServerHost(files);
                    const service = createProjectService(host);
            ...
            describe("Language service", () => {
                it("should work correctly on case-sensitive file systems", () => {
                    ...
                    const host = createServerHost([lib, f], { executingFilePath: "/a/Lib/tsc.js", vfs: { useCaseSensitiveFileNames: true } });
                    const projectService = createProjectService(host);
                    projectService.openClientFile(f.path);
                    projectService.checkNumberOfProjects({ inferredProjects: 1 });
            ...
            describe("rename a module file and rename back", () => {
                it("should restore the states for inferred projects", () => {
                    ...
                    host.vfs.renameSync(moduleFileOldPath, moduleFileNewPath);
                    host.runQueuedTimeoutCallbacks();
                    diags = session.executeCommand(getErrRequest).response as server.protocol.Diagnostic[];
                    verifyDiagnostics(diags, [
                    ...
                    host.vfs.renameSync(moduleFileNewPath, moduleFileOldPath);
                    host.runQueuedTimeoutCallbacks();
            ...
            describe("add the missing module file for inferred project", () => {
                ...
                it("npm install @types works", () => {
                    ...
                    // trigger only directory watcher
                    host.watchFiles = false;
                    host.writeFile(padIndex.path, padIndex.content);
                    host.watchFiles = true;
            ...
            describe("Configure file diagnostics events", () => {
                ...
                it("are generated when the config file has errors", () => {
                    ...
                    openFilesForSession([file.path], serverEventManager.session);
                ...
                it("are not generated when the config file doesnot include file opened and config file has errors", () => {
                    ...
                    const serverEventManager = new TestServerEventManager(host);
                    openFilesForSession([file2.path], serverEventManager.session);
            ...
            describe("skipLibCheck", () => {
                it("should be turned on for js-only inferred projects", () => {
                    ...
                    const host = createServerHost([file1, file2]);
                    const session = createSession(host);
                    openFilesForSession([file1.path, file2.path], session);
                ...
                it("should not report bind errors for declaration files with skipLibCheck=true", () => {
                    ...
                    const session = createSession(host);
                    openFilesForSession([jsFile.path], session);
            ...
            describe("non-existing directories listed in config file input array", () => {
                ...
                it("should be able to handle @types if input file list is empty", () => {
                    ...
                    const host = createServerHost([f, config, t1, t2], { vfs: { currentDirectory: getDirectoryPath(f.path) } });
                    const projectService = createProjectService(host);
        ...
        it("should tolerate invalid include files that start in subDirectory", () => {
            ...
            describe("Inferred projects", () => {
                ...
                function verifyProjectRootWithCaseSensitivity(useCaseSensitiveFileNames: boolean) {
                    ...
                    const host = createServerHost(files, { vfs: { useCaseSensitiveFileNames } });
            ...
            describe("No overwrite emit error", () => {
                it("for inferred project", () => {
                    ...
                    const session = createSession(host);
                    openFilesForSession([f1.path], session);
            ...
            describe("Options Diagnostic locations reported correctly with changes in configFile contents", () => {
                it("when options change", () => {
                    ...
                    const session = createSession(host);
                    openFilesForSession([file.path], session);
            ...
            describe("CachingFileSystemInformation", () => {
                ...
                function createCallsTrackingHost(host: fakes.FakeServerHost) {
                ...
                describe("WatchDirectories for config file with", () => {
                    function verifyWatchDirectoriesCaseSensitivity(useCaseSensitiveFileNames: boolean) {
                        ...
                        const host = createServerHost(projectFiles, { vfs: { useCaseSensitiveFileNames } });
                        const projectService = createProjectService(host);
                ...
                describe("Verify npm install in directory with tsconfig file works when", () => {
                    function verifyNpmInstall(timeoutDuringPartialInstallation: boolean) {
                        ...
                        const projectFilePaths = [app.path, libFile.path, tsconfigJson.path];
                        const typeRootDirectories = getTypeRootsFromLocation(getDirectoryPath(tsconfigJson.path));
                        const host = new fakes.FakeServerHost({ lib: true }, /*files*/ {
                            [app.path]: app.content,
                            [tsconfigJson.path]: tsconfigJson.content,
                        ...
                        host.vfs.apply({ [root]: {
                            "a/b/node_modules/.staging/typescript-8493ea5d/package.json.3017591594": undefined // deleted
                        }});
                        verifyAfterNpmFileOperation(0);

                        host.vfs.apply({ [root]: {
                            "a/b/node_modules/.staging/rxjs-22375c61/bundles": {},
                            "a/b/node_modules/.staging/rxjs-22375c61/operator": {},
                            "a/b/node_modules/.staging/rxjs-22375c61/src/add/observable/dom": {},
                            "a/b/node_modules/.staging/@types/lodash-e56c4fe7/index.d.ts": "\n// Stub for lodash\nexport = _;\nexport as namespace _;\ndeclare var _: _.LoDashStatic;\ndeclare namespace _ {\n    interface LoDashStatic {\n        someProp: string;\n    }\n    class SomeClass {\n        someMethod(): void;\n    }\n}"
                        }});
                        verifyAfterNpmFileOperation(2);

                        host.vfs.apply({ [root]: {
                            "a/b/node_modules/.staging/rxjs-22375c61/src/scheduler": {},
                            "a/b/node_modules/.staging/rxjs-22375c61/src/util": {},
                            "a/b/node_modules/.staging/rxjs-22375c61/symbol": {},
                            "a/b/node_modules/.staging/rxjs-22375c61/testing": {},
                            "a/b/node_modules/.staging/rxjs-22375c61/package.json.2252192041": "{\n  \"_args\": [\n    [\n      {\n        \"raw\": \"rxjs@^5.4.2\",\n        \"scope\": null,\n        \"escapedName\": \"rxjs\",\n        \"name\": \"rxjs\",\n        \"rawSpec\": \"^5.4.2\",\n        \"spec\": \">=5.4.2 <6.0.0\",\n        \"type\": \"range\"\n      },\n      \"C:\\\\Users\\\\shkamat\\\\Desktop\\\\app\"\n    ]\n  ],\n  \"_from\": \"rxjs@>=5.4.2 <6.0.0\",\n  \"_id\": \"rxjs@5.4.3\",\n  \"_inCache\": true,\n  \"_location\": \"/rxjs\",\n  \"_nodeVersion\": \"7.7.2\",\n  \"_npmOperationalInternal\": {\n    \"host\": \"s3://npm-registry-packages\",\n    \"tmp\": \"tmp/rxjs-5.4.3.tgz_1502407898166_0.6800217325799167\"\n  },\n  \"_npmUser\": {\n    \"name\": \"blesh\",\n    \"email\": \"ben@benlesh.com\"\n  },\n  \"_npmVersion\": \"5.3.0\",\n  \"_phantomChildren\": {},\n  \"_requested\": {\n    \"raw\": \"rxjs@^5.4.2\",\n    \"scope\": null,\n    \"escapedName\": \"rxjs\",\n    \"name\": \"rxjs\",\n    \"rawSpec\": \"^5.4.2\",\n    \"spec\": \">=5.4.2 <6.0.0\",\n    \"type\": \"range\"\n  },\n  \"_requiredBy\": [\n    \"/\"\n  ],\n  \"_resolved\": \"https://registry.npmjs.org/rxjs/-/rxjs-5.4.3.tgz\",\n  \"_shasum\": \"0758cddee6033d68e0fd53676f0f3596ce3d483f\",\n  \"_shrinkwrap\": null,\n  \"_spec\": \"rxjs@^5.4.2\",\n  \"_where\": \"C:\\\\Users\\\\shkamat\\\\Desktop\\\\app\",\n  \"author\": {\n    \"name\": \"Ben Lesh\",\n    \"email\": \"ben@benlesh.com\"\n  },\n  \"bugs\": {\n    \"url\": \"https://github.com/ReactiveX/RxJS/issues\"\n  },\n  \"config\": {\n    \"commitizen\": {\n      \"path\": \"cz-conventional-changelog\"\n    }\n  },\n  \"contributors\": [\n    {\n      \"name\": \"Ben Lesh\",\n      \"email\": \"ben@benlesh.com\"\n    },\n    {\n      \"name\": \"Paul Taylor\",\n      \"email\": \"paul.e.taylor@me.com\"\n    },\n    {\n      \"name\": \"Jeff Cross\",\n      \"email\": \"crossj@google.com\"\n    },\n    {\n      \"name\": \"Matthew Podwysocki\",\n      \"email\": \"matthewp@microsoft.com\"\n    },\n    {\n      \"name\": \"OJ Kwon\",\n      \"email\": \"kwon.ohjoong@gmail.com\"\n    },\n    {\n      \"name\": \"Andre Staltz\",\n      \"email\": \"andre@staltz.com\"\n    }\n  ],\n  \"dependencies\": {\n    \"symbol-observable\": \"^1.0.1\"\n  },\n  \"description\": \"Reactive Extensions for modern JavaScript\",\n  \"devDependencies\": {\n    \"babel-polyfill\": \"^6.23.0\",\n    \"benchmark\": \"^2.1.0\",\n    \"benchpress\": \"2.0.0-beta.1\",\n    \"chai\": \"^3.5.0\",\n    \"color\": \"^0.11.1\",\n    \"colors\": \"1.1.2\",\n    \"commitizen\": \"^2.8.6\",\n    \"coveralls\": \"^2.11.13\",\n    \"cz-conventional-changelog\": \"^1.2.0\",\n    \"danger\": \"^1.1.0\",\n    \"doctoc\": \"^1.0.0\",\n    \"escape-string-regexp\": \"^1.0.5 \",\n    \"esdoc\": \"^0.4.7\",\n    \"eslint\": \"^3.8.0\",\n    \"fs-extra\": \"^2.1.2\",\n    \"get-folder-size\": \"^1.0.0\",\n    \"glob\": \"^7.0.3\",\n    \"gm\": \"^1.22.0\",\n    \"google-closure-compiler-js\": \"^20170218.0.0\",\n    \"gzip-size\": \"^3.0.0\",\n    \"http-server\": \"^0.9.0\",\n    \"husky\": \"^0.13.3\",\n    \"lint-staged\": \"3.2.5\",\n    \"lodash\": \"^4.15.0\",\n    \"madge\": \"^1.4.3\",\n    \"markdown-doctest\": \"^0.9.1\",\n    \"minimist\": \"^1.2.0\",\n    \"mkdirp\": \"^0.5.1\",\n    \"mocha\": \"^3.0.2\",\n    \"mocha-in-sauce\": \"0.0.1\",\n    \"npm-run-all\": \"^4.0.2\",\n    \"npm-scripts-info\": \"^0.3.4\",\n    \"nyc\": \"^10.2.0\",\n    \"opn-cli\": \"^3.1.0\",\n    \"platform\": \"^1.3.1\",\n    \"promise\": \"^7.1.1\",\n    \"protractor\": \"^3.1.1\",\n    \"rollup\": \"0.36.3\",\n    \"rollup-plugin-inject\": \"^2.0.0\",\n    \"rollup-plugin-node-resolve\": \"^2.0.0\",\n    \"rx\": \"latest\",\n    \"rxjs\": \"latest\",\n    \"shx\": \"^0.2.2\",\n    \"sinon\": \"^2.1.0\",\n    \"sinon-chai\": \"^2.9.0\",\n    \"source-map-support\": \"^0.4.0\",\n    \"tslib\": \"^1.5.0\",\n    \"tslint\": \"^4.4.2\",\n    \"typescript\": \"~2.0.6\",\n    \"typings\": \"^2.0.0\",\n    \"validate-commit-msg\": \"^2.14.0\",\n    \"watch\": \"^1.0.1\",\n    \"webpack\": \"^1.13.1\",\n    \"xmlhttprequest\": \"1.8.0\"\n  },\n  \"directories\": {},\n  \"dist\": {\n    \"integrity\": \"sha512-fSNi+y+P9ss+EZuV0GcIIqPUK07DEaMRUtLJvdcvMyFjc9dizuDjere+A4V7JrLGnm9iCc+nagV/4QdMTkqC4A==\",\n    \"shasum\": \"0758cddee6033d68e0fd53676f0f3596ce3d483f\",\n    \"tarball\": \"https://registry.npmjs.org/rxjs/-/rxjs-5.4.3.tgz\"\n  },\n  \"engines\": {\n    \"npm\": \">=2.0.0\"\n  },\n  \"homepage\": \"https://github.com/ReactiveX/RxJS\",\n  \"keywords\": [\n    \"Rx\",\n    \"RxJS\",\n    \"ReactiveX\",\n    \"ReactiveExtensions\",\n    \"Streams\",\n    \"Observables\",\n    \"Observable\",\n    \"Stream\",\n    \"ES6\",\n    \"ES2015\"\n  ],\n  \"license\": \"Apache-2.0\",\n  \"lint-staged\": {\n    \"*.@(js)\": [\n      \"eslint --fix\",\n      \"git add\"\n    ],\n    \"*.@(ts)\": [\n      \"tslint --fix\",\n      \"git add\"\n    ]\n  },\n  \"main\": \"Rx.js\",\n  \"maintainers\": [\n    {\n      \"name\": \"blesh\",\n      \"email\": \"ben@benlesh.com\"\n    }\n  ],\n  \"name\": \"rxjs\",\n  \"optionalDependencies\": {},\n  \"readme\": \"ERROR: No README data found!\",\n  \"repository\": {\n    \"type\": \"git\",\n    \"url\": \"git+ssh://git@github.com/ReactiveX/RxJS.git\"\n  },\n  \"scripts-info\": {\n    \"info\": \"List available script\",\n    \"build_all\": \"Build all packages (ES6, CJS, UMD) and generate packages\",\n    \"build_cjs\": \"Build CJS package with clean up existing build, copy source into dist\",\n    \"build_es6\": \"Build ES6 package with clean up existing build, copy source into dist\",\n    \"build_closure_core\": \"Minify Global core build using closure compiler\",\n    \"build_global\": \"Build Global package, then minify build\",\n    \"build_perf\": \"Build CJS & Global build, run macro performance test\",\n    \"build_test\": \"Build CJS package & test spec, execute mocha test runner\",\n    \"build_cover\": \"Run lint to current code, build CJS & test spec, execute test coverage\",\n    \"build_docs\": \"Build ES6 & global package, create documentation using it\",\n    \"build_spec\": \"Build test specs\",\n    \"check_circular_dependencies\": \"Check codebase has circular dependencies\",\n    \"clean_spec\": \"Clean up existing test spec build output\",\n    \"clean_dist_cjs\": \"Clean up existing CJS package output\",\n    \"clean_dist_es6\": \"Clean up existing ES6 package output\",\n    \"clean_dist_global\": \"Clean up existing Global package output\",\n    \"commit\": \"Run git commit wizard\",\n    \"compile_dist_cjs\": \"Compile codebase into CJS module\",\n    \"compile_module_es6\": \"Compile codebase into ES6\",\n    \"cover\": \"Execute test coverage\",\n    \"lint_perf\": \"Run lint against performance test suite\",\n    \"lint_spec\": \"Run lint against test spec\",\n    \"lint_src\": \"Run lint against source\",\n    \"lint\": \"Run lint against everything\",\n    \"perf\": \"Run macro performance benchmark\",\n    \"perf_micro\": \"Run micro performance benchmark\",\n    \"test_mocha\": \"Execute mocha test runner against existing test spec build\",\n    \"test_browser\": \"Execute mocha test runner on browser against existing test spec build\",\n    \"test\": \"Clean up existing test spec build, build test spec and execute mocha test runner\",\n    \"tests2png\": \"Generate marble diagram image from test spec\",\n    \"watch\": \"Watch codebase, trigger compile when source code changes\"\n  },\n  \"typings\": \"Rx.d.ts\",\n  \"version\": \"5.4.3\"\n}\n"
                        }});
                        verifyAfterNpmFileOperation(2);
                        ...
                        host.vfs.apply({ [root]: {
                            "a/b/node_modules/symbol-observable": {},
                            "a/b/node_modules/@types": {},
                            "a/b/node_modules/@types/lodash": {},
                            "a/b/node_modules/lodash": {},
                            "a/b/node_modules/rxjs": {},
                            "a/b/node_modules/typescript": {},
                            "a/b/node_modules/.bin": {},
                            "a/b/node_modules/.staging/rxjs-22375c61/package.json.2252192041": undefined // deleted
                        }});
                        verifyAfterNpmFileOperation(2);

                        // replace files
                        host.vfs.scanSync(vpath.combine(root, "a/b/node_modules/.staging"), "descendants", {
                            accept(path, stats) {
                                const out = toOutputPath(path);
                                if (stats.isFile()) {
                                    host.vfs.mkdirpSync(vpath.dirname(out));
                                    host.vfs.renameSync(path, out);
                                }
                                else if (stats.isDirectory()) {
                                    host.vfs.mkdirpSync(out);
                                }
                                return true;
                            }
                        });
                        ...
                        projectFilePaths.push(lodashIndexPath);
                        ...
                        function toOutputPath(path: string) {
                            return path.replace(/\/node_modules\/\.staging\/(@[^/]+\/)?([^/]+?)(?:-[a-f0-9]{8})?(?:(\/.+?)(\.\d{10})?)?$/g, "/node_modules/$1$2$3");
                        }

                        function verifyAfterNpmFileOperation(timeoutQueueLengthWhenRunningTimeouts: number) {
            ...
            describe("ProjectsChangedInBackground", () => {
                ...
                function verifyProjectsUpdatedInBackgroundEvent(createSession: (host: fakes.FakeServerHost) => ProjectsUpdatedInBackgroundEventVerifier) {
                    ...
                    describe("with modules and configured project", () => {
                        ...
                        function getInitialState({ configObj = {}, getAdditionalFileOrFolder, firstReloadFileList }: InitialStateParams = {}) {
                            ...
                            for (const file of filesToReload) {
                                host.writeFile(file.path, file.content);
                            }
                            ...
                            function updateContentOfOpenFile(file: FileOrFolder, newContent: string) {
                                ...
                                host.writeFile(file.path, newContent);
                            }
                        }

                        it("should contains only itself if a module file's shape didn't change, and all files referencing it if its shape changed", () => {
                            const { moduleFile1, verifyProjectsUpdatedInBackgroundEvent, host } = getInitialState();
                            ...
                            host.writeFile(moduleFile1.path, moduleFile1.content);
                            verifyProjectsUpdatedInBackgroundEvent();
                        ...
                        it("should be up-to-date with the reference map changes", () => {
                            const { moduleFile1, file1Consumer1, updateContentOfOpenFile, verifyProjectsUpdatedInBackgroundEvent, verifyNoProjectsUpdatedInBackgroundEvent, host } = getInitialState();
                        ...
                        it("should be up-to-date with deleted files", () => {
                            const { moduleFile1, file1Consumer2, verifyProjectsUpdatedInBackgroundEvent, host } = getInitialState();
                            ...
                            host.vfs.unlinkSync(file1Consumer2.path);
                            verifyProjectsUpdatedInBackgroundEvent();
                        });
                        ...
                        it("should return all files if a global file changed shape", () => {
                            const { globalFile3, verifyProjectsUpdatedInBackgroundEvent, host } = getInitialState();

                            globalFile3.content += "var T2: string;";
                            host.writeFile(globalFile3.path, globalFile3.content);
                            verifyProjectsUpdatedInBackgroundEvent();
                        });
                        ...
                        it("should return cascaded affected file list", () => {
                            ...
                            const { moduleFile1, file1Consumer1, updateContentOfOpenFile, verifyNoProjectsUpdatedInBackgroundEvent, verifyProjectsUpdatedInBackgroundEvent, host } = getInitialState({
                        ...
                        it("should work fine for files with circular references", () => {
                            ...
                            const { verifyProjectsUpdatedInBackgroundEvent, host } = getInitialState({
                                getAdditionalFileOrFolder: () => [file1, file2],
                                firstReloadFileList: [file1.path, fakes.FakeServerHost.libPath, file2.path, configFilePath]
                            });
                        ...
                        it("should detect removed code file", () => {
                            ...
                            const { verifyProjectsUpdatedInBackgroundEvent, host } = getInitialState({
                                ...
                                firstReloadFileList: [referenceFile1.path, fakes.FakeServerHost.libPath, moduleFile1Path, configFilePath]
                            });
                        ...
                        it("should detect non-existing code file", () => {
                            ...
                            const { moduleFile2, updateContentOfOpenFile, verifyNoProjectsUpdatedInBackgroundEvent, verifyProjectsUpdatedInBackgroundEvent, host } = getInitialState({
                                getAdditionalFileOrFolder: () => [referenceFile1],
                                firstReloadFileList: [referenceFile1.path, fakes.FakeServerHost.libPath, configFilePath]
                            });
                ...
                describe("when event handler is set in the session", () => {
                    ...
                    function createSessionWithProjectChangedEventHandler(host: fakes.FakeServerHost): ProjectsUpdatedInBackgroundEventVerifier {
                ...
                describe("when event handler is not set but session is created with canUseEvents = true", () => {
                    ...
                    function createSessionThatUsesEvents(host: fakes.FakeServerHost): ProjectsUpdatedInBackgroundEventVerifier {
                        const session = createSession(host, { canUseEvents: true });
            ...
            describe("Watched recursive directories with windows style file system", () => {
                function verifyWatchedDirectories(useProjectAtRoot: boolean) {
                    ...
                    const windowsStyleLibFilePath = "c:" + fakes.FakeServerHost.libPath;
                    const files = [configFile, file1, file2, { path: fakes.FakeServerHost.dosLibPath, content: fakes.FakeServerHost.libContent }];
                    const host = createServerHost(files, { lib: true, dos: true });
                    const projectService = createProjectService(host);
                    projectService.openClientFile(file1.path);
                    const project = projectService.configuredProjects.get(configFile.path);
                    assert.isDefined(project);
            ...
            describe("tsserverProjectSystem typingsInstaller on inferred Project", () => {
                it("when projectRootPath is provided", () => {
                    ...
                    const host = createServerHost(files, { vfs: { currentDirectory } });
            ...
            describe("tsserverProjectSystem with symLinks", () => {
                it("rename in common file renames all project", () => {
                    ...
                    const files = [cFile, libFile, aFile, aTsconfig, bFile, bTsconfig];
                    const host = createServerHost(files);
                    host.vfs.symlinkSync(folderC, `${folderA}/c`);
                    host.vfs.symlinkSync(folderC, `${folderB}/c`);
                    const session = createSession(host);
                    const projectService = session.getProjectService();
