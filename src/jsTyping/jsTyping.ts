import { MapLike, Version, getProperty, versionMajorMinor, arrayToSet, Path, readConfigFile, createMapFromTemplate, TypeAcquisition, createMap, mapDefined, normalizePath, hasJSFileExtension, getDirectoryPath, combinePaths, deduplicate, equateStringsCaseSensitive, compareStringsCaseSensitive, forEach, Push, flatMap, getOwnKeys, removeFileExtension, getBaseFileName, removeMinAndVersionNumbers, some, fileExtensionIs, Extension, filter, getNormalizedAbsolutePath, CharacterCodes, Debug } from "./ts";
 ...
 */
/* @internal */
export function discoverTypings(host: TypingResolutionHost, log: ((message: string) => void) | undefined, fileNames: string[], projectRootPath: Path, safeList: SafeList, packageNameToTypingLocation: ts.ReadonlyMap<CachedTyping>, typeAcquisition: TypeAcquisition, unresolvedImports: readonly string[], typesRegistry: ts.ReadonlyMap<MapLike<string>>): {
