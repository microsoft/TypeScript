...
interface String {
     ...
     * @param locales The preferred locale, or list of preferred locales, to use for the conversation; see `Intl.LocalesArgument`.
    ...
    */
     ...
     * @param locales The preferred locale, or list of preferred locales, to use for the comparison; see `Intl.LocalesArgument`. If omitted, the default locale is used.
