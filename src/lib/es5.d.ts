...
interface TypedArrayConstructor<V extends number | bigint, Instance extends TypedArray<V>> {
    readonly prototype: Instance;
    new(length: number): Instance;
    new(array: ArrayLike<V>): Instance;
     ...
     */
    from(arrayLike: ArrayLike<V>): Instance;
     ...
     */
    from<T>(arrayLike: ArrayLike<T>, mapfn: (v: T, k: number) => V, thisArg?: any): Instance;
}

/**
 * A typed array of numeric values whose values are stored in a backing array buffer.
 * The contents are initialized to 0. If the requested number of bytes could not be
 * allocated an exception is raised.
 */
interface TypedArray<V extends number | bigint> {
    /**
     * The ArrayBuffer instance referenced by the array.
     */
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    every(predicate: (value: V, index: number, array: this) => unknown, thisArg?: any): boolean;
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    filter(predicate: (value: V, index: number, array: this) => any, thisArg?: any): this;
     ...
     */
    find(predicate: (value: V, index: number, obj: this) => boolean, thisArg?: any): V | undefined;
     ...
     * predicate. If it is not provided, undefined is used instead.
     */
    findIndex(predicate: (value: V, index: number, obj: this) => boolean, thisArg?: any): number;
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    forEach(callbackfn: (value: V, index: number, array: this) => void, thisArg?: any): void;
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    map(callbackfn: (value: V, index: number, array: this) => V, thisArg?: any): this;
     ...
     */
    reduce(callbackfn: (previousValue: V, currentValue: V, currentIndex: number, array: this) => V): V;
     ...
     * instead of an array value.
     */
    reduce<U>(callbackfn: (previousValue: U, currentValue: V, currentIndex: number, array: this) => U, initialValue: U): U;
     ...
     */
    reduceRight(callbackfn: (previousValue: V, currentValue: V, currentIndex: number, array: this) => V): V;
     ...
     * instead of an array value.
     */
    reduceRight<U>(callbackfn: (previousValue: U, currentValue: V, currentIndex: number, array: this) => U, initialValue: U): U;
     ...
     */
    set(array: ArrayLike<V>, offset?: number): void;
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    some(predicate: (value: V, index: number, array: this) => unknown, thisArg?: any): boolean;
