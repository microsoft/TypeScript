...
interface JSON {
     ...
     * @param space Adds indentation, white space, and line break characters to the return-value JSON text to make it easier to read.
     */
    stringify(value: Exclude<unknown, boolean | number | string | object>, replacer?: (this: unknown, key: string, value: unknown) => unknown, space?: string | number): string | undefined;
    /**
     * Converts a JavaScript value to a JavaScript Object Notation (JSON) string or undefined.
     * @param value A JavaScript value to be converted, which could potentially be a non-JSON-representable value.
     * @param replacer An array of strings and numbers that acts as an approved list for selecting the object properties that will be stringified.
     * @param space Adds indentation, white space, and line break characters to the return-value JSON text to make it easier to read.
     */
    stringify(value: Exclude<unknown, boolean | number | string | object>, replacer?: (number | string)[] | null, space?: string | number): string | undefined;
}
