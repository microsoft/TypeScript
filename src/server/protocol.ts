import { TextInsertion, TodoCommentDescriptor, TodoComment, OutliningSpanKind, EmitOutput, HighlightSpanKind, RenameLocation, ScriptElementKind, ScriptKind, TypeAcquisition, TextChange, FileExtensionInfo, CompilerOptionsValue, JSDocTagInfo, MapLike, PluginImport, ProjectReference } from "./ts";
