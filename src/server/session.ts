namespace ts.server {
    ...
    function combineProjectOutputForRenameLocations(
        ...
        combineProjectOutputWorker<DocumentPosition>(
            ...
            for (const output of project.getLanguageService().findRenameLocations(location.fileName, location.pos, findInStrings, findInComments, providePrefixAndSuffixTextForRename) || emptyArray) {
        ...
        */
        ...
        private getRenameLocations(args: protocol.RenameRequestArgs, simplifiedResult: boolean): protocol.RenameResponseBody | ReadonlyArray<RenameLocation> {
            ...
            const locations = combineProjectOutputForRenameLocations(
                ...
                !!args.findInStrings,
                !!args.findInComments,
                this.getHostPreferences().providePrefixAndSuffixTextForRename || false
            );
