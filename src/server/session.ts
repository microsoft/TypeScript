...
function referenceEntryToReferencesResponseItem(projectService: ts.server.ProjectService, { fileName, textSpan, contextSpan, isWriteAccess, isDefinition }: ts.ReferencedSymbolEntry): ts.server.protocol.ReferencesResponseItem {
