import { createMap, perfLogger, getBaseFileName, SortedArray, Comparer, binarySearch, identity } from "./ts";
import { Logger, ServerHost, LogLevel, NormalizedPath } from "./ts.server";
import * as ts from "./ts";
/* @internal */
export class ThrottledOperations {
    private readonly pendingTimeouts: ts.Map<any> = createMap<any>();
