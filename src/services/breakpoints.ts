                ...
                default:
                    ...
                    if (node.kind === SyntaxKind.BinaryExpression) {
                        ...
                        if (isArrayLiteralOrObjectLiteralDestructuringPattern(left)) {
                            return spanInArrayLiteralOrObjectLiteralDestructuringPattern((<ArrayLiteralExpression | ObjectLiteralExpression>left));
                        }
