import {
    __String, arrayToNumericMap, CancellationToken, CharacterCodes, ClassDeclaration, ClassificationInfo,
    ...
    JSDocReturnTag, JSDocSeeTag, JSDocTemplateTag, JSDocThisTag, JSDocThrowsTag, JSDocTypedefTag, JSDocTypeTag, JsxAttribute,
