import { Classifier, createScanner, ScriptTarget, EndOfLineState, ClassificationResult, Classifications, SyntaxKind, isTrivia, lastOrUndefined, Debug, isKeyword, arrayToNumericMap, Scanner, CharacterCodes, isTemplateLiteralKind, ClassificationType, Push, ClassificationInfo, TokenClass, isAccessibilityModifier, TypeChecker, CancellationToken, SourceFile, UnderscoreEscapedMap, TextSpan, ClassifiedSpan, Node, textSpanIntersectsWith, isIdentifier, nodeIsMissing, getMeaningFromLocation, Symbol, SemanticMeaning, SymbolFlags, some, isModuleDeclaration, getModuleInstanceState, ModuleInstanceState, ClassificationTypeNames, createTextSpan, couldStartTrivia, parseIsolatedJSDocComment, HasJSDoc, JSDoc, JSDocParameterTag, JSDocTemplateTag, JSDocTypeTag, JSDocReturnTag, commentPragmas, isLineBreak, isJSDoc, isToken, JsxOpeningElement, JsxClosingElement, JsxSelfClosingElement, JsxAttribute, getTypeArgumentOrTypeParameterList, isPunctuation, ClassDeclaration, TypeParameterDeclaration, InterfaceDeclaration, EnumDeclaration, ModuleDeclaration, ParameterDeclaration, isThisIdentifier, decodedTextSpanIntersectsWith } from "./ts";
