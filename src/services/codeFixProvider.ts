import { createMultiMap, CodeFixRegistration, FileTextChanges, DiagnosticAndArguments, diagnosticToString, CodeActionCommand, CodeFixAction, Debug, arrayFrom, Diagnostic, contains, CodeFixContext, flatMap, map, CodeFixAllContext, CombinedCodeActions, cast, isString, TextChange, DiagnosticWithLocation, Push, CodeFixContextBase, computeSuggestionDiagnostics } from "./ts";
import { ChangeTracker } from "./ts.textChanges";
import * as ts from "./ts";
/* @internal */
const errorCodeToFixes = createMultiMap<CodeFixRegistration>();
/* @internal */
const fixIdToRegistration = new ts.Map<string, CodeFixRegistration>();
/* @internal */
