import { Diagnostics, Node, SourceFile, getTokenAtPosition, isIdentifier, SyntaxKind, tryAddToSet } from "../ts";
...
/* @internal */
function makeChange(changeTracker: ChangeTracker, sourceFile: SourceFile, pos: number, fixedNodes?: ts.Set<Node>) {
