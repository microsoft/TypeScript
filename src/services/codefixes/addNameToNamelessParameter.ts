import { Diagnostics, SourceFile, getTokenAtPosition, isIdentifier, Debug, isParameter, createParameter, createTypeReferenceNode } from "../ts";
...
function makeChange(changeTracker: ChangeTracker, sourceFile: SourceFile, pos: number) {
    ...
    /*decorators*/ undefined, param.modifiers, param.dotDotDotToken, "arg" + i, param.questionToken, createTypeReferenceNode(token, /*typeArguments*/ undefined), param.initializer);
