import { Diagnostics, SourceFile, getTokenAtPosition, isParameter, Debug, factory, Identifier } from "../ts";
...
function makeChange(changeTracker: ChangeTracker, sourceFile: SourceFile, pos: number) {
    ...
    /*decorators*/ undefined, param.modifiers, param.dotDotDotToken, "arg" + i, param.questionToken, param.dotDotDotToken ? factory.createArrayTypeNode(typeNode) : typeNode, param.initializer);
