import {
    ...
    isFunctionLikeDeclaration, isIdentifier, isJSDocIndexSignature, isParameter, JSDocFunctionType,
    JSDocNonNullableType, JSDocNullableType, JSDocOptionalType, JSDocVariadicType, last, Node,
