import {
    Debug, Diagnostics, EmitFlags, emptyArray, factory, findChildOfKind, first, FunctionLikeDeclaration,
    getJSDocReturnType, getJSDocType, getJSDocTypeParameterDeclarations, getTokenAtPosition, isArrowFunction,
    isFunctionLikeDeclaration, isIdentifier, isJSDocIndexSignature, isOptionalJSDocPropertyLikeTag, isParameter,
    JSDocFunctionType, JSDocNonNullableType, JSDocNullableType, JSDocOptionalType, JSDocTypeLiteral, JSDocVariadicType,
    last, map, Node, nullTransformationContext, ParameterDeclaration, PropertyDeclaration, PropertySignature,
    setEmitFlags, SourceFile, SyntaxKind, textChanges, tryCast, TypeNode, TypeReferenceNode, VariableDeclaration,
