import {
    __String, AccessExpression, ArrowFunction, BinaryExpression, Block, canHaveModifiers, ClassDeclaration,
    ClassElement, CodeFixContext, CompilerOptions, concatenate, copyLeadingComments, Diagnostics, every, Expression,
    factory, filter, forEach, FunctionDeclaration, FunctionExpression, getEmitScriptTarget, getNameOfDeclaration,
    getQuotePreference, getTokenAtPosition, idText, isAccessExpression, isArrowFunction, isBinaryExpression,
    isFunctionDeclaration, isFunctionExpression, isFunctionLike, isGetOrSetAccessorDeclaration, isIdentifier,
    isIdentifierText, isMethodDeclaration, isNoSubstitutionTemplateLiteral, isNumericLiteral, isObjectLiteralExpression,
    isPropertyAccessExpression, isPropertyAssignment, isSourceFileJS, isStringLiteralLike, isVariableDeclaration,
