...
namespace ts.codefix {
    ...
    function doChange(changes: textChanges.ChangeTracker, sourceFile: SourceFile, position: number, checker: TypeChecker, preferences: UserPreferences, compilerOptions: CompilerOptions): void {
        ...
        function createClassElementsFromSymbol(symbol: Symbol) {
            ...
            function createClassElement(symbol: Symbol, modifiers: Modifier[] | undefined, members: ClassElement[]): void {
                ...
                // f.prototype = { ... }
                    ...
                    const prop = factory.createPropertyDeclaration(RESERVED, modifiers, memberDeclaration.name, /*questionToken*/ undefined, /*type*/ undefined, assignmentExpr);
                ...
                function createFunctionExpressionMember(members: ClassElement[], functionExpression: FunctionExpression, name: PropertyName) {
                    ...
                    const method = factory.createMethodDeclaration(RESERVED, fullModifiers, /*asteriskToken*/ undefined, name, /*questionToken*/ undefined,
        ...
        function createClassFromVariableDeclaration(node: VariableDeclaration): ClassDeclaration | undefined {
            ...
            if (initializer.body) {
                memberElements.unshift(factory.createConstructorDeclaration(RESERVED, /*modifiers*/ undefined, initializer.parameters, initializer.body));
            }

            const modifiers = getModifierKindFromSource(node.parent.parent, SyntaxKind.ExportKeyword);
            const cls = factory.createClassDeclaration(RESERVED, modifiers, node.name,
        ...
        function createClassFromFunctionDeclaration(node: FunctionDeclaration): ClassDeclaration {
            ...
            if (node.body) {
                memberElements.unshift(factory.createConstructorDeclaration(RESERVED, /*modifiers*/ undefined, node.parameters, node.body));
            }
