import { mapDefined, Diagnostics, DiagnosticCategory, isInJSFile, isCheckJsEnabledForFile, getNewLineOrDefaultFromHost, CodeFixAction, createTextChange, createTextSpanFromBounds, createTextSpan, SourceFile, getLineAndCharacterOfPosition, tryAddToSet } from "../ts";
...
/* @internal */
function makeChange(changes: ChangeTracker, sourceFile: SourceFile, position: number, seenLines?: ts.Set<number>) {
