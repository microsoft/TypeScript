...
function doChange(changes: textChanges.ChangeTracker, sourceFile: SourceFile, importType: ImportTypeNode) {
    const newTypeNode = factory.updateImportTypeNode(importType, importType.argument, importType.assertions, importType.attributes, importType.qualifier, importType.typeArguments, /*isTypeOf*/ true);
