import { Diagnostics, createMap, addToSeen, getNodeId, SourceFile, ConstructorDeclaration, ExpressionStatement, getTokenAtPosition, SyntaxKind, getContainingFunction, isPropertyAccessExpression, Node, CallExpression, isExpressionStatement, isSuperCall, isFunctionLike, forEachChild } from "../ts";
