import { Diagnostics, SourceFile, ConstructorDeclaration, getTokenAtPosition, Debug, isConstructorDeclaration, factory, emptyArray } from "../ts";
...
function doChange(changes: ChangeTracker, sourceFile: SourceFile, ctr: ConstructorDeclaration) {
    const superCall = factory.createExpressionStatement(factory.createCallExpression(factory.createSuper(), /*typeArguments*/ undefined, emptyArray));
