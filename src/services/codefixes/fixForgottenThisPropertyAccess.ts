import { Diagnostics, Identifier, PrivateIdentifier, SourceFile, getTokenAtPosition, isIdentifier, isPrivateIdentifier, getContainingClass, suppressLeadingAndTrailingTrivia, factory } from "../ts";
