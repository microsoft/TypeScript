import { Diagnostics, symbolName, SourceFile, CodeFixContextBase, Node, Symbol, getTokenAtPosition, isPropertyAccessExpression, Debug, isIdentifierOrPrivateIdentifier, NodeFlags, isImportSpecifier, isIdentifier, findAncestor, isImportDeclaration, getMeaningFromLocation, getTextOfNode, ScriptTarget, isIdentifierText, isNamedDeclaration, isPrivateIdentifier, createIdentifier, createElementAccess, createLiteral, SemanticMeaning, SymbolFlags, ImportDeclaration, isStringLiteralLike, getResolvedModule } from "../ts";
...
/* @internal */
function getInfo(sourceFile: SourceFile, pos: number, context: CodeFixContextBase): {
    node: Node;
