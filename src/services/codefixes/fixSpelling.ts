import {
    CodeFixContextBase, Debug, Diagnostics, factory, findAncestor, getEffectiveBaseTypeNode, getEmitScriptTarget,
    getMeaningFromLocation, getModeForUsageLocation, getResolvedModule, getTextOfNode, getTokenAtPosition,
    hasSyntacticModifier, ImportDeclaration, isBinaryExpression, isClassElement, isClassLike, isIdentifier,
    isIdentifierText, isImportDeclaration, isImportSpecifier, isJsxAttribute, isJsxOpeningLikeElement, isMemberName,
