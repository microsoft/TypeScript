import {
    ...
    isStringLiteral, isYieldExpression, LanguageServiceHost, length, map, MethodDeclaration, MethodSignature, Modifier,
    ...
    TypeParameterDeclaration, UnionType, UserPreferences, visitEachChild, visitNode,
} from "../_namespaces/ts";
