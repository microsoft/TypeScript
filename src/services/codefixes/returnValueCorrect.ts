...
const errorCodes = [
    Diagnostics.A_function_whose_declared_type_is_neither_void_nor_any_must_return_a_value_undefined_is_also_allowed_with_strictNullChecks.code,
...
function getInfo(checker: TypeChecker, sourceFile: SourceFile, position: number, errorCode: number): Info | undefined {
    ...
    switch (errorCode) {
        case Diagnostics.A_function_whose_declared_type_is_neither_void_nor_any_must_return_a_value_undefined_is_also_allowed_with_strictNullChecks.code:
