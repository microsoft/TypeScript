...
namespace ts.Completions {
    ...
    export function getCompletionsAtPosition(typeChecker: TypeChecker, log: (message: string) => void, target: ScriptTarget, sourceFile: SourceFile, position: number): CompletionInfo {
    ...
    export function getCompletionEntryDetails(typeChecker: TypeChecker, log: (message: string) => void, target: ScriptTarget, sourceFile: SourceFile, position: number, entryName: string): CompletionEntryDetails {
