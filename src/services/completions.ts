import {
    ...
    createTextRangeFromSpan, createTextSpanFromBounds, createTextSpanFromNode, Debug, Declaration, Diagnostics,
    diagnosticToString, displayPart, EmitHint, EmitTextWriter, escapeSnippetText, every, ExportKind, Expression,
    factory, filter, find, findAncestor, findChildOfKind, findPrecedingToken, first, firstDefined, flatMap, formatting,
    FunctionLikeDeclaration, getAllSuperTypeNodes, getAncestor, getCombinedLocalAndExportSymbolFlags,
    getContainingClass, getContextualTypeFromParent, getDeclarationModifierFlagsFromSymbol, getEffectiveBaseTypeNode,
    getEffectiveModifierFlags, getEffectiveTypeAnnotationNode, getEmitModuleResolutionKind, getEmitScriptTarget,
    ...
    LanguageServiceHost, LanguageVariant, last, lastOrUndefined, length, ListFormat, Map, mapDefined, maybeBind,
    ...
    SemanticMeaning, Set, setSnippetElement, shouldUseUriStyleNodeCoreModules, SignatureHelp, SignatureKind,
    ...
    SymbolFlags, SymbolId, SyntaxKind, TextChange, textChanges, textPart, TextSpan, timestamp, Token, TokenSyntaxKind,
