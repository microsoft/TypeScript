import {
    ...
    modifierToFlag, ModuleDeclaration, ModuleReference, NamedImportBindings, Node,
    ...
    UnionReduction, UnionType, UserPreferences, VariableDeclaration, walkUpParenthesizedExpressions, moduleResolutionSupportsPackageJsonExportsAndImports,
} from "./_namespaces/ts";
