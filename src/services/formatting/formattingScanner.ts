import { createScanner, ScriptTarget, LanguageVariant, Node, last, SyntaxKind, isTrivia, append, isKeyword, isJsxText, findAncestor, isJsxElement, isParenthesizedExpression, isJsxAttribute, Debug, isToken } from "../ts";
