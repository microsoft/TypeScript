...
export function getAllRules(): RuleSpec[] {
    ...
    const highPriorityCommonRules = [
        ...
        rule(
            ...
            [SyntaxKind.VarKeyword, SyntaxKind.ThrowKeyword, SyntaxKind.NewKeyword, SyntaxKind.DeleteKeyword, SyntaxKind.ReturnKeyword, SyntaxKind.TypeOfKeyword, SyntaxKind.AwaitKeyword],
            anyToken,
    ...
    const userConfigurableRules = [
        ...
        rule("NoSpaceAfterAnonymousFunctionKeyword", [SyntaxKind.FunctionKeyword, SyntaxKind.AsteriskToken], SyntaxKind.OpenParenToken, [
