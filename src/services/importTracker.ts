...
/* @internal */
export function createImportTracker(sourceFiles: readonly SourceFile[], sourceFilesSet: ts.ReadonlyMap<true>, checker: TypeChecker, cancellationToken: CancellationToken | undefined): ImportTracker {
...
/* @internal */
function getImportersForExport(sourceFiles: readonly SourceFile[], sourceFilesSet: ts.ReadonlyMap<true>, allDirectImports: ts.Map<ImporterOrCallExpression[]>, { exportingModuleSymbol, exportKind }: ExportInfo, checker: TypeChecker, cancellationToken: CancellationToken | undefined): {
...
/* @internal */
function getDirectImportsMap(sourceFiles: readonly SourceFile[], checker: TypeChecker, cancellationToken: CancellationToken | undefined): ts.Map<ImporterOrCallExpression[]> {
