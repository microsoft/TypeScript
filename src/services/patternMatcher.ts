import { TextSpan, createMap, last, startsWith, CharacterCodes, min, Comparison, compareValues, compareBooleans, createTextSpan, isUnicodeIdentifierStart, ScriptTarget } from "./ts";
...
/* @internal */
function getFullMatch(candidateContainers: readonly string[], candidate: string, dotSeparatedSegments: readonly Segment[], stringToWordSpans: ts.Map<TextSpan[]>): PatternMatch | undefined {
...
/* @internal */
function getWordSpans(word: string, stringToWordSpans: ts.Map<TextSpan[]>): TextSpan[] {
...
/* @internal */
function matchTextChunk(candidate: string, chunk: TextChunk, stringToWordSpans: ts.Map<TextSpan[]>): PatternMatch | undefined {
...
/* @internal */
function matchSegment(candidate: string, segment: Segment, stringToWordSpans: ts.Map<TextSpan[]>): PatternMatch | undefined {
