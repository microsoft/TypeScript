import {
    addEmitFlags, ApplicableRefactorInfo, ArrowFunction, BindingElement, CallExpression, CancellationToken, CheckFlags,
    ClassDeclaration, ClassExpression, compareValues, ConstructorDeclaration, contains, copyComments, Debug,
    deduplicate, Diagnostics, ElementAccessExpression, EmitFlags, emptyArray, equateValues, every, Expression, factory,
    FindAllReferences, findAncestor, findChildOfKind, findModifier, first, flatMap, FunctionBody, FunctionDeclaration,
    FunctionExpression, FunctionLikeDeclaration, getCheckFlags, getContainingFunctionDeclaration,
    getContainingObjectLiteralElement, getLocaleSpecificMessage, getMeaningFromLocation, getSourceFileOfNode,
    getSymbolTarget, getSynthesizedDeepClone, getTextOfIdentifierOrLiteral, getTouchingToken, getTypeNodeIfAccessible,
    Identifier, isCallOrNewExpression, isClassDeclaration, isConstructorDeclaration, isDeclaration,
    isElementAccessExpression, isExportAssignment, isExportSpecifier, isExpressionWithTypeArgumentsInClassExtendsClause,
    isFunctionLikeDeclaration, isIdentifier, isImportClause, isImportEqualsDeclaration, isImportSpecifier,
    isInterfaceDeclaration, isJSDocNode, isMethodSignature, isNamespaceImport, isNewExpressionTarget,
    isObjectLiteralExpression, isPropertyAccessExpression, isPropertyAssignment, isRestParameter, isSourceFileJS,
    isThis, isTypeLiteralNode, isVarConst, isVariableDeclaration, LanguageServiceHost, last, map, MethodDeclaration,
    MethodSignature, Modifier, NewExpression, Node, NodeArray, ObjectLiteralElementLike, ObjectLiteralExpression,
    ParameterDeclaration, Program, PropertyAccessExpression, PropertyAssignment, PropertySignature, rangeContainsRange,
