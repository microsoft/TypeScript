    ...
    function isAtTriggerLocation(sourceFile: SourceFile, node: Node, onSecondTry = false): boolean {
        switch (node.kind) {
            ...
            case SyntaxKind.VariableDeclarationList:
                ...
                return isExportsOrModuleExportsOrAlias(sourceFile, decl.initializer!); // TODO: GH#18217
            case SyntaxKind.VariableDeclaration:
                return isExportsOrModuleExportsOrAlias(sourceFile, (node as VariableDeclaration).initializer!); // TODO: GH#18217
            default:
