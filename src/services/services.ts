namespace ts {
    ...
    class CancellationTokenObject implements CancellationToken {
        ...
        public throwIfCancellationRequested(): void {
            if (this.isCancellationRequested()) {
                tracing.on && tracing.instant(tracing.Phase.Session, "cancellationThrown", { kind: "CancellationTokenObject" });
    ...
    export class ThrottledCancellationToken implements CancellationToken {
        ...
        public throwIfCancellationRequested(): void {
            if (this.isCancellationRequested()) {
                tracing.on && tracing.instant(tracing.Phase.Session, "cancellationThrown", { kind: "ThrottledCancellationToken" });
                throw new OperationCanceledException();
            }
        }
    }
