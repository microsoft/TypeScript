...
namespace ts {
    ...
    export interface LanguageServiceShim extends Shim {
         ...
         */
        getRenameInfo(fileName: string, position: number, preferences: UserPreferences, options?: RenameInfoOptions): string;
    ...
    class LanguageServiceShimObject extends ShimBase implements LanguageServiceShim {
        ...
        public getRenameInfo(fileName: string, position: number, preferences: UserPreferences, options?: RenameInfoOptions): string {
            return this.forwardJSONCall(
                `getRenameInfo('${fileName}', ${position})`,
                () => this.languageService.getRenameInfo(fileName, position, preferences, options)
            );
        }
