import {
    ...
    getLeadingCommentRanges, getModeForUsageLocation, getOwnKeys, getPackageJsonTypesVersionsPaths, getPathComponents, getTextOfJsxAttributeName,
    getReplacementSpanForContextToken, getSupportedExtensions, getSupportedExtensionsWithJsonIfResolveJsonModule,
    ...
    isStringLiteral, isStringLiteralLike, isTypeReferenceNode, isUrl, Iterator, JsxAttribute, LanguageServiceHost,
    length, LiteralExpression, LiteralTypeNode, Map, mapDefined, MapLike, ModuleKind, ModuleResolutionKind,
