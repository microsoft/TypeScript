import { createMap, SourceFile, Program, CancellationToken, DiagnosticWithLocation, programContainsEs6Modules, compilerOptionsIndicateEs6Modules, createDiagnosticForNode, Diagnostics, isSourceFileJS, getAllowSyntheticDefaultImports, importFromModuleSpecifier, getResolvedModule, isExportAssignment, addRange, Node, isVariableDeclaration, isVariableStatement, NodeFlags, isRequireCall, isFunctionLikeDeclaration, SyntaxKind, VariableStatement, ExpressionStatement, isBinaryExpression, getAssignmentDeclarationKind, AssignmentDeclarationKind, Expression, isPropertyAccessExpression, AnyValidImportOrReExport, Identifier, isStringLiteral, FunctionLikeDeclaration, TypeChecker, Push, isIdentifier, isAsyncFunction, isBlock, SignatureKind, Block, forEachReturnStatement, ReturnStatement, isReturnStatement, isCallExpression, CallExpression, hasPropertyAccessExpressionWithName, getDeclarationOfExpando } from "./ts";
