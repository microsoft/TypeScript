import {
    ...
    LanguageServiceHost, last, lastOrUndefined, length, mapDefined, MethodSignature, Modifier, NamedImportBindings,
    ...
    ScriptKind, ScriptTarget, setTextRangePosEnd, SignatureDeclaration, singleOrUndefined, skipTrivia, SourceFile,
