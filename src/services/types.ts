import {
    ...
    GetEffectiveTypeRootsHost, HasChangedAutomaticTypeDirectiveNames, HasInvalidatedResolution, LineAndCharacter,
    MinimalResolutionCacheHost, ModuleKind, ModuleResolutionCache, ModuleSpecifierCache, ParsedCommandLine, Path,
