import { TextChangeRange, FileReference, Path, ModuleSpecifierResolutionHost, CompilerOptions, ScriptKind, ProjectReference, ResolvedProjectReference, ResolvedModule, ResolvedModuleWithFailedLookupLocations, ResolvedTypeReferenceDirective, HasInvalidatedResolution, CustomTransformers, DocumentPositionMapper, SourceFileLike, ResolvedProjectReferenceCallbacks, DiagnosticWithLocation, Diagnostic, TextSpan, UserPreferences, Symbol, DocumentHighlights, LineAndCharacter, SourceMapper, TextRange, EmitOutput, Program, SourceFile, CancellationToken } from "./ts";
import { ImportSuggestionsForFileCache } from "./ts.Completions";
...
export interface LanguageServiceHost extends ModuleSpecifierResolutionHost {
    ...
    /* @internal */
    getImportSuggestionsCache?(): ImportSuggestionsForFileCache;
    /* @internal */
