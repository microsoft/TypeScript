    ...
    export function start() {
        ...
        class ProgressBars {
            ...
            private _render(index: number) {
                ...
                cursor.hide();
                readline.moveCursor(process.stdout, -process.stdout.columns!, -this._lineCount); // eslint-disable-line @typescript-eslint/no-unnecessary-type-assertion
                let lineCount = 0;
                ...
                for (let i = 0; i < numProgressBars; i++) {
                    if (i === index) {
                        ...
                        readline.moveCursor(process.stdout, -process.stdout.columns!, +1); // eslint-disable-line @typescript-eslint/no-unnecessary-type-assertion
                    }
