...
export function start(importTests: () => Promise<unknown>): void {
    ...
    function shimTestInterface(rootSuite: Mocha.Suite, context: Mocha.MochaGlobals) {
        ...
        context.after = (title: string | Mocha.Func | Mocha.AsyncFunc, fn?: Mocha.Func | Mocha.AsyncFunc) => suites[0].after all(title as string, fn);
        ...
        context.describe.skip = context.describe = context.xcontext = (title: string) => addSuite(title, /*fn*/ undefined);
