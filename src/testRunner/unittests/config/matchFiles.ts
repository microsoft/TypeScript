...
import { ParsedCommandLine, CompilerOptions, Path, parseJsonText, parseJsonSourceFileConfigFileContent, parseJsonConfigFileContent, Diagnostic, DiagnosticMessage, SourceFile, SyntaxKind, createFileDiagnostic, WatchDirectoryFlags, createCompilerDiagnostic, Diagnostics, JsxEmit } from "../../ts";
