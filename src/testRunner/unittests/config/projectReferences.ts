import { ProjectReference, CompilerOptions, Diagnostic, DiagnosticMessage, combinePaths, Program, createMap, TestFSWithWatch, getDirectoryPath, readConfigFile, flattenDiagnosticMessageText, parseJsonConfigFileContent, parseConfigHostFromCompilerHostLike, createProgram, Diagnostics } from "../../ts";
