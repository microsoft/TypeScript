...
describe("unittests:: FactoryAPI", () => {
    ...
    describe("createBinaryExpression", () => {
        it("parenthesizes arrow function in RHS if necessary", () => {
            ...
            /*typeParameters*/ undefined, [], 
            /*type*/ undefined, 
            /*equalsGreaterThanToken*/ undefined, createBlock([]));
