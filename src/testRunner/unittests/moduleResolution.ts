...
import { getDiagnosticOfFileFromProgram } from "../ts.tscWatch";
...
describe("unittests:: moduleResolution:: Relative imports", () => {
    function test(files: ts.Map<string>, currentDirectory: string, rootFiles: string[], expectedFilesCount: number, relativeNamesToCheck: string[]) {
...
describe("unittests:: moduleResolution:: Files with different casing with forceConsistentCasingInFileNames", () => {
    ...
    function test(files: ts.Map<string>, options: CompilerOptions, currentDirectory: string, useCaseSensitiveFileNames: boolean, rootFiles: string[], expectedDiagnostics: (program: Program) => readonly Diagnostic[]): void {
    ...
    it("should fail when two files used in program differ only in casing (tripleslash references)", () => {
        ...
        /*useCaseSensitiveFileNames*/ false, ["c.ts", "d.ts"], program => [{
                ...getDiagnosticOfFileFromProgram(program, "c.ts", `/// <reference path="D.ts"/>`.indexOf(`D.ts`), "D.ts".length, Diagnostics.Already_included_file_name_0_differs_from_file_name_1_only_in_casing, "D.ts", "d.ts"),
    ...
    it("should fail when two files used in program differ only in casing (imports)", () => {
        ...
        test(files, { module: ModuleKind.AMD, forceConsistentCasingInFileNames: true }, "/a/b", 
        /*useCaseSensitiveFileNames*/ false, ["c.ts", "d.ts"], program => [{
                ...getDiagnosticOfFileFromProgram(program, "c.ts", `import {x} from "D"`.indexOf(`"D"`), `"D"`.length, Diagnostics.Already_included_file_name_0_differs_from_file_name_1_only_in_casing, "/a/b/D.ts", "d.ts"),
                reportsUnnecessary: undefined
            }]);
    });
    it("should fail when two files used in program differ only in casing (imports, relative module names)", () => {
        ...
        /*useCaseSensitiveFileNames*/ false, ["moduleA.ts", "moduleB.ts"], program => [{
                ...getDiagnosticOfFileFromProgram(program, "moduleA.ts", `import {x} from "./ModuleB"`.indexOf(`"./ModuleB"`), `"./ModuleB"`.length, Diagnostics.Already_included_file_name_0_differs_from_file_name_1_only_in_casing, "ModuleB.ts", "moduleB.ts"),
                reportsUnnecessary: undefined
            }]);
    });
    ...
    it("should fail when module name in 'require' calls has inconsistent casing", () => {
        ...
        /*useCaseSensitiveFileNames*/ false, ["moduleA.ts", "moduleB.ts", "moduleC.ts"], program => [
            {
                ...getDiagnosticOfFileFromProgram(program, "moduleA.ts", `import a = require("./ModuleC")`.indexOf(`"./ModuleC"`), `"./ModuleC"`.length, Diagnostics.Already_included_file_name_0_differs_from_file_name_1_only_in_casing, "ModuleC.ts", "moduleC.ts"),
                reportsUnnecessary: undefined
            },
            {
                ...getDiagnosticOfFileFromProgram(program, "moduleB.ts", `import a = require("./moduleC")`.indexOf(`"./moduleC"`), `"./moduleC"`.length, Diagnostics.File_name_0_differs_from_already_included_file_name_1_only_in_casing, "moduleC.ts", "ModuleC.ts"),
                reportsUnnecessary: undefined
            }
        ]);
    });
...
import b = require("./moduleB");
        ...
        /*useCaseSensitiveFileNames*/ false, ["moduleD.ts"], program => [{
                ...getDiagnosticOfFileFromProgram(program, "moduleB.ts", `import a = require("./moduleC")`.indexOf(`"./moduleC"`), `"./moduleC"`.length, Diagnostics.File_name_0_differs_from_already_included_file_name_1_only_in_casing, "/a/B/c/moduleC.ts", "/a/B/c/ModuleC.ts"),
                reportsUnnecessary: undefined
            }]);
    });
