import { createDocumentRegistry, getDefaultCompilerOptions, ScriptSnapshot, CompilerOptions, ScriptTarget, ModuleKind, createTextChangeRange, createTextSpan } from "../../ts";
