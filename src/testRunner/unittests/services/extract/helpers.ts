import { createMap, CharacterCodes, hasProperty, isIdentifierPart, ScriptTarget, LanguageServiceHost, notImplemented, DiagnosticMessage, Extension, RefactorContext, noop, returnFalse, formatting, testFormatSettings, emptyOptions, refactor, createTextSpanFromRange, find, textChanges, Program, length } from "../../../ts";
