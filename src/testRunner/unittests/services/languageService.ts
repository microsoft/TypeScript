import { ScriptSnapshot, getDefaultLibFilePath, emptyArray, createMap, LanguageServiceHost, returnTrue, getDefaultCompilerOptions, Program } from "../../ts";
import { libFile } from "../../ts.projectSystem";
