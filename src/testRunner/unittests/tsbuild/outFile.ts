...
import { getExpectedDiagnosticForProjectsInBuild, Diagnostics, loadProjectFromDisk, BuildOptions, TscIncremental, BuildKind, replaceText, appendText, VerifyTsBuildInput, verifyTscIncrementalEdits, verifyTsc, noChangeRun, getFsWithTime, changeCompilerVersion, verifyOutputsAbsent, verifyOutputsPresent, ExitStatus, enableStrict, addTestPrologue, addShebang, addRest, removeRest, addStubFoo, changeStubToRest, addSpread, addTripleSlashRef, prependText } from "../../ts";
