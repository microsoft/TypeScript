import { verifyTscWatch, File, createWatchedSystem, libFile, TscWatchCompileChange, WatchedSystem } from "../../ts.tscWatch";
...
describe("unittests:: tsc-watch:: emit with when module emit is specified as node", () => {
    verifyTscWatch({
        ...
        changes: [
            sys => {
                sys.modifyFile("/a/rootFolder/project/Scripts/TypeScript.ts", "var zz30 = 100;", { invokeDirectoryWatcherInsteadOfFileChanged: true });
                sys.runQueuedTimeoutCallbacks();
