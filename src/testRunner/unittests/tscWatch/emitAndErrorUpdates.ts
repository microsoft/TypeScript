import { File, projectRoot, verifyTscWatch, createWatchedSystem, libFile, TscWatchCompileChange } from "../../ts.tscWatch";
...
describe("unittests:: tsc-watch:: Emit times and Error updates in builder after program changes", () => {
    ...
    function verifyEmitAndErrorUpdatesWorker({ subScenario, files, currentDirectory, lib, configFile, changes, }: VerifyEmitAndErrorUpdatesWorker) {
        verifyTscWatch({
                ...
                content: `export class C
{
    d = 1;
            ...
            verifyDeepImportChange("updates errors when deep import file changes", bFile, cFile);
        });
                ...
                content: `export class C
{
    d: number;
            ...
            verifyDeepImportChange("updates errors when deep import through declaration file changes", bFile, cFile);
        });
    });
...
export class Data {
    ...
    title: string;
        ...
        describe("when there are no circular import and exports", () => {
            verifyTransitiveExports("when there are no circular import and exports", [lib2Data]);
        });
...
export class Data2 {
    public dat?: Data;
            ...
            verifyTransitiveExports("when there are circular import and exports", [lib2Data, lib2Data2]);
        });
    });
    verifyEmitAndErrorUpdates({
