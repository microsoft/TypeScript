namespace ts.projectSystem {
    describe("unittests:: tsserver:: CachingFileSystemInformation:: tsserverProjectSystem CachingFileSystemInformation", () => {
        ...
        describe("Verify npm install in directory with tsconfig file works when", () => {
            function verifyNpmInstall(scenario: string, timeoutDuringPartialInstallation: boolean) {
                it(scenario, () => {
...
`
                    ...
                    verifyAfterPartialOrCompleteNpmInstall(2);
                    baselineTsserverLogs("cachingFileSystemInformation", `npm install in directory with tsconfig ${scenario}`, projectService);
            ...
            verifyNpmInstall("timeouts occur inbetween installation", /*timeoutDuringPartialInstallation*/ true);
            verifyNpmInstall("timeout occurs after installation", /*timeoutDuringPartialInstallation*/ false);
        });
