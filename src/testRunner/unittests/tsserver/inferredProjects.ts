...
import { combinePaths, ModuleResolutionKind, ScriptTarget, ScriptKind, createMap } from "../../ts";
...
describe("unittests:: tsserver:: Inferred projects", () => {
    ...
    it("should support files without extensions", () => {
        ...
        session.executeCommand((<protocol.SetCompilerOptionsForInferredProjectsRequest>{
            seq: 1,
            type: "request",
