import { File, protocol, TestSession, TestServerHost, checkErrorMessage, checkCompleteEvent, createServerHost, libFile, createSession, openFilesForSession, createSessionWithEventTracking, createDiagnostic } from "../../ts.projectSystem";
import { isString, noop, emptyArray, Diagnostics } from "../../ts";
import { projectRoot } from "../../ts.tscWatch";
import { ConfigFileDiagEvent } from "../../ts.server";
...
describe("unittests:: tsserver:: with project references and error reporting", () => {
    ...
    interface VerifyScenario {
        ...
        expectedConfigFileDiagEvents: () => readonly ConfigFileDiagEvent["data"][];
    }
    ...
    function verifyUsageAndDependency({ allFiles, usageDiagnostics, dependencyDiagnostics }: VerifyUsageAndDependency) {
        ...
        function usageConfigDiag(): ConfigFileDiagEvent["data"] {
            return {
        ...
        function dependencyConfigDiag(): ConfigFileDiagEvent["data"] {
            return {
...
`
        ...
        function usageDiagnostics(): GetErrDiagnostics {
            return {
                ...
                syntax: emptyArray,
                semantic: [
                    createDiagnostic({ line: 4, offset: 5 }, { line: 4, offset: 10 }, Diagnostics.Module_0_has_no_exported_member_1, [`"../dependency/fns"`, "fnErr"], "error")
                ],
                suggestion: emptyArray
            };
        }
        function dependencyDiagnostics(): GetErrDiagnostics {
            return {
                ...
                syntax: emptyArray,
                semantic: [
                    createDiagnostic({ line: 6, offset: 12 }, { line: 6, offset: 13 }, Diagnostics.Type_0_is_not_assignable_to_type_1, ["10", "string"], "error")
                ],
                suggestion: emptyArray
            };
        }
...
`
        ...
        function usageDiagnostics(): GetErrDiagnostics {
            return {
                ...
                syntax: emptyArray,
                semantic: [
                    createDiagnostic({ line: 3, offset: 1 }, { line: 3, offset: 6 }, Diagnostics.Cannot_find_name_0, ["fnErr"], "error")
                ],
                suggestion: emptyArray
            };
        }
        function dependencyDiagnostics(): GetErrDiagnostics {
            return {
                ...
                syntax: emptyArray,
                semantic: [
                    createDiagnostic({ line: 6, offset: 5 }, { line: 6, offset: 6 }, Diagnostics.Type_0_is_not_assignable_to_type_1, ["10", "string"], "error")
                ],
                suggestion: emptyArray
            };
        }
