import { File, createServerHost, libFile, createSession, openFilesForSession, checkNumberOfInferredProjects, checkProjectRootFiles, checkProjectActualFiles, makeSessionRequest, verifyDiagnostics, commonFile2, verifyNoDiagnostics, commonFile1, createProjectService, configuredProjectAt, checkNumberOfConfiguredProjects, toExternalFiles, checkNumberOfProjects, customTypesMap, checkWatchedFiles, toExternalFile, createHasErrorMessageLogger, closeFilesForSession, verifyGetErrRequest } from "../../ts.projectSystem";
import { protocol, CommandNames, ITypingsInstaller, createInstallTypingsRequest, emptyArray, NormalizedPath } from "../../ts.server";
import { Diagnostics, noop, singleIterator, emptyOptions, returnFalse, notImplemented, removeMinAndVersionNumbers, ScriptKind, projectSystem, combinePaths, getDirectoryPath, createTextSpan, getSnapshotText, ScriptElementKind, ScriptTarget, normalizePath, Debug, Path, mapDefined } from "../../ts";
