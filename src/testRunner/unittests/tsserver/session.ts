import { FileWatcher, noop, returnUndefined, AnyFunction, IndentStyle, CompilerOptions, ModuleKind, ScriptTarget, JsxEmit, NewLineKind, ModuleResolutionKind, version, Debug, createMap, FileTextChanges } from "../../ts";
...
describe("unittests:: tsserver:: Session:: General functionality", () => {
    ...
    describe("executeCommand", () => {
        ...
        it("should handle literal types in request", () => {
            ...
            assert.deepEqual(session.getProjectService().getCompilerOptionsForInferredProjects(), (<CompilerOptions>{
