import { File, SymLink, libFile, createServerHost, createSession, openFilesForSession, checkNumberOfProjects, executeSessionRequest, protocol, protocolLocationFromSubstring, protocolRenameSpanFromSubstring, protocolTextSpanFromSubstring, TestSession, verifyGetErrRequest, TestServerHost, checkWatchedFilesDetailed, checkWatchedDirectoriesDetailed, getTypeRootsFromLocation, getNodeModuleDirectories, checkProjectActualFiles, createDiagnostic } from "../../ts.projectSystem";
import { ScriptElementKind, ScriptElementKindModifier, arrayToMap, cloneMap, emptyArray, Diagnostics } from "../../ts";
...
new C();`
        ...
        function verifyWatchedFilesAndDirectories(host: TestServerHost, files: string[], recursiveDirectories: ts.ReadonlyMap<number>, nonRecursiveDirectories: string[]) {
