namespace ts.projectSystem {
    ...
    describe("typingsInstaller:: local module", () => {
    ...
    describe("typingsInstaller:: General functionality", () => {
    ...
    describe("typingsInstaller:: Validate package name:", () => {
    ...
    describe("typingsInstaller:: Invalid package names", () => {
    ...
    describe("typingsInstaller:: discover typings", () => {
    ...
    describe("typingsInstaller:: telemetry events", () => {
    ...
    describe("typingsInstaller:: progress notifications", () => {
    ...
    describe("typingsInstaller:: npm installation command", () => {
    ...
    describe("typingsInstaller:: recomputing resolutions of unresolved imports", () => {
