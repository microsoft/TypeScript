...
import { sys, MapLike, createMap, createMapFromTemplate, combinePaths, normalizeSlashes, toPath, createGetCanonicalFileName, stringContains, Debug, version, forEachAncestorDirectory, getDirectoryPath } from "./ts";
...
function loadTypesRegistryFile(typesRegistryFilePath: string, host: InstallTypingHost, log: Log): ts.Map<MapLike<string>> {
...
export class NodeTypingsInstaller extends TypingsInstaller {
    ...
    readonly typesRegistry: ts.Map<MapLike<string>>;
