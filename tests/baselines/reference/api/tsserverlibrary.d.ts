...
declare namespace ts {
    ...
    type PipelineToken = Token<SyntaxKind.PipelineToken>;
    ...
    type PipelineOperator = SyntaxKind.PipelineToken;
    type ExponentiationOperator = PipelineOperator | SyntaxKind.AsteriskAsteriskToken;
    ...
    interface PipelineExpression extends BinaryExpression {
