...
declare namespace ts {
    ...
    interface InfinityExpression extends LiteralExpression {
        readonly kind: SyntaxKind.InfinityKeyword;
    }
    interface NaNExpression extends LiteralExpression {
        readonly kind: SyntaxKind.NaNKeyword;
    }
    type InfinityOrNaNExpression = InfinityExpression | NaNExpression;
