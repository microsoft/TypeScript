...
declare namespace ts {
     ...
     */
    interface OperatorListExpression extends Expression {
        kind: SyntaxKind.OperatorListExpression;
        operatorToken: BinaryOperatorToken;
        elements: NodeArray<Expression>;
    }
...
declare namespace ts {
    ...
    function createOperatorList(elements: ReadonlyArray<Expression>, operator: Token<BinaryOperator>): OperatorListExpression;
    function updateOperatorList(node: OperatorListExpression, elements: ReadonlyArray<Expression>, operator: Token<BinaryOperator>): OperatorListExpression;
