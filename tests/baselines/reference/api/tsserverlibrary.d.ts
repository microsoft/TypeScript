...
declare namespace ts {
    ...
    export enum TypeFlags {
        ...
        TypeVariable = 17039360,
        InstantiableNonPrimitive = 117702656,
        InstantiablePrimitive = 8388608,
        Instantiable = 126091264,
        StructuredOrInstantiable = 129761280,
        Narrowable = 268188671,
        NotUnionOrUnit = 134746115,
    }
...
declare namespace ts {
    ...
    function createHalfRangeTypeNode(operator: HalfRangeTypeNode["operator"], basis: HalfRangeTypeNode["basis"]): HalfRangeTypeNode;
    function updateHalfRangeTypeNode(node: HalfRangeTypeNode, operator: HalfRangeTypeNode["operator"], basis: HalfRangeTypeNode["basis"]): HalfRangeTypeNode;
