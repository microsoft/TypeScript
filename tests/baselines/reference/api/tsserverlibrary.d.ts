...
declare namespace ts {
    ...
    export enum SyntaxKind {
        ...
        ArrowFunction = 214,
        PartialApplicationExpression = 215,
        PartialApplicationPlaceholderElement = 216,
    ...
    export type PrefixUnaryOperator = SyntaxKind.PlusPlusToken | SyntaxKind.MinusMinusToken | SyntaxKind.PlusToken | SyntaxKind.MinusToken | SyntaxKind.TildeToken | SyntaxKind.TildeOpenParenToken | SyntaxKind.ExclamationToken;
...
declare namespace ts {
    ...
    function isPartialApplicationPlaceholderElement(node: Node): node is PartialApplicationPlaceholderElement;
