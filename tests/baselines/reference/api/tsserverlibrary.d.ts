...
declare namespace ts {
    /** Input to `create*` functions: Either a fresh array (which will have NodeArray properties added) or an existing NodeArray (which will be readonly). */
    type Nodes<T extends Node> = T[] | NodeArray<T>;
    function createNodeArray<T extends Node>(elements?: Nodes<T>, hasTrailingComma?: boolean): NodeArray<T>;
    ...
    function createParameter(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, dotDotDotToken: DotDotDotToken | undefined, name: string | BindingName, questionToken?: QuestionToken, type?: TypeNode, initializer?: Expression): ParameterDeclaration;
    function updateParameter(node: ParameterDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, dotDotDotToken: DotDotDotToken | undefined, name: string | BindingName, questionToken: QuestionToken | undefined, type: TypeNode | undefined, initializer: Expression | undefined): ParameterDeclaration;
    ...
    function createPropertySignature(modifiers: Nodes<Modifier> | undefined, name: PropertyName | string, questionToken: QuestionToken | undefined, type: TypeNode | undefined, initializer: Expression | undefined): PropertySignature;
    function updatePropertySignature(node: PropertySignature, modifiers: Nodes<Modifier> | undefined, name: PropertyName, questionToken: QuestionToken | undefined, type: TypeNode | undefined, initializer: Expression | undefined): PropertySignature;
    function createProperty(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: string | PropertyName, questionToken: QuestionToken | undefined, type: TypeNode | undefined, initializer: Expression | undefined): PropertyDeclaration;
    function updateProperty(node: PropertyDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: string | PropertyName, questionToken: QuestionToken | undefined, type: TypeNode | undefined, initializer: Expression | undefined): PropertyDeclaration;
    function createMethodSignature(typeParameters: Nodes<TypeParameterDeclaration> | undefined, parameters: Nodes<ParameterDeclaration>, type: TypeNode | undefined, name: string | PropertyName, questionToken: QuestionToken | undefined): MethodSignature;
    ...
    function createMethod(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, asteriskToken: AsteriskToken | undefined, name: string | PropertyName, questionToken: QuestionToken | undefined, typeParameters: Nodes<TypeParameterDeclaration> | undefined, parameters: Nodes<ParameterDeclaration>, type: TypeNode | undefined, body: Block | undefined): MethodDeclaration;
    function updateMethod(node: MethodDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, asteriskToken: AsteriskToken | undefined, name: PropertyName, questionToken: QuestionToken | undefined, typeParameters: Nodes<TypeParameterDeclaration> | undefined, parameters: Nodes<ParameterDeclaration>, type: TypeNode | undefined, body: Block | undefined): MethodDeclaration;
    function createConstructor(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, parameters: Nodes<ParameterDeclaration>, body: Block | undefined): ConstructorDeclaration;
    function updateConstructor(node: ConstructorDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, parameters: Nodes<ParameterDeclaration>, body: Block | undefined): ConstructorDeclaration;
    function createGetAccessor(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: string | PropertyName, parameters: Nodes<ParameterDeclaration>, type: TypeNode | undefined, body: Block | undefined): GetAccessorDeclaration;
    function updateGetAccessor(node: GetAccessorDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: PropertyName, parameters: Nodes<ParameterDeclaration>, type: TypeNode | undefined, body: Block | undefined): GetAccessorDeclaration;
    function createSetAccessor(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: string | PropertyName, parameters: Nodes<ParameterDeclaration>, body: Block | undefined): SetAccessorDeclaration;
    function updateSetAccessor(node: SetAccessorDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: PropertyName, parameters: Nodes<ParameterDeclaration>, body: Block | undefined): SetAccessorDeclaration;
    ...
    function createIndexSignature(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, parameters: Nodes<ParameterDeclaration>, type: TypeNode): IndexSignatureDeclaration;
    function updateIndexSignature(node: IndexSignatureDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, parameters: Nodes<ParameterDeclaration>, type: TypeNode): IndexSignatureDeclaration;
    ...
    function createTypeReferenceNode(typeName: string | EntityName, typeArguments: Nodes<TypeNode> | undefined): TypeReferenceNode;
    ...
    function createFunctionTypeNode(typeParameters: Nodes<TypeParameterDeclaration> | undefined, parameters: ParameterDeclaration[], type: TypeNode | undefined): FunctionTypeNode;
    function updateFunctionTypeNode(node: FunctionTypeNode, typeParameters: Nodes<TypeParameterDeclaration> | undefined, parameters: Nodes<ParameterDeclaration>, type: TypeNode | undefined): FunctionTypeNode;
    function createConstructorTypeNode(typeParameters: Nodes<TypeParameterDeclaration> | undefined, parameters: Nodes<ParameterDeclaration>, type: TypeNode | undefined): ConstructorTypeNode;
    function updateConstructorTypeNode(node: ConstructorTypeNode, typeParameters: Nodes<TypeParameterDeclaration> | undefined, parameters: Nodes<ParameterDeclaration>, type: TypeNode | undefined): ConstructorTypeNode;
    ...
    function createTypeLiteralNode(members: Nodes<TypeElement>): TypeLiteralNode;
    ...
    function createTupleTypeNode(elementTypes: Nodes<TypeNode>): TupleTypeNode;
    function updateTypleTypeNode(node: TupleTypeNode, elementTypes: Nodes<TypeNode>): TupleTypeNode;
    ...
    function createUnionOrIntersectionTypeNode(kind: SyntaxKind.UnionType | SyntaxKind.IntersectionType, types: Nodes<TypeNode>): UnionOrIntersectionTypeNode;
    ...
    function createObjectBindingPattern(elements: Nodes<BindingElement>): ObjectBindingPattern;
    function updateObjectBindingPattern(node: ObjectBindingPattern, elements: Nodes<BindingElement>): ObjectBindingPattern;
    function createArrayBindingPattern(elements: Nodes<ArrayBindingElement>): ArrayBindingPattern;
    function updateArrayBindingPattern(node: ArrayBindingPattern, elements: Nodes<ArrayBindingElement>): ArrayBindingPattern;
    ...
    function createArrayLiteral(elements?: Nodes<Expression>, multiLine?: boolean): ArrayLiteralExpression;
    function updateArrayLiteral(node: ArrayLiteralExpression, elements: Nodes<Expression>): ArrayLiteralExpression;
    function createObjectLiteral(properties?: Nodes<ObjectLiteralElementLike>, multiLine?: boolean): ObjectLiteralExpression;
    function updateObjectLiteral(node: ObjectLiteralExpression, properties: Nodes<ObjectLiteralElementLike>): ObjectLiteralExpression;
    ...
    function createCall(expression: Expression, typeArguments: Nodes<TypeNode> | undefined, argumentsArray: Nodes<Expression>): CallExpression;
    function updateCall(node: CallExpression, expression: Expression, typeArguments: Nodes<TypeNode> | undefined, argumentsArray: Nodes<Expression>): CallExpression;
    function createNew(expression: Expression, typeArguments: Nodes<TypeNode> | undefined, argumentsArray: Nodes<Expression> | undefined): NewExpression;
    function updateNew(node: NewExpression, expression: Expression, typeArguments: Nodes<TypeNode> | undefined, argumentsArray: Nodes<Expression> | undefined): NewExpression;
    ...
    function createFunctionExpression(modifiers: Nodes<Modifier> | undefined, asteriskToken: AsteriskToken | undefined, name: string | Identifier | undefined, typeParameters: Nodes<TypeParameterDeclaration> | undefined, parameters: Nodes<ParameterDeclaration>, type: TypeNode | undefined, body: Block): FunctionExpression;
    function updateFunctionExpression(node: FunctionExpression, modifiers: Nodes<Modifier> | undefined, asteriskToken: AsteriskToken | undefined, name: Identifier | undefined, typeParameters: Nodes<TypeParameterDeclaration> | undefined, parameters: Nodes<ParameterDeclaration>, type: TypeNode | undefined, body: Block): FunctionExpression;
    function createArrowFunction(modifiers: Nodes<Modifier> | undefined, typeParameters: Nodes<TypeParameterDeclaration> | undefined, parameters: Nodes<ParameterDeclaration>, type: TypeNode | undefined, equalsGreaterThanToken: EqualsGreaterThanToken | undefined, body: ConciseBody): ArrowFunction;
    function updateArrowFunction(node: ArrowFunction, modifiers: Nodes<Modifier> | undefined, typeParameters: Nodes<TypeParameterDeclaration> | undefined, parameters: Nodes<ParameterDeclaration>, type: TypeNode | undefined, body: ConciseBody): ArrowFunction;
    function updateArrowFunction(node: ArrowFunction, modifiers: Nodes<Modifier> | undefined, typeParameters: Nodes<TypeParameterDeclaration> | undefined, parameters: Nodes<ParameterDeclaration>, type: TypeNode | undefined, equalsGreaterThanToken: Token<SyntaxKind.EqualsGreaterThanToken>, body: ConciseBody): ArrowFunction;
    ...
    function createTemplateExpression(head: TemplateHead, templateSpans: Nodes<TemplateSpan>): TemplateExpression;
    function updateTemplateExpression(node: TemplateExpression, head: TemplateHead, templateSpans: Nodes<TemplateSpan>): TemplateExpression;
    ...
    function createClassExpression(modifiers: Nodes<Modifier> | undefined, name: string | Identifier | undefined, typeParameters: Nodes<TypeParameterDeclaration> | undefined, heritageClauses: Nodes<HeritageClause>, members: Nodes<ClassElement>): ClassExpression;
    function updateClassExpression(node: ClassExpression, modifiers: Nodes<Modifier> | undefined, name: Identifier | undefined, typeParameters: Nodes<TypeParameterDeclaration> | undefined, heritageClauses: Nodes<HeritageClause>, members: Nodes<ClassElement>): ClassExpression;
    function createOmittedExpression(): OmittedExpression;
    function createExpressionWithTypeArguments(typeArguments: Nodes<TypeNode>, expression: Expression): ExpressionWithTypeArguments;
    function updateExpressionWithTypeArguments(node: ExpressionWithTypeArguments, typeArguments: Nodes<TypeNode>, expression: Expression): ExpressionWithTypeArguments;
    ...
    function createBlock(statements: Nodes<Statement>, multiLine?: boolean): Block;
    function updateBlock(node: Block, statements: Nodes<Statement>): Block;
    function createVariableStatement(modifiers: Nodes<Modifier> | undefined, declarationList: VariableDeclarationList | Nodes<VariableDeclaration>): VariableStatement;
    function updateVariableStatement(node: VariableStatement, modifiers: Nodes<Modifier> | undefined, declarationList: VariableDeclarationList): VariableStatement;
    ...
    function createVariableDeclarationList(declarations: Nodes<VariableDeclaration>, flags?: NodeFlags): VariableDeclarationList;
    function updateVariableDeclarationList(node: VariableDeclarationList, declarations: Nodes<VariableDeclaration>): VariableDeclarationList;
    function createFunctionDeclaration(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, asteriskToken: AsteriskToken | undefined, name: string | Identifier | undefined, typeParameters: Nodes<TypeParameterDeclaration> | undefined, parameters: Nodes<ParameterDeclaration>, type: TypeNode | undefined, body: Block | undefined): FunctionDeclaration;
    function updateFunctionDeclaration(node: FunctionDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, asteriskToken: AsteriskToken | undefined, name: Identifier | undefined, typeParameters: Nodes<TypeParameterDeclaration> | undefined, parameters: Nodes<ParameterDeclaration>, type: TypeNode | undefined, body: Block | undefined): FunctionDeclaration;
    function createClassDeclaration(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: string | Identifier | undefined, typeParameters: Nodes<TypeParameterDeclaration> | undefined, heritageClauses: Nodes<HeritageClause>, members: Nodes<ClassElement>): ClassDeclaration;
    function updateClassDeclaration(node: ClassDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: Identifier | undefined, typeParameters: Nodes<TypeParameterDeclaration> | undefined, heritageClauses: Nodes<HeritageClause>, members: Nodes<ClassElement>): ClassDeclaration;
    function createInterfaceDeclaration(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: string | Identifier, typeParameters: Nodes<TypeParameterDeclaration> | undefined, heritageClauses: Nodes<HeritageClause> | undefined, members: Nodes<TypeElement>): InterfaceDeclaration;
    function updateInterfaceDeclaration(node: InterfaceDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: Identifier, typeParameters: Nodes<TypeParameterDeclaration> | undefined, heritageClauses: Nodes<HeritageClause> | undefined, members: Nodes<TypeElement>): InterfaceDeclaration;
    function createTypeAliasDeclaration(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: string | Identifier, typeParameters: Nodes<TypeParameterDeclaration> | undefined, type: TypeNode): TypeAliasDeclaration;
    function updateTypeAliasDeclaration(node: TypeAliasDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: Identifier, typeParameters: Nodes<TypeParameterDeclaration> | undefined, type: TypeNode): TypeAliasDeclaration;
    function createEnumDeclaration(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: string | Identifier, members: Nodes<EnumMember>): EnumDeclaration;
    function updateEnumDeclaration(node: EnumDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: Identifier, members: Nodes<EnumMember>): EnumDeclaration;
    function createModuleDeclaration(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: ModuleName, body: ModuleBody | undefined, flags?: NodeFlags): ModuleDeclaration;
    function updateModuleDeclaration(node: ModuleDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: ModuleName, body: ModuleBody | undefined): ModuleDeclaration;
    function createModuleBlock(statements: Nodes<Statement>): ModuleBlock;
    function updateModuleBlock(node: ModuleBlock, statements: Nodes<Statement>): ModuleBlock;
    function createCaseBlock(clauses: Nodes<CaseOrDefaultClause>): CaseBlock;
    function updateCaseBlock(node: CaseBlock, clauses: Nodes<CaseOrDefaultClause>): CaseBlock;
    ...
    function createImportEqualsDeclaration(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: string | Identifier, moduleReference: ModuleReference): ImportEqualsDeclaration;
    function updateImportEqualsDeclaration(node: ImportEqualsDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, name: Identifier, moduleReference: ModuleReference): ImportEqualsDeclaration;
    function createImportDeclaration(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, importClause: ImportClause | undefined, moduleSpecifier?: Expression): ImportDeclaration;
    function updateImportDeclaration(node: ImportDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, importClause: ImportClause | undefined, moduleSpecifier: Expression | undefined): ImportDeclaration;
    ...
    function createNamedImports(elements: Nodes<ImportSpecifier>): NamedImports;
    function updateNamedImports(node: NamedImports, elements: Nodes<ImportSpecifier>): NamedImports;
    ...
    function createExportAssignment(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, isExportEquals: boolean, expression: Expression): ExportAssignment;
    function updateExportAssignment(node: ExportAssignment, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, expression: Expression): ExportAssignment;
    function createExportDeclaration(decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, exportClause: NamedExports | undefined, moduleSpecifier?: Expression): ExportDeclaration;
    function updateExportDeclaration(node: ExportDeclaration, decorators: Nodes<Decorator> | undefined, modifiers: Nodes<Modifier> | undefined, exportClause: NamedExports | undefined, moduleSpecifier: Expression | undefined): ExportDeclaration;
    function createNamedExports(elements: Nodes<ExportSpecifier>): NamedExports;
    function updateNamedExports(node: NamedExports, elements: Nodes<ExportSpecifier>): NamedExports;
    ...
    function createJsxElement(openingElement: JsxOpeningElement, children: Nodes<JsxChild>, closingElement: JsxClosingElement): JsxElement;
    function updateJsxElement(node: JsxElement, openingElement: JsxOpeningElement, children: Nodes<JsxChild>, closingElement: JsxClosingElement): JsxElement;
    ...
    function createJsxFragment(openingFragment: JsxOpeningFragment, children: Nodes<JsxChild>, closingFragment: JsxClosingFragment): JsxFragment;
    function updateJsxFragment(node: JsxFragment, openingFragment: JsxOpeningFragment, children: Nodes<JsxChild>, closingFragment: JsxClosingFragment): JsxFragment;
    function createJsxAttribute(name: Identifier, initializer: StringLiteral | JsxExpression): JsxAttribute;
    function updateJsxAttribute(node: JsxAttribute, name: Identifier, initializer: StringLiteral | JsxExpression): JsxAttribute;
    function createJsxAttributes(properties: Nodes<JsxAttributeLike>): JsxAttributes;
    function updateJsxAttributes(node: JsxAttributes, properties: Nodes<JsxAttributeLike>): JsxAttributes;
    ...
    function createCaseClause(expression: Expression, statements: Nodes<Statement>): CaseClause;
    function updateCaseClause(node: CaseClause, expression: Expression, statements: Nodes<Statement>): CaseClause;
    function createDefaultClause(statements: Nodes<Statement>): DefaultClause;
    function updateDefaultClause(node: DefaultClause, statements: Nodes<Statement>): DefaultClause;
    function createHeritageClause(token: HeritageClause["token"], types: Nodes<ExpressionWithTypeArguments>): HeritageClause;
    function updateHeritageClause(node: HeritageClause, types: Nodes<ExpressionWithTypeArguments>): HeritageClause;
    ...
    function updateSourceFileNode(node: SourceFile, statements: Nodes<Statement>): SourceFile;
    /**
    ...
    function createCommaList(elements: Nodes<Expression>): CommaListExpression;
    function updateCommaList(node: CommaListExpression, elements: Nodes<Expression>): CommaListExpression;
