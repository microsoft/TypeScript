...
declare namespace ts {
    ...
    export enum SyntaxKind {
        ...
        TemplateType = 192,
        TemplateTypeSpan = 193,
        ImportType = 194,
        ObjectBindingPattern = 195,
        ArrayBindingPattern = 196,
        BindingElement = 197,
        ArrayLiteralExpression = 198,
        ObjectLiteralExpression = 199,
        PropertyAccessExpression = 200,
        ElementAccessExpression = 201,
        CallExpression = 202,
        NewExpression = 203,
