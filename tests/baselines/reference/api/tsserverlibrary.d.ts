...
declare namespace ts {
    ...
    enum SyntaxKind {
        ...
        LiteralType = 183,
        ImportType = 184,
        InlineTypeAliasDeclaration = 185,
    ...
    interface InlineTypeAliasDeclaration extends TypeNode, Declaration, JSDocContainer {
...
declare namespace ts {
    ...
    function createInlineTypeAliasDeclaration(name: Identifier | string, type: TypeNode): InlineTypeAliasDeclaration;
    function updateInlineTypeAliasDeclaration(node: InlineTypeAliasDeclaration, name: Identifier | string, type: TypeNode): InlineTypeAliasDeclaration;
