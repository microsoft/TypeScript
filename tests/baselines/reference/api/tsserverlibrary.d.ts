...
declare namespace ts {
    ...
    function createJsxText(text: string, containsOnlyWhiteSpaces: boolean): JsxText;
    function updateJsxText(node: JsxText, text: string, containsOnlyWhiteSpaces: boolean): JsxText;
