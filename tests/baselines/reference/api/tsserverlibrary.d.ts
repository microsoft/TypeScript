...
declare namespace ts {
    ...
    export enum SyntaxKind {
        ...
        NewExpression = 202,
        BindExpression = 203,
        TaggedTemplateExpression = 204,
        TypeAssertionExpression = 205,
        ParenthesizedExpression = 206,
        FunctionExpression = 207,
        ArrowFunction = 208,
        DeleteExpression = 209,
        TypeOfExpression = 210,
        VoidExpression = 211,
        AwaitExpression = 212,
        PrefixUnaryExpression = 213,
        PostfixUnaryExpression = 214,
        BinaryExpression = 215,
        ConditionalExpression = 216,
        TemplateExpression = 217,
        YieldExpression = 218,
        SpreadElement = 219,
        ClassExpression = 220,
        OmittedExpression = 221,
        ExpressionWithTypeArguments = 222,
        AsExpression = 223,
        NonNullExpression = 224,
        MetaProperty = 225,
        SyntheticExpression = 226,
        TemplateSpan = 227,
        SemicolonClassElement = 228,
        Block = 229,
        EmptyStatement = 230,
        VariableStatement = 231,
