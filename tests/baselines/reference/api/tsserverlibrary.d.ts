...
declare namespace ts {
    ...
    type PreferInferKeyword = ModifierToken<SyntaxKind.PreferInferKeyword>;
    ...
    type Modifier = AbstractKeyword | AccessorKeyword | AsyncKeyword | ConstKeyword | DeclareKeyword | DefaultKeyword | ExportKeyword | InKeyword | PreferInferKeyword | PrivateKeyword | ProtectedKeyword | PublicKeyword | OutKeyword | OverrideKeyword | ReadonlyKeyword | StaticKeyword;
