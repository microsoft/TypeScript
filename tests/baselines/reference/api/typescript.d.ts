...
declare namespace ts {
    ...
    interface PrivateNameTypeNode extends TypeNode {
    ...
    interface PrivateNameType extends StringLiteralType {
        symbol: Symbol;
    }
    ...
    function isPrivateNameTypeNode(node: Node): node is PrivateNameTypeNode;
