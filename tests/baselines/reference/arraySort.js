...
strTuple.sort(); // Type should be ("foo" | "bar" | "baz")[] instead of ["foo", "bar", "baz"]
var numTuple;
numTuple.sort(function (a, b) { return a - b; }); // Type should be (11 | 2 | 22 | 1)[] instead of [11, 2, 22, 1]
var int8Array;
int8Array.sort(function (a, b) { return a - b; }); // Int8Array
var uint8Array;
uint8Array.sort(function (a, b) { return a - b; }); // Uint8Array
var uint8ClampedArray;
uint8ClampedArray.sort(function (a, b) { return a - b; }); // Uint8ClampedArray
var int16Array;
int16Array.sort(function (a, b) { return a - b; }); // Int16Array
var uint16Array;
uint16Array.sort(function (a, b) { return a - b; }); // Uint16Array
var int32Array;
int32Array.sort(function (a, b) { return a - b; }); // Int32Array
var uint32Array;
uint32Array.sort(function (a, b) { return a - b; }); // Uint32Array
var float32Array;
float32Array.sort(function (a, b) { return a - b; }); // Float32Array
var float64Array;
float64Array.sort(function (a, b) { return a - b; }); // Float64Array
var bigInt64Array;
bigInt64Array.sort(function (a, b) { return a - b; }); // BigInt64Array
var bigUint64Array;
bigUint64Array.sort(function (a, b) { return a - b; }); // BigUint64Array
