...
a2 = function (x) {var args = [];
    ...
    return 1;}; // should be type mismatch error
...
a4 = function (x) {var args = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        args[_i - 1] = arguments[_i];
    }
    return 1;}; // error, rest params have type mismatch
