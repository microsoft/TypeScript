//// [asyncGenerators.functionDeclaration.14.es5.ts]
async function * f() {
    yield * f();
}

//// [asyncGenerators.functionDeclaration.14.es5.js]
...
function f() {
    return __asyncGenerator(this, arguments, function f_1() {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [5 /*yield**/, __values(__asyncDelegator(f(), "__iterator__"))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
