//// [tests/cases/compiler/bundleCommonjs.ts] ////

//// [bundleCommonjs_file0.ts]
...
module.exports = (function() {
    ...
    __define("/tests/cases/compiler/bundleCommonjs_file0", function(require, exports, module){
        class Foo {
        }
        Foo.CONSTANT = "Foo";
        exports.Foo = Foo;
    ...
    __define("/tests/cases/compiler/bundleCommonjs_file1", function(require, exports, module){
        var bundleCommonjs_file0_1 = require("./bundleCommonjs_file0");
        bundleCommonjs_file0_1.assert(bundleCommonjs_file0_1.Foo.CONSTANT === "Foo");
    });
    return __define.require("bundleCommonjs_file1");
})();
