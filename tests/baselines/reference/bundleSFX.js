//// [tests/cases/compiler/bundleSFX.ts] ////
...
(function() {
    ...
    __define("/tests/cases/compiler/bundleSFX_file0", function(require, exports, module){
        class Foo {
        }
        Foo.CONSTANT = "Foo";
        exports.Foo = Foo;
    ...
    __define("/tests/cases/compiler/bundleSFX_file1", function(require, exports, module){
        var bundleSFX_file0_1 = require("./bundleSFX_file0");
        bundleSFX_file0_1.assert(bundleSFX_file0_1.Foo.CONSTANT === "Foo");
    });
    return __define.require("bundleSFX_file1");
})()
