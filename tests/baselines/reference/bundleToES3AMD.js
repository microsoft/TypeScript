//// [tests/cases/compiler/bundleToES3AMD.ts] ////

//// [bundleToES3AMD_file0.ts]
...
define(["require"], function(require){
    return (function() {
        ...
        __define("/tests/cases/compiler/bundleToES3AMD_file0", function(require, exports, module){
            var Foo = (function () {
                function Foo() {
                }
                Foo.CONSTANT = "Foo";
