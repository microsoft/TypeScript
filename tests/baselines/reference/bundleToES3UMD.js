//// [tests/cases/compiler/bundleToES3UMD.ts] ////

//// [bundleToES3UMD_file0.ts]
...
(function (deps, factory) {
    ...
    return (function() {
        ...
        __define("/tests/cases/compiler/bundleToES3UMD_file0", function(require, exports, module){
            var Foo = (function () {
                function Foo() {
                }
                Foo.CONSTANT = "Foo";
        ...
        __define("/tests/cases/compiler/bundleToES3UMD_file1", function(require, exports, module){
            var bundleToES3UMD_file0_1 = require("./bundleToES3UMD_file0");
            bundleToES3UMD_file0_1.assert(bundleToES3UMD_file0_1.Foo.CONSTANT === "Foo");
        });
        return __define.require("bundleToES3UMD_file1");
    })();
});
