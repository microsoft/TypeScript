//// [tests/cases/compiler/bundleUMD.ts] ////
...
(function (deps, factory) {
    ...
    return (function() {
        ...
        __define("/tests/cases/compiler/bundleUMD_file0", function(require, exports, module){
            class Foo {
            }
            Foo.CONSTANT = "Foo";
            exports.Foo = Foo;
        ...
        __define("/tests/cases/compiler/bundleUMD_file1", function(require, exports, module){
            var bundleUMD_file0_1 = require("./bundleUMD_file0");
            bundleUMD_file0_1.assert(bundleUMD_file0_1.Foo.CONSTANT === "Foo");
        });
        return __define.require("bundleUMD_file1");
    })();
});
