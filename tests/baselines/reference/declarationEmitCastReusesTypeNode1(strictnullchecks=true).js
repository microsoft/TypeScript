...
declarationEmitCastReusesTypeNode1.d.ts(7,59): error TS1016: A required parameter cannot follow an optional parameter.
declarationEmitCastReusesTypeNode1.d.ts(14,38): error TS1016: A required parameter cannot follow an optional parameter.
declarationEmitCastReusesTypeNode1.d.ts(21,70): error TS1016: A required parameter cannot follow an optional parameter.


==== declarationEmitCastReusesTypeNode1.d.ts (3 errors) ====
    type P = {} & {
        name: string;
    };
    export declare let vLet: P;
