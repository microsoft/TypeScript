...
export declare const arrow2: () => void;
export declare const arrow3: {
    (): void;
    77: number;
};
export declare const arrow4: () => void;
export declare const arrow5: {
    (): void;
    "101": number;
};
export declare const arrow6: () => void;
export declare const arrow7: {
    (): void;
    "qwe rty": number;
};
export declare const arrow8: () => void;
export declare const arrow9: {
    (): void;
    "\uD83E\uDD2A": number;
};
export declare const arrow10: () => void;
