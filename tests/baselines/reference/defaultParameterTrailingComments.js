...
var C = /** @class */ (function () {
    function C(defaultParam /* Emit only once*/) {if (defaultParam === void 0) { defaultParam = false; }}
    return C;
}());
function foo(defaultParam /*emit only once*/) {if (defaultParam === void 0) { defaultParam = 10; }}
