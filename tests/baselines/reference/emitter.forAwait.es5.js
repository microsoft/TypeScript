//// [tests/cases/conformance/emitter/es5/forAwait/emitter.forAwait.es5.ts] ////
    ...
    return __asyncGenerator(this, arguments, function f3_1() {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 6:
                    _b.trys.push([6, , 8, 9]);
                    return [4 /*yield*/, ["await", __close(y_1)]];
                case 7:
                    _b.sent();
                    return [3 /*break*/, 9];
                case 8:
