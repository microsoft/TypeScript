...
function callExpression4() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, x.apply(void 0, __spread(y, [z]))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, x];
                case 1:
                    (_a.sent()).apply(void 0, __spread(y, [z]));
                    return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, y];
                case 1:
                    _b.apply(_a, _c.concat([__spread.apply(void 0, [(_d.sent()), [z]])]));
                    return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    return [4 /*yield*/, z];
                case 1:
                    _b.apply(_a, _c.concat([__spread.apply(void 0, _d.concat([[_e.sent()]]))]));
                    return [2 /*return*/];
            }
        });
    });
