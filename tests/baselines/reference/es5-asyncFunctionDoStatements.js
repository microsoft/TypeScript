...
function doStatement2() {
    return __awaiter(this, void 0, void 0, function () {return __generator(this, function (_a) {switch (_a.label) {case 0:
                    x;
                    _a.label = 1;
                case 1: return [4 /*yield*/, y];
                case 2:if (_a.sent()) return [3 /*break*/, 0];
                    _a.label = 3;
                case 3: return [2 /*return*/];
            }
        });
...
function doStatement6() {
    return __awaiter(this, void 0, void 0, function () {return __generator(this, function (_a) {switch (_a.label) {case 0: return [3 /*break*/, 1];
                case 1: return [4 /*yield*/, y];
                case 2:if (_a.sent()) return [3 /*break*/, 0];
                    _a.label = 3;
                case 3: return [2 /*return*/];
...
function doStatement14() {
    return __awaiter(this, void 0, void 0, function () {return __generator(this, function (_a) {switch (_a.label) {case 0: return [3 /*break*/, 3];
                case 1: return [4 /*yield*/, y];
                case 2:if (_a.sent()) return [3 /*break*/, 0];
                    _a.label = 3;
                case 3: return [2 /*return*/];
