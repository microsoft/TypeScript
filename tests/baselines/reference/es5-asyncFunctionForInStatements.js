...
function forInStatement1() {
    return __awaiter(this, void 0, void 0, function () {var _a, _b, _i;
        return __generator(this, function (_c) {switch (_c.label) {case 0:_a = [];
                    return [4 /*yield*/, y];
                case 1:for (_b in _c.sent())
                        _a.push(_b);
                    _i = 0;
                    _c.label = 2;
...
function forInStatement2() {
    return __awaiter(this, void 0, void 0, function () {var _a, _b, _i;
        return __generator(this, function (_c) {switch (_c.label) {case 0:_a = [];
                    ...
                    _i = 0;
                    _c.label = 1;
                case 1:if (!(_i < _a.length)) return [3 /*break*/, 4];
                    x = _a[_i];
                    return [4 /*yield*/, z];
                case 2:
                    _c.sent();
...
function forInStatement6() {
    return __awaiter(this, void 0, void 0, function () {var a;
...
function forInStatement7() {
    return __awaiter(this, void 0, void 0, function () {var _a, _b, _i, b;
        return __generator(this, function (_c) {switch (_c.label) {case 0:_a = [];
                    return [4 /*yield*/, y];
                case 1:for (_b in _c.sent())
                        _a.push(_b);
...
function forInStatement8() {
    return __awaiter(this, void 0, void 0, function () {var _a, _b, _i, c;
        return __generator(this, function (_c) {switch (_c.label) {case 0:_a = [];
                    for (_b in y)
                        _a.push(_b);
                    _i = 0;
