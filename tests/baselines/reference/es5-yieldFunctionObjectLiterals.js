...
function objectLiteral3() {
    var x, _a;
    var _b;
    return __generator(this, function (_c) {switch (_c.label) {case 0:_a = {
                    a: 1
                };
                return [4 /*yield*/, 2];
            case 1:x = (_b = (_a.b = _c.sent(),
                    _a),
                    _b[g()] = 3,
                    _b.c = 4,
                    _b);
