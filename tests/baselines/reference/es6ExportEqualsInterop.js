...
z9.a;
z0.a;
const y2 = __importStar(require("variable"));
const y3 = __importStar(require("interface-variable"));
const y4 = __importStar(require("module"));
const y5 = __importStar(require("interface-module"));
const y6 = __importStar(require("variable-module"));
const y7 = __importStar(require("function"));
const y8 = __importStar(require("function-module"));
const y9 = __importStar(require("class"));
const y0 = __importStar(require("class-module"));
y1.a;
y2.a;
y3.a;
y4.a;
