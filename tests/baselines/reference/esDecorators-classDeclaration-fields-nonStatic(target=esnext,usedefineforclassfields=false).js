...
let C = (() => {
    ...
    return class C {
        ...
        static {
            ...
            __esDecorate(null, null, _member_decorators_1, { kind: "field", name: _a, static: false, private: false, access: { has: obj => _a in obj, get: obj => obj[_a], set: (obj, value) => { obj[_a] = value; } }, metadata: metadata }, _member_initializers_1, _instanceExtraInitializers);
