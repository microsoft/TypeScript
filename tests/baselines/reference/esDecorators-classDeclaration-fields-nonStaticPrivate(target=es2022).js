...
let C = (() => {
    ...
    return class C {
        static {
            ...
            __esDecorate(null, null, _private_field1_decorators, { kind: "field", name: "#field1", static: false, private: true, access: { has: obj => #field1 in obj, get: obj => obj.#field1, set: (obj, value) => { obj.#field1 = value; } }, metadata: metadata }, _private_field1_initializers, _instanceExtraInitializers);
