...
let C = (() => {
    ...
    return class C {
        static {
            ...
            tslib_1.__esDecorate(null, null, _private_x_decorators, { kind: "field", name: "#x", static: false, private: true, access: { get() { return this.#x; }, set(value) { this.#x = value; } } }, _private_x_initializers, _instanceExtraInitializers);
        }
