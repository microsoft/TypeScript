...
let C = (() => {
    ...
    return class C {
        static {
            ...
            tslib_1.__esDecorate(this, _private_set_foo_descriptor = { set: tslib_1.__setFunctionName(function (value) { }, "#foo", "set") }, _private_set_foo_decorators, { kind: "setter", name: "#foo", static: false, private: true, access: { set(value) { this.#foo = value; } } }, null, _instanceExtraInitializers);
        }
