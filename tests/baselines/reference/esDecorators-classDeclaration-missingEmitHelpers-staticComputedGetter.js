...
let C = (() => {
    ...
    return class C {
        static {
            ...
            tslib_1.__esDecorate(this, null, _static_get_member_decorators, { kind: "getter", name: _a, static: true, private: false, access: { has: obj => _a in obj, get: obj => obj[_a] }, metadata: metadata }, null, _staticExtraInitializers);
