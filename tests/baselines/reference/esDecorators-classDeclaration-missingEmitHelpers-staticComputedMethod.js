...
let C = (() => {
    ...
    return class C {
        static {
            tslib_1.__esDecorate(this, null, _static_member_decorators, { kind: "method", name: _a, static: true, private: false, access: { get() { return this[_a]; } } }, null, _staticExtraInitializers);
