...
let C = (() => {
    ...
    return class C {
        static {
            tslib_1.__esDecorate(this, null, _static_set_member_decorators, { kind: "setter", name: _a, static: true, private: false, access: { set(value) { this[_a] = value; } } }, null, _staticExtraInitializers);
