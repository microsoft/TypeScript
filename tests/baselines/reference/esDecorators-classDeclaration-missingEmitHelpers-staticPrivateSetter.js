...
let C = (() => {
    ...
    return class C {
        static {
            ...
            tslib_1.__esDecorate(this, _static_private_set_foo_descriptor = { set: tslib_1.__setFunctionName(function (value) { }, "#foo", "set") }, _static_private_set_foo_decorators, { kind: "setter", name: "#foo", static: true, private: true, access: { set(value) { this.#foo = value; } } }, null, _staticExtraInitializers);
