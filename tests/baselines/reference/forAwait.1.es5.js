...
try {
    for (var ai_1 = { iterator: __asyncValues(ai, "__iterator__") }; yield __asyncStep(ai_1);) {
        var x = ai_1.result.value;
    }
}
catch (e_1_1) { e_1 = { error: e_1_1 }; }
finally {
    try { yield __close(ai_1); } finally { if (e_1) throw e_1.error; }
}
var e_1;
