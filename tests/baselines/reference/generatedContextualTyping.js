...
var x12: Generic<Base> = { func: n => { return [d1, d2]; } };
...
class x24 { member: Generic<Base> = { func: n => { return [d1, d2]; } } }
...
class x36 { private member: Generic<Base> = { func: n => { return [d1, d2]; } } }
...
class x48 { public member: Generic<Base> = { func: n => { return [d1, d2]; } } }
...
class x60 { static member: Generic<Base> = { func: n => { return [d1, d2]; } } }
...
class x72 { private static member: Generic<Base> = { func: n => { return [d1, d2]; } } }
...
class x84 { public static member: Generic<Base> = { func: n => { return [d1, d2]; } } }
...
class x96 { constructor(parm: Generic<Base> = { func: n => { return [d1, d2]; } }) { } }
...
class x108 { constructor(public parm: Generic<Base> = { func: n => { return [d1, d2]; } }) { } }
...
class x120 { constructor(private parm: Generic<Base> = { func: n => { return [d1, d2]; } }) { } }
...
function x132(parm: Generic<Base> = { func: n => { return [d1, d2]; } }) { }
...
function x144(): Generic<Base> { return { func: n => { return [d1, d2]; } }; }
...
function x156(): Generic<Base> { return { func: n => { return [d1, d2]; } }; return { func: n => { return [d1, d2]; } }; }
...
var x168: () => Generic<Base> = () => { return { func: n => { return [d1, d2]; } }; };
...
var x180: () => Generic<Base> = function() { return { func: n => { return [d1, d2]; } }; };
...
namespace x192 { var t: Generic<Base> = { func: n => { return [d1, d2]; } }; }
...
namespace x204 { export var t: Generic<Base> = { func: n => { return [d1, d2]; } }; }
...
var x216 = <Generic<Base>>{ func: n => { return [d1, d2]; } };
...
var x236: Generic<Base>; x236 = { func: n => { return [d1, d2]; } };
...
var x248: { n: Generic<Base>; } = { n: { func: n => { return [d1, d2]; } } };
var x252: { (): Base[]; }[] = [() => [d1, d2]];
...
var x260: Generic<Base>[] = [{ func: n => { return [d1, d2]; } }];
...
var x296: Generic<Base> = true ? { func: n => { return [d1, d2]; } } : { func: n => { return [d1, d2]; } };
...
var x308: Generic<Base> = true ? undefined : { func: n => { return [d1, d2]; } };
...
var x320: Generic<Base> = true ? { func: n => { return [d1, d2]; } } : undefined;
...
function x332(n: Generic<Base>) { }; x332({ func: n => { return [d1, d2]; } });
...
var x344 = (n: Generic<Base>) => n; x344({ func: n => { return [d1, d2]; } });
...
var x356 = function(n: Generic<Base>) { }; x356({ func: n => { return [d1, d2]; } });
