...
var r5 = foo2(1, function (a) { return ''; });
var r6 = foo2('', function (a) { return 1; });
function foo3(x, cb, y) {
    return cb(x);
}
var r7 = foo3(1, function (a) { return ''; }, '');
var r8 = foo3(1, function (a) {
    return '';
}, 1);
var r9 = foo3(1, function (a) { return ''; }, '');
function other(t, u) {
    var r10 = foo2(1, function (x) { return ''; });
    var r10 = foo2(1, function (x) { return ''; });
    var r11 = foo3(1, function (x) { return ''; }, '');
