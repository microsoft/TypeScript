...
(function (GenericParameter) {
    ...
    var r5 = foo5(function (x) { return x; });
    var a;
    var r7 = foo5(a);
    function foo6(cb) {
        return cb;
    }
    var r8 = foo6(function (x) { return x; });
    var r9 = foo6(function (x) { return ''; });
    var r11 = foo6(function (x, y) { return ''; });
    function foo7(x, cb) {
        return cb;
    }
    var r12 = foo7(1, function (x) { return x; });
    var r13 = foo7(1, function (x) { return ''; });
    var a;
    var r14 = foo7(1, a);
