...
f1(ns[0], ns[1], true);
f1.apply(void 0, __spreadArray(__spreadArray([], ns, false), [true], false));
f2(42, "hello", true);
f2(t3[0], t3[1], t3[2]);
f2.apply(void 0, t3);
...
f2(ns[0], ns[1], true);
f2.apply(void 0, __spreadArray(__spreadArray([], ns, false), [true], false));
...
var x18 = f10.apply(void 0, __spreadArray(__spreadArray([], ns, false), [true], false)); // [number, string, boolean]
function g10(u, v) {
    var x1 = f10.apply(void 0, u); // U
    var x2 = f10.apply(void 0, v); // [V["0"], V["1"]]
    var x3 = f10.apply(void 0, __spreadArray([1], u, false)); // [number, ...U]
    var x4 = f10.apply(void 0, __spreadArray(__spreadArray([], u, false), v, false)); // [...U, V["0"], V["1"]]
}
...
var z18 = f11.apply(void 0, __spreadArray(__spreadArray([], ns, false), [true], false)); // [number, string, true]
function g11(u, v) {
    var x1 = f11.apply(void 0, u); // U
    var x2 = f11.apply(void 0, v); // [V["0"], V["1"]]
    var x3 = f11.apply(void 0, __spreadArray([1], u, false)); // [1, ...U]
    var x4 = f11.apply(void 0, __spreadArray(__spreadArray([], u, false), v, false)); // [...U, V["0"], V["1"]]
}
function call(f) {
    var args = [];
...
var x23 = call(f16, "hello", 42); // string | number
