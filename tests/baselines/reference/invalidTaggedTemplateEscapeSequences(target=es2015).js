...
const y = `\u{hello} ${100} \xtraordinary ${200} wonderful ${300} \uworld`; // should error with NoSubstitutionTemplate
const z = tag(__makeTemplateObject([undefined], ["\\u{hello} \\xtraordinary wonderful \\uworld"]))

; // should work with Tagged NoSubstitutionTemplate
const a1 = tag `${100}\0`
; // \0
const a2 = tag(__makeTemplateObject(["", undefined], ["", "\\00"]), 100)
; // \\00
const a3 = tag(__makeTemplateObject(["", undefined], ["", "\\u"]), 100)
; // \\u
const a4 = tag(__makeTemplateObject(["", undefined], ["", "\\u0"]), 100)
; // \\u0
const a5 = tag(__makeTemplateObject(["", undefined], ["", "\\u00"]), 100)
; // \\u00
const a6 = tag(__makeTemplateObject(["", undefined], ["", "\\u000"]), 100)
; // \\u000
const a7 = tag `${100}\u0000`
; // \u0000
const a8 = tag(__makeTemplateObject(["", undefined], ["", "\\u{"]), 100)
; // \\u{
const a9 = tag `${100}\u{10FFFF}`
; // \\u{10FFFF
const a10 = tag(__makeTemplateObject(["", undefined], ["", "\\u{1f622"]), 100)
; // \\u{1f622
const a11 = tag `${100}\u{1f622}`
; // \u{1f622}
const a12 = tag(__makeTemplateObject(["", undefined], ["", "\\x"]), 100)
; // \\x
const a13 = tag(__makeTemplateObject(["", undefined], ["", "\\x0"]), 100)
; // \\x0
const a14 = tag `${100}\x00`
; // \x00
