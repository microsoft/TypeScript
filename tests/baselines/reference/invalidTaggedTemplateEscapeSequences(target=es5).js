...
var z = tag(__makeTemplateObject([undefined], ["\\u{hello} \\xtraordinary wonderful \\uworld"]))

; // should work with Tagged NoSubstitutionTemplate

var a1 = tag(__makeTemplateObject(["", "\0"], ["", "\\0"]), 100)
; // \0
var a2 = tag(__makeTemplateObject(["", undefined], ["", "\\00"]), 100)
; // \\00
var a3 = tag(__makeTemplateObject(["", undefined], ["", "\\u"]), 100)
; // \\u
var a4 = tag(__makeTemplateObject(["", undefined], ["", "\\u0"]), 100)
; // \\u0
var a5 = tag(__makeTemplateObject(["", undefined], ["", "\\u00"]), 100)
; // \\u00
var a6 = tag(__makeTemplateObject(["", undefined], ["", "\\u000"]), 100)
; // \\u000
var a7 = tag(__makeTemplateObject(["", "\0"], ["", "\\u0000"]), 100)
; // \u0000
var a8 = tag(__makeTemplateObject(["", undefined], ["", "\\u{"]), 100)
; // \\u{
var a9 = tag(__makeTemplateObject(["", "\uDBFF\uDFFF"], ["", "\\u{10FFFF}"]), 100)
; // \\u{10FFFF
var a10 = tag(__makeTemplateObject(["", undefined], ["", "\\u{1f622"]), 100)
; // \\u{1f622
var a11 = tag(__makeTemplateObject(["", "\uD83D\uDE22"], ["", "\\u{1f622}"]), 100)
; // \u{1f622}
var a12 = tag(__makeTemplateObject(["", undefined], ["", "\\x"]), 100)
; // \\x
var a13 = tag(__makeTemplateObject(["", undefined], ["", "\\x0"]), 100)
; // \\x0
var a14 = tag(__makeTemplateObject(["", "\0"], ["", "\\x00"]), 100)
; // \x00
