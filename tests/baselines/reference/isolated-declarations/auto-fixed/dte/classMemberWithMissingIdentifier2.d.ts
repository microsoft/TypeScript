...
classMemberWithMissingIdentifier2.ts(2,11): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
...
==== classMemberWithMissingIdentifier2.ts (8 errors) ====
    class C { 
        public {[name:string]:VariableDeclaration};
