...
export const testRecFun = <T extends Object>(parent: T): {
    result: T; deeper: <U extends Object>(child: U) => {
        result: T & U;
...
//# sourceMappingURL=declarationsWithRecursiveInternalTypesProduceUniqueTypeParams.d.ts.map