...
destructuringParameterProperties2.ts(2,45): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
destructuringParameterProperties2.ts(2,48): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
destructuringParameterProperties2.ts(2,51): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
...
==== destructuringParameterProperties2.ts (13 errors) ====
    class C1 {
        constructor(private k: number, private [a, b, c]: [number, string, boolean]) {
                                       ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
