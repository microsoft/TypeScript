...
destructuringParameterProperties5.ts(5,25): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
destructuringParameterProperties5.ts(5,27): error TS2339: Property 'x1' does not exist on type 'ObjType1'.
destructuringParameterProperties5.ts(5,27): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
destructuringParameterProperties5.ts(5,31): error TS2339: Property 'x2' does not exist on type 'ObjType1'.
destructuringParameterProperties5.ts(5,31): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
destructuringParameterProperties5.ts(5,35): error TS2339: Property 'x3' does not exist on type 'ObjType1'.
destructuringParameterProperties5.ts(5,35): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
destructuringParameterProperties5.ts(5,41): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
destructuringParameterProperties5.ts(5,44): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
...
==== destructuringParameterProperties5.ts (23 errors) ====
    type ObjType1 = { x: number; y: string; z: boolean }
    type TupleType1 = [ObjType1, number, string]
