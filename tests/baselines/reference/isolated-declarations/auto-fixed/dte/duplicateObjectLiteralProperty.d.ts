...
duplicateObjectLiteralProperty.ts(16,9): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.


==== duplicateObjectLiteralProperty.ts (9 errors) ====
    var x = {
        a: 1,
        b: true, // OK
        a: 56,   // Duplicate
