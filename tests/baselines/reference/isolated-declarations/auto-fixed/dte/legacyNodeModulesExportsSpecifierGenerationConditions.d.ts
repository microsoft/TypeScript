...
index.ts(1,18): error TS9507: Function must have an explicit type annotation with with --isolatedDeclarations
...
!!! related TS9600 index.ts:1:14: Add a type annotation to the variable a
!!! related TS9603 index.ts:1:18: Add a return type to the function expression
