...
export function useState<T>(initial: T): [value: T, setter: (T: any) => void] {
    return null as any;
}
...
export function readSegment([length, count]: [number, number]): void {}
...
export const argumentsOfGAsFirstArgument: [
    [elem: object, index: number]
] = f(getArgsForInjection(g)); // one tuple with captures arguments as first member
export const argumentsOfG: [
    elem: object,
    index: number
] = f(...getArgsForInjection(g)); // captured arguments list re-spread
...
export type RecusiveRest = [first: string, ...rest: RecusiveRest[]];
export type RecusiveRest2 = [string, ...RecusiveRest2[]];
export declare const argumentsOfGAsFirstArgument: [
    [
        elem: object,
        index: number
    ]
];
export declare const argumentsOfG: [
    elem: object,
    index: number
];
//# sourceMappingURL=namedTupleMembers.d.ts.map