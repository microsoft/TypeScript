...
asyncGeneratorPropertyIsError.ts(2,13): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
...
==== asyncGeneratorPropertyIsError.ts (2 errors) ====
    class C25 {
        async * x = 1: any;
                ~
!!! error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
