...
//// [/.src/parserErrorRecovery_ParameterList1.d.ts]
...
parserErrorRecovery_ParameterList1.ts(1,10): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
...
==== parserErrorRecovery_ParameterList1.ts (4 errors) ====
    function f(a: any {
             ~
