...
module TypeScript {
    ...
    export class AstPath {
        ...
        public isTopLevelImplicitModule(): any {
            return this.count() >= 1 &&
        ...
        public isBodyOfTopLevelImplicitModule(): any {
            return this.count() >= 2 &&
    ...
    export class AstPathContext {
        public path: AstPath = new TypeScript.AstPath();
    }
    ...
    ///
    export function getAstPathToPosition(script: TypeScript.AST, pos: number, options: GetAstPathOptions = GetAstPathOptions.Default): TypeScript.AstPath {
...
declare namespace TypeScript {
    ...
    function isValidAstNode(ast: TypeScript.ASTSpan): boolean;
    ...
    function getAstPathToPosition(script: TypeScript.AST, pos: number, options?: GetAstPathOptions): TypeScript.AstPath;
...
parserRealSource14.ts(4,21): error TS9010: Reference directives are not supported in isolated declaration mode.
...
parserRealSource14.ts(74,34): error TS2694: Namespace 'TypeScript' has no exported member 'AST'.
parserRealSource14.ts(75,32): error TS2694: Namespace 'TypeScript' has no exported member 'AST'.
parserRealSource14.ts(78,37): error TS2694: Namespace 'TypeScript' has no exported member 'AST'.
...
parserRealSource14.ts(456,9): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
parserRealSource14.ts(462,61): error TS2694: Namespace 'TypeScript' has no exported member 'AST'.
parserRealSource14.ts(463,52): error TS2694: Namespace 'TypeScript' has no exported member 'Comment'.
parserRealSource14.ts(478,45): error TS2694: Namespace 'TypeScript' has no exported member 'AST'.
...
parserRealSource14.ts(559,69): error TS2694: Namespace 'TypeScript' has no exported member 'AST'.
parserRealSource14.ts(559,93): error TS2694: Namespace 'TypeScript' has no exported member 'IAstWalker'.
...
==== parserRealSource14.ts (164 errors) ====
    // Copyright (c) Microsoft. All rights reserved. Licensed under the Apache License, Version 2.0. 
    // See LICENSE.txt in the project root for complete license information.
