...
function fn<A>(inp: Child<A>): void {
...
const machine: StateNode<any, any> = createMachine({} as any);
...
declare let Anon: invalid;
declare let OuterC: invalid;
//# sourceMappingURL=varianceAnnotations.d.ts.map
/// [Errors] ////
