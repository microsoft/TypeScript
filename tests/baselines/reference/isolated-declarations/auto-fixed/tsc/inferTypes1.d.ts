...
const result: number = invoker('test', true)({ test: (a: boolean) => 123 })
...
inferTypes1.ts(46,25): error TS2344: Type 'string' does not satisfy the constraint 'abstract new (...args: any) => any'.
inferTypes1.ts(47,25): error TS2344: Type 'Function' does not satisfy the constraint 'abstract new (...args: any) => any'.
  Type 'Function' provides no match for the signature 'new (...args: any): any'.
inferTypes1.ts(58,25): error TS2344: Type '(x: string, y: string) => number' does not satisfy the constraint '(x: any) => any'.
  Target signature provides too few arguments. Expected 2 or more, but got 1.
inferTypes1.ts(59,25): error TS2344: Type 'Function' does not satisfy the constraint '(x: any) => any'.
  Type 'Function' provides no match for the signature '(x: any): any'.
inferTypes1.ts(85,12): error TS1338: 'infer' declarations are only permitted in the 'extends' clause of a conditional type.
inferTypes1.ts(86,16): error TS1338: 'infer' declarations are only permitted in the 'extends' clause of a conditional type.
...
inferTypes1.ts(87,15): error TS2304: Cannot find name 'U'.
inferTypes1.ts(87,15): error TS4081: Exported type alias 'T62' has or is using private name 'U'.
inferTypes1.ts(87,43): error TS2304: Cannot find name 'U'.
inferTypes1.ts(87,43): error TS4081: Exported type alias 'T62' has or is using private name 'U'.
inferTypes1.ts(94,44): error TS2344: Type 'U' does not satisfy the constraint 'string'.
  Type 'number' is not assignable to type 'string'.
inferTypes1.ts(156,40): error TS2322: Type 'T' is not assignable to type 'string | number | symbol'.
...
!!! related TS2208 inferTypes1.ts:156:8: This type parameter might need an `extends string | number | symbol` constraint.
