...
computedPropertyNames4_ES6.ts(6,10): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
...
==== computedPropertyNames4_ES6.ts (6 errors) ====
    var s: string;
    var n: number;
    var a: any;
    var v = {
