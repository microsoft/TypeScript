...
declare const fn3: <Key extends keyof typeof myRecord2>(key: Key) => invalid;
...
noUncheckedIndexedAccess.ts(97,13): error TS9007: Function must have an explicit return type annotation with --isolatedDeclarations.
...
==== noUncheckedIndexedAccess.ts (32 errors) ====
    type CheckBooleanOnly<T extends boolean> = any;
    // Validate CheckBooleanOnly works - should error
    type T_ERR1 = CheckBooleanOnly<boolean | undefined>;
                                   ~~~~~~~~~~~~~~~~~~~
...
!!! related TS9027 noUncheckedIndexedAccess.ts:97:7: Add a type annotation to the variable fn3.
!!! related TS9030 noUncheckedIndexedAccess.ts:97:13: Add a return type to the function expression.
        myRecord2[key] = undefined; // Should error
        ~~~~~~~~~~~~~~
