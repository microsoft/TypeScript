...
//// [/.src/out/other4.d.ts]
export type LocalInterface = import("pkg", { with: {} });
export declare const a: import("pkg", { with: {} }), Asserts1: invalid, RequireInterface: invalid;
export declare const b: import("pkg", { with: {} }), Asserts2: invalid, ImportInterface: invalid;
