...
declare const fourBit = 15n;
declare const fiveBit = 31n;
declare const sixBit = 63n;
declare const sevenBit = 127n;
declare const eightBit = 255n;
declare const nineBit = 511n;
declare const tenBit = 1023n;
declare const elevenBit = 2047n;
declare const twelveBit = 4095n;
declare const thirteenBit = 8191n;
declare const fourteenBit = 16383n;
declare const fifteenBit = 32767n;
declare const sixteenBit = 65535n;
declare const seventeenBit = 131071n;
declare const neg = -123n;
declare const negHex: -16n;
declare const negZero: 0n;
declare const baseChange: 255n;
declare const leadingZeros: 0xffn;
