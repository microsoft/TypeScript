...
//// [recursiveTypesWithTypeof.d.ts]
declare var c: typeof c;
declare var c: any;
declare var d: typeof e;
declare var d: any;
declare var e: typeof d;
declare var e: any;
interface Foo<T> {
}
declare var f: Array<typeof f>;
declare var f: any;
declare var f2: Foo<typeof f2>;
declare var f2: any;
declare var f3: Foo<typeof f3>[];
declare var f3: any;
declare var g: {
    x: typeof g;
};
declare var g: typeof g.x;
declare var h: () => typeof h;
declare var h: () => typeof h;
declare var i: (x: typeof i) => typeof x;
declare var i: (x: typeof i) => typeof x;
declare var j: <T extends typeof j>(x: T) => T;
declare var j: <T extends typeof j>(x: T) => T;
declare var h2: new () => typeof h2;
declare var h2: new () => typeof h2;
declare var i2: new (x: typeof i2) => typeof x;
declare var i2: new (x: typeof i2) => typeof x;
declare var j2: new <T extends typeof j2>(x: T) => T;
declare var j2: new <T extends typeof j2>(x: T) => T;
declare var k: {
    [n: number]: typeof k;
    [s: string]: typeof k;
...
declare var hy3: Foo2<typeof hy3, {
    x: typeof hy3;
}>;
declare var hy3: any;
