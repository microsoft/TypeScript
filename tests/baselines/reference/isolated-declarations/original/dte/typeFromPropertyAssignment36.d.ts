...
typeFromPropertyAssignment36.ts(59,11): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
typeFromPropertyAssignment36.ts(64,3): error TS2565: Property 'expando' is used before being assigned.


==== typeFromPropertyAssignment36.ts (8 errors) ====
    function f(b: boolean) {
             ~
