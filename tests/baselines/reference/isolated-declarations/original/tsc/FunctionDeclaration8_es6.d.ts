...
FunctionDeclaration8_es6.ts(1,11): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations.
...
==== FunctionDeclaration8_es6.ts (4 errors) ====
    var v = { [yield]: foo }
              ~~~~~~~
