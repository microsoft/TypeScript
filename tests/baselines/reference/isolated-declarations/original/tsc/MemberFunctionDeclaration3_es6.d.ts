...
MemberFunctionDeclaration3_es6.ts(2,5): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
...
==== MemberFunctionDeclaration3_es6.ts (4 errors) ====
    class C {
       *[foo]() { }
        ~~~~~
