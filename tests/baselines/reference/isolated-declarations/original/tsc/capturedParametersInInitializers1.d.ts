...
capturedParametersInInitializers1.ts(38,20): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
capturedParametersInInitializers1.ts(38,21): error TS2373: Parameter 'y' cannot reference identifier 'z' declared after it.


==== capturedParametersInInitializers1.ts (22 errors) ====
    // ok - usage is deferred
    function foo1(y = class {c = x}, x = 1) {
             ~~~~
