...
computedPropertyNames11_ES6.ts(5,9): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
computedPropertyNames11_ES6.ts(6,9): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
...
computedPropertyNames11_ES6.ts(12,9): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
...
==== computedPropertyNames11_ES6.ts (19 errors) ====
    var s: string;
    var n: number;
    var a: any;
    var v = {
