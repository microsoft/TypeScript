...
computedPropertyNames13_ES5.ts(5,5): error TS9008: Method must have an explicit return type annotation with --isolatedDeclarations
...
computedPropertyNames13_ES5.ts(6,5): error TS9008: Method must have an explicit return type annotation with --isolatedDeclarations
...
computedPropertyNames13_ES5.ts(12,5): error TS9008: Method must have an explicit return type annotation with --isolatedDeclarations
...
==== computedPropertyNames13_ES5.ts (9 errors) ====
    var s: string;
    var n: number;
    var a: any;
    class C {
...
!!! related TS9034 computedPropertyNames13_ES5.ts:5:5: Add a return type to the method
        ~~~
!!! error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
        [n]() { }
        ~~~
!!! error TS9008: Method must have an explicit return type annotation with --isolatedDeclarations
!!! related TS9034 computedPropertyNames13_ES5.ts:6:5: Add a return type to the method
        ~~~
!!! error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
        static [s + s]() { }
        [s + n]() { }
...
!!! related TS9034 computedPropertyNames13_ES5.ts:11:5: Add a return type to the method
        ...
        ~~~
!!! error TS9008: Method must have an explicit return type annotation with --isolatedDeclarations
!!! related TS9034 computedPropertyNames13_ES5.ts:12:5: Add a return type to the method
        ~~~
!!! error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
        static [<any>true]() { }
        [`hello bye`]() { }
