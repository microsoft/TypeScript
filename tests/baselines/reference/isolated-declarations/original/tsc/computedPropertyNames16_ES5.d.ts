...
computedPropertyNames16_ES5.ts(5,9): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
computedPropertyNames16_ES5.ts(6,9): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
...
computedPropertyNames16_ES5.ts(12,9): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
...
==== computedPropertyNames16_ES5.ts (9 errors) ====
    var s: string;
    var n: number;
    var a: any;
    class C {
