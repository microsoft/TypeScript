...
computedPropertyNames2_ES6.ts(7,24): error TS9009: At least one accessor must have an explicit return type annotation with --isolatedDeclarations
...
computedPropertyNames2_ES6.ts(9,31): error TS9009: At least one accessor must have an explicit return type annotation with --isolatedDeclarations


==== computedPropertyNames2_ES6.ts (14 errors) ====
    var methodName = "method";
    var accessorName = "accessor";
    class C {
        [methodName]() { }
