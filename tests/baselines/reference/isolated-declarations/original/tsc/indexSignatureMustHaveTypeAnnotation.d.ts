...
indexSignatureMustHaveTypeAnnotation.ts(9,5): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
...
==== indexSignatureMustHaveTypeAnnotation.ts (8 errors) ====
    interface I {
        // Used to be indexer, now it is a computed property
        [x]: string;
        ~~~
