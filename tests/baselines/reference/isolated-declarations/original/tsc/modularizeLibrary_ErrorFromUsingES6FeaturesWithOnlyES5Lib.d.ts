...
modularizeLibrary_ErrorFromUsingES6FeaturesWithOnlyES5Lib.ts(25,5): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
...
modularizeLibrary_ErrorFromUsingES6FeaturesWithOnlyES5Lib.ts(51,5): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
...
==== modularizeLibrary_ErrorFromUsingES6FeaturesWithOnlyES5Lib.ts (22 errors) ====
    // All will be error from using ES6 features but only include ES5 library
    // Using Es6 array
    function f(x: number, y: number, z: number) {
             ~
