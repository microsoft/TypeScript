...
//// [/.src/parserComputedPropertyName25.d.ts]
declare class C {
    [e]: invalid;
}
/// [Errors] ////
...
parserComputedPropertyName25.ts(3,5): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
...
==== parserComputedPropertyName25.ts (6 errors) ====
    class C {
        // No ASI
        [e] = 0
        ~~~
