...
parserComputedPropertyName32.ts(2,5): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
...
==== parserComputedPropertyName32.ts (4 errors) ====
    declare class C {
        [e](): number 
        ~~~
