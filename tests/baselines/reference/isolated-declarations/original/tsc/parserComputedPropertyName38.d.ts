...
parserComputedPropertyName38.ts(2,5): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
...
==== parserComputedPropertyName38.ts (5 errors) ====
    class C {
        [public]() { }
        ~~~~~~~~
