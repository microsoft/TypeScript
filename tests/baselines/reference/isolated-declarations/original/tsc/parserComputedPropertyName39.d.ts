...
parserComputedPropertyName39.ts(3,5): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
...
==== parserComputedPropertyName39.ts (5 errors) ====
    "use strict";
    class C {
        [public]() { }
        ~~~~~~~~
