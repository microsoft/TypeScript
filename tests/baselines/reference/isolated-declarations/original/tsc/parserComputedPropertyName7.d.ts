...
parserComputedPropertyName7.ts(2,4): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
parserComputedPropertyName7.ts(2,5): error TS2304: Cannot find name 'e'.
parserComputedPropertyName7.ts(2,5): error TS4031: Public property '[e]' of exported class has or is using private name 'e'.


==== parserComputedPropertyName7.ts (5 errors) ====
    class C {
       [e]
       ~~~
