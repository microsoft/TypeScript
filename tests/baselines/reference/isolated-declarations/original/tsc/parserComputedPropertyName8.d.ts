...
parserComputedPropertyName8.ts(2,11): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
...
==== parserComputedPropertyName8.ts (5 errors) ====
    class C {
       public [e]
              ~~~
