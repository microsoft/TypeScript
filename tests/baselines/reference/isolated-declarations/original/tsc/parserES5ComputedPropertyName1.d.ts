...
//// [/.src/parserES5ComputedPropertyName1.d.ts]
declare class C {
    [e]: number;
}
/// [Errors] ////
...
parserES5ComputedPropertyName1.ts(2,5): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
...
==== parserES5ComputedPropertyName1.ts (4 errors) ====
    declare class C {
        [e]: number 
        ~~~
