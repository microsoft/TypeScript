...
parserES5ComputedPropertyName4.ts(1,15): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
parserES5ComputedPropertyName4.ts(1,16): error TS2304: Cannot find name 'e'.


==== parserES5ComputedPropertyName4.ts (4 errors) ====
    var v = { get [e]() { } };
                  ~~~
...
!!! related TS9027 parserES5ComputedPropertyName4.ts:1:5: Add a type annotation to the variable v
                   ~
