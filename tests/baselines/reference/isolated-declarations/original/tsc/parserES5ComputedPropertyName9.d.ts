...
parserES5ComputedPropertyName9.ts(2,4): error TS9007: Declaration emit for this file requires type resolution. An explicit type annotation may unblock declaration emit.
...
==== parserES5ComputedPropertyName9.ts (6 errors) ====
    class C {
       [e]: Type
       ~~~
