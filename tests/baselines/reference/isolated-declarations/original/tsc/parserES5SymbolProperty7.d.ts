...
parserES5SymbolProperty7.ts(2,5): error TS9014: Computed properties must be number or string literals, variables or dotted expressions with --isolatedDeclarations
...
==== parserES5SymbolProperty7.ts (3 errors) ====
    class C {
        [Symbol.toStringTag](): void { }
        ~~~~~~~~~~~~~~~~~~~~
