...
type F7 = ({ a, b: number }: invalid) => typeof number;
...
type G7 = new ({ a, b: number }: invalid) => typeof number;
...
interface I {
    ...
    method2({ a }: invalid): any;
    (arg: number): any;
    ({ a }: invalid): any;
    new (arg: number): any;
    new ({ a }: invalid): any;
}
declare function f1({ a }: O): invalid;
declare const f2: ({ a }: O) => invalid;
declare const f3: ({ a, b, c }: O) => invalid;
...
declare function f6({ a }: O): invalid;
declare const f7: ({ a, b, c }: O) => invalid;
