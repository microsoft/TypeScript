...
class MyMap implements Map<string, number> {
    ...
    entries(): BuiltinIterator<[string, number]> { throw new Error("Method not implemented."); }
    keys(): BuiltinIterator<string> { throw new Error("Method not implemented."); }
    [Symbol.iterator](): BuiltinIterator<[string, number]> { throw new Error("Method not implemented."); }
