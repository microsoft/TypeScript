...
function Counter(_a) {
    ...
    return react_1.createElement(react_1.Fragment, null, react_1.createElement("p", null, cnt), react_1.createElement("button", { onClick: function () { return setCnt(function (prev) { return prev + 1; }); }, type: "button" }, "Update")
    );
}
