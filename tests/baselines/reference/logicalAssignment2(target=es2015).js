...
(_g = a.foo)[_h = "baz"] && (_g[_h] = result.foo.baz);
(_j = b.foo)[_k = "baz"] || (_j[_k] = result.foo.baz);
(_b = (_l = c.foo)[_m = "baz"]) !== null && _b !== void 0 ? _b : (_l[_m] = result.foo.baz);
(_o = a.foo.bar()).baz && (_o.baz = result.foo.bar().baz);
(_p = b.foo.bar()).baz || (_p.baz = result.foo.bar().baz);
(_c = (_q = c.foo.bar()).baz) !== null && _c !== void 0 ? _c : (_q.baz = result.foo.bar().baz);
