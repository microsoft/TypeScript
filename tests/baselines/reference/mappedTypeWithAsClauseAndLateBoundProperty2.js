...
export declare const thing: {
    ...
    toLocaleString: {
        ...
        (locales?: string | string[], options?: object): string;
...
mappedTypeWithAsClauseAndLateBoundProperty2.d.ts(29,118): error TS2526: A 'this' type is available only in a non-static member of a class or interface.
