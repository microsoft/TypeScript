...
var c = { a: { x: 'hello', y: 2 } }; // error - y does not exist in type B
var d = { a: { x: 'hello' }, c: 5 }; // ok
var e = { a: { x: 2 }, c: 5 }; // error - types of property x are incompatible
var f = { a: { x: 'hello', y: 2 }, c: 5 }; // y does not exist in type D
var template = {
    foo: 1,
    __name: 'n',
    bar: {
...
var empty1 = { x: "hello" };
var empty2 = { x: "hello" };
var empty3 = { x: "hello", y: true }; // error as A & Empty = A
var empty4 = { x: "hello", y: true }; // error as A & EmptyInterface is equivalent to A
var empty5 = { x: { x: "hello" } };
var empty6 = { x: { x: "hello" } };
var empty7 = { x: { x: "hello", y: true } }; // error
var empty8 = { x: { x: "hello", y: true } }; // error
var nesting1 = { x: { a: true, b: "b" } };
var nesting2 = { y: "excess" }; // y is excess
var nesting3 = { x: { excess: true } }; // excess is excess
var nesting4 = { x: { a: true, b: "b", y: true, z: "hello" } }; // Double dipping on both sides of the union
var nesting5 = { x: { y: true, z: "b", excess: true } }; // excess is excess
var innerUnion1 = { x: { y: "ok", q: true } };
var innerUnion2 = { x: { z: true, q: true } };
var innerUnion3 = { x: { y: "not ok", z: true, q: true } };
