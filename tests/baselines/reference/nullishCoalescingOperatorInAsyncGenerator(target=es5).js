...
function f(a) {
    var _a;
    return __asyncGenerator(this, arguments, function f_1() {var c;
        return __generator(this, function (_b) {switch (_b.label) {case 0:c = (_a = a.b) !== null && _a !== void 0 ? _a : 10;
                    _b.label = 1;
                case 1:if (!c) return [3 /*break*/, 4];
