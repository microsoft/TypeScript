...
const v2 = unbox(b2);
const b3 = { value: su === null || su === void 0 ? void 0 : su.length };
const v3 = unbox(b3);
const b4 = { value: fnu === null || fnu === void 0 ? void 0 : fnu() };
const v4 = unbox(b4);
const b5 = { value: su === null || su === void 0 ? void 0 : su["length"] };
const v5 = unbox(b5);
const b6 = { value: osu === null || osu === void 0 ? void 0 : osu.prop.length };
const v6 = unbox(b6);
const b7 = { value: osu === null || osu === void 0 ? void 0 : osu.prop["length"] };
const v7 = unbox(b7);
const b8 = { value: ofnu === null || ofnu === void 0 ? void 0 : ofnu.prop() };
const v8 = unbox(b8);
