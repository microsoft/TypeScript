...
var C1 = /** @class */ (function () {
    function C1(v, p) {if (v === void 0) { v = 1; }if (p === void 0) { p = 0; }
        this.n = 0;
    }
    ...
    // C1M3 contains all optional parameters
    C1.prototype.C1M3 = function (C1M3A1, C1M3A2) {if (C1M3A1 === void 0) { C1M3A1 = 0; }if (C1M3A2 === void 0) { C1M3A2 = C1M3A1; }
...
function F3(F3A1, F3A2) {if (F3A1 === void 0) { F3A1 = 0; }if (F3A2 === void 0) { F3A2 = F3A1; }
    return F3A1 + F3A2;
}
...
F4();
L4();
function fnOpt1(id, children, expectedPath, isRoot) {if (children === void 0) { children = []; }if (expectedPath === void 0) { expectedPath = []; }}
