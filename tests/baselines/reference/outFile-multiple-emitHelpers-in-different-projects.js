...
2 >Emitted(11, 19) Source(1, 11) + SourceIndex(3)
3 >Emitted(11, 20) Source(1, 12) + SourceIndex(3)
4 >Emitted(11, 21) Source(1, 13) + SourceIndex(3)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^^^^^->
1 >{
  >    // Comment text
  >}
1 >Emitted(12, 2) Source(3, 2) + SourceIndex(3)
---
>>>declare namespace N {
1->
2 >^^^^^^^^^^^^^^^^^^
...
2 >Emitted(13, 19) Source(5, 11) + SourceIndex(3)
3 >Emitted(13, 20) Source(5, 12) + SourceIndex(3)
4 >Emitted(13, 21) Source(5, 13) + SourceIndex(3)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^^^^^^^->
1 >{
  ...
  >    f();
  >}
1 >Emitted(14, 2) Source(11, 2) + SourceIndex(3)
---
>>>declare class second1 {
1->
2 >^^^^^^^^^^^^^^
...
2 >Emitted(15, 15) Source(13, 7) + SourceIndex(3)
3 >Emitted(15, 22) Source(13, 14) + SourceIndex(3)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^->
1 > { }
1 >Emitted(16, 2) Source(13, 18) + SourceIndex(3)
---
>>>declare class second2 extends second1 {
1->
2 >^^^^^^^^^^^^^^
...
4 >                     extends 
5 >                              second1
1->Emitted(17, 1) Source(14, 1) + SourceIndex(3)
2 >Emitted(17, 15) Source(14, 7) + SourceIndex(3)
3 >Emitted(17, 22) Source(14, 15) + SourceIndex(3)
4 >Emitted(17, 31) Source(14, 23) + SourceIndex(3)
5 >Emitted(17, 38) Source(14, 30) + SourceIndex(3)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^->
1 > { }
1 >Emitted(18, 2) Source(14, 34) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.d.ts
sourceFile:../../../second/second_part2.ts
...
5 >              = new C()
6 >                ;
1->Emitted(23, 1) Source(1, 1) + SourceIndex(0)
2 >Emitted(23, 9) Source(1, 1) + SourceIndex(0)
3 >Emitted(23, 13) Source(1, 5) + SourceIndex(0)
4 >Emitted(23, 14) Source(1, 6) + SourceIndex(0)
5 >Emitted(23, 17) Source(1, 16) + SourceIndex(0)
6 >Emitted(23, 18) Source(1, 17) + SourceIndex(0)
---
>>>declare function thirdthird_part1Spread(...b: number[]): void;
1->
2 >^^^^^^^^^^^^^^^^^
...
8 >                                                    []
9 >                                                      ) { }
1->Emitted(24, 1) Source(4, 1) + SourceIndex(0)
2 >Emitted(24, 18) Source(4, 10) + SourceIndex(0)
3 >Emitted(24, 40) Source(4, 32) + SourceIndex(0)
4 >Emitted(24, 41) Source(4, 33) + SourceIndex(0)
5 >Emitted(24, 44) Source(4, 36) + SourceIndex(0)
6 >Emitted(24, 47) Source(4, 39) + SourceIndex(0)
7 >Emitted(24, 53) Source(4, 45) + SourceIndex(0)
8 >Emitted(24, 55) Source(4, 47) + SourceIndex(0)
9 >Emitted(24, 63) Source(4, 52) + SourceIndex(0)
---
>>>//# sourceMappingURL=third-output.d.ts.map
