...
{"version":3,"file":"third-output.js","sourceRoot":"","sources":["../../third_part1.ts","../../../first/first_PART1.ts","../../../first/first_part2.ts","../../../first/first_part3.ts","../../../second/second_part1.ts","../../../second/second_part2.ts"],"names":[],"mappings":";;ACIA,IAAM,CAAC,GAAG,cAAc,CAAC;AAMzB,OAAO,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC;ACVf,OAAO,CAAC,GAAG,CAAC,CAAC,EAAE,CAAC,CAAC;ACAjB,SAAS,CAAC;IACN,OAAO,gBAAgB,CAAC;AAC5B,CAAC;;ACFD,YAAY,CAAA;ACAZ,aAAa,CAAC;ADKd,IAAU,CAAC,CAMV;AAND,WAAU,CAAC;IACP,SAAS,CAAC;QACN,OAAO,CAAC,GAAG,CAAC,SAAS,CAAC,CAAC;IAC3B,CAAC;IAED,CAAC,EAAE,CAAC;AACR,CAAC,EANS,CAAC,KAAD,CAAC,QAMV;ACVD;IAAA;IAIA,CAAC;IAHG,uBAAW,GAAX;QACI,OAAO,CAAC,GAAG,CAAC,oBAAoB,CAAC,CAAC;IACtC,CAAC;IACL,QAAC;AAAD,CAAC,AAJD,IAIC;;ALLD,IAAI,CAAC,GAAG,IAAI,CAAC,EAAE,CAAC;AAChB,CAAC,CAAC,WAAW,EAAE,CAAC"}
...
2 >Emitted(10, 13) Source(1, 13) + SourceIndex(4)
3 >Emitted(10, 14) Source(1, 13) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
2 >"myPrologue2"
3 >             ;
1->Emitted(11, 1) Source(1, 1) + SourceIndex(5)
2 >Emitted(11, 14) Source(1, 14) + SourceIndex(5)
3 >Emitted(11, 15) Source(1, 15) + SourceIndex(5)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part1.ts
...
2 >Emitted(12, 5) Source(6, 11) + SourceIndex(4)
3 >Emitted(12, 6) Source(6, 12) + SourceIndex(4)
4 >Emitted(12, 7) Source(12, 2) + SourceIndex(4)
---
>>>(function (N) {
1->
2 >^^^^^^^^^^^
...
2 >Emitted(13, 12) Source(6, 11) + SourceIndex(4)
3 >Emitted(13, 13) Source(6, 12) + SourceIndex(4)
---
>>>    function f() {
1->^^^^
2 >    ^^^^^^^^^
...
2 >    function 
3 >             f
1->Emitted(14, 5) Source(7, 5) + SourceIndex(4)
2 >Emitted(14, 14) Source(7, 14) + SourceIndex(4)
3 >Emitted(14, 15) Source(7, 15) + SourceIndex(4)
---
>>>        console.log('testing');
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                             )
8 >                              ;
1->Emitted(15, 9) Source(8, 9) + SourceIndex(4)
2 >Emitted(15, 16) Source(8, 16) + SourceIndex(4)
3 >Emitted(15, 17) Source(8, 17) + SourceIndex(4)
4 >Emitted(15, 20) Source(8, 20) + SourceIndex(4)
5 >Emitted(15, 21) Source(8, 21) + SourceIndex(4)
6 >Emitted(15, 30) Source(8, 30) + SourceIndex(4)
7 >Emitted(15, 31) Source(8, 31) + SourceIndex(4)
8 >Emitted(15, 32) Source(8, 32) + SourceIndex(4)
---
>>>    }
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(16, 5) Source(9, 5) + SourceIndex(4)
2 >Emitted(16, 6) Source(9, 6) + SourceIndex(4)
---
>>>    f();
1->^^^^
2 >    ^
...
3 >     ()
4 >       ;
1->Emitted(17, 5) Source(11, 5) + SourceIndex(4)
2 >Emitted(17, 6) Source(11, 6) + SourceIndex(4)
3 >Emitted(17, 8) Source(11, 8) + SourceIndex(4)
4 >Emitted(17, 9) Source(11, 9) + SourceIndex(4)
---
>>>})(N || (N = {}));
1->
2 >^
...
7 >           {
  ...
  >              f();
  >          }
1->Emitted(18, 1) Source(12, 1) + SourceIndex(4)
2 >Emitted(18, 2) Source(12, 2) + SourceIndex(4)
3 >Emitted(18, 4) Source(6, 11) + SourceIndex(4)
4 >Emitted(18, 5) Source(6, 12) + SourceIndex(4)
5 >Emitted(18, 10) Source(6, 11) + SourceIndex(4)
6 >Emitted(18, 11) Source(6, 12) + SourceIndex(4)
7 >Emitted(18, 19) Source(12, 2) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
1->"myPrologue2";
  >
1->Emitted(19, 1) Source(2, 1) + SourceIndex(5)
---
>>>    function C() {
1->^^^^
2 >    ^^->
1->
1->Emitted(20, 5) Source(2, 1) + SourceIndex(5)
---
>>>    }
1->^^^^
2 >    ^
...
1->class C {
  ...
  >
2 >    }
1->Emitted(21, 5) Source(6, 1) + SourceIndex(5)
2 >Emitted(21, 6) Source(6, 2) + SourceIndex(5)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(22, 5) Source(3, 5) + SourceIndex(5)
2 >Emitted(22, 28) Source(3, 16) + SourceIndex(5)
3 >Emitted(22, 31) Source(3, 5) + SourceIndex(5)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(23, 9) Source(4, 9) + SourceIndex(5)
2 >Emitted(23, 16) Source(4, 16) + SourceIndex(5)
3 >Emitted(23, 17) Source(4, 17) + SourceIndex(5)
4 >Emitted(23, 20) Source(4, 20) + SourceIndex(5)
5 >Emitted(23, 21) Source(4, 21) + SourceIndex(5)
6 >Emitted(23, 41) Source(4, 41) + SourceIndex(5)
7 >Emitted(23, 42) Source(4, 42) + SourceIndex(5)
8 >Emitted(23, 43) Source(4, 43) + SourceIndex(5)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(24, 5) Source(5, 5) + SourceIndex(5)
2 >Emitted(24, 6) Source(5, 6) + SourceIndex(5)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
...
2 >Emitted(25, 13) Source(6, 2) + SourceIndex(5)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(26, 1) Source(6, 1) + SourceIndex(5)
2 >Emitted(26, 2) Source(6, 2) + SourceIndex(5)
3 >Emitted(26, 2) Source(2, 1) + SourceIndex(5)
4 >Emitted(26, 6) Source(6, 2) + SourceIndex(5)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../third_part1.ts
