...
2 >Emitted(3, 11) Source(2, 11) + SourceIndex(1)
3 >Emitted(3, 19) Source(2, 19) + SourceIndex(1)
---
>>>    none: any;
1 >^^^^
2 >    ^^^^
...
4 >          any
5 >             ;
1 >Emitted(4, 5) Source(3, 5) + SourceIndex(1)
2 >Emitted(4, 9) Source(3, 9) + SourceIndex(1)
3 >Emitted(4, 11) Source(3, 11) + SourceIndex(1)
4 >Emitted(4, 14) Source(3, 14) + SourceIndex(1)
5 >Emitted(4, 15) Source(3, 15) + SourceIndex(1)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^->
1 >
  >}
1 >Emitted(5, 2) Source(4, 2) + SourceIndex(1)
---
>>>declare const s = "Hello, world";
1->
2 >^^^^^^^^
...
2 >Emitted(6, 9) Source(6, 1) + SourceIndex(1)
3 >Emitted(6, 15) Source(6, 7) + SourceIndex(1)
4 >Emitted(6, 16) Source(6, 8) + SourceIndex(1)
5 >Emitted(6, 33) Source(6, 25) + SourceIndex(1)
6 >Emitted(6, 34) Source(6, 26) + SourceIndex(1)
---
>>>interface NoJsForHereEither {
1 >
2 >^^^^^^^^^^
...
2 >interface 
3 >          NoJsForHereEither
1 >Emitted(7, 1) Source(8, 1) + SourceIndex(1)
2 >Emitted(7, 11) Source(8, 11) + SourceIndex(1)
3 >Emitted(7, 28) Source(8, 28) + SourceIndex(1)
---
>>>    none: any;
1 >^^^^
2 >    ^^^^
...
4 >          any
5 >             ;
1 >Emitted(8, 5) Source(9, 5) + SourceIndex(1)
2 >Emitted(8, 9) Source(9, 9) + SourceIndex(1)
3 >Emitted(8, 11) Source(9, 11) + SourceIndex(1)
4 >Emitted(8, 14) Source(9, 14) + SourceIndex(1)
5 >Emitted(8, 15) Source(9, 15) + SourceIndex(1)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^->
1 >
  >}
1 >Emitted(9, 2) Source(10, 2) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.d.ts
...
2 >Emitted(13, 19) Source(2, 11) + SourceIndex(3)
3 >Emitted(13, 20) Source(2, 12) + SourceIndex(3)
4 >Emitted(13, 21) Source(2, 13) + SourceIndex(3)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^^^^^->
1 >{
  >    // Comment text
  >}
1 >Emitted(14, 2) Source(4, 2) + SourceIndex(3)
---
>>>declare namespace N {
1->
2 >^^^^^^^^^^^^^^^^^^
...
3 >                  N
4 >                    
1->Emitted(15, 1) Source(6, 1) + SourceIndex(3)
2 >Emitted(15, 19) Source(6, 11) + SourceIndex(3)
3 >Emitted(15, 20) Source(6, 12) + SourceIndex(3)
4 >Emitted(15, 21) Source(6, 13) + SourceIndex(3)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^->
1 >{
  ...
  >    f();
  >}
1 >Emitted(16, 2) Source(12, 2) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.d.ts
sourceFile:../../../second/second_part2.ts
...
2 >Emitted(17, 15) Source(1, 7) + SourceIndex(4)
3 >Emitted(17, 16) Source(1, 8) + SourceIndex(4)
---
>>>    doSomething(): void;
1->^^^^
2 >    ^^^^^^^^^^^
...
2 >Emitted(18, 16) Source(2, 16) + SourceIndex(4)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^->
1 >() {
  ...
  >    }
  >}
1 >Emitted(19, 2) Source(5, 2) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.d.ts
...
2 >Emitted(21, 9) Source(2, 1) + SourceIndex(0)
3 >Emitted(21, 13) Source(2, 5) + SourceIndex(0)
4 >Emitted(21, 14) Source(2, 6) + SourceIndex(0)
5 >Emitted(21, 17) Source(2, 16) + SourceIndex(0)
6 >Emitted(21, 18) Source(2, 17) + SourceIndex(0)
---
>>>//# sourceMappingURL=third-output.d.ts.map
...
5 >        "Hello, world"
6 >                      ;
1 >Emitted(3, 1) Source(6, 1) + SourceIndex(1)
2 >Emitted(3, 5) Source(6, 7) + SourceIndex(1)
3 >Emitted(3, 6) Source(6, 8) + SourceIndex(1)
4 >Emitted(3, 9) Source(6, 11) + SourceIndex(1)
5 >Emitted(3, 23) Source(6, 25) + SourceIndex(1)
6 >Emitted(3, 24) Source(6, 26) + SourceIndex(1)
---
>>>console.log(s);
1 >
2 >^^^^^^^
...
7 >             )
8 >              ;
1 >Emitted(4, 1) Source(12, 1) + SourceIndex(1)
2 >Emitted(4, 8) Source(12, 8) + SourceIndex(1)
3 >Emitted(4, 9) Source(12, 9) + SourceIndex(1)
4 >Emitted(4, 12) Source(12, 12) + SourceIndex(1)
5 >Emitted(4, 13) Source(12, 13) + SourceIndex(1)
6 >Emitted(4, 14) Source(12, 14) + SourceIndex(1)
7 >Emitted(4, 15) Source(12, 15) + SourceIndex(1)
8 >Emitted(4, 16) Source(12, 16) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
...
8 >               )
9 >                ;
1->Emitted(5, 1) Source(2, 1) + SourceIndex(2)
2 >Emitted(5, 8) Source(2, 8) + SourceIndex(2)
3 >Emitted(5, 9) Source(2, 9) + SourceIndex(2)
4 >Emitted(5, 12) Source(2, 12) + SourceIndex(2)
5 >Emitted(5, 13) Source(2, 13) + SourceIndex(2)
6 >Emitted(5, 14) Source(2, 14) + SourceIndex(2)
7 >Emitted(5, 16) Source(2, 16) + SourceIndex(2)
8 >Emitted(5, 17) Source(2, 17) + SourceIndex(2)
9 >Emitted(5, 18) Source(2, 18) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../first/first_part3.ts
...
4 >      {
  ...
  >         f();
  >     }
1->Emitted(11, 1) Source(6, 1) + SourceIndex(4)
2 >Emitted(11, 5) Source(6, 11) + SourceIndex(4)
3 >Emitted(11, 6) Source(6, 12) + SourceIndex(4)
4 >Emitted(11, 7) Source(12, 2) + SourceIndex(4)
---
>>>(function (N) {
1->
2 >^^^^^^^^^^^
...
2 >namespace 
3 >           N
1->Emitted(12, 1) Source(6, 1) + SourceIndex(4)
2 >Emitted(12, 12) Source(6, 11) + SourceIndex(4)
3 >Emitted(12, 13) Source(6, 12) + SourceIndex(4)
---
>>>    function f() {
1->^^^^
2 >    ^^^^^^^^^
...
2 >    function 
3 >             f
1->Emitted(13, 5) Source(7, 5) + SourceIndex(4)
2 >Emitted(13, 14) Source(7, 14) + SourceIndex(4)
3 >Emitted(13, 15) Source(7, 15) + SourceIndex(4)
---
>>>        console.log('testing');
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                             )
8 >                              ;
1->Emitted(14, 9) Source(8, 9) + SourceIndex(4)
2 >Emitted(14, 16) Source(8, 16) + SourceIndex(4)
3 >Emitted(14, 17) Source(8, 17) + SourceIndex(4)
4 >Emitted(14, 20) Source(8, 20) + SourceIndex(4)
5 >Emitted(14, 21) Source(8, 21) + SourceIndex(4)
6 >Emitted(14, 30) Source(8, 30) + SourceIndex(4)
7 >Emitted(14, 31) Source(8, 31) + SourceIndex(4)
8 >Emitted(14, 32) Source(8, 32) + SourceIndex(4)
---
>>>    }
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(15, 5) Source(9, 5) + SourceIndex(4)
2 >Emitted(15, 6) Source(9, 6) + SourceIndex(4)
---
>>>    f();
1->^^^^
2 >    ^
...
3 >     ()
4 >       ;
1->Emitted(16, 5) Source(11, 5) + SourceIndex(4)
2 >Emitted(16, 6) Source(11, 6) + SourceIndex(4)
3 >Emitted(16, 8) Source(11, 8) + SourceIndex(4)
4 >Emitted(16, 9) Source(11, 9) + SourceIndex(4)
---
>>>})(N || (N = {}));
1->
2 >^
...
7 >           {
  ...
  >              f();
  >          }
1->Emitted(17, 1) Source(12, 1) + SourceIndex(4)
2 >Emitted(17, 2) Source(12, 2) + SourceIndex(4)
3 >Emitted(17, 4) Source(6, 11) + SourceIndex(4)
4 >Emitted(17, 5) Source(6, 12) + SourceIndex(4)
5 >Emitted(17, 10) Source(6, 11) + SourceIndex(4)
6 >Emitted(17, 11) Source(6, 12) + SourceIndex(4)
7 >Emitted(17, 19) Source(12, 2) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
2 >Emitted(27, 5) Source(2, 5) + SourceIndex(0)
3 >Emitted(27, 6) Source(2, 6) + SourceIndex(0)
4 >Emitted(27, 9) Source(2, 9) + SourceIndex(0)
5 >Emitted(27, 13) Source(2, 13) + SourceIndex(0)
6 >Emitted(27, 14) Source(2, 14) + SourceIndex(0)
7 >Emitted(27, 16) Source(2, 16) + SourceIndex(0)
8 >Emitted(27, 17) Source(2, 17) + SourceIndex(0)
---
>>>c.doSomething();
1->
2 >^
...
2 >Emitted(28, 2) Source(3, 2) + SourceIndex(0)
3 >Emitted(28, 3) Source(3, 3) + SourceIndex(0)
4 >Emitted(28, 14) Source(3, 14) + SourceIndex(0)
5 >Emitted(28, 16) Source(3, 16) + SourceIndex(0)
6 >Emitted(28, 17) Source(3, 17) + SourceIndex(0)
---
>>>//# sourceMappingURL=third-output.js.map
