...
9 >                ;
1->Emitted(5, 1) Source(1, 1) + SourceIndex(2)
2 >Emitted(5, 8) Source(1, 8) + SourceIndex(2)
3 >Emitted(5, 9) Source(1, 9) + SourceIndex(2)
4 >Emitted(5, 12) Source(1, 12) + SourceIndex(2)
5 >Emitted(5, 13) Source(1, 13) + SourceIndex(2)
6 >Emitted(5, 14) Source(1, 14) + SourceIndex(2)
7 >Emitted(5, 16) Source(1, 16) + SourceIndex(2)
8 >Emitted(5, 17) Source(1, 17) + SourceIndex(2)
9 >Emitted(5, 18) Source(1, 18) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../first/first_part3.ts
...
2 >Emitted(6, 10) Source(1, 10) + SourceIndex(3)
3 >Emitted(6, 11) Source(1, 11) + SourceIndex(3)
---
>>>    return "JS does hoists";
1->^^^^
2 >    ^^^^^^^
...
3 >           "JS does hoists"
4 >                           ;
1->Emitted(7, 5) Source(2, 5) + SourceIndex(3)
2 >Emitted(7, 12) Source(2, 12) + SourceIndex(3)
3 >Emitted(7, 28) Source(2, 28) + SourceIndex(3)
4 >Emitted(7, 29) Source(2, 29) + SourceIndex(3)
---
>>>}
1 >
2 >^
...
1 >
  >
2 >}
1 >Emitted(8, 1) Source(3, 1) + SourceIndex(3)
2 >Emitted(8, 2) Source(3, 2) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part1.ts
...
4 >      {
  ...
  >         f();
  >     }
1->Emitted(11, 1) Source(5, 1) + SourceIndex(4)
2 >Emitted(11, 5) Source(5, 11) + SourceIndex(4)
3 >Emitted(11, 6) Source(5, 12) + SourceIndex(4)
4 >Emitted(11, 7) Source(11, 2) + SourceIndex(4)
---
>>>(function (N) {
1->
2 >^^^^^^^^^^^
...
2 >Emitted(12, 12) Source(5, 11) + SourceIndex(4)
3 >Emitted(12, 13) Source(5, 12) + SourceIndex(4)
---
>>>    function f() {
1->^^^^
2 >    ^^^^^^^^^
...
2 >    function 
3 >             f
1->Emitted(13, 5) Source(6, 5) + SourceIndex(4)
2 >Emitted(13, 14) Source(6, 14) + SourceIndex(4)
3 >Emitted(13, 15) Source(6, 15) + SourceIndex(4)
---
>>>        console.log('testing');
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                             )
8 >                              ;
1->Emitted(14, 9) Source(7, 9) + SourceIndex(4)
2 >Emitted(14, 16) Source(7, 16) + SourceIndex(4)
3 >Emitted(14, 17) Source(7, 17) + SourceIndex(4)
4 >Emitted(14, 20) Source(7, 20) + SourceIndex(4)
5 >Emitted(14, 21) Source(7, 21) + SourceIndex(4)
6 >Emitted(14, 30) Source(7, 30) + SourceIndex(4)
7 >Emitted(14, 31) Source(7, 31) + SourceIndex(4)
8 >Emitted(14, 32) Source(7, 32) + SourceIndex(4)
---
>>>    }
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(15, 5) Source(8, 5) + SourceIndex(4)
2 >Emitted(15, 6) Source(8, 6) + SourceIndex(4)
---
>>>    f();
1->^^^^
2 >    ^
...
3 >     ()
4 >       ;
1->Emitted(16, 5) Source(10, 5) + SourceIndex(4)
2 >Emitted(16, 6) Source(10, 6) + SourceIndex(4)
3 >Emitted(16, 8) Source(10, 8) + SourceIndex(4)
4 >Emitted(16, 9) Source(10, 9) + SourceIndex(4)
---
>>>})(N || (N = {}));
1->
2 >^
...
7 >           {
  ...
  >              f();
  >          }
1->Emitted(17, 1) Source(11, 1) + SourceIndex(4)
2 >Emitted(17, 2) Source(11, 2) + SourceIndex(4)
3 >Emitted(17, 4) Source(5, 11) + SourceIndex(4)
4 >Emitted(17, 5) Source(5, 12) + SourceIndex(4)
5 >Emitted(17, 10) Source(5, 11) + SourceIndex(4)
6 >Emitted(17, 11) Source(5, 12) + SourceIndex(4)
7 >Emitted(17, 19) Source(11, 2) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
2 >    ^^->
1->
1->Emitted(19, 5) Source(1, 1) + SourceIndex(5)
---
>>>    }
1->^^^^
2 >    ^
...
1->class C {
  ...
  >
2 >    }
1->Emitted(20, 5) Source(5, 1) + SourceIndex(5)
2 >Emitted(20, 6) Source(5, 2) + SourceIndex(5)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(21, 5) Source(2, 5) + SourceIndex(5)
2 >Emitted(21, 28) Source(2, 16) + SourceIndex(5)
3 >Emitted(21, 31) Source(2, 5) + SourceIndex(5)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(22, 9) Source(3, 9) + SourceIndex(5)
2 >Emitted(22, 16) Source(3, 16) + SourceIndex(5)
3 >Emitted(22, 17) Source(3, 17) + SourceIndex(5)
4 >Emitted(22, 20) Source(3, 20) + SourceIndex(5)
5 >Emitted(22, 21) Source(3, 21) + SourceIndex(5)
6 >Emitted(22, 41) Source(3, 41) + SourceIndex(5)
7 >Emitted(22, 42) Source(3, 42) + SourceIndex(5)
8 >Emitted(22, 43) Source(3, 43) + SourceIndex(5)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(23, 5) Source(4, 5) + SourceIndex(5)
2 >Emitted(23, 6) Source(4, 6) + SourceIndex(5)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
1->
  >
2 >    }
1->Emitted(24, 5) Source(5, 1) + SourceIndex(5)
2 >Emitted(24, 13) Source(5, 2) + SourceIndex(5)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(25, 1) Source(5, 1) + SourceIndex(5)
2 >Emitted(25, 2) Source(5, 2) + SourceIndex(5)
3 >Emitted(25, 2) Source(1, 1) + SourceIndex(5)
4 >Emitted(25, 6) Source(5, 2) + SourceIndex(5)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../third_part1.ts
...
2 >Emitted(27, 5) Source(1, 5) + SourceIndex(0)
3 >Emitted(27, 6) Source(1, 6) + SourceIndex(0)
4 >Emitted(27, 9) Source(1, 9) + SourceIndex(0)
5 >Emitted(27, 13) Source(1, 13) + SourceIndex(0)
6 >Emitted(27, 14) Source(1, 14) + SourceIndex(0)
7 >Emitted(27, 16) Source(1, 16) + SourceIndex(0)
8 >Emitted(27, 17) Source(1, 17) + SourceIndex(0)
---
>>>c.doSomething();
1->
2 >^
...
2 >Emitted(28, 2) Source(2, 2) + SourceIndex(0)
3 >Emitted(28, 3) Source(2, 3) + SourceIndex(0)
4 >Emitted(28, 14) Source(2, 14) + SourceIndex(0)
5 >Emitted(28, 16) Source(2, 16) + SourceIndex(0)
6 >Emitted(28, 17) Source(2, 17) + SourceIndex(0)
---
>>>//# sourceMappingURL=third-output.js.map
