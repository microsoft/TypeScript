...
function left(a, b, c) {if (b === void 0) { b = a; }
    if (c === void 0) { c = b; }
    a;
    b;
}
...
function right2(a, b, c) {if (a === void 0) { a = b; }
    if (b === void 0) { b = c; }
    if (c === void 0) { c = a; }
    a;
    b;
...
function defaultArgFunction(a, b) {if (a === void 0) { a = function () { return b; }; }
    if (b === void 0) { b = 1; }}
function defaultArgArrow(a, b) {if (a === void 0) { a = function () { return function () { return b; }; }; }
    if (b === void 0) { b = 3; }}

var C = /** @class */ (function () {
    function C(a, b) {if (a === void 0) { a = b; }
        if (b === void 0) { b = 1; }}
    C.prototype.method = function (a, b) {if (a === void 0) { a = b; }
        if (b === void 0) { b = 1; }};
    return C;
}());
// Function expressions
