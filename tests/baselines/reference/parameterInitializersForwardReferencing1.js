...
function f1(bar) {if (bar === void 0) { bar = foo; }
    var foo = 2;
    return bar; // returns 1
}
...
function f4(foo, bar) {if (bar === void 0) { bar = foo; }
    return bar;
}

function f5(a) {if (a === void 0) { a = a; }
    return a;
}

function f6(async) {if (async === void 0) { async = async; }
    return async;
}
...
function f8(foo1, bar) {if (bar === void 0) { bar = foo1; }}
