...
(function (TypeScript) {
    ...
    setTokenInfo(2 /* Break */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "break", ErrorRecoverySet.Stmt);
    setTokenInfo(3 /* Case */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "case", ErrorRecoverySet.SCase);
    setTokenInfo(4 /* Catch */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "catch", ErrorRecoverySet.Catch);
    setTokenInfo(5 /* Class */, 6 /* TypeScriptAndJSFuture */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "class", ErrorRecoverySet.TypeScriptS);
    setTokenInfo(6 /* Const */, 6 /* TypeScriptAndJSFuture */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "const", ErrorRecoverySet.Var);
    setTokenInfo(7 /* Continue */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "continue", ErrorRecoverySet.Stmt);
    setTokenInfo(8 /* Debugger */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.Debugger, "debugger", ErrorRecoverySet.Stmt);
    setTokenInfo(9 /* Default */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "default", ErrorRecoverySet.SCase);
    setTokenInfo(10 /* Delete */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 14 /* Unary */, NodeType.Delete, "delete", ErrorRecoverySet.Prefix);
    setTokenInfo(11 /* Do */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "do", ErrorRecoverySet.Stmt);
    setTokenInfo(12 /* Else */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "else", ErrorRecoverySet.Else);
    setTokenInfo(13 /* Enum */, 6 /* TypeScriptAndJSFuture */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "enum", ErrorRecoverySet.TypeScriptS);
    setTokenInfo(14 /* Export */, 6 /* TypeScriptAndJSFuture */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "export", ErrorRecoverySet.TypeScriptS);
    setTokenInfo(15 /* Extends */, 6 /* TypeScriptAndJSFuture */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "extends", ErrorRecoverySet.None);
    setTokenInfo(16 /* Declare */, 4 /* TypeScript */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "declare", ErrorRecoverySet.Stmt);
    setTokenInfo(17 /* False */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "false", ErrorRecoverySet.RLit);
    setTokenInfo(18 /* Finally */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "finally", ErrorRecoverySet.Catch);
    setTokenInfo(19 /* For */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "for", ErrorRecoverySet.Stmt);
    setTokenInfo(20 /* Function */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "function", ErrorRecoverySet.Func);
    setTokenInfo(21 /* Constructor */, 12 /* TypeScriptAndJSFutureStrict */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "constructor", ErrorRecoverySet.Func);
    ...
    setTokenInfo(23 /* If */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "if", ErrorRecoverySet.Stmt);
    setTokenInfo(24 /* Implements */, 12 /* TypeScriptAndJSFutureStrict */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "implements", ErrorRecoverySet.None);
    setTokenInfo(25 /* Import */, 6 /* TypeScriptAndJSFuture */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "import", ErrorRecoverySet.TypeScriptS);
    setTokenInfo(26 /* In */, 5 /* TypeScriptAndJS */, 10 /* Relational */, NodeType.In, 0 /* None */, NodeType.None, "in", ErrorRecoverySet.None);
    setTokenInfo(27 /* InstanceOf */, 5 /* TypeScriptAndJS */, 10 /* Relational */, NodeType.InstOf, 0 /* None */, NodeType.None, "instanceof", ErrorRecoverySet.BinOp);
    setTokenInfo(28 /* Interface */, 12 /* TypeScriptAndJSFutureStrict */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "interface", ErrorRecoverySet.TypeScriptS);
    ...
    setTokenInfo(31 /* New */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "new", ErrorRecoverySet.PreOp);
    setTokenInfo(32 /* Number */, 4 /* TypeScript */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "number", ErrorRecoverySet.PrimType);
    setTokenInfo(33 /* Null */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "null", ErrorRecoverySet.RLit);
    setTokenInfo(34 /* Package */, 8 /* JavascriptFutureStrict */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "package", ErrorRecoverySet.None);
    setTokenInfo(35 /* Private */, 12 /* TypeScriptAndJSFutureStrict */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "private", ErrorRecoverySet.TypeScriptS);
    ...
    setTokenInfo(37 /* Public */, 12 /* TypeScriptAndJSFutureStrict */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "public", ErrorRecoverySet.TypeScriptS);
    setTokenInfo(38 /* Return */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "return", ErrorRecoverySet.Stmt);
    setTokenInfo(40 /* Static */, 12 /* TypeScriptAndJSFutureStrict */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "static", ErrorRecoverySet.None);
    setTokenInfo(41 /* String */, 4 /* TypeScript */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "string", ErrorRecoverySet.PrimType);
    setTokenInfo(42 /* Super */, 6 /* TypeScriptAndJSFuture */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "super", ErrorRecoverySet.RLit);
    setTokenInfo(43 /* Switch */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "switch", ErrorRecoverySet.Stmt);
    setTokenInfo(44 /* This */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "this", ErrorRecoverySet.RLit);
    setTokenInfo(45 /* Throw */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "throw", ErrorRecoverySet.Stmt);
    setTokenInfo(46 /* True */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "true", ErrorRecoverySet.RLit);
    setTokenInfo(47 /* Try */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "try", ErrorRecoverySet.Stmt);
    setTokenInfo(48 /* TypeOf */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 14 /* Unary */, NodeType.Typeof, "typeof", ErrorRecoverySet.Prefix);
    setTokenInfo(49 /* Var */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "var", ErrorRecoverySet.Var);
    setTokenInfo(50 /* Void */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 14 /* Unary */, NodeType.Void, "void", ErrorRecoverySet.Prefix);
    setTokenInfo(51 /* With */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.With, "with", ErrorRecoverySet.Stmt);
    setTokenInfo(52 /* While */, 5 /* TypeScriptAndJS */, 0 /* None */, NodeType.None, 0 /* None */, NodeType.None, "while", ErrorRecoverySet.While);
