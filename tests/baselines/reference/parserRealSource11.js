...
(function (TypeScript) {
    ...
    class FuncDecl extends AST {
        constructor(name, bod, isConstructor, arguments, vars, scopes, statistics, nodeType) {
            super(nodeType);
            this.name = name;
            this.bod = bod;
        ...
        hasStaticDeclarations() { return (!this.isConstructor && (this.statistics.members.length > 0 || this.innerStaticFuncs.length > 0)); }
    }
