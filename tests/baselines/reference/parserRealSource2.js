...
(function (TypeScript) {
    ...
    var ErrorRecoverySet = TypeScript.ErrorRecoverySet || (TypeScript.ErrorRecoverySet = {});
    ...
    var AllowedElements = TypeScript.AllowedElements || (TypeScript.AllowedElements = {});
    ...
    var Modifiers = TypeScript.Modifiers || (TypeScript.Modifiers = {});
    (function (Modifiers) {
    ...
    var ASTFlags = TypeScript.ASTFlags || (TypeScript.ASTFlags = {});
    (function (ASTFlags) {
    ...
    var DeclFlags = TypeScript.DeclFlags || (TypeScript.DeclFlags = {});
    (function (DeclFlags) {
    ...
    var ModuleFlags = TypeScript.ModuleFlags || (TypeScript.ModuleFlags = {});
    ...
    var SymbolFlags = TypeScript.SymbolFlags || (TypeScript.SymbolFlags = {});
    ...
    var VarFlags = TypeScript.VarFlags || (TypeScript.VarFlags = {});
    (function (VarFlags) {
    ...
    var FncFlags = TypeScript.FncFlags || (TypeScript.FncFlags = {});
    (function (FncFlags) {
    ...
    var SignatureFlags = TypeScript.SignatureFlags || (TypeScript.SignatureFlags = {});
    ...
    var TypeFlags = TypeScript.TypeFlags || (TypeScript.TypeFlags = {});
    (function (TypeFlags) {
    ...
    var TypeRelationshipFlags = TypeScript.TypeRelationshipFlags || (TypeScript.TypeRelationshipFlags = {});
    ...
    var CodeGenTarget = TypeScript.CodeGenTarget || (TypeScript.CodeGenTarget = {});
    (function (CodeGenTarget) {
        CodeGenTarget[CodeGenTarget["ES3"] = 0] = "ES3";
        CodeGenTarget[CodeGenTarget["ES5"] = 1] = "ES5";
    })(CodeGenTarget);
    var ModuleGenTarget = TypeScript.ModuleGenTarget || (TypeScript.ModuleGenTarget = {});
