...
var add1 = (_add_1 = add, _origFuncArg_1 = x, function (_origFuncArg1) { return _add_1(_origFuncArg_1, _origFuncArg1); });
x = 2;
add1(2) === 3;
var mutAdd = function (a, b) { return a + b; };
var mutAdd2 = (_mutAdd_1 = mutAdd, function (_origFuncArg1) { return _mutAdd_1(2, _origFuncArg1); });
mutAdd2(5) === 7;
