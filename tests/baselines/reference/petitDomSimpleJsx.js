//// [tests/cases/compiler/petitDomSimpleJsx.tsx] ////
...
var petit_dom_1 = require("petit-dom");
function assertEqual(a, b) { }
function eventHandler(event) { }
/**
 * Create an <a> element with text content, using HyperScript syntax and JSX syntax
 */
function testHtmlElementWithTextContent() {
    // HyperScript syntax returns an ElementNode<T> object, with typed properties
    var aNode = petit_dom_1.h("a", { href: "link", onclick: eventHandler }, "click here");
    assertEqual(aNode.isSVG, false);
    assertEqual(aNode.type, "a");
    assertEqual(aNode.key, null);
    assertEqual(aNode.props.href, "link");
    ...
    assertEqual(aNode.content.length, 1);
    // JSX syntax returns a VNode object, so the "type" and "props" properties are "any"
    var jsxNode = petit_dom_1.h("a", { href: "link", onclick: eventHandler }, "click here");
    var jsxNodeType = jsxNode.type;
    var jsxNodeProps = jsxNode.props;
    assertEqual(jsxNode.isSVG, false);
    assertEqual(jsxNodeType, "a");
    assertEqual(jsxNode.key, null);
    assertEqual(jsxNodeProps.href, "link");
...
exports.testHtmlElementWithTextContent = testHtmlElementWithTextContent;
/**
 * Create a <form> element with both text content and child elements, using HyperScript syntax and JSX syntax
 */
function testHtmlElementWithMixedContent() {
    // HyperScript syntax returns an ElementNode<T> object, with typed properties
    var formNode = petit_dom_1.h("form", { key: 1, method: "POST", onsubmit: eventHandler }, "Hello ", petit_dom_1.h("span", null, "World"));
    assertEqual(formNode.isSVG, false);
    assertEqual(formNode.type, "form");
    assertEqual(formNode.key, 1);
    assertEqual(formNode.props.method, "POST");
    ...
    assertEqual(formNode.content.length, 2);
    // JSX syntax returns a VNode object, so the "type" and "props" properties are "any"
    var jsxNode = petit_dom_1.h("form", { key: 1, method: "POST", onsubmit: eventHandler },
        "Hello ",
        petit_dom_1.h("span", null, "World"));
    var jsxNodeType = jsxNode.type;
    var jsxNodeProps = jsxNode.props;
    assertEqual(jsxNode.isSVG, false);
    assertEqual(jsxNodeType, "form");
...
exports.testHtmlElementWithMixedContent = testHtmlElementWithMixedContent;
/**
 * Create an <svg> element with a child element, using HyperScript syntax and JSX syntax
 */
function testSvgElementWithChild() {
    // HyperScript syntax returns an ElementNode<T> object, with typed properties
    var svgNode = petit_dom_1.h("svg", { key: 2, currentScale: 1 }, petit_dom_1.h("path"));
    assertEqual(svgNode.isSVG, true);
    assertEqual(svgNode.type, "svg");
    assertEqual(svgNode.key, 2);
    assertEqual(svgNode.props.currentScale, 1);
    assertEqual(svgNode.content.length, 1);
    // JSX syntax returns a VNode object, so the "type" and "props" properties are "any"
    var jsxNode = petit_dom_1.h("svg", { key: 2, currentScale: 1 },
        petit_dom_1.h("path", null));
    var jsxNodeType = jsxNode.type;
    var jsxNodeProps = jsxNode.props;
    assertEqual(jsxNode.isSVG, true);
    assertEqual(jsxNodeType, "svg");
...
exports.testSvgElementWithChild = testSvgElementWithChild;
/**
 * Create a function component, using HyperScript syntax and JSX syntax
 */
function testFunctionComponent() {
    function FunctionComponent() {
        return petit_dom_1.h("div", null, "Hello World");
    }
    // HyperScript syntax returns a FunctionComponentNode<T> object, with typed properties
    var node = petit_dom_1.h(FunctionComponent, { key: "1" });
    assertEqual(node.isSVG, false);
    assertEqual(node.type, FunctionComponent);
    assertEqual(node.key, "1");
    assertEqual(node.props.key, "1");
    assertEqual(node.content.length, 0);
    // JSX syntax returns a VNode object, so the "type" and "props" properties are "any"
    var jsxNode = petit_dom_1.h(FunctionComponent, { key: "1" });
    var jsxNodeType = jsxNode.type;
    var jsxNodeProps = jsxNode.props;
    assertEqual(jsxNode.isSVG, false);
    assertEqual(jsxNodeType, FunctionComponent);
 ...
 * Create a function component with props, using HyperScript syntax and JSX syntax
 */
function testFunctionComponentWithProps() {
    function FunctionComponentWithProps(props) {
        var name = props.name, count = props.count, onSomeEvent = props.onSomeEvent;
        return petit_dom_1.h("div", { className: name, tabIndex: count, onclick: onSomeEvent });
    }
    // HyperScript syntax returns a FunctionComponentNode<T> object, with typed properties
    var node = petit_dom_1.h(FunctionComponentWithProps, { name: "xyz", count: 123, onSomeEvent: eventHandler });
    assertEqual(node.isSVG, false);
    assertEqual(node.type, FunctionComponentWithProps);
    assertEqual(node.key, null);
    assertEqual(node.props.name, "xyz");
    ...
    assertEqual(node.content.length, 0);
    // JSX syntax returns a VNode object, so the "type" and "props" properties are "any"
    var jsxNode = petit_dom_1.h(FunctionComponentWithProps, { name: "xyz", count: 123, onSomeEvent: eventHandler });
    var jsxNodeType = jsxNode.type;
    var jsxNodeProps = jsxNode.props;
    assertEqual(jsxNode.isSVG, false);
    assertEqual(jsxNodeType, FunctionComponentWithProps);
...
exports.testFunctionComponentWithProps = testFunctionComponentWithProps;
/**
 * Create a function component with child content, using HyperScript syntax and JSX syntax
 */
function testFunctionComponentWithChildren() {
    function FunctionComponentWithChildren(props, content) {
        var name = props.name, count = props.count, onSomeEvent = props.onSomeEvent;
        return petit_dom_1.h("div", { className: name, tabIndex: count, onclick: onSomeEvent }, content);
    }
    // HyperScript syntax returns a FunctionComponentNode<T> object, with typed properties
    var node = petit_dom_1.h(FunctionComponentWithChildren, { name: "xyz", count: 123, onSomeEvent: eventHandler }, "Hello", petit_dom_1.h("span", null, "World"));
    assertEqual(node.isSVG, false);
    assertEqual(node.type, FunctionComponentWithChildren);
    assertEqual(node.key, null);
    assertEqual(node.props.name, "xyz");
    ...
    assertEqual(node.content.length, 2);
    // JSX syntax returns a VNode object, so the "type" and "props" properties are "any"
    var jsxNode = (petit_dom_1.h(FunctionComponentWithChildren, { name: "xyz", count: 123, onSomeEvent: eventHandler },
        "Hello ",
        petit_dom_1.h("span", null, "World")));
    var jsxNodeType = jsxNode.type;
    var jsxNodeProps = jsxNode.props;
...
exports.testFunctionComponentWithChildren = testFunctionComponentWithChildren;
/**
 * Create a component class, using HyperScript syntax and JSX syntax
 */
function testComponentClass() {
    var ComponentClass = /** @class */ (function () {
        function ComponentClass() {
            this.props = {};
        }
        ComponentClass.prototype.mount = function () {
            return petit_dom_1.mount(petit_dom_1.h("div", { className: "some-class" }));
        };
        ComponentClass.prototype.patch = function (element, newProps, oldProps, newContent, oldContent) {
            petit_dom_1.patch(petit_dom_1.h("div", __assign({}, oldProps), oldContent), petit_dom_1.h("div", __assign({}, newProps), newContent));
            return element;
        };
        ComponentClass.prototype.unmount = function (element) {
            petit_dom_1.unmount(petit_dom_1.h("div", null, "Hello World"));
        };
        return ComponentClass;
    }());
    // HyperScript syntax returns a ComponentClassNode<T> object, with typed properties
    var node = petit_dom_1.h(ComponentClass, { key: "1" });
    assertEqual(node.isSVG, false);
    assertEqual(node.type, ComponentClass);
    assertEqual(node.key, "1");
    assertEqual(node.props.key, "1");
    assertEqual(node.content.length, 0);
    // JSX syntax returns a VNode object, so the "type" and "props" properties are "any"
    var jsxNode = petit_dom_1.h(ComponentClass, { key: "1" });
    var jsxNodeType = jsxNode.type;
    var jsxNodeProps = jsxNode.props;
    assertEqual(jsxNode.isSVG, false);
    assertEqual(jsxNodeType, ComponentClass);
 ...
 * Create a component class with props, using HyperScript syntax and JSX syntax
 */
function testComponentClassWithProps() {
    var ComponentClassWithProps = /** @class */ (function () {
        function ComponentClassWithProps(props) {
            this.props = props;
        }
        ComponentClassWithProps.prototype.mount = function (props) {
            var name = props.name, count = props.count, onSomeEvent = props.onSomeEvent;
            return petit_dom_1.mount(petit_dom_1.h("div", { className: name, tabIndex: count, onclick: onSomeEvent }));
        };
        ComponentClassWithProps.prototype.patch = function (element, newProps, oldProps, newContent, oldContent) {
            petit_dom_1.patch(petit_dom_1.h("div", __assign({}, oldProps), oldContent), petit_dom_1.h("div", __assign({}, newProps), newContent));
            return element;
        };
        ComponentClassWithProps.prototype.unmount = function (element) {
            petit_dom_1.unmount(petit_dom_1.h("div", null, " Hello World"));
        };
        return ComponentClassWithProps;
    }());
    // HyperScript syntax returns a ComponentClassNode<T> object, with typed properties
    var node = petit_dom_1.h(ComponentClassWithProps, { name: "xyz", count: 123, onSomeEvent: eventHandler });
    assertEqual(node.isSVG, false);
    assertEqual(node.type, ComponentClassWithProps);
    assertEqual(node.key, null);
    assertEqual(node.props.name, "xyz");
    ...
    assertEqual(node.content.length, 0);
    // JSX syntax returns a VNode object, so the "type" and "props" properties are "any"
    var jsxNode = petit_dom_1.h(ComponentClassWithProps, { name: "xyz", count: 123, onSomeEvent: eventHandler });
    var jsxNodeType = jsxNode.type;
    var jsxNodeProps = jsxNode.props;
    assertEqual(jsxNode.isSVG, false);
    assertEqual(jsxNodeType, ComponentClassWithProps);
...
exports.testComponentClassWithProps = testComponentClassWithProps;
/**
 * Create a component class with child content, using HyperScript syntax and JSX syntax
 */
function testComponentClassWithChildren() {
    var ComponentClassWithChildren = /** @class */ (function () {
        function ComponentClassWithChildren(props) {
            this.props = props;
        }
        ComponentClassWithChildren.prototype.mount = function (props, content) {
            var name = props.name, count = props.count, onSomeEvent = props.onSomeEvent;
            return petit_dom_1.mount(petit_dom_1.h("div", { className: name, tabIndex: count, onclick: onSomeEvent }, content));
        };
        ComponentClassWithChildren.prototype.patch = function (element, newProps, oldProps, newContent, oldContent) {
            petit_dom_1.patch(petit_dom_1.h("div", __assign({}, oldProps), oldContent), petit_dom_1.h("div", __assign({}, newProps), newContent));
            return element;
        };
        ComponentClassWithChildren.prototype.unmount = function (element) {
            petit_dom_1.unmount(petit_dom_1.h("div", null, " Hello World"));
        };
        return ComponentClassWithChildren;
    }());
    // HyperScript syntax returns a ComponentClassNode<T> object, with typed properties
    var node = petit_dom_1.h(ComponentClassWithChildren, { name: "xyz", count: 123, onSomeEvent: eventHandler }, "Hello", petit_dom_1.h("span", null, "World"));
    assertEqual(node.isSVG, false);
    assertEqual(node.type, ComponentClassWithChildren);
    assertEqual(node.key, null);
    assertEqual(node.props.name, "xyz");
    ...
    assertEqual(node.content.length, 2);
    // JSX syntax returns a VNode object, so the "type" and "props" properties are "any"
    var jsxNode = (petit_dom_1.h(ComponentClassWithChildren, { name: "xyz", count: 123, onSomeEvent: eventHandler },
        "Hello ",
        petit_dom_1.h("span", null, "World")));
    var jsxNodeType = jsxNode.type;
    var jsxNodeProps = jsxNode.props;
...
exports.testComponentClassWithChildren = testComponentClassWithChildren;
