...
var _C_instances, _C_foo, _C_bar, _C_baz_get, _a;
const C = (_a = class {
        constructor() {
    ...
    _C_bar = function _C_bar() { __classPrivateAccessorGet(new C(), _C_instances, _C_baz_get); },
    _C_baz_get = function _C_baz_get() { return 42; },
    _a);
