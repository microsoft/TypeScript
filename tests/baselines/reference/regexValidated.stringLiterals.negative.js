//// [regexValidated.stringLiterals.negative.ts]
...
//// [regexValidated.stringLiterals.negative.js]
var fontColor = '#0000'; // not 3 or 6 characters
var catdogfish = 'cat,fish,dog,fosh,cat'; // misspelled fish
var digits = '02338374729O'; // Capital O isn't 0
var hexDigits = 'X0F12A'; // X isn't a hex digit
var address = 'type★script@microsoft.com'; // ★ isn't part of the validated range for addresses
var gmailAddress = 'example@GMAIL.ORG'; // wrong tld
