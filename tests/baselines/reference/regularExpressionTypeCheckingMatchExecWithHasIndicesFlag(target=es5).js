...
match[0].length; // number
match[1].length; // number
(_a = match[16]) === null || _a === void 0 ? void 0 : _a.length; // number | undefined
match[17]; // should error, but see #45560#issuecomment-1111121849
match.groups.date.length; // number
(_b = match.groups.timeZoneSecond) === null || _b === void 0 ? void 0 : _b.length; // number | undefined
match.groups.foo; // error
// Each element is of type [startIndex: number, endIndex: number]
match.indices.length; // 17
match.indices[0].length; // 2
match.indices[1].length; // 2
match.indices[2].length; // 2
(_c = match.indices[3]) === null || _c === void 0 ? void 0 : _c.length; // 2 | undefined
match.indices[4].length; // 2
match.indices[5].length; // 2
(_d = match.indices[6]) === null || _d === void 0 ? void 0 : _d.length; // 2 | undefined
(_e = match.indices[16]) === null || _e === void 0 ? void 0 : _e.length; // 2 | undefined
match.indices[17]; // should error, but see #45560#issuecomment-1111121849
match.indices.groups.date.length; // 2
match.indices.groups.year.length; // 2
match.indices.groups.month.length; // 2
match.indices.groups.day.length; // 2
(_f = match.indices.groups.time) === null || _f === void 0 ? void 0 : _f.length; // 2 | undefined
(_g = match.indices.groups.hour) === null || _g === void 0 ? void 0 : _g.length; // 2 | undefined
(_h = match.indices.groups.minute) === null || _h === void 0 ? void 0 : _h.length; // 2 | undefined
(_j = match.indices.groups.second) === null || _j === void 0 ? void 0 : _j.length; // 2 | undefined
(_k = match.indices.groups.timeZone) === null || _k === void 0 ? void 0 : _k.length; // 2 | undefined
(_l = match.indices.groups.timeZoneSecond) === null || _l === void 0 ? void 0 : _l.length; // 2 | undefined
match.indices.groups.foo; // error
