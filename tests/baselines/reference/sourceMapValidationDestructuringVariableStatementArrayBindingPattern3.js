...
var multiRobotAInfo;
robotA[0], nameA = robotA[1];
_a = getRobotB(), _a[0], nameB = _a[1];
_b = [2, "trimmer", "trimming"], _b[0], nameB = _b[1];
multiRobotB[0], multiSkillB = multiRobotB[1];
_c = getMultiRobotB(), _c[0], multiSkillB = _c[1];
_d = ["roomba", ["vacuum", "mopping"]], _d[0], multiSkillB = _d[1];
numberB = robotB[0];
numberB = getRobotB()[0];
