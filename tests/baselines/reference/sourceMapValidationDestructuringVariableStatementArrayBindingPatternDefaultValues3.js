...
var multiRobotAInfo;
robotA[0], _a = robotA[1], nameA = _a === void 0 ? "helloNoName" : _a;
_b = getRobotB(), _b[0], _c = _b[1], nameB = _c === void 0 ? "helloNoName" : _c;
_d = [2, "trimmer", "trimming"], _d[0], _e = _d[1], nameB = _e === void 0 ? "helloNoName" : _e;
multiRobotB[0], _f = multiRobotB[1], multiSkillB = _f === void 0 ? [] : _f;
_g = getMultiRobotB(), _g[0], _h = _g[1], multiSkillB = _h === void 0 ? [] : _h;
_j = ["roomba", ["vacuum", "mopping"]], _j[0], _k = _j[1], multiSkillB = _k === void 0 ? [] : _k;
