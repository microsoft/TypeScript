...
1->export const 
2 >            x
1->Emitted(5, 13) Source(1, 14) + SourceIndex(1)
2 >Emitted(5, 14) Source(1, 15) + SourceIndex(1)
---
>>>    exports.x = 10;
1->^^^^
2 >    ^^^^^^^^
...
1 >export const 
2 >            y
1 >Emitted(12, 13) Source(1, 14) + SourceIndex(2)
2 >Emitted(12, 14) Source(1, 15) + SourceIndex(2)
---
>>>    exports.y = 20;
1->^^^^
2 >    ^^^^^^^^
...
1->export const 
2 >            z
1->Emitted(19, 13) Source(1, 14) + SourceIndex(4)
2 >Emitted(19, 14) Source(1, 15) + SourceIndex(4)
---
>>>    exports.z = 30;
1->^^^^
2 >    ^^^^^^^^
...
{"version":3,"file":"module.js","sourceRoot":"","sources":["file0.ts","file1.ts","file2.ts","global.ts"],"names":[],"mappings":"AAAA,IAAM,MAAM,GAAG,EAAE,CAAC;;;;YCAL,CAAC;IAAD,QAAA,CAAC,GAAG,EAAE,CAAC;IAAA,OAAO,CAAC,GAAG,CAAC,SAAC,CAAC,CAAC;;;;;YCAtB,CAAC;IAAD,QAAA,CAAC,GAAG,EAAE,CAAC;;ACApB,IAAM,WAAW,GAAG,EAAE,CAAC"}
