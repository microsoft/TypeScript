...
7 >Emitted(6, 27) Source(1, 28) + SourceIndex(1)
8 >Emitted(6, 28) Source(1, 29) + SourceIndex(1)
9 >Emitted(6, 31) Source(1, 32) + SourceIndex(1)
10>Emitted(6, 32) Source(1, 33) + SourceIndex(1)
11>Emitted(6, 41) Source(1, 34) + SourceIndex(1)
12>Emitted(6, 42) Source(1, 35) + SourceIndex(1)
13>Emitted(6, 43) Source(1, 36) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
...
----------------------------------------------------------------------
prepend: (0-480):: ../lib/module.js texts:: 1
>>--------------------------------------------------------------------
text: (0-480)
var myGlob = 20;
define("file1", ["require", "exports"], function (require, exports) {
