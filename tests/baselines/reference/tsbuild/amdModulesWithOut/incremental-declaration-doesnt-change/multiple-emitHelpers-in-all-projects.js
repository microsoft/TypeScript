...
4 >Emitted(34, 28) Source(2, 25) + SourceIndex(0)
5 >Emitted(34, 39) Source(2, 39) + SourceIndex(0)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
2 >Emitted(39, 5) Source(3, 7) + SourceIndex(0)
3 >Emitted(39, 16) Source(3, 18) + SourceIndex(0)
4 >Emitted(39, 19) Source(3, 21) + SourceIndex(0)
5 >Emitted(39, 20) Source(3, 22) + SourceIndex(0)
6 >Emitted(39, 22) Source(3, 24) + SourceIndex(0)
7 >Emitted(39, 24) Source(3, 26) + SourceIndex(0)
8 >Emitted(39, 26) Source(3, 28) + SourceIndex(0)
9 >Emitted(39, 27) Source(3, 29) + SourceIndex(0)
10>Emitted(39, 28) Source(3, 30) + SourceIndex(0)
---
>>>libfile0Spread.apply(void 0, __spreadArray([10], __read(libfile0_ar)));
1->
2 >^^^^^^^^^^^^^^
...
6 >                                                        libfile0_ar
7 >                                                                   );
1->Emitted(40, 1) Source(4, 1) + SourceIndex(0)
2 >Emitted(40, 15) Source(4, 15) + SourceIndex(0)
3 >Emitted(40, 45) Source(4, 16) + SourceIndex(0)
4 >Emitted(40, 47) Source(4, 18) + SourceIndex(0)
5 >Emitted(40, 57) Source(4, 23) + SourceIndex(0)
6 >Emitted(40, 68) Source(4, 34) + SourceIndex(0)
7 >Emitted(40, 72) Source(4, 36) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
...
7 >Emitted(44, 29) Source(1, 30) + SourceIndex(1)
8 >Emitted(44, 44) Source(1, 45) + SourceIndex(1)
---
>>>        var _a = { a: 10, b: 30, yy: 30 }, b = _a.b, rest = __rest(_a, ["b"]);
1->^^^^^^^^
2 >        ^^^^
...
3 >Emitted(45, 18) Source(2, 24) + SourceIndex(1)
4 >Emitted(45, 20) Source(2, 26) + SourceIndex(1)
5 >Emitted(45, 21) Source(2, 27) + SourceIndex(1)
6 >Emitted(45, 23) Source(2, 29) + SourceIndex(1)
7 >Emitted(45, 25) Source(2, 31) + SourceIndex(1)
8 >Emitted(45, 27) Source(2, 33) + SourceIndex(1)
9 >Emitted(45, 28) Source(2, 34) + SourceIndex(1)
10>Emitted(45, 30) Source(2, 36) + SourceIndex(1)
11>Emitted(45, 32) Source(2, 38) + SourceIndex(1)
12>Emitted(45, 34) Source(2, 40) + SourceIndex(1)
13>Emitted(45, 36) Source(2, 42) + SourceIndex(1)
14>Emitted(45, 38) Source(2, 44) + SourceIndex(1)
15>Emitted(45, 40) Source(2, 46) + SourceIndex(1)
16>Emitted(45, 42) Source(2, 48) + SourceIndex(1)
17>Emitted(45, 44) Source(2, 9) + SourceIndex(1)
18>Emitted(45, 45) Source(2, 10) + SourceIndex(1)
19>Emitted(45, 52) Source(2, 10) + SourceIndex(1)
20>Emitted(45, 54) Source(2, 15) + SourceIndex(1)
21>Emitted(45, 58) Source(2, 19) + SourceIndex(1)
22>Emitted(45, 72) Source(2, 7) + SourceIndex(1)
23>Emitted(45, 77) Source(2, 21) + SourceIndex(1)
24>Emitted(45, 78) Source(2, 48) + SourceIndex(1)
25>Emitted(45, 79) Source(2, 49) + SourceIndex(1)
---
>>>    }
1 >^^^^
2 >    ^
...
2 >Emitted(69, 5) Source(3, 7) + SourceIndex(5)
3 >Emitted(69, 16) Source(3, 18) + SourceIndex(5)
4 >Emitted(69, 19) Source(3, 21) + SourceIndex(5)
5 >Emitted(69, 20) Source(3, 22) + SourceIndex(5)
6 >Emitted(69, 22) Source(3, 24) + SourceIndex(5)
7 >Emitted(69, 24) Source(3, 26) + SourceIndex(5)
8 >Emitted(69, 26) Source(3, 28) + SourceIndex(5)
9 >Emitted(69, 27) Source(3, 29) + SourceIndex(5)
10>Emitted(69, 28) Source(3, 30) + SourceIndex(5)
---
>>>appfile4Spread.apply(void 0, __spreadArray([10], __read(appfile4_ar)));
1->
2 >^^^^^^^^^^^^^^
...
6 >                                                        appfile4_ar
7 >                                                                   );
1->Emitted(70, 1) Source(4, 1) + SourceIndex(5)
2 >Emitted(70, 15) Source(4, 15) + SourceIndex(5)
3 >Emitted(70, 45) Source(4, 16) + SourceIndex(5)
4 >Emitted(70, 47) Source(4, 18) + SourceIndex(5)
5 >Emitted(70, 57) Source(4, 23) + SourceIndex(5)
6 >Emitted(70, 68) Source(4, 34) + SourceIndex(5)
7 >Emitted(70, 72) Source(4, 36) + SourceIndex(5)
---
>>>//# sourceMappingURL=module.js.map
...
----------------------------------------------------------------------
prepend: (1201-2027):: ../lib/module.js texts:: 1
>>--------------------------------------------------------------------
text: (1201-2027)
var myGlob = 20;
function libfile0Spread() {var b = [];
