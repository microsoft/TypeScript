...
7 >Emitted(10, 27) Source(1, 28) + SourceIndex(3)
8 >Emitted(10, 28) Source(1, 29) + SourceIndex(3)
9 >Emitted(10, 31) Source(1, 32) + SourceIndex(3)
10>Emitted(10, 32) Source(1, 33) + SourceIndex(3)
11>Emitted(10, 41) Source(1, 34) + SourceIndex(3)
12>Emitted(10, 42) Source(1, 35) + SourceIndex(3)
13>Emitted(10, 43) Source(1, 36) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
...
"myPrologue2";
----------------------------------------------------------------------
prepend: (62-565):: ../lib/module.js texts:: 1
>>--------------------------------------------------------------------
text: (62-565)
var myGlob = 20;
define("file1", ["require", "exports"], function (require, exports) {
...
{"version":3,"file":"module.js","sourceRoot":"","sources":["file0.ts","global.ts","file1.ts","file2.ts"],"names":[],"mappings":";AAAA,YAAY,CAAA;ACAZ,aAAa,CAAA;ADCb,IAAM,MAAM,GAAG,EAAE,CAAC;;;;;IEDL,QAAA,CAAC,GAAG,EAAE,CAAC,OAAO,CAAC,GAAG,CAAC,SAAC,CAAC,CAAC;;;;ICAnC,gBAAgB,CAAA;;;IACH,QAAA,CAAC,GAAG,EAAE,CAAC;;AFApB,IAAM,WAAW,GAAG,EAAE,CAAC"}
...
7 >Emitted(9, 27) Source(1, 28) + SourceIndex(2)
8 >Emitted(9, 28) Source(1, 29) + SourceIndex(2)
9 >Emitted(9, 31) Source(1, 32) + SourceIndex(2)
10>Emitted(9, 32) Source(1, 33) + SourceIndex(2)
11>Emitted(9, 41) Source(1, 34) + SourceIndex(2)
12>Emitted(9, 42) Source(1, 35) + SourceIndex(2)
13>Emitted(9, 43) Source(1, 36) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/lib/module.js
sourceFile:file2.ts
