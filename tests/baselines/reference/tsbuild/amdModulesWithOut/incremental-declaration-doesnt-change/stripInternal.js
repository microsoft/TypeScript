...
7 >                         )
8 >                          ;
1 >Emitted(100, 5) Source(26, 51) + SourceIndex(1)
2 >Emitted(100, 12) Source(26, 58) + SourceIndex(1)
3 >Emitted(100, 13) Source(26, 59) + SourceIndex(1)
4 >Emitted(100, 16) Source(26, 62) + SourceIndex(1)
5 >Emitted(100, 17) Source(26, 63) + SourceIndex(1)
6 >Emitted(100, 26) Source(26, 64) + SourceIndex(1)
7 >Emitted(100, 27) Source(26, 65) + SourceIndex(1)
8 >Emitted(100, 28) Source(26, 66) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
...
5 >                20
6 >                  ;
1 >Emitted(105, 5) Source(1, 14) + SourceIndex(2)
2 >Emitted(105, 13) Source(1, 14) + SourceIndex(2)
3 >Emitted(105, 14) Source(1, 15) + SourceIndex(2)
4 >Emitted(105, 17) Source(1, 18) + SourceIndex(2)
5 >Emitted(105, 19) Source(1, 20) + SourceIndex(2)
6 >Emitted(105, 20) Source(1, 21) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
...
5 >                  10
6 >                    ;
1 >Emitted(107, 1) Source(1, 1) + SourceIndex(3)
2 >Emitted(107, 5) Source(1, 7) + SourceIndex(3)
3 >Emitted(107, 16) Source(1, 18) + SourceIndex(3)
4 >Emitted(107, 19) Source(1, 21) + SourceIndex(3)
5 >Emitted(107, 21) Source(1, 23) + SourceIndex(3)
6 >Emitted(107, 22) Source(1, 24) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
sourceFile:file3.ts
...
5 >                30
6 >                  ;
1->Emitted(111, 5) Source(1, 14) + SourceIndex(4)
2 >Emitted(111, 13) Source(1, 14) + SourceIndex(4)
3 >Emitted(111, 14) Source(1, 15) + SourceIndex(4)
4 >Emitted(111, 17) Source(1, 18) + SourceIndex(4)
5 >Emitted(111, 19) Source(1, 20) + SourceIndex(4)
6 >Emitted(111, 20) Source(1, 21) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
sourceFile:file4.ts
...
5 >            30
6 >              ;
1 >Emitted(113, 1) Source(1, 1) + SourceIndex(5)
2 >Emitted(113, 5) Source(1, 7) + SourceIndex(5)
3 >Emitted(113, 10) Source(1, 12) + SourceIndex(5)
4 >Emitted(113, 13) Source(1, 15) + SourceIndex(5)
5 >Emitted(113, 15) Source(1, 17) + SourceIndex(5)
6 >Emitted(113, 16) Source(1, 18) + SourceIndex(5)
---
>>>//# sourceMappingURL=module.js.map
...
----------------------------------------------------------------------
prepend: (0-4357):: ../lib/module.js texts:: 1
>>--------------------------------------------------------------------
text: (0-4357)
/*@internal*/ var myGlob = 20;
define("file1", ["require", "exports"], function (require, exports) {
