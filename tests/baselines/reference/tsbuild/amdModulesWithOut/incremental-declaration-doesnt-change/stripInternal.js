...
7 >                         )
8 >                          ;
1 >Emitted(84, 5) Source(26, 51) + SourceIndex(1)
2 >Emitted(84, 12) Source(26, 58) + SourceIndex(1)
3 >Emitted(84, 13) Source(26, 59) + SourceIndex(1)
4 >Emitted(84, 16) Source(26, 62) + SourceIndex(1)
5 >Emitted(84, 17) Source(26, 63) + SourceIndex(1)
6 >Emitted(84, 26) Source(26, 64) + SourceIndex(1)
7 >Emitted(84, 27) Source(26, 65) + SourceIndex(1)
8 >Emitted(84, 28) Source(26, 66) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
...
5 >                20
6 >                  ;
1 >Emitted(89, 5) Source(1, 14) + SourceIndex(2)
2 >Emitted(89, 13) Source(1, 14) + SourceIndex(2)
3 >Emitted(89, 14) Source(1, 15) + SourceIndex(2)
4 >Emitted(89, 17) Source(1, 18) + SourceIndex(2)
5 >Emitted(89, 19) Source(1, 20) + SourceIndex(2)
6 >Emitted(89, 20) Source(1, 21) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
...
5 >                  10
6 >                    ;
1 >Emitted(91, 1) Source(1, 1) + SourceIndex(3)
2 >Emitted(91, 5) Source(1, 7) + SourceIndex(3)
3 >Emitted(91, 16) Source(1, 18) + SourceIndex(3)
4 >Emitted(91, 19) Source(1, 21) + SourceIndex(3)
5 >Emitted(91, 21) Source(1, 23) + SourceIndex(3)
6 >Emitted(91, 22) Source(1, 24) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
sourceFile:file3.ts
...
----------------------------------------------------------------------
prepend: (0-4227):: ../lib/module.js texts:: 1
>>--------------------------------------------------------------------
text: (0-4227)
/*@internal*/ /*@internal*/ var myGlob = 20;
define("file1", ["require", "exports"], function (require, exports) {
