...
4:32:00 PM - Projects in this build: 
    * src/lib/tsconfig.json
    * src/app/tsconfig.json

4:32:00 PM - Project 'src/lib/tsconfig.json' is out of date because oldest output 'src/lib/module.js' is older than newest input 'src/lib/file1.ts'

4:32:00 PM - Building project '/src/lib/tsconfig.json'...

4:32:00 PM - Project 'src/app/tsconfig.json' is out of date because output of its dependency 'src/lib' has changed

4:32:00 PM - Updating output of project '/src/app/tsconfig.json'...

4:32:00 PM - Updating unchanged output timestamps of project '/src/app/tsconfig.json'...
