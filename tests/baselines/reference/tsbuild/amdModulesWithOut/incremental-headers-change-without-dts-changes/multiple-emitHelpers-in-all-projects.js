...
2 >Emitted(67, 5) Source(3, 7) + SourceIndex(5)
3 >Emitted(67, 16) Source(3, 18) + SourceIndex(5)
4 >Emitted(67, 19) Source(3, 21) + SourceIndex(5)
5 >Emitted(67, 20) Source(3, 22) + SourceIndex(5)
6 >Emitted(67, 22) Source(3, 24) + SourceIndex(5)
7 >Emitted(67, 24) Source(3, 26) + SourceIndex(5)
8 >Emitted(67, 26) Source(3, 28) + SourceIndex(5)
9 >Emitted(67, 27) Source(3, 29) + SourceIndex(5)
10>Emitted(67, 28) Source(3, 30) + SourceIndex(5)
---
>>>appfile4Spread.apply(void 0, __spreadArray([10], __read(appfile4_ar)));
1->
2 >^^^^^^^^^^^^^^
...
6 >                                                        appfile4_ar
7 >                                                                   );
1->Emitted(68, 1) Source(4, 1) + SourceIndex(5)
2 >Emitted(68, 15) Source(4, 15) + SourceIndex(5)
3 >Emitted(68, 45) Source(4, 16) + SourceIndex(5)
4 >Emitted(68, 47) Source(4, 18) + SourceIndex(5)
5 >Emitted(68, 57) Source(4, 23) + SourceIndex(5)
6 >Emitted(68, 68) Source(4, 34) + SourceIndex(5)
7 >Emitted(68, 72) Source(4, 36) + SourceIndex(5)
---
>>>//# sourceMappingURL=module.js.map
...
----------------------------------------------------------------------
prepend: (1201-1919):: ../lib/module.js texts:: 1
>>--------------------------------------------------------------------
text: (1201-1919)
var myGlob = 20;
function libfile0Spread() {var b = [];
...
4 >Emitted(23, 28) Source(2, 25) + SourceIndex(0)
5 >Emitted(23, 39) Source(2, 39) + SourceIndex(0)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
2 >Emitted(28, 5) Source(3, 7) + SourceIndex(0)
3 >Emitted(28, 16) Source(3, 18) + SourceIndex(0)
4 >Emitted(28, 19) Source(3, 21) + SourceIndex(0)
5 >Emitted(28, 20) Source(3, 22) + SourceIndex(0)
6 >Emitted(28, 22) Source(3, 24) + SourceIndex(0)
7 >Emitted(28, 24) Source(3, 26) + SourceIndex(0)
8 >Emitted(28, 26) Source(3, 28) + SourceIndex(0)
9 >Emitted(28, 27) Source(3, 29) + SourceIndex(0)
10>Emitted(28, 28) Source(3, 30) + SourceIndex(0)
---
>>>libfile0Spread.apply(void 0, __spreadArray([10], __read(libfile0_ar)));
1->
2 >^^^^^^^^^^^^^^
...
2 >Emitted(29, 15) Source(4, 15) + SourceIndex(0)
3 >Emitted(29, 45) Source(4, 16) + SourceIndex(0)
4 >Emitted(29, 47) Source(4, 18) + SourceIndex(0)
5 >Emitted(29, 57) Source(4, 23) + SourceIndex(0)
6 >Emitted(29, 68) Source(4, 34) + SourceIndex(0)
7 >Emitted(29, 72) Source(4, 36) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/lib/module.js
sourceFile:file1.ts
