...
define("file1", ["require", "exports"], function (require, exports) {
    ...
    /*@internal*/ exports.internalNamespace = undefined;
    ...
    /*@internal*/ exports.internalOther = undefined;
    ...
    /*@internal*/ var internalEnum;
    /*@internal*/ exports.internalEnum = undefined;
    (function (internalEnum) {
        internalEnum[internalEnum["a"] = 0] = "a";
        internalEnum[internalEnum["b"] = 1] = "b";
        internalEnum[internalEnum["c"] = 2] = "c";
...
4 >                    {
  ...
  >                       /*@internal*/ export enum internalEnum { a, b, c }
  >                   }
1->Emitted(20, 5) Source(9, 18) + SourceIndex(1)
2 >Emitted(20, 13) Source(9, 18) + SourceIndex(1)
3 >Emitted(20, 20) Source(9, 25) + SourceIndex(1)
4 >Emitted(20, 33) Source(18, 2) + SourceIndex(1)
---
>>>    (function (normalN) {
1 >^^^^
2 >    ^^^^^^^^^^^
...
3 >Emitted(69, 19) Source(21, 32) + SourceIndex(1)
4 >Emitted(69, 27) Source(21, 32) + SourceIndex(1)
5 >Emitted(69, 44) Source(21, 49) + SourceIndex(1)
6 >Emitted(69, 57) Source(21, 79) + SourceIndex(1)
---
>>>    (function (internalNamespace) {
1 >^^^^
2 >    ^^^^^^^^^^^
...
5 >                          internalOther
6 >                                       .something { export class someClass {} }
1->Emitted(79, 5) Source(22, 1) + SourceIndex(1)
2 >Emitted(79, 18) Source(22, 14) + SourceIndex(1)
3 >Emitted(79, 19) Source(22, 32) + SourceIndex(1)
4 >Emitted(79, 27) Source(22, 32) + SourceIndex(1)
5 >Emitted(79, 40) Source(22, 45) + SourceIndex(1)
6 >Emitted(79, 53) Source(22, 85) + SourceIndex(1)
---
>>>    (function (internalOther) {
1 >^^^^
2 >    ^^^^^^^^^^^
...
2 >    export namespace 
3 >               internalOther
1 >Emitted(80, 5) Source(22, 15) + SourceIndex(1)
2 >Emitted(80, 16) Source(22, 32) + SourceIndex(1)
3 >Emitted(80, 29) Source(22, 45) + SourceIndex(1)
---
>>>        var something;
1 >^^^^^^^^
2 >        ^^^^
...
2 >Emitted(81, 13) Source(22, 46) + SourceIndex(1)
3 >Emitted(81, 22) Source(22, 55) + SourceIndex(1)
4 >Emitted(81, 23) Source(22, 85) + SourceIndex(1)
---
>>>        (function (something) {
1->^^^^^^^^
2 >        ^^^^^^^^^^^
...
2 >        
3 >                   something
1->Emitted(82, 9) Source(22, 46) + SourceIndex(1)
2 >Emitted(82, 20) Source(22, 46) + SourceIndex(1)
3 >Emitted(82, 29) Source(22, 55) + SourceIndex(1)
---
>>>            var someClass = /** @class */ (function () {
1->^^^^^^^^^^^^
2 >            ^^^^^^^^^^^^^^^^^^^^^^^^^^^->
1-> { 
1->Emitted(83, 13) Source(22, 58) + SourceIndex(1)
---
>>>                function someClass() {
1->^^^^^^^^^^^^^^^^
2 >                ^^->
1->
1->Emitted(84, 17) Source(22, 58) + SourceIndex(1)
---
>>>                }
1->^^^^^^^^^^^^^^^^
2 >                ^
...
2 >Emitted(85, 18) Source(22, 83) + SourceIndex(1)
---
>>>                return someClass;
1->^^^^^^^^^^^^^^^^
2 >                ^^^^^^^^^^^^^^^^
1->
2 >                }
1->Emitted(86, 17) Source(22, 82) + SourceIndex(1)
2 >Emitted(86, 33) Source(22, 83) + SourceIndex(1)
---
>>>            }());
1 >^^^^^^^^^^^^
2 >            ^
...
3 >             
4 >             export class someClass {}
1 >Emitted(87, 13) Source(22, 82) + SourceIndex(1)
2 >Emitted(87, 14) Source(22, 83) + SourceIndex(1)
3 >Emitted(87, 14) Source(22, 58) + SourceIndex(1)
4 >Emitted(87, 18) Source(22, 83) + SourceIndex(1)
---
>>>            something.someClass = someClass;
1->^^^^^^^^^^^^
2 >            ^^^^^^^^^^^^^^^^^^^
...
3 >                                {}
4 >                                           
1->Emitted(88, 13) Source(22, 71) + SourceIndex(1)
2 >Emitted(88, 32) Source(22, 80) + SourceIndex(1)
3 >Emitted(88, 44) Source(22, 83) + SourceIndex(1)
4 >Emitted(88, 45) Source(22, 83) + SourceIndex(1)
---
>>>        })(something = internalOther.something || (internalOther.something = {}));
1->^^^^^^^^
2 >        ^
...
8 >                                                   something
9 >                                                                           { export class someClass {} }
1->Emitted(89, 9) Source(22, 84) + SourceIndex(1)
2 >Emitted(89, 10) Source(22, 85) + SourceIndex(1)
3 >Emitted(89, 12) Source(22, 46) + SourceIndex(1)
4 >Emitted(89, 21) Source(22, 55) + SourceIndex(1)
5 >Emitted(89, 24) Source(22, 46) + SourceIndex(1)
6 >Emitted(89, 47) Source(22, 55) + SourceIndex(1)
7 >Emitted(89, 52) Source(22, 46) + SourceIndex(1)
8 >Emitted(89, 75) Source(22, 55) + SourceIndex(1)
9 >Emitted(89, 83) Source(22, 85) + SourceIndex(1)
---
>>>    })(internalOther = exports.internalOther || (exports.internalOther = {}));
1 >^^^^
2 >    ^
...
8 >                                                 internalOther
9 >                                                                      .something { export class someClass {} }
1 >Emitted(90, 5) Source(22, 84) + SourceIndex(1)
2 >Emitted(90, 6) Source(22, 85) + SourceIndex(1)
3 >Emitted(90, 8) Source(22, 32) + SourceIndex(1)
4 >Emitted(90, 21) Source(22, 45) + SourceIndex(1)
5 >Emitted(90, 24) Source(22, 32) + SourceIndex(1)
6 >Emitted(90, 45) Source(22, 45) + SourceIndex(1)
7 >Emitted(90, 50) Source(22, 32) + SourceIndex(1)
8 >Emitted(90, 71) Source(22, 45) + SourceIndex(1)
9 >Emitted(90, 79) Source(22, 85) + SourceIndex(1)
---
>>>    /*@internal*/ exports.internalImport = internalNamespace.someClass;
1 >^^^^
2 >    ^^^^^^^^^^^^^
...
9 >                                                             someClass
10>                                                                      ;
1 >Emitted(91, 5) Source(23, 1) + SourceIndex(1)
2 >Emitted(91, 18) Source(23, 14) + SourceIndex(1)
3 >Emitted(91, 19) Source(23, 29) + SourceIndex(1)
4 >Emitted(91, 27) Source(23, 29) + SourceIndex(1)
5 >Emitted(91, 41) Source(23, 43) + SourceIndex(1)
6 >Emitted(91, 44) Source(23, 46) + SourceIndex(1)
7 >Emitted(91, 61) Source(23, 63) + SourceIndex(1)
8 >Emitted(91, 62) Source(23, 64) + SourceIndex(1)
9 >Emitted(91, 71) Source(23, 73) + SourceIndex(1)
10>Emitted(91, 72) Source(23, 74) + SourceIndex(1)
---
>>>    /*@internal*/ exports.internalConst = 10;
1 >^^^^
2 >    ^^^^^^^^^^^^^
...
7 >                                          10
8 >                                            ;
1 >Emitted(92, 5) Source(25, 1) + SourceIndex(1)
2 >Emitted(92, 18) Source(25, 14) + SourceIndex(1)
3 >Emitted(92, 19) Source(25, 28) + SourceIndex(1)
4 >Emitted(92, 27) Source(25, 28) + SourceIndex(1)
5 >Emitted(92, 40) Source(25, 41) + SourceIndex(1)
6 >Emitted(92, 43) Source(25, 44) + SourceIndex(1)
7 >Emitted(92, 45) Source(25, 46) + SourceIndex(1)
8 >Emitted(92, 46) Source(25, 47) + SourceIndex(1)
---
>>>    /*@internal*/ var internalEnum;
1 >^^^^
2 >    ^^^^^^^^^^^^^
...
4 >                  export enum 
5 >                      internalEnum { a, b, c }
1 >Emitted(93, 5) Source(26, 1) + SourceIndex(1)
2 >Emitted(93, 18) Source(26, 14) + SourceIndex(1)
3 >Emitted(93, 19) Source(26, 15) + SourceIndex(1)
4 >Emitted(93, 23) Source(26, 27) + SourceIndex(1)
5 >Emitted(93, 35) Source(26, 51) + SourceIndex(1)
---
>>>    /*@internal*/ exports.internalEnum = undefined;
1->^^^^
2 >    ^^^^^^^^^^^^^
...
4 >                  
5 >                          internalEnum
1->Emitted(94, 5) Source(26, 1) + SourceIndex(1)
2 >Emitted(94, 18) Source(26, 14) + SourceIndex(1)
3 >Emitted(94, 19) Source(26, 27) + SourceIndex(1)
4 >Emitted(94, 27) Source(26, 27) + SourceIndex(1)
5 >Emitted(94, 39) Source(26, 39) + SourceIndex(1)
---
>>>    (function (internalEnum) {
1 >^^^^
2 >    ^^^^^^^^^^^
...
2 >    export enum 
3 >               internalEnum
1 >Emitted(95, 5) Source(26, 15) + SourceIndex(1)
2 >Emitted(95, 16) Source(26, 27) + SourceIndex(1)
3 >Emitted(95, 28) Source(26, 39) + SourceIndex(1)
---
>>>        internalEnum[internalEnum["a"] = 0] = "a";
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >        a
3 >                                                 
1->Emitted(96, 9) Source(26, 42) + SourceIndex(1)
2 >Emitted(96, 50) Source(26, 43) + SourceIndex(1)
3 >Emitted(96, 51) Source(26, 43) + SourceIndex(1)
---
>>>        internalEnum[internalEnum["b"] = 1] = "b";
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >        b
3 >                                                 
1->Emitted(97, 9) Source(26, 45) + SourceIndex(1)
2 >Emitted(97, 50) Source(26, 46) + SourceIndex(1)
3 >Emitted(97, 51) Source(26, 46) + SourceIndex(1)
---
>>>        internalEnum[internalEnum["c"] = 2] = "c";
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >        c
3 >                                                 
1->Emitted(98, 9) Source(26, 48) + SourceIndex(1)
2 >Emitted(98, 50) Source(26, 49) + SourceIndex(1)
3 >Emitted(98, 51) Source(26, 49) + SourceIndex(1)
---
>>>    })(internalEnum = exports.internalEnum || (exports.internalEnum = {}));
1->^^^^
2 >    ^
...
8 >                                               internalEnum
9 >                                                                    { a, b, c }
1->Emitted(99, 5) Source(26, 50) + SourceIndex(1)
2 >Emitted(99, 6) Source(26, 51) + SourceIndex(1)
3 >Emitted(99, 8) Source(26, 27) + SourceIndex(1)
4 >Emitted(99, 20) Source(26, 39) + SourceIndex(1)
5 >Emitted(99, 23) Source(26, 27) + SourceIndex(1)
6 >Emitted(99, 43) Source(26, 39) + SourceIndex(1)
7 >Emitted(99, 48) Source(26, 27) + SourceIndex(1)
8 >Emitted(99, 68) Source(26, 39) + SourceIndex(1)
9 >Emitted(99, 76) Source(26, 51) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
sourceFile:../lib/file2.ts
...
5 >                20
6 >                  ;
1 >Emitted(104, 5) Source(1, 14) + SourceIndex(2)
2 >Emitted(104, 13) Source(1, 14) + SourceIndex(2)
3 >Emitted(104, 14) Source(1, 15) + SourceIndex(2)
4 >Emitted(104, 17) Source(1, 18) + SourceIndex(2)
5 >Emitted(104, 19) Source(1, 20) + SourceIndex(2)
6 >Emitted(104, 20) Source(1, 21) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
sourceFile:../lib/global.ts
...
5 >                  10
6 >                    ;
1 >Emitted(106, 1) Source(1, 1) + SourceIndex(3)
2 >Emitted(106, 5) Source(1, 7) + SourceIndex(3)
3 >Emitted(106, 16) Source(1, 18) + SourceIndex(3)
4 >Emitted(106, 19) Source(1, 21) + SourceIndex(3)
5 >Emitted(106, 21) Source(1, 23) + SourceIndex(3)
6 >Emitted(106, 22) Source(1, 24) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
sourceFile:file3.ts
...
----------------------------------------------------------------------
prepend: (0-4342):: ../lib/module.js texts:: 1
>>--------------------------------------------------------------------
text: (0-4342)
/*@internal*/ var myGlob = 20;
define("file1", ["require", "exports"], function (require, exports) {
