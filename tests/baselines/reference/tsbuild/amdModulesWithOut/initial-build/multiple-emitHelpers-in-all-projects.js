...
2 >Emitted(68, 5) Source(3, 7) + SourceIndex(5)
3 >Emitted(68, 16) Source(3, 18) + SourceIndex(5)
4 >Emitted(68, 19) Source(3, 21) + SourceIndex(5)
5 >Emitted(68, 20) Source(3, 22) + SourceIndex(5)
6 >Emitted(68, 22) Source(3, 24) + SourceIndex(5)
7 >Emitted(68, 24) Source(3, 26) + SourceIndex(5)
8 >Emitted(68, 26) Source(3, 28) + SourceIndex(5)
9 >Emitted(68, 27) Source(3, 29) + SourceIndex(5)
10>Emitted(68, 28) Source(3, 30) + SourceIndex(5)
---
>>>appfile4Spread.apply(void 0, __spreadArray([10], __read(appfile4_ar)));
1->
2 >^^^^^^^^^^^^^^
...
6 >                                                        appfile4_ar
7 >                                                                   );
1->Emitted(69, 1) Source(4, 1) + SourceIndex(5)
2 >Emitted(69, 15) Source(4, 15) + SourceIndex(5)
3 >Emitted(69, 45) Source(4, 16) + SourceIndex(5)
4 >Emitted(69, 47) Source(4, 18) + SourceIndex(5)
5 >Emitted(69, 57) Source(4, 23) + SourceIndex(5)
6 >Emitted(69, 68) Source(4, 34) + SourceIndex(5)
7 >Emitted(69, 72) Source(4, 36) + SourceIndex(5)
---
>>>//# sourceMappingURL=module.js.map
...
----------------------------------------------------------------------
prepend: (1201-1998):: ../lib/module.js texts:: 1
>>--------------------------------------------------------------------
text: (1201-1998)
var myGlob = 20;
function libfile0Spread() {var b = [];
