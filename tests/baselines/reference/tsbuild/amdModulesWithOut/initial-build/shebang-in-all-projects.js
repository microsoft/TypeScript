...
1->#!someshebang app file3
  >export const 
2 >            z
1->Emitted(19, 13) Source(2, 14) + SourceIndex(4)
2 >Emitted(19, 14) Source(2, 15) + SourceIndex(4)
---
>>>    exports.z = 30;
1->^^^^
2 >    ^^^^^^^^
...
{"version":3,"file":"module.js","sourceRoot":"","sources":["file0.ts","file1.ts","file2.ts","global.ts"],"names":[],"mappings":";AACA,IAAM,MAAM,GAAG,EAAE,CAAC;;;;YCAL,CAAC;IAAD,QAAA,CAAC,GAAG,EAAE,CAAC;;;;;YCDP,CAAC;IAAD,QAAA,CAAC,GAAG,EAAE,CAAC;;ACApB,IAAM,WAAW,GAAG,EAAE,CAAC"}
