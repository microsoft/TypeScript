...
//// [/src/lib/module.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "./file0.ts": {
        "original": {
          "version": "4690807917-const myGlob = 20;\nfunction libfile0Spread(...b: number[]) { }\nconst libfile0_ar = [20, 30];\nlibfile0Spread(10, ...libfile0_ar);",
          "impliedFormat": 1
        },
        "version": "4690807917-const myGlob = 20;\nfunction libfile0Spread(...b: number[]) { }\nconst libfile0_ar = [20, 30];\nlibfile0Spread(10, ...libfile0_ar);",
        "impliedFormat": "commonjs"
      ...
      "./file1.ts": {
        "original": {
          "version": "186113334-export const x = 10;function forlibfile1Rest() {\nconst { b, ...rest } = { a: 10, b: 30, yy: 30 };\n}",
          "impliedFormat": 1
        },
        "version": "186113334-export const x = 10;function forlibfile1Rest() {\nconst { b, ...rest } = { a: 10, b: 30, yy: 30 };\n}",
        "impliedFormat": "commonjs"
...
//// [/src/lib/module.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "./file1.ts": {
        "original": {
          "version": "12502459933-export const x = 10;function forlibfile1Rest() {\nconst { b, ...rest } = { a: 10, b: 30, yy: 30 };\n}console.log(x);",
          "impliedFormat": 1
        },
        "version": "12502459933-export const x = 10;function forlibfile1Rest() {\nconst { b, ...rest } = { a: 10, b: 30, yy: 30 };\n}console.log(x);",
        "impliedFormat": "commonjs"
...
//// [/src/lib/module.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "./file1.ts": {
        "original": {
          "version": "-2014796510-export const x = 10;function forlibfile1Rest() { }console.log(x);",
          "impliedFormat": 1
        },
        "version": "-2014796510-export const x = 10;function forlibfile1Rest() { }console.log(x);",
        "impliedFormat": "commonjs"
