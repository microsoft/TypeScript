...
5 >Emitted(34, 22) Source(5, 24) + SourceIndex(0)
6 >Emitted(34, 23) Source(5, 25) + SourceIndex(0)
---
>>>console.log(s);
1 >
2 >^^^^^^^
...
5 >Emitted(67, 22) Source(5, 24) + SourceIndex(0)
6 >Emitted(67, 23) Source(5, 25) + SourceIndex(0)
---
>>>console.log(s);
1 >
2 >^^^^^^^
