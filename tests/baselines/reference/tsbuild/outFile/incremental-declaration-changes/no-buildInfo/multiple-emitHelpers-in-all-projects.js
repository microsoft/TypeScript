...
5 >Emitted(59, 22) Source(5, 24) + SourceIndex(0)
6 >Emitted(59, 23) Source(5, 25) + SourceIndex(0)
---
>>>console.log(s);
1 >
2 >^^^^^^^
...
8 >               )
9 >                ;
1->Emitted(64, 1) Source(1, 1) + SourceIndex(1)
2 >Emitted(64, 8) Source(1, 8) + SourceIndex(1)
3 >Emitted(64, 9) Source(1, 9) + SourceIndex(1)
4 >Emitted(64, 12) Source(1, 12) + SourceIndex(1)
5 >Emitted(64, 13) Source(1, 13) + SourceIndex(1)
6 >Emitted(64, 14) Source(1, 14) + SourceIndex(1)
7 >Emitted(64, 16) Source(1, 16) + SourceIndex(1)
8 >Emitted(64, 17) Source(1, 17) + SourceIndex(1)
9 >Emitted(64, 18) Source(1, 18) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../first/first_part3.ts
...
2 >function 
3 >         f
1 >Emitted(65, 1) Source(1, 1) + SourceIndex(2)
2 >Emitted(65, 10) Source(1, 10) + SourceIndex(2)
3 >Emitted(65, 11) Source(1, 11) + SourceIndex(2)
---
>>>    return "JS does hoists";
1->^^^^
2 >    ^^^^^^^
...
3 >           "JS does hoists"
4 >                           ;
1->Emitted(66, 5) Source(2, 5) + SourceIndex(2)
2 >Emitted(66, 12) Source(2, 12) + SourceIndex(2)
3 >Emitted(66, 28) Source(2, 28) + SourceIndex(2)
4 >Emitted(66, 29) Source(2, 29) + SourceIndex(2)
---
>>>}
1 >
2 >^
...
1 >
  >
2 >}
1 >Emitted(67, 1) Source(3, 1) + SourceIndex(2)
2 >Emitted(67, 2) Source(3, 2) + SourceIndex(2)
---
>>>function firstfirst_part3Spread() {
1->
2 >^^^^^^^^^
...
2 >function 
3 >         firstfirst_part3Spread
1->Emitted(68, 1) Source(4, 1) + SourceIndex(2)
2 >Emitted(68, 10) Source(4, 10) + SourceIndex(2)
3 >Emitted(68, 32) Source(4, 32) + SourceIndex(2)
---
>>>    var b = [];
1 >^^^^
2 >    ^^^^^^^^^^^
...
1 >(
2 >    ...b: number[]
1 >Emitted(69, 5) Source(4, 33) + SourceIndex(2)
2 >Emitted(69, 16) Source(4, 47) + SourceIndex(2)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
5 >                                          
6 >                                            ...b: number[]
1->Emitted(70, 10) Source(4, 33) + SourceIndex(2)
2 >Emitted(70, 20) Source(4, 47) + SourceIndex(2)
3 >Emitted(70, 22) Source(4, 33) + SourceIndex(2)
4 >Emitted(70, 43) Source(4, 47) + SourceIndex(2)
5 >Emitted(70, 45) Source(4, 33) + SourceIndex(2)
6 >Emitted(70, 49) Source(4, 47) + SourceIndex(2)
---
>>>        b[_i] = arguments[_i];
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
1 >
2 >        ...b: number[]
1 >Emitted(71, 9) Source(4, 33) + SourceIndex(2)
2 >Emitted(71, 31) Source(4, 47) + SourceIndex(2)
---
>>>    }
>>>}
1 >
...
1 >) { 
2 >}
1 >Emitted(73, 1) Source(4, 51) + SourceIndex(2)
2 >Emitted(73, 2) Source(4, 52) + SourceIndex(2)
---
>>>firstfirst_part3Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^
...
10>                                                         ]
11>                                                          );
1->Emitted(74, 1) Source(5, 1) + SourceIndex(2)
2 >Emitted(74, 23) Source(5, 23) + SourceIndex(2)
3 >Emitted(74, 47) Source(5, 27) + SourceIndex(2)
4 >Emitted(74, 48) Source(5, 28) + SourceIndex(2)
5 >Emitted(74, 50) Source(5, 30) + SourceIndex(2)
6 >Emitted(74, 52) Source(5, 32) + SourceIndex(2)
7 >Emitted(74, 54) Source(5, 34) + SourceIndex(2)
8 >Emitted(74, 56) Source(5, 36) + SourceIndex(2)
9 >Emitted(74, 58) Source(5, 38) + SourceIndex(2)
10>Emitted(74, 59) Source(5, 39) + SourceIndex(2)
11>Emitted(74, 62) Source(5, 41) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part1.ts
...
4 >      {
  ...
  >         f();
  >     }
1 >Emitted(105, 1) Source(5, 1) + SourceIndex(3)
2 >Emitted(105, 5) Source(5, 11) + SourceIndex(3)
3 >Emitted(105, 6) Source(5, 12) + SourceIndex(3)
4 >Emitted(105, 7) Source(11, 2) + SourceIndex(3)
---
>>>(function (N) {
1->
2 >^^^^^^^^^^^
...
2 >Emitted(106, 12) Source(5, 11) + SourceIndex(3)
3 >Emitted(106, 13) Source(5, 12) + SourceIndex(3)
---
>>>    function f() {
1->^^^^
2 >    ^^^^^^^^^
...
2 >    function 
3 >             f
1->Emitted(107, 5) Source(6, 5) + SourceIndex(3)
2 >Emitted(107, 14) Source(6, 14) + SourceIndex(3)
3 >Emitted(107, 15) Source(6, 15) + SourceIndex(3)
---
>>>        console.log('testing');
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                             )
8 >                              ;
1->Emitted(108, 9) Source(7, 9) + SourceIndex(3)
2 >Emitted(108, 16) Source(7, 16) + SourceIndex(3)
3 >Emitted(108, 17) Source(7, 17) + SourceIndex(3)
4 >Emitted(108, 20) Source(7, 20) + SourceIndex(3)
5 >Emitted(108, 21) Source(7, 21) + SourceIndex(3)
6 >Emitted(108, 30) Source(7, 30) + SourceIndex(3)
7 >Emitted(108, 31) Source(7, 31) + SourceIndex(3)
8 >Emitted(108, 32) Source(7, 32) + SourceIndex(3)
---
>>>    }
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(109, 5) Source(8, 5) + SourceIndex(3)
2 >Emitted(109, 6) Source(8, 6) + SourceIndex(3)
---
>>>    f();
1->^^^^
2 >    ^
...
3 >     ()
4 >       ;
1->Emitted(110, 5) Source(10, 5) + SourceIndex(3)
2 >Emitted(110, 6) Source(10, 6) + SourceIndex(3)
3 >Emitted(110, 8) Source(10, 8) + SourceIndex(3)
4 >Emitted(110, 9) Source(10, 9) + SourceIndex(3)
---
>>>})(N || (N = {}));
1->
2 >^
...
7 >           {
  ...
  >              f();
  >          }
1->Emitted(111, 1) Source(11, 1) + SourceIndex(3)
2 >Emitted(111, 2) Source(11, 2) + SourceIndex(3)
3 >Emitted(111, 4) Source(5, 11) + SourceIndex(3)
4 >Emitted(111, 5) Source(5, 12) + SourceIndex(3)
5 >Emitted(111, 10) Source(5, 11) + SourceIndex(3)
6 >Emitted(111, 11) Source(5, 12) + SourceIndex(3)
7 >Emitted(111, 19) Source(11, 2) + SourceIndex(3)
---
>>>function forsecondsecond_part1Rest() {
1->
2 >^^^^^^^^^
...
2 >function 
3 >         forsecondsecond_part1Rest
1->Emitted(112, 1) Source(12, 1) + SourceIndex(3)
2 >Emitted(112, 10) Source(12, 10) + SourceIndex(3)
3 >Emitted(112, 35) Source(12, 35) + SourceIndex(3)
---
>>>    var _a = { a: 10, b: 30, yy: 30 }, b = _a.b, rest = __rest(_a, ["b"]);
1->^^^^
2 >    ^^^^
...
7 >                                                 ...rest } = { a: 10, b: 30, yy: 30 }
8 >                                                                         ;
1->Emitted(113, 5) Source(13, 1) + SourceIndex(3)
2 >Emitted(113, 9) Source(13, 7) + SourceIndex(3)
3 >Emitted(113, 38) Source(13, 48) + SourceIndex(3)
4 >Emitted(113, 40) Source(13, 9) + SourceIndex(3)
5 >Emitted(113, 48) Source(13, 10) + SourceIndex(3)
6 >Emitted(113, 50) Source(13, 12) + SourceIndex(3)
7 >Emitted(113, 74) Source(13, 48) + SourceIndex(3)
8 >Emitted(113, 75) Source(13, 49) + SourceIndex(3)
---
>>>}
1 >
2 >^
...
1 >
  >
2 >}
1 >Emitted(114, 1) Source(14, 1) + SourceIndex(3)
2 >Emitted(114, 2) Source(14, 2) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
2 >^^^^^^^^^^^^^^^^^^^->
1->
1->Emitted(115, 1) Source(1, 1) + SourceIndex(4)
---
>>>    function C() {
1->^^^^
2 >    ^^->
1->
1->Emitted(116, 5) Source(1, 1) + SourceIndex(4)
---
>>>    }
1->^^^^
2 >    ^
...
1->class C {
  ...
  >
2 >    }
1->Emitted(117, 5) Source(5, 1) + SourceIndex(4)
2 >Emitted(117, 6) Source(5, 2) + SourceIndex(4)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(118, 5) Source(2, 5) + SourceIndex(4)
2 >Emitted(118, 28) Source(2, 16) + SourceIndex(4)
3 >Emitted(118, 31) Source(2, 5) + SourceIndex(4)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(119, 9) Source(3, 9) + SourceIndex(4)
2 >Emitted(119, 16) Source(3, 16) + SourceIndex(4)
3 >Emitted(119, 17) Source(3, 17) + SourceIndex(4)
4 >Emitted(119, 20) Source(3, 20) + SourceIndex(4)
5 >Emitted(119, 21) Source(3, 21) + SourceIndex(4)
6 >Emitted(119, 41) Source(3, 41) + SourceIndex(4)
7 >Emitted(119, 42) Source(3, 42) + SourceIndex(4)
8 >Emitted(119, 43) Source(3, 43) + SourceIndex(4)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(120, 5) Source(4, 5) + SourceIndex(4)
2 >Emitted(120, 6) Source(4, 6) + SourceIndex(4)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
1->
  >
2 >    }
1->Emitted(121, 5) Source(5, 1) + SourceIndex(4)
2 >Emitted(121, 13) Source(5, 2) + SourceIndex(4)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(122, 1) Source(5, 1) + SourceIndex(4)
2 >Emitted(122, 2) Source(5, 2) + SourceIndex(4)
3 >Emitted(122, 2) Source(1, 1) + SourceIndex(4)
4 >Emitted(122, 6) Source(5, 2) + SourceIndex(4)
---
>>>function secondsecond_part2Spread() {
1->
2 >^^^^^^^^^
...
2 >function 
3 >         secondsecond_part2Spread
1->Emitted(123, 1) Source(7, 1) + SourceIndex(4)
2 >Emitted(123, 10) Source(7, 10) + SourceIndex(4)
3 >Emitted(123, 34) Source(7, 34) + SourceIndex(4)
---
>>>    var b = [];
1 >^^^^
2 >    ^^^^^^^^^^^
...
1 >(
2 >    ...b: number[]
1 >Emitted(124, 5) Source(7, 35) + SourceIndex(4)
2 >Emitted(124, 16) Source(7, 49) + SourceIndex(4)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
5 >                                          
6 >                                            ...b: number[]
1->Emitted(125, 10) Source(7, 35) + SourceIndex(4)
2 >Emitted(125, 20) Source(7, 49) + SourceIndex(4)
3 >Emitted(125, 22) Source(7, 35) + SourceIndex(4)
4 >Emitted(125, 43) Source(7, 49) + SourceIndex(4)
5 >Emitted(125, 45) Source(7, 35) + SourceIndex(4)
6 >Emitted(125, 49) Source(7, 49) + SourceIndex(4)
---
>>>        b[_i] = arguments[_i];
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
1 >
2 >        ...b: number[]
1 >Emitted(126, 9) Source(7, 35) + SourceIndex(4)
2 >Emitted(126, 31) Source(7, 49) + SourceIndex(4)
---
>>>    }
>>>}
1 >
...
1 >) { 
2 >}
1 >Emitted(128, 1) Source(7, 53) + SourceIndex(4)
2 >Emitted(128, 2) Source(7, 54) + SourceIndex(4)
---
>>>secondsecond_part2Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^^^
...
10>                                                           ]
11>                                                            );
1->Emitted(129, 1) Source(8, 1) + SourceIndex(4)
2 >Emitted(129, 25) Source(8, 25) + SourceIndex(4)
3 >Emitted(129, 49) Source(8, 29) + SourceIndex(4)
4 >Emitted(129, 50) Source(8, 30) + SourceIndex(4)
5 >Emitted(129, 52) Source(8, 32) + SourceIndex(4)
6 >Emitted(129, 54) Source(8, 34) + SourceIndex(4)
7 >Emitted(129, 56) Source(8, 36) + SourceIndex(4)
8 >Emitted(129, 58) Source(8, 38) + SourceIndex(4)
9 >Emitted(129, 60) Source(8, 40) + SourceIndex(4)
10>Emitted(129, 61) Source(8, 41) + SourceIndex(4)
11>Emitted(129, 64) Source(8, 43) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../third_part1.ts
...
7 >             ()
8 >               ;
1 >Emitted(131, 1) Source(1, 1) + SourceIndex(5)
2 >Emitted(131, 5) Source(1, 5) + SourceIndex(5)
3 >Emitted(131, 6) Source(1, 6) + SourceIndex(5)
4 >Emitted(131, 9) Source(1, 9) + SourceIndex(5)
5 >Emitted(131, 13) Source(1, 13) + SourceIndex(5)
6 >Emitted(131, 14) Source(1, 14) + SourceIndex(5)
7 >Emitted(131, 16) Source(1, 16) + SourceIndex(5)
8 >Emitted(131, 17) Source(1, 17) + SourceIndex(5)
---
>>>c.doSomething();
1->
2 >^
...
5 >             ()
6 >               ;
1->Emitted(132, 1) Source(2, 1) + SourceIndex(5)
2 >Emitted(132, 2) Source(2, 2) + SourceIndex(5)
3 >Emitted(132, 3) Source(2, 3) + SourceIndex(5)
4 >Emitted(132, 14) Source(2, 14) + SourceIndex(5)
5 >Emitted(132, 16) Source(2, 16) + SourceIndex(5)
6 >Emitted(132, 17) Source(2, 17) + SourceIndex(5)
---
>>>function forthirdthird_part1Rest() {
1->
2 >^^^^^^^^^
...
2 >function 
3 >         forthirdthird_part1Rest
1->Emitted(133, 1) Source(3, 1) + SourceIndex(5)
2 >Emitted(133, 10) Source(3, 10) + SourceIndex(5)
3 >Emitted(133, 33) Source(3, 33) + SourceIndex(5)
---
>>>    var _a = { a: 10, b: 30, yy: 30 }, b = _a.b, rest = __rest(_a, ["b"]);
1->^^^^
2 >    ^^^^
...
7 >                                                 ...rest } = { a: 10, b: 30, yy: 30 }
8 >                                                                         ;
1->Emitted(134, 5) Source(4, 1) + SourceIndex(5)
2 >Emitted(134, 9) Source(4, 7) + SourceIndex(5)
3 >Emitted(134, 38) Source(4, 48) + SourceIndex(5)
4 >Emitted(134, 40) Source(4, 9) + SourceIndex(5)
5 >Emitted(134, 48) Source(4, 10) + SourceIndex(5)
6 >Emitted(134, 50) Source(4, 12) + SourceIndex(5)
7 >Emitted(134, 74) Source(4, 48) + SourceIndex(5)
8 >Emitted(134, 75) Source(4, 49) + SourceIndex(5)
---
>>>}
1 >
2 >^
...
1 >
  >
2 >}
1 >Emitted(135, 1) Source(5, 1) + SourceIndex(5)
2 >Emitted(135, 2) Source(5, 2) + SourceIndex(5)
---
>>>function thirdthird_part1Spread() {
1->
2 >^^^^^^^^^
...
2 >function 
3 >         thirdthird_part1Spread
1->Emitted(136, 1) Source(6, 1) + SourceIndex(5)
2 >Emitted(136, 10) Source(6, 10) + SourceIndex(5)
3 >Emitted(136, 32) Source(6, 32) + SourceIndex(5)
---
>>>    var b = [];
1 >^^^^
2 >    ^^^^^^^^^^^
...
1 >(
2 >    ...b: number[]
1 >Emitted(137, 5) Source(6, 33) + SourceIndex(5)
2 >Emitted(137, 16) Source(6, 47) + SourceIndex(5)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
5 >                                          
6 >                                            ...b: number[]
1->Emitted(138, 10) Source(6, 33) + SourceIndex(5)
2 >Emitted(138, 20) Source(6, 47) + SourceIndex(5)
3 >Emitted(138, 22) Source(6, 33) + SourceIndex(5)
4 >Emitted(138, 43) Source(6, 47) + SourceIndex(5)
5 >Emitted(138, 45) Source(6, 33) + SourceIndex(5)
6 >Emitted(138, 49) Source(6, 47) + SourceIndex(5)
---
>>>        b[_i] = arguments[_i];
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
1 >
2 >        ...b: number[]
1 >Emitted(139, 9) Source(6, 33) + SourceIndex(5)
2 >Emitted(139, 31) Source(6, 47) + SourceIndex(5)
---
>>>    }
>>>}
1 >
...
1 >) { 
2 >}
1 >Emitted(141, 1) Source(6, 51) + SourceIndex(5)
2 >Emitted(141, 2) Source(6, 52) + SourceIndex(5)
---
>>>thirdthird_part1Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^
...
10>                                                         ]
11>                                                          );
1->Emitted(142, 1) Source(7, 1) + SourceIndex(5)
2 >Emitted(142, 23) Source(7, 23) + SourceIndex(5)
3 >Emitted(142, 47) Source(7, 27) + SourceIndex(5)
4 >Emitted(142, 48) Source(7, 28) + SourceIndex(5)
5 >Emitted(142, 50) Source(7, 30) + SourceIndex(5)
6 >Emitted(142, 52) Source(7, 32) + SourceIndex(5)
7 >Emitted(142, 54) Source(7, 34) + SourceIndex(5)
8 >Emitted(142, 56) Source(7, 36) + SourceIndex(5)
9 >Emitted(142, 58) Source(7, 38) + SourceIndex(5)
10>Emitted(142, 59) Source(7, 39) + SourceIndex(5)
11>Emitted(142, 62) Source(7, 41) + SourceIndex(5)
---
>>>//# sourceMappingURL=third-output.js.map
