...
2 >Emitted(12, 19) Source(2, 11) + SourceIndex(2)
3 >Emitted(12, 20) Source(2, 12) + SourceIndex(2)
4 >Emitted(12, 21) Source(2, 13) + SourceIndex(2)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^^^^^->
1 >{
  >    // Comment text
  >}
1 >Emitted(13, 2) Source(4, 2) + SourceIndex(2)
---
>>>declare namespace N {
1->
2 >^^^^^^^^^^^^^^^^^^
...
3 >                  N
4 >                    
1->Emitted(14, 1) Source(6, 1) + SourceIndex(2)
2 >Emitted(14, 19) Source(6, 11) + SourceIndex(2)
3 >Emitted(14, 20) Source(6, 12) + SourceIndex(2)
4 >Emitted(14, 21) Source(6, 13) + SourceIndex(2)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^->
1 >{
  ...
  >    f();
  >}
1 >Emitted(15, 2) Source(12, 2) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.d.ts
