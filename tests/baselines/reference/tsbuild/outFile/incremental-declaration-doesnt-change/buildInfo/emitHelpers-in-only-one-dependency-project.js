...
1->
  >
  >
1->Emitted(29, 1) Source(13, 1) + SourceIndex(3)
---
>>>    function second1() {
1->^^^^
2 >    ^^->
...
2 >Emitted(31, 6) Source(13, 18) + SourceIndex(3)
---
>>>    return second1;
1->^^^^
2 >    ^^^^^^^^^^^^^^
1->
2 >    }
1->Emitted(32, 5) Source(13, 17) + SourceIndex(3)
2 >Emitted(32, 19) Source(13, 18) + SourceIndex(3)
---
>>>}());
1 >
2 >^
...
3 > 
4 > class second1 { }
1 >Emitted(33, 1) Source(13, 17) + SourceIndex(3)
2 >Emitted(33, 2) Source(13, 18) + SourceIndex(3)
3 >Emitted(33, 2) Source(13, 1) + SourceIndex(3)
4 >Emitted(33, 6) Source(13, 18) + SourceIndex(3)
---
>>>var second2 = (function (_super) {
1->
2 >^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^->
...
1->class second2 extends 
2 >    second1
1->Emitted(35, 5) Source(14, 23) + SourceIndex(3)
2 >Emitted(35, 32) Source(14, 30) + SourceIndex(3)
---
>>>    function second2() {
1 >^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^->
1 >
1 >Emitted(36, 5) Source(14, 1) + SourceIndex(3)
---
>>>        return _super !== null && _super.apply(this, arguments) || this;
>>>    }
1->^^^^
...
2 >Emitted(38, 6) Source(14, 34) + SourceIndex(3)
---
>>>    return second2;
1->^^^^
2 >    ^^^^^^^^^^^^^^
1->
2 >    }
1->Emitted(39, 5) Source(14, 33) + SourceIndex(3)
2 >Emitted(39, 19) Source(14, 34) + SourceIndex(3)
---
>>>}(second1));
1 >
2 >^
...
5 >  second1
6 >          { }
1 >Emitted(40, 1) Source(14, 33) + SourceIndex(3)
2 >Emitted(40, 2) Source(14, 34) + SourceIndex(3)
3 >Emitted(40, 2) Source(14, 1) + SourceIndex(3)
4 >Emitted(40, 3) Source(14, 23) + SourceIndex(3)
5 >Emitted(40, 10) Source(14, 30) + SourceIndex(3)
6 >Emitted(40, 13) Source(14, 34) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
2 >^^^^^^^^^^^^^^^^^^^->
1->
1->Emitted(41, 1) Source(1, 1) + SourceIndex(4)
---
>>>    function C() {
1->^^^^
2 >    ^^->
1->
1->Emitted(42, 5) Source(1, 1) + SourceIndex(4)
---
>>>    }
1->^^^^
2 >    ^
...
1->class C {
  ...
  >
2 >    }
1->Emitted(43, 5) Source(5, 1) + SourceIndex(4)
2 >Emitted(43, 6) Source(5, 2) + SourceIndex(4)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(44, 5) Source(2, 5) + SourceIndex(4)
2 >Emitted(44, 28) Source(2, 16) + SourceIndex(4)
3 >Emitted(44, 31) Source(2, 5) + SourceIndex(4)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(45, 9) Source(3, 9) + SourceIndex(4)
2 >Emitted(45, 16) Source(3, 16) + SourceIndex(4)
3 >Emitted(45, 17) Source(3, 17) + SourceIndex(4)
4 >Emitted(45, 20) Source(3, 20) + SourceIndex(4)
5 >Emitted(45, 21) Source(3, 21) + SourceIndex(4)
6 >Emitted(45, 41) Source(3, 41) + SourceIndex(4)
7 >Emitted(45, 42) Source(3, 42) + SourceIndex(4)
8 >Emitted(45, 43) Source(3, 43) + SourceIndex(4)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(46, 5) Source(4, 5) + SourceIndex(4)
2 >Emitted(46, 6) Source(4, 6) + SourceIndex(4)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
1->
  >
2 >    }
1->Emitted(47, 5) Source(5, 1) + SourceIndex(4)
2 >Emitted(47, 13) Source(5, 2) + SourceIndex(4)
---
>>>}());
1 >
2 >^
...
2 >Emitted(48, 2) Source(5, 2) + SourceIndex(4)
3 >Emitted(48, 2) Source(1, 1) + SourceIndex(4)
4 >Emitted(48, 6) Source(5, 2) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../third_part1.ts
...
7 >             ()
8 >               ;
1->Emitted(50, 1) Source(1, 1) + SourceIndex(5)
2 >Emitted(50, 5) Source(1, 5) + SourceIndex(5)
3 >Emitted(50, 6) Source(1, 6) + SourceIndex(5)
4 >Emitted(50, 9) Source(1, 9) + SourceIndex(5)
5 >Emitted(50, 13) Source(1, 13) + SourceIndex(5)
6 >Emitted(50, 14) Source(1, 14) + SourceIndex(5)
7 >Emitted(50, 16) Source(1, 16) + SourceIndex(5)
8 >Emitted(50, 17) Source(1, 17) + SourceIndex(5)
---
>>>c.doSomething();
1->
2 >^
...
5 >             ()
6 >               ;
1->Emitted(51, 1) Source(2, 1) + SourceIndex(5)
2 >Emitted(51, 2) Source(2, 2) + SourceIndex(5)
3 >Emitted(51, 3) Source(2, 3) + SourceIndex(5)
4 >Emitted(51, 14) Source(2, 14) + SourceIndex(5)
5 >Emitted(51, 16) Source(2, 16) + SourceIndex(5)
6 >Emitted(51, 17) Source(2, 17) + SourceIndex(5)
---
>>>//# sourceMappingURL=third-output.js.map
