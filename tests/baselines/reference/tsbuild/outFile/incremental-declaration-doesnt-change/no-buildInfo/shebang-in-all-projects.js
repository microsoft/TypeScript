...
2 >Emitted(3, 11) Source(2, 11) + SourceIndex(0)
3 >Emitted(3, 19) Source(2, 19) + SourceIndex(0)
---
>>>    none: any;
1 >^^^^
2 >    ^^^^
...
2 >Emitted(4, 9) Source(3, 9) + SourceIndex(0)
3 >Emitted(4, 11) Source(3, 11) + SourceIndex(0)
4 >Emitted(4, 14) Source(3, 14) + SourceIndex(0)
5 >Emitted(4, 15) Source(3, 15) + SourceIndex(0)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^->
...
2 >Emitted(6, 9) Source(6, 1) + SourceIndex(0)
3 >Emitted(6, 15) Source(6, 7) + SourceIndex(0)
4 >Emitted(6, 16) Source(6, 8) + SourceIndex(0)
5 >Emitted(6, 33) Source(6, 25) + SourceIndex(0)
6 >Emitted(6, 34) Source(6, 26) + SourceIndex(0)
---
>>>interface NoJsForHereEither {
1 >
2 >^^^^^^^^^^
...
2 >Emitted(7, 11) Source(8, 11) + SourceIndex(0)
3 >Emitted(7, 28) Source(8, 28) + SourceIndex(0)
---
>>>    none: any;
1 >^^^^
2 >    ^^^^
...
2 >Emitted(8, 9) Source(9, 9) + SourceIndex(0)
3 >Emitted(8, 11) Source(9, 11) + SourceIndex(0)
4 >Emitted(8, 14) Source(9, 14) + SourceIndex(0)
5 >Emitted(8, 15) Source(9, 15) + SourceIndex(0)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^->
...
2 >Emitted(10, 18) Source(1, 10) + SourceIndex(1)
3 >Emitted(10, 19) Source(1, 11) + SourceIndex(1)
4 >Emitted(10, 30) Source(3, 2) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.d.ts
sourceFile:../../../second/second_part1.ts
...
3 >                  N
4 >                    
1->Emitted(13, 1) Source(2, 1) + SourceIndex(2)
2 >Emitted(13, 19) Source(2, 11) + SourceIndex(2)
3 >Emitted(13, 20) Source(2, 12) + SourceIndex(2)
4 >Emitted(13, 21) Source(2, 13) + SourceIndex(2)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^^^^^->
1 >{
  >    // Comment text
  >}
1 >Emitted(14, 2) Source(4, 2) + SourceIndex(2)
---
>>>declare namespace N {
1->
2 >^^^^^^^^^^^^^^^^^^
...
3 >                  N
4 >                    
1->Emitted(15, 1) Source(6, 1) + SourceIndex(2)
2 >Emitted(15, 19) Source(6, 11) + SourceIndex(2)
3 >Emitted(15, 20) Source(6, 12) + SourceIndex(2)
4 >Emitted(15, 21) Source(6, 13) + SourceIndex(2)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^->
1 >{
  ...
  >    f();
  >}
1 >Emitted(16, 2) Source(12, 2) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.d.ts
sourceFile:../../../second/second_part2.ts
...
5 >              = new C()
6 >                ;
1->Emitted(21, 1) Source(2, 1) + SourceIndex(4)
2 >Emitted(21, 9) Source(2, 1) + SourceIndex(4)
3 >Emitted(21, 13) Source(2, 5) + SourceIndex(4)
4 >Emitted(21, 14) Source(2, 6) + SourceIndex(4)
5 >Emitted(21, 17) Source(2, 16) + SourceIndex(4)
6 >Emitted(21, 18) Source(2, 17) + SourceIndex(4)
---
>>>//# sourceMappingURL=third-output.d.ts.map
