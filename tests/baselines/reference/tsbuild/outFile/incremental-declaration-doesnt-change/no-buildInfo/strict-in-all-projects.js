...
{"version":3,"file":"third-output.js","sourceRoot":"","sources":["../../third_part1.ts","../../../first/first_PART1.ts","../../../first/first_part2.ts","../../../first/first_part3.ts","../../../second/second_part1.ts","../../../second/second_part2.ts"],"names":[],"mappings":";;ACIA,IAAM,CAAC,GAAG,cAAc,CAAC;AAMzB,OAAO,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC;AACf,OAAO,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC;ACXf,OAAO,CAAC,GAAG,CAAC,CAAC,EAAE,CAAC,CAAC;ACAjB,SAAS,CAAC;IACN,OAAO,gBAAgB,CAAC;AAC5B,CAAC;;;ACED,IAAU,CAAC,CAMV;AAND,WAAU,CAAC;IACP,SAAS,CAAC;QACN,OAAO,CAAC,GAAG,CAAC,SAAS,CAAC,CAAC;IAC3B,CAAC;IAED,CAAC,EAAE,CAAC;AACR,CAAC,EANS,CAAC,KAAD,CAAC,QAMV;ACVD;IAAA;IAIA,CAAC;IAHG,uBAAW,GAAX;QACI,OAAO,CAAC,GAAG,CAAC,oBAAoB,CAAC,CAAC;IACtC,CAAC;IACL,QAAC;AAAD,CAAC,AAJD,IAIC;;ALJD,IAAI,CAAC,GAAG,IAAI,CAAC,EAAE,CAAC;AAChB,CAAC,CAAC,WAAW,EAAE,CAAC"}
...
5 >        "Hello, world"
6 >                      ;
1 >Emitted(3, 1) Source(5, 1) + SourceIndex(1)
2 >Emitted(3, 5) Source(5, 7) + SourceIndex(1)
3 >Emitted(3, 6) Source(5, 8) + SourceIndex(1)
4 >Emitted(3, 9) Source(5, 11) + SourceIndex(1)
5 >Emitted(3, 23) Source(5, 25) + SourceIndex(1)
6 >Emitted(3, 24) Source(5, 26) + SourceIndex(1)
---
>>>console.log(s);
1 >
2 >^^^^^^^
...
7 >             )
8 >              ;
1 >Emitted(4, 1) Source(11, 1) + SourceIndex(1)
2 >Emitted(4, 8) Source(11, 8) + SourceIndex(1)
3 >Emitted(4, 9) Source(11, 9) + SourceIndex(1)
4 >Emitted(4, 12) Source(11, 12) + SourceIndex(1)
5 >Emitted(4, 13) Source(11, 13) + SourceIndex(1)
6 >Emitted(4, 14) Source(11, 14) + SourceIndex(1)
7 >Emitted(4, 15) Source(11, 15) + SourceIndex(1)
8 >Emitted(4, 16) Source(11, 16) + SourceIndex(1)
---
>>>console.log(s);
1->
2 >^^^^^^^
...
7 >             )
8 >              ;
1->Emitted(5, 1) Source(12, 1) + SourceIndex(1)
2 >Emitted(5, 8) Source(12, 8) + SourceIndex(1)
3 >Emitted(5, 9) Source(12, 9) + SourceIndex(1)
4 >Emitted(5, 12) Source(12, 12) + SourceIndex(1)
5 >Emitted(5, 13) Source(12, 13) + SourceIndex(1)
6 >Emitted(5, 14) Source(12, 14) + SourceIndex(1)
7 >Emitted(5, 15) Source(12, 15) + SourceIndex(1)
8 >Emitted(5, 16) Source(12, 16) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
...
9 >                ;
1->Emitted(6, 1) Source(1, 1) + SourceIndex(2)
2 >Emitted(6, 8) Source(1, 8) + SourceIndex(2)
3 >Emitted(6, 9) Source(1, 9) + SourceIndex(2)
4 >Emitted(6, 12) Source(1, 12) + SourceIndex(2)
5 >Emitted(6, 13) Source(1, 13) + SourceIndex(2)
6 >Emitted(6, 14) Source(1, 14) + SourceIndex(2)
7 >Emitted(6, 16) Source(1, 16) + SourceIndex(2)
8 >Emitted(6, 17) Source(1, 17) + SourceIndex(2)
9 >Emitted(6, 18) Source(1, 18) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../first/first_part3.ts
...
2 >Emitted(7, 10) Source(1, 10) + SourceIndex(3)
3 >Emitted(7, 11) Source(1, 11) + SourceIndex(3)
---
>>>    return "JS does hoists";
1->^^^^
2 >    ^^^^^^^
...
3 >           "JS does hoists"
4 >                           ;
1->Emitted(8, 5) Source(2, 5) + SourceIndex(3)
2 >Emitted(8, 12) Source(2, 12) + SourceIndex(3)
3 >Emitted(8, 28) Source(2, 28) + SourceIndex(3)
4 >Emitted(8, 29) Source(2, 29) + SourceIndex(3)
---
>>>}
1 >
2 >^
...
1 >
  >
2 >}
1 >Emitted(9, 1) Source(3, 1) + SourceIndex(3)
2 >Emitted(9, 2) Source(3, 2) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part1.ts
...
4 >      {
  ...
  >         f();
  >     }
1->Emitted(12, 1) Source(5, 1) + SourceIndex(4)
2 >Emitted(12, 5) Source(5, 11) + SourceIndex(4)
3 >Emitted(12, 6) Source(5, 12) + SourceIndex(4)
4 >Emitted(12, 7) Source(11, 2) + SourceIndex(4)
---
>>>(function (N) {
1->
2 >^^^^^^^^^^^
...
2 >namespace 
3 >           N
1->Emitted(13, 1) Source(5, 1) + SourceIndex(4)
2 >Emitted(13, 12) Source(5, 11) + SourceIndex(4)
3 >Emitted(13, 13) Source(5, 12) + SourceIndex(4)
---
>>>    function f() {
1->^^^^
2 >    ^^^^^^^^^
...
2 >    function 
3 >             f
1->Emitted(14, 5) Source(6, 5) + SourceIndex(4)
2 >Emitted(14, 14) Source(6, 14) + SourceIndex(4)
3 >Emitted(14, 15) Source(6, 15) + SourceIndex(4)
---
>>>        console.log('testing');
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                             )
8 >                              ;
1->Emitted(15, 9) Source(7, 9) + SourceIndex(4)
2 >Emitted(15, 16) Source(7, 16) + SourceIndex(4)
3 >Emitted(15, 17) Source(7, 17) + SourceIndex(4)
4 >Emitted(15, 20) Source(7, 20) + SourceIndex(4)
5 >Emitted(15, 21) Source(7, 21) + SourceIndex(4)
6 >Emitted(15, 30) Source(7, 30) + SourceIndex(4)
7 >Emitted(15, 31) Source(7, 31) + SourceIndex(4)
8 >Emitted(15, 32) Source(7, 32) + SourceIndex(4)
---
>>>    }
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(16, 5) Source(8, 5) + SourceIndex(4)
2 >Emitted(16, 6) Source(8, 6) + SourceIndex(4)
---
>>>    f();
1->^^^^
2 >    ^
...
3 >     ()
4 >       ;
1->Emitted(17, 5) Source(10, 5) + SourceIndex(4)
2 >Emitted(17, 6) Source(10, 6) + SourceIndex(4)
3 >Emitted(17, 8) Source(10, 8) + SourceIndex(4)
4 >Emitted(17, 9) Source(10, 9) + SourceIndex(4)
---
>>>})(N || (N = {}));
1->
2 >^
...
7 >           {
  ...
  >              f();
  >          }
1->Emitted(18, 1) Source(11, 1) + SourceIndex(4)
2 >Emitted(18, 2) Source(11, 2) + SourceIndex(4)
3 >Emitted(18, 4) Source(5, 11) + SourceIndex(4)
4 >Emitted(18, 5) Source(5, 12) + SourceIndex(4)
5 >Emitted(18, 10) Source(5, 11) + SourceIndex(4)
6 >Emitted(18, 11) Source(5, 12) + SourceIndex(4)
7 >Emitted(18, 19) Source(11, 2) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
2 >Emitted(21, 6) Source(5, 2) + SourceIndex(5)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(22, 5) Source(2, 5) + SourceIndex(5)
2 >Emitted(22, 28) Source(2, 16) + SourceIndex(5)
3 >Emitted(22, 31) Source(2, 5) + SourceIndex(5)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(23, 9) Source(3, 9) + SourceIndex(5)
2 >Emitted(23, 16) Source(3, 16) + SourceIndex(5)
3 >Emitted(23, 17) Source(3, 17) + SourceIndex(5)
4 >Emitted(23, 20) Source(3, 20) + SourceIndex(5)
5 >Emitted(23, 21) Source(3, 21) + SourceIndex(5)
6 >Emitted(23, 41) Source(3, 41) + SourceIndex(5)
7 >Emitted(23, 42) Source(3, 42) + SourceIndex(5)
8 >Emitted(23, 43) Source(3, 43) + SourceIndex(5)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(24, 5) Source(4, 5) + SourceIndex(5)
2 >Emitted(24, 6) Source(4, 6) + SourceIndex(5)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
1->
  >
2 >    }
1->Emitted(25, 5) Source(5, 1) + SourceIndex(5)
2 >Emitted(25, 13) Source(5, 2) + SourceIndex(5)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(26, 1) Source(5, 1) + SourceIndex(5)
2 >Emitted(26, 2) Source(5, 2) + SourceIndex(5)
3 >Emitted(26, 2) Source(1, 1) + SourceIndex(5)
4 >Emitted(26, 6) Source(5, 2) + SourceIndex(5)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../third_part1.ts
...
7 >             ()
8 >               ;
1->Emitted(28, 1) Source(1, 1) + SourceIndex(0)
2 >Emitted(28, 5) Source(1, 5) + SourceIndex(0)
3 >Emitted(28, 6) Source(1, 6) + SourceIndex(0)
4 >Emitted(28, 9) Source(1, 9) + SourceIndex(0)
5 >Emitted(28, 13) Source(1, 13) + SourceIndex(0)
6 >Emitted(28, 14) Source(1, 14) + SourceIndex(0)
7 >Emitted(28, 16) Source(1, 16) + SourceIndex(0)
8 >Emitted(28, 17) Source(1, 17) + SourceIndex(0)
---
>>>c.doSomething();
1->
2 >^
...
5 >             ()
6 >               ;
1->Emitted(29, 1) Source(2, 1) + SourceIndex(0)
2 >Emitted(29, 2) Source(2, 2) + SourceIndex(0)
3 >Emitted(29, 3) Source(2, 3) + SourceIndex(0)
4 >Emitted(29, 14) Source(2, 14) + SourceIndex(0)
5 >Emitted(29, 16) Source(2, 16) + SourceIndex(0)
6 >Emitted(29, 17) Source(2, 17) + SourceIndex(0)
---
>>>//# sourceMappingURL=third-output.js.map
