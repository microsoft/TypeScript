...
2 >Emitted(27, 5) Source(5, 11) + SourceIndex(3)
3 >Emitted(27, 6) Source(5, 12) + SourceIndex(3)
4 >Emitted(27, 7) Source(11, 2) + SourceIndex(3)
---
>>>(function (N) {
1->
2 >^^^^^^^^^^^
...
2 >Emitted(28, 12) Source(5, 11) + SourceIndex(3)
3 >Emitted(28, 13) Source(5, 12) + SourceIndex(3)
---
>>>    function f() {
1->^^^^
2 >    ^^^^^^^^^
...
2 >    function 
3 >             f
1->Emitted(29, 5) Source(6, 5) + SourceIndex(3)
2 >Emitted(29, 14) Source(6, 14) + SourceIndex(3)
3 >Emitted(29, 15) Source(6, 15) + SourceIndex(3)
---
>>>        console.log('testing');
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                             )
8 >                              ;
1->Emitted(30, 9) Source(7, 9) + SourceIndex(3)
2 >Emitted(30, 16) Source(7, 16) + SourceIndex(3)
3 >Emitted(30, 17) Source(7, 17) + SourceIndex(3)
4 >Emitted(30, 20) Source(7, 20) + SourceIndex(3)
5 >Emitted(30, 21) Source(7, 21) + SourceIndex(3)
6 >Emitted(30, 30) Source(7, 30) + SourceIndex(3)
7 >Emitted(30, 31) Source(7, 31) + SourceIndex(3)
8 >Emitted(30, 32) Source(7, 32) + SourceIndex(3)
---
>>>    }
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(31, 5) Source(8, 5) + SourceIndex(3)
2 >Emitted(31, 6) Source(8, 6) + SourceIndex(3)
---
>>>    f();
1->^^^^
2 >    ^
...
3 >     ()
4 >       ;
1->Emitted(32, 5) Source(10, 5) + SourceIndex(3)
2 >Emitted(32, 6) Source(10, 6) + SourceIndex(3)
3 >Emitted(32, 8) Source(10, 8) + SourceIndex(3)
4 >Emitted(32, 9) Source(10, 9) + SourceIndex(3)
---
>>>})(N || (N = {}));
1->
2 >^
...
7 >           {
  ...
  >              f();
  >          }
1->Emitted(33, 1) Source(11, 1) + SourceIndex(3)
2 >Emitted(33, 2) Source(11, 2) + SourceIndex(3)
3 >Emitted(33, 4) Source(5, 11) + SourceIndex(3)
4 >Emitted(33, 5) Source(5, 12) + SourceIndex(3)
5 >Emitted(33, 10) Source(5, 11) + SourceIndex(3)
6 >Emitted(33, 11) Source(5, 12) + SourceIndex(3)
7 >Emitted(33, 19) Source(11, 2) + SourceIndex(3)
---
>>>function forsecondsecond_part1Rest() {
1->
2 >^^^^^^^^^
...
2 >function 
3 >         forsecondsecond_part1Rest
1->Emitted(34, 1) Source(12, 1) + SourceIndex(3)
2 >Emitted(34, 10) Source(12, 10) + SourceIndex(3)
3 >Emitted(34, 35) Source(12, 35) + SourceIndex(3)
---
>>>    var _a = { a: 10, b: 30, yy: 30 }, b = _a.b, rest = __rest(_a, ["b"]);
1->^^^^
2 >    ^^^^
...
8 >                                                                         ;
1->Emitted(35, 5) Source(13, 1) + SourceIndex(3)
2 >Emitted(35, 9) Source(13, 7) + SourceIndex(3)
3 >Emitted(35, 38) Source(13, 48) + SourceIndex(3)
4 >Emitted(35, 40) Source(13, 9) + SourceIndex(3)
5 >Emitted(35, 48) Source(13, 10) + SourceIndex(3)
6 >Emitted(35, 50) Source(13, 12) + SourceIndex(3)
7 >Emitted(35, 74) Source(13, 48) + SourceIndex(3)
8 >Emitted(35, 75) Source(13, 49) + SourceIndex(3)
---
>>>}
1 >
2 >^
...
1 >
  >
2 >}
1 >Emitted(36, 1) Source(14, 1) + SourceIndex(3)
2 >Emitted(36, 2) Source(14, 2) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
2 >^^^^^^^^^^^^^^^^^^^->
1->
1->Emitted(37, 1) Source(1, 1) + SourceIndex(4)
---
>>>    function C() {
1->^^^^
2 >    ^^->
1->
1->Emitted(38, 5) Source(1, 1) + SourceIndex(4)
---
>>>    }
1->^^^^
2 >    ^
...
2 >Emitted(39, 6) Source(5, 2) + SourceIndex(4)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(40, 5) Source(2, 5) + SourceIndex(4)
2 >Emitted(40, 28) Source(2, 16) + SourceIndex(4)
3 >Emitted(40, 31) Source(2, 5) + SourceIndex(4)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(41, 9) Source(3, 9) + SourceIndex(4)
2 >Emitted(41, 16) Source(3, 16) + SourceIndex(4)
3 >Emitted(41, 17) Source(3, 17) + SourceIndex(4)
4 >Emitted(41, 20) Source(3, 20) + SourceIndex(4)
5 >Emitted(41, 21) Source(3, 21) + SourceIndex(4)
6 >Emitted(41, 41) Source(3, 41) + SourceIndex(4)
7 >Emitted(41, 42) Source(3, 42) + SourceIndex(4)
8 >Emitted(41, 43) Source(3, 43) + SourceIndex(4)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(42, 5) Source(4, 5) + SourceIndex(4)
2 >Emitted(42, 6) Source(4, 6) + SourceIndex(4)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
...
2 >Emitted(43, 13) Source(5, 2) + SourceIndex(4)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(44, 1) Source(5, 1) + SourceIndex(4)
2 >Emitted(44, 2) Source(5, 2) + SourceIndex(4)
3 >Emitted(44, 2) Source(1, 1) + SourceIndex(4)
4 >Emitted(44, 6) Source(5, 2) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../third_part1.ts
...
2 >Emitted(46, 5) Source(1, 5) + SourceIndex(5)
3 >Emitted(46, 6) Source(1, 6) + SourceIndex(5)
4 >Emitted(46, 9) Source(1, 9) + SourceIndex(5)
5 >Emitted(46, 13) Source(1, 13) + SourceIndex(5)
6 >Emitted(46, 14) Source(1, 14) + SourceIndex(5)
7 >Emitted(46, 16) Source(1, 16) + SourceIndex(5)
8 >Emitted(46, 17) Source(1, 17) + SourceIndex(5)
---
>>>c.doSomething();
1->
2 >^
...
2 >Emitted(47, 2) Source(2, 2) + SourceIndex(5)
3 >Emitted(47, 3) Source(2, 3) + SourceIndex(5)
4 >Emitted(47, 14) Source(2, 14) + SourceIndex(5)
5 >Emitted(47, 16) Source(2, 16) + SourceIndex(5)
6 >Emitted(47, 17) Source(2, 17) + SourceIndex(5)
---
>>>function forthirdthird_part1Rest() {
1->
2 >^^^^^^^^^
...
2 >function 
3 >         forthirdthird_part1Rest
1->Emitted(48, 1) Source(3, 1) + SourceIndex(5)
2 >Emitted(48, 10) Source(3, 10) + SourceIndex(5)
3 >Emitted(48, 33) Source(3, 33) + SourceIndex(5)
---
>>>    var _a = { a: 10, b: 30, yy: 30 }, b = _a.b, rest = __rest(_a, ["b"]);
1->^^^^
2 >    ^^^^
...
7 >                                                 ...rest } = { a: 10, b: 30, yy: 30 }
8 >                                                                         ;
1->Emitted(49, 5) Source(4, 1) + SourceIndex(5)
2 >Emitted(49, 9) Source(4, 7) + SourceIndex(5)
3 >Emitted(49, 38) Source(4, 48) + SourceIndex(5)
4 >Emitted(49, 40) Source(4, 9) + SourceIndex(5)
5 >Emitted(49, 48) Source(4, 10) + SourceIndex(5)
6 >Emitted(49, 50) Source(4, 12) + SourceIndex(5)
7 >Emitted(49, 74) Source(4, 48) + SourceIndex(5)
8 >Emitted(49, 75) Source(4, 49) + SourceIndex(5)
---
>>>}
1 >
2 >^
...
1 >
  >
2 >}
1 >Emitted(50, 1) Source(5, 1) + SourceIndex(5)
2 >Emitted(50, 2) Source(5, 2) + SourceIndex(5)
---
>>>//# sourceMappingURL=third-output.js.map
