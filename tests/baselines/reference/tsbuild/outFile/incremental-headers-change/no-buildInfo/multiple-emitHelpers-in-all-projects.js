...
5 >        "Hello, world"
6 >                      ;
1 >Emitted(50, 1) Source(5, 1) + SourceIndex(0)
2 >Emitted(50, 5) Source(5, 7) + SourceIndex(0)
3 >Emitted(50, 6) Source(5, 8) + SourceIndex(0)
4 >Emitted(50, 9) Source(5, 11) + SourceIndex(0)
5 >Emitted(50, 23) Source(5, 25) + SourceIndex(0)
6 >Emitted(50, 24) Source(5, 26) + SourceIndex(0)
---
>>>console.log(s);
1 >
2 >^^^^^^^
...
7 >             )
8 >              ;
1 >Emitted(51, 1) Source(11, 1) + SourceIndex(0)
2 >Emitted(51, 8) Source(11, 8) + SourceIndex(0)
3 >Emitted(51, 9) Source(11, 9) + SourceIndex(0)
4 >Emitted(51, 12) Source(11, 12) + SourceIndex(0)
5 >Emitted(51, 13) Source(11, 13) + SourceIndex(0)
6 >Emitted(51, 14) Source(11, 14) + SourceIndex(0)
7 >Emitted(51, 15) Source(11, 15) + SourceIndex(0)
8 >Emitted(51, 16) Source(11, 16) + SourceIndex(0)
---
>>>function forfirstfirst_PART1Rest() { }
1->
2 >^^^^^^^^^
...
4 >                                () { 
5 >                                     }
1->Emitted(52, 1) Source(12, 1) + SourceIndex(0)
2 >Emitted(52, 10) Source(12, 10) + SourceIndex(0)
3 >Emitted(52, 33) Source(12, 33) + SourceIndex(0)
4 >Emitted(52, 38) Source(12, 38) + SourceIndex(0)
5 >Emitted(52, 39) Source(12, 39) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
...
2 >Emitted(53, 8) Source(1, 8) + SourceIndex(1)
3 >Emitted(53, 9) Source(1, 9) + SourceIndex(1)
4 >Emitted(53, 12) Source(1, 12) + SourceIndex(1)
5 >Emitted(53, 13) Source(1, 13) + SourceIndex(1)
6 >Emitted(53, 14) Source(1, 14) + SourceIndex(1)
7 >Emitted(53, 16) Source(1, 16) + SourceIndex(1)
8 >Emitted(53, 17) Source(1, 17) + SourceIndex(1)
9 >Emitted(53, 18) Source(1, 18) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../first/first_part3.ts
...
2 >function 
3 >         f
1 >Emitted(54, 1) Source(1, 1) + SourceIndex(2)
2 >Emitted(54, 10) Source(1, 10) + SourceIndex(2)
3 >Emitted(54, 11) Source(1, 11) + SourceIndex(2)
---
>>>    return "JS does hoists";
1->^^^^
2 >    ^^^^^^^
...
3 >           "JS does hoists"
4 >                           ;
1->Emitted(55, 5) Source(2, 5) + SourceIndex(2)
2 >Emitted(55, 12) Source(2, 12) + SourceIndex(2)
3 >Emitted(55, 28) Source(2, 28) + SourceIndex(2)
4 >Emitted(55, 29) Source(2, 29) + SourceIndex(2)
---
>>>}
1 >
2 >^
...
1 >
  >
2 >}
1 >Emitted(56, 1) Source(3, 1) + SourceIndex(2)
2 >Emitted(56, 2) Source(3, 2) + SourceIndex(2)
---
>>>function firstfirst_part3Spread() {
1->
2 >^^^^^^^^^
...
2 >function 
3 >         firstfirst_part3Spread
1->Emitted(57, 1) Source(4, 1) + SourceIndex(2)
2 >Emitted(57, 10) Source(4, 10) + SourceIndex(2)
3 >Emitted(57, 32) Source(4, 32) + SourceIndex(2)
---
>>>    var b = [];
1 >^^^^
2 >    ^^^^^^^^^^^
...
1 >(
2 >    ...b: number[]
1 >Emitted(58, 5) Source(4, 33) + SourceIndex(2)
2 >Emitted(58, 16) Source(4, 47) + SourceIndex(2)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
5 >                                          
6 >                                            ...b: number[]
1->Emitted(59, 10) Source(4, 33) + SourceIndex(2)
2 >Emitted(59, 20) Source(4, 47) + SourceIndex(2)
3 >Emitted(59, 22) Source(4, 33) + SourceIndex(2)
4 >Emitted(59, 43) Source(4, 47) + SourceIndex(2)
5 >Emitted(59, 45) Source(4, 33) + SourceIndex(2)
6 >Emitted(59, 49) Source(4, 47) + SourceIndex(2)
---
>>>        b[_i] = arguments[_i];
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
1 >
2 >        ...b: number[]
1 >Emitted(60, 9) Source(4, 33) + SourceIndex(2)
2 >Emitted(60, 31) Source(4, 47) + SourceIndex(2)
---
>>>    }
>>>}
1 >
...
1 >) { 
2 >}
1 >Emitted(62, 1) Source(4, 51) + SourceIndex(2)
2 >Emitted(62, 2) Source(4, 52) + SourceIndex(2)
---
>>>firstfirst_part3Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^
...
10>                                                         ]
11>                                                          );
1->Emitted(63, 1) Source(5, 1) + SourceIndex(2)
2 >Emitted(63, 23) Source(5, 23) + SourceIndex(2)
3 >Emitted(63, 47) Source(5, 27) + SourceIndex(2)
4 >Emitted(63, 48) Source(5, 28) + SourceIndex(2)
5 >Emitted(63, 50) Source(5, 30) + SourceIndex(2)
6 >Emitted(63, 52) Source(5, 32) + SourceIndex(2)
7 >Emitted(63, 54) Source(5, 34) + SourceIndex(2)
8 >Emitted(63, 56) Source(5, 36) + SourceIndex(2)
9 >Emitted(63, 58) Source(5, 38) + SourceIndex(2)
10>Emitted(63, 59) Source(5, 39) + SourceIndex(2)
11>Emitted(63, 62) Source(5, 41) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part1.ts
...
4 >      {
  ...
  >         f();
  >     }
1 >Emitted(94, 1) Source(5, 1) + SourceIndex(3)
2 >Emitted(94, 5) Source(5, 11) + SourceIndex(3)
3 >Emitted(94, 6) Source(5, 12) + SourceIndex(3)
4 >Emitted(94, 7) Source(11, 2) + SourceIndex(3)
---
>>>(function (N) {
1->
2 >^^^^^^^^^^^
...
2 >namespace 
3 >           N
1->Emitted(95, 1) Source(5, 1) + SourceIndex(3)
2 >Emitted(95, 12) Source(5, 11) + SourceIndex(3)
3 >Emitted(95, 13) Source(5, 12) + SourceIndex(3)
---
>>>    function f() {
1->^^^^
2 >    ^^^^^^^^^
...
2 >    function 
3 >             f
1->Emitted(96, 5) Source(6, 5) + SourceIndex(3)
2 >Emitted(96, 14) Source(6, 14) + SourceIndex(3)
3 >Emitted(96, 15) Source(6, 15) + SourceIndex(3)
---
>>>        console.log('testing');
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                             )
8 >                              ;
1->Emitted(97, 9) Source(7, 9) + SourceIndex(3)
2 >Emitted(97, 16) Source(7, 16) + SourceIndex(3)
3 >Emitted(97, 17) Source(7, 17) + SourceIndex(3)
4 >Emitted(97, 20) Source(7, 20) + SourceIndex(3)
5 >Emitted(97, 21) Source(7, 21) + SourceIndex(3)
6 >Emitted(97, 30) Source(7, 30) + SourceIndex(3)
7 >Emitted(97, 31) Source(7, 31) + SourceIndex(3)
8 >Emitted(97, 32) Source(7, 32) + SourceIndex(3)
---
>>>    }
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(98, 5) Source(8, 5) + SourceIndex(3)
2 >Emitted(98, 6) Source(8, 6) + SourceIndex(3)
---
>>>    f();
1->^^^^
2 >    ^
...
3 >     ()
4 >       ;
1->Emitted(99, 5) Source(10, 5) + SourceIndex(3)
2 >Emitted(99, 6) Source(10, 6) + SourceIndex(3)
3 >Emitted(99, 8) Source(10, 8) + SourceIndex(3)
4 >Emitted(99, 9) Source(10, 9) + SourceIndex(3)
---
>>>})(N || (N = {}));
1->
2 >^
...
7 >           {
  ...
  >              f();
  >          }
1->Emitted(100, 1) Source(11, 1) + SourceIndex(3)
2 >Emitted(100, 2) Source(11, 2) + SourceIndex(3)
3 >Emitted(100, 4) Source(5, 11) + SourceIndex(3)
4 >Emitted(100, 5) Source(5, 12) + SourceIndex(3)
5 >Emitted(100, 10) Source(5, 11) + SourceIndex(3)
6 >Emitted(100, 11) Source(5, 12) + SourceIndex(3)
7 >Emitted(100, 19) Source(11, 2) + SourceIndex(3)
---
>>>function forsecondsecond_part1Rest() {
1->
2 >^^^^^^^^^
...
2 >function 
3 >         forsecondsecond_part1Rest
1->Emitted(101, 1) Source(12, 1) + SourceIndex(3)
2 >Emitted(101, 10) Source(12, 10) + SourceIndex(3)
3 >Emitted(101, 35) Source(12, 35) + SourceIndex(3)
---
>>>    var _a = { a: 10, b: 30, yy: 30 }, b = _a.b, rest = __rest(_a, ["b"]);
1->^^^^
2 >    ^^^^
...
8 >                                                                         ;
1->Emitted(102, 5) Source(13, 1) + SourceIndex(3)
2 >Emitted(102, 9) Source(13, 7) + SourceIndex(3)
3 >Emitted(102, 38) Source(13, 48) + SourceIndex(3)
4 >Emitted(102, 40) Source(13, 9) + SourceIndex(3)
5 >Emitted(102, 48) Source(13, 10) + SourceIndex(3)
6 >Emitted(102, 50) Source(13, 12) + SourceIndex(3)
7 >Emitted(102, 74) Source(13, 48) + SourceIndex(3)
8 >Emitted(102, 75) Source(13, 49) + SourceIndex(3)
---
>>>}
1 >
2 >^
...
1 >
  >
2 >}
1 >Emitted(103, 1) Source(14, 1) + SourceIndex(3)
2 >Emitted(103, 2) Source(14, 2) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
2 >^^^^^^^^^^^^^^^^^^^->
1->
1->Emitted(104, 1) Source(1, 1) + SourceIndex(4)
---
>>>    function C() {
1->^^^^
2 >    ^^->
1->
1->Emitted(105, 5) Source(1, 1) + SourceIndex(4)
---
>>>    }
1->^^^^
2 >    ^
...
1->class C {
  ...
  >
2 >    }
1->Emitted(106, 5) Source(5, 1) + SourceIndex(4)
2 >Emitted(106, 6) Source(5, 2) + SourceIndex(4)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(107, 5) Source(2, 5) + SourceIndex(4)
2 >Emitted(107, 28) Source(2, 16) + SourceIndex(4)
3 >Emitted(107, 31) Source(2, 5) + SourceIndex(4)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(108, 9) Source(3, 9) + SourceIndex(4)
2 >Emitted(108, 16) Source(3, 16) + SourceIndex(4)
3 >Emitted(108, 17) Source(3, 17) + SourceIndex(4)
4 >Emitted(108, 20) Source(3, 20) + SourceIndex(4)
5 >Emitted(108, 21) Source(3, 21) + SourceIndex(4)
6 >Emitted(108, 41) Source(3, 41) + SourceIndex(4)
7 >Emitted(108, 42) Source(3, 42) + SourceIndex(4)
8 >Emitted(108, 43) Source(3, 43) + SourceIndex(4)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(109, 5) Source(4, 5) + SourceIndex(4)
2 >Emitted(109, 6) Source(4, 6) + SourceIndex(4)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
1->
  >
2 >    }
1->Emitted(110, 5) Source(5, 1) + SourceIndex(4)
2 >Emitted(110, 13) Source(5, 2) + SourceIndex(4)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(111, 1) Source(5, 1) + SourceIndex(4)
2 >Emitted(111, 2) Source(5, 2) + SourceIndex(4)
3 >Emitted(111, 2) Source(1, 1) + SourceIndex(4)
4 >Emitted(111, 6) Source(5, 2) + SourceIndex(4)
---
>>>function secondsecond_part2Spread() {
1->
2 >^^^^^^^^^
...
2 >function 
3 >         secondsecond_part2Spread
1->Emitted(112, 1) Source(7, 1) + SourceIndex(4)
2 >Emitted(112, 10) Source(7, 10) + SourceIndex(4)
3 >Emitted(112, 34) Source(7, 34) + SourceIndex(4)
---
>>>    var b = [];
1 >^^^^
2 >    ^^^^^^^^^^^
...
1 >(
2 >    ...b: number[]
1 >Emitted(113, 5) Source(7, 35) + SourceIndex(4)
2 >Emitted(113, 16) Source(7, 49) + SourceIndex(4)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
5 >                                          
6 >                                            ...b: number[]
1->Emitted(114, 10) Source(7, 35) + SourceIndex(4)
2 >Emitted(114, 20) Source(7, 49) + SourceIndex(4)
3 >Emitted(114, 22) Source(7, 35) + SourceIndex(4)
4 >Emitted(114, 43) Source(7, 49) + SourceIndex(4)
5 >Emitted(114, 45) Source(7, 35) + SourceIndex(4)
6 >Emitted(114, 49) Source(7, 49) + SourceIndex(4)
---
>>>        b[_i] = arguments[_i];
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
1 >
2 >        ...b: number[]
1 >Emitted(115, 9) Source(7, 35) + SourceIndex(4)
2 >Emitted(115, 31) Source(7, 49) + SourceIndex(4)
---
>>>    }
>>>}
1 >
...
1 >) { 
2 >}
1 >Emitted(117, 1) Source(7, 53) + SourceIndex(4)
2 >Emitted(117, 2) Source(7, 54) + SourceIndex(4)
---
>>>secondsecond_part2Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^^^
...
10>                                                           ]
11>                                                            );
1->Emitted(118, 1) Source(8, 1) + SourceIndex(4)
2 >Emitted(118, 25) Source(8, 25) + SourceIndex(4)
3 >Emitted(118, 49) Source(8, 29) + SourceIndex(4)
4 >Emitted(118, 50) Source(8, 30) + SourceIndex(4)
5 >Emitted(118, 52) Source(8, 32) + SourceIndex(4)
6 >Emitted(118, 54) Source(8, 34) + SourceIndex(4)
7 >Emitted(118, 56) Source(8, 36) + SourceIndex(4)
8 >Emitted(118, 58) Source(8, 38) + SourceIndex(4)
9 >Emitted(118, 60) Source(8, 40) + SourceIndex(4)
10>Emitted(118, 61) Source(8, 41) + SourceIndex(4)
11>Emitted(118, 64) Source(8, 43) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../third_part1.ts
...
7 >             ()
8 >               ;
1 >Emitted(120, 1) Source(1, 1) + SourceIndex(5)
2 >Emitted(120, 5) Source(1, 5) + SourceIndex(5)
3 >Emitted(120, 6) Source(1, 6) + SourceIndex(5)
4 >Emitted(120, 9) Source(1, 9) + SourceIndex(5)
5 >Emitted(120, 13) Source(1, 13) + SourceIndex(5)
6 >Emitted(120, 14) Source(1, 14) + SourceIndex(5)
7 >Emitted(120, 16) Source(1, 16) + SourceIndex(5)
8 >Emitted(120, 17) Source(1, 17) + SourceIndex(5)
---
>>>c.doSomething();
1->
2 >^
...
5 >             ()
6 >               ;
1->Emitted(121, 1) Source(2, 1) + SourceIndex(5)
2 >Emitted(121, 2) Source(2, 2) + SourceIndex(5)
3 >Emitted(121, 3) Source(2, 3) + SourceIndex(5)
4 >Emitted(121, 14) Source(2, 14) + SourceIndex(5)
5 >Emitted(121, 16) Source(2, 16) + SourceIndex(5)
6 >Emitted(121, 17) Source(2, 17) + SourceIndex(5)
---
>>>function forthirdthird_part1Rest() {
1->
2 >^^^^^^^^^
...
2 >function 
3 >         forthirdthird_part1Rest
1->Emitted(122, 1) Source(3, 1) + SourceIndex(5)
2 >Emitted(122, 10) Source(3, 10) + SourceIndex(5)
3 >Emitted(122, 33) Source(3, 33) + SourceIndex(5)
---
>>>    var _a = { a: 10, b: 30, yy: 30 }, b = _a.b, rest = __rest(_a, ["b"]);
1->^^^^
2 >    ^^^^
...
7 >                                                 ...rest } = { a: 10, b: 30, yy: 30 }
8 >                                                                         ;
1->Emitted(123, 5) Source(4, 1) + SourceIndex(5)
2 >Emitted(123, 9) Source(4, 7) + SourceIndex(5)
3 >Emitted(123, 38) Source(4, 48) + SourceIndex(5)
4 >Emitted(123, 40) Source(4, 9) + SourceIndex(5)
5 >Emitted(123, 48) Source(4, 10) + SourceIndex(5)
6 >Emitted(123, 50) Source(4, 12) + SourceIndex(5)
7 >Emitted(123, 74) Source(4, 48) + SourceIndex(5)
8 >Emitted(123, 75) Source(4, 49) + SourceIndex(5)
---
>>>}
1 >
2 >^
...
1 >
  >
2 >}
1 >Emitted(124, 1) Source(5, 1) + SourceIndex(5)
2 >Emitted(124, 2) Source(5, 2) + SourceIndex(5)
---
>>>function thirdthird_part1Spread() {
1->
2 >^^^^^^^^^
...
2 >function 
3 >         thirdthird_part1Spread
1->Emitted(125, 1) Source(6, 1) + SourceIndex(5)
2 >Emitted(125, 10) Source(6, 10) + SourceIndex(5)
3 >Emitted(125, 32) Source(6, 32) + SourceIndex(5)
---
>>>    var b = [];
1 >^^^^
2 >    ^^^^^^^^^^^
...
1 >(
2 >    ...b: number[]
1 >Emitted(126, 5) Source(6, 33) + SourceIndex(5)
2 >Emitted(126, 16) Source(6, 47) + SourceIndex(5)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
5 >                                          
6 >                                            ...b: number[]
1->Emitted(127, 10) Source(6, 33) + SourceIndex(5)
2 >Emitted(127, 20) Source(6, 47) + SourceIndex(5)
3 >Emitted(127, 22) Source(6, 33) + SourceIndex(5)
4 >Emitted(127, 43) Source(6, 47) + SourceIndex(5)
5 >Emitted(127, 45) Source(6, 33) + SourceIndex(5)
6 >Emitted(127, 49) Source(6, 47) + SourceIndex(5)
---
>>>        b[_i] = arguments[_i];
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
1 >
2 >        ...b: number[]
1 >Emitted(128, 9) Source(6, 33) + SourceIndex(5)
2 >Emitted(128, 31) Source(6, 47) + SourceIndex(5)
---
>>>    }
>>>}
1 >
...
1 >) { 
2 >}
1 >Emitted(130, 1) Source(6, 51) + SourceIndex(5)
2 >Emitted(130, 2) Source(6, 52) + SourceIndex(5)
---
>>>thirdthird_part1Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^
...
10>                                                         ]
11>                                                          );
1->Emitted(131, 1) Source(7, 1) + SourceIndex(5)
2 >Emitted(131, 23) Source(7, 23) + SourceIndex(5)
3 >Emitted(131, 47) Source(7, 27) + SourceIndex(5)
4 >Emitted(131, 48) Source(7, 28) + SourceIndex(5)
5 >Emitted(131, 50) Source(7, 30) + SourceIndex(5)
6 >Emitted(131, 52) Source(7, 32) + SourceIndex(5)
7 >Emitted(131, 54) Source(7, 34) + SourceIndex(5)
8 >Emitted(131, 56) Source(7, 36) + SourceIndex(5)
9 >Emitted(131, 58) Source(7, 38) + SourceIndex(5)
10>Emitted(131, 59) Source(7, 39) + SourceIndex(5)
11>Emitted(131, 62) Source(7, 41) + SourceIndex(5)
---
>>>//# sourceMappingURL=third-output.js.map
