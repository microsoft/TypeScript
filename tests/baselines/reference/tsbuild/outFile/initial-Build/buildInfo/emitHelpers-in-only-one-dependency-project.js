...
2 >Emitted(13, 8) Source(1, 8) + SourceIndex(1)
3 >Emitted(13, 9) Source(1, 9) + SourceIndex(1)
4 >Emitted(13, 12) Source(1, 12) + SourceIndex(1)
5 >Emitted(13, 13) Source(1, 13) + SourceIndex(1)
6 >Emitted(13, 14) Source(1, 14) + SourceIndex(1)
7 >Emitted(13, 16) Source(1, 16) + SourceIndex(1)
8 >Emitted(13, 17) Source(1, 17) + SourceIndex(1)
9 >Emitted(13, 18) Source(1, 18) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../first/first_part3.ts
...
2 >Emitted(14, 10) Source(1, 10) + SourceIndex(2)
3 >Emitted(14, 11) Source(1, 11) + SourceIndex(2)
---
>>>    return "JS does hoists";
1->^^^^
2 >    ^^^^^^^
...
3 >           "JS does hoists"
4 >                           ;
1->Emitted(15, 5) Source(2, 5) + SourceIndex(2)
2 >Emitted(15, 12) Source(2, 12) + SourceIndex(2)
3 >Emitted(15, 28) Source(2, 28) + SourceIndex(2)
4 >Emitted(15, 29) Source(2, 29) + SourceIndex(2)
---
>>>}
1 >
2 >^
...
1 >
  >
2 >}
1 >Emitted(16, 1) Source(3, 1) + SourceIndex(2)
2 >Emitted(16, 2) Source(3, 2) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part1.ts
