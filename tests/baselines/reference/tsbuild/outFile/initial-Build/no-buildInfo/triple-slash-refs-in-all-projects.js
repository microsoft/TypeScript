...
2 >Emitted(3, 11) Source(1, 11) + SourceIndex(0)
3 >Emitted(3, 19) Source(1, 19) + SourceIndex(0)
---
>>>    none: any;
1 >^^^^
2 >    ^^^^
...
2 >Emitted(4, 9) Source(2, 9) + SourceIndex(0)
3 >Emitted(4, 11) Source(2, 11) + SourceIndex(0)
4 >Emitted(4, 14) Source(2, 14) + SourceIndex(0)
5 >Emitted(4, 15) Source(2, 15) + SourceIndex(0)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^->
1 >
  >}
1 >Emitted(5, 2) Source(3, 2) + SourceIndex(0)
---
>>>declare const s = "Hello, world";
1->
2 >^^^^^^^^
...
2 >Emitted(6, 9) Source(5, 1) + SourceIndex(0)
3 >Emitted(6, 15) Source(5, 7) + SourceIndex(0)
4 >Emitted(6, 16) Source(5, 8) + SourceIndex(0)
5 >Emitted(6, 33) Source(5, 25) + SourceIndex(0)
6 >Emitted(6, 34) Source(5, 26) + SourceIndex(0)
---
>>>interface NoJsForHereEither {
1 >
2 >^^^^^^^^^^
...
2 >Emitted(7, 11) Source(7, 11) + SourceIndex(0)
3 >Emitted(7, 28) Source(7, 28) + SourceIndex(0)
---
>>>    none: any;
1 >^^^^
2 >    ^^^^
...
3 >Emitted(8, 11) Source(8, 11) + SourceIndex(0)
4 >Emitted(8, 14) Source(8, 14) + SourceIndex(0)
...
1 >
  >}
1 >Emitted(9, 2) Source(9, 2) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.d.ts
...
2 >Emitted(10, 9) Source(2, 1) + SourceIndex(1)
3 >Emitted(10, 15) Source(2, 7) + SourceIndex(1)
4 >Emitted(10, 31) Source(2, 23) + SourceIndex(1)
5 >Emitted(10, 49) Source(2, 48) + SourceIndex(1)
6 >Emitted(10, 50) Source(2, 49) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.d.ts
...
2 >Emitted(11, 18) Source(1, 10) + SourceIndex(2)
3 >Emitted(11, 19) Source(1, 11) + SourceIndex(2)
4 >Emitted(11, 30) Source(3, 2) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.d.ts
sourceFile:../../../second/second_part1.ts
