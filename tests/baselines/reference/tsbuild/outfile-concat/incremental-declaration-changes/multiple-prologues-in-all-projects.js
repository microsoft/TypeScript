...
5 >Emitted(4, 22) Source(6, 24) + SourceIndex(0)
6 >Emitted(4, 23) Source(6, 25) + SourceIndex(0)
---
>>>
>>>console.log(s);
1 >
...
5 >Emitted(6, 22) Source(6, 24) + SourceIndex(0)
6 >Emitted(6, 23) Source(6, 25) + SourceIndex(0)
---
>>>
>>>console.log(s);
1 >
...
3 >     ()
4 >       ;
1 >Emitted(19, 5) Source(11, 5) + SourceIndex(5)
2 >Emitted(19, 6) Source(11, 6) + SourceIndex(5)
3 >Emitted(19, 8) Source(11, 8) + SourceIndex(5)
4 >Emitted(19, 9) Source(11, 9) + SourceIndex(5)
---
>>>})(N || (N = {}));
1->
2 >^
...
7 >           {
  ...
  >              f();
  >          }
1->Emitted(20, 1) Source(12, 1) + SourceIndex(5)
2 >Emitted(20, 2) Source(12, 2) + SourceIndex(5)
3 >Emitted(20, 4) Source(6, 11) + SourceIndex(5)
4 >Emitted(20, 5) Source(6, 12) + SourceIndex(5)
5 >Emitted(20, 10) Source(6, 11) + SourceIndex(5)
6 >Emitted(20, 11) Source(6, 12) + SourceIndex(5)
7 >Emitted(20, 19) Source(12, 2) + SourceIndex(5)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
2 >Emitted(23, 6) Source(6, 2) + SourceIndex(1)
3 >Emitted(23, 6) Source(3, 5) + SourceIndex(1)
4 >Emitted(23, 29) Source(3, 16) + SourceIndex(1)
5 >Emitted(23, 32) Source(3, 5) + SourceIndex(1)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
"myPrologue3";
----------------------------------------------------------------------
prepend: (62-175):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (62-175)
...
----------------------------------------------------------------------
prepend: (175-456):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (175-456)
var N;
(function (N) {
