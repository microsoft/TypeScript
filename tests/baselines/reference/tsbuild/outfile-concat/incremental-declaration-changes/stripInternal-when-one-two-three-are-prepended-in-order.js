...
6:48:00 PM - Projects in this build: 
    * src/first/tsconfig.json
    * src/second/tsconfig.json
    * src/third/tsconfig.json

6:48:00 PM - Project 'src/first/tsconfig.json' is out of date because oldest output 'src/first/bin/first-output.js' is older than newest input 'src/first/first_PART1.ts'

6:48:00 PM - Building project '/src/first/tsconfig.json'...

6:48:00 PM - Project 'src/second/tsconfig.json' is out of date because oldest output 'src/2/second-output.js' is older than newest input 'src/first'

6:48:00 PM - Building project '/src/second/tsconfig.json'...

6:48:00 PM - Project 'src/third/tsconfig.json' is out of date because oldest output 'src/third/thirdjs/output/third-output.js' is older than newest input 'src/second'

6:48:00 PM - Building project '/src/third/tsconfig.json'...
