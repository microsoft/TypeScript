...
4 >                               method() { 
5 >                                             }
1 >Emitted(20, 5) Source(16, 19) + SourceIndex(3)
2 >Emitted(20, 29) Source(16, 25) + SourceIndex(3)
3 >Emitted(20, 32) Source(16, 19) + SourceIndex(3)
4 >Emitted(20, 46) Source(16, 30) + SourceIndex(3)
5 >Emitted(20, 47) Source(16, 31) + SourceIndex(3)
---
>>>    Object.defineProperty(normalC.prototype, "c", {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
6 >                                      
7 >                                      }
1 >Emitted(22, 14) Source(17, 19) + SourceIndex(3)
2 >Emitted(22, 28) Source(17, 29) + SourceIndex(3)
3 >Emitted(22, 35) Source(17, 36) + SourceIndex(3)
4 >Emitted(22, 37) Source(17, 38) + SourceIndex(3)
5 >Emitted(22, 38) Source(17, 39) + SourceIndex(3)
6 >Emitted(22, 39) Source(17, 40) + SourceIndex(3)
7 >Emitted(22, 40) Source(17, 41) + SourceIndex(3)
---
>>>        set: function (val) { },
1 >^^^^^^^^^^^^^
2 >             ^^^^^^^^^^
...
4 >                          ) { 
5 >                              }
1 >Emitted(23, 14) Source(18, 19) + SourceIndex(3)
2 >Emitted(23, 24) Source(18, 25) + SourceIndex(3)
3 >Emitted(23, 27) Source(18, 36) + SourceIndex(3)
4 >Emitted(23, 31) Source(18, 40) + SourceIndex(3)
5 >Emitted(23, 32) Source(18, 41) + SourceIndex(3)
---
>>>        enumerable: false,
>>>        configurable: true
>>>    });
...
1-> {
  >    /*@internal*/ 
1->Emitted(31, 5) Source(21, 19) + SourceIndex(3)
---
>>>        function C() {}
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^
...
6 >                                       C
7 >                                        ;
1 >Emitted(55, 5) Source(25, 33) + SourceIndex(3)
2 >Emitted(55, 23) Source(25, 43) + SourceIndex(3)
3 >Emitted(55, 26) Source(25, 46) + SourceIndex(3)
4 >Emitted(55, 39) Source(25, 59) + SourceIndex(3)
5 >Emitted(55, 40) Source(25, 60) + SourceIndex(3)
6 >Emitted(55, 41) Source(25, 61) + SourceIndex(3)
7 >Emitted(55, 42) Source(25, 62) + SourceIndex(3)
---
>>>
>>>    normalN.internalConst = 10;
1 >^^^^
...
4 >                            10
5 >                              ;
1 >Emitted(57, 5) Source(27, 32) + SourceIndex(3)
2 >Emitted(57, 26) Source(27, 45) + SourceIndex(3)
3 >Emitted(57, 29) Source(27, 48) + SourceIndex(3)
4 >Emitted(57, 31) Source(27, 50) + SourceIndex(3)
5 >Emitted(57, 32) Source(27, 51) + SourceIndex(3)
---
>>>    var internalEnum;
1 >^^^^
2 >    ^^^^
...
2 >Emitted(58, 9) Source(28, 31) + SourceIndex(3)
3 >Emitted(58, 21) Source(28, 55) + SourceIndex(3)
---
>>>    (function (internalEnum) {
1->^^^^
2 >    ^^^^^^^^^^^
...
1->
  >/*@internal*/ 
1->Emitted(63, 1) Source(30, 15) + SourceIndex(3)
---
>>>    function internalC() {}
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
4 >                    () {
5 >                         }
1->Emitted(67, 1) Source(31, 15) + SourceIndex(3)
2 >Emitted(67, 10) Source(31, 24) + SourceIndex(3)
3 >Emitted(67, 21) Source(31, 35) + SourceIndex(3)
4 >Emitted(67, 26) Source(31, 39) + SourceIndex(3)
5 >Emitted(67, 27) Source(31, 40) + SourceIndex(3)
---
>>>var internalNamespace;
1 >
2 >^^^^
...
2 >Emitted(68, 5) Source(32, 25) + SourceIndex(3)
3 >Emitted(68, 22) Source(32, 42) + SourceIndex(3)
4 >Emitted(68, 23) Source(32, 72) + SourceIndex(3)
---
>>>(function (internalNamespace) {var someClass = (function () {
1->
2 >^^^^^^^^^^^
...
2 >Emitted(75, 5) Source(33, 25) + SourceIndex(3)
3 >Emitted(75, 18) Source(33, 38) + SourceIndex(3)
4 >Emitted(75, 19) Source(33, 78) + SourceIndex(3)
---
>>>(function (internalOther) {
1->
2 >^^^^^^^^^^^
...
7 >                                       someClass
8 >                                                ;
1->Emitted(85, 1) Source(34, 15) + SourceIndex(3)
2 >Emitted(85, 5) Source(34, 22) + SourceIndex(3)
3 >Emitted(85, 19) Source(34, 36) + SourceIndex(3)
4 >Emitted(85, 22) Source(34, 39) + SourceIndex(3)
5 >Emitted(85, 39) Source(34, 56) + SourceIndex(3)
6 >Emitted(85, 40) Source(34, 57) + SourceIndex(3)
7 >Emitted(85, 49) Source(34, 66) + SourceIndex(3)
8 >Emitted(85, 50) Source(34, 67) + SourceIndex(3)
---
>>>
>>>var internalConst = 10;
1 >
...
5 >                    10
6 >                      ;
1 >Emitted(87, 1) Source(36, 15) + SourceIndex(3)
2 >Emitted(87, 5) Source(36, 21) + SourceIndex(3)
3 >Emitted(87, 18) Source(36, 34) + SourceIndex(3)
4 >Emitted(87, 21) Source(36, 37) + SourceIndex(3)
5 >Emitted(87, 23) Source(36, 39) + SourceIndex(3)
6 >Emitted(87, 24) Source(36, 40) + SourceIndex(3)
---
>>>var internalEnum;
1 >
2 >^^^^
...
2 >enum 
3 >    internalEnum { a, b, c }
1 >Emitted(88, 1) Source(37, 15) + SourceIndex(3)
2 >Emitted(88, 5) Source(37, 20) + SourceIndex(3)
3 >Emitted(88, 17) Source(37, 44) + SourceIndex(3)
---
>>>(function (internalEnum) {
1->
2 >^^^^^^^^^^^
...
----------------------------------------------------------------------
prepend: (0-3018):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (0-3018)
