...
3 >Emitted(21, 6) Source(2, 5) + SourceIndex(4)
4 >Emitted(21, 29) Source(2, 16) + SourceIndex(4)
5 >Emitted(21, 32) Source(2, 5) + SourceIndex(4)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(22, 9) Source(3, 9) + SourceIndex(4)
2 >Emitted(22, 16) Source(3, 16) + SourceIndex(4)
3 >Emitted(22, 17) Source(3, 17) + SourceIndex(4)
4 >Emitted(22, 20) Source(3, 20) + SourceIndex(4)
5 >Emitted(22, 21) Source(3, 21) + SourceIndex(4)
6 >Emitted(22, 41) Source(3, 41) + SourceIndex(4)
7 >Emitted(22, 42) Source(3, 42) + SourceIndex(4)
8 >Emitted(22, 43) Source(3, 43) + SourceIndex(4)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(23, 5) Source(4, 5) + SourceIndex(4)
2 >Emitted(23, 6) Source(4, 6) + SourceIndex(4)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
1->
  >
2 >    }
1->Emitted(24, 5) Source(5, 1) + SourceIndex(4)
2 >Emitted(24, 13) Source(5, 2) + SourceIndex(4)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(25, 1) Source(5, 1) + SourceIndex(4)
2 >Emitted(25, 2) Source(5, 2) + SourceIndex(4)
3 >Emitted(25, 2) Source(1, 1) + SourceIndex(4)
4 >Emitted(25, 6) Source(5, 2) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../third_part1.ts
...
----------------------------------------------------------------------
prepend: (161-493):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (161-493)
var second_part1Const = new secondsecond_part1();
var N;
