...
"myPrologue3";
----------------------------------------------------------------------
prepend: (62-229):: /src/first/bin/first-output.js texts:: 2
>>--------------------------------------------------------------------
text: (62-189)
var s = "Hello, world";
console.log(s);
...
>>--------------------------------------------------------------------
sourceMapUrl: (189-229)
//# sourceMappingURL=first-output.js.map
----------------------------------------------------------------------
prepend: (231-557):: /src/2/second-output.js texts:: 2
>>--------------------------------------------------------------------
text: (231-516)
var N;
(function (N) {
...
7 >             ()
8 >               ;
1->Emitted(29, 1) Source(3, 1) + SourceIndex(2)
2 >Emitted(29, 5) Source(3, 5) + SourceIndex(2)
3 >Emitted(29, 6) Source(3, 6) + SourceIndex(2)
4 >Emitted(29, 9) Source(3, 9) + SourceIndex(2)
5 >Emitted(29, 13) Source(3, 13) + SourceIndex(2)
6 >Emitted(29, 14) Source(3, 14) + SourceIndex(2)
7 >Emitted(29, 16) Source(3, 16) + SourceIndex(2)
8 >Emitted(29, 17) Source(3, 17) + SourceIndex(2)
---
>>>c.doSomething();
1->
2 >^
...
5 >             ()
6 >               ;
1->Emitted(30, 1) Source(4, 1) + SourceIndex(2)
2 >Emitted(30, 2) Source(4, 2) + SourceIndex(2)
3 >Emitted(30, 3) Source(4, 3) + SourceIndex(2)
4 >Emitted(30, 14) Source(4, 14) + SourceIndex(2)
5 >Emitted(30, 16) Source(4, 16) + SourceIndex(2)
6 >Emitted(30, 17) Source(4, 17) + SourceIndex(2)
---
>>>//# sourceMappingURL=third-output.js.map
