...
3 >Emitted(60, 6) Source(2, 5) + SourceIndex(4)
4 >Emitted(60, 29) Source(2, 16) + SourceIndex(4)
5 >Emitted(60, 32) Source(2, 5) + SourceIndex(4)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
----------------------------------------------------------------------
prepend: (1428-1919):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1428-1919)
var N;
(function (N) {
