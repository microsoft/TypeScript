...
2 >Emitted(29, 10) Source(13, 10) + SourceIndex(3)
3 >Emitted(29, 34) Source(13, 34) + SourceIndex(3)
---
>>>    var b = [];
1 >^^^^
2 >    ^^^^^^^^^^^
...
1 >(
2 >    ...b: number[]
1 >Emitted(30, 5) Source(13, 35) + SourceIndex(3)
2 >Emitted(30, 16) Source(13, 49) + SourceIndex(3)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
5 >                                          
6 >                                            ...b: number[]
1->Emitted(31, 10) Source(13, 35) + SourceIndex(3)
2 >Emitted(31, 20) Source(13, 49) + SourceIndex(3)
3 >Emitted(31, 22) Source(13, 35) + SourceIndex(3)
4 >Emitted(31, 43) Source(13, 49) + SourceIndex(3)
5 >Emitted(31, 45) Source(13, 35) + SourceIndex(3)
6 >Emitted(31, 49) Source(13, 49) + SourceIndex(3)
---
>>>        b[_i] = arguments[_i];
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
1 >
2 >        ...b: number[]
1 >Emitted(32, 9) Source(13, 35) + SourceIndex(3)
2 >Emitted(32, 31) Source(13, 49) + SourceIndex(3)
---
>>>    }
>>>}
1 >
...
1 >) { 
2 >}
1 >Emitted(34, 1) Source(13, 53) + SourceIndex(3)
2 >Emitted(34, 2) Source(13, 54) + SourceIndex(3)
---
>>>secondsecond_part1Spread.apply(void 0, [10, 20, 30]);
1->
2 >^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >Emitted(35, 25) Source(14, 25) + SourceIndex(3)
3 >Emitted(35, 40) Source(14, 29) + SourceIndex(3)
4 >Emitted(35, 41) Source(14, 30) + SourceIndex(3)
5 >Emitted(35, 43) Source(14, 32) + SourceIndex(3)
6 >Emitted(35, 45) Source(14, 34) + SourceIndex(3)
7 >Emitted(35, 47) Source(14, 36) + SourceIndex(3)
8 >Emitted(35, 49) Source(14, 38) + SourceIndex(3)
9 >Emitted(35, 51) Source(14, 40) + SourceIndex(3)
10>Emitted(35, 52) Source(14, 41) + SourceIndex(3)
11>Emitted(35, 54) Source(14, 43) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
...
7 >             ()
8 >               ;
1->Emitted(44, 1) Source(1, 1) + SourceIndex(5)
2 >Emitted(44, 5) Source(1, 5) + SourceIndex(5)
3 >Emitted(44, 6) Source(1, 6) + SourceIndex(5)
4 >Emitted(44, 9) Source(1, 9) + SourceIndex(5)
5 >Emitted(44, 13) Source(1, 13) + SourceIndex(5)
6 >Emitted(44, 14) Source(1, 14) + SourceIndex(5)
7 >Emitted(44, 16) Source(1, 16) + SourceIndex(5)
8 >Emitted(44, 17) Source(1, 17) + SourceIndex(5)
---
>>>c.doSomething();
1->
2 >^
...
5 >             ()
6 >               ;
1->Emitted(45, 1) Source(2, 1) + SourceIndex(5)
2 >Emitted(45, 2) Source(2, 2) + SourceIndex(5)
3 >Emitted(45, 3) Source(2, 3) + SourceIndex(5)
4 >Emitted(45, 14) Source(2, 14) + SourceIndex(5)
5 >Emitted(45, 16) Source(2, 16) + SourceIndex(5)
6 >Emitted(45, 17) Source(2, 17) + SourceIndex(5)
---
>>>function forthirdthird_part1Rest() {
1->
2 >^^^^^^^^^
...
1->Emitted(46, 1) Source(3, 1) + SourceIndex(5)
2 >Emitted(46, 10) Source(3, 10) + SourceIndex(5)
3 >Emitted(46, 33) Source(3, 33) + SourceIndex(5)
---
>>>    var _a = { a: 10, b: 30, yy: 30 }, b = _a.b, rest = __rest(_a, ["b"]);
1->^^^^
2 >    ^^^^
...
24>                                                                         = { a: 10, b: 30, yy: 30 }
25>                                                                         ;
1->Emitted(47, 5) Source(4, 1) + SourceIndex(5)
2 >Emitted(47, 9) Source(4, 7) + SourceIndex(5)
3 >Emitted(47, 14) Source(4, 24) + SourceIndex(5)
4 >Emitted(47, 16) Source(4, 26) + SourceIndex(5)
5 >Emitted(47, 17) Source(4, 27) + SourceIndex(5)
6 >Emitted(47, 19) Source(4, 29) + SourceIndex(5)
7 >Emitted(47, 21) Source(4, 31) + SourceIndex(5)
8 >Emitted(47, 23) Source(4, 33) + SourceIndex(5)
9 >Emitted(47, 24) Source(4, 34) + SourceIndex(5)
10>Emitted(47, 26) Source(4, 36) + SourceIndex(5)
11>Emitted(47, 28) Source(4, 38) + SourceIndex(5)
12>Emitted(47, 30) Source(4, 40) + SourceIndex(5)
13>Emitted(47, 32) Source(4, 42) + SourceIndex(5)
14>Emitted(47, 34) Source(4, 44) + SourceIndex(5)
15>Emitted(47, 36) Source(4, 46) + SourceIndex(5)
16>Emitted(47, 38) Source(4, 48) + SourceIndex(5)
17>Emitted(47, 40) Source(4, 9) + SourceIndex(5)
18>Emitted(47, 41) Source(4, 10) + SourceIndex(5)
19>Emitted(47, 48) Source(4, 10) + SourceIndex(5)
20>Emitted(47, 50) Source(4, 15) + SourceIndex(5)
21>Emitted(47, 54) Source(4, 19) + SourceIndex(5)
22>Emitted(47, 68) Source(4, 7) + SourceIndex(5)
23>Emitted(47, 73) Source(4, 21) + SourceIndex(5)
24>Emitted(47, 74) Source(4, 48) + SourceIndex(5)
25>Emitted(47, 75) Source(4, 49) + SourceIndex(5)
---
>>>}
1 >
2 >^
...
1 >
  >
2 >}
1 >Emitted(48, 1) Source(5, 1) + SourceIndex(5)
2 >Emitted(48, 2) Source(5, 2) + SourceIndex(5)
---
>>>//# sourceMappingURL=third-output.js.map
...
----------------------------------------------------------------------
prepend: (746-1237):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (746-1237)
var N;
(function (N) {
