...
3 >Emitted(24, 6) Source(3, 5) + SourceIndex(1)
4 >Emitted(24, 29) Source(3, 16) + SourceIndex(1)
5 >Emitted(24, 32) Source(3, 5) + SourceIndex(1)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(25, 9) Source(4, 9) + SourceIndex(1)
2 >Emitted(25, 16) Source(4, 16) + SourceIndex(1)
3 >Emitted(25, 17) Source(4, 17) + SourceIndex(1)
4 >Emitted(25, 20) Source(4, 20) + SourceIndex(1)
5 >Emitted(25, 21) Source(4, 21) + SourceIndex(1)
6 >Emitted(25, 41) Source(4, 41) + SourceIndex(1)
7 >Emitted(25, 42) Source(4, 42) + SourceIndex(1)
8 >Emitted(25, 43) Source(4, 43) + SourceIndex(1)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(26, 5) Source(5, 5) + SourceIndex(1)
2 >Emitted(26, 6) Source(5, 6) + SourceIndex(1)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
1->
  >
2 >    }
1->Emitted(27, 5) Source(6, 1) + SourceIndex(1)
2 >Emitted(27, 13) Source(6, 2) + SourceIndex(1)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(28, 1) Source(6, 1) + SourceIndex(1)
2 >Emitted(28, 2) Source(6, 2) + SourceIndex(1)
3 >Emitted(28, 2) Source(2, 1) + SourceIndex(1)
4 >Emitted(28, 6) Source(6, 2) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../third_part1.ts
...
----------------------------------------------------------------------
prepend: (193-474):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (193-474)
var N;
(function (N) {
