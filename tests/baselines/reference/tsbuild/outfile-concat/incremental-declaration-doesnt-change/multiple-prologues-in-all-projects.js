...
4:46:00 PM - Projects in this build: 
    * src/first/tsconfig.json
    * src/second/tsconfig.json
    * src/third/tsconfig.json

4:46:00 PM - Project 'src/first/tsconfig.json' is out of date because oldest output 'src/first/bin/first-output.js' is older than newest input 'src/first/first_PART1.ts'

4:46:00 PM - Building project '/src/first/tsconfig.json'...

4:46:00 PM - Project 'src/second/tsconfig.json' is up to date because newest input 'src/second/second_part1.ts' is older than oldest output 'src/2/second-output.js'

4:46:00 PM - Project 'src/third/tsconfig.json' is out of date because output of its dependency 'src/first' has changed

4:46:00 PM - Updating output of project '/src/third/tsconfig.json'...

4:46:00 PM - Updating unchanged output timestamps of project '/src/third/tsconfig.json'...
