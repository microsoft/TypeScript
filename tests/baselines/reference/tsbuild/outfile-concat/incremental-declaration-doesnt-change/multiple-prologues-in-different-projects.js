...
5 >        "Hello, world"
6 >                      ;
1 >Emitted(5, 1) Source(5, 1) + SourceIndex(2)
2 >Emitted(5, 5) Source(5, 7) + SourceIndex(2)
3 >Emitted(5, 6) Source(5, 8) + SourceIndex(2)
4 >Emitted(5, 9) Source(5, 11) + SourceIndex(2)
5 >Emitted(5, 23) Source(5, 25) + SourceIndex(2)
6 >Emitted(5, 24) Source(5, 26) + SourceIndex(2)
---
>>>
>>>console.log(s);
1 >
...
7 >             )
8 >              ;
1 >Emitted(7, 1) Source(11, 1) + SourceIndex(2)
2 >Emitted(7, 8) Source(11, 8) + SourceIndex(2)
3 >Emitted(7, 9) Source(11, 9) + SourceIndex(2)
4 >Emitted(7, 12) Source(11, 12) + SourceIndex(2)
5 >Emitted(7, 13) Source(11, 13) + SourceIndex(2)
6 >Emitted(7, 14) Source(11, 14) + SourceIndex(2)
7 >Emitted(7, 15) Source(11, 15) + SourceIndex(2)
8 >Emitted(7, 16) Source(11, 16) + SourceIndex(2)
---
>>>console.log(s);
1->
2 >^^^^^^^
...
7 >             )
8 >              ;
1->Emitted(8, 1) Source(12, 1) + SourceIndex(2)
2 >Emitted(8, 8) Source(12, 8) + SourceIndex(2)
3 >Emitted(8, 9) Source(12, 9) + SourceIndex(2)
4 >Emitted(8, 12) Source(12, 12) + SourceIndex(2)
5 >Emitted(8, 13) Source(12, 13) + SourceIndex(2)
6 >Emitted(8, 14) Source(12, 14) + SourceIndex(2)
7 >Emitted(8, 15) Source(12, 15) + SourceIndex(2)
8 >Emitted(8, 16) Source(12, 16) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
...
2 >Emitted(13, 5) Source(6, 11) + SourceIndex(0)
3 >Emitted(13, 6) Source(6, 12) + SourceIndex(0)
4 >Emitted(13, 7) Source(12, 2) + SourceIndex(0)
---
>>>(function (N) {
1->
2 >^^^^^^^^^^^
...
2 >namespace 
3 >           N
1->Emitted(14, 1) Source(6, 1) + SourceIndex(0)
2 >Emitted(14, 12) Source(6, 11) + SourceIndex(0)
3 >Emitted(14, 13) Source(6, 12) + SourceIndex(0)
---
>>>    function f() {
1->^^^^
2 >    ^^^^^^^^^
...
2 >    function 
3 >             f
1->Emitted(15, 5) Source(7, 5) + SourceIndex(0)
2 >Emitted(15, 14) Source(7, 14) + SourceIndex(0)
3 >Emitted(15, 15) Source(7, 15) + SourceIndex(0)
---
>>>        console.log('testing');
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                             )
8 >                              ;
1->Emitted(16, 9) Source(8, 9) + SourceIndex(0)
2 >Emitted(16, 16) Source(8, 16) + SourceIndex(0)
3 >Emitted(16, 17) Source(8, 17) + SourceIndex(0)
4 >Emitted(16, 20) Source(8, 20) + SourceIndex(0)
5 >Emitted(16, 21) Source(8, 21) + SourceIndex(0)
6 >Emitted(16, 30) Source(8, 30) + SourceIndex(0)
7 >Emitted(16, 31) Source(8, 31) + SourceIndex(0)
8 >Emitted(16, 32) Source(8, 32) + SourceIndex(0)
---
>>>    }
1 >^^^^
2 >    ^
1 >
  >    
2 >    }
1 >Emitted(17, 5) Source(9, 5) + SourceIndex(0)
2 >Emitted(17, 6) Source(9, 6) + SourceIndex(0)
---
>>>
>>>    f();
1 >^^^^
...
3 >     ()
4 >       ;
1 >Emitted(19, 5) Source(11, 5) + SourceIndex(0)
2 >Emitted(19, 6) Source(11, 6) + SourceIndex(0)
3 >Emitted(19, 8) Source(11, 8) + SourceIndex(0)
4 >Emitted(19, 9) Source(11, 9) + SourceIndex(0)
---
>>>})(N || (N = {}));
1->
2 >^
...
2 >Emitted(20, 2) Source(12, 2) + SourceIndex(0)
3 >Emitted(20, 4) Source(6, 11) + SourceIndex(0)
4 >Emitted(20, 5) Source(6, 12) + SourceIndex(0)
5 >Emitted(20, 10) Source(6, 11) + SourceIndex(0)
6 >Emitted(20, 11) Source(6, 12) + SourceIndex(0)
7 >Emitted(20, 19) Source(12, 2) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
"myPrologue2";
----------------------------------------------------------------------
prepend: (46-177):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (46-177)
...
----------------------------------------------------------------------
prepend: (177-458):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (177-458)
var N;
(function (N) {
