...
2 >Emitted(17, 18) Source(14, 18) + SourceIndex(3)
3 >Emitted(17, 19) Source(14, 19) + SourceIndex(3)
---
>>>    }
1 >^^^^
2 >    ^
...
2 >Emitted(19, 18) Source(16, 18) + SourceIndex(3)
3 >Emitted(19, 19) Source(16, 19) + SourceIndex(3)
4 >Emitted(19, 43) Source(16, 25) + SourceIndex(3)
5 >Emitted(19, 46) Source(16, 19) + SourceIndex(3)
6 >Emitted(19, 60) Source(16, 30) + SourceIndex(3)
7 >Emitted(19, 61) Source(16, 31) + SourceIndex(3)
---
>>>    Object.defineProperty(normalC.prototype, "c", {
1 >^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
2 >Emitted(21, 22) Source(17, 18) + SourceIndex(3)
3 >Emitted(21, 28) Source(17, 19) + SourceIndex(3)
4 >Emitted(21, 42) Source(17, 29) + SourceIndex(3)
5 >Emitted(21, 49) Source(17, 36) + SourceIndex(3)
6 >Emitted(21, 51) Source(17, 38) + SourceIndex(3)
7 >Emitted(21, 52) Source(17, 39) + SourceIndex(3)
8 >Emitted(21, 53) Source(17, 40) + SourceIndex(3)
9 >Emitted(21, 54) Source(17, 41) + SourceIndex(3)
---
>>>        /*@internal*/ set: function (val) { },
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^
...
2 >Emitted(22, 22) Source(18, 18) + SourceIndex(3)
3 >Emitted(22, 28) Source(18, 19) + SourceIndex(3)
4 >Emitted(22, 38) Source(18, 25) + SourceIndex(3)
5 >Emitted(22, 41) Source(18, 36) + SourceIndex(3)
6 >Emitted(22, 45) Source(18, 40) + SourceIndex(3)
7 >Emitted(22, 46) Source(18, 41) + SourceIndex(3)
---
>>>        enumerable: true,
>>>        configurable: true
>>>    });
...
2 >Emitted(30, 18) Source(21, 18) + SourceIndex(3)
3 >Emitted(30, 19) Source(21, 19) + SourceIndex(3)
---
>>>        function C() {
1->^^^^^^^^
2 >        ^^->
...
2 >Emitted(59, 18) Source(25, 18) + SourceIndex(3)
3 >Emitted(59, 19) Source(25, 33) + SourceIndex(3)
4 >Emitted(59, 37) Source(25, 43) + SourceIndex(3)
5 >Emitted(59, 40) Source(25, 46) + SourceIndex(3)
6 >Emitted(59, 53) Source(25, 59) + SourceIndex(3)
7 >Emitted(59, 54) Source(25, 60) + SourceIndex(3)
8 >Emitted(59, 55) Source(25, 61) + SourceIndex(3)
9 >Emitted(59, 56) Source(25, 62) + SourceIndex(3)
---
>>>    /*@internal*/ normalN.internalConst = 10;
1 >^^^^
2 >    ^^^^^^^^^^^^^
...
2 >Emitted(73, 14) Source(31, 14) + SourceIndex(3)
3 >Emitted(73, 15) Source(31, 15) + SourceIndex(3)
4 >Emitted(73, 24) Source(31, 24) + SourceIndex(3)
5 >Emitted(73, 35) Source(31, 35) + SourceIndex(3)
6 >Emitted(73, 40) Source(31, 39) + SourceIndex(3)
7 >Emitted(73, 41) Source(31, 40) + SourceIndex(3)
---
>>>/*@internal*/ var internalNamespace;
1 >
2 >^^^^^^^^^^^^^
...
2 >Emitted(74, 14) Source(32, 14) + SourceIndex(3)
3 >Emitted(74, 15) Source(32, 15) + SourceIndex(3)
4 >Emitted(74, 19) Source(32, 25) + SourceIndex(3)
5 >Emitted(74, 36) Source(32, 42) + SourceIndex(3)
6 >Emitted(74, 37) Source(32, 72) + SourceIndex(3)
---
>>>(function (internalNamespace) {
1 >
2 >^^^^^^^^^^^
...
2 >Emitted(83, 14) Source(33, 14) + SourceIndex(3)
3 >Emitted(83, 15) Source(33, 15) + SourceIndex(3)
4 >Emitted(83, 19) Source(33, 25) + SourceIndex(3)
5 >Emitted(83, 32) Source(33, 38) + SourceIndex(3)
6 >Emitted(83, 33) Source(33, 78) + SourceIndex(3)
---
>>>(function (internalOther) {
1 >
2 >^^^^^^^^^^^
...
2 >Emitted(95, 14) Source(34, 14) + SourceIndex(3)
3 >Emitted(95, 15) Source(34, 15) + SourceIndex(3)
4 >Emitted(95, 19) Source(34, 22) + SourceIndex(3)
5 >Emitted(95, 33) Source(34, 36) + SourceIndex(3)
6 >Emitted(95, 36) Source(34, 39) + SourceIndex(3)
7 >Emitted(95, 53) Source(34, 56) + SourceIndex(3)
8 >Emitted(95, 54) Source(34, 57) + SourceIndex(3)
9 >Emitted(95, 63) Source(34, 66) + SourceIndex(3)
10>Emitted(95, 64) Source(34, 67) + SourceIndex(3)
---
>>>/*@internal*/ var internalConst = 10;
1 >
2 >^^^^^^^^^^^^^
...
2 >Emitted(96, 14) Source(36, 14) + SourceIndex(3)
3 >Emitted(96, 15) Source(36, 15) + SourceIndex(3)
4 >Emitted(96, 19) Source(36, 21) + SourceIndex(3)
5 >Emitted(96, 32) Source(36, 34) + SourceIndex(3)
6 >Emitted(96, 35) Source(36, 37) + SourceIndex(3)
7 >Emitted(96, 37) Source(36, 39) + SourceIndex(3)
8 >Emitted(96, 38) Source(36, 40) + SourceIndex(3)
---
>>>/*@internal*/ var internalEnum;
1 >
2 >^^^^^^^^^^^^^
...
2 >Emitted(97, 14) Source(37, 14) + SourceIndex(3)
3 >Emitted(97, 15) Source(37, 15) + SourceIndex(3)
4 >Emitted(97, 19) Source(37, 20) + SourceIndex(3)
5 >Emitted(97, 31) Source(37, 44) + SourceIndex(3)
---
>>>(function (internalEnum) {
1 >
2 >^^^^^^^^^^^
