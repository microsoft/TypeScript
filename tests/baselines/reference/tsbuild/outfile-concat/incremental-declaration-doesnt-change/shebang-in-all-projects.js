...
8 >               )
9 >                ;
1->Emitted(8, 1) Source(2, 1) + SourceIndex(1)
2 >Emitted(8, 8) Source(2, 8) + SourceIndex(1)
3 >Emitted(8, 9) Source(2, 9) + SourceIndex(1)
4 >Emitted(8, 12) Source(2, 12) + SourceIndex(1)
5 >Emitted(8, 13) Source(2, 13) + SourceIndex(1)
6 >Emitted(8, 14) Source(2, 14) + SourceIndex(1)
7 >Emitted(8, 16) Source(2, 16) + SourceIndex(1)
8 >Emitted(8, 17) Source(2, 17) + SourceIndex(1)
9 >Emitted(8, 18) Source(2, 18) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/first/bin/first-output.js
...
2 >Emitted(12, 5) Source(6, 11) + SourceIndex(3)
3 >Emitted(12, 6) Source(6, 12) + SourceIndex(3)
4 >Emitted(12, 7) Source(12, 2) + SourceIndex(3)
---
>>>(function (N) {
1->
2 >^^^^^^^^^^^
...
2 >Emitted(13, 12) Source(6, 11) + SourceIndex(3)
3 >Emitted(13, 13) Source(6, 12) + SourceIndex(3)
---
>>>    function f() {
1->^^^^
2 >    ^^^^^^^^^
...
2 >    function 
3 >             f
1->Emitted(14, 5) Source(7, 5) + SourceIndex(3)
2 >Emitted(14, 14) Source(7, 14) + SourceIndex(3)
3 >Emitted(14, 15) Source(7, 15) + SourceIndex(3)
---
>>>        console.log('testing');
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                             )
8 >                              ;
1->Emitted(15, 9) Source(8, 9) + SourceIndex(3)
2 >Emitted(15, 16) Source(8, 16) + SourceIndex(3)
3 >Emitted(15, 17) Source(8, 17) + SourceIndex(3)
4 >Emitted(15, 20) Source(8, 20) + SourceIndex(3)
5 >Emitted(15, 21) Source(8, 21) + SourceIndex(3)
6 >Emitted(15, 30) Source(8, 30) + SourceIndex(3)
7 >Emitted(15, 31) Source(8, 31) + SourceIndex(3)
8 >Emitted(15, 32) Source(8, 32) + SourceIndex(3)
---
>>>    }
1 >^^^^
2 >    ^
1 >
  >    
2 >    }
1 >Emitted(16, 5) Source(9, 5) + SourceIndex(3)
2 >Emitted(16, 6) Source(9, 6) + SourceIndex(3)
---
>>>
>>>    f();
1 >^^^^
...
3 >     ()
4 >       ;
1 >Emitted(18, 5) Source(11, 5) + SourceIndex(3)
2 >Emitted(18, 6) Source(11, 6) + SourceIndex(3)
3 >Emitted(18, 8) Source(11, 8) + SourceIndex(3)
4 >Emitted(18, 9) Source(11, 9) + SourceIndex(3)
---
>>>})(N || (N = {}));
1->
2 >^
...
7 >           {
  ...
  >              f();
  >          }
1->Emitted(19, 1) Source(12, 1) + SourceIndex(3)
2 >Emitted(19, 2) Source(12, 2) + SourceIndex(3)
3 >Emitted(19, 4) Source(6, 11) + SourceIndex(3)
4 >Emitted(19, 5) Source(6, 12) + SourceIndex(3)
5 >Emitted(19, 10) Source(6, 11) + SourceIndex(3)
6 >Emitted(19, 11) Source(6, 12) + SourceIndex(3)
7 >Emitted(19, 19) Source(12, 2) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
...
2 >Emitted(28, 5) Source(2, 5) + SourceIndex(5)
3 >Emitted(28, 6) Source(2, 6) + SourceIndex(5)
4 >Emitted(28, 9) Source(2, 9) + SourceIndex(5)
5 >Emitted(28, 13) Source(2, 13) + SourceIndex(5)
6 >Emitted(28, 14) Source(2, 14) + SourceIndex(5)
7 >Emitted(28, 16) Source(2, 16) + SourceIndex(5)
8 >Emitted(28, 17) Source(2, 17) + SourceIndex(5)
---
>>>c.doSomething();
1->
2 >^
...
2 >Emitted(29, 2) Source(3, 2) + SourceIndex(5)
3 >Emitted(29, 3) Source(3, 3) + SourceIndex(5)
4 >Emitted(29, 14) Source(3, 14) + SourceIndex(5)
5 >Emitted(29, 16) Source(3, 16) + SourceIndex(5)
6 >Emitted(29, 17) Source(3, 17) + SourceIndex(5)
---
>>>//# sourceMappingURL=third-output.js.map
...
----------------------------------------------------------------------
prepend: (33-166):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (33-166)
...
----------------------------------------------------------------------
prepend: (166-453):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (166-453)
var N;
(function (N) {
