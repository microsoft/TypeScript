...
2 >Emitted(6, 8) Source(13, 8) + SourceIndex(0)
3 >Emitted(6, 9) Source(13, 9) + SourceIndex(0)
4 >Emitted(6, 12) Source(13, 12) + SourceIndex(0)
5 >Emitted(6, 13) Source(13, 13) + SourceIndex(0)
6 >Emitted(6, 14) Source(13, 14) + SourceIndex(0)
7 >Emitted(6, 15) Source(13, 15) + SourceIndex(0)
8 >Emitted(6, 16) Source(13, 16) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/first/bin/first-output.js
...
8 >               )
9 >                ;
1->Emitted(7, 1) Source(2, 1) + SourceIndex(1)
2 >Emitted(7, 8) Source(2, 8) + SourceIndex(1)
3 >Emitted(7, 9) Source(2, 9) + SourceIndex(1)
4 >Emitted(7, 12) Source(2, 12) + SourceIndex(1)
5 >Emitted(7, 13) Source(2, 13) + SourceIndex(1)
6 >Emitted(7, 14) Source(2, 14) + SourceIndex(1)
7 >Emitted(7, 16) Source(2, 16) + SourceIndex(1)
8 >Emitted(7, 17) Source(2, 17) + SourceIndex(1)
9 >Emitted(7, 18) Source(2, 18) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/first/bin/first-output.js
...
2 >Emitted(27, 5) Source(2, 5) + SourceIndex(5)
3 >Emitted(27, 6) Source(2, 6) + SourceIndex(5)
4 >Emitted(27, 9) Source(2, 9) + SourceIndex(5)
5 >Emitted(27, 13) Source(2, 13) + SourceIndex(5)
6 >Emitted(27, 14) Source(2, 14) + SourceIndex(5)
7 >Emitted(27, 16) Source(2, 16) + SourceIndex(5)
8 >Emitted(27, 17) Source(2, 17) + SourceIndex(5)
---
>>>c.doSomething();
1->
2 >^
...
2 >Emitted(28, 2) Source(3, 2) + SourceIndex(5)
3 >Emitted(28, 3) Source(3, 3) + SourceIndex(5)
4 >Emitted(28, 14) Source(3, 14) + SourceIndex(5)
5 >Emitted(28, 16) Source(3, 16) + SourceIndex(5)
6 >Emitted(28, 17) Source(3, 17) + SourceIndex(5)
---
>>>//# sourceMappingURL=third-output.js.map
...
----------------------------------------------------------------------
prepend: (33-164):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (33-164)
...
----------------------------------------------------------------------
prepend: (164-451):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (164-451)
var N;
(function (N) {
