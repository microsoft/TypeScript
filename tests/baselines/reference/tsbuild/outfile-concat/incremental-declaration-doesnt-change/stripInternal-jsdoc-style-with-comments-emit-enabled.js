...
4 >Emitted(62, 92) Source(28, 51) + SourceIndex(3)
5 >Emitted(62, 93) Source(28, 53) + SourceIndex(3)
6 >Emitted(62, 134) Source(28, 54) + SourceIndex(3)
7 >Emitted(62, 135) Source(28, 54) + SourceIndex(3)
---
>>>    })(internalEnum = normalN.internalEnum || (normalN.internalEnum = {}));
1 >^^^^
2 >    ^
...
8 >                                               internalEnum
9 >                                                                    { a, b, c }
1 >Emitted(63, 5) Source(28, 55) + SourceIndex(3)
2 >Emitted(63, 6) Source(28, 56) + SourceIndex(3)
3 >Emitted(63, 8) Source(28, 32) + SourceIndex(3)
4 >Emitted(63, 20) Source(28, 44) + SourceIndex(3)
5 >Emitted(63, 23) Source(28, 32) + SourceIndex(3)
6 >Emitted(63, 43) Source(28, 44) + SourceIndex(3)
7 >Emitted(63, 48) Source(28, 32) + SourceIndex(3)
8 >Emitted(63, 68) Source(28, 44) + SourceIndex(3)
9 >Emitted(63, 76) Source(28, 56) + SourceIndex(3)
---
>>>})(normalN || (normalN = {}));
1 >
2 >^
...
2 >Emitted(65, 15) Source(30, 15) + SourceIndex(3)
3 >Emitted(65, 16) Source(30, 16) + SourceIndex(3)
---
>>>    function internalC() {}
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
2 >    class internalC {
3 >                          }
1->Emitted(66, 5) Source(30, 16) + SourceIndex(3)
2 >Emitted(66, 27) Source(30, 33) + SourceIndex(3)
3 >Emitted(66, 28) Source(30, 34) + SourceIndex(3)
---
>>>    return internalC;
1 >^^^^
2 >    ^^^^^^^^^^^^^^^^
1 >
2 >    }
1 >Emitted(67, 5) Source(30, 33) + SourceIndex(3)
2 >Emitted(67, 21) Source(30, 34) + SourceIndex(3)
---
>>>}());
1 >
2 >^
...
3 > 
4 > class internalC {}
1 >Emitted(68, 1) Source(30, 33) + SourceIndex(3)
2 >Emitted(68, 2) Source(30, 34) + SourceIndex(3)
3 >Emitted(68, 2) Source(30, 16) + SourceIndex(3)
4 >Emitted(68, 6) Source(30, 34) + SourceIndex(3)
---
>>>/**@internal*/ function internalfoo() { }
1->
2 >^^^^^^^^^^^^^^
...
2 >Emitted(69, 15) Source(31, 15) + SourceIndex(3)
3 >Emitted(69, 16) Source(31, 16) + SourceIndex(3)
4 >Emitted(69, 25) Source(31, 25) + SourceIndex(3)
5 >Emitted(69, 36) Source(31, 36) + SourceIndex(3)
6 >Emitted(69, 41) Source(31, 40) + SourceIndex(3)
7 >Emitted(69, 42) Source(31, 41) + SourceIndex(3)
---
>>>/**@internal*/ var internalNamespace;
1 >
2 >^^^^^^^^^^^^^^
...
2 >Emitted(70, 15) Source(32, 15) + SourceIndex(3)
3 >Emitted(70, 16) Source(32, 16) + SourceIndex(3)
4 >Emitted(70, 20) Source(32, 26) + SourceIndex(3)
5 >Emitted(70, 37) Source(32, 43) + SourceIndex(3)
6 >Emitted(70, 38) Source(32, 73) + SourceIndex(3)
---
>>>(function (internalNamespace) {var someClass = /** @class */ (function () {
1->
2 >^^^^^^^^^^^
...
2 >Emitted(71, 12) Source(32, 26) + SourceIndex(3)
3 >Emitted(71, 29) Source(32, 43) + SourceIndex(3)
4 >Emitted(71, 32) Source(32, 46) + SourceIndex(3)
---
>>>        function someClass() {}
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
...
2 >        export class someClass {
3 >                              }
1->Emitted(72, 9) Source(32, 46) + SourceIndex(3)
2 >Emitted(72, 31) Source(32, 70) + SourceIndex(3)
3 >Emitted(72, 32) Source(32, 71) + SourceIndex(3)
---
>>>        return someClass;
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^
1 >
2 >        }
1 >Emitted(73, 9) Source(32, 70) + SourceIndex(3)
2 >Emitted(73, 25) Source(32, 71) + SourceIndex(3)
---
>>>    }());
1 >^^^^
2 >    ^
...
3 >     
4 >     export class someClass {}
1 >Emitted(74, 5) Source(32, 70) + SourceIndex(3)
2 >Emitted(74, 6) Source(32, 71) + SourceIndex(3)
3 >Emitted(74, 6) Source(32, 46) + SourceIndex(3)
4 >Emitted(74, 10) Source(32, 71) + SourceIndex(3)
---
>>>    internalNamespace.someClass = someClass;
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
3 >                                {}
4 >                                           
1->Emitted(75, 5) Source(32, 59) + SourceIndex(3)
2 >Emitted(75, 32) Source(32, 68) + SourceIndex(3)
3 >Emitted(75, 44) Source(32, 71) + SourceIndex(3)
4 >Emitted(75, 45) Source(32, 71) + SourceIndex(3)
---
>>>})(internalNamespace || (internalNamespace = {}));
1->
2 >^
...
1->Emitted(76, 1) Source(32, 72) + SourceIndex(3)
2 >Emitted(76, 2) Source(32, 73) + SourceIndex(3)
3 >Emitted(76, 4) Source(32, 26) + SourceIndex(3)
4 >Emitted(76, 21) Source(32, 43) + SourceIndex(3)
5 >Emitted(76, 26) Source(32, 26) + SourceIndex(3)
6 >Emitted(76, 43) Source(32, 43) + SourceIndex(3)
7 >Emitted(76, 51) Source(32, 73) + SourceIndex(3)
---
>>>/**@internal*/ var internalOther;
1 >
2 >^^^^^^^^^^^^^^
...
2 >Emitted(77, 15) Source(33, 15) + SourceIndex(3)
3 >Emitted(77, 16) Source(33, 16) + SourceIndex(3)
4 >Emitted(77, 20) Source(33, 26) + SourceIndex(3)
5 >Emitted(77, 33) Source(33, 39) + SourceIndex(3)
6 >Emitted(77, 34) Source(33, 79) + SourceIndex(3)
---
>>>(function (internalOther) {
1 >
2 >^^^^^^^^^^^
...
2 >Emitted(78, 12) Source(33, 26) + SourceIndex(3)
3 >Emitted(78, 25) Source(33, 39) + SourceIndex(3)
---
>>>    var something;
1 >^^^^
2 >    ^^^^
...
2 >Emitted(79, 9) Source(33, 40) + SourceIndex(3)
3 >Emitted(79, 18) Source(33, 49) + SourceIndex(3)
...
2 >Emitted(87, 15) Source(34, 15) + SourceIndex(3)
3 >Emitted(87, 16) Source(34, 16) + SourceIndex(3)
4 >Emitted(87, 20) Source(34, 23) + SourceIndex(3)
5 >Emitted(87, 34) Source(34, 37) + SourceIndex(3)
6 >Emitted(87, 37) Source(34, 40) + SourceIndex(3)
7 >Emitted(87, 54) Source(34, 57) + SourceIndex(3)
8 >Emitted(87, 55) Source(34, 58) + SourceIndex(3)
9 >Emitted(87, 64) Source(34, 67) + SourceIndex(3)
10>Emitted(87, 65) Source(34, 68) + SourceIndex(3)
---
>>>
>>>/**@internal*/ var internalConst = 10;
1 >
...
2 >Emitted(89, 15) Source(36, 15) + SourceIndex(3)
3 >Emitted(89, 16) Source(36, 16) + SourceIndex(3)
4 >Emitted(89, 20) Source(36, 22) + SourceIndex(3)
5 >Emitted(89, 33) Source(36, 35) + SourceIndex(3)
6 >Emitted(89, 36) Source(36, 38) + SourceIndex(3)
7 >Emitted(89, 38) Source(36, 40) + SourceIndex(3)
8 >Emitted(89, 39) Source(36, 41) + SourceIndex(3)
---
>>>/**@internal*/ var internalEnum;
1 >
2 >^^^^^^^^^^^^^^
...
2 >Emitted(90, 15) Source(37, 15) + SourceIndex(3)
3 >Emitted(90, 16) Source(37, 16) + SourceIndex(3)
4 >Emitted(90, 20) Source(37, 21) + SourceIndex(3)
5 >Emitted(90, 32) Source(37, 45) + SourceIndex(3)
---
>>>(function (internalEnum) {
1 >
2 >^^^^^^^^^^^
...
3 >Emitted(92, 47) Source(37, 39) + SourceIndex(3)
4 >Emitted(92, 88) Source(37, 40) + SourceIndex(3)
5 >Emitted(92, 89) Source(37, 42) + SourceIndex(3)
6 >Emitted(92, 130) Source(37, 43) + SourceIndex(3)
7 >Emitted(92, 131) Source(37, 43) + SourceIndex(3)
---
>>>})(internalEnum || (internalEnum = {}));
1 >
2 >^
...
6 >                    internalEnum
7 >                                 { a, b, c }
1 >Emitted(93, 1) Source(37, 44) + SourceIndex(3)
2 >Emitted(93, 2) Source(37, 45) + SourceIndex(3)
3 >Emitted(93, 4) Source(37, 21) + SourceIndex(3)
4 >Emitted(93, 16) Source(37, 33) + SourceIndex(3)
5 >Emitted(93, 21) Source(37, 21) + SourceIndex(3)
6 >Emitted(93, 33) Source(37, 33) + SourceIndex(3)
7 >Emitted(93, 41) Source(37, 45) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
...
----------------------------------------------------------------------
prepend: (0-148):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (0-148)
/**@internal*/ 
...
----------------------------------------------------------------------
prepend: (148-3435):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (148-3435)
var N;
(function (N) {
