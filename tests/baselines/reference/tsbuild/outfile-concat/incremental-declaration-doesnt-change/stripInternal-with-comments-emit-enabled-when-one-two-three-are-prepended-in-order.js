...
4 >Emitted(19, 33) Source(16, 25) + SourceIndex(3)
5 >Emitted(19, 36) Source(16, 19) + SourceIndex(3)
6 >Emitted(19, 50) Source(16, 30) + SourceIndex(3)
7 >Emitted(19, 51) Source(16, 31) + SourceIndex(3)
---
>>>    Object.defineProperty(proto_1, "c", {
1 >^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
3 >Emitted(20, 39) Source(17, 24) + SourceIndex(3)
---
>>>        /*@internal*/ get: function () { return 10; },
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^
