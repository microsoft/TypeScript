...
6 >                                       C
7 >                                        ;
1 >Emitted(54, 5) Source(25, 33) + SourceIndex(3)
2 >Emitted(54, 23) Source(25, 43) + SourceIndex(3)
3 >Emitted(54, 26) Source(25, 46) + SourceIndex(3)
4 >Emitted(54, 39) Source(25, 59) + SourceIndex(3)
5 >Emitted(54, 40) Source(25, 60) + SourceIndex(3)
6 >Emitted(54, 41) Source(25, 61) + SourceIndex(3)
7 >Emitted(54, 42) Source(25, 62) + SourceIndex(3)
---
>>>    normalN.internalConst = 10;
1 >^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^
...
4 >                            10
5 >                              ;
1 >Emitted(55, 5) Source(27, 32) + SourceIndex(3)
2 >Emitted(55, 26) Source(27, 45) + SourceIndex(3)
3 >Emitted(55, 29) Source(27, 48) + SourceIndex(3)
4 >Emitted(55, 31) Source(27, 50) + SourceIndex(3)
5 >Emitted(55, 32) Source(27, 51) + SourceIndex(3)
---
>>>    var internalEnum;
1 >^^^^
2 >    ^^^^
...
2 >Emitted(56, 9) Source(28, 31) + SourceIndex(3)
3 >Emitted(56, 21) Source(28, 55) + SourceIndex(3)
---
>>>    (function (internalEnum) {
1->^^^^
2 >    ^^^^^^^^^^^
...
7 >                                       someClass
8 >                                                ;
1->Emitted(84, 1) Source(34, 15) + SourceIndex(3)
2 >Emitted(84, 5) Source(34, 22) + SourceIndex(3)
3 >Emitted(84, 19) Source(34, 36) + SourceIndex(3)
4 >Emitted(84, 22) Source(34, 39) + SourceIndex(3)
5 >Emitted(84, 39) Source(34, 56) + SourceIndex(3)
6 >Emitted(84, 40) Source(34, 57) + SourceIndex(3)
7 >Emitted(84, 49) Source(34, 66) + SourceIndex(3)
8 >Emitted(84, 50) Source(34, 67) + SourceIndex(3)
---
>>>
>>>var internalConst = 10;
1 >
...
5 >                    10
6 >                      ;
1 >Emitted(86, 1) Source(36, 15) + SourceIndex(3)
2 >Emitted(86, 5) Source(36, 21) + SourceIndex(3)
3 >Emitted(86, 18) Source(36, 34) + SourceIndex(3)
4 >Emitted(86, 21) Source(36, 37) + SourceIndex(3)
5 >Emitted(86, 23) Source(36, 39) + SourceIndex(3)
6 >Emitted(86, 24) Source(36, 40) + SourceIndex(3)
---
>>>var internalEnum;
1 >
2 >^^^^
...
2 >Emitted(87, 5) Source(37, 20) + SourceIndex(3)
3 >Emitted(87, 17) Source(37, 44) + SourceIndex(3)
---
>>>(function (internalEnum) {
1->
2 >^^^^^^^^^^^
