...
2 >    constructor() { 
3 >                        }
1->Emitted(20, 5) Source(14, 19) + SourceIndex(3)
2 >Emitted(20, 25) Source(14, 35) + SourceIndex(3)
3 >Emitted(20, 26) Source(14, 36) + SourceIndex(3)
---
>>>
>>>    normalC.prototype.method = function () { };
1 >^^^^
...
4 >                               method() { 
5 >                                             }
1 >Emitted(22, 5) Source(16, 19) + SourceIndex(3)
2 >Emitted(22, 29) Source(16, 25) + SourceIndex(3)
3 >Emitted(22, 32) Source(16, 19) + SourceIndex(3)
4 >Emitted(22, 46) Source(16, 30) + SourceIndex(3)
5 >Emitted(22, 47) Source(16, 31) + SourceIndex(3)
---
>>>    Object.defineProperty(normalC.prototype, "c", {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
6 >                                      
7 >                                      }
1 >Emitted(24, 14) Source(17, 19) + SourceIndex(3)
2 >Emitted(24, 28) Source(17, 29) + SourceIndex(3)
3 >Emitted(24, 35) Source(17, 36) + SourceIndex(3)
4 >Emitted(24, 37) Source(17, 38) + SourceIndex(3)
5 >Emitted(24, 38) Source(17, 39) + SourceIndex(3)
6 >Emitted(24, 39) Source(17, 40) + SourceIndex(3)
7 >Emitted(24, 40) Source(17, 41) + SourceIndex(3)
---
>>>        set: function (val) { },
1 >^^^^^^^^^^^^^
2 >             ^^^^^^^^^^
...
4 >                          ) { 
5 >                              }
1 >Emitted(25, 14) Source(18, 19) + SourceIndex(3)
2 >Emitted(25, 24) Source(18, 25) + SourceIndex(3)
3 >Emitted(25, 27) Source(18, 36) + SourceIndex(3)
4 >Emitted(25, 31) Source(18, 40) + SourceIndex(3)
5 >Emitted(25, 32) Source(18, 41) + SourceIndex(3)
---
>>>        enumerable: false,
>>>        configurable: true
>>>    });
...
1-> {
  >    /*@internal*/ 
1->Emitted(33, 5) Source(21, 19) + SourceIndex(3)
---
>>>        function C() {}
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^
...
4 >                () {
5 >                     }
1->Emitted(38, 5) Source(22, 19) + SourceIndex(3)
2 >Emitted(38, 14) Source(22, 35) + SourceIndex(3)
3 >Emitted(38, 17) Source(22, 38) + SourceIndex(3)
4 >Emitted(38, 22) Source(22, 42) + SourceIndex(3)
5 >Emitted(38, 23) Source(22, 43) + SourceIndex(3)
---
>>>    normalN.foo = foo;
1->^^^^
2 >    ^^^^^^^^^^^
...
2 >Emitted(40, 9) Source(23, 36) + SourceIndex(3)
3 >Emitted(40, 22) Source(23, 49) + SourceIndex(3)
4 >Emitted(40, 23) Source(23, 71) + SourceIndex(3)
---
>>>    (function (someNamespace) {var C = (function () {
1->^^^^
2 >    ^^^^^^^^^^^
...
2 >Emitted(79, 5) Source(33, 25) + SourceIndex(3)
3 >Emitted(79, 18) Source(33, 38) + SourceIndex(3)
...
7 >                                       someClass
8 >                                                ;
1->Emitted(89, 1) Source(34, 15) + SourceIndex(3)
2 >Emitted(89, 5) Source(34, 22) + SourceIndex(3)
3 >Emitted(89, 19) Source(34, 36) + SourceIndex(3)
4 >Emitted(89, 22) Source(34, 39) + SourceIndex(3)
5 >Emitted(89, 39) Source(34, 56) + SourceIndex(3)
6 >Emitted(89, 40) Source(34, 57) + SourceIndex(3)
7 >Emitted(89, 49) Source(34, 66) + SourceIndex(3)
8 >Emitted(89, 50) Source(34, 67) + SourceIndex(3)
---
>>>
>>>var internalConst = 10;
1 >
...
5 >                    10
6 >                      ;
1 >Emitted(91, 1) Source(36, 15) + SourceIndex(3)
2 >Emitted(91, 5) Source(36, 21) + SourceIndex(3)
3 >Emitted(91, 18) Source(36, 34) + SourceIndex(3)
4 >Emitted(91, 21) Source(36, 37) + SourceIndex(3)
5 >Emitted(91, 23) Source(36, 39) + SourceIndex(3)
6 >Emitted(91, 24) Source(36, 40) + SourceIndex(3)
---
>>>var internalEnum;
1 >
2 >^^^^
...
2 >Emitted(92, 5) Source(37, 20) + SourceIndex(3)
3 >Emitted(92, 17) Source(37, 44) + SourceIndex(3)
---
>>>(function (internalEnum) {
1->
2 >^^^^^^^^^^^
