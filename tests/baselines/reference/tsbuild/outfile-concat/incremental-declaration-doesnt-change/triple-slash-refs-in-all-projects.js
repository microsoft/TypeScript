...
2 >Emitted(7, 5) Source(2, 7) + SourceIndex(1)
3 >Emitted(7, 21) Source(2, 23) + SourceIndex(1)
4 >Emitted(7, 24) Source(2, 26) + SourceIndex(1)
5 >Emitted(7, 28) Source(2, 30) + SourceIndex(1)
6 >Emitted(7, 44) Source(2, 46) + SourceIndex(1)
7 >Emitted(7, 46) Source(2, 48) + SourceIndex(1)
8 >Emitted(7, 47) Source(2, 49) + SourceIndex(1)
---
>>>console.log(f());
1 >
2 >^^^^^^^
...
2 >Emitted(8, 8) Source(3, 8) + SourceIndex(1)
3 >Emitted(8, 9) Source(3, 9) + SourceIndex(1)
4 >Emitted(8, 12) Source(3, 12) + SourceIndex(1)
5 >Emitted(8, 13) Source(3, 13) + SourceIndex(1)
6 >Emitted(8, 14) Source(3, 14) + SourceIndex(1)
7 >Emitted(8, 16) Source(3, 16) + SourceIndex(1)
8 >Emitted(8, 17) Source(3, 17) + SourceIndex(1)
9 >Emitted(8, 18) Source(3, 18) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/first/bin/first-output.js
...
7 >                                              ()
8 >                                                ;
1->Emitted(12, 1) Source(2, 1) + SourceIndex(3)
2 >Emitted(12, 5) Source(2, 7) + SourceIndex(3)
3 >Emitted(12, 22) Source(2, 24) + SourceIndex(3)
4 >Emitted(12, 25) Source(2, 27) + SourceIndex(3)
5 >Emitted(12, 29) Source(2, 31) + SourceIndex(3)
6 >Emitted(12, 47) Source(2, 49) + SourceIndex(3)
7 >Emitted(12, 49) Source(2, 51) + SourceIndex(3)
8 >Emitted(12, 50) Source(2, 52) + SourceIndex(3)
---
>>>var N;
1 >
2 >^^^^
...
2 >Emitted(13, 5) Source(7, 11) + SourceIndex(3)
3 >Emitted(13, 6) Source(7, 12) + SourceIndex(3)
4 >Emitted(13, 7) Source(13, 2) + SourceIndex(3)
---
>>>(function (N) {
1->
2 >^^^^^^^^^^^
...
2 >Emitted(14, 12) Source(7, 11) + SourceIndex(3)
3 >Emitted(14, 13) Source(7, 12) + SourceIndex(3)
---
>>>    function f() {
1->^^^^
2 >    ^^^^^^^^^
...
2 >Emitted(15, 14) Source(8, 14) + SourceIndex(3)
3 >Emitted(15, 15) Source(8, 15) + SourceIndex(3)
---
>>>        console.log('testing');
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                             )
8 >                              ;
1->Emitted(16, 9) Source(9, 9) + SourceIndex(3)
2 >Emitted(16, 16) Source(9, 16) + SourceIndex(3)
3 >Emitted(16, 17) Source(9, 17) + SourceIndex(3)
4 >Emitted(16, 20) Source(9, 20) + SourceIndex(3)
5 >Emitted(16, 21) Source(9, 21) + SourceIndex(3)
6 >Emitted(16, 30) Source(9, 30) + SourceIndex(3)
7 >Emitted(16, 31) Source(9, 31) + SourceIndex(3)
8 >Emitted(16, 32) Source(9, 32) + SourceIndex(3)
---
>>>    }
1 >^^^^
2 >    ^
...
3 >     ()
4 >       ;
1 >Emitted(19, 5) Source(12, 5) + SourceIndex(3)
2 >Emitted(19, 6) Source(12, 6) + SourceIndex(3)
3 >Emitted(19, 8) Source(12, 8) + SourceIndex(3)
4 >Emitted(19, 9) Source(12, 9) + SourceIndex(3)
---
>>>})(N || (N = {}));
1->
2 >^
...
2 >Emitted(20, 2) Source(13, 2) + SourceIndex(3)
3 >Emitted(20, 4) Source(7, 11) + SourceIndex(3)
4 >Emitted(20, 5) Source(7, 12) + SourceIndex(3)
5 >Emitted(20, 10) Source(7, 11) + SourceIndex(3)
6 >Emitted(20, 11) Source(7, 12) + SourceIndex(3)
7 >Emitted(20, 19) Source(13, 2) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
...
2 >    ^^->
1->
1->Emitted(22, 5) Source(1, 1) + SourceIndex(4)
---
>>>    }
1->^^^^
2 >    ^
...
2 >Emitted(23, 6) Source(5, 2) + SourceIndex(4)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >Emitted(24, 28) Source(2, 16) + SourceIndex(4)
3 >Emitted(24, 31) Source(2, 5) + SourceIndex(4)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(25, 9) Source(3, 9) + SourceIndex(4)
2 >Emitted(25, 16) Source(3, 16) + SourceIndex(4)
3 >Emitted(25, 17) Source(3, 17) + SourceIndex(4)
4 >Emitted(25, 20) Source(3, 20) + SourceIndex(4)
5 >Emitted(25, 21) Source(3, 21) + SourceIndex(4)
6 >Emitted(25, 41) Source(3, 41) + SourceIndex(4)
7 >Emitted(25, 42) Source(3, 42) + SourceIndex(4)
8 >Emitted(25, 43) Source(3, 43) + SourceIndex(4)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(26, 5) Source(4, 5) + SourceIndex(4)
2 >Emitted(26, 6) Source(4, 6) + SourceIndex(4)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
1->
  >
2 >    }
1->Emitted(27, 5) Source(5, 1) + SourceIndex(4)
2 >Emitted(27, 13) Source(5, 2) + SourceIndex(4)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(28, 1) Source(5, 1) + SourceIndex(4)
2 >Emitted(28, 2) Source(5, 2) + SourceIndex(4)
3 >Emitted(28, 2) Source(1, 1) + SourceIndex(4)
4 >Emitted(28, 6) Source(5, 2) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
...
2 >Emitted(29, 5) Source(2, 7) + SourceIndex(5)
3 >Emitted(29, 21) Source(2, 23) + SourceIndex(5)
4 >Emitted(29, 24) Source(2, 26) + SourceIndex(5)
5 >Emitted(29, 28) Source(2, 30) + SourceIndex(5)
6 >Emitted(29, 44) Source(2, 46) + SourceIndex(5)
7 >Emitted(29, 46) Source(2, 48) + SourceIndex(5)
8 >Emitted(29, 47) Source(2, 49) + SourceIndex(5)
---
>>>var c = new C();
1 >
2 >^^^^
...
7 >             ()
8 >               ;
1 >Emitted(30, 1) Source(3, 1) + SourceIndex(5)
2 >Emitted(30, 5) Source(3, 5) + SourceIndex(5)
3 >Emitted(30, 6) Source(3, 6) + SourceIndex(5)
4 >Emitted(30, 9) Source(3, 9) + SourceIndex(5)
5 >Emitted(30, 13) Source(3, 13) + SourceIndex(5)
6 >Emitted(30, 14) Source(3, 14) + SourceIndex(5)
7 >Emitted(30, 16) Source(3, 16) + SourceIndex(5)
8 >Emitted(30, 17) Source(3, 17) + SourceIndex(5)
---
>>>c.doSomething();
1->
2 >^
...
5 >             ()
6 >               ;
1->Emitted(31, 1) Source(4, 1) + SourceIndex(5)
2 >Emitted(31, 2) Source(4, 2) + SourceIndex(5)
3 >Emitted(31, 3) Source(4, 3) + SourceIndex(5)
4 >Emitted(31, 14) Source(4, 14) + SourceIndex(5)
5 >Emitted(31, 16) Source(4, 16) + SourceIndex(5)
6 >Emitted(31, 17) Source(4, 17) + SourceIndex(5)
---
>>>//# sourceMappingURL=third-output.js.map
...
----------------------------------------------------------------------
prepend: (0-181):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (0-181)
...
----------------------------------------------------------------------
prepend: (181-519):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (181-519)
var second_part1Const = new secondsecond_part1();
var N;
