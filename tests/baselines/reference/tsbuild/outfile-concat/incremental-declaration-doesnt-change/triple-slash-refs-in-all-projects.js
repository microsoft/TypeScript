...
3 >Emitted(22, 6) Source(2, 5) + SourceIndex(4)
4 >Emitted(22, 29) Source(2, 16) + SourceIndex(4)
5 >Emitted(22, 32) Source(2, 5) + SourceIndex(4)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
----------------------------------------------------------------------
prepend: (0-179):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (0-179)
...
----------------------------------------------------------------------
prepend: (179-511):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (179-511)
var second_part1Const = new secondsecond_part1();
var N;
