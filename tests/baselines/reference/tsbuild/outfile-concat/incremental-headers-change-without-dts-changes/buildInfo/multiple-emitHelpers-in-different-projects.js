...
----------------------------------------------------------------------
prepend: (1095-1285):: /src/first/bin/first-output.js texts:: 2
>>--------------------------------------------------------------------
text: (1095-1245)
var s = "Hello, world";
console.log(s);
...
>>--------------------------------------------------------------------
sourceMapUrl: (1245-1285)
//# sourceMappingURL=first-output.js.map
----------------------------------------------------------------------
prepend: (1287-1829):: /src/2/second-output.js texts:: 2
>>--------------------------------------------------------------------
text: (1287-1788)
var N;
(function (N) {
...
2 >function 
3 >         secondsecond_part1Spread
1->Emitted(45, 1) Source(13, 1) + SourceIndex(3)
2 >Emitted(45, 10) Source(13, 10) + SourceIndex(3)
3 >Emitted(45, 34) Source(13, 34) + SourceIndex(3)
---
>>>    var b = [];
1 >^^^^
2 >    ^^^^^^^^^^^
...
1 >(
2 >    ...b: number[]
1 >Emitted(46, 5) Source(13, 35) + SourceIndex(3)
2 >Emitted(46, 16) Source(13, 49) + SourceIndex(3)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
5 >                                          
6 >                                            ...b: number[]
1->Emitted(47, 10) Source(13, 35) + SourceIndex(3)
2 >Emitted(47, 20) Source(13, 49) + SourceIndex(3)
3 >Emitted(47, 22) Source(13, 35) + SourceIndex(3)
4 >Emitted(47, 43) Source(13, 49) + SourceIndex(3)
5 >Emitted(47, 45) Source(13, 35) + SourceIndex(3)
6 >Emitted(47, 49) Source(13, 49) + SourceIndex(3)
---
>>>        b[_i] = arguments[_i];
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
1 >
2 >        ...b: number[]
1 >Emitted(48, 9) Source(13, 35) + SourceIndex(3)
2 >Emitted(48, 31) Source(13, 49) + SourceIndex(3)
---
>>>    }
>>>}
1 >
...
1 >) { 
2 >}
1 >Emitted(50, 1) Source(13, 53) + SourceIndex(3)
2 >Emitted(50, 2) Source(13, 54) + SourceIndex(3)
---
>>>secondsecond_part1Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^^^
...
10>                                                           ]
11>                                                            );
1->Emitted(51, 1) Source(14, 1) + SourceIndex(3)
2 >Emitted(51, 25) Source(14, 25) + SourceIndex(3)
3 >Emitted(51, 49) Source(14, 29) + SourceIndex(3)
4 >Emitted(51, 50) Source(14, 30) + SourceIndex(3)
5 >Emitted(51, 52) Source(14, 32) + SourceIndex(3)
6 >Emitted(51, 54) Source(14, 34) + SourceIndex(3)
7 >Emitted(51, 56) Source(14, 36) + SourceIndex(3)
8 >Emitted(51, 58) Source(14, 38) + SourceIndex(3)
9 >Emitted(51, 60) Source(14, 40) + SourceIndex(3)
10>Emitted(51, 61) Source(14, 41) + SourceIndex(3)
11>Emitted(51, 64) Source(14, 43) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
2 >Emitted(63, 10) Source(3, 10) + SourceIndex(5)
3 >Emitted(63, 33) Source(3, 33) + SourceIndex(5)
---
>>>    var _a = { a: 10, b: 30, yy: 30 }, b = _a.b, rest = __rest(_a, ["b"]);
1->^^^^
2 >    ^^^^
...
1 >
  >
2 >}
1 >Emitted(65, 1) Source(5, 1) + SourceIndex(5)
2 >Emitted(65, 2) Source(5, 2) + SourceIndex(5)
---
>>>//# sourceMappingURL=third-output.js.map
