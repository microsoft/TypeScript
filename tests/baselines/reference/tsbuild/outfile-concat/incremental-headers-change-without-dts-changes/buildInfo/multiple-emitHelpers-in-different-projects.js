...
----------------------------------------------------------------------
prepend: (1095-1245):: /src/first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1095-1245)
var s = "Hello, world";
console.log(s);
...
----------------------------------------------------------------------
prepend: (1245-1746):: /src/2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1245-1746)
var N;
(function (N) {
...
4 >      {
  ...
  >         f();
  >     }
1->Emitted(37, 1) Source(5, 1) + SourceIndex(3)
2 >Emitted(37, 5) Source(5, 11) + SourceIndex(3)
3 >Emitted(37, 6) Source(5, 12) + SourceIndex(3)
4 >Emitted(37, 7) Source(11, 2) + SourceIndex(3)
---
>>>(function (N) {
1->
2 >^^^^^^^^^^^
...
2 >Emitted(38, 12) Source(5, 11) + SourceIndex(3)
3 >Emitted(38, 13) Source(5, 12) + SourceIndex(3)
---
>>>    function f() {
1->^^^^
2 >    ^^^^^^^^^
...
2 >    function 
3 >             f
1->Emitted(39, 5) Source(6, 5) + SourceIndex(3)
2 >Emitted(39, 14) Source(6, 14) + SourceIndex(3)
3 >Emitted(39, 15) Source(6, 15) + SourceIndex(3)
---
>>>        console.log('testing');
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                             )
8 >                              ;
1->Emitted(40, 9) Source(7, 9) + SourceIndex(3)
2 >Emitted(40, 16) Source(7, 16) + SourceIndex(3)
3 >Emitted(40, 17) Source(7, 17) + SourceIndex(3)
4 >Emitted(40, 20) Source(7, 20) + SourceIndex(3)
5 >Emitted(40, 21) Source(7, 21) + SourceIndex(3)
6 >Emitted(40, 30) Source(7, 30) + SourceIndex(3)
7 >Emitted(40, 31) Source(7, 31) + SourceIndex(3)
8 >Emitted(40, 32) Source(7, 32) + SourceIndex(3)
---
>>>    }
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(41, 5) Source(8, 5) + SourceIndex(3)
2 >Emitted(41, 6) Source(8, 6) + SourceIndex(3)
---
>>>    f();
1->^^^^
2 >    ^
...
3 >     ()
4 >       ;
1->Emitted(42, 5) Source(10, 5) + SourceIndex(3)
2 >Emitted(42, 6) Source(10, 6) + SourceIndex(3)
3 >Emitted(42, 8) Source(10, 8) + SourceIndex(3)
4 >Emitted(42, 9) Source(10, 9) + SourceIndex(3)
---
>>>})(N || (N = {}));
1->
2 >^
...
7 >           {
  ...
  >              f();
  >          }
1->Emitted(43, 1) Source(11, 1) + SourceIndex(3)
2 >Emitted(43, 2) Source(11, 2) + SourceIndex(3)
3 >Emitted(43, 4) Source(5, 11) + SourceIndex(3)
4 >Emitted(43, 5) Source(5, 12) + SourceIndex(3)
5 >Emitted(43, 10) Source(5, 11) + SourceIndex(3)
6 >Emitted(43, 11) Source(5, 12) + SourceIndex(3)
7 >Emitted(43, 19) Source(11, 2) + SourceIndex(3)
---
>>>function secondsecond_part1Spread() {
1->
2 >^^^^^^^^^
...
2 >function 
3 >         secondsecond_part1Spread
1->Emitted(44, 1) Source(13, 1) + SourceIndex(3)
2 >Emitted(44, 10) Source(13, 10) + SourceIndex(3)
3 >Emitted(44, 34) Source(13, 34) + SourceIndex(3)
---
>>>    var b = [];
1 >^^^^
2 >    ^^^^^^^^^^^
...
1 >(
2 >    ...b: number[]
1 >Emitted(45, 5) Source(13, 35) + SourceIndex(3)
2 >Emitted(45, 16) Source(13, 49) + SourceIndex(3)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
5 >                                          
6 >                                            ...b: number[]
1->Emitted(46, 10) Source(13, 35) + SourceIndex(3)
2 >Emitted(46, 20) Source(13, 49) + SourceIndex(3)
3 >Emitted(46, 22) Source(13, 35) + SourceIndex(3)
4 >Emitted(46, 43) Source(13, 49) + SourceIndex(3)
5 >Emitted(46, 45) Source(13, 35) + SourceIndex(3)
6 >Emitted(46, 49) Source(13, 49) + SourceIndex(3)
---
>>>        b[_i] = arguments[_i];
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
1 >
2 >        ...b: number[]
1 >Emitted(47, 9) Source(13, 35) + SourceIndex(3)
2 >Emitted(47, 31) Source(13, 49) + SourceIndex(3)
---
>>>    }
>>>}
1 >
...
1 >) { 
2 >}
1 >Emitted(49, 1) Source(13, 53) + SourceIndex(3)
2 >Emitted(49, 2) Source(13, 54) + SourceIndex(3)
---
>>>secondsecond_part1Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^^^
...
3 >Emitted(62, 38) Source(4, 48) + SourceIndex(5)
4 >Emitted(62, 40) Source(4, 9) + SourceIndex(5)
5 >Emitted(62, 48) Source(4, 10) + SourceIndex(5)
6 >Emitted(62, 50) Source(4, 12) + SourceIndex(5)
7 >Emitted(62, 74) Source(4, 48) + SourceIndex(5)
8 >Emitted(62, 75) Source(4, 49) + SourceIndex(5)
---
>>>}
1 >
2 >^
