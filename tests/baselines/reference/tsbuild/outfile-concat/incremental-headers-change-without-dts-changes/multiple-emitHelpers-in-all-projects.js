...
2 >Emitted(23, 5) Source(5, 7) + SourceIndex(0)
3 >Emitted(23, 6) Source(5, 8) + SourceIndex(0)
4 >Emitted(23, 9) Source(5, 11) + SourceIndex(0)
5 >Emitted(23, 23) Source(5, 25) + SourceIndex(0)
6 >Emitted(23, 24) Source(5, 26) + SourceIndex(0)
---
>>>
>>>console.log(s);
1 >
...
2 >Emitted(36, 5) Source(5, 7) + SourceIndex(2)
3 >Emitted(36, 24) Source(5, 26) + SourceIndex(2)
4 >Emitted(36, 27) Source(5, 29) + SourceIndex(2)
5 >Emitted(36, 28) Source(5, 30) + SourceIndex(2)
6 >Emitted(36, 30) Source(5, 32) + SourceIndex(2)
7 >Emitted(36, 32) Source(5, 34) + SourceIndex(2)
8 >Emitted(36, 34) Source(5, 36) + SourceIndex(2)
9 >Emitted(36, 35) Source(5, 37) + SourceIndex(2)
10>Emitted(36, 36) Source(5, 38) + SourceIndex(2)
---
>>>firstfirst_part3Spread.apply(void 0, __spreadArray([10], __read(firstfirst_part3_ar)));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^
...
7 >                                                                                   );
1->Emitted(37, 1) Source(6, 1) + SourceIndex(2)
2 >Emitted(37, 23) Source(6, 23) + SourceIndex(2)
3 >Emitted(37, 53) Source(6, 24) + SourceIndex(2)
4 >Emitted(37, 55) Source(6, 26) + SourceIndex(2)
5 >Emitted(37, 65) Source(6, 31) + SourceIndex(2)
6 >Emitted(37, 84) Source(6, 50) + SourceIndex(2)
7 >Emitted(37, 88) Source(6, 52) + SourceIndex(2)
---
>>>//# sourceMappingURL=first-output.js.map
...
2 >Emitted(47, 5) Source(5, 7) + SourceIndex(2)
3 >Emitted(47, 24) Source(5, 26) + SourceIndex(2)
4 >Emitted(47, 27) Source(5, 29) + SourceIndex(2)
5 >Emitted(47, 28) Source(5, 30) + SourceIndex(2)
6 >Emitted(47, 30) Source(5, 32) + SourceIndex(2)
7 >Emitted(47, 32) Source(5, 34) + SourceIndex(2)
8 >Emitted(47, 34) Source(5, 36) + SourceIndex(2)
9 >Emitted(47, 35) Source(5, 37) + SourceIndex(2)
10>Emitted(47, 36) Source(5, 38) + SourceIndex(2)
---
>>>firstfirst_part3Spread.apply(void 0, __spreadArray([10], __read(firstfirst_part3_ar)));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^
...
6 >                                                                firstfirst_part3_ar
7 >                                                                                   );
1->Emitted(48, 1) Source(6, 1) + SourceIndex(2)
2 >Emitted(48, 23) Source(6, 23) + SourceIndex(2)
3 >Emitted(48, 53) Source(6, 24) + SourceIndex(2)
4 >Emitted(48, 55) Source(6, 26) + SourceIndex(2)
5 >Emitted(48, 65) Source(6, 31) + SourceIndex(2)
6 >Emitted(48, 84) Source(6, 50) + SourceIndex(2)
7 >Emitted(48, 88) Source(6, 52) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part1.ts
...
2 >Emitted(73, 5) Source(8, 7) + SourceIndex(4)
3 >Emitted(73, 26) Source(8, 28) + SourceIndex(4)
4 >Emitted(73, 29) Source(8, 31) + SourceIndex(4)
5 >Emitted(73, 30) Source(8, 32) + SourceIndex(4)
6 >Emitted(73, 32) Source(8, 34) + SourceIndex(4)
7 >Emitted(73, 34) Source(8, 36) + SourceIndex(4)
8 >Emitted(73, 36) Source(8, 38) + SourceIndex(4)
9 >Emitted(73, 37) Source(8, 39) + SourceIndex(4)
10>Emitted(73, 38) Source(8, 40) + SourceIndex(4)
---
>>>secondsecond_part2Spread.apply(void 0, __spreadArray([10], __read(secondsecond_part2_ar)));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^^^
...
7 >                                                                                       );
1->Emitted(74, 1) Source(9, 1) + SourceIndex(4)
2 >Emitted(74, 25) Source(9, 25) + SourceIndex(4)
3 >Emitted(74, 55) Source(9, 26) + SourceIndex(4)
4 >Emitted(74, 57) Source(9, 28) + SourceIndex(4)
5 >Emitted(74, 67) Source(9, 33) + SourceIndex(4)
6 >Emitted(74, 88) Source(9, 54) + SourceIndex(4)
7 >Emitted(74, 92) Source(9, 56) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../third_part1.ts
...
----------------------------------------------------------------------
prepend: (1201-1622):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1201-1622)
...
firstfirst_part3Spread.apply(void 0, __spreadArray([10], __read(firstfirst_part3_ar)));
----------------------------------------------------------------------
prepend: (1624-2305):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1624-2305)
var N;
(function (N) {
