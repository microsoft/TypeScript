...
{"version":3,"file":"first-output.js","sourceRoot":"","sources":["../first_PART1.ts","../first_part2.ts","../first_part3.ts"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;AAIA,IAAM,CAAC,GAAG,cAAc,CAAC;AAMzB,OAAO,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC;AACf,SAAS,uBAAuB,KAAK,CAAC;ACXtC,OAAO,CAAC,GAAG,CAAC,CAAC,EAAE,CAAC,CAAC;ACAjB,SAAS,CAAC;IACN,OAAO,gBAAgB,CAAC;AAC5B,CAAC;AACD,SAAS,sBAAsB,KAAmB,CAAC;AACnD,sBAAsB,wBAAI,CAAC,EAAE,EAAE,EAAE,EAAE,EAAE,CAAC,GAAE"}
...
4 >Emitted(28, 37) Source(4, 51) + SourceIndex(2)
5 >Emitted(28, 38) Source(4, 52) + SourceIndex(2)
---
>>>firstfirst_part3Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^
...
10>                                                         ]
11>                                                          );
1->Emitted(29, 1) Source(5, 1) + SourceIndex(2)
2 >Emitted(29, 23) Source(5, 23) + SourceIndex(2)
3 >Emitted(29, 47) Source(5, 27) + SourceIndex(2)
4 >Emitted(29, 48) Source(5, 28) + SourceIndex(2)
5 >Emitted(29, 50) Source(5, 30) + SourceIndex(2)
6 >Emitted(29, 52) Source(5, 32) + SourceIndex(2)
7 >Emitted(29, 54) Source(5, 34) + SourceIndex(2)
8 >Emitted(29, 56) Source(5, 36) + SourceIndex(2)
9 >Emitted(29, 58) Source(5, 38) + SourceIndex(2)
10>Emitted(29, 59) Source(5, 39) + SourceIndex(2)
11>Emitted(29, 62) Source(5, 41) + SourceIndex(2)
---
>>>//# sourceMappingURL=first-output.js.map
...
4 >Emitted(39, 37) Source(4, 51) + SourceIndex(2)
5 >Emitted(39, 38) Source(4, 52) + SourceIndex(2)
---
>>>firstfirst_part3Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^
...
2 >Emitted(40, 23) Source(5, 23) + SourceIndex(2)
3 >Emitted(40, 47) Source(5, 27) + SourceIndex(2)
4 >Emitted(40, 48) Source(5, 28) + SourceIndex(2)
5 >Emitted(40, 50) Source(5, 30) + SourceIndex(2)
6 >Emitted(40, 52) Source(5, 32) + SourceIndex(2)
7 >Emitted(40, 54) Source(5, 34) + SourceIndex(2)
8 >Emitted(40, 56) Source(5, 36) + SourceIndex(2)
9 >Emitted(40, 58) Source(5, 38) + SourceIndex(2)
10>Emitted(40, 59) Source(5, 39) + SourceIndex(2)
11>Emitted(40, 62) Source(5, 41) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part1.ts
...
2 >function 
3 >         forsecondsecond_part1Rest
1->Emitted(48, 1) Source(12, 1) + SourceIndex(3)
2 >Emitted(48, 10) Source(12, 10) + SourceIndex(3)
3 >Emitted(48, 35) Source(12, 35) + SourceIndex(3)
---
>>>    var _a = { a: 10, b: 30, yy: 30 }, b = _a.b, rest = __rest(_a, ["b"]);
1->^^^^
2 >    ^^^^
...
24>                                                                         = { a: 10, b: 30, yy: 30 }
25>                                                                         ;
1->Emitted(49, 5) Source(13, 1) + SourceIndex(3)
2 >Emitted(49, 9) Source(13, 7) + SourceIndex(3)
3 >Emitted(49, 14) Source(13, 24) + SourceIndex(3)
4 >Emitted(49, 16) Source(13, 26) + SourceIndex(3)
5 >Emitted(49, 17) Source(13, 27) + SourceIndex(3)
6 >Emitted(49, 19) Source(13, 29) + SourceIndex(3)
7 >Emitted(49, 21) Source(13, 31) + SourceIndex(3)
8 >Emitted(49, 23) Source(13, 33) + SourceIndex(3)
9 >Emitted(49, 24) Source(13, 34) + SourceIndex(3)
10>Emitted(49, 26) Source(13, 36) + SourceIndex(3)
11>Emitted(49, 28) Source(13, 38) + SourceIndex(3)
12>Emitted(49, 30) Source(13, 40) + SourceIndex(3)
13>Emitted(49, 32) Source(13, 42) + SourceIndex(3)
14>Emitted(49, 34) Source(13, 44) + SourceIndex(3)
15>Emitted(49, 36) Source(13, 46) + SourceIndex(3)
16>Emitted(49, 38) Source(13, 48) + SourceIndex(3)
17>Emitted(49, 40) Source(13, 9) + SourceIndex(3)
18>Emitted(49, 41) Source(13, 10) + SourceIndex(3)
19>Emitted(49, 48) Source(13, 10) + SourceIndex(3)
20>Emitted(49, 50) Source(13, 15) + SourceIndex(3)
21>Emitted(49, 54) Source(13, 19) + SourceIndex(3)
22>Emitted(49, 68) Source(13, 7) + SourceIndex(3)
23>Emitted(49, 73) Source(13, 21) + SourceIndex(3)
24>Emitted(49, 74) Source(13, 48) + SourceIndex(3)
25>Emitted(49, 75) Source(13, 49) + SourceIndex(3)
---
>>>}
1 >
2 >^
...
2 >Emitted(50, 2) Source(14, 2) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
4 >                                 (...b: number[]) { 
5 >                                      }
1->Emitted(59, 1) Source(7, 1) + SourceIndex(4)
2 >Emitted(59, 10) Source(7, 10) + SourceIndex(4)
3 >Emitted(59, 34) Source(7, 34) + SourceIndex(4)
4 >Emitted(59, 39) Source(7, 53) + SourceIndex(4)
5 >Emitted(59, 40) Source(7, 54) + SourceIndex(4)
---
>>>secondsecond_part2Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^^^
...
10>                                                           ]
11>                                                            );
1->Emitted(60, 1) Source(8, 1) + SourceIndex(4)
2 >Emitted(60, 25) Source(8, 25) + SourceIndex(4)
3 >Emitted(60, 49) Source(8, 29) + SourceIndex(4)
4 >Emitted(60, 50) Source(8, 30) + SourceIndex(4)
5 >Emitted(60, 52) Source(8, 32) + SourceIndex(4)
6 >Emitted(60, 54) Source(8, 34) + SourceIndex(4)
7 >Emitted(60, 56) Source(8, 36) + SourceIndex(4)
8 >Emitted(60, 58) Source(8, 38) + SourceIndex(4)
9 >Emitted(60, 60) Source(8, 40) + SourceIndex(4)
10>Emitted(60, 61) Source(8, 41) + SourceIndex(4)
11>Emitted(60, 64) Source(8, 43) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../third_part1.ts
...
4 >                               (...b: number[]) { 
5 >                                    }
1->Emitted(66, 1) Source(6, 1) + SourceIndex(5)
2 >Emitted(66, 10) Source(6, 10) + SourceIndex(5)
3 >Emitted(66, 32) Source(6, 32) + SourceIndex(5)
4 >Emitted(66, 37) Source(6, 51) + SourceIndex(5)
5 >Emitted(66, 38) Source(6, 52) + SourceIndex(5)
---
>>>thirdthird_part1Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^
...
10>                                                         ]
11>                                                          );
1->Emitted(67, 1) Source(7, 1) + SourceIndex(5)
2 >Emitted(67, 23) Source(7, 23) + SourceIndex(5)
3 >Emitted(67, 47) Source(7, 27) + SourceIndex(5)
4 >Emitted(67, 48) Source(7, 28) + SourceIndex(5)
5 >Emitted(67, 50) Source(7, 30) + SourceIndex(5)
6 >Emitted(67, 52) Source(7, 32) + SourceIndex(5)
7 >Emitted(67, 54) Source(7, 34) + SourceIndex(5)
8 >Emitted(67, 56) Source(7, 36) + SourceIndex(5)
9 >Emitted(67, 58) Source(7, 38) + SourceIndex(5)
10>Emitted(67, 59) Source(7, 39) + SourceIndex(5)
11>Emitted(67, 62) Source(7, 41) + SourceIndex(5)
---
>>>//# sourceMappingURL=third-output.js.map
...
----------------------------------------------------------------------
prepend: (1180-1432):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1180-1432)
var s = "Hello, world";
console.log(s);
...
----------------------------------------------------------------------
prepend: (1432-1942):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1432-1942)
var N;
(function (N) {
