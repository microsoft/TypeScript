...
7 >             )
8 >              ;
1 >Emitted(24, 1) Source(11, 1) + SourceIndex(0)
2 >Emitted(24, 8) Source(11, 8) + SourceIndex(0)
3 >Emitted(24, 9) Source(11, 9) + SourceIndex(0)
4 >Emitted(24, 12) Source(11, 12) + SourceIndex(0)
5 >Emitted(24, 13) Source(11, 13) + SourceIndex(0)
6 >Emitted(24, 14) Source(11, 14) + SourceIndex(0)
7 >Emitted(24, 15) Source(11, 15) + SourceIndex(0)
8 >Emitted(24, 16) Source(11, 16) + SourceIndex(0)
---
>>>function forfirstfirst_PART1Rest() { }
1->
2 >^^^^^^^^^
...
2 >Emitted(25, 10) Source(12, 10) + SourceIndex(0)
3 >Emitted(25, 33) Source(12, 33) + SourceIndex(0)
4 >Emitted(25, 38) Source(12, 38) + SourceIndex(0)
5 >Emitted(25, 39) Source(12, 39) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/first/bin/first-output.js
...
8 >               )
9 >                ;
1 >Emitted(26, 1) Source(1, 1) + SourceIndex(1)
2 >Emitted(26, 8) Source(1, 8) + SourceIndex(1)
3 >Emitted(26, 9) Source(1, 9) + SourceIndex(1)
4 >Emitted(26, 12) Source(1, 12) + SourceIndex(1)
5 >Emitted(26, 13) Source(1, 13) + SourceIndex(1)
6 >Emitted(26, 14) Source(1, 14) + SourceIndex(1)
7 >Emitted(26, 16) Source(1, 16) + SourceIndex(1)
8 >Emitted(26, 17) Source(1, 17) + SourceIndex(1)
9 >Emitted(26, 18) Source(1, 18) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/first/bin/first-output.js
sourceFile:../first_part3.ts
...
2 >function 
3 >         f
1 >Emitted(27, 1) Source(1, 1) + SourceIndex(2)
2 >Emitted(27, 10) Source(1, 10) + SourceIndex(2)
3 >Emitted(27, 11) Source(1, 11) + SourceIndex(2)
---
>>>    return "JS does hoists";
1->^^^^
2 >    ^^^^^^^
...
3 >           "JS does hoists"
4 >                           ;
1->Emitted(28, 5) Source(2, 5) + SourceIndex(2)
2 >Emitted(28, 12) Source(2, 12) + SourceIndex(2)
3 >Emitted(28, 28) Source(2, 28) + SourceIndex(2)
4 >Emitted(28, 29) Source(2, 29) + SourceIndex(2)
---
>>>}
1 >
2 >^
...
2 >Emitted(29, 2) Source(3, 2) + SourceIndex(2)
---
>>>function firstfirst_part3Spread() {var b = [];
1->
2 >^^^^^^^^^
...
2 >Emitted(30, 10) Source(4, 10) + SourceIndex(2)
3 >Emitted(30, 32) Source(4, 32) + SourceIndex(2)
4 >Emitted(30, 36) Source(4, 33) + SourceIndex(2)
5 >Emitted(30, 47) Source(4, 47) + SourceIndex(2)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
2 >Emitted(35, 23) Source(5, 23) + SourceIndex(2)
3 >Emitted(35, 47) Source(5, 27) + SourceIndex(2)
4 >Emitted(35, 48) Source(5, 28) + SourceIndex(2)
5 >Emitted(35, 50) Source(5, 30) + SourceIndex(2)
6 >Emitted(35, 52) Source(5, 32) + SourceIndex(2)
7 >Emitted(35, 54) Source(5, 34) + SourceIndex(2)
8 >Emitted(35, 56) Source(5, 36) + SourceIndex(2)
9 >Emitted(35, 58) Source(5, 38) + SourceIndex(2)
10>Emitted(35, 59) Source(5, 39) + SourceIndex(2)
11>Emitted(35, 62) Source(5, 41) + SourceIndex(2)
---
>>>//# sourceMappingURL=first-output.js.map
...
4 >Emitted(41, 36) Source(4, 33) + SourceIndex(2)
5 >Emitted(41, 47) Source(4, 47) + SourceIndex(2)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
4 >Emitted(65, 38) Source(7, 35) + SourceIndex(4)
5 >Emitted(65, 49) Source(7, 49) + SourceIndex(4)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
4 >Emitted(76, 36) Source(6, 33) + SourceIndex(5)
5 >Emitted(76, 47) Source(6, 47) + SourceIndex(5)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
5 >                                          
6 >                                            ...b: number[]
1->Emitted(77, 10) Source(6, 33) + SourceIndex(5)
2 >Emitted(77, 20) Source(6, 47) + SourceIndex(5)
3 >Emitted(77, 22) Source(6, 33) + SourceIndex(5)
4 >Emitted(77, 43) Source(6, 47) + SourceIndex(5)
5 >Emitted(77, 45) Source(6, 33) + SourceIndex(5)
6 >Emitted(77, 49) Source(6, 47) + SourceIndex(5)
---
>>>        b[_i] = arguments[_i];
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
1 >
2 >        ...b: number[]
1 >Emitted(78, 9) Source(6, 33) + SourceIndex(5)
2 >Emitted(78, 31) Source(6, 47) + SourceIndex(5)
---
>>>    }
>>>}
1 >
...
1 >) { 
2 >}
1 >Emitted(80, 1) Source(6, 51) + SourceIndex(5)
2 >Emitted(80, 2) Source(6, 52) + SourceIndex(5)
---
>>>thirdthird_part1Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^
...
10>                                                         ]
11>                                                          );
1->Emitted(81, 1) Source(7, 1) + SourceIndex(5)
2 >Emitted(81, 23) Source(7, 23) + SourceIndex(5)
3 >Emitted(81, 47) Source(7, 27) + SourceIndex(5)
4 >Emitted(81, 48) Source(7, 28) + SourceIndex(5)
5 >Emitted(81, 50) Source(7, 30) + SourceIndex(5)
6 >Emitted(81, 52) Source(7, 32) + SourceIndex(5)
7 >Emitted(81, 54) Source(7, 34) + SourceIndex(5)
8 >Emitted(81, 56) Source(7, 36) + SourceIndex(5)
9 >Emitted(81, 58) Source(7, 38) + SourceIndex(5)
10>Emitted(81, 59) Source(7, 39) + SourceIndex(5)
11>Emitted(81, 62) Source(7, 41) + SourceIndex(5)
---
>>>//# sourceMappingURL=third-output.js.map
...
----------------------------------------------------------------------
prepend: (1180-1538):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1180-1538)
...
firstfirst_part3Spread.apply(void 0, __spread([10, 20, 30]));
----------------------------------------------------------------------
prepend: (1540-2148):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1540-2148)
var N;
(function (N) {
