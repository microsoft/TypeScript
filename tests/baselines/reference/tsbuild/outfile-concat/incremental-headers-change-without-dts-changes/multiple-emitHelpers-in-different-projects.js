...
2 >function 
3 >         secondsecond_part1Spread
1->Emitted(26, 1) Source(13, 1) + SourceIndex(3)
2 >Emitted(26, 10) Source(13, 10) + SourceIndex(3)
3 >Emitted(26, 34) Source(13, 34) + SourceIndex(3)
---
>>>    var b = [];
1 >^^^^
2 >    ^^^^^^^^^^^
...
1 >(
2 >    ...b: number[]
1 >Emitted(27, 5) Source(13, 35) + SourceIndex(3)
2 >Emitted(27, 16) Source(13, 49) + SourceIndex(3)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
5 >                                          
6 >                                            ...b: number[]
1->Emitted(28, 10) Source(13, 35) + SourceIndex(3)
2 >Emitted(28, 20) Source(13, 49) + SourceIndex(3)
3 >Emitted(28, 22) Source(13, 35) + SourceIndex(3)
4 >Emitted(28, 43) Source(13, 49) + SourceIndex(3)
5 >Emitted(28, 45) Source(13, 35) + SourceIndex(3)
6 >Emitted(28, 49) Source(13, 49) + SourceIndex(3)
---
>>>        b[_i] = arguments[_i];
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
1 >
2 >        ...b: number[]
1 >Emitted(29, 9) Source(13, 35) + SourceIndex(3)
2 >Emitted(29, 31) Source(13, 49) + SourceIndex(3)
---
>>>    }
>>>}
1 >
...
1 >) { 
2 >}
1 >Emitted(31, 1) Source(13, 53) + SourceIndex(3)
2 >Emitted(31, 2) Source(13, 54) + SourceIndex(3)
---
>>>secondsecond_part1Spread.apply(void 0, [10, 20, 30]);
1->
2 >^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >Emitted(32, 25) Source(14, 25) + SourceIndex(3)
3 >Emitted(32, 40) Source(14, 29) + SourceIndex(3)
4 >Emitted(32, 41) Source(14, 30) + SourceIndex(3)
5 >Emitted(32, 43) Source(14, 32) + SourceIndex(3)
6 >Emitted(32, 45) Source(14, 34) + SourceIndex(3)
7 >Emitted(32, 47) Source(14, 36) + SourceIndex(3)
8 >Emitted(32, 49) Source(14, 38) + SourceIndex(3)
9 >Emitted(32, 51) Source(14, 40) + SourceIndex(3)
10>Emitted(32, 52) Source(14, 41) + SourceIndex(3)
11>Emitted(32, 54) Source(14, 43) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
----------------------------------------------------------------------
prepend: (652-1143):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (652-1143)
var N;
(function (N) {
