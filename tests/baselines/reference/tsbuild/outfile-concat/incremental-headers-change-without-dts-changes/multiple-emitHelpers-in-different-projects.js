...
2 >Emitted(53, 5) Source(14, 7) + SourceIndex(3)
3 >Emitted(53, 26) Source(14, 28) + SourceIndex(3)
4 >Emitted(53, 29) Source(14, 31) + SourceIndex(3)
5 >Emitted(53, 30) Source(14, 32) + SourceIndex(3)
6 >Emitted(53, 32) Source(14, 34) + SourceIndex(3)
7 >Emitted(53, 34) Source(14, 36) + SourceIndex(3)
8 >Emitted(53, 36) Source(14, 38) + SourceIndex(3)
9 >Emitted(53, 37) Source(14, 39) + SourceIndex(3)
10>Emitted(53, 38) Source(14, 40) + SourceIndex(3)
---
>>>secondsecond_part1Spread.apply(void 0, __spreadArray([10], __read(secondsecond_part1_ar)));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^^^
...
7 >                                                                                       );
1->Emitted(54, 1) Source(15, 1) + SourceIndex(3)
2 >Emitted(54, 25) Source(15, 25) + SourceIndex(3)
3 >Emitted(54, 55) Source(15, 26) + SourceIndex(3)
4 >Emitted(54, 57) Source(15, 28) + SourceIndex(3)
5 >Emitted(54, 67) Source(15, 33) + SourceIndex(3)
6 >Emitted(54, 88) Source(15, 54) + SourceIndex(3)
7 >Emitted(54, 92) Source(15, 56) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
----------------------------------------------------------------------
prepend: (1201-1351):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1201-1351)
var s = "Hello, world";
console.log(s);
...
----------------------------------------------------------------------
prepend: (1351-1919):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1351-1919)
var N;
(function (N) {
