...
2 >Emitted(14, 5) Source(6, 11) + SourceIndex(1)
3 >Emitted(14, 6) Source(6, 12) + SourceIndex(1)
4 >Emitted(14, 7) Source(12, 2) + SourceIndex(1)
---
>>>(function (N) {
1->
2 >^^^^^^^^^^^
...
2 >namespace 
3 >           N
1->Emitted(15, 1) Source(6, 1) + SourceIndex(1)
2 >Emitted(15, 12) Source(6, 11) + SourceIndex(1)
3 >Emitted(15, 13) Source(6, 12) + SourceIndex(1)
---
>>>    function f() {
1->^^^^
2 >    ^^^^^^^^^
...
2 >    function 
3 >             f
1->Emitted(16, 5) Source(7, 5) + SourceIndex(1)
2 >Emitted(16, 14) Source(7, 14) + SourceIndex(1)
3 >Emitted(16, 15) Source(7, 15) + SourceIndex(1)
---
>>>        console.log('testing');
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                             )
8 >                              ;
1->Emitted(17, 9) Source(8, 9) + SourceIndex(1)
2 >Emitted(17, 16) Source(8, 16) + SourceIndex(1)
3 >Emitted(17, 17) Source(8, 17) + SourceIndex(1)
4 >Emitted(17, 20) Source(8, 20) + SourceIndex(1)
5 >Emitted(17, 21) Source(8, 21) + SourceIndex(1)
6 >Emitted(17, 30) Source(8, 30) + SourceIndex(1)
7 >Emitted(17, 31) Source(8, 31) + SourceIndex(1)
8 >Emitted(17, 32) Source(8, 32) + SourceIndex(1)
---
>>>    }
1 >^^^^
2 >    ^
1 >
  >    
2 >    }
1 >Emitted(18, 5) Source(9, 5) + SourceIndex(1)
2 >Emitted(18, 6) Source(9, 6) + SourceIndex(1)
---
>>>
>>>    f();
1 >^^^^
...
3 >     ()
4 >       ;
1 >Emitted(20, 5) Source(11, 5) + SourceIndex(1)
2 >Emitted(20, 6) Source(11, 6) + SourceIndex(1)
3 >Emitted(20, 8) Source(11, 8) + SourceIndex(1)
4 >Emitted(20, 9) Source(11, 9) + SourceIndex(1)
---
>>>})(N || (N = {}));
1->
2 >^
...
7 >           {
  ...
  >              f();
  >          }
1->Emitted(21, 1) Source(12, 1) + SourceIndex(1)
2 >Emitted(21, 2) Source(12, 2) + SourceIndex(1)
3 >Emitted(21, 4) Source(6, 11) + SourceIndex(1)
4 >Emitted(21, 5) Source(6, 12) + SourceIndex(1)
5 >Emitted(21, 10) Source(6, 11) + SourceIndex(1)
6 >Emitted(21, 11) Source(6, 12) + SourceIndex(1)
7 >Emitted(21, 19) Source(12, 2) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
2 >    ^^->
1->
1->Emitted(23, 5) Source(2, 1) + SourceIndex(2)
---
>>>    }
1->^^^^
2 >    ^
...
2 >Emitted(24, 6) Source(6, 2) + SourceIndex(2)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(25, 5) Source(3, 5) + SourceIndex(2)
2 >Emitted(25, 28) Source(3, 16) + SourceIndex(2)
3 >Emitted(25, 31) Source(3, 5) + SourceIndex(2)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(26, 9) Source(4, 9) + SourceIndex(2)
2 >Emitted(26, 16) Source(4, 16) + SourceIndex(2)
3 >Emitted(26, 17) Source(4, 17) + SourceIndex(2)
4 >Emitted(26, 20) Source(4, 20) + SourceIndex(2)
5 >Emitted(26, 21) Source(4, 21) + SourceIndex(2)
6 >Emitted(26, 41) Source(4, 41) + SourceIndex(2)
7 >Emitted(26, 42) Source(4, 42) + SourceIndex(2)
8 >Emitted(26, 43) Source(4, 43) + SourceIndex(2)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(27, 5) Source(5, 5) + SourceIndex(2)
2 >Emitted(27, 6) Source(5, 6) + SourceIndex(2)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
1->
  >
2 >    }
1->Emitted(28, 5) Source(6, 1) + SourceIndex(2)
2 >Emitted(28, 13) Source(6, 2) + SourceIndex(2)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(29, 1) Source(6, 1) + SourceIndex(2)
2 >Emitted(29, 2) Source(6, 2) + SourceIndex(2)
3 >Emitted(29, 2) Source(2, 1) + SourceIndex(2)
4 >Emitted(29, 6) Source(6, 2) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../third_part1.ts
...
7 >             ()
8 >               ;
1->Emitted(30, 1) Source(1, 1) + SourceIndex(5)
2 >Emitted(30, 5) Source(1, 5) + SourceIndex(5)
3 >Emitted(30, 6) Source(1, 6) + SourceIndex(5)
4 >Emitted(30, 9) Source(1, 9) + SourceIndex(5)
5 >Emitted(30, 13) Source(1, 13) + SourceIndex(5)
6 >Emitted(30, 14) Source(1, 14) + SourceIndex(5)
7 >Emitted(30, 16) Source(1, 16) + SourceIndex(5)
8 >Emitted(30, 17) Source(1, 17) + SourceIndex(5)
---
>>>c.doSomething();
1->
2 >^
...
5 >             ()
6 >               ;
1->Emitted(31, 1) Source(2, 1) + SourceIndex(5)
2 >Emitted(31, 2) Source(2, 2) + SourceIndex(5)
3 >Emitted(31, 3) Source(2, 3) + SourceIndex(5)
4 >Emitted(31, 14) Source(2, 14) + SourceIndex(5)
5 >Emitted(31, 16) Source(2, 16) + SourceIndex(5)
6 >Emitted(31, 17) Source(2, 17) + SourceIndex(5)
---
>>>//# sourceMappingURL=third-output.js.map
...
"myPrologue2";
----------------------------------------------------------------------
prepend: (62-178):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (62-178)
...
----------------------------------------------------------------------
prepend: (178-465):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (178-465)
var N;
(function (N) {
