...
2 >    doSomething
3 >                           
1->Emitted(24, 5) Source(3, 5) + SourceIndex(2)
2 >Emitted(24, 28) Source(3, 16) + SourceIndex(2)
3 >Emitted(24, 31) Source(3, 5) + SourceIndex(2)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(25, 9) Source(4, 9) + SourceIndex(2)
2 >Emitted(25, 16) Source(4, 16) + SourceIndex(2)
3 >Emitted(25, 17) Source(4, 17) + SourceIndex(2)
4 >Emitted(25, 20) Source(4, 20) + SourceIndex(2)
5 >Emitted(25, 21) Source(4, 21) + SourceIndex(2)
6 >Emitted(25, 41) Source(4, 41) + SourceIndex(2)
7 >Emitted(25, 42) Source(4, 42) + SourceIndex(2)
8 >Emitted(25, 43) Source(4, 43) + SourceIndex(2)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(26, 5) Source(5, 5) + SourceIndex(2)
2 >Emitted(26, 6) Source(5, 6) + SourceIndex(2)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
...
2 >Emitted(27, 13) Source(6, 2) + SourceIndex(2)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(28, 1) Source(6, 1) + SourceIndex(2)
2 >Emitted(28, 2) Source(6, 2) + SourceIndex(2)
3 >Emitted(28, 2) Source(2, 1) + SourceIndex(2)
...
7 >             ()
8 >               ;
1->Emitted(29, 1) Source(1, 1) + SourceIndex(5)
2 >Emitted(29, 5) Source(1, 5) + SourceIndex(5)
3 >Emitted(29, 6) Source(1, 6) + SourceIndex(5)
4 >Emitted(29, 9) Source(1, 9) + SourceIndex(5)
5 >Emitted(29, 13) Source(1, 13) + SourceIndex(5)
6 >Emitted(29, 14) Source(1, 14) + SourceIndex(5)
7 >Emitted(29, 16) Source(1, 16) + SourceIndex(5)
8 >Emitted(29, 17) Source(1, 17) + SourceIndex(5)
---
>>>c.doSomething();
1->
2 >^
...
5 >             ()
6 >               ;
1->Emitted(30, 1) Source(2, 1) + SourceIndex(5)
2 >Emitted(30, 2) Source(2, 2) + SourceIndex(5)
3 >Emitted(30, 3) Source(2, 3) + SourceIndex(5)
4 >Emitted(30, 14) Source(2, 14) + SourceIndex(5)
5 >Emitted(30, 16) Source(2, 16) + SourceIndex(5)
6 >Emitted(30, 17) Source(2, 17) + SourceIndex(5)
---
>>>//# sourceMappingURL=third-output.js.map
...
----------------------------------------------------------------------
prepend: (176-463):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (176-463)
var N;
(function (N) {
