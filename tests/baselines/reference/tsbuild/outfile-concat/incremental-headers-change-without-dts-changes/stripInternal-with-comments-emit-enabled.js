...
1 >Emitted(44, 5) Source(24, 5) + SourceIndex(3)
2 >Emitted(44, 18) Source(24, 18) + SourceIndex(3)
3 >Emitted(44, 19) Source(24, 19) + SourceIndex(3)
4 >Emitted(44, 23) Source(24, 36) + SourceIndex(3)
5 >Emitted(44, 32) Source(24, 45) + SourceIndex(3)
6 >Emitted(44, 33) Source(24, 85) + SourceIndex(3)
---
>>>    (function (someOther) {var something;
1->^^^^
2 >    ^^^^^^^^^^^
...
8 >                                                     C
9 >                                                      ;
1 >Emitted(53, 5) Source(25, 5) + SourceIndex(3)
2 >Emitted(53, 18) Source(25, 18) + SourceIndex(3)
3 >Emitted(53, 19) Source(25, 33) + SourceIndex(3)
4 >Emitted(53, 37) Source(25, 43) + SourceIndex(3)
5 >Emitted(53, 40) Source(25, 46) + SourceIndex(3)
6 >Emitted(53, 53) Source(25, 59) + SourceIndex(3)
7 >Emitted(53, 54) Source(25, 60) + SourceIndex(3)
8 >Emitted(53, 55) Source(25, 61) + SourceIndex(3)
9 >Emitted(53, 56) Source(25, 62) + SourceIndex(3)
---
>>>    /*@internal*/ normalN.internalConst = 10;
1 >^^^^
2 >    ^^^^^^^^^^^^^
...
6 >                                          10
7 >                                            ;
1 >Emitted(54, 5) Source(27, 5) + SourceIndex(3)
2 >Emitted(54, 18) Source(27, 18) + SourceIndex(3)
3 >Emitted(54, 19) Source(27, 32) + SourceIndex(3)
4 >Emitted(54, 40) Source(27, 45) + SourceIndex(3)
5 >Emitted(54, 43) Source(27, 48) + SourceIndex(3)
6 >Emitted(54, 45) Source(27, 50) + SourceIndex(3)
7 >Emitted(54, 46) Source(27, 51) + SourceIndex(3)
---
>>>    /*@internal*/ var internalEnum;
1 >^^^^
2 >    ^^^^^^^^^^^^^
...
1 >Emitted(55, 5) Source(28, 5) + SourceIndex(3)
2 >Emitted(55, 18) Source(28, 18) + SourceIndex(3)
3 >Emitted(55, 19) Source(28, 19) + SourceIndex(3)
4 >Emitted(55, 23) Source(28, 31) + SourceIndex(3)
5 >Emitted(55, 35) Source(28, 55) + SourceIndex(3)
---
>>>    (function (internalEnum) {
1 >^^^^
2 >    ^^^^^^^^^^^
...
2 >/*@internal*/
3 >              
1->Emitted(62, 1) Source(30, 1) + SourceIndex(3)
2 >Emitted(62, 14) Source(30, 14) + SourceIndex(3)
3 >Emitted(62, 15) Source(30, 15) + SourceIndex(3)
---
>>>    function internalC() {}
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
6 >                                  () {
7 >                                       }
1->Emitted(66, 1) Source(31, 1) + SourceIndex(3)
2 >Emitted(66, 14) Source(31, 14) + SourceIndex(3)
3 >Emitted(66, 15) Source(31, 15) + SourceIndex(3)
4 >Emitted(66, 24) Source(31, 24) + SourceIndex(3)
5 >Emitted(66, 35) Source(31, 35) + SourceIndex(3)
6 >Emitted(66, 40) Source(31, 39) + SourceIndex(3)
7 >Emitted(66, 41) Source(31, 40) + SourceIndex(3)
---
>>>/*@internal*/ var internalNamespace;
1 >
2 >^^^^^^^^^^^^^
...
1 >Emitted(67, 1) Source(32, 1) + SourceIndex(3)
2 >Emitted(67, 14) Source(32, 14) + SourceIndex(3)
3 >Emitted(67, 15) Source(32, 15) + SourceIndex(3)
4 >Emitted(67, 19) Source(32, 25) + SourceIndex(3)
5 >Emitted(67, 36) Source(32, 42) + SourceIndex(3)
6 >Emitted(67, 37) Source(32, 72) + SourceIndex(3)
---
>>>(function (internalNamespace) {var someClass = /** @class */ (function () {
1->
2 >^^^^^^^^^^^
...
5 >                  internalOther
6 >                               .something { export class someClass {} }
1 >Emitted(74, 1) Source(33, 1) + SourceIndex(3)
2 >Emitted(74, 14) Source(33, 14) + SourceIndex(3)
3 >Emitted(74, 15) Source(33, 15) + SourceIndex(3)
4 >Emitted(74, 19) Source(33, 25) + SourceIndex(3)
5 >Emitted(74, 32) Source(33, 38) + SourceIndex(3)
6 >Emitted(74, 33) Source(33, 78) + SourceIndex(3)
---
>>>(function (internalOther) {var something;
1->
2 >^^^^^^^^^^^
...
9 >                                                     someClass
10>                                                              ;
1->Emitted(83, 1) Source(34, 1) + SourceIndex(3)
2 >Emitted(83, 14) Source(34, 14) + SourceIndex(3)
3 >Emitted(83, 15) Source(34, 15) + SourceIndex(3)
4 >Emitted(83, 19) Source(34, 22) + SourceIndex(3)
5 >Emitted(83, 33) Source(34, 36) + SourceIndex(3)
6 >Emitted(83, 36) Source(34, 39) + SourceIndex(3)
7 >Emitted(83, 53) Source(34, 56) + SourceIndex(3)
8 >Emitted(83, 54) Source(34, 57) + SourceIndex(3)
9 >Emitted(83, 63) Source(34, 66) + SourceIndex(3)
10>Emitted(83, 64) Source(34, 67) + SourceIndex(3)
---
>>>
>>>/*@internal*/ var internalConst = 10;
1 >
...
7 >                                  10
8 >                                    ;
1 >Emitted(85, 1) Source(36, 1) + SourceIndex(3)
2 >Emitted(85, 14) Source(36, 14) + SourceIndex(3)
3 >Emitted(85, 15) Source(36, 15) + SourceIndex(3)
4 >Emitted(85, 19) Source(36, 21) + SourceIndex(3)
5 >Emitted(85, 32) Source(36, 34) + SourceIndex(3)
6 >Emitted(85, 35) Source(36, 37) + SourceIndex(3)
7 >Emitted(85, 37) Source(36, 39) + SourceIndex(3)
8 >Emitted(85, 38) Source(36, 40) + SourceIndex(3)
---
>>>/*@internal*/ var internalEnum;
1 >
2 >^^^^^^^^^^^^^
...
4 >              enum 
5 >                  internalEnum { a, b, c }
1 >Emitted(86, 1) Source(37, 1) + SourceIndex(3)
2 >Emitted(86, 14) Source(37, 14) + SourceIndex(3)
3 >Emitted(86, 15) Source(37, 15) + SourceIndex(3)
4 >Emitted(86, 19) Source(37, 20) + SourceIndex(3)
5 >Emitted(86, 31) Source(37, 44) + SourceIndex(3)
---
>>>(function (internalEnum) {
1 >
2 >^^^^^^^^^^^
...
----------------------------------------------------------------------
prepend: (114-3401):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (114-3401)
var N;
(function (N) {
