...
3 >Emitted(37, 38) Source(13, 48) + SourceIndex(3)
4 >Emitted(37, 40) Source(13, 9) + SourceIndex(3)
5 >Emitted(37, 48) Source(13, 10) + SourceIndex(3)
6 >Emitted(37, 50) Source(13, 12) + SourceIndex(3)
7 >Emitted(37, 74) Source(13, 48) + SourceIndex(3)
8 >Emitted(37, 75) Source(13, 49) + SourceIndex(3)
---
>>>}
1 >
2 >^
...
7 >             ()
8 >               ;
1->Emitted(48, 1) Source(1, 1) + SourceIndex(5)
2 >Emitted(48, 5) Source(1, 5) + SourceIndex(5)
3 >Emitted(48, 6) Source(1, 6) + SourceIndex(5)
4 >Emitted(48, 9) Source(1, 9) + SourceIndex(5)
5 >Emitted(48, 13) Source(1, 13) + SourceIndex(5)
6 >Emitted(48, 14) Source(1, 14) + SourceIndex(5)
7 >Emitted(48, 16) Source(1, 16) + SourceIndex(5)
8 >Emitted(48, 17) Source(1, 17) + SourceIndex(5)
---
>>>c.doSomething();
1->
2 >^
...
5 >             ()
6 >               ;
1->Emitted(49, 1) Source(2, 1) + SourceIndex(5)
2 >Emitted(49, 2) Source(2, 2) + SourceIndex(5)
3 >Emitted(49, 3) Source(2, 3) + SourceIndex(5)
4 >Emitted(49, 14) Source(2, 14) + SourceIndex(5)
5 >Emitted(49, 16) Source(2, 16) + SourceIndex(5)
6 >Emitted(49, 17) Source(2, 17) + SourceIndex(5)
---
>>>//# sourceMappingURL=third-output.js.map
