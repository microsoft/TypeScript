...
2 >Emitted(5, 14) Source(1, 14) + SourceIndex(1)
3 >Emitted(5, 15) Source(1, 14) + SourceIndex(1)
---
>>>"myPrologue";
1 >
2 >^^^^^^^^^^^^
...
2 >Emitted(6, 13) Source(2, 13) + SourceIndex(1)
3 >Emitted(6, 14) Source(2, 13) + SourceIndex(1)
---
>>>var s = "Hello, world";
1->
2 >^^^^
...
2 >Emitted(7, 5) Source(7, 7) + SourceIndex(1)
3 >Emitted(7, 6) Source(7, 8) + SourceIndex(1)
4 >Emitted(7, 9) Source(7, 11) + SourceIndex(1)
5 >Emitted(7, 23) Source(7, 25) + SourceIndex(1)
6 >Emitted(7, 24) Source(7, 26) + SourceIndex(1)
---
>>>console.log(s);
1 >
2 >^^^^^^^
