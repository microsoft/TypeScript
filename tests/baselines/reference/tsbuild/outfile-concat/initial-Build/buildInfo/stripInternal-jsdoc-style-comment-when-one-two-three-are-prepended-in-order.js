...
3 >     () { return 10; }
  >         /**@internal*/ set c(val: 
4 >       number
1->Emitted(17, 5) Source(17, 24) + SourceIndex(2)
2 >Emitted(17, 6) Source(17, 25) + SourceIndex(2)
3 >Emitted(17, 8) Source(18, 31) + SourceIndex(2)
4 >Emitted(17, 14) Source(18, 37) + SourceIndex(2)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^^^^^^^^^^^->
...
2 >    export class 
3 >          C
1 >Emitted(20, 5) Source(21, 20) + SourceIndex(2)
2 >Emitted(20, 11) Source(21, 33) + SourceIndex(2)
3 >Emitted(20, 12) Source(21, 34) + SourceIndex(2)
---
>>>    }
1 >^^^^^
2 >     ^^^^^^^^^^^^^^^^^^^^^->
...
3 >             foo
4 >                () {}
1->Emitted(22, 5) Source(22, 20) + SourceIndex(2)
2 >Emitted(22, 14) Source(22, 36) + SourceIndex(2)
3 >Emitted(22, 17) Source(22, 39) + SourceIndex(2)
4 >Emitted(22, 26) Source(22, 44) + SourceIndex(2)
---
>>>    namespace someNamespace {
1->^^^^
2 >    ^^^^^^^^^^
...
3 >              someNamespace
4 >                            
1->Emitted(23, 5) Source(23, 20) + SourceIndex(2)
2 >Emitted(23, 15) Source(23, 37) + SourceIndex(2)
3 >Emitted(23, 28) Source(23, 50) + SourceIndex(2)
4 >Emitted(23, 29) Source(23, 51) + SourceIndex(2)
---
>>>        class C {
1 >^^^^^^^^
2 >        ^^^^^^
...
5 >                        something
6 >                                  
1->Emitted(27, 5) Source(24, 20) + SourceIndex(2)
2 >Emitted(27, 15) Source(24, 37) + SourceIndex(2)
3 >Emitted(27, 24) Source(24, 46) + SourceIndex(2)
4 >Emitted(27, 25) Source(24, 47) + SourceIndex(2)
5 >Emitted(27, 34) Source(24, 56) + SourceIndex(2)
6 >Emitted(27, 35) Source(24, 57) + SourceIndex(2)
---
>>>        class someClass {
1 >^^^^^^^^
2 >        ^^^^^^
...
8 >                                             C
9 >                                              ;
1->Emitted(31, 5) Source(25, 20) + SourceIndex(2)
2 >Emitted(31, 11) Source(25, 26) + SourceIndex(2)
3 >Emitted(31, 19) Source(25, 34) + SourceIndex(2)
4 >Emitted(31, 29) Source(25, 44) + SourceIndex(2)
5 >Emitted(31, 32) Source(25, 47) + SourceIndex(2)
6 >Emitted(31, 45) Source(25, 60) + SourceIndex(2)
7 >Emitted(31, 46) Source(25, 61) + SourceIndex(2)
8 >Emitted(31, 47) Source(25, 62) + SourceIndex(2)
9 >Emitted(31, 48) Source(25, 63) + SourceIndex(2)
---
>>>    type internalType = internalC;
1 >^^^^
2 >    ^^^^^
...
5 >                        internalC
6 >                                 ;
1 >Emitted(32, 5) Source(26, 20) + SourceIndex(2)
2 >Emitted(32, 10) Source(26, 32) + SourceIndex(2)
3 >Emitted(32, 22) Source(26, 44) + SourceIndex(2)
4 >Emitted(32, 25) Source(26, 47) + SourceIndex(2)
5 >Emitted(32, 34) Source(26, 56) + SourceIndex(2)
6 >Emitted(32, 35) Source(26, 57) + SourceIndex(2)
---
>>>    const internalConst = 10;
1 >^^^^
2 >    ^^^^^^
...
4 >                        = 10
5 >                            ;
1 >Emitted(33, 5) Source(27, 27) + SourceIndex(2)
2 >Emitted(33, 11) Source(27, 33) + SourceIndex(2)
3 >Emitted(33, 24) Source(27, 46) + SourceIndex(2)
4 >Emitted(33, 29) Source(27, 51) + SourceIndex(2)
5 >Emitted(33, 30) Source(27, 52) + SourceIndex(2)
---
>>>    enum internalEnum {
1 >^^^^
2 >    ^^^^^
...
2 >    export enum 
3 >         internalEnum
1 >Emitted(34, 5) Source(28, 20) + SourceIndex(2)
2 >Emitted(34, 10) Source(28, 32) + SourceIndex(2)
3 >Emitted(34, 22) Source(28, 44) + SourceIndex(2)
---
>>>        a = 0,
1 >^^^^^^^^
2 >        ^
...
2 >class 
3 >              internalC
1->Emitted(40, 1) Source(30, 16) + SourceIndex(2)
2 >Emitted(40, 15) Source(30, 22) + SourceIndex(2)
3 >Emitted(40, 24) Source(30, 31) + SourceIndex(2)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^->
...
3 >                 internalfoo
4 >                            () {}
1->Emitted(42, 1) Source(31, 16) + SourceIndex(2)
2 >Emitted(42, 18) Source(31, 25) + SourceIndex(2)
3 >Emitted(42, 29) Source(31, 36) + SourceIndex(2)
4 >Emitted(42, 38) Source(31, 41) + SourceIndex(2)
---
>>>declare namespace internalNamespace {
1->
2 >^^^^^^^^^^^^^^^^^^
...
3 >                  internalNamespace
4 >                                    
1->Emitted(43, 1) Source(32, 16) + SourceIndex(2)
2 >Emitted(43, 19) Source(32, 26) + SourceIndex(2)
3 >Emitted(43, 36) Source(32, 43) + SourceIndex(2)
4 >Emitted(43, 37) Source(32, 44) + SourceIndex(2)
---
>>>    class someClass {
1 >^^^^
2 >    ^^^^^^
...
5 >                                something
6 >                                          
1->Emitted(47, 1) Source(33, 16) + SourceIndex(2)
2 >Emitted(47, 19) Source(33, 26) + SourceIndex(2)
3 >Emitted(47, 32) Source(33, 39) + SourceIndex(2)
4 >Emitted(47, 33) Source(33, 40) + SourceIndex(2)
5 >Emitted(47, 42) Source(33, 49) + SourceIndex(2)
6 >Emitted(47, 43) Source(33, 50) + SourceIndex(2)
---
>>>    class someClass {
1 >^^^^
2 >    ^^^^^^
...
7 >                                          someClass
8 >                                                   ;
1->Emitted(51, 1) Source(34, 16) + SourceIndex(2)
2 >Emitted(51, 8) Source(34, 23) + SourceIndex(2)
3 >Emitted(51, 22) Source(34, 37) + SourceIndex(2)
4 >Emitted(51, 25) Source(34, 40) + SourceIndex(2)
5 >Emitted(51, 42) Source(34, 57) + SourceIndex(2)
6 >Emitted(51, 43) Source(34, 58) + SourceIndex(2)
7 >Emitted(51, 52) Source(34, 67) + SourceIndex(2)
8 >Emitted(51, 53) Source(34, 68) + SourceIndex(2)
---
>>>declare type internalType = internalC;
1 >
2 >^^^^^^^^^^^^^
...
5 >                            internalC
6 >                                     ;
1 >Emitted(52, 1) Source(35, 16) + SourceIndex(2)
2 >Emitted(52, 14) Source(35, 21) + SourceIndex(2)
3 >Emitted(52, 26) Source(35, 33) + SourceIndex(2)
4 >Emitted(52, 29) Source(35, 36) + SourceIndex(2)
5 >Emitted(52, 38) Source(35, 45) + SourceIndex(2)
6 >Emitted(52, 39) Source(35, 46) + SourceIndex(2)
---
>>>declare const internalConst = 10;
1 >
2 >^^^^^^^^
...
5 >                            = 10
6 >                                ;
1 >Emitted(53, 1) Source(36, 16) + SourceIndex(2)
2 >Emitted(53, 9) Source(36, 16) + SourceIndex(2)
3 >Emitted(53, 15) Source(36, 22) + SourceIndex(2)
4 >Emitted(53, 28) Source(36, 35) + SourceIndex(2)
5 >Emitted(53, 33) Source(36, 40) + SourceIndex(2)
6 >Emitted(53, 34) Source(36, 41) + SourceIndex(2)
---
>>>declare enum internalEnum {
1 >
2 >^^^^^^^^^^^^^
...
2 >enum 
3 >             internalEnum
1 >Emitted(54, 1) Source(37, 16) + SourceIndex(2)
2 >Emitted(54, 14) Source(37, 21) + SourceIndex(2)
3 >Emitted(54, 26) Source(37, 33) + SourceIndex(2)
---
>>>    a = 0,
1 >^^^^
2 >    ^
