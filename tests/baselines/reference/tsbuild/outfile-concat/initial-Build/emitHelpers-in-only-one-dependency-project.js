...
5:28:00 PM - Projects in this build: 
    * src/first/tsconfig.json
    * src/second/tsconfig.json
    * src/third/tsconfig.json

5:28:00 PM - Project 'src/first/tsconfig.json' is out of date because output file 'src/first/bin/first-output.js' does not exist

5:28:00 PM - Building project '/src/first/tsconfig.json'...

5:28:00 PM - Project 'src/second/tsconfig.json' is out of date because output file 'src/2/second-output.js' does not exist

5:28:00 PM - Building project '/src/second/tsconfig.json'...

5:28:00 PM - Project 'src/third/tsconfig.json' is out of date because output file 'src/third/thirdjs/output/third-output.js' does not exist

5:28:00 PM - Building project '/src/third/tsconfig.json'...
...
3 >Emitted(20, 38) Source(13, 48) + SourceIndex(0)
4 >Emitted(20, 40) Source(13, 9) + SourceIndex(0)
5 >Emitted(20, 48) Source(13, 10) + SourceIndex(0)
6 >Emitted(20, 50) Source(13, 12) + SourceIndex(0)
7 >Emitted(20, 74) Source(13, 48) + SourceIndex(0)
8 >Emitted(20, 75) Source(13, 49) + SourceIndex(0)
---
>>>}
1 >
2 >^
