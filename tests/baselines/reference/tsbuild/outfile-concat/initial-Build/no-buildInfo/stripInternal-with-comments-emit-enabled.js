...
3 >                   () { return 10; }
  >                       /*@internal*/ set c(val: 
4 >                     number
1->Emitted(9, 19) Source(17, 23) + SourceIndex(0)
2 >Emitted(9, 20) Source(17, 24) + SourceIndex(0)
3 >Emitted(9, 22) Source(18, 30) + SourceIndex(0)
4 >Emitted(9, 28) Source(18, 36) + SourceIndex(0)
---
>>>}
1 >^
2 > ^^^^^^^^^^^^^^^^^^^^^^^^^^^->
