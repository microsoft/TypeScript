...
6:22:00 PM - Projects in this build: 
    * src/first/tsconfig.json
    * src/second/tsconfig.json
    * src/third/tsconfig.json

6:22:00 PM - Project 'src/first/tsconfig.json' is out of date because output file 'src/first/bin/first-output.js' does not exist

6:22:00 PM - Building project '/src/first/tsconfig.json'...

6:22:00 PM - Project 'src/second/tsconfig.json' is out of date because output file 'src/2/second-output.js' does not exist

6:22:00 PM - Building project '/src/second/tsconfig.json'...

6:22:00 PM - Project 'src/third/tsconfig.json' is out of date because output file 'src/third/thirdjs/output/third-output.js' does not exist

6:22:00 PM - Building project '/src/third/tsconfig.json'...
