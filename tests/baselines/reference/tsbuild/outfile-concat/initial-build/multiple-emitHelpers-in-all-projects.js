...
2 >function 
3 >         forsecondsecond_part1Rest
1->Emitted(41, 1) Source(12, 1) + SourceIndex(0)
2 >Emitted(41, 10) Source(12, 10) + SourceIndex(0)
3 >Emitted(41, 35) Source(12, 35) + SourceIndex(0)
---
>>>    var _a = { a: 10, b: 30, yy: 30 }, b = _a.b, rest = __rest(_a, ["b"]);
1->^^^^
2 >    ^^^^
...
2 >Emitted(42, 9) Source(13, 7) + SourceIndex(0)
3 >Emitted(42, 14) Source(13, 24) + SourceIndex(0)
4 >Emitted(42, 16) Source(13, 26) + SourceIndex(0)
5 >Emitted(42, 17) Source(13, 27) + SourceIndex(0)
6 >Emitted(42, 19) Source(13, 29) + SourceIndex(0)
7 >Emitted(42, 21) Source(13, 31) + SourceIndex(0)
8 >Emitted(42, 23) Source(13, 33) + SourceIndex(0)
9 >Emitted(42, 24) Source(13, 34) + SourceIndex(0)
10>Emitted(42, 26) Source(13, 36) + SourceIndex(0)
11>Emitted(42, 28) Source(13, 38) + SourceIndex(0)
12>Emitted(42, 30) Source(13, 40) + SourceIndex(0)
13>Emitted(42, 32) Source(13, 42) + SourceIndex(0)
14>Emitted(42, 34) Source(13, 44) + SourceIndex(0)
15>Emitted(42, 36) Source(13, 46) + SourceIndex(0)
16>Emitted(42, 38) Source(13, 48) + SourceIndex(0)
17>Emitted(42, 40) Source(13, 9) + SourceIndex(0)
18>Emitted(42, 41) Source(13, 10) + SourceIndex(0)
19>Emitted(42, 48) Source(13, 10) + SourceIndex(0)
20>Emitted(42, 50) Source(13, 15) + SourceIndex(0)
21>Emitted(42, 54) Source(13, 19) + SourceIndex(0)
22>Emitted(42, 68) Source(13, 7) + SourceIndex(0)
23>Emitted(42, 73) Source(13, 21) + SourceIndex(0)
24>Emitted(42, 74) Source(13, 48) + SourceIndex(0)
25>Emitted(42, 75) Source(13, 49) + SourceIndex(0)
---
>>>}
1 >
2 >^
...
1 >
  >
2 >}
1 >Emitted(43, 1) Source(14, 1) + SourceIndex(0)
2 >Emitted(43, 2) Source(14, 2) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/2/second-output.js
sourceFile:../second/second_part2.ts
...
2 >^^^^^^^^^^^^^^^^^^^->
1->
1->Emitted(44, 1) Source(1, 1) + SourceIndex(1)
---
>>>    function C() {
1->^^^^
2 >    ^^->
1->
1->Emitted(45, 5) Source(1, 1) + SourceIndex(1)
---
>>>    }
1->^^^^
2 >    ^
...
2 >Emitted(46, 6) Source(5, 2) + SourceIndex(1)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(47, 5) Source(2, 5) + SourceIndex(1)
2 >Emitted(47, 28) Source(2, 16) + SourceIndex(1)
3 >Emitted(47, 31) Source(2, 5) + SourceIndex(1)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(48, 9) Source(3, 9) + SourceIndex(1)
2 >Emitted(48, 16) Source(3, 16) + SourceIndex(1)
3 >Emitted(48, 17) Source(3, 17) + SourceIndex(1)
4 >Emitted(48, 20) Source(3, 20) + SourceIndex(1)
5 >Emitted(48, 21) Source(3, 21) + SourceIndex(1)
6 >Emitted(48, 41) Source(3, 41) + SourceIndex(1)
7 >Emitted(48, 42) Source(3, 42) + SourceIndex(1)
8 >Emitted(48, 43) Source(3, 43) + SourceIndex(1)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(49, 5) Source(4, 5) + SourceIndex(1)
2 >Emitted(49, 6) Source(4, 6) + SourceIndex(1)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
1->
  >
2 >    }
1->Emitted(50, 5) Source(5, 1) + SourceIndex(1)
2 >Emitted(50, 13) Source(5, 2) + SourceIndex(1)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(51, 1) Source(5, 1) + SourceIndex(1)
2 >Emitted(51, 2) Source(5, 2) + SourceIndex(1)
3 >Emitted(51, 2) Source(1, 1) + SourceIndex(1)
4 >Emitted(51, 6) Source(5, 2) + SourceIndex(1)
---
>>>function secondsecond_part2Spread() {var b = [];
1->
2 >^^^^^^^^^
...
4 >                                 (
5 >                                     ...b: number[]
1->Emitted(52, 1) Source(7, 1) + SourceIndex(1)
2 >Emitted(52, 10) Source(7, 10) + SourceIndex(1)
3 >Emitted(52, 34) Source(7, 34) + SourceIndex(1)
4 >Emitted(52, 38) Source(7, 35) + SourceIndex(1)
5 >Emitted(52, 49) Source(7, 49) + SourceIndex(1)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
4 >Emitted(70, 38) Source(7, 35) + SourceIndex(4)
5 >Emitted(70, 49) Source(7, 49) + SourceIndex(4)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
4 >Emitted(82, 36) Source(6, 33) + SourceIndex(5)
5 >Emitted(82, 47) Source(6, 47) + SourceIndex(5)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
----------------------------------------------------------------------
prepend: (1201-1699):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1201-1699)
...
firstfirst_part3Spread.apply(void 0, __spreadArray([10], __read(firstfirst_part3_ar)));
----------------------------------------------------------------------
prepend: (1701-2382):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1701-2382)
var N;
(function (N) {
