...
3 >Emitted(45, 6) Source(2, 5) + SourceIndex(1)
4 >Emitted(45, 29) Source(2, 16) + SourceIndex(1)
5 >Emitted(45, 32) Source(2, 5) + SourceIndex(1)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
4 >Emitted(50, 38) Source(7, 35) + SourceIndex(1)
5 >Emitted(50, 49) Source(7, 49) + SourceIndex(1)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
5 >                                          
6 >                                            ...b: number[]
1->Emitted(51, 10) Source(7, 35) + SourceIndex(1)
2 >Emitted(51, 20) Source(7, 49) + SourceIndex(1)
3 >Emitted(51, 22) Source(7, 35) + SourceIndex(1)
4 >Emitted(51, 43) Source(7, 49) + SourceIndex(1)
5 >Emitted(51, 45) Source(7, 35) + SourceIndex(1)
6 >Emitted(51, 49) Source(7, 49) + SourceIndex(1)
---
>>>        b[_i] = arguments[_i];
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
1 >
2 >        ...b: number[]
1 >Emitted(52, 9) Source(7, 35) + SourceIndex(1)
2 >Emitted(52, 31) Source(7, 49) + SourceIndex(1)
---
>>>    }
>>>}
1 >
...
1 >) { 
2 >}
1 >Emitted(54, 1) Source(7, 53) + SourceIndex(1)
2 >Emitted(54, 2) Source(7, 54) + SourceIndex(1)
---
>>>secondsecond_part2Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^^^
...
10>                                                           ]
11>                                                            );
1->Emitted(55, 1) Source(8, 1) + SourceIndex(1)
2 >Emitted(55, 25) Source(8, 25) + SourceIndex(1)
3 >Emitted(55, 49) Source(8, 29) + SourceIndex(1)
4 >Emitted(55, 50) Source(8, 30) + SourceIndex(1)
5 >Emitted(55, 52) Source(8, 32) + SourceIndex(1)
6 >Emitted(55, 54) Source(8, 34) + SourceIndex(1)
7 >Emitted(55, 56) Source(8, 36) + SourceIndex(1)
8 >Emitted(55, 58) Source(8, 38) + SourceIndex(1)
9 >Emitted(55, 60) Source(8, 40) + SourceIndex(1)
10>Emitted(55, 61) Source(8, 41) + SourceIndex(1)
11>Emitted(55, 64) Source(8, 43) + SourceIndex(1)
---
>>>//# sourceMappingURL=second-output.js.map
...
4 >Emitted(43, 36) Source(4, 33) + SourceIndex(2)
5 >Emitted(43, 47) Source(4, 47) + SourceIndex(2)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
3 >Emitted(62, 6) Source(2, 5) + SourceIndex(4)
4 >Emitted(62, 29) Source(2, 16) + SourceIndex(4)
5 >Emitted(62, 32) Source(2, 5) + SourceIndex(4)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
4 >Emitted(67, 38) Source(7, 35) + SourceIndex(4)
5 >Emitted(67, 49) Source(7, 49) + SourceIndex(4)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
4 >Emitted(78, 36) Source(6, 33) + SourceIndex(5)
5 >Emitted(78, 47) Source(6, 47) + SourceIndex(5)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
----------------------------------------------------------------------
prepend: (1180-1615):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1180-1615)
...
firstfirst_part3Spread.apply(void 0, __spread([10, 20, 30]));
----------------------------------------------------------------------
prepend: (1617-2225):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1617-2225)
var N;
(function (N) {
