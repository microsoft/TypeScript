...
secondsecond_part1Spread.apply(void 0, [10, 20, 30]);
var C = (function () {
    function C() {
    }
...
2 >Emitted(8, 10) Source(13, 10) + SourceIndex(0)
3 >Emitted(8, 34) Source(13, 34) + SourceIndex(0)
---
>>>    var b = [];
1 >^^^^
2 >    ^^^^^^^^^^^
...
1 >(
2 >    ...b: number[]
1 >Emitted(9, 5) Source(13, 35) + SourceIndex(0)
2 >Emitted(9, 16) Source(13, 49) + SourceIndex(0)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
5 >                                          
6 >                                            ...b: number[]
1->Emitted(10, 10) Source(13, 35) + SourceIndex(0)
2 >Emitted(10, 20) Source(13, 49) + SourceIndex(0)
3 >Emitted(10, 22) Source(13, 35) + SourceIndex(0)
4 >Emitted(10, 43) Source(13, 49) + SourceIndex(0)
5 >Emitted(10, 45) Source(13, 35) + SourceIndex(0)
6 >Emitted(10, 49) Source(13, 49) + SourceIndex(0)
---
>>>        b[_i] = arguments[_i];
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
1 >
2 >        ...b: number[]
1 >Emitted(11, 9) Source(13, 35) + SourceIndex(0)
2 >Emitted(11, 31) Source(13, 49) + SourceIndex(0)
---
>>>    }
>>>}
1 >
...
1 >) { 
2 >}
1 >Emitted(13, 1) Source(13, 53) + SourceIndex(0)
2 >Emitted(13, 2) Source(13, 54) + SourceIndex(0)
---
>>>secondsecond_part1Spread.apply(void 0, [10, 20, 30]);
1->
2 >^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >Emitted(14, 25) Source(14, 25) + SourceIndex(0)
3 >Emitted(14, 40) Source(14, 29) + SourceIndex(0)
4 >Emitted(14, 41) Source(14, 30) + SourceIndex(0)
5 >Emitted(14, 43) Source(14, 32) + SourceIndex(0)
6 >Emitted(14, 45) Source(14, 34) + SourceIndex(0)
7 >Emitted(14, 47) Source(14, 36) + SourceIndex(0)
8 >Emitted(14, 49) Source(14, 38) + SourceIndex(0)
9 >Emitted(14, 51) Source(14, 40) + SourceIndex(0)
10>Emitted(14, 52) Source(14, 41) + SourceIndex(0)
11>Emitted(14, 54) Source(14, 43) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/2/second-output.js
sourceFile:../second/second_part2.ts
...
2 >    ^^->
1->
1->Emitted(16, 5) Source(1, 1) + SourceIndex(1)
---
>>>    }
1->^^^^
2 >    ^
...
1->class C {
  ...
  >
2 >    }
1->Emitted(17, 5) Source(5, 1) + SourceIndex(1)
2 >Emitted(17, 6) Source(5, 2) + SourceIndex(1)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(18, 5) Source(2, 5) + SourceIndex(1)
2 >Emitted(18, 28) Source(2, 16) + SourceIndex(1)
3 >Emitted(18, 31) Source(2, 5) + SourceIndex(1)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(19, 9) Source(3, 9) + SourceIndex(1)
2 >Emitted(19, 16) Source(3, 16) + SourceIndex(1)
3 >Emitted(19, 17) Source(3, 17) + SourceIndex(1)
4 >Emitted(19, 20) Source(3, 20) + SourceIndex(1)
5 >Emitted(19, 21) Source(3, 21) + SourceIndex(1)
6 >Emitted(19, 41) Source(3, 41) + SourceIndex(1)
7 >Emitted(19, 42) Source(3, 42) + SourceIndex(1)
8 >Emitted(19, 43) Source(3, 43) + SourceIndex(1)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(20, 5) Source(4, 5) + SourceIndex(1)
2 >Emitted(20, 6) Source(4, 6) + SourceIndex(1)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
1->
  >
2 >    }
1->Emitted(21, 5) Source(5, 1) + SourceIndex(1)
2 >Emitted(21, 13) Source(5, 2) + SourceIndex(1)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(22, 1) Source(5, 1) + SourceIndex(1)
2 >Emitted(22, 2) Source(5, 2) + SourceIndex(1)
3 >Emitted(22, 2) Source(1, 1) + SourceIndex(1)
4 >Emitted(22, 6) Source(5, 2) + SourceIndex(1)
---
>>>//# sourceMappingURL=second-output.js.map
...
2 >Emitted(28, 10) Source(13, 10) + SourceIndex(3)
3 >Emitted(28, 34) Source(13, 34) + SourceIndex(3)
---
>>>    var b = [];
1 >^^^^
2 >    ^^^^^^^^^^^
...
1 >(
2 >    ...b: number[]
1 >Emitted(29, 5) Source(13, 35) + SourceIndex(3)
2 >Emitted(29, 16) Source(13, 49) + SourceIndex(3)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
5 >                                          
6 >                                            ...b: number[]
1->Emitted(30, 10) Source(13, 35) + SourceIndex(3)
2 >Emitted(30, 20) Source(13, 49) + SourceIndex(3)
3 >Emitted(30, 22) Source(13, 35) + SourceIndex(3)
4 >Emitted(30, 43) Source(13, 49) + SourceIndex(3)
5 >Emitted(30, 45) Source(13, 35) + SourceIndex(3)
6 >Emitted(30, 49) Source(13, 49) + SourceIndex(3)
---
>>>        b[_i] = arguments[_i];
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
1 >
2 >        ...b: number[]
1 >Emitted(31, 9) Source(13, 35) + SourceIndex(3)
2 >Emitted(31, 31) Source(13, 49) + SourceIndex(3)
---
>>>    }
>>>}
1 >
...
1 >) { 
2 >}
1 >Emitted(33, 1) Source(13, 53) + SourceIndex(3)
2 >Emitted(33, 2) Source(13, 54) + SourceIndex(3)
---
>>>secondsecond_part1Spread.apply(void 0, [10, 20, 30]);
1->
2 >^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >Emitted(34, 25) Source(14, 25) + SourceIndex(3)
3 >Emitted(34, 40) Source(14, 29) + SourceIndex(3)
4 >Emitted(34, 41) Source(14, 30) + SourceIndex(3)
5 >Emitted(34, 43) Source(14, 32) + SourceIndex(3)
6 >Emitted(34, 45) Source(14, 34) + SourceIndex(3)
7 >Emitted(34, 47) Source(14, 36) + SourceIndex(3)
8 >Emitted(34, 49) Source(14, 38) + SourceIndex(3)
9 >Emitted(34, 51) Source(14, 40) + SourceIndex(3)
10>Emitted(34, 52) Source(14, 41) + SourceIndex(3)
11>Emitted(34, 54) Source(14, 43) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
----------------------------------------------------------------------
prepend: (729-1220):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (729-1220)
var N;
(function (N) {
