...
3 >     ()
4 >       ;
1 >Emitted(28, 5) Source(10, 5) + SourceIndex(0)
2 >Emitted(28, 6) Source(10, 6) + SourceIndex(0)
3 >Emitted(28, 8) Source(10, 8) + SourceIndex(0)
4 >Emitted(28, 9) Source(10, 9) + SourceIndex(0)
---
>>>})(N || (N = {}));
1->
2 >^
...
7 >           {
  ...
  >              f();
  >          }
1->Emitted(29, 1) Source(11, 1) + SourceIndex(0)
2 >Emitted(29, 2) Source(11, 2) + SourceIndex(0)
3 >Emitted(29, 4) Source(5, 11) + SourceIndex(0)
4 >Emitted(29, 5) Source(5, 12) + SourceIndex(0)
5 >Emitted(29, 10) Source(5, 11) + SourceIndex(0)
6 >Emitted(29, 11) Source(5, 12) + SourceIndex(0)
7 >Emitted(29, 19) Source(11, 2) + SourceIndex(0)
---
>>>function secondsecond_part1Spread() {var b = [];
1->
2 >^^^^^^^^^
...
4 >                                 (
5 >                                     ...b: number[]
1->Emitted(30, 1) Source(13, 1) + SourceIndex(0)
2 >Emitted(30, 10) Source(13, 10) + SourceIndex(0)
3 >Emitted(30, 34) Source(13, 34) + SourceIndex(0)
4 >Emitted(30, 38) Source(13, 35) + SourceIndex(0)
5 >Emitted(30, 49) Source(13, 49) + SourceIndex(0)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
7 >Emitted(58, 92) Source(15, 56) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
----------------------------------------------------------------------
prepend: (1201-1432):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1201-1432)
...
----------------------------------------------------------------------
prepend: (1432-1996):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1432-1996)
var N;
(function (N) {
