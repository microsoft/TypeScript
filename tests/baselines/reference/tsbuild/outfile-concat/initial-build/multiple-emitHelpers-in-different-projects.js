...
{"version":3,"file":"second-output.js","sourceRoot":"","sources":["../second/second_part1.ts","../second/second_part2.ts"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;AAIA,IAAU,CAAC,CAMV;AAND,WAAU,CAAC;IACP,SAAS,CAAC;QACN,OAAO,CAAC,GAAG,CAAC,SAAS,CAAC,CAAC;IAC3B,CAAC;IAED,CAAC,EAAE,CAAC;AACR,CAAC,EANS,CAAC,KAAD,CAAC,QAMV;AAED,SAAS,wBAAwB,KAAmB,CAAC;AACrD,wBAAwB,wBAAI,CAAC,EAAE,EAAE,EAAE,EAAE,EAAE,CAAC,GAAE;ACb1C;IAAA;IAIA,CAAC;IAHG,uBAAW,GAAX;QACI,OAAO,CAAC,GAAG,CAAC,oBAAoB,CAAC,CAAC;IACtC,CAAC;IACL,QAAC;AAAD,CAAC,AAJD,IAIC"}
...
4 >Emitted(28, 39) Source(13, 53) + SourceIndex(0)
5 >Emitted(28, 40) Source(13, 54) + SourceIndex(0)
---
>>>secondsecond_part1Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >Emitted(29, 25) Source(14, 25) + SourceIndex(0)
3 >Emitted(29, 49) Source(14, 29) + SourceIndex(0)
4 >Emitted(29, 50) Source(14, 30) + SourceIndex(0)
5 >Emitted(29, 52) Source(14, 32) + SourceIndex(0)
6 >Emitted(29, 54) Source(14, 34) + SourceIndex(0)
7 >Emitted(29, 56) Source(14, 36) + SourceIndex(0)
8 >Emitted(29, 58) Source(14, 38) + SourceIndex(0)
9 >Emitted(29, 60) Source(14, 40) + SourceIndex(0)
10>Emitted(29, 61) Source(14, 41) + SourceIndex(0)
11>Emitted(29, 64) Source(14, 43) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/2/second-output.js
sourceFile:../second/second_part2.ts
...
2 >    ^^->
1->
1->Emitted(31, 5) Source(1, 1) + SourceIndex(1)
---
>>>    }
1->^^^^
2 >    ^
...
1->class C {
  ...
  >
2 >    }
1->Emitted(32, 5) Source(5, 1) + SourceIndex(1)
2 >Emitted(32, 6) Source(5, 2) + SourceIndex(1)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(33, 5) Source(2, 5) + SourceIndex(1)
2 >Emitted(33, 28) Source(2, 16) + SourceIndex(1)
3 >Emitted(33, 31) Source(2, 5) + SourceIndex(1)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(34, 9) Source(3, 9) + SourceIndex(1)
2 >Emitted(34, 16) Source(3, 16) + SourceIndex(1)
3 >Emitted(34, 17) Source(3, 17) + SourceIndex(1)
4 >Emitted(34, 20) Source(3, 20) + SourceIndex(1)
5 >Emitted(34, 21) Source(3, 21) + SourceIndex(1)
6 >Emitted(34, 41) Source(3, 41) + SourceIndex(1)
7 >Emitted(34, 42) Source(3, 42) + SourceIndex(1)
8 >Emitted(34, 43) Source(3, 43) + SourceIndex(1)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(35, 5) Source(4, 5) + SourceIndex(1)
2 >Emitted(35, 6) Source(4, 6) + SourceIndex(1)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
1->
  >
2 >    }
1->Emitted(36, 5) Source(5, 1) + SourceIndex(1)
2 >Emitted(36, 13) Source(5, 2) + SourceIndex(1)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(37, 1) Source(5, 1) + SourceIndex(1)
2 >Emitted(37, 2) Source(5, 2) + SourceIndex(1)
3 >Emitted(37, 2) Source(1, 1) + SourceIndex(1)
4 >Emitted(37, 6) Source(5, 2) + SourceIndex(1)
---
>>>//# sourceMappingURL=second-output.js.map
...
4 >Emitted(48, 39) Source(13, 53) + SourceIndex(3)
5 >Emitted(48, 40) Source(13, 54) + SourceIndex(3)
---
>>>secondsecond_part1Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^^^
...
10>                                                           ]
11>                                                            );
1->Emitted(49, 1) Source(14, 1) + SourceIndex(3)
2 >Emitted(49, 25) Source(14, 25) + SourceIndex(3)
3 >Emitted(49, 49) Source(14, 29) + SourceIndex(3)
4 >Emitted(49, 50) Source(14, 30) + SourceIndex(3)
5 >Emitted(49, 52) Source(14, 32) + SourceIndex(3)
6 >Emitted(49, 54) Source(14, 34) + SourceIndex(3)
7 >Emitted(49, 56) Source(14, 36) + SourceIndex(3)
8 >Emitted(49, 58) Source(14, 38) + SourceIndex(3)
9 >Emitted(49, 60) Source(14, 40) + SourceIndex(3)
10>Emitted(49, 61) Source(14, 41) + SourceIndex(3)
11>Emitted(49, 64) Source(14, 43) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
2 >^^^^^^^^^^^^^^^^^^^->
1 >
1 >Emitted(50, 1) Source(1, 1) + SourceIndex(4)
---
>>>    function C() {
1->^^^^
2 >    ^^->
1->
1->Emitted(51, 5) Source(1, 1) + SourceIndex(4)
---
>>>    }
1->^^^^
2 >    ^
...
1->class C {
  ...
  >
2 >    }
1->Emitted(52, 5) Source(5, 1) + SourceIndex(4)
2 >Emitted(52, 6) Source(5, 2) + SourceIndex(4)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(53, 5) Source(2, 5) + SourceIndex(4)
2 >Emitted(53, 28) Source(2, 16) + SourceIndex(4)
3 >Emitted(53, 31) Source(2, 5) + SourceIndex(4)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(54, 9) Source(3, 9) + SourceIndex(4)
2 >Emitted(54, 16) Source(3, 16) + SourceIndex(4)
3 >Emitted(54, 17) Source(3, 17) + SourceIndex(4)
4 >Emitted(54, 20) Source(3, 20) + SourceIndex(4)
5 >Emitted(54, 21) Source(3, 21) + SourceIndex(4)
6 >Emitted(54, 41) Source(3, 41) + SourceIndex(4)
7 >Emitted(54, 42) Source(3, 42) + SourceIndex(4)
8 >Emitted(54, 43) Source(3, 43) + SourceIndex(4)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(55, 5) Source(4, 5) + SourceIndex(4)
2 >Emitted(55, 6) Source(4, 6) + SourceIndex(4)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
...
2 >Emitted(56, 13) Source(5, 2) + SourceIndex(4)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(57, 1) Source(5, 1) + SourceIndex(4)
2 >Emitted(57, 2) Source(5, 2) + SourceIndex(4)
3 >Emitted(57, 2) Source(1, 1) + SourceIndex(4)
4 >Emitted(57, 6) Source(5, 2) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../third_part1.ts
...
3 >Emitted(61, 14) Source(4, 24) + SourceIndex(5)
4 >Emitted(61, 16) Source(4, 26) + SourceIndex(5)
5 >Emitted(61, 17) Source(4, 27) + SourceIndex(5)
6 >Emitted(61, 19) Source(4, 29) + SourceIndex(5)
7 >Emitted(61, 21) Source(4, 31) + SourceIndex(5)
8 >Emitted(61, 23) Source(4, 33) + SourceIndex(5)
9 >Emitted(61, 24) Source(4, 34) + SourceIndex(5)
10>Emitted(61, 26) Source(4, 36) + SourceIndex(5)
11>Emitted(61, 28) Source(4, 38) + SourceIndex(5)
12>Emitted(61, 30) Source(4, 40) + SourceIndex(5)
13>Emitted(61, 32) Source(4, 42) + SourceIndex(5)
14>Emitted(61, 34) Source(4, 44) + SourceIndex(5)
15>Emitted(61, 36) Source(4, 46) + SourceIndex(5)
16>Emitted(61, 38) Source(4, 48) + SourceIndex(5)
17>Emitted(61, 40) Source(4, 9) + SourceIndex(5)
18>Emitted(61, 41) Source(4, 10) + SourceIndex(5)
19>Emitted(61, 48) Source(4, 10) + SourceIndex(5)
20>Emitted(61, 50) Source(4, 15) + SourceIndex(5)
21>Emitted(61, 54) Source(4, 19) + SourceIndex(5)
22>Emitted(61, 68) Source(4, 7) + SourceIndex(5)
23>Emitted(61, 73) Source(4, 21) + SourceIndex(5)
24>Emitted(61, 74) Source(4, 48) + SourceIndex(5)
25>Emitted(61, 75) Source(4, 49) + SourceIndex(5)
---
>>>}
1 >
2 >^
...
----------------------------------------------------------------------
prepend: (1407-1798):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1407-1798)
var N;
(function (N) {
