...
3 >     ()
4 >       ;
1 >Emitted(10, 5) Source(11, 5) + SourceIndex(0)
2 >Emitted(10, 6) Source(11, 6) + SourceIndex(0)
3 >Emitted(10, 8) Source(11, 8) + SourceIndex(0)
4 >Emitted(10, 9) Source(11, 9) + SourceIndex(0)
---
>>>})(N || (N = {}));
1->
2 >^
...
2 >Emitted(11, 2) Source(12, 2) + SourceIndex(0)
3 >Emitted(11, 4) Source(6, 11) + SourceIndex(0)
4 >Emitted(11, 5) Source(6, 12) + SourceIndex(0)
5 >Emitted(11, 10) Source(6, 11) + SourceIndex(0)
6 >Emitted(11, 11) Source(6, 12) + SourceIndex(0)
7 >Emitted(11, 19) Source(12, 2) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/2/second-output.js
sourceFile:../second/second_part2.ts
...
2 >Emitted(14, 6) Source(6, 2) + SourceIndex(1)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(15, 5) Source(3, 5) + SourceIndex(1)
2 >Emitted(15, 28) Source(3, 16) + SourceIndex(1)
3 >Emitted(15, 31) Source(3, 5) + SourceIndex(1)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(16, 9) Source(4, 9) + SourceIndex(1)
2 >Emitted(16, 16) Source(4, 16) + SourceIndex(1)
3 >Emitted(16, 17) Source(4, 17) + SourceIndex(1)
4 >Emitted(16, 20) Source(4, 20) + SourceIndex(1)
5 >Emitted(16, 21) Source(4, 21) + SourceIndex(1)
6 >Emitted(16, 41) Source(4, 41) + SourceIndex(1)
7 >Emitted(16, 42) Source(4, 42) + SourceIndex(1)
8 >Emitted(16, 43) Source(4, 43) + SourceIndex(1)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(17, 5) Source(5, 5) + SourceIndex(1)
2 >Emitted(17, 6) Source(5, 6) + SourceIndex(1)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
1->
  >
2 >    }
1->Emitted(18, 5) Source(6, 1) + SourceIndex(1)
2 >Emitted(18, 13) Source(6, 2) + SourceIndex(1)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(19, 1) Source(6, 1) + SourceIndex(1)
2 >Emitted(19, 2) Source(6, 2) + SourceIndex(1)
3 >Emitted(19, 2) Source(2, 1) + SourceIndex(1)
4 >Emitted(19, 6) Source(6, 2) + SourceIndex(1)
---
>>>//# sourceMappingURL=second-output.js.map
