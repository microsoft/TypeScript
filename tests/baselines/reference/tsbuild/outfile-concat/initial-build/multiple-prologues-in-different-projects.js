...
3 >Emitted(13, 6) Source(3, 5) + SourceIndex(1)
4 >Emitted(13, 29) Source(3, 16) + SourceIndex(1)
5 >Emitted(13, 32) Source(3, 5) + SourceIndex(1)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
3 >     ()
4 >       ;
1 >Emitted(18, 5) Source(11, 5) + SourceIndex(0)
2 >Emitted(18, 6) Source(11, 6) + SourceIndex(0)
3 >Emitted(18, 8) Source(11, 8) + SourceIndex(0)
4 >Emitted(18, 9) Source(11, 9) + SourceIndex(0)
---
>>>})(N || (N = {}));
1->
2 >^
...
2 >Emitted(19, 2) Source(12, 2) + SourceIndex(0)
3 >Emitted(19, 4) Source(6, 11) + SourceIndex(0)
4 >Emitted(19, 5) Source(6, 12) + SourceIndex(0)
5 >Emitted(19, 10) Source(6, 11) + SourceIndex(0)
6 >Emitted(19, 11) Source(6, 12) + SourceIndex(0)
7 >Emitted(19, 19) Source(12, 2) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
3 >Emitted(22, 6) Source(3, 5) + SourceIndex(1)
4 >Emitted(22, 29) Source(3, 16) + SourceIndex(1)
5 >Emitted(22, 32) Source(3, 5) + SourceIndex(1)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
"myPrologue2";
----------------------------------------------------------------------
prepend: (46-160):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (46-160)
...
----------------------------------------------------------------------
prepend: (160-441):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (160-441)
var N;
(function (N) {
