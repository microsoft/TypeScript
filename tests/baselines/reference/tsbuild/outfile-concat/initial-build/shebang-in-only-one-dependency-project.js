...
2 >^^^^^^^^^^^^^^^^^^^->
1->
1->Emitted(10, 1) Source(1, 1) + SourceIndex(1)
---
>>>    function C() {
1->^^^^
2 >    ^^->
1->
1->Emitted(11, 5) Source(1, 1) + SourceIndex(1)
---
>>>    }
1->^^^^
2 >    ^
...
1->class C {
  ...
  >
2 >    }
1->Emitted(12, 5) Source(5, 1) + SourceIndex(1)
2 >Emitted(12, 6) Source(5, 2) + SourceIndex(1)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(13, 5) Source(2, 5) + SourceIndex(1)
2 >Emitted(13, 28) Source(2, 16) + SourceIndex(1)
3 >Emitted(13, 31) Source(2, 5) + SourceIndex(1)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(14, 9) Source(3, 9) + SourceIndex(1)
2 >Emitted(14, 16) Source(3, 16) + SourceIndex(1)
3 >Emitted(14, 17) Source(3, 17) + SourceIndex(1)
4 >Emitted(14, 20) Source(3, 20) + SourceIndex(1)
5 >Emitted(14, 21) Source(3, 21) + SourceIndex(1)
6 >Emitted(14, 41) Source(3, 41) + SourceIndex(1)
7 >Emitted(14, 42) Source(3, 42) + SourceIndex(1)
8 >Emitted(14, 43) Source(3, 43) + SourceIndex(1)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(15, 5) Source(4, 5) + SourceIndex(1)
2 >Emitted(15, 6) Source(4, 6) + SourceIndex(1)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
...
2 >Emitted(16, 13) Source(5, 2) + SourceIndex(1)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(17, 1) Source(5, 1) + SourceIndex(1)
2 >Emitted(17, 2) Source(5, 2) + SourceIndex(1)
3 >Emitted(17, 2) Source(1, 1) + SourceIndex(1)
...
2 >Emitted(11, 5) Source(6, 11) + SourceIndex(3)
3 >Emitted(11, 6) Source(6, 12) + SourceIndex(3)
4 >Emitted(11, 7) Source(12, 2) + SourceIndex(3)
---
>>>(function (N) {
1->
2 >^^^^^^^^^^^
...
2 >Emitted(12, 12) Source(6, 11) + SourceIndex(3)
3 >Emitted(12, 13) Source(6, 12) + SourceIndex(3)
---
>>>    function f() {
1->^^^^
2 >    ^^^^^^^^^
...
2 >    function 
3 >             f
1->Emitted(13, 5) Source(7, 5) + SourceIndex(3)
2 >Emitted(13, 14) Source(7, 14) + SourceIndex(3)
3 >Emitted(13, 15) Source(7, 15) + SourceIndex(3)
---
>>>        console.log('testing');
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                             )
8 >                              ;
1->Emitted(14, 9) Source(8, 9) + SourceIndex(3)
2 >Emitted(14, 16) Source(8, 16) + SourceIndex(3)
3 >Emitted(14, 17) Source(8, 17) + SourceIndex(3)
4 >Emitted(14, 20) Source(8, 20) + SourceIndex(3)
5 >Emitted(14, 21) Source(8, 21) + SourceIndex(3)
6 >Emitted(14, 30) Source(8, 30) + SourceIndex(3)
7 >Emitted(14, 31) Source(8, 31) + SourceIndex(3)
8 >Emitted(14, 32) Source(8, 32) + SourceIndex(3)
---
>>>    }
1 >^^^^
2 >    ^
1 >
  >    
2 >    }
1 >Emitted(15, 5) Source(9, 5) + SourceIndex(3)
2 >Emitted(15, 6) Source(9, 6) + SourceIndex(3)
---
>>>
>>>    f();
1 >^^^^
...
3 >     ()
4 >       ;
1 >Emitted(17, 5) Source(11, 5) + SourceIndex(3)
2 >Emitted(17, 6) Source(11, 6) + SourceIndex(3)
3 >Emitted(17, 8) Source(11, 8) + SourceIndex(3)
4 >Emitted(17, 9) Source(11, 9) + SourceIndex(3)
---
>>>})(N || (N = {}));
1->
2 >^
...
7 >           {
  ...
  >              f();
  >          }
1->Emitted(18, 1) Source(12, 1) + SourceIndex(3)
2 >Emitted(18, 2) Source(12, 2) + SourceIndex(3)
3 >Emitted(18, 4) Source(6, 11) + SourceIndex(3)
4 >Emitted(18, 5) Source(6, 12) + SourceIndex(3)
5 >Emitted(18, 10) Source(6, 11) + SourceIndex(3)
6 >Emitted(18, 11) Source(6, 12) + SourceIndex(3)
7 >Emitted(18, 19) Source(12, 2) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
----------------------------------------------------------------------
prepend: (35-151):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (35-151)
...
----------------------------------------------------------------------
prepend: (151-438):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (151-438)
var N;
(function (N) {
