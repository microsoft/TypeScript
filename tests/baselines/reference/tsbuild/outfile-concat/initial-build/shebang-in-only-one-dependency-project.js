...
3 >     ()
4 >       ;
1 >Emitted(16, 5) Source(11, 5) + SourceIndex(3)
2 >Emitted(16, 6) Source(11, 6) + SourceIndex(3)
3 >Emitted(16, 8) Source(11, 8) + SourceIndex(3)
4 >Emitted(16, 9) Source(11, 9) + SourceIndex(3)
---
>>>})(N || (N = {}));
1->
2 >^
...
7 >           {
  ...
  >              f();
  >          }
1->Emitted(17, 1) Source(12, 1) + SourceIndex(3)
2 >Emitted(17, 2) Source(12, 2) + SourceIndex(3)
3 >Emitted(17, 4) Source(6, 11) + SourceIndex(3)
4 >Emitted(17, 5) Source(6, 12) + SourceIndex(3)
5 >Emitted(17, 10) Source(6, 11) + SourceIndex(3)
6 >Emitted(17, 11) Source(6, 12) + SourceIndex(3)
7 >Emitted(17, 19) Source(12, 2) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
...
2 >    ^^->
1->
1->Emitted(19, 5) Source(1, 1) + SourceIndex(4)
---
>>>    }
1->^^^^
2 >    ^
...
2 >Emitted(20, 6) Source(5, 2) + SourceIndex(4)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(21, 5) Source(2, 5) + SourceIndex(4)
2 >Emitted(21, 28) Source(2, 16) + SourceIndex(4)
3 >Emitted(21, 31) Source(2, 5) + SourceIndex(4)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
----------------------------------------------------------------------
prepend: (35-149):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (35-149)
...
----------------------------------------------------------------------
prepend: (149-436):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (149-436)
var N;
(function (N) {
