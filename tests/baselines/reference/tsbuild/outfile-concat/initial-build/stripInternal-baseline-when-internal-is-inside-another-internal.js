...
2 >Emitted(2, 5) Source(32, 7) + SourceIndex(0)
3 >Emitted(2, 6) Source(32, 8) + SourceIndex(0)
4 >Emitted(2, 9) Source(32, 11) + SourceIndex(0)
5 >Emitted(2, 23) Source(32, 25) + SourceIndex(0)
6 >Emitted(2, 24) Source(32, 26) + SourceIndex(0)
---
>>>
>>>
>>>console.log(s);
...
7 >             )
8 >              ;
1 >Emitted(5, 1) Source(38, 1) + SourceIndex(0)
2 >Emitted(5, 8) Source(38, 8) + SourceIndex(0)
3 >Emitted(5, 9) Source(38, 9) + SourceIndex(0)
4 >Emitted(5, 12) Source(38, 12) + SourceIndex(0)
5 >Emitted(5, 13) Source(38, 13) + SourceIndex(0)
6 >Emitted(5, 14) Source(38, 14) + SourceIndex(0)
7 >Emitted(5, 15) Source(38, 15) + SourceIndex(0)
8 >Emitted(5, 16) Source(38, 16) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/first/bin/first-output.js
