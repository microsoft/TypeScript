...
7 >             )
8 >              ;
1 >Emitted(4, 1) Source(38, 1) + SourceIndex(0)
2 >Emitted(4, 8) Source(38, 8) + SourceIndex(0)
3 >Emitted(4, 9) Source(38, 9) + SourceIndex(0)
4 >Emitted(4, 12) Source(38, 12) + SourceIndex(0)
5 >Emitted(4, 13) Source(38, 13) + SourceIndex(0)
6 >Emitted(4, 14) Source(38, 14) + SourceIndex(0)
7 >Emitted(4, 15) Source(38, 15) + SourceIndex(0)
8 >Emitted(4, 16) Source(38, 16) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/first/bin/first-output.js
