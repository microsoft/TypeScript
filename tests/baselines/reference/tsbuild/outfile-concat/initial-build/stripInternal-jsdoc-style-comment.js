...
1->
  >/**@internal*/ 
1->Emitted(57, 1) Source(30, 16) + SourceIndex(0)
---
>>>    function internalC() {}
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
4 >                    () {
5 >                         }
1->Emitted(61, 1) Source(31, 16) + SourceIndex(0)
2 >Emitted(61, 10) Source(31, 25) + SourceIndex(0)
3 >Emitted(61, 21) Source(31, 36) + SourceIndex(0)
4 >Emitted(61, 26) Source(31, 40) + SourceIndex(0)
5 >Emitted(61, 27) Source(31, 41) + SourceIndex(0)
---
>>>var internalNamespace;
1 >
2 >^^^^
...
3 >    internalNamespace
4 >                      { export class someClass {} }
1 >Emitted(62, 1) Source(32, 16) + SourceIndex(0)
2 >Emitted(62, 5) Source(32, 26) + SourceIndex(0)
3 >Emitted(62, 22) Source(32, 43) + SourceIndex(0)
4 >Emitted(62, 23) Source(32, 73) + SourceIndex(0)
---
>>>(function (internalNamespace) {var someClass = (function () {
1->
2 >^^^^^^^^^^^
...
3 >    internalOther
4 >                 .something { export class someClass {} }
1 >Emitted(69, 1) Source(33, 16) + SourceIndex(0)
2 >Emitted(69, 5) Source(33, 26) + SourceIndex(0)
3 >Emitted(69, 18) Source(33, 39) + SourceIndex(0)
...
7 >                                       someClass
8 >                                                ;
1->Emitted(79, 1) Source(34, 16) + SourceIndex(0)
2 >Emitted(79, 5) Source(34, 23) + SourceIndex(0)
3 >Emitted(79, 19) Source(34, 37) + SourceIndex(0)
4 >Emitted(79, 22) Source(34, 40) + SourceIndex(0)
5 >Emitted(79, 39) Source(34, 57) + SourceIndex(0)
6 >Emitted(79, 40) Source(34, 58) + SourceIndex(0)
7 >Emitted(79, 49) Source(34, 67) + SourceIndex(0)
8 >Emitted(79, 50) Source(34, 68) + SourceIndex(0)
---
>>>
>>>var internalConst = 10;
1 >
...
5 >                    10
6 >                      ;
1 >Emitted(81, 1) Source(36, 16) + SourceIndex(0)
2 >Emitted(81, 5) Source(36, 22) + SourceIndex(0)
3 >Emitted(81, 18) Source(36, 35) + SourceIndex(0)
4 >Emitted(81, 21) Source(36, 38) + SourceIndex(0)
5 >Emitted(81, 23) Source(36, 40) + SourceIndex(0)
6 >Emitted(81, 24) Source(36, 41) + SourceIndex(0)
---
>>>var internalEnum;
1 >
2 >^^^^
...
2 >enum 
3 >    internalEnum { a, b, c }
1 >Emitted(82, 1) Source(37, 16) + SourceIndex(0)
2 >Emitted(82, 5) Source(37, 21) + SourceIndex(0)
3 >Emitted(82, 17) Source(37, 45) + SourceIndex(0)
---
>>>(function (internalEnum) {
1->
2 >^^^^^^^^^^^
...
2 >Emitted(80, 9) Source(33, 40) + SourceIndex(3)
3 >Emitted(80, 18) Source(33, 49) + SourceIndex(3)
4 >Emitted(80, 19) Source(33, 79) + SourceIndex(3)
---
>>>    (function (something) {var someClass = (function () {
1->^^^^
2 >    ^^^^^^^^^^^
...
2 >Emitted(81, 16) Source(33, 40) + SourceIndex(3)
3 >Emitted(81, 25) Source(33, 49) + SourceIndex(3)
4 >Emitted(81, 28) Source(33, 52) + SourceIndex(3)
---
>>>            function someClass() {}
1->^^^^^^^^^^^^
2 >            ^^^^^^^^^^^^^^^^^^^^^^
...
2 >            export class someClass {
3 >                                  }
1->Emitted(82, 13) Source(33, 52) + SourceIndex(3)
2 >Emitted(82, 35) Source(33, 76) + SourceIndex(3)
3 >Emitted(82, 36) Source(33, 77) + SourceIndex(3)
---
>>>            return someClass;
1 >^^^^^^^^^^^^
2 >            ^^^^^^^^^^^^^^^^
1 >
2 >            }
1 >Emitted(83, 13) Source(33, 76) + SourceIndex(3)
2 >Emitted(83, 29) Source(33, 77) + SourceIndex(3)
---
>>>        }());
1 >^^^^^^^^
2 >        ^
...
3 >         
4 >         export class someClass {}
1 >Emitted(84, 9) Source(33, 76) + SourceIndex(3)
2 >Emitted(84, 10) Source(33, 77) + SourceIndex(3)
3 >Emitted(84, 10) Source(33, 52) + SourceIndex(3)
4 >Emitted(84, 14) Source(33, 77) + SourceIndex(3)
---
>>>        something.someClass = someClass;
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^
...
3 >                            {}
4 >                                       
1->Emitted(85, 9) Source(33, 65) + SourceIndex(3)
2 >Emitted(85, 28) Source(33, 74) + SourceIndex(3)
3 >Emitted(85, 40) Source(33, 77) + SourceIndex(3)
4 >Emitted(85, 41) Source(33, 77) + SourceIndex(3)
---
>>>    })(something = internalOther.something || (internalOther.something = {}));
1->^^^^
2 >    ^
...
8 >                                               something
9 >                                                                       { export class someClass {} }
1->Emitted(86, 5) Source(33, 78) + SourceIndex(3)
2 >Emitted(86, 6) Source(33, 79) + SourceIndex(3)
3 >Emitted(86, 8) Source(33, 40) + SourceIndex(3)
4 >Emitted(86, 17) Source(33, 49) + SourceIndex(3)
5 >Emitted(86, 20) Source(33, 40) + SourceIndex(3)
6 >Emitted(86, 43) Source(33, 49) + SourceIndex(3)
7 >Emitted(86, 48) Source(33, 40) + SourceIndex(3)
8 >Emitted(86, 71) Source(33, 49) + SourceIndex(3)
9 >Emitted(86, 79) Source(33, 79) + SourceIndex(3)
---
>>>})(internalOther || (internalOther = {}));
1 >
2 >^
...
6 >                     internalOther
7 >                                  .something { export class someClass {} }
1 >Emitted(87, 1) Source(33, 78) + SourceIndex(3)
2 >Emitted(87, 2) Source(33, 79) + SourceIndex(3)
3 >Emitted(87, 4) Source(33, 26) + SourceIndex(3)
4 >Emitted(87, 17) Source(33, 39) + SourceIndex(3)
5 >Emitted(87, 22) Source(33, 26) + SourceIndex(3)
6 >Emitted(87, 35) Source(33, 39) + SourceIndex(3)
7 >Emitted(87, 43) Source(33, 79) + SourceIndex(3)
---
>>>var internalImport = internalNamespace.someClass;
1->
2 >^^^^
...
7 >                                       someClass
8 >                                                ;
1->Emitted(88, 1) Source(34, 16) + SourceIndex(3)
2 >Emitted(88, 5) Source(34, 23) + SourceIndex(3)
3 >Emitted(88, 19) Source(34, 37) + SourceIndex(3)
4 >Emitted(88, 22) Source(34, 40) + SourceIndex(3)
5 >Emitted(88, 39) Source(34, 57) + SourceIndex(3)
6 >Emitted(88, 40) Source(34, 58) + SourceIndex(3)
7 >Emitted(88, 49) Source(34, 67) + SourceIndex(3)
8 >Emitted(88, 50) Source(34, 68) + SourceIndex(3)
---
>>>
>>>var internalConst = 10;
1 >
...
5 >                    10
6 >                      ;
1 >Emitted(90, 1) Source(36, 16) + SourceIndex(3)
2 >Emitted(90, 5) Source(36, 22) + SourceIndex(3)
3 >Emitted(90, 18) Source(36, 35) + SourceIndex(3)
4 >Emitted(90, 21) Source(36, 38) + SourceIndex(3)
5 >Emitted(90, 23) Source(36, 40) + SourceIndex(3)
6 >Emitted(90, 24) Source(36, 41) + SourceIndex(3)
---
>>>var internalEnum;
1 >
2 >^^^^
...
2 >Emitted(91, 5) Source(37, 21) + SourceIndex(3)
3 >Emitted(91, 17) Source(37, 45) + SourceIndex(3)
---
>>>(function (internalEnum) {
1->
2 >^^^^^^^^^^^
...
2 >Emitted(92, 12) Source(37, 21) + SourceIndex(3)
3 >Emitted(92, 24) Source(37, 33) + SourceIndex(3)
---
>>>    internalEnum[internalEnum["a"] = 0] = "a";
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    a
3 >                                             
1->Emitted(93, 5) Source(37, 36) + SourceIndex(3)
2 >Emitted(93, 46) Source(37, 37) + SourceIndex(3)
3 >Emitted(93, 47) Source(37, 37) + SourceIndex(3)
---
>>>    internalEnum[internalEnum["b"] = 1] = "b";
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    b
3 >                                             
1->Emitted(94, 5) Source(37, 39) + SourceIndex(3)
2 >Emitted(94, 46) Source(37, 40) + SourceIndex(3)
3 >Emitted(94, 47) Source(37, 40) + SourceIndex(3)
---
>>>    internalEnum[internalEnum["c"] = 2] = "c";
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    c
3 >                                             
1->Emitted(95, 5) Source(37, 42) + SourceIndex(3)
2 >Emitted(95, 46) Source(37, 43) + SourceIndex(3)
3 >Emitted(95, 47) Source(37, 43) + SourceIndex(3)
---
>>>})(internalEnum || (internalEnum = {}));
1 >
2 >^
...
6 >                    internalEnum
7 >                                 { a, b, c }
1 >Emitted(96, 1) Source(37, 44) + SourceIndex(3)
2 >Emitted(96, 2) Source(37, 45) + SourceIndex(3)
3 >Emitted(96, 4) Source(37, 21) + SourceIndex(3)
4 >Emitted(96, 16) Source(37, 33) + SourceIndex(3)
5 >Emitted(96, 21) Source(37, 21) + SourceIndex(3)
6 >Emitted(96, 33) Source(37, 33) + SourceIndex(3)
7 >Emitted(96, 41) Source(37, 45) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../../second/second_part2.ts
