...
2 >Emitted(10, 19) Source(14, 19) + SourceIndex(0)
3 >Emitted(10, 20) Source(14, 20) + SourceIndex(0)
4 >Emitted(10, 40) Source(14, 36) + SourceIndex(0)
5 >Emitted(10, 41) Source(14, 37) + SourceIndex(0)
---
>>>    /**@internal*/ normalC.prototype.method = function () { };
1->^^^^
2 >    ^^^^^^^^^^^^^^
...
2 >Emitted(23, 23) Source(21, 37) + SourceIndex(0)
3 >Emitted(23, 24) Source(21, 38) + SourceIndex(0)
---
>>>        return C;
1 >^^^^^^^^
2 >        ^^^^^^^^
...
2 >Emitted(24, 17) Source(21, 38) + SourceIndex(0)
---
>>>    }());
1 >^^^^
2 >    ^
...
3 >     
4 >     export class C { }
1 >Emitted(25, 5) Source(21, 37) + SourceIndex(0)
2 >Emitted(25, 6) Source(21, 38) + SourceIndex(0)
3 >Emitted(25, 6) Source(21, 20) + SourceIndex(0)
4 >Emitted(25, 10) Source(21, 38) + SourceIndex(0)
---
>>>    normalN.C = C;
1->^^^^
2 >    ^^^^^^^^^
...
3 >              { }
4 >                 
1->Emitted(26, 5) Source(21, 33) + SourceIndex(0)
2 >Emitted(26, 14) Source(21, 34) + SourceIndex(0)
3 >Emitted(26, 18) Source(21, 38) + SourceIndex(0)
4 >Emitted(26, 19) Source(21, 38) + SourceIndex(0)
---
>>>    /**@internal*/ function foo() { }
1->^^^^
2 >    ^^^^^^^^^^^^^^
...
6 >                               () {
7 >                                    }
1->Emitted(27, 5) Source(22, 5) + SourceIndex(0)
2 >Emitted(27, 19) Source(22, 19) + SourceIndex(0)
3 >Emitted(27, 20) Source(22, 20) + SourceIndex(0)
4 >Emitted(27, 29) Source(22, 36) + SourceIndex(0)
5 >Emitted(27, 32) Source(22, 39) + SourceIndex(0)
6 >Emitted(27, 37) Source(22, 43) + SourceIndex(0)
7 >Emitted(27, 38) Source(22, 44) + SourceIndex(0)
---
>>>    normalN.foo = foo;
1 >^^^^
2 >    ^^^^^^^^^^^
...
3 >               () {}
4 >                     
1 >Emitted(28, 5) Source(22, 36) + SourceIndex(0)
2 >Emitted(28, 16) Source(22, 39) + SourceIndex(0)
3 >Emitted(28, 22) Source(22, 44) + SourceIndex(0)
4 >Emitted(28, 23) Source(22, 44) + SourceIndex(0)
---
>>>    /**@internal*/ var someNamespace;
1->^^^^
2 >    ^^^^^^^^^^^^^^
...
2 >Emitted(29, 19) Source(23, 19) + SourceIndex(0)
3 >Emitted(29, 20) Source(23, 20) + SourceIndex(0)
4 >Emitted(29, 24) Source(23, 37) + SourceIndex(0)
5 >Emitted(29, 37) Source(23, 50) + SourceIndex(0)
6 >Emitted(29, 38) Source(23, 72) + SourceIndex(0)
---
>>>    (function (someNamespace) {var C = /** @class */ (function () {
1->^^^^
2 >    ^^^^^^^^^^^
...
2 >Emitted(30, 16) Source(23, 37) + SourceIndex(0)
3 >Emitted(30, 29) Source(23, 50) + SourceIndex(0)
4 >Emitted(30, 32) Source(23, 53) + SourceIndex(0)
---
>>>            function C() {}
1 >^^^^^^^^^^^^
2 >            ^^^^^^^^^^^^^^
...
2 >            export class C {
3 >                          }
1 >Emitted(31, 13) Source(23, 53) + SourceIndex(0)
2 >Emitted(31, 27) Source(23, 69) + SourceIndex(0)
3 >Emitted(31, 28) Source(23, 70) + SourceIndex(0)
---
>>>            return C;
1 >^^^^^^^^^^^^
2 >            ^^^^^^^^
1 >
2 >            }
1 >Emitted(32, 13) Source(23, 69) + SourceIndex(0)
2 >Emitted(32, 21) Source(23, 70) + SourceIndex(0)
---
>>>        }());
1 >^^^^^^^^
2 >        ^
...
3 >         
4 >         export class C {}
1 >Emitted(33, 9) Source(23, 69) + SourceIndex(0)
2 >Emitted(33, 10) Source(23, 70) + SourceIndex(0)
3 >Emitted(33, 10) Source(23, 53) + SourceIndex(0)
4 >Emitted(33, 14) Source(23, 70) + SourceIndex(0)
---
>>>        someNamespace.C = C;
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^
...
3 >                        {}
4 >                           
1->Emitted(34, 9) Source(23, 66) + SourceIndex(0)
2 >Emitted(34, 24) Source(23, 67) + SourceIndex(0)
3 >Emitted(34, 28) Source(23, 70) + SourceIndex(0)
4 >Emitted(34, 29) Source(23, 70) + SourceIndex(0)
---
>>>    })(someNamespace = normalN.someNamespace || (normalN.someNamespace = {}));
1->^^^^
2 >    ^
...
8 >                                                 someNamespace
9 >                                                                       { export class C {} }
1->Emitted(35, 5) Source(23, 71) + SourceIndex(0)
2 >Emitted(35, 6) Source(23, 72) + SourceIndex(0)
3 >Emitted(35, 8) Source(23, 37) + SourceIndex(0)
4 >Emitted(35, 21) Source(23, 50) + SourceIndex(0)
5 >Emitted(35, 24) Source(23, 37) + SourceIndex(0)
6 >Emitted(35, 45) Source(23, 50) + SourceIndex(0)
7 >Emitted(35, 50) Source(23, 37) + SourceIndex(0)
8 >Emitted(35, 71) Source(23, 50) + SourceIndex(0)
9 >Emitted(35, 79) Source(23, 72) + SourceIndex(0)
---
>>>    /**@internal*/ var someOther;
1 >^^^^
2 >    ^^^^^^^^^^^^^^
...
1 >Emitted(36, 5) Source(24, 5) + SourceIndex(0)
2 >Emitted(36, 19) Source(24, 19) + SourceIndex(0)
3 >Emitted(36, 20) Source(24, 20) + SourceIndex(0)
4 >Emitted(36, 24) Source(24, 37) + SourceIndex(0)
5 >Emitted(36, 33) Source(24, 46) + SourceIndex(0)
6 >Emitted(36, 34) Source(24, 86) + SourceIndex(0)
---
>>>    (function (someOther) {var something;
1->^^^^
2 >    ^^^^^^^^^^^
...
2 >Emitted(37, 16) Source(24, 37) + SourceIndex(0)
3 >Emitted(37, 25) Source(24, 46) + SourceIndex(0)
4 >Emitted(37, 28) Source(24, 47) + SourceIndex(0)
5 >Emitted(37, 32) Source(24, 47) + SourceIndex(0)
6 >Emitted(37, 41) Source(24, 56) + SourceIndex(0)
7 >Emitted(37, 42) Source(24, 86) + SourceIndex(0)
---
>>>        (function (something) {var someClass = /** @class */ (function () {
1->^^^^^^^^
2 >        ^^^^^^^^^^^
...
3 >                   something
4 >                             { 
1->Emitted(38, 9) Source(24, 47) + SourceIndex(0)
2 >Emitted(38, 20) Source(24, 47) + SourceIndex(0)
3 >Emitted(38, 29) Source(24, 56) + SourceIndex(0)
4 >Emitted(38, 32) Source(24, 59) + SourceIndex(0)
---
>>>                function someClass() {}
1->^^^^^^^^^^^^^^^^
2 >                ^^^^^^^^^^^^^^^^^^^^^^
...
3 >                                      }
1->Emitted(39, 17) Source(24, 59) + SourceIndex(0)
2 >Emitted(39, 39) Source(24, 83) + SourceIndex(0)
3 >Emitted(39, 40) Source(24, 84) + SourceIndex(0)
---
>>>                return someClass;
1 >^^^^^^^^^^^^^^^^
2 >                ^^^^^^^^^^^^^^^^
1 >
2 >                }
1 >Emitted(40, 17) Source(24, 83) + SourceIndex(0)
2 >Emitted(40, 33) Source(24, 84) + SourceIndex(0)
---
>>>            }());
1 >^^^^^^^^^^^^
2 >            ^
...
1 >Emitted(41, 13) Source(24, 83) + SourceIndex(0)
2 >Emitted(41, 14) Source(24, 84) + SourceIndex(0)
3 >Emitted(41, 14) Source(24, 59) + SourceIndex(0)
4 >Emitted(41, 18) Source(24, 84) + SourceIndex(0)
---
>>>            something.someClass = someClass;
1->^^^^^^^^^^^^
2 >            ^^^^^^^^^^^^^^^^^^^
...
3 >                                {}
4 >                                           
1->Emitted(42, 13) Source(24, 72) + SourceIndex(0)
2 >Emitted(42, 32) Source(24, 81) + SourceIndex(0)
3 >Emitted(42, 44) Source(24, 84) + SourceIndex(0)
4 >Emitted(42, 45) Source(24, 84) + SourceIndex(0)
---
>>>        })(something = someOther.something || (someOther.something = {}));
1->^^^^^^^^
2 >        ^
...
1->Emitted(43, 9) Source(24, 85) + SourceIndex(0)
2 >Emitted(43, 10) Source(24, 86) + SourceIndex(0)
3 >Emitted(43, 12) Source(24, 47) + SourceIndex(0)
4 >Emitted(43, 21) Source(24, 56) + SourceIndex(0)
5 >Emitted(43, 24) Source(24, 47) + SourceIndex(0)
6 >Emitted(43, 43) Source(24, 56) + SourceIndex(0)
7 >Emitted(43, 48) Source(24, 47) + SourceIndex(0)
8 >Emitted(43, 67) Source(24, 56) + SourceIndex(0)
9 >Emitted(43, 75) Source(24, 86) + SourceIndex(0)
---
>>>    })(someOther = normalN.someOther || (normalN.someOther = {}));
1 >^^^^
2 >    ^
...
1 >Emitted(44, 5) Source(24, 85) + SourceIndex(0)
2 >Emitted(44, 6) Source(24, 86) + SourceIndex(0)
3 >Emitted(44, 8) Source(24, 37) + SourceIndex(0)
4 >Emitted(44, 17) Source(24, 46) + SourceIndex(0)
5 >Emitted(44, 20) Source(24, 37) + SourceIndex(0)
6 >Emitted(44, 37) Source(24, 46) + SourceIndex(0)
7 >Emitted(44, 42) Source(24, 37) + SourceIndex(0)
8 >Emitted(44, 59) Source(24, 46) + SourceIndex(0)
9 >Emitted(44, 67) Source(24, 86) + SourceIndex(0)
---
>>>    /**@internal*/ normalN.someImport = someNamespace.C;
1 >^^^^
2 >    ^^^^^^^^^^^^^^
...
8 >                                                      C
9 >                                                       ;
1 >Emitted(45, 5) Source(25, 5) + SourceIndex(0)
2 >Emitted(45, 19) Source(25, 19) + SourceIndex(0)
3 >Emitted(45, 20) Source(25, 34) + SourceIndex(0)
4 >Emitted(45, 38) Source(25, 44) + SourceIndex(0)
5 >Emitted(45, 41) Source(25, 47) + SourceIndex(0)
6 >Emitted(45, 54) Source(25, 60) + SourceIndex(0)
7 >Emitted(45, 55) Source(25, 61) + SourceIndex(0)
8 >Emitted(45, 56) Source(25, 62) + SourceIndex(0)
9 >Emitted(45, 57) Source(25, 63) + SourceIndex(0)
---
>>>    /**@internal*/ normalN.internalConst = 10;
1 >^^^^
2 >    ^^^^^^^^^^^^^^
...
6 >                                           10
7 >                                             ;
1 >Emitted(46, 5) Source(27, 5) + SourceIndex(0)
2 >Emitted(46, 19) Source(27, 19) + SourceIndex(0)
3 >Emitted(46, 20) Source(27, 33) + SourceIndex(0)
4 >Emitted(46, 41) Source(27, 46) + SourceIndex(0)
5 >Emitted(46, 44) Source(27, 49) + SourceIndex(0)
6 >Emitted(46, 46) Source(27, 51) + SourceIndex(0)
7 >Emitted(46, 47) Source(27, 52) + SourceIndex(0)
---
>>>    /**@internal*/ var internalEnum;
1 >^^^^
2 >    ^^^^^^^^^^^^^^
...
1 >Emitted(47, 5) Source(28, 5) + SourceIndex(0)
2 >Emitted(47, 19) Source(28, 19) + SourceIndex(0)
3 >Emitted(47, 20) Source(28, 20) + SourceIndex(0)
4 >Emitted(47, 24) Source(28, 32) + SourceIndex(0)
5 >Emitted(47, 36) Source(28, 56) + SourceIndex(0)
---
>>>    (function (internalEnum) {
1 >^^^^
2 >    ^^^^^^^^^^^
...
2 >    export enum 
3 >               internalEnum
1 >Emitted(48, 5) Source(28, 20) + SourceIndex(0)
2 >Emitted(48, 16) Source(28, 32) + SourceIndex(0)
3 >Emitted(48, 28) Source(28, 44) + SourceIndex(0)
---
>>>        internalEnum[internalEnum["a"] = 0] = "a";
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >        a
3 >                                                 
1->Emitted(49, 9) Source(28, 47) + SourceIndex(0)
2 >Emitted(49, 50) Source(28, 48) + SourceIndex(0)
3 >Emitted(49, 51) Source(28, 48) + SourceIndex(0)
---
>>>        internalEnum[internalEnum["b"] = 1] = "b";
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >        b
3 >                                                 
1->Emitted(50, 9) Source(28, 50) + SourceIndex(0)
2 >Emitted(50, 50) Source(28, 51) + SourceIndex(0)
3 >Emitted(50, 51) Source(28, 51) + SourceIndex(0)
---
>>>        internalEnum[internalEnum["c"] = 2] = "c";
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >        c
3 >                                                 
1->Emitted(51, 9) Source(28, 53) + SourceIndex(0)
2 >Emitted(51, 50) Source(28, 54) + SourceIndex(0)
3 >Emitted(51, 51) Source(28, 54) + SourceIndex(0)
---
>>>    })(internalEnum = normalN.internalEnum || (normalN.internalEnum = {}));
1->^^^^
2 >    ^
...
8 >                                               internalEnum
9 >                                                                    { a, b, c }
1->Emitted(52, 5) Source(28, 55) + SourceIndex(0)
2 >Emitted(52, 6) Source(28, 56) + SourceIndex(0)
3 >Emitted(52, 8) Source(28, 32) + SourceIndex(0)
4 >Emitted(52, 20) Source(28, 44) + SourceIndex(0)
5 >Emitted(52, 23) Source(28, 32) + SourceIndex(0)
6 >Emitted(52, 43) Source(28, 44) + SourceIndex(0)
7 >Emitted(52, 48) Source(28, 32) + SourceIndex(0)
8 >Emitted(52, 68) Source(28, 44) + SourceIndex(0)
9 >Emitted(52, 76) Source(28, 56) + SourceIndex(0)
---
>>>})(normalN || (normalN = {}));
1 >
2 >^
...
7 >                       {
  ...
  >                          /**@internal*/ export enum internalEnum { a, b, c }
  >                      }
1 >Emitted(53, 1) Source(29, 1) + SourceIndex(0)
2 >Emitted(53, 2) Source(29, 2) + SourceIndex(0)
3 >Emitted(53, 4) Source(20, 11) + SourceIndex(0)
4 >Emitted(53, 11) Source(20, 18) + SourceIndex(0)
5 >Emitted(53, 16) Source(20, 11) + SourceIndex(0)
6 >Emitted(53, 23) Source(20, 18) + SourceIndex(0)
7 >Emitted(53, 31) Source(29, 2) + SourceIndex(0)
---
>>>/**@internal*/ var internalC = /** @class */ (function () {
1->
2 >^^^^^^^^^^^^^^
...
2 >/**@internal*/
3 >               
1->Emitted(54, 1) Source(30, 1) + SourceIndex(0)
2 >Emitted(54, 15) Source(30, 15) + SourceIndex(0)
3 >Emitted(54, 16) Source(30, 16) + SourceIndex(0)
---
>>>    function internalC() {}
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
2 >    class internalC {
3 >                          }
1->Emitted(55, 5) Source(30, 16) + SourceIndex(0)
2 >Emitted(55, 27) Source(30, 33) + SourceIndex(0)
3 >Emitted(55, 28) Source(30, 34) + SourceIndex(0)
---
>>>    return internalC;
1 >^^^^
2 >    ^^^^^^^^^^^^^^^^
1 >
2 >    }
1 >Emitted(56, 5) Source(30, 33) + SourceIndex(0)
2 >Emitted(56, 21) Source(30, 34) + SourceIndex(0)
---
>>>}());
1 >
2 >^
...
3 > 
4 > class internalC {}
1 >Emitted(57, 1) Source(30, 33) + SourceIndex(0)
2 >Emitted(57, 2) Source(30, 34) + SourceIndex(0)
3 >Emitted(57, 2) Source(30, 16) + SourceIndex(0)
4 >Emitted(57, 6) Source(30, 34) + SourceIndex(0)
---
>>>/**@internal*/ function internalfoo() { }
1->
2 >^^^^^^^^^^^^^^
...
6 >                                   () {
7 >                                        }
1->Emitted(58, 1) Source(31, 1) + SourceIndex(0)
2 >Emitted(58, 15) Source(31, 15) + SourceIndex(0)
3 >Emitted(58, 16) Source(31, 16) + SourceIndex(0)
4 >Emitted(58, 25) Source(31, 25) + SourceIndex(0)
5 >Emitted(58, 36) Source(31, 36) + SourceIndex(0)
6 >Emitted(58, 41) Source(31, 40) + SourceIndex(0)
7 >Emitted(58, 42) Source(31, 41) + SourceIndex(0)
---
>>>/**@internal*/ var internalNamespace;
1 >
2 >^^^^^^^^^^^^^^
...
1 >Emitted(59, 1) Source(32, 1) + SourceIndex(0)
2 >Emitted(59, 15) Source(32, 15) + SourceIndex(0)
3 >Emitted(59, 16) Source(32, 16) + SourceIndex(0)
4 >Emitted(59, 20) Source(32, 26) + SourceIndex(0)
5 >Emitted(59, 37) Source(32, 43) + SourceIndex(0)
6 >Emitted(59, 38) Source(32, 73) + SourceIndex(0)
---
>>>(function (internalNamespace) {var someClass = /** @class */ (function () {
1->
2 >^^^^^^^^^^^
...
2 >Emitted(60, 12) Source(32, 26) + SourceIndex(0)
3 >Emitted(60, 29) Source(32, 43) + SourceIndex(0)
4 >Emitted(60, 32) Source(32, 46) + SourceIndex(0)
---
>>>        function someClass() {}
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
...
2 >        export class someClass {
3 >                              }
1->Emitted(61, 9) Source(32, 46) + SourceIndex(0)
2 >Emitted(61, 31) Source(32, 70) + SourceIndex(0)
3 >Emitted(61, 32) Source(32, 71) + SourceIndex(0)
---
>>>        return someClass;
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^
1 >
2 >        }
1 >Emitted(62, 9) Source(32, 70) + SourceIndex(0)
2 >Emitted(62, 25) Source(32, 71) + SourceIndex(0)
---
>>>    }());
1 >^^^^
2 >    ^
...
3 >     
4 >     export class someClass {}
1 >Emitted(63, 5) Source(32, 70) + SourceIndex(0)
2 >Emitted(63, 6) Source(32, 71) + SourceIndex(0)
3 >Emitted(63, 6) Source(32, 46) + SourceIndex(0)
4 >Emitted(63, 10) Source(32, 71) + SourceIndex(0)
---
>>>    internalNamespace.someClass = someClass;
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
3 >                                {}
4 >                                           
1->Emitted(64, 5) Source(32, 59) + SourceIndex(0)
2 >Emitted(64, 32) Source(32, 68) + SourceIndex(0)
3 >Emitted(64, 44) Source(32, 71) + SourceIndex(0)
4 >Emitted(64, 45) Source(32, 71) + SourceIndex(0)
---
>>>})(internalNamespace || (internalNamespace = {}));
1->
2 >^
...
6 >                         internalNamespace
7 >                                           { export class someClass {} }
1->Emitted(65, 1) Source(32, 72) + SourceIndex(0)
2 >Emitted(65, 2) Source(32, 73) + SourceIndex(0)
3 >Emitted(65, 4) Source(32, 26) + SourceIndex(0)
4 >Emitted(65, 21) Source(32, 43) + SourceIndex(0)
5 >Emitted(65, 26) Source(32, 26) + SourceIndex(0)
6 >Emitted(65, 43) Source(32, 43) + SourceIndex(0)
7 >Emitted(65, 51) Source(32, 73) + SourceIndex(0)
---
>>>/**@internal*/ var internalOther;
1 >
2 >^^^^^^^^^^^^^^
...
5 >                   internalOther
6 >                                .something { export class someClass {} }
1 >Emitted(66, 1) Source(33, 1) + SourceIndex(0)
2 >Emitted(66, 15) Source(33, 15) + SourceIndex(0)
3 >Emitted(66, 16) Source(33, 16) + SourceIndex(0)
4 >Emitted(66, 20) Source(33, 26) + SourceIndex(0)
5 >Emitted(66, 33) Source(33, 39) + SourceIndex(0)
6 >Emitted(66, 34) Source(33, 79) + SourceIndex(0)
---
>>>(function (internalOther) {var something;
1->
2 >^^^^^^^^^^^
...
2 >Emitted(67, 12) Source(33, 26) + SourceIndex(0)
3 >Emitted(67, 25) Source(33, 39) + SourceIndex(0)
4 >Emitted(67, 28) Source(33, 40) + SourceIndex(0)
5 >Emitted(67, 32) Source(33, 40) + SourceIndex(0)
6 >Emitted(67, 41) Source(33, 49) + SourceIndex(0)
7 >Emitted(67, 42) Source(33, 79) + SourceIndex(0)
---
>>>    (function (something) {var someClass = /** @class */ (function () {
1->^^^^
2 >    ^^^^^^^^^^^
...
3 >               something
4 >                         { 
1->Emitted(68, 5) Source(33, 40) + SourceIndex(0)
2 >Emitted(68, 16) Source(33, 40) + SourceIndex(0)
3 >Emitted(68, 25) Source(33, 49) + SourceIndex(0)
4 >Emitted(68, 28) Source(33, 52) + SourceIndex(0)
---
>>>            function someClass() {}
1->^^^^^^^^^^^^
2 >            ^^^^^^^^^^^^^^^^^^^^^^
...
2 >            export class someClass {
3 >                                  }
1->Emitted(69, 13) Source(33, 52) + SourceIndex(0)
2 >Emitted(69, 35) Source(33, 76) + SourceIndex(0)
3 >Emitted(69, 36) Source(33, 77) + SourceIndex(0)
---
>>>            return someClass;
1 >^^^^^^^^^^^^
2 >            ^^^^^^^^^^^^^^^^
1 >
2 >            }
1 >Emitted(70, 13) Source(33, 76) + SourceIndex(0)
2 >Emitted(70, 29) Source(33, 77) + SourceIndex(0)
---
>>>        }());
1 >^^^^^^^^
2 >        ^
...
3 >         
4 >         export class someClass {}
1 >Emitted(71, 9) Source(33, 76) + SourceIndex(0)
2 >Emitted(71, 10) Source(33, 77) + SourceIndex(0)
3 >Emitted(71, 10) Source(33, 52) + SourceIndex(0)
4 >Emitted(71, 14) Source(33, 77) + SourceIndex(0)
---
>>>        something.someClass = someClass;
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^
...
3 >                            {}
4 >                                       
1->Emitted(72, 9) Source(33, 65) + SourceIndex(0)
2 >Emitted(72, 28) Source(33, 74) + SourceIndex(0)
3 >Emitted(72, 40) Source(33, 77) + SourceIndex(0)
4 >Emitted(72, 41) Source(33, 77) + SourceIndex(0)
---
>>>    })(something = internalOther.something || (internalOther.something = {}));
1->^^^^
2 >    ^
...
8 >                                               something
9 >                                                                       { export class someClass {} }
1->Emitted(73, 5) Source(33, 78) + SourceIndex(0)
2 >Emitted(73, 6) Source(33, 79) + SourceIndex(0)
3 >Emitted(73, 8) Source(33, 40) + SourceIndex(0)
4 >Emitted(73, 17) Source(33, 49) + SourceIndex(0)
5 >Emitted(73, 20) Source(33, 40) + SourceIndex(0)
6 >Emitted(73, 43) Source(33, 49) + SourceIndex(0)
7 >Emitted(73, 48) Source(33, 40) + SourceIndex(0)
8 >Emitted(73, 71) Source(33, 49) + SourceIndex(0)
9 >Emitted(73, 79) Source(33, 79) + SourceIndex(0)
---
>>>})(internalOther || (internalOther = {}));
1 >
2 >^
...
1 >Emitted(74, 1) Source(33, 78) + SourceIndex(0)
2 >Emitted(74, 2) Source(33, 79) + SourceIndex(0)
3 >Emitted(74, 4) Source(33, 26) + SourceIndex(0)
4 >Emitted(74, 17) Source(33, 39) + SourceIndex(0)
5 >Emitted(74, 22) Source(33, 26) + SourceIndex(0)
6 >Emitted(74, 35) Source(33, 39) + SourceIndex(0)
7 >Emitted(74, 43) Source(33, 79) + SourceIndex(0)
---
>>>/**@internal*/ var internalImport = internalNamespace.someClass;
1->
2 >^^^^^^^^^^^^^^
...
9 >                                                      someClass
10>                                                               ;
1->Emitted(75, 1) Source(34, 1) + SourceIndex(0)
2 >Emitted(75, 15) Source(34, 15) + SourceIndex(0)
3 >Emitted(75, 16) Source(34, 16) + SourceIndex(0)
4 >Emitted(75, 20) Source(34, 23) + SourceIndex(0)
5 >Emitted(75, 34) Source(34, 37) + SourceIndex(0)
6 >Emitted(75, 37) Source(34, 40) + SourceIndex(0)
7 >Emitted(75, 54) Source(34, 57) + SourceIndex(0)
8 >Emitted(75, 55) Source(34, 58) + SourceIndex(0)
9 >Emitted(75, 64) Source(34, 67) + SourceIndex(0)
10>Emitted(75, 65) Source(34, 68) + SourceIndex(0)
---
>>>
>>>/**@internal*/ var internalConst = 10;
1 >
...
7 >                                   10
8 >                                     ;
1 >Emitted(77, 1) Source(36, 1) + SourceIndex(0)
2 >Emitted(77, 15) Source(36, 15) + SourceIndex(0)
3 >Emitted(77, 16) Source(36, 16) + SourceIndex(0)
4 >Emitted(77, 20) Source(36, 22) + SourceIndex(0)
5 >Emitted(77, 33) Source(36, 35) + SourceIndex(0)
6 >Emitted(77, 36) Source(36, 38) + SourceIndex(0)
7 >Emitted(77, 38) Source(36, 40) + SourceIndex(0)
8 >Emitted(77, 39) Source(36, 41) + SourceIndex(0)
---
>>>/**@internal*/ var internalEnum;
1 >
2 >^^^^^^^^^^^^^^
...
4 >               enum 
5 >                   internalEnum { a, b, c }
1 >Emitted(78, 1) Source(37, 1) + SourceIndex(0)
2 >Emitted(78, 15) Source(37, 15) + SourceIndex(0)
3 >Emitted(78, 16) Source(37, 16) + SourceIndex(0)
4 >Emitted(78, 20) Source(37, 21) + SourceIndex(0)
5 >Emitted(78, 32) Source(37, 45) + SourceIndex(0)
---
>>>(function (internalEnum) {
1 >
2 >^^^^^^^^^^^
...
2 >enum 
3 >           internalEnum
1 >Emitted(79, 1) Source(37, 16) + SourceIndex(0)
2 >Emitted(79, 12) Source(37, 21) + SourceIndex(0)
3 >Emitted(79, 24) Source(37, 33) + SourceIndex(0)
---
>>>    internalEnum[internalEnum["a"] = 0] = "a";
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    a
3 >                                             
1->Emitted(80, 5) Source(37, 36) + SourceIndex(0)
2 >Emitted(80, 46) Source(37, 37) + SourceIndex(0)
3 >Emitted(80, 47) Source(37, 37) + SourceIndex(0)
---
>>>    internalEnum[internalEnum["b"] = 1] = "b";
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    b
3 >                                             
1->Emitted(81, 5) Source(37, 39) + SourceIndex(0)
2 >Emitted(81, 46) Source(37, 40) + SourceIndex(0)
3 >Emitted(81, 47) Source(37, 40) + SourceIndex(0)
---
>>>    internalEnum[internalEnum["c"] = 2] = "c";
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    c
3 >                                             
1->Emitted(82, 5) Source(37, 42) + SourceIndex(0)
2 >Emitted(82, 46) Source(37, 43) + SourceIndex(0)
3 >Emitted(82, 47) Source(37, 43) + SourceIndex(0)
---
>>>})(internalEnum || (internalEnum = {}));
1 >
2 >^
...
2 >    doSomething
3 >                           
1->Emitted(87, 5) Source(2, 5) + SourceIndex(1)
2 >Emitted(87, 28) Source(2, 16) + SourceIndex(1)
3 >Emitted(87, 31) Source(2, 5) + SourceIndex(1)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(88, 9) Source(3, 9) + SourceIndex(1)
2 >Emitted(88, 16) Source(3, 16) + SourceIndex(1)
3 >Emitted(88, 17) Source(3, 17) + SourceIndex(1)
4 >Emitted(88, 20) Source(3, 20) + SourceIndex(1)
5 >Emitted(88, 21) Source(3, 21) + SourceIndex(1)
6 >Emitted(88, 41) Source(3, 41) + SourceIndex(1)
7 >Emitted(88, 42) Source(3, 42) + SourceIndex(1)
8 >Emitted(88, 43) Source(3, 43) + SourceIndex(1)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(89, 5) Source(4, 5) + SourceIndex(1)
2 >Emitted(89, 6) Source(4, 6) + SourceIndex(1)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
1->
  >
2 >    }
1->Emitted(90, 5) Source(5, 1) + SourceIndex(1)
2 >Emitted(90, 13) Source(5, 2) + SourceIndex(1)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(91, 1) Source(5, 1) + SourceIndex(1)
2 >Emitted(91, 2) Source(5, 2) + SourceIndex(1)
3 >Emitted(91, 2) Source(1, 1) + SourceIndex(1)
4 >Emitted(91, 6) Source(5, 2) + SourceIndex(1)
---
>>>//# sourceMappingURL=second-output.js.map
...
2 >Emitted(20, 19) Source(16, 19) + SourceIndex(3)
3 >Emitted(20, 20) Source(16, 20) + SourceIndex(3)
4 >Emitted(20, 44) Source(16, 26) + SourceIndex(3)
5 >Emitted(20, 47) Source(16, 20) + SourceIndex(3)
6 >Emitted(20, 61) Source(16, 31) + SourceIndex(3)
7 >Emitted(20, 62) Source(16, 32) + SourceIndex(3)
---
>>>    Object.defineProperty(normalC.prototype, "c", {
1 >^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
2 >Emitted(22, 23) Source(17, 19) + SourceIndex(3)
3 >Emitted(22, 29) Source(17, 20) + SourceIndex(3)
4 >Emitted(22, 43) Source(17, 30) + SourceIndex(3)
5 >Emitted(22, 50) Source(17, 37) + SourceIndex(3)
6 >Emitted(22, 52) Source(17, 39) + SourceIndex(3)
7 >Emitted(22, 53) Source(17, 40) + SourceIndex(3)
8 >Emitted(22, 54) Source(17, 41) + SourceIndex(3)
9 >Emitted(22, 55) Source(17, 42) + SourceIndex(3)
---
>>>        /**@internal*/ set: function (val) { },
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^
...
2 >Emitted(23, 23) Source(18, 19) + SourceIndex(3)
3 >Emitted(23, 29) Source(18, 20) + SourceIndex(3)
4 >Emitted(23, 39) Source(18, 26) + SourceIndex(3)
5 >Emitted(23, 42) Source(18, 37) + SourceIndex(3)
6 >Emitted(23, 46) Source(18, 41) + SourceIndex(3)
7 >Emitted(23, 47) Source(18, 42) + SourceIndex(3)
---
>>>        enumerable: false,
>>>        configurable: true
>>>    });
...
2 >Emitted(31, 19) Source(21, 19) + SourceIndex(3)
3 >Emitted(31, 20) Source(21, 20) + SourceIndex(3)
---
>>>        function C() {}
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^
...
8 >                                                      C
9 >                                                       ;
1 >Emitted(54, 5) Source(25, 5) + SourceIndex(3)
2 >Emitted(54, 19) Source(25, 19) + SourceIndex(3)
3 >Emitted(54, 20) Source(25, 34) + SourceIndex(3)
4 >Emitted(54, 38) Source(25, 44) + SourceIndex(3)
5 >Emitted(54, 41) Source(25, 47) + SourceIndex(3)
6 >Emitted(54, 54) Source(25, 60) + SourceIndex(3)
7 >Emitted(54, 55) Source(25, 61) + SourceIndex(3)
8 >Emitted(54, 56) Source(25, 62) + SourceIndex(3)
9 >Emitted(54, 57) Source(25, 63) + SourceIndex(3)
---
>>>    /**@internal*/ normalN.internalConst = 10;
1 >^^^^
2 >    ^^^^^^^^^^^^^^
...
6 >                                           10
7 >                                             ;
1 >Emitted(55, 5) Source(27, 5) + SourceIndex(3)
2 >Emitted(55, 19) Source(27, 19) + SourceIndex(3)
3 >Emitted(55, 20) Source(27, 33) + SourceIndex(3)
4 >Emitted(55, 41) Source(27, 46) + SourceIndex(3)
5 >Emitted(55, 44) Source(27, 49) + SourceIndex(3)
6 >Emitted(55, 46) Source(27, 51) + SourceIndex(3)
7 >Emitted(55, 47) Source(27, 52) + SourceIndex(3)
---
>>>    /**@internal*/ var internalEnum;
1 >^^^^
2 >    ^^^^^^^^^^^^^^
...
4 >                   export enum 
5 >                       internalEnum { a, b, c }
1 >Emitted(56, 5) Source(28, 5) + SourceIndex(3)
2 >Emitted(56, 19) Source(28, 19) + SourceIndex(3)
3 >Emitted(56, 20) Source(28, 20) + SourceIndex(3)
4 >Emitted(56, 24) Source(28, 32) + SourceIndex(3)
5 >Emitted(56, 36) Source(28, 56) + SourceIndex(3)
---
>>>    (function (internalEnum) {
1 >^^^^
2 >    ^^^^^^^^^^^
...
2 >Emitted(63, 15) Source(30, 15) + SourceIndex(3)
3 >Emitted(63, 16) Source(30, 16) + SourceIndex(3)
---
>>>    function internalC() {}
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
2 >Emitted(67, 15) Source(31, 15) + SourceIndex(3)
3 >Emitted(67, 16) Source(31, 16) + SourceIndex(3)
4 >Emitted(67, 25) Source(31, 25) + SourceIndex(3)
5 >Emitted(67, 36) Source(31, 36) + SourceIndex(3)
6 >Emitted(67, 41) Source(31, 40) + SourceIndex(3)
7 >Emitted(67, 42) Source(31, 41) + SourceIndex(3)
---
>>>/**@internal*/ var internalNamespace;
1 >
2 >^^^^^^^^^^^^^^
...
2 >Emitted(68, 15) Source(32, 15) + SourceIndex(3)
3 >Emitted(68, 16) Source(32, 16) + SourceIndex(3)
4 >Emitted(68, 20) Source(32, 26) + SourceIndex(3)
5 >Emitted(68, 37) Source(32, 43) + SourceIndex(3)
6 >Emitted(68, 38) Source(32, 73) + SourceIndex(3)
---
>>>(function (internalNamespace) {var someClass = /** @class */ (function () {
1->
2 >^^^^^^^^^^^
...
2 >Emitted(75, 15) Source(33, 15) + SourceIndex(3)
3 >Emitted(75, 16) Source(33, 16) + SourceIndex(3)
4 >Emitted(75, 20) Source(33, 26) + SourceIndex(3)
5 >Emitted(75, 33) Source(33, 39) + SourceIndex(3)
6 >Emitted(75, 34) Source(33, 79) + SourceIndex(3)
---
>>>(function (internalOther) {var something;
1->
2 >^^^^^^^^^^^
...
9 >                                                      someClass
10>                                                               ;
1->Emitted(84, 1) Source(34, 1) + SourceIndex(3)
2 >Emitted(84, 15) Source(34, 15) + SourceIndex(3)
3 >Emitted(84, 16) Source(34, 16) + SourceIndex(3)
4 >Emitted(84, 20) Source(34, 23) + SourceIndex(3)
5 >Emitted(84, 34) Source(34, 37) + SourceIndex(3)
6 >Emitted(84, 37) Source(34, 40) + SourceIndex(3)
7 >Emitted(84, 54) Source(34, 57) + SourceIndex(3)
8 >Emitted(84, 55) Source(34, 58) + SourceIndex(3)
9 >Emitted(84, 64) Source(34, 67) + SourceIndex(3)
10>Emitted(84, 65) Source(34, 68) + SourceIndex(3)
---
>>>
>>>/**@internal*/ var internalConst = 10;
1 >
...
7 >                                   10
8 >                                     ;
1 >Emitted(86, 1) Source(36, 1) + SourceIndex(3)
2 >Emitted(86, 15) Source(36, 15) + SourceIndex(3)
3 >Emitted(86, 16) Source(36, 16) + SourceIndex(3)
4 >Emitted(86, 20) Source(36, 22) + SourceIndex(3)
5 >Emitted(86, 33) Source(36, 35) + SourceIndex(3)
6 >Emitted(86, 36) Source(36, 38) + SourceIndex(3)
7 >Emitted(86, 38) Source(36, 40) + SourceIndex(3)
8 >Emitted(86, 39) Source(36, 41) + SourceIndex(3)
---
>>>/**@internal*/ var internalEnum;
1 >
2 >^^^^^^^^^^^^^^
...
4 >               enum 
5 >                   internalEnum { a, b, c }
1 >Emitted(87, 1) Source(37, 1) + SourceIndex(3)
2 >Emitted(87, 15) Source(37, 15) + SourceIndex(3)
3 >Emitted(87, 16) Source(37, 16) + SourceIndex(3)
4 >Emitted(87, 20) Source(37, 21) + SourceIndex(3)
5 >Emitted(87, 32) Source(37, 45) + SourceIndex(3)
---
>>>(function (internalEnum) {
1 >
2 >^^^^^^^^^^^
...
----------------------------------------------------------------------
prepend: (131-3436):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (131-3436)
var N;
(function (N) {
