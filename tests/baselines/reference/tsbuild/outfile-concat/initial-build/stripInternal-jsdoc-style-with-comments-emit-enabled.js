...
2 >/**@internal*/
3 >               
1->Emitted(55, 1) Source(30, 1) + SourceIndex(0)
2 >Emitted(55, 15) Source(30, 15) + SourceIndex(0)
3 >Emitted(55, 16) Source(30, 16) + SourceIndex(0)
---
>>>    function internalC() {}
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
6 >                                   () {
7 >                                        }
1->Emitted(59, 1) Source(31, 1) + SourceIndex(0)
2 >Emitted(59, 15) Source(31, 15) + SourceIndex(0)
3 >Emitted(59, 16) Source(31, 16) + SourceIndex(0)
4 >Emitted(59, 25) Source(31, 25) + SourceIndex(0)
5 >Emitted(59, 36) Source(31, 36) + SourceIndex(0)
6 >Emitted(59, 41) Source(31, 40) + SourceIndex(0)
7 >Emitted(59, 42) Source(31, 41) + SourceIndex(0)
---
>>>/**@internal*/ var internalNamespace;
1 >
2 >^^^^^^^^^^^^^^
...
1 >Emitted(60, 1) Source(32, 1) + SourceIndex(0)
2 >Emitted(60, 15) Source(32, 15) + SourceIndex(0)
3 >Emitted(60, 16) Source(32, 16) + SourceIndex(0)
4 >Emitted(60, 20) Source(32, 26) + SourceIndex(0)
5 >Emitted(60, 37) Source(32, 43) + SourceIndex(0)
6 >Emitted(60, 38) Source(32, 73) + SourceIndex(0)
---
>>>(function (internalNamespace) {var someClass = /** @class */ (function () {
1->
2 >^^^^^^^^^^^
...
5 >                   internalOther
6 >                                .something { export class someClass {} }
1 >Emitted(67, 1) Source(33, 1) + SourceIndex(0)
2 >Emitted(67, 15) Source(33, 15) + SourceIndex(0)
3 >Emitted(67, 16) Source(33, 16) + SourceIndex(0)
4 >Emitted(67, 20) Source(33, 26) + SourceIndex(0)
5 >Emitted(67, 33) Source(33, 39) + SourceIndex(0)
6 >Emitted(67, 34) Source(33, 79) + SourceIndex(0)
---
>>>(function (internalOther) {
1 >
2 >^^^^^^^^^^^
...
9 >                                                      someClass
10>                                                               ;
1->Emitted(77, 1) Source(34, 1) + SourceIndex(0)
2 >Emitted(77, 15) Source(34, 15) + SourceIndex(0)
3 >Emitted(77, 16) Source(34, 16) + SourceIndex(0)
4 >Emitted(77, 20) Source(34, 23) + SourceIndex(0)
5 >Emitted(77, 34) Source(34, 37) + SourceIndex(0)
6 >Emitted(77, 37) Source(34, 40) + SourceIndex(0)
7 >Emitted(77, 54) Source(34, 57) + SourceIndex(0)
8 >Emitted(77, 55) Source(34, 58) + SourceIndex(0)
9 >Emitted(77, 64) Source(34, 67) + SourceIndex(0)
10>Emitted(77, 65) Source(34, 68) + SourceIndex(0)
---
>>>
>>>/**@internal*/ var internalConst = 10;
1 >
...
7 >                                   10
8 >                                     ;
1 >Emitted(79, 1) Source(36, 1) + SourceIndex(0)
2 >Emitted(79, 15) Source(36, 15) + SourceIndex(0)
3 >Emitted(79, 16) Source(36, 16) + SourceIndex(0)
4 >Emitted(79, 20) Source(36, 22) + SourceIndex(0)
5 >Emitted(79, 33) Source(36, 35) + SourceIndex(0)
6 >Emitted(79, 36) Source(36, 38) + SourceIndex(0)
7 >Emitted(79, 38) Source(36, 40) + SourceIndex(0)
8 >Emitted(79, 39) Source(36, 41) + SourceIndex(0)
---
>>>/**@internal*/ var internalEnum;
1 >
2 >^^^^^^^^^^^^^^
...
4 >               enum 
5 >                   internalEnum { a, b, c }
1 >Emitted(80, 1) Source(37, 1) + SourceIndex(0)
2 >Emitted(80, 15) Source(37, 15) + SourceIndex(0)
3 >Emitted(80, 16) Source(37, 16) + SourceIndex(0)
4 >Emitted(80, 20) Source(37, 21) + SourceIndex(0)
5 >Emitted(80, 32) Source(37, 45) + SourceIndex(0)
---
>>>(function (internalEnum) {
1 >
2 >^^^^^^^^^^^
...
----------------------------------------------------------------------
prepend: (131-3418):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (131-3418)
var N;
(function (N) {
