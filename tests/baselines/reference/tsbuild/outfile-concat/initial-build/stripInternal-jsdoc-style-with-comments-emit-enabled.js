...
2 >Emitted(12, 19) Source(16, 19) + SourceIndex(0)
3 >Emitted(12, 20) Source(16, 20) + SourceIndex(0)
4 >Emitted(12, 34) Source(16, 26) + SourceIndex(0)
5 >Emitted(12, 37) Source(16, 20) + SourceIndex(0)
6 >Emitted(12, 51) Source(16, 31) + SourceIndex(0)
7 >Emitted(12, 52) Source(16, 32) + SourceIndex(0)
---
>>>    Object.defineProperty(proto_1, "c", {
1 >^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
3 >Emitted(13, 39) Source(17, 25) + SourceIndex(0)
---
>>>        /**@internal*/ get: function () { return 10; },
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^
...
8 >                                                     
9 >                                                     }
1->Emitted(14, 9) Source(17, 5) + SourceIndex(0)
2 >Emitted(14, 23) Source(17, 19) + SourceIndex(0)
3 >Emitted(14, 29) Source(17, 20) + SourceIndex(0)
4 >Emitted(14, 43) Source(17, 30) + SourceIndex(0)
5 >Emitted(14, 50) Source(17, 37) + SourceIndex(0)
6 >Emitted(14, 52) Source(17, 39) + SourceIndex(0)
7 >Emitted(14, 53) Source(17, 40) + SourceIndex(0)
8 >Emitted(14, 54) Source(17, 41) + SourceIndex(0)
9 >Emitted(14, 55) Source(17, 42) + SourceIndex(0)
---
>>>        /**@internal*/ set: function (val) { },
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^
...
6 >                                         ) { 
7 >                                             }
1 >Emitted(15, 9) Source(18, 5) + SourceIndex(0)
2 >Emitted(15, 23) Source(18, 19) + SourceIndex(0)
3 >Emitted(15, 29) Source(18, 20) + SourceIndex(0)
4 >Emitted(15, 39) Source(18, 26) + SourceIndex(0)
5 >Emitted(15, 42) Source(18, 37) + SourceIndex(0)
6 >Emitted(15, 46) Source(18, 41) + SourceIndex(0)
7 >Emitted(15, 47) Source(18, 42) + SourceIndex(0)
---
>>>        enumerable: false,
>>>        configurable: true
>>>    });
...
2 >    /**@internal*/
3 >                   
1->Emitted(23, 5) Source(21, 5) + SourceIndex(0)
2 >Emitted(23, 19) Source(21, 19) + SourceIndex(0)
3 >Emitted(23, 20) Source(21, 20) + SourceIndex(0)
---
>>>        function C() {
1->^^^^^^^^
2 >        ^^->
...
2 >Emitted(25, 10) Source(21, 38) + SourceIndex(0)
---
>>>        return C;
1->^^^^^^^^
2 >        ^^^^^^^^
1->
2 >        }
1->Emitted(26, 9) Source(21, 37) + SourceIndex(0)
2 >Emitted(26, 17) Source(21, 38) + SourceIndex(0)
---
>>>    }());
1 >^^^^
2 >    ^
...
2 >Emitted(27, 6) Source(21, 38) + SourceIndex(0)
3 >Emitted(27, 6) Source(21, 20) + SourceIndex(0)
4 >Emitted(27, 10) Source(21, 38) + SourceIndex(0)
---
>>>    normalN.C = C;
1->^^^^
2 >    ^^^^^^^^^
...
3 >              { }
4 >                 
1->Emitted(28, 5) Source(21, 33) + SourceIndex(0)
2 >Emitted(28, 14) Source(21, 34) + SourceIndex(0)
3 >Emitted(28, 18) Source(21, 38) + SourceIndex(0)
4 >Emitted(28, 19) Source(21, 38) + SourceIndex(0)
---
>>>    /**@internal*/ function foo() { }
1->^^^^
2 >    ^^^^^^^^^^^^^^
...
6 >                               () {
7 >                                    }
1->Emitted(29, 5) Source(22, 5) + SourceIndex(0)
2 >Emitted(29, 19) Source(22, 19) + SourceIndex(0)
3 >Emitted(29, 20) Source(22, 20) + SourceIndex(0)
4 >Emitted(29, 29) Source(22, 36) + SourceIndex(0)
5 >Emitted(29, 32) Source(22, 39) + SourceIndex(0)
6 >Emitted(29, 37) Source(22, 43) + SourceIndex(0)
7 >Emitted(29, 38) Source(22, 44) + SourceIndex(0)
---
>>>    normalN.foo = foo;
1 >^^^^
2 >    ^^^^^^^^^^^
...
3 >               () {}
4 >                     
1 >Emitted(30, 5) Source(22, 36) + SourceIndex(0)
2 >Emitted(30, 16) Source(22, 39) + SourceIndex(0)
3 >Emitted(30, 22) Source(22, 44) + SourceIndex(0)
4 >Emitted(30, 23) Source(22, 44) + SourceIndex(0)
---
>>>    /**@internal*/ var someNamespace;
1->^^^^
2 >    ^^^^^^^^^^^^^^
...
5 >                       someNamespace
6 >                                     { export class C {} }
1->Emitted(31, 5) Source(23, 5) + SourceIndex(0)
2 >Emitted(31, 19) Source(23, 19) + SourceIndex(0)
3 >Emitted(31, 20) Source(23, 20) + SourceIndex(0)
4 >Emitted(31, 24) Source(23, 37) + SourceIndex(0)
5 >Emitted(31, 37) Source(23, 50) + SourceIndex(0)
6 >Emitted(31, 38) Source(23, 72) + SourceIndex(0)
---
>>>    (function (someNamespace) {
1 >^^^^
2 >    ^^^^^^^^^^^
...
2 >    export namespace 
3 >               someNamespace
1 >Emitted(32, 5) Source(23, 20) + SourceIndex(0)
2 >Emitted(32, 16) Source(23, 37) + SourceIndex(0)
3 >Emitted(32, 29) Source(23, 50) + SourceIndex(0)
---
>>>        var C = /** @class */ (function () {
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^->
1-> { 
1->Emitted(33, 9) Source(23, 53) + SourceIndex(0)
---
>>>            function C() {
1->^^^^^^^^^^^^
2 >            ^^->
1->
1->Emitted(34, 13) Source(23, 53) + SourceIndex(0)
---
>>>            }
1->^^^^^^^^^^^^
2 >            ^
...
2 >Emitted(35, 14) Source(23, 70) + SourceIndex(0)
---
>>>            return C;
1->^^^^^^^^^^^^
2 >            ^^^^^^^^
1->
2 >            }
1->Emitted(36, 13) Source(23, 69) + SourceIndex(0)
2 >Emitted(36, 21) Source(23, 70) + SourceIndex(0)
---
>>>        }());
1 >^^^^^^^^
2 >        ^
...
3 >         
4 >         export class C {}
1 >Emitted(37, 9) Source(23, 69) + SourceIndex(0)
2 >Emitted(37, 10) Source(23, 70) + SourceIndex(0)
3 >Emitted(37, 10) Source(23, 53) + SourceIndex(0)
4 >Emitted(37, 14) Source(23, 70) + SourceIndex(0)
---
>>>        someNamespace.C = C;
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^
...
3 >                        {}
4 >                           
1->Emitted(38, 9) Source(23, 66) + SourceIndex(0)
2 >Emitted(38, 24) Source(23, 67) + SourceIndex(0)
3 >Emitted(38, 28) Source(23, 70) + SourceIndex(0)
4 >Emitted(38, 29) Source(23, 70) + SourceIndex(0)
---
>>>    })(someNamespace = normalN.someNamespace || (normalN.someNamespace = {}));
1->^^^^
2 >    ^
...
8 >                                                 someNamespace
9 >                                                                       { export class C {} }
1->Emitted(39, 5) Source(23, 71) + SourceIndex(0)
2 >Emitted(39, 6) Source(23, 72) + SourceIndex(0)
3 >Emitted(39, 8) Source(23, 37) + SourceIndex(0)
4 >Emitted(39, 21) Source(23, 50) + SourceIndex(0)
5 >Emitted(39, 24) Source(23, 37) + SourceIndex(0)
6 >Emitted(39, 45) Source(23, 50) + SourceIndex(0)
7 >Emitted(39, 50) Source(23, 37) + SourceIndex(0)
8 >Emitted(39, 71) Source(23, 50) + SourceIndex(0)
9 >Emitted(39, 79) Source(23, 72) + SourceIndex(0)
---
>>>    /**@internal*/ var someOther;
1 >^^^^
2 >    ^^^^^^^^^^^^^^
...
1 >Emitted(40, 5) Source(24, 5) + SourceIndex(0)
2 >Emitted(40, 19) Source(24, 19) + SourceIndex(0)
3 >Emitted(40, 20) Source(24, 20) + SourceIndex(0)
4 >Emitted(40, 24) Source(24, 37) + SourceIndex(0)
5 >Emitted(40, 33) Source(24, 46) + SourceIndex(0)
6 >Emitted(40, 34) Source(24, 86) + SourceIndex(0)
---
>>>    (function (someOther) {
1 >^^^^
2 >    ^^^^^^^^^^^
...
2 >    export namespace 
3 >               someOther
1 >Emitted(41, 5) Source(24, 20) + SourceIndex(0)
2 >Emitted(41, 16) Source(24, 37) + SourceIndex(0)
3 >Emitted(41, 25) Source(24, 46) + SourceIndex(0)
---
>>>        var something;
1 >^^^^^^^^
2 >        ^^^^
...
2 >Emitted(42, 13) Source(24, 47) + SourceIndex(0)
3 >Emitted(42, 22) Source(24, 56) + SourceIndex(0)
4 >Emitted(42, 23) Source(24, 86) + SourceIndex(0)
---
>>>        (function (something) {
1->^^^^^^^^
2 >        ^^^^^^^^^^^
...
2 >        
3 >                   something
1->Emitted(43, 9) Source(24, 47) + SourceIndex(0)
2 >Emitted(43, 20) Source(24, 47) + SourceIndex(0)
3 >Emitted(43, 29) Source(24, 56) + SourceIndex(0)
---
>>>            var someClass = /** @class */ (function () {
1->^^^^^^^^^^^^
2 >            ^^^^^^^^^^^^^^^^^^^^^^^^^^^->
1-> { 
1->Emitted(44, 13) Source(24, 59) + SourceIndex(0)
---
>>>                function someClass() {
1->^^^^^^^^^^^^^^^^
2 >                ^^->
1->
1->Emitted(45, 17) Source(24, 59) + SourceIndex(0)
---
>>>                }
1->^^^^^^^^^^^^^^^^
2 >                ^
...
2 >Emitted(46, 18) Source(24, 84) + SourceIndex(0)
---
>>>                return someClass;
1->^^^^^^^^^^^^^^^^
2 >                ^^^^^^^^^^^^^^^^
1->
2 >                }
1->Emitted(47, 17) Source(24, 83) + SourceIndex(0)
2 >Emitted(47, 33) Source(24, 84) + SourceIndex(0)
---
>>>            }());
1 >^^^^^^^^^^^^
2 >            ^
...
3 >             
4 >             export class someClass {}
1 >Emitted(48, 13) Source(24, 83) + SourceIndex(0)
2 >Emitted(48, 14) Source(24, 84) + SourceIndex(0)
3 >Emitted(48, 14) Source(24, 59) + SourceIndex(0)
4 >Emitted(48, 18) Source(24, 84) + SourceIndex(0)
---
>>>            something.someClass = someClass;
1->^^^^^^^^^^^^
2 >            ^^^^^^^^^^^^^^^^^^^
...
3 >                                {}
4 >                                           
1->Emitted(49, 13) Source(24, 72) + SourceIndex(0)
2 >Emitted(49, 32) Source(24, 81) + SourceIndex(0)
3 >Emitted(49, 44) Source(24, 84) + SourceIndex(0)
4 >Emitted(49, 45) Source(24, 84) + SourceIndex(0)
---
>>>        })(something = someOther.something || (someOther.something = {}));
1->^^^^^^^^
2 >        ^
...
1->Emitted(50, 9) Source(24, 85) + SourceIndex(0)
2 >Emitted(50, 10) Source(24, 86) + SourceIndex(0)
3 >Emitted(50, 12) Source(24, 47) + SourceIndex(0)
4 >Emitted(50, 21) Source(24, 56) + SourceIndex(0)
5 >Emitted(50, 24) Source(24, 47) + SourceIndex(0)
6 >Emitted(50, 43) Source(24, 56) + SourceIndex(0)
7 >Emitted(50, 48) Source(24, 47) + SourceIndex(0)
8 >Emitted(50, 67) Source(24, 56) + SourceIndex(0)
9 >Emitted(50, 75) Source(24, 86) + SourceIndex(0)
---
>>>    })(someOther = normalN.someOther || (normalN.someOther = {}));
1 >^^^^
2 >    ^
...
1 >Emitted(51, 5) Source(24, 85) + SourceIndex(0)
2 >Emitted(51, 6) Source(24, 86) + SourceIndex(0)
3 >Emitted(51, 8) Source(24, 37) + SourceIndex(0)
4 >Emitted(51, 17) Source(24, 46) + SourceIndex(0)
5 >Emitted(51, 20) Source(24, 37) + SourceIndex(0)
6 >Emitted(51, 37) Source(24, 46) + SourceIndex(0)
7 >Emitted(51, 42) Source(24, 37) + SourceIndex(0)
8 >Emitted(51, 59) Source(24, 46) + SourceIndex(0)
9 >Emitted(51, 67) Source(24, 86) + SourceIndex(0)
---
>>>    /**@internal*/ normalN.someImport = someNamespace.C;
1 >^^^^
2 >    ^^^^^^^^^^^^^^
...
8 >                                                      C
9 >                                                       ;
1 >Emitted(52, 5) Source(25, 5) + SourceIndex(0)
2 >Emitted(52, 19) Source(25, 19) + SourceIndex(0)
3 >Emitted(52, 20) Source(25, 34) + SourceIndex(0)
4 >Emitted(52, 38) Source(25, 44) + SourceIndex(0)
5 >Emitted(52, 41) Source(25, 47) + SourceIndex(0)
6 >Emitted(52, 54) Source(25, 60) + SourceIndex(0)
7 >Emitted(52, 55) Source(25, 61) + SourceIndex(0)
8 >Emitted(52, 56) Source(25, 62) + SourceIndex(0)
9 >Emitted(52, 57) Source(25, 63) + SourceIndex(0)
---
>>>    /**@internal*/ normalN.internalConst = 10;
1 >^^^^
2 >    ^^^^^^^^^^^^^^
...
6 >                                           10
7 >                                             ;
1 >Emitted(53, 5) Source(27, 5) + SourceIndex(0)
2 >Emitted(53, 19) Source(27, 19) + SourceIndex(0)
3 >Emitted(53, 20) Source(27, 33) + SourceIndex(0)
4 >Emitted(53, 41) Source(27, 46) + SourceIndex(0)
5 >Emitted(53, 44) Source(27, 49) + SourceIndex(0)
6 >Emitted(53, 46) Source(27, 51) + SourceIndex(0)
7 >Emitted(53, 47) Source(27, 52) + SourceIndex(0)
---
>>>    /**@internal*/ var internalEnum;
1 >^^^^
2 >    ^^^^^^^^^^^^^^
...
2 >Emitted(54, 19) Source(28, 19) + SourceIndex(0)
3 >Emitted(54, 20) Source(28, 20) + SourceIndex(0)
4 >Emitted(54, 24) Source(28, 32) + SourceIndex(0)
5 >Emitted(54, 36) Source(28, 56) + SourceIndex(0)
---
>>>    (function (internalEnum) {
1 >^^^^
2 >    ^^^^^^^^^^^
...
2 >    export enum 
3 >               internalEnum
1 >Emitted(55, 5) Source(28, 20) + SourceIndex(0)
2 >Emitted(55, 16) Source(28, 32) + SourceIndex(0)
3 >Emitted(55, 28) Source(28, 44) + SourceIndex(0)
---
>>>        internalEnum[internalEnum["a"] = 0] = "a";
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >        a
3 >                                                 
1->Emitted(56, 9) Source(28, 47) + SourceIndex(0)
2 >Emitted(56, 50) Source(28, 48) + SourceIndex(0)
3 >Emitted(56, 51) Source(28, 48) + SourceIndex(0)
---
>>>        internalEnum[internalEnum["b"] = 1] = "b";
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >        b
3 >                                                 
1->Emitted(57, 9) Source(28, 50) + SourceIndex(0)
2 >Emitted(57, 50) Source(28, 51) + SourceIndex(0)
3 >Emitted(57, 51) Source(28, 51) + SourceIndex(0)
---
>>>        internalEnum[internalEnum["c"] = 2] = "c";
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >        c
3 >                                                 
1->Emitted(58, 9) Source(28, 53) + SourceIndex(0)
2 >Emitted(58, 50) Source(28, 54) + SourceIndex(0)
3 >Emitted(58, 51) Source(28, 54) + SourceIndex(0)
---
>>>    })(internalEnum = normalN.internalEnum || (normalN.internalEnum = {}));
1->^^^^
2 >    ^
...
8 >                                               internalEnum
9 >                                                                    { a, b, c }
1->Emitted(59, 5) Source(28, 55) + SourceIndex(0)
2 >Emitted(59, 6) Source(28, 56) + SourceIndex(0)
3 >Emitted(59, 8) Source(28, 32) + SourceIndex(0)
4 >Emitted(59, 20) Source(28, 44) + SourceIndex(0)
5 >Emitted(59, 23) Source(28, 32) + SourceIndex(0)
6 >Emitted(59, 43) Source(28, 44) + SourceIndex(0)
7 >Emitted(59, 48) Source(28, 32) + SourceIndex(0)
8 >Emitted(59, 68) Source(28, 44) + SourceIndex(0)
9 >Emitted(59, 76) Source(28, 56) + SourceIndex(0)
---
>>>})(normalN || (normalN = {}));
1 >
2 >^
...
7 >                       {
  ...
  >                          /**@internal*/ export enum internalEnum { a, b, c }
  >                      }
1 >Emitted(60, 1) Source(29, 1) + SourceIndex(0)
2 >Emitted(60, 2) Source(29, 2) + SourceIndex(0)
3 >Emitted(60, 4) Source(20, 11) + SourceIndex(0)
4 >Emitted(60, 11) Source(20, 18) + SourceIndex(0)
5 >Emitted(60, 16) Source(20, 11) + SourceIndex(0)
6 >Emitted(60, 23) Source(20, 18) + SourceIndex(0)
7 >Emitted(60, 31) Source(29, 2) + SourceIndex(0)
---
>>>/**@internal*/ var internalC = /** @class */ (function () {
1->
2 >^^^^^^^^^^^^^^
...
2 >/**@internal*/
3 >               
1->Emitted(61, 1) Source(30, 1) + SourceIndex(0)
2 >Emitted(61, 15) Source(30, 15) + SourceIndex(0)
3 >Emitted(61, 16) Source(30, 16) + SourceIndex(0)
---
>>>    function internalC() {
1->^^^^
2 >    ^^->
1->
1->Emitted(62, 5) Source(30, 16) + SourceIndex(0)
---
>>>    }
1->^^^^
2 >    ^
...
2 >Emitted(63, 6) Source(30, 34) + SourceIndex(0)
---
>>>    return internalC;
1->^^^^
2 >    ^^^^^^^^^^^^^^^^
1->
2 >    }
1->Emitted(64, 5) Source(30, 33) + SourceIndex(0)
2 >Emitted(64, 21) Source(30, 34) + SourceIndex(0)
---
>>>}());
1 >
2 >^
...
3 > 
4 > class internalC {}
1 >Emitted(65, 1) Source(30, 33) + SourceIndex(0)
2 >Emitted(65, 2) Source(30, 34) + SourceIndex(0)
3 >Emitted(65, 2) Source(30, 16) + SourceIndex(0)
4 >Emitted(65, 6) Source(30, 34) + SourceIndex(0)
---
>>>/**@internal*/ function internalfoo() { }
1->
2 >^^^^^^^^^^^^^^
...
6 >                                   () {
7 >                                        }
1->Emitted(66, 1) Source(31, 1) + SourceIndex(0)
2 >Emitted(66, 15) Source(31, 15) + SourceIndex(0)
3 >Emitted(66, 16) Source(31, 16) + SourceIndex(0)
4 >Emitted(66, 25) Source(31, 25) + SourceIndex(0)
5 >Emitted(66, 36) Source(31, 36) + SourceIndex(0)
6 >Emitted(66, 41) Source(31, 40) + SourceIndex(0)
7 >Emitted(66, 42) Source(31, 41) + SourceIndex(0)
---
>>>/**@internal*/ var internalNamespace;
1 >
2 >^^^^^^^^^^^^^^
...
1 >Emitted(67, 1) Source(32, 1) + SourceIndex(0)
2 >Emitted(67, 15) Source(32, 15) + SourceIndex(0)
3 >Emitted(67, 16) Source(32, 16) + SourceIndex(0)
4 >Emitted(67, 20) Source(32, 26) + SourceIndex(0)
5 >Emitted(67, 37) Source(32, 43) + SourceIndex(0)
6 >Emitted(67, 38) Source(32, 73) + SourceIndex(0)
---
>>>(function (internalNamespace) {
1 >
2 >^^^^^^^^^^^
...
2 >namespace 
3 >           internalNamespace
1 >Emitted(68, 1) Source(32, 16) + SourceIndex(0)
2 >Emitted(68, 12) Source(32, 26) + SourceIndex(0)
3 >Emitted(68, 29) Source(32, 43) + SourceIndex(0)
---
>>>    var someClass = /** @class */ (function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^->
1-> { 
1->Emitted(69, 5) Source(32, 46) + SourceIndex(0)
---
>>>        function someClass() {
1->^^^^^^^^
2 >        ^^->
1->
1->Emitted(70, 9) Source(32, 46) + SourceIndex(0)
---
>>>        }
1->^^^^^^^^
2 >        ^
...
2 >Emitted(71, 10) Source(32, 71) + SourceIndex(0)
---
>>>        return someClass;
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^
1->
2 >        }
1->Emitted(72, 9) Source(32, 70) + SourceIndex(0)
2 >Emitted(72, 25) Source(32, 71) + SourceIndex(0)
---
>>>    }());
1 >^^^^
2 >    ^
...
3 >     
4 >     export class someClass {}
1 >Emitted(73, 5) Source(32, 70) + SourceIndex(0)
2 >Emitted(73, 6) Source(32, 71) + SourceIndex(0)
3 >Emitted(73, 6) Source(32, 46) + SourceIndex(0)
4 >Emitted(73, 10) Source(32, 71) + SourceIndex(0)
---
>>>    internalNamespace.someClass = someClass;
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
3 >                                {}
4 >                                           
1->Emitted(74, 5) Source(32, 59) + SourceIndex(0)
2 >Emitted(74, 32) Source(32, 68) + SourceIndex(0)
3 >Emitted(74, 44) Source(32, 71) + SourceIndex(0)
4 >Emitted(74, 45) Source(32, 71) + SourceIndex(0)
---
>>>})(internalNamespace || (internalNamespace = {}));
1->
2 >^
...
1->Emitted(75, 1) Source(32, 72) + SourceIndex(0)
2 >Emitted(75, 2) Source(32, 73) + SourceIndex(0)
3 >Emitted(75, 4) Source(32, 26) + SourceIndex(0)
4 >Emitted(75, 21) Source(32, 43) + SourceIndex(0)
5 >Emitted(75, 26) Source(32, 26) + SourceIndex(0)
6 >Emitted(75, 43) Source(32, 43) + SourceIndex(0)
7 >Emitted(75, 51) Source(32, 73) + SourceIndex(0)
---
>>>/**@internal*/ var internalOther;
1 >
2 >^^^^^^^^^^^^^^
...
5 >                   internalOther
6 >                                .something { export class someClass {} }
1 >Emitted(76, 1) Source(33, 1) + SourceIndex(0)
2 >Emitted(76, 15) Source(33, 15) + SourceIndex(0)
3 >Emitted(76, 16) Source(33, 16) + SourceIndex(0)
4 >Emitted(76, 20) Source(33, 26) + SourceIndex(0)
5 >Emitted(76, 33) Source(33, 39) + SourceIndex(0)
6 >Emitted(76, 34) Source(33, 79) + SourceIndex(0)
---
>>>(function (internalOther) {
1 >
2 >^^^^^^^^^^^
...
2 >namespace 
3 >           internalOther
1 >Emitted(77, 1) Source(33, 16) + SourceIndex(0)
2 >Emitted(77, 12) Source(33, 26) + SourceIndex(0)
3 >Emitted(77, 25) Source(33, 39) + SourceIndex(0)
---
>>>    var something;
1 >^^^^
2 >    ^^^^
...
2 >Emitted(78, 9) Source(33, 40) + SourceIndex(0)
3 >Emitted(78, 18) Source(33, 49) + SourceIndex(0)
4 >Emitted(78, 19) Source(33, 79) + SourceIndex(0)
---
>>>    (function (something) {
1->^^^^
2 >    ^^^^^^^^^^^
...
2 >    
3 >               something
1->Emitted(79, 5) Source(33, 40) + SourceIndex(0)
2 >Emitted(79, 16) Source(33, 40) + SourceIndex(0)
3 >Emitted(79, 25) Source(33, 49) + SourceIndex(0)
---
>>>        var someClass = /** @class */ (function () {
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^^^^^^->
1-> { 
1->Emitted(80, 9) Source(33, 52) + SourceIndex(0)
---
>>>            function someClass() {
1->^^^^^^^^^^^^
2 >            ^^->
1->
1->Emitted(81, 13) Source(33, 52) + SourceIndex(0)
---
>>>            }
1->^^^^^^^^^^^^
2 >            ^
...
2 >Emitted(82, 14) Source(33, 77) + SourceIndex(0)
---
>>>            return someClass;
1->^^^^^^^^^^^^
2 >            ^^^^^^^^^^^^^^^^
1->
2 >            }
1->Emitted(83, 13) Source(33, 76) + SourceIndex(0)
2 >Emitted(83, 29) Source(33, 77) + SourceIndex(0)
---
>>>        }());
1 >^^^^^^^^
2 >        ^
...
3 >         
4 >         export class someClass {}
1 >Emitted(84, 9) Source(33, 76) + SourceIndex(0)
2 >Emitted(84, 10) Source(33, 77) + SourceIndex(0)
3 >Emitted(84, 10) Source(33, 52) + SourceIndex(0)
4 >Emitted(84, 14) Source(33, 77) + SourceIndex(0)
---
>>>        something.someClass = someClass;
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^
...
3 >                            {}
4 >                                       
1->Emitted(85, 9) Source(33, 65) + SourceIndex(0)
2 >Emitted(85, 28) Source(33, 74) + SourceIndex(0)
3 >Emitted(85, 40) Source(33, 77) + SourceIndex(0)
4 >Emitted(85, 41) Source(33, 77) + SourceIndex(0)
---
>>>    })(something = internalOther.something || (internalOther.something = {}));
1->^^^^
2 >    ^
...
8 >                                               something
9 >                                                                       { export class someClass {} }
1->Emitted(86, 5) Source(33, 78) + SourceIndex(0)
2 >Emitted(86, 6) Source(33, 79) + SourceIndex(0)
3 >Emitted(86, 8) Source(33, 40) + SourceIndex(0)
4 >Emitted(86, 17) Source(33, 49) + SourceIndex(0)
5 >Emitted(86, 20) Source(33, 40) + SourceIndex(0)
6 >Emitted(86, 43) Source(33, 49) + SourceIndex(0)
7 >Emitted(86, 48) Source(33, 40) + SourceIndex(0)
8 >Emitted(86, 71) Source(33, 49) + SourceIndex(0)
9 >Emitted(86, 79) Source(33, 79) + SourceIndex(0)
---
>>>})(internalOther || (internalOther = {}));
1 >
2 >^
...
1 >Emitted(87, 1) Source(33, 78) + SourceIndex(0)
2 >Emitted(87, 2) Source(33, 79) + SourceIndex(0)
3 >Emitted(87, 4) Source(33, 26) + SourceIndex(0)
4 >Emitted(87, 17) Source(33, 39) + SourceIndex(0)
5 >Emitted(87, 22) Source(33, 26) + SourceIndex(0)
6 >Emitted(87, 35) Source(33, 39) + SourceIndex(0)
7 >Emitted(87, 43) Source(33, 79) + SourceIndex(0)
---
>>>/**@internal*/ var internalImport = internalNamespace.someClass;
1->
2 >^^^^^^^^^^^^^^
...
9 >                                                      someClass
10>                                                               ;
1->Emitted(88, 1) Source(34, 1) + SourceIndex(0)
2 >Emitted(88, 15) Source(34, 15) + SourceIndex(0)
3 >Emitted(88, 16) Source(34, 16) + SourceIndex(0)
4 >Emitted(88, 20) Source(34, 23) + SourceIndex(0)
5 >Emitted(88, 34) Source(34, 37) + SourceIndex(0)
6 >Emitted(88, 37) Source(34, 40) + SourceIndex(0)
7 >Emitted(88, 54) Source(34, 57) + SourceIndex(0)
8 >Emitted(88, 55) Source(34, 58) + SourceIndex(0)
9 >Emitted(88, 64) Source(34, 67) + SourceIndex(0)
10>Emitted(88, 65) Source(34, 68) + SourceIndex(0)
---
>>>/**@internal*/ var internalConst = 10;
1 >
2 >^^^^^^^^^^^^^^
...
7 >                                   10
8 >                                     ;
1 >Emitted(89, 1) Source(36, 1) + SourceIndex(0)
2 >Emitted(89, 15) Source(36, 15) + SourceIndex(0)
3 >Emitted(89, 16) Source(36, 16) + SourceIndex(0)
4 >Emitted(89, 20) Source(36, 22) + SourceIndex(0)
5 >Emitted(89, 33) Source(36, 35) + SourceIndex(0)
6 >Emitted(89, 36) Source(36, 38) + SourceIndex(0)
7 >Emitted(89, 38) Source(36, 40) + SourceIndex(0)
8 >Emitted(89, 39) Source(36, 41) + SourceIndex(0)
---
>>>/**@internal*/ var internalEnum;
1 >
2 >^^^^^^^^^^^^^^
...
4 >               enum 
5 >                   internalEnum { a, b, c }
1 >Emitted(90, 1) Source(37, 1) + SourceIndex(0)
2 >Emitted(90, 15) Source(37, 15) + SourceIndex(0)
3 >Emitted(90, 16) Source(37, 16) + SourceIndex(0)
4 >Emitted(90, 20) Source(37, 21) + SourceIndex(0)
5 >Emitted(90, 32) Source(37, 45) + SourceIndex(0)
---
>>>(function (internalEnum) {
1 >
2 >^^^^^^^^^^^
...
2 >enum 
3 >           internalEnum
1 >Emitted(91, 1) Source(37, 16) + SourceIndex(0)
2 >Emitted(91, 12) Source(37, 21) + SourceIndex(0)
3 >Emitted(91, 24) Source(37, 33) + SourceIndex(0)
---
>>>    internalEnum[internalEnum["a"] = 0] = "a";
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    a
3 >                                             
1->Emitted(92, 5) Source(37, 36) + SourceIndex(0)
2 >Emitted(92, 46) Source(37, 37) + SourceIndex(0)
3 >Emitted(92, 47) Source(37, 37) + SourceIndex(0)
---
>>>    internalEnum[internalEnum["b"] = 1] = "b";
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    b
3 >                                             
1->Emitted(93, 5) Source(37, 39) + SourceIndex(0)
2 >Emitted(93, 46) Source(37, 40) + SourceIndex(0)
3 >Emitted(93, 47) Source(37, 40) + SourceIndex(0)
---
>>>    internalEnum[internalEnum["c"] = 2] = "c";
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    c
3 >                                             
1->Emitted(94, 5) Source(37, 42) + SourceIndex(0)
2 >Emitted(94, 46) Source(37, 43) + SourceIndex(0)
3 >Emitted(94, 47) Source(37, 43) + SourceIndex(0)
---
>>>})(internalEnum || (internalEnum = {}));
1 >
2 >^
...
6 >                    internalEnum
7 >                                 { a, b, c }
1 >Emitted(95, 1) Source(37, 44) + SourceIndex(0)
2 >Emitted(95, 2) Source(37, 45) + SourceIndex(0)
3 >Emitted(95, 4) Source(37, 21) + SourceIndex(0)
4 >Emitted(95, 16) Source(37, 33) + SourceIndex(0)
5 >Emitted(95, 21) Source(37, 21) + SourceIndex(0)
6 >Emitted(95, 33) Source(37, 33) + SourceIndex(0)
7 >Emitted(95, 41) Source(37, 45) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/2/second-output.js
sourceFile:../second/second_part2.ts
...
2 >^^^^^^^^^^^^^^^^^^^->
1 >
1 >Emitted(96, 1) Source(1, 1) + SourceIndex(1)
---
>>>    function C() {
1->^^^^
2 >    ^^->
1->
1->Emitted(97, 5) Source(1, 1) + SourceIndex(1)
---
>>>    }
1->^^^^
2 >    ^
...
1->class C {
  ...
  >
2 >    }
1->Emitted(98, 5) Source(5, 1) + SourceIndex(1)
2 >Emitted(98, 6) Source(5, 2) + SourceIndex(1)
---
>>>    C.prototype.doSomething = function () {
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^
...
2 >    doSomething
3 >                           
1->Emitted(99, 5) Source(2, 5) + SourceIndex(1)
2 >Emitted(99, 28) Source(2, 16) + SourceIndex(1)
3 >Emitted(99, 31) Source(2, 5) + SourceIndex(1)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(100, 9) Source(3, 9) + SourceIndex(1)
2 >Emitted(100, 16) Source(3, 16) + SourceIndex(1)
3 >Emitted(100, 17) Source(3, 17) + SourceIndex(1)
4 >Emitted(100, 20) Source(3, 20) + SourceIndex(1)
5 >Emitted(100, 21) Source(3, 21) + SourceIndex(1)
6 >Emitted(100, 41) Source(3, 41) + SourceIndex(1)
7 >Emitted(100, 42) Source(3, 42) + SourceIndex(1)
8 >Emitted(100, 43) Source(3, 43) + SourceIndex(1)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(101, 5) Source(4, 5) + SourceIndex(1)
2 >Emitted(101, 6) Source(4, 6) + SourceIndex(1)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
1->
  >
2 >    }
1->Emitted(102, 5) Source(5, 1) + SourceIndex(1)
2 >Emitted(102, 13) Source(5, 2) + SourceIndex(1)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(103, 1) Source(5, 1) + SourceIndex(1)
2 >Emitted(103, 2) Source(5, 2) + SourceIndex(1)
3 >Emitted(103, 2) Source(1, 1) + SourceIndex(1)
4 >Emitted(103, 6) Source(5, 2) + SourceIndex(1)
---
>>>//# sourceMappingURL=second-output.js.map
...
4 >Emitted(18, 34) Source(16, 26) + SourceIndex(3)
5 >Emitted(18, 37) Source(16, 20) + SourceIndex(3)
6 >Emitted(18, 51) Source(16, 31) + SourceIndex(3)
7 >Emitted(18, 52) Source(16, 32) + SourceIndex(3)
---
>>>    Object.defineProperty(proto_1, "c", {
1 >^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
3 >Emitted(19, 39) Source(17, 25) + SourceIndex(3)
---
>>>        /**@internal*/ get: function () { return 10; },
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^
...
----------------------------------------------------------------------
prepend: (110-3563):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (110-3563)
var N;
(function (N) {
