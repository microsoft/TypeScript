...
2 >Emitted(18, 5) Source(27, 7) + SourceIndex(0)
3 >Emitted(18, 6) Source(27, 8) + SourceIndex(0)
4 >Emitted(18, 9) Source(27, 11) + SourceIndex(0)
5 >Emitted(18, 23) Source(27, 25) + SourceIndex(0)
6 >Emitted(18, 24) Source(27, 26) + SourceIndex(0)
---
>>>
>>>
>>>console.log(s);
...
2 >Emitted(21, 8) Source(33, 8) + SourceIndex(0)
3 >Emitted(21, 9) Source(33, 9) + SourceIndex(0)
4 >Emitted(21, 12) Source(33, 12) + SourceIndex(0)
5 >Emitted(21, 13) Source(33, 13) + SourceIndex(0)
6 >Emitted(21, 14) Source(33, 14) + SourceIndex(0)
7 >Emitted(21, 15) Source(33, 15) + SourceIndex(0)
8 >Emitted(21, 16) Source(33, 16) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/first/bin/first-output.js
...
2 >Emitted(22, 8) Source(1, 8) + SourceIndex(1)
3 >Emitted(22, 9) Source(1, 9) + SourceIndex(1)
4 >Emitted(22, 12) Source(1, 12) + SourceIndex(1)
5 >Emitted(22, 13) Source(1, 13) + SourceIndex(1)
6 >Emitted(22, 14) Source(1, 14) + SourceIndex(1)
7 >Emitted(22, 16) Source(1, 16) + SourceIndex(1)
8 >Emitted(22, 17) Source(1, 17) + SourceIndex(1)
9 >Emitted(22, 18) Source(1, 18) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/first/bin/first-output.js
sourceFile:../first_part3.ts
...
3 >         f
1 >Emitted(23, 1) Source(1, 1) + SourceIndex(2)
2 >Emitted(23, 10) Source(1, 10) + SourceIndex(2)
3 >Emitted(23, 11) Source(1, 11) + SourceIndex(2)
---
>>>    return "JS does hoists";
1->^^^^
2 >    ^^^^^^^
...
3 >           "JS does hoists"
4 >                           ;
1->Emitted(24, 5) Source(2, 5) + SourceIndex(2)
2 >Emitted(24, 12) Source(2, 12) + SourceIndex(2)
3 >Emitted(24, 28) Source(2, 28) + SourceIndex(2)
4 >Emitted(24, 29) Source(2, 29) + SourceIndex(2)
---
>>>}
1 >
2 >^
...
1 >
  >
2 >}
1 >Emitted(25, 1) Source(3, 1) + SourceIndex(2)
2 >Emitted(25, 2) Source(3, 2) + SourceIndex(2)
---
>>>//# sourceMappingURL=first-output.js.map
...
2 >    doSomething
3 >                           
1->Emitted(37, 5) Source(2, 5) + SourceIndex(4)
2 >Emitted(37, 28) Source(2, 16) + SourceIndex(4)
3 >Emitted(37, 31) Source(2, 5) + SourceIndex(4)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                                        )
8 >                                         ;
1->Emitted(38, 9) Source(3, 9) + SourceIndex(4)
2 >Emitted(38, 16) Source(3, 16) + SourceIndex(4)
3 >Emitted(38, 17) Source(3, 17) + SourceIndex(4)
4 >Emitted(38, 20) Source(3, 20) + SourceIndex(4)
5 >Emitted(38, 21) Source(3, 21) + SourceIndex(4)
6 >Emitted(38, 41) Source(3, 41) + SourceIndex(4)
7 >Emitted(38, 42) Source(3, 42) + SourceIndex(4)
8 >Emitted(38, 43) Source(3, 43) + SourceIndex(4)
---
>>>    };
1 >^^^^
2 >    ^
...
1 >
  >    
2 >    }
1 >Emitted(39, 5) Source(4, 5) + SourceIndex(4)
2 >Emitted(39, 6) Source(4, 6) + SourceIndex(4)
---
>>>    return C;
1->^^^^
2 >    ^^^^^^^^
...
2 >Emitted(40, 13) Source(5, 2) + SourceIndex(4)
---
>>>}());
1 >
2 >^
...
4 > class C {
  ...
  >     }
  > }
1 >Emitted(41, 1) Source(5, 1) + SourceIndex(4)
2 >Emitted(41, 2) Source(5, 2) + SourceIndex(4)
3 >Emitted(41, 2) Source(1, 1) + SourceIndex(4)
4 >Emitted(41, 6) Source(5, 2) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/third/thirdjs/output/third-output.js
sourceFile:../../third_part1.ts
...
7 >             ()
8 >               ;
1->Emitted(42, 1) Source(1, 1) + SourceIndex(5)
2 >Emitted(42, 5) Source(1, 5) + SourceIndex(5)
3 >Emitted(42, 6) Source(1, 6) + SourceIndex(5)
4 >Emitted(42, 9) Source(1, 9) + SourceIndex(5)
5 >Emitted(42, 13) Source(1, 13) + SourceIndex(5)
6 >Emitted(42, 14) Source(1, 14) + SourceIndex(5)
7 >Emitted(42, 16) Source(1, 16) + SourceIndex(5)
8 >Emitted(42, 17) Source(1, 17) + SourceIndex(5)
---
>>>c.doSomething();
1->
2 >^
...
5 >             ()
6 >               ;
1->Emitted(43, 1) Source(2, 1) + SourceIndex(5)
2 >Emitted(43, 2) Source(2, 2) + SourceIndex(5)
3 >Emitted(43, 3) Source(2, 3) + SourceIndex(5)
4 >Emitted(43, 14) Source(2, 14) + SourceIndex(5)
5 >Emitted(43, 16) Source(2, 16) + SourceIndex(5)
6 >Emitted(43, 17) Source(2, 17) + SourceIndex(5)
---
>>>//# sourceMappingURL=third-output.js.map
...
----------------------------------------------------------------------
prepend: (0-1137):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (0-1137)
var TokenFlags;
(function (TokenFlags) {
...
----------------------------------------------------------------------
prepend: (1137-1424):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1137-1424)
var N;
(function (N) {
