...
3 >Emitted(11, 6) Source(2, 5) + SourceIndex(1)
4 >Emitted(11, 29) Source(2, 16) + SourceIndex(1)
5 >Emitted(11, 32) Source(2, 5) + SourceIndex(1)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
2 >Emitted(20, 8) Source(33, 8) + SourceIndex(0)
3 >Emitted(20, 9) Source(33, 9) + SourceIndex(0)
4 >Emitted(20, 12) Source(33, 12) + SourceIndex(0)
5 >Emitted(20, 13) Source(33, 13) + SourceIndex(0)
6 >Emitted(20, 14) Source(33, 14) + SourceIndex(0)
7 >Emitted(20, 15) Source(33, 15) + SourceIndex(0)
8 >Emitted(20, 16) Source(33, 16) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/first/bin/first-output.js
...
8 >               )
9 >                ;
1->Emitted(21, 1) Source(1, 1) + SourceIndex(1)
2 >Emitted(21, 8) Source(1, 8) + SourceIndex(1)
3 >Emitted(21, 9) Source(1, 9) + SourceIndex(1)
4 >Emitted(21, 12) Source(1, 12) + SourceIndex(1)
5 >Emitted(21, 13) Source(1, 13) + SourceIndex(1)
6 >Emitted(21, 14) Source(1, 14) + SourceIndex(1)
7 >Emitted(21, 16) Source(1, 16) + SourceIndex(1)
8 >Emitted(21, 17) Source(1, 17) + SourceIndex(1)
9 >Emitted(21, 18) Source(1, 18) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/first/bin/first-output.js
sourceFile:../first_part3.ts
...
2 >Emitted(22, 10) Source(1, 10) + SourceIndex(2)
3 >Emitted(22, 11) Source(1, 11) + SourceIndex(2)
---
>>>    return "JS does hoists";
1->^^^^
2 >    ^^^^^^^
...
3 >           "JS does hoists"
4 >                           ;
1->Emitted(23, 5) Source(2, 5) + SourceIndex(2)
2 >Emitted(23, 12) Source(2, 12) + SourceIndex(2)
3 >Emitted(23, 28) Source(2, 28) + SourceIndex(2)
4 >Emitted(23, 29) Source(2, 29) + SourceIndex(2)
---
>>>}
1 >
2 >^
...
1 >
  >
2 >}
1 >Emitted(24, 1) Source(3, 1) + SourceIndex(2)
2 >Emitted(24, 2) Source(3, 2) + SourceIndex(2)
---
>>>//# sourceMappingURL=first-output.js.map
...
2 >Emitted(25, 5) Source(5, 11) + SourceIndex(3)
3 >Emitted(25, 6) Source(5, 12) + SourceIndex(3)
4 >Emitted(25, 7) Source(11, 2) + SourceIndex(3)
---
>>>(function (N) {
1->
2 >^^^^^^^^^^^
...
2 >Emitted(26, 12) Source(5, 11) + SourceIndex(3)
3 >Emitted(26, 13) Source(5, 12) + SourceIndex(3)
---
>>>    function f() {
1->^^^^
2 >    ^^^^^^^^^
...
2 >    function 
3 >             f
1->Emitted(27, 5) Source(6, 5) + SourceIndex(3)
2 >Emitted(27, 14) Source(6, 14) + SourceIndex(3)
3 >Emitted(27, 15) Source(6, 15) + SourceIndex(3)
---
>>>        console.log('testing');
1->^^^^^^^^
2 >        ^^^^^^^
...
7 >                             )
8 >                              ;
1->Emitted(28, 9) Source(7, 9) + SourceIndex(3)
2 >Emitted(28, 16) Source(7, 16) + SourceIndex(3)
3 >Emitted(28, 17) Source(7, 17) + SourceIndex(3)
4 >Emitted(28, 20) Source(7, 20) + SourceIndex(3)
5 >Emitted(28, 21) Source(7, 21) + SourceIndex(3)
6 >Emitted(28, 30) Source(7, 30) + SourceIndex(3)
7 >Emitted(28, 31) Source(7, 31) + SourceIndex(3)
8 >Emitted(28, 32) Source(7, 32) + SourceIndex(3)
---
>>>    }
1 >^^^^
2 >    ^
1 >
  >    
2 >    }
1 >Emitted(29, 5) Source(8, 5) + SourceIndex(3)
2 >Emitted(29, 6) Source(8, 6) + SourceIndex(3)
---
>>>
>>>    f();
1 >^^^^
...
3 >Emitted(35, 6) Source(2, 5) + SourceIndex(4)
4 >Emitted(35, 29) Source(2, 16) + SourceIndex(4)
5 >Emitted(35, 32) Source(2, 5) + SourceIndex(4)
---
>>>        console.log("something got done");
1->^^^^^^^^
2 >        ^^^^^^^
...
----------------------------------------------------------------------
prepend: (0-1135):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (0-1135)
var TokenFlags;
(function (TokenFlags) {
...
----------------------------------------------------------------------
prepend: (1135-1416):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1135-1416)
var N;
(function (N) {
