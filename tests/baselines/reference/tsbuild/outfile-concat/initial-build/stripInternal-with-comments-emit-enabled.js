...
3 >Emitted(52, 51) Source(28, 49) + SourceIndex(0)
4 >Emitted(52, 92) Source(28, 50) + SourceIndex(0)
5 >Emitted(52, 93) Source(28, 52) + SourceIndex(0)
6 >Emitted(52, 134) Source(28, 53) + SourceIndex(0)
7 >Emitted(52, 135) Source(28, 53) + SourceIndex(0)
---
>>>    })(internalEnum = normalN.internalEnum || (normalN.internalEnum = {}));
1 >^^^^
2 >    ^
...
8 >                                               internalEnum
9 >                                                                    { a, b, c }
1 >Emitted(53, 5) Source(28, 54) + SourceIndex(0)
2 >Emitted(53, 6) Source(28, 55) + SourceIndex(0)
3 >Emitted(53, 8) Source(28, 31) + SourceIndex(0)
4 >Emitted(53, 20) Source(28, 43) + SourceIndex(0)
5 >Emitted(53, 23) Source(28, 31) + SourceIndex(0)
6 >Emitted(53, 43) Source(28, 43) + SourceIndex(0)
7 >Emitted(53, 48) Source(28, 31) + SourceIndex(0)
8 >Emitted(53, 68) Source(28, 43) + SourceIndex(0)
9 >Emitted(53, 76) Source(28, 55) + SourceIndex(0)
---
>>>})(normalN || (normalN = {}));
1 >
2 >^
...
2 >Emitted(55, 14) Source(30, 14) + SourceIndex(0)
3 >Emitted(55, 15) Source(30, 15) + SourceIndex(0)
---
>>>    function internalC() {}
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
2 >    class internalC {
3 >                          }
1->Emitted(56, 5) Source(30, 15) + SourceIndex(0)
2 >Emitted(56, 27) Source(30, 32) + SourceIndex(0)
3 >Emitted(56, 28) Source(30, 33) + SourceIndex(0)
---
>>>    return internalC;
1 >^^^^
2 >    ^^^^^^^^^^^^^^^^
1 >
2 >    }
1 >Emitted(57, 5) Source(30, 32) + SourceIndex(0)
2 >Emitted(57, 21) Source(30, 33) + SourceIndex(0)
---
>>>}());
1 >
2 >^
...
3 > 
4 > class internalC {}
1 >Emitted(58, 1) Source(30, 32) + SourceIndex(0)
2 >Emitted(58, 2) Source(30, 33) + SourceIndex(0)
3 >Emitted(58, 2) Source(30, 15) + SourceIndex(0)
4 >Emitted(58, 6) Source(30, 33) + SourceIndex(0)
---
>>>/*@internal*/ function internalfoo() { }
1->
2 >^^^^^^^^^^^^^
...
2 >Emitted(59, 14) Source(31, 14) + SourceIndex(0)
3 >Emitted(59, 15) Source(31, 15) + SourceIndex(0)
4 >Emitted(59, 24) Source(31, 24) + SourceIndex(0)
5 >Emitted(59, 35) Source(31, 35) + SourceIndex(0)
6 >Emitted(59, 40) Source(31, 39) + SourceIndex(0)
7 >Emitted(59, 41) Source(31, 40) + SourceIndex(0)
---
>>>/*@internal*/ var internalNamespace;
1 >
2 >^^^^^^^^^^^^^
...
2 >Emitted(60, 14) Source(32, 14) + SourceIndex(0)
3 >Emitted(60, 15) Source(32, 15) + SourceIndex(0)
4 >Emitted(60, 19) Source(32, 25) + SourceIndex(0)
5 >Emitted(60, 36) Source(32, 42) + SourceIndex(0)
6 >Emitted(60, 37) Source(32, 72) + SourceIndex(0)
---
>>>(function (internalNamespace) {var someClass = /** @class */ (function () {
1->
2 >^^^^^^^^^^^
...
3 >           internalNamespace
4 >                             { 
1->Emitted(61, 1) Source(32, 15) + SourceIndex(0)
2 >Emitted(61, 12) Source(32, 25) + SourceIndex(0)
3 >Emitted(61, 29) Source(32, 42) + SourceIndex(0)
4 >Emitted(61, 32) Source(32, 45) + SourceIndex(0)
---
>>>        function someClass() {}
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
...
2 >        export class someClass {
3 >                              }
1->Emitted(62, 9) Source(32, 45) + SourceIndex(0)
2 >Emitted(62, 31) Source(32, 69) + SourceIndex(0)
3 >Emitted(62, 32) Source(32, 70) + SourceIndex(0)
---
>>>        return someClass;
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^
1 >
2 >        }
1 >Emitted(63, 9) Source(32, 69) + SourceIndex(0)
2 >Emitted(63, 25) Source(32, 70) + SourceIndex(0)
---
>>>    }());
1 >^^^^
2 >    ^
...
3 >     
4 >     export class someClass {}
1 >Emitted(64, 5) Source(32, 69) + SourceIndex(0)
2 >Emitted(64, 6) Source(32, 70) + SourceIndex(0)
3 >Emitted(64, 6) Source(32, 45) + SourceIndex(0)
4 >Emitted(64, 10) Source(32, 70) + SourceIndex(0)
---
>>>    internalNamespace.someClass = someClass;
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
3 >                                {}
4 >                                           
1->Emitted(65, 5) Source(32, 58) + SourceIndex(0)
2 >Emitted(65, 32) Source(32, 67) + SourceIndex(0)
3 >Emitted(65, 44) Source(32, 70) + SourceIndex(0)
4 >Emitted(65, 45) Source(32, 70) + SourceIndex(0)
---
>>>})(internalNamespace || (internalNamespace = {}));
1->
2 >^
...
1->Emitted(66, 1) Source(32, 71) + SourceIndex(0)
2 >Emitted(66, 2) Source(32, 72) + SourceIndex(0)
3 >Emitted(66, 4) Source(32, 25) + SourceIndex(0)
4 >Emitted(66, 21) Source(32, 42) + SourceIndex(0)
5 >Emitted(66, 26) Source(32, 25) + SourceIndex(0)
6 >Emitted(66, 43) Source(32, 42) + SourceIndex(0)
7 >Emitted(66, 51) Source(32, 72) + SourceIndex(0)
---
>>>/*@internal*/ var internalOther;
1 >
2 >^^^^^^^^^^^^^
...
2 >Emitted(67, 14) Source(33, 14) + SourceIndex(0)
3 >Emitted(67, 15) Source(33, 15) + SourceIndex(0)
4 >Emitted(67, 19) Source(33, 25) + SourceIndex(0)
5 >Emitted(67, 32) Source(33, 38) + SourceIndex(0)
6 >Emitted(67, 33) Source(33, 78) + SourceIndex(0)
---
>>>(function (internalOther) {
1 >
2 >^^^^^^^^^^^
...
2 >namespace 
3 >           internalOther
1 >Emitted(68, 1) Source(33, 15) + SourceIndex(0)
2 >Emitted(68, 12) Source(33, 25) + SourceIndex(0)
3 >Emitted(68, 25) Source(33, 38) + SourceIndex(0)
---
>>>    var something;
1 >^^^^
2 >    ^^^^
...
3 >        something
4 >                  { export class someClass {} }
1 >Emitted(69, 5) Source(33, 39) + SourceIndex(0)
2 >Emitted(69, 9) Source(33, 39) + SourceIndex(0)
3 >Emitted(69, 18) Source(33, 48) + SourceIndex(0)
4 >Emitted(69, 19) Source(33, 78) + SourceIndex(0)
---
>>>    (function (something) {var someClass = /** @class */ (function () {
1->^^^^
2 >    ^^^^^^^^^^^
...
3 >               something
4 >                         { 
1->Emitted(70, 5) Source(33, 39) + SourceIndex(0)
2 >Emitted(70, 16) Source(33, 39) + SourceIndex(0)
3 >Emitted(70, 25) Source(33, 48) + SourceIndex(0)
4 >Emitted(70, 28) Source(33, 51) + SourceIndex(0)
---
>>>            function someClass() {}
1->^^^^^^^^^^^^
2 >            ^^^^^^^^^^^^^^^^^^^^^^
...
2 >            export class someClass {
3 >                                  }
1->Emitted(71, 13) Source(33, 51) + SourceIndex(0)
2 >Emitted(71, 35) Source(33, 75) + SourceIndex(0)
3 >Emitted(71, 36) Source(33, 76) + SourceIndex(0)
---
>>>            return someClass;
1 >^^^^^^^^^^^^
2 >            ^^^^^^^^^^^^^^^^
1 >
2 >            }
1 >Emitted(72, 13) Source(33, 75) + SourceIndex(0)
2 >Emitted(72, 29) Source(33, 76) + SourceIndex(0)
---
>>>        }());
1 >^^^^^^^^
2 >        ^
...
3 >         
4 >         export class someClass {}
1 >Emitted(73, 9) Source(33, 75) + SourceIndex(0)
2 >Emitted(73, 10) Source(33, 76) + SourceIndex(0)
3 >Emitted(73, 10) Source(33, 51) + SourceIndex(0)
4 >Emitted(73, 14) Source(33, 76) + SourceIndex(0)
---
>>>        something.someClass = someClass;
1->^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^
...
3 >                            {}
4 >                                       
1->Emitted(74, 9) Source(33, 64) + SourceIndex(0)
2 >Emitted(74, 28) Source(33, 73) + SourceIndex(0)
3 >Emitted(74, 40) Source(33, 76) + SourceIndex(0)
4 >Emitted(74, 41) Source(33, 76) + SourceIndex(0)
---
>>>    })(something = internalOther.something || (internalOther.something = {}));
1->^^^^
2 >    ^
...
8 >                                               something
9 >                                                                       { export class someClass {} }
1->Emitted(75, 5) Source(33, 77) + SourceIndex(0)
2 >Emitted(75, 6) Source(33, 78) + SourceIndex(0)
3 >Emitted(75, 8) Source(33, 39) + SourceIndex(0)
4 >Emitted(75, 17) Source(33, 48) + SourceIndex(0)
5 >Emitted(75, 20) Source(33, 39) + SourceIndex(0)
6 >Emitted(75, 43) Source(33, 48) + SourceIndex(0)
7 >Emitted(75, 48) Source(33, 39) + SourceIndex(0)
8 >Emitted(75, 71) Source(33, 48) + SourceIndex(0)
9 >Emitted(75, 79) Source(33, 78) + SourceIndex(0)
---
>>>})(internalOther || (internalOther = {}));
1 >
2 >^
...
1 >Emitted(76, 1) Source(33, 77) + SourceIndex(0)
2 >Emitted(76, 2) Source(33, 78) + SourceIndex(0)
3 >Emitted(76, 4) Source(33, 25) + SourceIndex(0)
4 >Emitted(76, 17) Source(33, 38) + SourceIndex(0)
5 >Emitted(76, 22) Source(33, 25) + SourceIndex(0)
6 >Emitted(76, 35) Source(33, 38) + SourceIndex(0)
7 >Emitted(76, 43) Source(33, 78) + SourceIndex(0)
---
>>>/*@internal*/ var internalImport = internalNamespace.someClass;
1->
2 >^^^^^^^^^^^^^
...
2 >Emitted(77, 14) Source(34, 14) + SourceIndex(0)
3 >Emitted(77, 15) Source(34, 15) + SourceIndex(0)
4 >Emitted(77, 19) Source(34, 22) + SourceIndex(0)
5 >Emitted(77, 33) Source(34, 36) + SourceIndex(0)
6 >Emitted(77, 36) Source(34, 39) + SourceIndex(0)
7 >Emitted(77, 53) Source(34, 56) + SourceIndex(0)
8 >Emitted(77, 54) Source(34, 57) + SourceIndex(0)
9 >Emitted(77, 63) Source(34, 66) + SourceIndex(0)
10>Emitted(77, 64) Source(34, 67) + SourceIndex(0)
---
>>>
>>>/*@internal*/ var internalConst = 10;
1 >
...
2 >Emitted(79, 14) Source(36, 14) + SourceIndex(0)
3 >Emitted(79, 15) Source(36, 15) + SourceIndex(0)
4 >Emitted(79, 19) Source(36, 21) + SourceIndex(0)
5 >Emitted(79, 32) Source(36, 34) + SourceIndex(0)
6 >Emitted(79, 35) Source(36, 37) + SourceIndex(0)
7 >Emitted(79, 37) Source(36, 39) + SourceIndex(0)
8 >Emitted(79, 38) Source(36, 40) + SourceIndex(0)
---
>>>/*@internal*/ var internalEnum;
1 >
2 >^^^^^^^^^^^^^
...
2 >Emitted(80, 14) Source(37, 14) + SourceIndex(0)
3 >Emitted(80, 15) Source(37, 15) + SourceIndex(0)
4 >Emitted(80, 19) Source(37, 20) + SourceIndex(0)
5 >Emitted(80, 31) Source(37, 44) + SourceIndex(0)
---
>>>(function (internalEnum) {
1 >
2 >^^^^^^^^^^^
...
2 >enum 
3 >           internalEnum
1 >Emitted(81, 1) Source(37, 15) + SourceIndex(0)
2 >Emitted(81, 12) Source(37, 20) + SourceIndex(0)
3 >Emitted(81, 24) Source(37, 32) + SourceIndex(0)
---
>>>    internalEnum[internalEnum["a"] = 0] = "a";internalEnum[internalEnum["b"] = 1] = "b";internalEnum[internalEnum["c"] = 2] = "c";
1->^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
6 >                                                                                        c
7 >                                                                                                                                 
1->Emitted(82, 5) Source(37, 35) + SourceIndex(0)
2 >Emitted(82, 46) Source(37, 36) + SourceIndex(0)
3 >Emitted(82, 47) Source(37, 38) + SourceIndex(0)
4 >Emitted(82, 88) Source(37, 39) + SourceIndex(0)
5 >Emitted(82, 89) Source(37, 41) + SourceIndex(0)
6 >Emitted(82, 130) Source(37, 42) + SourceIndex(0)
7 >Emitted(82, 131) Source(37, 42) + SourceIndex(0)
---
>>>})(internalEnum || (internalEnum = {}));
1 >
2 >^
...
----------------------------------------------------------------------
prepend: (130-3399):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (130-3399)
var N;
(function (N) {
