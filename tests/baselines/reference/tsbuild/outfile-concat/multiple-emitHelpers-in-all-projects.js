...
//// [/src/2/second-output.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "../second/second_part1.ts": {
        "original": {
          "version": "-13362958657-namespace N {\n    // Comment text\n}\n\nnamespace N {\n    function f() {\n        console.log('testing');\n    }\n\n    f();\n}\nfunction forsecondsecond_part1Rest() {\nconst { b, ...rest } = { a: 10, b: 30, yy: 30 };\n}",
          "impliedFormat": 1
        },
        "version": "-13362958657-namespace N {\n    // Comment text\n}\n\nnamespace N {\n    function f() {\n        console.log('testing');\n    }\n\n    f();\n}\nfunction forsecondsecond_part1Rest() {\nconst { b, ...rest } = { a: 10, b: 30, yy: 30 };\n}",
        "impliedFormat": "commonjs"
...
//// [/src/first/bin/first-output.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "../first_part1.ts": {
        "original": {
          "version": "-25468252236-interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\nfunction forfirstfirst_PART1Rest() {\nconst { b, ...rest } = { a: 10, b: 30, yy: 30 };\n}",
          "impliedFormat": 1
        },
        "version": "-25468252236-interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\nfunction forfirstfirst_PART1Rest() {\nconst { b, ...rest } = { a: 10, b: 30, yy: 30 };\n}",
        "impliedFormat": "commonjs"
...
//// [/src/first/bin/first-output.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "../first_part1.ts": {
        "original": {
          "version": "-25115744362-interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\nfunction forfirstfirst_PART1Rest() {\nconst { b, ...rest } = { a: 10, b: 30, yy: 30 };\n}console.log(s);",
          "impliedFormat": 1
        },
        "version": "-25115744362-interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\nfunction forfirstfirst_PART1Rest() {\nconst { b, ...rest } = { a: 10, b: 30, yy: 30 };\n}console.log(s);",
        "impliedFormat": "commonjs"
...
//// [/src/first/bin/first-output.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "../first_part1.ts": {
        "original": {
          "version": "-20328557861-interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\nfunction forfirstfirst_PART1Rest() { }console.log(s);",
          "impliedFormat": 1
        },
        "version": "-20328557861-interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\nfunction forfirstfirst_PART1Rest() { }console.log(s);",
        "impliedFormat": "commonjs"
