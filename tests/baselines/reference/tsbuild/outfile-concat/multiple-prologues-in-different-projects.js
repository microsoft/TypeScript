...
//// [/src/2/second-output.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "../second/second_part2.ts": {
        "original": {
          "version": "7702061777-\"myPrologue2\";\nclass C {\n    doSomething() {\n        console.log(\"something got done\");\n    }\n}\n",
          "impliedFormat": 1
        },
        "version": "7702061777-\"myPrologue2\";\nclass C {\n    doSomething() {\n        console.log(\"something got done\");\n    }\n}\n",
        "impliedFormat": "commonjs"
...
[[90m12:01:18 AM[0m] Project 'src/second/tsconfig.json' is up to date because newest input 'src/second/second_part2.ts' is older than output 'src/2/second-output.tsbuildinfo'
...
//// [/src/first/bin/first-output.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "../first_part1.ts": {
        "original": {
          "version": "13639857830-\"myPrologue5\"\ninterface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\nconsole.log(s);",
          "impliedFormat": 1
        },
        "version": "13639857830-\"myPrologue5\"\ninterface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\nconsole.log(s);",
        "impliedFormat": "commonjs"
