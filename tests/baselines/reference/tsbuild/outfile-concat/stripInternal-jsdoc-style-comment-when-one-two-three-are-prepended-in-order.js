...
[96msrc/second/tsconfig.json[0m:[93m15[0m:[93m5[0m - [91merror[0m[90m TS5102: [0mOption 'prepend' has been removed. Please remove it from your configuration.

[7m15[0m     { "path": "../first", "prepend": true }
[7m  [0m [91m    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[0m

[[90m12:00:37 AM[0m] Project 'src/third/tsconfig.json' can't be built because its dependency 'src/second' has errors

[[90m12:00:38 AM[0m] Skipping build of project '/src/third/tsconfig.json' because its dependency '/src/second' has errors
...
//// [/src/first/bin/first-output.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "../first_part1.ts": {
        "original": {
          "version": "-2065248729-/**@internal*/ interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\n",
          "impliedFormat": 1
        },
        "version": "-2065248729-/**@internal*/ interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\n",
        "impliedFormat": "commonjs"
...
[[90m12:00:43 AM[0m] Project 'src/first/tsconfig.json' is out of date because output 'src/first/bin/first-output.tsbuildinfo' is older than input 'src/first/first_PART1.ts'

[[90m12:00:44 AM[0m] Building project '/src/first/tsconfig.json'...

[[90m12:00:52 AM[0m] Project 'src/second/tsconfig.json' is out of date because output file 'src/2/second-output.tsbuildinfo' does not exist

[[90m12:00:53 AM[0m] Building project '/src/second/tsconfig.json'...
...
[[90m12:00:54 AM[0m] Project 'src/third/tsconfig.json' can't be built because its dependency 'src/second' has errors

[[90m12:00:55 AM[0m] Skipping build of project '/src/third/tsconfig.json' because its dependency '/src/second' has errors
...
//// [/src/first/bin/first-output.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "../first_part1.ts": {
        "original": {
          "version": "248375721-/**@internal*/ interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\nconsole.log(s);",
          "impliedFormat": 1
        },
        "version": "248375721-/**@internal*/ interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\nconsole.log(s);",
        "impliedFormat": "commonjs"
...
[[90m12:01:09 AM[0m] Project 'src/second/tsconfig.json' is out of date because output file 'src/2/second-output.tsbuildinfo' does not exist

[[90m12:01:10 AM[0m] Building project '/src/second/tsconfig.json'...
...
[[90m12:01:11 AM[0m] Project 'src/third/tsconfig.json' can't be built because its dependency 'src/second' has errors

[[90m12:01:12 AM[0m] Skipping build of project '/src/third/tsconfig.json' because its dependency '/src/second' has errors
