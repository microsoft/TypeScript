...
//// [/src/first/bin/first-output.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "../first_part1.ts": {
        "original": {
          "version": "6800247997-/*@internal*/ interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\n",
          "impliedFormat": 1
        },
        "version": "6800247997-/*@internal*/ interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\n",
        "impliedFormat": "commonjs"
...
[[90m12:00:53 AM[0m] Project 'src/second/tsconfig.json' is out of date because output file 'src/2/second-output.tsbuildinfo' does not exist

[[90m12:00:54 AM[0m] Building project '/src/second/tsconfig.json'...
...
[[90m12:00:55 AM[0m] Project 'src/third/tsconfig.json' can't be built because its dependency 'src/second' has errors

[[90m12:00:56 AM[0m] Skipping build of project '/src/third/tsconfig.json' because its dependency '/src/second' has errors
...
//// [/src/first/bin/first-output.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "../first_part1.ts": {
        "original": {
          "version": "-17321008723-/*@internal*/ interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hola, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\n",
          "impliedFormat": 1
        },
        "version": "-17321008723-/*@internal*/ interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hola, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\n",
        "impliedFormat": "commonjs"
...
[[90m12:01:10 AM[0m] Project 'src/second/tsconfig.json' is out of date because output file 'src/2/second-output.tsbuildinfo' does not exist

[[90m12:01:11 AM[0m] Building project '/src/second/tsconfig.json'...
...
[[90m12:01:12 AM[0m] Project 'src/third/tsconfig.json' can't be built because its dependency 'src/second' has errors

[[90m12:01:13 AM[0m] Skipping build of project '/src/third/tsconfig.json' because its dependency '/src/second' has errors
...
//// [/src/first/bin/first-output.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "../first_part1.ts": {
        "original": {
          "version": "-21236879249-/*@internal*/ interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hola, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\nconsole.log(s);",
          "impliedFormat": 1
        },
        "version": "-21236879249-/*@internal*/ interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hola, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\nconsole.log(s);",
        "impliedFormat": "commonjs"
...
[[90m12:01:27 AM[0m] Project 'src/second/tsconfig.json' is out of date because output file 'src/2/second-output.tsbuildinfo' does not exist

[[90m12:01:28 AM[0m] Building project '/src/second/tsconfig.json'...
...
[[90m12:01:29 AM[0m] Project 'src/third/tsconfig.json' can't be built because its dependency 'src/second' has errors

[[90m12:01:30 AM[0m] Skipping build of project '/src/third/tsconfig.json' because its dependency '/src/second' has errors
