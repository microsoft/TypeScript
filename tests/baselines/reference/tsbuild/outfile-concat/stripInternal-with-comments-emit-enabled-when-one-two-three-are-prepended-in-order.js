...
[[90m12:00:40 AM[0m] Project 'src/third/tsconfig.json' can't be built because its dependency 'src/second' has errors

[[90m12:00:41 AM[0m] Skipping build of project '/src/third/tsconfig.json' because its dependency '/src/second' has errors
...
[[90m12:00:55 AM[0m] Project 'src/second/tsconfig.json' is out of date because output file 'src/2/second-output.tsbuildinfo' does not exist

[[90m12:00:56 AM[0m] Building project '/src/second/tsconfig.json'...
...
[[90m12:00:57 AM[0m] Project 'src/third/tsconfig.json' can't be built because its dependency 'src/second' has errors

[[90m12:00:58 AM[0m] Skipping build of project '/src/third/tsconfig.json' because its dependency '/src/second' has errors
...
//// [/src/first/bin/first-output.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "../first_part1.ts": {
        "original": {
          "version": "3002800511-/*@internal*/ interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\nconsole.log(s);",
          "impliedFormat": 1
        },
        "version": "3002800511-/*@internal*/ interface TheFirst {\n    none: any;\n}\n\nconst s = \"Hello, world\";\n\ninterface NoJsForHereEither {\n    none: any;\n}\n\nconsole.log(s);\nconsole.log(s);",
        "impliedFormat": "commonjs"
...
[[90m12:01:12 AM[0m] Project 'src/second/tsconfig.json' is out of date because output file 'src/2/second-output.tsbuildinfo' does not exist

[[90m12:01:13 AM[0m] Building project '/src/second/tsconfig.json'...
...
[[90m12:01:14 AM[0m] Project 'src/third/tsconfig.json' can't be built because its dependency 'src/second' has errors

[[90m12:01:15 AM[0m] Skipping build of project '/src/third/tsconfig.json' because its dependency '/src/second' has errors
