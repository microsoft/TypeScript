...
//// [/src/first/bin/first-output.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "../tripleref.d.ts": {
        "original": {
          "version": "-2651673797-declare class firstfirst_part2 { }",
          "impliedFormat": 1
        },
        "version": "-2651673797-declare class firstfirst_part2 { }",
        "impliedFormat": "commonjs"
      ...
      "../first_part2.ts": {
        "original": {
          "version": "2784064630-///<reference path=\"./tripleRef.d.ts\"/>\nconst first_part2Const = new firstfirst_part2();\nconsole.log(f());\n",
          "impliedFormat": 1
        },
        "version": "2784064630-///<reference path=\"./tripleRef.d.ts\"/>\nconst first_part2Const = new firstfirst_part2();\nconsole.log(f());\n",
        "impliedFormat": "commonjs"
...
[[90m12:01:06 AM[0m] Project 'src/third/tsconfig.json' is out of date because output file 'src/third/thirdjs/output/third-output.tsbuildinfo' does not exist
...
[[90m12:01:12 AM[0m] Project 'src/first/tsconfig.json' is out of date because output 'src/first/bin/first-output.tsbuildinfo' is older than input 'src/first/first_PART1.ts'

[[90m12:01:13 AM[0m] Building project '/src/first/tsconfig.json'...

[[90m12:01:21 AM[0m] Project 'src/second/tsconfig.json' is up to date because newest input 'src/second/second_part1.ts' is older than output 'src/2/second-output.tsbuildinfo'

[[90m12:01:22 AM[0m] Project 'src/third/tsconfig.json' is out of date because output file 'src/third/thirdjs/output/third-output.tsbuildinfo' does not exist

[[90m12:01:23 AM[0m] Building project '/src/third/tsconfig.json'...
