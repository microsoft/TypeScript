...
//// [/src/2/second-output.tsbuildinfo.readable.baseline.txt]
{
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "../second/tripleref.d.ts": {
        "original": {
          "version": "-742713438-declare class secondsecond_part1 { }",
          "impliedFormat": 1
        },
        "version": "-742713438-declare class secondsecond_part1 { }",
        "impliedFormat": "commonjs"
      ...
      "../second/second_part1.ts": {
        "original": {
          "version": "-13901060436-///<reference path=\"./tripleRef.d.ts\"/>\nconst second_part1Const = new secondsecond_part1();\nnamespace N {\n    // Comment text\n}\n\nnamespace N {\n    function f() {\n        console.log('testing');\n    }\n\n    f();\n}\n",
          "impliedFormat": 1
        },
        "version": "-13901060436-///<reference path=\"./tripleRef.d.ts\"/>\nconst second_part1Const = new secondsecond_part1();\nnamespace N {\n    // Comment text\n}\n\nnamespace N {\n    function f() {\n        console.log('testing');\n    }\n\n    f();\n}\n",
        "impliedFormat": "commonjs"
...
[[90m12:01:01 AM[0m] Project 'src/third/tsconfig.json' is out of date because output file 'src/third/thirdjs/output/third-output.tsbuildinfo' does not exist

[[90m12:01:02 AM[0m] Building project '/src/third/tsconfig.json'...
