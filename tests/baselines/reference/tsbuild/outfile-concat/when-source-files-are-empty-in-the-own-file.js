...
[[90m12:00:18 AM[0m] Project 'src/second/tsconfig.json' is out of date because output file 'src/2/second-output.tsbuildinfo' does not exist

[[90m12:00:19 AM[0m] Building project '/src/second/tsconfig.json'...

[[90m12:00:28 AM[0m] Project 'src/third/tsconfig.json' is out of date because output file 'src/third/thirdjs/output/third-output.tsbuildinfo' does not exist
...
[[90m12:00:47 AM[0m] Project 'src/first/tsconfig.json' is out of date because oldest output 'src/first/bin/first-output.tsbuildinfo' is older than newest input 'src/first/first_PART1.ts'

[[90m12:00:48 AM[0m] Building project '/src/first/tsconfig.json'...

[[90m12:00:57 AM[0m] Project 'src/second/tsconfig.json' is up to date because newest input 'src/second/second_part1.ts' is older than oldest output 'src/2/second-output.tsbuildinfo'

[[90m12:00:58 AM[0m] Project 'src/third/tsconfig.json' is out of date because output of its dependency 'src/first' has changed

[[90m12:00:59 AM[0m] Updating output of project '/src/third/tsconfig.json'...
