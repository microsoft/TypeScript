...
[[90m12:00:35 AM[0m] Project 'src/core/tsconfig.json' is out of date because oldest output 'src/core/tsconfig.tsbuildinfo' is older than newest input 'src/core/index.ts'
...
src/core/some_decl.d.ts
  Matched by include pattern '**/*' in 'src/core/tsconfig.json'
[[90m12:00:43 AM[0m] Project 'src/logic/tsconfig.json' is out of date because oldest output 'src/logic/tsconfig.tsbuildinfo' is older than newest input 'src/core'
...
[[90m12:01:00 AM[0m] Project 'src/core/tsconfig.json' is out of date because oldest output 'src/core/tsconfig.tsbuildinfo' is older than newest input 'src/core/index.ts'

[[90m12:01:01 AM[0m] Building project '/src/core/tsconfig.json'...
...
src/core/some_decl.d.ts
  Matched by include pattern '**/*' in 'src/core/tsconfig.json'
[[90m12:01:08 AM[0m] Project 'src/logic/tsconfig.json' is up to date with .d.ts files from its dependencies

[[90m12:01:09 AM[0m] Updating output timestamps of project '/src/logic/tsconfig.json'...

[[90m12:01:12 AM[0m] Project 'src/tests/tsconfig.json' is up to date with .d.ts files from its dependencies

[[90m12:01:13 AM[0m] Updating output timestamps of project '/src/tests/tsconfig.json'...
...
[[90m12:01:17 AM[0m] Project 'src/core/tsconfig.json' is up to date because newest input 'src/core/index.ts' is older than oldest output 'src/core/tsconfig.tsbuildinfo'

[[90m12:01:18 AM[0m] Project 'src/logic/tsconfig.json' is up to date because newest input 'src/logic/index.ts' is older than oldest output 'src/logic/tsconfig.tsbuildinfo'

[[90m12:01:19 AM[0m] Project 'src/tests/tsconfig.json' is up to date because newest input 'src/tests/index.ts' is older than oldest output 'src/tests/tsconfig.tsbuildinfo'
