...
src/core/some_decl.d.ts
  Matched by include pattern '**/*' in 'src/core/tsconfig.json'
[[90m12:00:17 AM[0m] Project 'src/logic/tsconfig.json' is out of date because output file 'src/logic/tsconfig.tsbuildinfo' does not exist
...
[[90m12:00:24 AM[0m] Project 'src/tests/tsconfig.json' is out of date because output file 'src/tests/tsconfig.tsbuildinfo' does not exist
...
[[90m12:00:32 AM[0m] Project 'src/core/tsconfig.json' is out of date because oldest output 'src/core/tsconfig.tsbuildinfo' is older than newest input 'src/core/index.ts'

[[90m12:00:33 AM[0m] Building project '/src/core/tsconfig.json'...
...
src/core/some_decl.d.ts
  Matched by include pattern '**/*' in 'src/core/tsconfig.json'
[[90m12:00:39 AM[0m] Project 'src/logic/tsconfig.json' is out of date because oldest output 'src/logic/tsconfig.tsbuildinfo' is older than newest input 'src/core'

[[90m12:00:40 AM[0m] Building project '/src/logic/tsconfig.json'...
...
src/logic/index.ts
  Matched by include pattern '**/*' in 'src/logic/tsconfig.json'
[[90m12:00:46 AM[0m] Project 'src/tests/tsconfig.json' is out of date because oldest output 'src/tests/tsconfig.tsbuildinfo' is older than newest input 'src/core'
...
[[90m12:00:54 AM[0m] Project 'src/core/tsconfig.json' is out of date because oldest output 'src/core/tsconfig.tsbuildinfo' is older than newest input 'src/core/index.ts'
...
[[90m12:01:10 AM[0m] Project 'src/core/tsconfig.json' is up to date because newest input 'src/core/index.ts' is older than oldest output 'src/core/tsconfig.tsbuildinfo'

[[90m12:01:11 AM[0m] Project 'src/logic/tsconfig.json' is up to date because newest input 'src/logic/index.ts' is older than oldest output 'src/logic/tsconfig.tsbuildinfo'

[[90m12:01:12 AM[0m] Project 'src/tests/tsconfig.json' is up to date because newest input 'src/tests/index.ts' is older than oldest output 'src/tests/tsconfig.tsbuildinfo'
