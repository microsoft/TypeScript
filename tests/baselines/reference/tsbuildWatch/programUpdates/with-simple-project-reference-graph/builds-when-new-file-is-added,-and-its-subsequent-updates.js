    ...
    "fileInfos": {
      ...
      "./newfile.ts": {
        "original": {
          ...
          "signature": "-22629543551-export declare const newFileConst = 30;\r\n"
        },
        "version": "-16320201030-export const newFileConst = 30;",
        "signature": "-22629543551-export declare const newFileConst = 30;\r\n"
      }
...
//// [/user/username/projects/sample1/core/tsconfig.tsbuildinfo]
{"program":{"fileNames":["../../../../../a/lib/lib.d.ts","./anothermodule.ts","./index.ts","./newfile.ts"],"fileInfos":[{"version":"-7698705165-/// <reference no-default-lib=\"true\"/>\ninterface Boolean {}\ninterface Function {}\ninterface CallableFunction {}\ninterface NewableFunction {}\ninterface IArguments {}\ninterface Number { toExponential: any; }\ninterface Object {}\ninterface RegExp {}\ninterface String { charAt: any; }\ninterface Array<T> { length: number; [n: number]: T; }","affectsGlobalScope":true},{"version":"-2676574883-export const World = \"hello\";\r\n","signature":"-8396256275-export declare const World = \"hello\";\r\n"},{"version":"-18749805970-export const someString: string = \"HELLO WORLD\";\r\nexport function leftPad(s: string, n: number) { return s + n; }\r\nexport function multiply(a: number, b: number) { return a * b; }\r\n","signature":"1874987148-export declare const someString: string;\r\nexport declare function leftPad(s: string, n: number): string;\r\nexport declare function multiply(a: number, b: number): number;\r\n"},{"version":"-9703836816-export const newFileConst = 30;\nexport class someClass2 { }","signature":"-19621175669-export declare const newFileConst = 30;\r\nexport declare class someClass2 {\r\n}\r\n"}],"options":{"composite":true,"declaration":true,"declarationMap":true,"skipDefaultLibCheck":true},"referencedMap":[],"exportedModulesMap":[],"semanticDiagnosticsPerFile":[1,2,3,4],"latestChangedDtsFile":"./newfile.d.ts"},"version":"FakeTSVersion"}
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "./newfile.ts": {
        "original": {
          "version": "-9703836816-export const newFileConst = 30;\nexport class someClass2 { }",
          "signature": "-19621175669-export declare const newFileConst = 30;\r\nexport declare class someClass2 {\r\n}\r\n"
        },
        "version": "-9703836816-export const newFileConst = 30;\nexport class someClass2 { }",
        "signature": "-19621175669-export declare const newFileConst = 30;\r\nexport declare class someClass2 {\r\n}\r\n"
      }
