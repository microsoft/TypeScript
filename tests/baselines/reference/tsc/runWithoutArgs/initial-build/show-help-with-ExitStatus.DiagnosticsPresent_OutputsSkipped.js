...
[34m                   --project, -p  [39mCompile the project given the path to its configuration file, or to a folder with a 'tsconfig.json'.
...
[34m                    --target, -t  [39mSpecify ECMAScript target version.
                         ...
                         any of:  es3, es5, es6, es2015, es2016, es2017, es2018, es2019, es2020, es2021, esnext

                        default:  ES3

[34m                    --module, -m  [39mSpecify module code generation.

                         any of:  none, commonjs, amd, system, umd, es6, es2015, es2020, esnext
...
[34m                           --jsx  [39mSpecify JSX code generation.
                         ...
                         any of:  preserve, react-native, react, react-jsx, react-jsxdev
...
[34m               --esModuleInterop  [39mEnables emit interoperability between CommonJS and ES Modules via creation of namespace objects for all imports. Implies 'allowSyntheticDefaultImports'.
