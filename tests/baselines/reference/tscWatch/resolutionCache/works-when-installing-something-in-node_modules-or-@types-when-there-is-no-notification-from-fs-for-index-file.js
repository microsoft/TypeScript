...
[96mworker.ts[0m:[93m1[0m:[93m1[0m - [91merror[0m[90m TS2591: [0mCannot find name 'process'. Do you need to install type definitions for node? Try `npm i --save-dev @types/node` and then add 'node' to the types field in your tsconfig.
...
29: timerToUpdateProgram *new*

Before running Timeout callback:: count: 2
28: timerToInvalidateFailedLookupResolutions
29: timerToUpdateProgram
...
Timeout callback:: count: 2
31: timerToInvalidateFailedLookupResolutions *new*
32: timerToUpdateProgram *new*

Before running Timeout callback:: count: 2
31: timerToInvalidateFailedLookupResolutions
32: timerToUpdateProgram
...
37: timerToInvalidateFailedLookupResolutions *new*

Before running Timeout callback:: count: 2
36: timerToUpdateProgram
37: timerToInvalidateFailedLookupResolutions
...
37: timerToInvalidateFailedLookupResolutions *deleted*
