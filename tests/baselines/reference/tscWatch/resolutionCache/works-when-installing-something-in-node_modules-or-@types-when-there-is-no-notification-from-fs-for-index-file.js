...
CreatingProgramWith::
  ...
  options: {"types":["node"],"watch":true,"extendedDiagnostics":true,"configFilePath":"/user/username/projects/myproject/tsconfig.json"}
...
[91merror[0m[90m TS2688: [0mCannot find type definition file for 'node'.
  ...
  [96mtsconfig.json[0m:[93m4[0m:[93m7[0m
    [7m4[0m       "node"
    [7m [0m [96m      ~~~~~~[0m
...
Timeout callback:: count: 2
25: timerToUpdateProgram *deleted*
...
30: timerToInvalidateFailedLookupResolutions *deleted*
