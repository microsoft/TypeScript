    ...
    "fileInfos": {
      ...
      "./main.ts": {
        "original": {
          ...
          "signature": "-8923332775-export declare const x: string;\r\n"
        },
        "version": "-5691975201-export const x: string = 10;\n// SomeComment",
        "signature": "-8923332775-export declare const x: string;\r\n"
      },
...
//// [/user/username/projects/myproject/tsconfig.tsbuildinfo]
{"program":{"fileNames":["../../../../a/lib/lib.d.ts","./main.ts","./other.ts"],"fileInfos":[{"version":"-7698705165-/// <reference no-default-lib=\"true\"/>\ninterface Boolean {}\ninterface Function {}\ninterface CallableFunction {}\ninterface NewableFunction {}\ninterface IArguments {}\ninterface Number { toExponential: any; }\ninterface Object {}\ninterface RegExp {}\ninterface String { charAt: any; }\ninterface Array<T> { length: number; [n: number]: T; }","affectsGlobalScope":true},{"version":"-10726455937-export const x = 10;","signature":"-6057683066-export declare const x = 10;\r\n"},{"version":"-13729955264-export const y = 10;","signature":"-8398337913-export declare const y = 10;\r\n"}],"options":{"composite":true,"noEmitOnError":true},"referencedMap":[],"exportedModulesMap":[],"semanticDiagnosticsPerFile":[1,2,3],"latestChangedDtsFile":"./other.d.ts"},"version":"FakeTSVersion"}
  ...
  "program": {
    ...
    "fileInfos": {
      ...
      "./other.ts": {
        "original": {
          "version": "-13729955264-export const y = 10;",
          "signature": "-8398337913-export declare const y = 10;\r\n"
        },
        "version": "-13729955264-export const y = 10;",
        "signature": "-8398337913-export declare const y = 10;\r\n"
      }
