...
Info seq  [hh:mm:ss:mss] request:
    {
      ...
      "arguments": {
        "command": {
          "type": "install package",
          "file": "/home/src/projects/project/src/file.ts",
          "packageName": "; echo 'hello' #"
        }
      },
      "seq": 3,
      "type": "request"
    }
TI:: [hh:mm:ss:mss] '; echo 'hello' #':: Package name '; echo 'hello' #' contains invalid characters
TI:: [hh:mm:ss:mss] Sending response:
    {
      ...
      "id": 1,
      "success": false,
      "message": "'; echo 'hello' #':: Package name '; echo 'hello' #' contains invalid characters"
    }
Info seq  [hh:mm:ss:mss] event:
    {
      "seq": 0,
...
Info seq  [hh:mm:ss:mss] request:
    {
      ...
      "arguments": {
        "command": {
          "type": "install package",
          "file": "/home/src/projects/project/src/file.ts",
          "packageName": "react'test"
        }
      },
      "seq": 4,
      "type": "request"
    }
TI:: [hh:mm:ss:mss] 'react'test':: Package name 'react'test' contains invalid characters
TI:: [hh:mm:ss:mss] Sending response:
    {
      "kind": "action::packageInstalled",
      "projectName": "/home/src/projects/project/tsconfig.json",
      "id": 2,
      "success": false,
      "message": "'react'test':: Package name 'react'test' contains invalid characters"
    }
Info seq  [hh:mm:ss:mss] event:
    {
      "seq": 0,
...
TI:: [hh:mm:ss:mss] 'a/b/c':: Package name 'a/b/c' contains invalid characters
TI:: [hh:mm:ss:mss] Sending response:
    {
      "kind": "action::packageInstalled",
      "projectName": "/home/src/projects/project/tsconfig.json",
      "id": 3,
      "success": false,
      "message": "'a/b/c':: Package name 'a/b/c' contains invalid characters"
    }
Info seq  [hh:mm:ss:mss] event:
    {
      "seq": 0,
