...
TI:: [hh:mm:ss:mss] Closing file watchers for project '/user/username/projects/myproject/jsconfig.json'
TI:: [hh:mm:ss:mss] No watchers are registered for project '/user/username/projects/myproject/jsconfig.json'
TI:: [hh:mm:ss:mss] Sending response:
    {
      "projectName": "/user/username/projects/myproject/jsconfig.json",
      "typeAcquisition": {
