...
Info seq  [hh:mm:ss:mss] Search path: /user/username/projects/myproject/XY
Info seq  [hh:mm:ss:mss] For info: /user/username/projects/myproject/XY/a.ts :: Config file name: /user/username/projects/myproject/tsconfig.json
Info seq  [hh:mm:ss:mss] Project '/user/username/projects/myproject/tsconfig.json' (Configured)
Info seq  [hh:mm:ss:mss] 	Files (4)
...
Info seq  [hh:mm:ss:mss] Search path: /user/username/projects/myproject/link
Info seq  [hh:mm:ss:mss] For info: /user/username/projects/myproject/link/a.ts :: Config file name: /user/username/projects/myproject/tsconfig.json
Info seq  [hh:mm:ss:mss] Project '/user/username/projects/myproject/tsconfig.json' (Configured)
Info seq  [hh:mm:ss:mss] 	Files (4)
