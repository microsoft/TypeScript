...
Info seq  [hh:mm:ss:mss] FileWatcher:: Added:: WatchInfo: /tests/cases/fourslash/server/BaseClass/package.json 2000 undefined Project: /dev/null/inferredProject1* WatchType: File location affecting resolution
...
/tests/cases/fourslash/server/BaseClass/jsconfig.json: *new*
  {"pollingInterval":2000}
/tests/cases/fourslash/server/BaseClass/package.json: *new*
  {"pollingInterval":2000}
...
Info seq  [hh:mm:ss:mss] FileWatcher:: Added:: WatchInfo: /home/src/tslibs/TS/Lib/package.json 2000 undefined Project: /tests/cases/fourslash/server/buttonClass/tsconfig.json WatchType: File location affecting resolution
Info seq  [hh:mm:ss:mss] FileWatcher:: Added:: WatchInfo: /home/src/tslibs/TS/package.json 2000 undefined Project: /tests/cases/fourslash/server/buttonClass/tsconfig.json WatchType: File location affecting resolution
Info seq  [hh:mm:ss:mss] FileWatcher:: Added:: WatchInfo: /home/src/tslibs/package.json 2000 undefined Project: /tests/cases/fourslash/server/buttonClass/tsconfig.json WatchType: File location affecting resolution
Info seq  [hh:mm:ss:mss] FileWatcher:: Added:: WatchInfo: /tests/cases/fourslash/server/buttonClass/package.json 2000 undefined Project: /tests/cases/fourslash/server/buttonClass/tsconfig.json WatchType: File location affecting resolution
Info seq  [hh:mm:ss:mss] FileWatcher:: Added:: WatchInfo: /tests/cases/fourslash/server/package.json 2000 undefined Project: /tests/cases/fourslash/server/buttonClass/tsconfig.json WatchType: File location affecting resolution
Info seq  [hh:mm:ss:mss] FileWatcher:: Added:: WatchInfo: /tests/cases/fourslash/package.json 2000 undefined Project: /tests/cases/fourslash/server/buttonClass/tsconfig.json WatchType: File location affecting resolution
Info seq  [hh:mm:ss:mss] FileWatcher:: Added:: WatchInfo: /tests/cases/fourslash/server/BaseClass/package.json 2000 undefined Project: /tests/cases/fourslash/server/buttonClass/tsconfig.json WatchType: File location affecting resolution
...
Info seq  [hh:mm:ss:mss] FileWatcher:: Close:: WatchInfo: /tests/cases/fourslash/server/BaseClass/package.json 2000 undefined Project: /dev/null/inferredProject1* WatchType: File location affecting resolution
...
/tests/cases/fourslash/package.json:
  {"pollingInterval":2000} *new*
/tests/cases/fourslash/server/BaseClass/package.json:
  {"pollingInterval":2000} *new*
/tests/cases/fourslash/server/buttonClass/package.json: *new*
  {"pollingInterval":2000}
...
/tests/cases/fourslash/server/BaseClass/package.json:
  {"pollingInterval":2000}
/tests/cases/fourslash/server/buttonClass/package.json:
  {"pollingInterval":2000}
/tests/cases/fourslash/server/buttonClass/tsconfig.json:
  {"pollingInterval":2000}
/tests/cases/fourslash/server/package.json:
