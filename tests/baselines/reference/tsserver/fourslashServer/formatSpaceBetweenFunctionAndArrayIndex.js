...
Info seq  [hh:mm:ss:mss] request:
    {
      ...
      "type": "request",
      "arguments": {
        "file": "/tests/cases/fourslash/server/formatSpaceBetweenFunctionAndArrayIndex.ts"
      },
      "command": "open"
    }
Info seq  [hh:mm:ss:mss] getConfigFileNameForFile:: File: /tests/cases/fourslash/server/formatSpaceBetweenFunctionAndArrayIndex.ts ProjectRootPath: undefined:: Result: undefined
...
Info seq  [hh:mm:ss:mss] extractUnresolvedImportsFromSourceFile:: /tests/cases/fourslash/server/formatspacebetweenfunctionandarrayindex.ts:: []
