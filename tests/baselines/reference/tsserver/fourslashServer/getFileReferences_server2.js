...
Info seq  [hh:mm:ss:mss] Creating configuration project /home/src/workspaces/project/packages/server/tsconfig.json
Info seq  [hh:mm:ss:mss] event:
    {
      "seq": 0,
      "type": "event",
...
Info seq  [hh:mm:ss:mss] Creating configuration project /home/src/workspaces/project/packages/shared/tsconfig.json
Info seq  [hh:mm:ss:mss] event:
    {
      "seq": 0,
      "type": "event",
...
Info seq  [hh:mm:ss:mss] Creating configuration project /home/src/workspaces/project/packages/client/tsconfig.json
Info seq  [hh:mm:ss:mss] event:
    {
      "seq": 0,
      "type": "event",
