...
Info seq  [hh:mm:ss:mss] request:
    {"seq":0,"type":"request","arguments":{"file":"/tests/cases/fourslash/server/getOutliningSpansForRegionsNoSingleLineFolds.ts"},"command":"open"}
...
Info seq  [hh:mm:ss:mss] request:
    {"seq":1,"type":"request","arguments":{"file":"/tests/cases/fourslash/server/getOutliningSpansForRegionsNoSingleLineFolds.ts"},"command":"getOutliningSpans"}
