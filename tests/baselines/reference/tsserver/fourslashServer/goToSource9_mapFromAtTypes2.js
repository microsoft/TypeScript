...
Info seq  [hh:mm:ss:mss] request:
    {"seq":2,"type":"request","arguments":{"file":"/index.ts","line":1,"offset":8},"command":"findSourceDefinition"}
...
Info seq  [hh:mm:ss:mss] request:
    {"seq":3,"type":"request","arguments":{"file":"/index.ts","line":1,"offset":13},"command":"findSourceDefinition"}
Info seq  [hh:mm:ss:mss] response:
    {
     "seq": 0,
     "type": "response",
...
Info seq  [hh:mm:ss:mss] request:
    {"seq":4,"type":"request","arguments":{"file":"/index.ts","line":1,"offset":24},"command":"findSourceDefinition"}
Info seq  [hh:mm:ss:mss] response:
    {
     "seq": 0,
     "type": "response",
