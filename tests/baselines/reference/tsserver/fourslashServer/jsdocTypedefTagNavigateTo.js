...
Info seq  [hh:mm:ss:mss] request:
    {"seq":1,"type":"request","arguments":{"file":"/tests/cases/fourslash/server/jsDocTypedef_form2.js"},"command":"navtree"}
...
Info seq  [hh:mm:ss:mss] request:
    {"seq":2,"type":"request","arguments":{"file":"/tests/cases/fourslash/server/jsDocTypedef_form2.js"},"command":"navbar"}
Info seq  [hh:mm:ss:mss] response:
    {
     "seq": 0,
     "type": "response",
