...
Info seq  [hh:mm:ss:mss] 	Files (5)
	...
	/file1.ts SVC-1-0 "export interface Test1 {}\nexport interface Test2 {}\nexport interface Test3 {}\nexport interface Test4 {}"
	/file2.ts Text-1 "const a = 10;\nconst b = 10;\nconst c = 10;"
...
Info seq  [hh:mm:ss:mss] FileWatcher:: Close:: WatchInfo: /file2.ts 500 undefined WatchType: Closed Script info
Info seq  [hh:mm:ss:mss] Search path: /
Info seq  [hh:mm:ss:mss] For info: /file2.ts :: Config file name: /tsconfig.json
Info seq  [hh:mm:ss:mss] Project '/tsconfig.json' (Configured)
Info seq  [hh:mm:ss:mss] 	Files (5)
