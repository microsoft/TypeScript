...
Info seq  [hh:mm:ss:mss] request:
    {"seq":0,"type":"request","arguments":{"file":"/tests/cases/fourslash/server/typeReferenceOnServer.ts"},"command":"open"}
...
Info seq  [hh:mm:ss:mss] request:
    {"seq":2,"type":"request","arguments":{"file":"/tests/cases/fourslash/server/typeReferenceOnServer.ts","line":3,"offset":3},"command":"completionInfo"}
