...
TI:: [hh:mm:ss:mss] Closing file watchers for project '/dev/null/inferredProject10*'
TI:: [hh:mm:ss:mss] No watchers are registered for project '/dev/null/inferredProject10*'
TI:: [hh:mm:ss:mss] Sending response:
    {
      "projectName": "/dev/null/inferredProject10*",
      "typeAcquisition": {
...
TI:: [hh:mm:ss:mss] Closing file watchers for project '/dev/null/inferredProject11*'
TI:: [hh:mm:ss:mss] No watchers are registered for project '/dev/null/inferredProject11*'
TI:: [hh:mm:ss:mss] Sending response:
    {
      "projectName": "/dev/null/inferredProject11*",
      "typeAcquisition": {
