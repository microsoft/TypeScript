...
request:{"jsonrpc":"2.0","method":"textDocument/didOpen","params":{"textDocument":{"languageId":"typescript","text":"/**\n* this is documentation\n* @param s any string\n*/\nfunction foo(s: string): 5 {\n    return 5;\n}\nfoo()","uri":"file:///a/file.ts","version":0}}}
Search path: /a
...
response:{"responseRequired":false}
request:{"jsonrpc":"2.0","method":"textDocument/signatureHelp","params":{"position":{"line":7,"character":4},"textDocument":{"uri":"file:///a/file.ts"},"context":{"triggerKind":1,"isRetrigger":false}},"id":2}
response:{"response":{"signatures":[{"label":"foo(s: string): 5","documentation":{"kind":"markdown","value":"this is documentation"},"parameters":[{"label":[4,13],"documentation":{"kind":"markdown","value":"any string"}}]}],"activeSignature":0,"activeParameter":0},"responseRequired":true}