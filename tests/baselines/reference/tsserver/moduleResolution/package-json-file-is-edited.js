...
Info seq  [hh:mm:ss:mss] Starting updateGraphWorker: Project: /user/username/projects/myproject/src/tsconfig.json
Info seq  [hh:mm:ss:mss] Lookup for package.json from '/home/src/tslibs/TS/Lib' was found in cache and does not resolve.
...
Info seq  [hh:mm:ss:mss] Found 'package.json' at '/user/username/projects/myproject/package.json'.
Info seq  [hh:mm:ss:mss] Lookup for package.json from '/user/username/projects/myproject/src' was found in cache and resolves to '/user/username/projects/myproject/package.json'.
Info seq  [hh:mm:ss:mss] ======== Resolving module './fileB.mjs' from '/user/username/projects/myproject/src/fileA.ts'. ========
Info seq  [hh:mm:ss:mss] Module resolution kind is not specified, using 'Node16'.
...
Info seq  [hh:mm:ss:mss] Lookup for package.json from '/user/username/projects/myproject/src' was found in cache and does not resolve.
