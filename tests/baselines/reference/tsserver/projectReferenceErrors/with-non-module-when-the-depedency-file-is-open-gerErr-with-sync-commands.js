...
Info 51   [00:01:41.000] response:
    {
      "response": [],
      "responseRequired": true
    }
Info 52   [00:01:42.000] request:
    {
      "command": "semanticDiagnosticsSync",
      "arguments": {
        "file": "/user/username/projects/myproject/dependency/fns.ts"
...
Info 55   [00:01:45.000] response:
    {
      "response": [],
      "responseRequired": true
    }
Info 56   [00:01:46.000] request:
    {
      "command": "syntacticDiagnosticsSync",
      "arguments": {
        "file": "/user/username/projects/myproject/usage/usage.ts",
...
Info 57   [00:01:47.000] response:
    {
      "response": [],
      "responseRequired": true
    }
Info 58   [00:01:48.000] request:
    {
      "command": "semanticDiagnosticsSync",
      "arguments": {
        "file": "/user/username/projects/myproject/usage/usage.ts",
...
Info 61   [00:01:51.000] response:
    {
      "response": [],
      "responseRequired": true
    }
Info 62   [00:01:52.000] request:
    {
      "command": "syntacticDiagnosticsSync",
      "arguments": {
        "file": "/user/username/projects/myproject/dependency/fns.ts",
...
Info 65   [00:01:55.000] response:
    {
      "response": [],
      "responseRequired": true
    }
Info 66   [00:01:56.000] request:
    {
      "command": "suggestionDiagnosticsSync",
      "arguments": {
        "file": "/user/username/projects/myproject/dependency/fns.ts",
...
Info 67   [00:01:57.000] response:
    {
      "response": [],
      "responseRequired": true
    }
Info 68   [00:01:58.000] request:
    {
      "command": "syntacticDiagnosticsSync",
      "arguments": {
        "file": "/user/username/projects/myproject/dependency/fns.ts",
...
Info 69   [00:01:59.000] response:
    {
      "response": [],
      "responseRequired": true
    }
Info 70   [00:02:00.000] request:
    {
      "command": "semanticDiagnosticsSync",
      "arguments": {
        "file": "/user/username/projects/myproject/dependency/fns.ts",
