...
Info seq  [hh:mm:ss:mss] Search path: /hunter2
Info seq  [hh:mm:ss:mss] For info: /hunter2/a.ts :: Config file name: /tsconfig.json
...
Info seq  [hh:mm:ss:mss] event:
    {
      ...
      "body": {
        ...
        "reason": "Creating possible configured project for /hunter2/a.ts to open"
      }
    }
...
Info seq  [hh:mm:ss:mss] DirectoryWatcher:: Added:: WatchInfo: /hunter2 1 undefined Config: /tsconfig.json WatchType: Wild card directory
...
Info seq  [hh:mm:ss:mss] 	FileName: /hunter2/a.ts ProjectRootPath: undefined
