...
TI:: [hh:mm:ss:mss] Closing file watchers for project '/user/username/projects/project/proj.csproj'
TI:: [hh:mm:ss:mss] No watchers are registered for project '/user/username/projects/project/proj.csproj'
