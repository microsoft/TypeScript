...
Module myplugin2:: create with config: {"init2":"initialConfig2","name":"myplugin2"} and options: {"watchFactory":{"name":"myplugin2","myconfig":"somethingelse"}}
...
Module myplugin:: create with config: {"init":"initialConfig","name":"myplugin"} and options: {"watchFactory":{"name":"myplugin","myconfig":"somethingelse"}}
Info seq  [hh:mm:ss:mss] Plugin validation succeeded
