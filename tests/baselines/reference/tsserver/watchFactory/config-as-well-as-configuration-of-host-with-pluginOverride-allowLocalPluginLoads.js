...
Info seq  [hh:mm:ss:mss] Enabling watchFactory 'myplugin2' from candidate paths: /a/pluginprobe1,/a/pluginprobe2,/a/lib/tsc.js/../../..
Info seq  [hh:mm:ss:mss] Loading myplugin2 from /a/pluginprobe1 (resolved to /a/pluginprobe1/node_modules)
CustomRequire:: Resolving myplugin2 from /a/pluginprobe1/node_modules
Module myplugin2:: create with config: {"init2":"initialConfig2","name":"myplugin2"} and options: {"watchFactory":"myplugin2"}
...
Info seq  [hh:mm:ss:mss] Enabling watchFactory 'myplugin' from candidate paths: /user/username/projects/myproject,/a/pluginprobe1,/a/pluginprobe2,/a/lib/tsc.js/../../..
Info seq  [hh:mm:ss:mss] Loading myplugin from /user/username/projects/myproject (resolved to /user/username/projects/myproject/node_modules)
CustomRequire:: Resolving myplugin from /user/username/projects/myproject/node_modules
Module myplugin:: create with config: {"init":"initialConfig","name":"myplugin"} and options: {"watchFactory":"myplugin"}
Info seq  [hh:mm:ss:mss] Plugin validation succeeded
