...
var render = function (ctrl, model) {
    return vdom.createElement("section", { "class": "todoapp" }, vdom.createElement("header", { "class": "header" }, vdom.createElement("h1", null, "todos <x>"),
        ...
        vdom.createElement("section", { "class": "main", style: { display: (model.todos && model.todos.length) ? "block" : "none" } }, vdom.createElement("input", { "class": "toggle-all", type: "checkbox", onChange: ctrl.toggleAll.bind(ctrl) }),
