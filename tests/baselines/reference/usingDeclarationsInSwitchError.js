//// [tests/cases/conformance/statements/VariableStatements/usingDeclarations/usingDeclarationsInSwitchError.ts] ////

//// [usingDeclarationsInSwitchError.ts]
...
//// [usingDeclarationsInSwitchError.js]
// Error: using in case clause
switch (1) {
    case 0:
        using x = { [Symbol.dispose]() { } };
