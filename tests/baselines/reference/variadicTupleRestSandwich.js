 ...
 */
{
    var t2a = [1, "$"]; // Error (expected)
    var t2b = [1, true, "$"]; // OK (expected)
}
{
    var t12a = ["^", "$"]; // Error (unexpected)
    var t12b = ["^", true, "$"]; // Error (unexpected)
    var t12c = ["^", "$"]; // OK (expected)
    var t12d = ["^", true, "$"]; // OK (expected)
}
