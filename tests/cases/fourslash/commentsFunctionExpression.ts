...
verify.completions({
    ...
    includes: {
        ...
        tags: [
            { name: "param", text: "s param on expression", links: undefined },
            { name: "param", text: "s the first parameter!", links: undefined },
        ],
    },
});
...
verify.completions({
    ...
    includes: [{
        ...
        tags: [
            { name: "param", text: "s param on expression", links: undefined },
            { name: "returns", text: "return on expression", links: undefined },
            { name: "param", text: "s the first parameter!", links: undefined },
            { name: "returns", text: "the parameter's length", links: undefined },
        ],
    },
]});
verify.signatureHelp({
