...
goTo.marker("3");
//bug 718362 expected result : "} while (1)" , actual result : "}   while (1)"
...
verify.currentLineContentIs("}");
goTo.marker("13");
//bug 718362 expected result : "do { do { do { } while (a !== b) } while (a !== b) } while (a !== b)" , actual result : "do {do {do { }while(a !== b) }while(a !== b) }while(a !== b)"
...
verify.currentLineContentIs("do {");
goTo.marker("17");
//bug 718362 expected result : "        } while (a !== b)" , actual result : "        }while(a !== b)"
...
verify.currentLineContentIs("        x += 2");
goTo.marker("31");
//bug 718362 expected result : "    } finally {" , actual result : "} finally {"
...
verify.currentLineContentIs("}");
goTo.marker("35");
//bug 718362 expected result : "do { var a } while (1)" , actual result : "do { var a }   while (1)"
//verify.currentLineContentIs("do { var a } while (1)");
verify.currentLineContentIs("do { var a }   while (1)");
goTo.marker("49");
//bug 718362 expected result : "foo(function (file) {" , actual result : "    foo(function(file) {"
//verify.currentLineContentIs("foo(function (file) {");
verify.currentLineContentIs("    foo(function(file) {");
goTo.marker("50");
//bug 718362 expected result : "    return 0" , actual result : "        return 0"
//verify.currentLineContentIs("    return 0");
verify.currentLineContentIs("        return 0");
goTo.marker("51");
//bug 718362 expected result : "}).then(function (doc) {" , actual result : "    }).then(function(doc) {"
//verify.currentLineContentIs("}).then(function (doc) {");
verify.currentLineContentIs("    }).then(function(doc) {");
goTo.marker("52");
//bug 718362 expected result : "    return 1" , actual result : "        return 1"
...
goTo.marker("57");
//bug 718362 expected result : "    else" , actual result : "else"
...
verify.currentLineContentIs("            ;");
goTo.marker("63");
//bug 718362 expected result : "do do do do" , actual result : "         do do do do"
//verify.currentLineContentIs("do do do do");
verify.currentLineContentIs("         do do do do");
goTo.marker("64");
verify.currentLineContentIs("    test;");
goTo.marker("65");
//bug 718362 expected result : "while (0)" , actual result : "            while (0)"
