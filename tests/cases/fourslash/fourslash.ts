...
declare namespace FourSlashInterface {
    ...
    class verifyNegatable {
        ...
        refactorAvailable(name: string, actionName?: string, actionDescription?: string, preferences?: {}, includeInteractiveActions?: boolean): void;
        refactorAvailableForTriggerReason(triggerReason: RefactorTriggerReason, name: string, action?: string, preferences?: {}, includeInteractiveActions?: boolean): void;
