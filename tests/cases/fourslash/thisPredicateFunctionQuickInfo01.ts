...
verify.quickInfos({
    ...
    3: "(method) FileSystemObject.isNetworked(): this is this & Networked",

    4: "(method) FileSystemObject.isFile(): this is Item",
    5: "(method) FileSystemObject.isNetworked(): this is Item & Networked",
    6: "(method) FileSystemObject.isDirectory(): this is Directory",
    7: "(method) FileSystemObject.isNetworked(): this is Directory & Networked",
    8: "(method) FileSystemObject.isNetworked(): this is FileSystemObject & Networked"
});
