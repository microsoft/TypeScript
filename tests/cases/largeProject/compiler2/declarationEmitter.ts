...
module TypeScript2 {
    ...
    export class DeclarationEmitter implements AstWalkerWithDetailCallback.AstWalkerDetailCallback {
        ...
        private declarationContainerStack: AST2[] = [];
        private isDottedModuleName: boolean[] = [];
        private dottedModuleEmit: string;
        private ignoreCallbackAst: AST2 = null;
        ...
        public emitDeclarations(script: TypeScript2.Script): void {
        ...
        private canEmitPrePostAstSignature(declFlags: DeclFlags, astWithPrePostCallback: AST2, preCallback: boolean) {
        ...
        private pushDeclarationContainer(ast: AST2) {
            this.declarationContainerStack.push(ast);
        }

        private popDeclarationContainer(ast: AST2) {
        ...
        private emitTypeSignature(type: Type2) {
        ...
        private emitDeclarationComments(ast: AST2, endLine?: boolean);
        ...
        private emitBaseList(bases: ASTList2, qual: string) {
        ...
        private emitEnumSignature(moduleDecl: ModuleDeclaration) {
            ...
            for (var j = 1; j < membersLen; j++) {
                var memberDecl: AST2 = moduleDecl.members.members[j];
        ...
        public DefaultCallback(pre: boolean, ast: AST2): boolean {
