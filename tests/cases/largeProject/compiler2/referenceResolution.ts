...
module TypeScript2 {
    ...
    export interface IFileSystemObject2 {
    ...
    export class CompilationEnvironment2 {
        constructor (public compilationSettings: CompilationSettings, public ioHost: IFileSystemObject2) { }
        public residentCode: SourceUnit[] = [];
        public code: SourceUnit[] = [];
    }

    export interface IResolutionDispatcher2 {
    ...
    export class CodeResolver implements TypeScript2.ICodeResolver2 {
        ...
        public resolveCode(referencePath: string, parentPath: string, performSearch: boolean, resolutionDispatcher: TypeScript2.IResolutionDispatcher2): void {
            ...
            var isRelativePath = TypeScript2.isRelative(referencePath);
            ...
            if (!this.visited[absoluteModuleID]) {
                ...
                if (isRelativePath || isRootedPath || !performSearch) {
                    ...
                    if (resolvedFile) {
                        resolvedFile.path = switchToForwardSlashes(TypeScript2.stripQuotes(resolvedFile.path));
