...
module TypeScript2 {
    ...
    export class SymbolScope {
        ...
        public enter(container: Symbol, ast: AST2, symbol: Symbol, errorReporter: ErrorReporter, publicOnly: boolean,
    ...
    export class SymbolScopeBuilder extends SymbolScope {
        ...
        public enter(container: Symbol, ast: AST2, symbol: Symbol, errorReporter: ErrorReporter, insertAsPublic: boolean, typespace: boolean, ambient: boolean): void {
            var table = null;
