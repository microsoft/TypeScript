...
module TypeScript2 {
    ...
    function getBaseTypeLinks(bases: ASTList2, baseTypeLinks: TypeLink[]) {
        if (bases) {
    ...
    function getBases(type: Type2, typeDecl: TypeDeclaration) {
        type.extendsTypeLinks = getBaseTypeLinks(typeDecl.extendsList, type.extendsTypeLinks);
        type.implementsTypeLinks = getBaseTypeLinks(typeDecl.implementsList, type.implementsTypeLinks);
    }

    function addPrototypeField(classType: Type2, ast: AST2, context: TypeCollectionContext) {
    ...
    export function createNewConstructGroupForType(type: Type2) {
    ...
    export function cloneParentConstructGroupForChildType(child: Type2, parent: Type2) {
    ...
    function findSymbolFromAlias(alias: AST2, context: IAliasScopeContext): Symbol {
        var symbol: Symbol = null;
        switch (alias.nodeType) {
            case NodeType.Name:
                var name = (<Identifier2>alias).text;
            ...
            case NodeType.Dot:
                var dottedExpr = <BinaryExpression2>alias;
    ...
    export function preCollectImportTypes(ast: AST2, parent: AST2, context: TypeCollectionContext) {
    ...
    export function preCollectModuleTypes(ast: AST2, parent: AST2, context: TypeCollectionContext) {
        var scopeChain = context.scopeChain;
    ...
    export function preCollectClassTypes(ast: AST2, parent: AST2, context: TypeCollectionContext) {
        var scopeChain = context.scopeChain;
        var classDecl = <ClassDeclaration>ast;

        var classType: Type2;
        var instanceType: Type2;
        var typeSymbol: TypeSymbol = null;
        var className = (<Identifier2>classDecl.name).text;
        ...
        if (typeSymbol == null) {
            ...
            if (classType.instanceType == null) {
                classType.instanceType = new Type2();
    ...
    export function preCollectArgDeclTypes(ast: AST2, parent: AST2, context: TypeCollectionContext) {
        var scopeChain = context.scopeChain;
    ...
    export function preCollectVarDeclTypes(ast: AST2, parent: AST2, context: TypeCollectionContext) {
        var scopeChain = context.scopeChain;
    ...
    export function preCollectFuncDeclTypes(ast: AST2, parent: AST2, context: TypeCollectionContext) {
        var scopeChain = context.scopeChain;
    ...
    export function preCollectTypes(ast: AST2, parent: AST2, walker: IAstWalker) {
    ...
    export function postCollectTypes(ast: AST2, parent: AST2, walker: IAstWalker) {
        var context: TypeCollectionContext = walker.state;
