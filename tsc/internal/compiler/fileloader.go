...
func processAllProgramFiles(
	...
	loader.resolver = module.NewResolver(loader.projectReferenceFileMapper.fs, opts.Config.BaseDirectory(), compilerOptions, opts.TypingsLocation, opts.ProjectName, opts.Config.ContentMapperExtensions())
	if opts.Tracing != nil {
	...
	loader.projectReferenceFileMapper.fs = nil
...
func (p *fileLoader) resolveAutomaticTypeDirectives(containingFileName tspath.RootedFilePath) (
	...
	automaticTypeDirectiveNames := module.GetAutomaticTypeDirectiveNames(p.opts.Config.CompilerOptions(), p.opts.Config.BaseDirectory(), p.opts.Host.FS())
