...
//go:generate go run generate.go -diagnostics ./diagnostics_generated.go -loc ./loc_generated.go -locdir ./loc -locproject ../../../tools/LocProject.json -locsource ./diagnosticMessages.generated.json
