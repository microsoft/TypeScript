...
func TestRecursiveCallbackArgumentConstraintDiagnostics(t *testing.T) {
	t.Parallel()
	for _, test := range []struct {
		...
		{name: "recursiveCallbackArgumentConstraintSchemaFirst", files: []string{"/schema.ts", "/consumer.ts"}},
		{name: "recursiveCallbackArgumentConstraintConsumerFirst", files: []string{"/consumer.ts", "/schema.ts"}},
		{name: "recursiveCallbackArgumentConstraintConsumerOnly", files: []string{"/consumer.ts"}},
		{name: "recursiveCallbackArgumentConstraintHoverFirst", files: []string{"/schema.ts", "/consumer.ts"}, hoverFirst: "next"},
	} {
