...
func getModuleResolver(host RegistryCloneHost, currentDirectory tspath.RootedDirectoryPath, realpath func(tspath.RootedFilePath) tspath.RootedFilePath, opts module.ResolverOptions) *module.DefaultResolver {
