...
func NewView(registry *Registry, importingFile *ast.SourceFile, projectKey tspath.PathKey, program *compiler.Program, typeChecker *checker.Checker, preferences modulespecifiers.UserPreferences) *View {
