...
// should report, keyed by file. Checking everything in one call lets the pool share the work across
// its checkers and keeps its own coordination rather than repeating it per file.
//
