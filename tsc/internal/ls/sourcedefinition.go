...
func (l *LanguageService) newSourceDefResolver(
	...
	return &sourceDefResolver{
		...
		resolver:      module.NewResolver(program.Host().FS(), program.BaseDirectory(), noDtsOptions, program.GetGlobalTypingsCacheLocation(), "", program.CommandLine().ContentMapperExtensions()),
	}
}
