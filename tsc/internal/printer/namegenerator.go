...
type NameGenerator struct {
	...
	generatedNames                     core.Set[string] // NOTE: Used to match Strada, but should be moved to nameGenerationScope after port is complete.
}
...
type nameGenerationScope struct {
	...
	// generatedNames         core.Set[string] // NOTE: generated names should be scoped after Strada port is complete.
}
