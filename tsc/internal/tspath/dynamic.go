...
const (
	DynamicURIFileNamePrefix              = "^/~ts-uri~/"
	dynamicURIPathSegmentEscapePrefix     = "~ts-uri-escape~"
	dynamicURIModuleSpecifierEscapePrefix = "~ts-uri-spec~"
	dynamicURINoPathEscapePrefix          = "~ts-uri-no-path~"
)
