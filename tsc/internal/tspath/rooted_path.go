...
func (f RootedFilePath) Compare(other RootedFilePath) int {
...
// Compare returns the case-sensitive lexical ordering of the normalized path text.
func (p RootedPath) Compare(other RootedPath) int {
...
// Compare returns the case-sensitive lexical ordering of the normalized path text.
func (d RootedDirectoryPath) Compare(other RootedDirectoryPath) int {
	return strings.Compare(string(d), string(other))
}
...
func (directory RootedDirectoryPath) ForEachAncestorDirectory[T any](
...
func ForEachAncestorDirectoryPathStoppingAtGlobalCache[T any](
	...
	result, _ := directory.ForEachAncestorDirectory(func(ancestor RootedDirectoryPath) (T, bool) {
