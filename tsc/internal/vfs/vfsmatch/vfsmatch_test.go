...
func TestReadDirectoryWithExtendedDynamicRoot(t *testing.T) {
	...
	const packageDirectory = "^/~ts-uri~/custom/ts-nul-authority/node_modules/Pkg"
...
func TestReadDirectoryDynamicRootUsesCaseSensitivePatterns(t *testing.T) {
	...
	const root = "^/~ts-uri~/custom/ts-nul-authority"
...
func TestDynamicAbsoluteGlobUsesCaseSensitivePattern(t *testing.T) {
	...
	matcher := NewSpecMatcher(
		[]string{root + "/Foo/**/*.ts"},
		tspath.RootedDirectoryPath("/dev"),
		UsageFiles,
		tspath.CaseInsensitive,
	)
...
func TestGlobPatternInternals(t *testing.T) {
	...
	t.Run("literal component with package folder in include", func(t *testing.T) {
		...
		got := matchFileNames(tspath.RootedDirectoryPath("/dev"), []string{".ts"}, nil,
...
func TestReadDirectoryConsecutiveSlashes(t *testing.T) {
	...
	got := matchFileNames(tspath.RootedDirectoryPath("/dev"), []string{".ts"}, nil, []string{"**/*.ts"}, UnlimitedDepth, host)
...
func TestGlobPatternLiteralWithPackageFolders(t *testing.T) {
	...
	t.Run("explicit literal includes package folder", func(t *testing.T) {
		...
		got := matchFileNames(tspath.RootedDirectoryPath("/dev"), []string{".ts"}, nil, []string{"node_modules/b.ts"}, UnlimitedDepth, host)
