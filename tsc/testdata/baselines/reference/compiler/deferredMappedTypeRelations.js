...
//// [deferredMappedTypeRelations.js]
"use strict";
const badArray = array;
const goodArray = array;
const badTuple = tuple;
const goodTuple = tuple;
const badReadonlyArray = readonlyArray;
const goodReadonlyArray = readonlyArray;
const badReadonlyTuple = readonlyTuple;
const goodReadonlyTuple = readonlyTuple;
const inferred = infer(nested);
const badInferred = infer(nested);
const sameStructure = growing;
const badBoundedArray = boundedArray;
const goodBoundedArray = boundedArray;
const badBoundedTuple = boundedTuple;
const goodBoundedTuple = boundedTuple;
const badChain = chain;
const goodChain = chain;
const badComputedArray = computedArray;
const goodComputedArray = computedArray;
