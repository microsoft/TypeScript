...
export declare function withoutNull(value: unknown): not null;
export declare function withoutUndefined(value: unknown): not undefined;
export declare function withoutNullish(value: unknown): NonNullable<unknown>;
export declare function onlyNullish(value: unknown): null | undefined;
export declare function genericWithoutNullish<Value>(value: Value): NonNullable<Value>;
...
export declare const emptySpreadValue: number | undefined;
