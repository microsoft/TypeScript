//// [tests/cases/compiler/inferenceSharedTypeArguments.ts] ////

//// [inferenceSharedTypeArguments.ts]
...
//// [inferenceSharedTypeArguments.js]
const x2 = x1
    .f1("s1", { p11: "1", f1: "f", p14: () => [] })
    .f1("s2", { p11: "2", f1: "f", p14: () => [] })
    .f1("s3", { p11: "3", f1: "f", p13: { p6: { p1: "a" } }, p14: () => [] })
...
export const x9 = f3(x5);
export const x10 = f4(x6);
export const x11 = f5({ p23: x4, p24: x4, p25: (x1) => { } });
export function f6(x1) {
    return f2(x1);
}
export const x12 = f7(x4);
export const x13 = f8(x4, { p22: 1 });
...
//// [inferenceSharedTypeArguments.d.ts]
type T11<N = string> = {
    p22: N;
};
export declare const x7: string;
export declare const x8: number;
export declare const x9: number;
export declare const x10: number;
export declare const x11: number;
export declare function f6<N>(x1: T11<N>): N;
export declare const x12: number;
export declare const x13: number;
export declare const x15: number;
export declare const x23: boolean;
export declare const x24: unknown;
export declare const x25: unknown;
export {};
