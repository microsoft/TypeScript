//// [tests/cases/compiler/recursiveTypeThroughObjectLiteralGetterDeclarationEmit.ts] ////

//// [recursiveTypeThroughObjectLiteralGetterDeclarationEmit.ts]
...
//// [recursiveTypeThroughObjectLiteralGetterDeclarationEmit.d.ts]
interface Internals<out O = unknown> {
    readonly out: O;
}
interface Schema {
...
interface ObjectInternals<S extends Shape> extends Internals<{
    [K in keyof S]: Out<S[K]>;
}> {
}
interface ObjectSchema<S extends Shape = Shape> extends Schema {
    readonly internals: ObjectInternals<S>;
...
export declare const node: ObjectSchema<{
    name: StringSchema;
    readonly children: ArraySchema<ObjectSchema</*elided*/ any>>;
}>;
export {};
