...
export declare const numericAccess: number | undefined;
export declare const stringAccess: number | undefined;
export declare const numericKey: keyof StringIndex;
export declare const stringKey: keyof StringIndex;
export declare const numericIndex: number | undefined;
export declare const numericStringIndex: number | undefined;
export declare const patternIndex: boolean | undefined;
...
export declare const remappedNumericAccess: number | undefined;
