...
declare function ensureNotNull<T>(x: T): T & not null;
declare function ensureNotUndefined<T>(x: T): T & not undefined;
declare function ensureNotNullOrUndefined<T>(x: T): T & not null & not undefined;
