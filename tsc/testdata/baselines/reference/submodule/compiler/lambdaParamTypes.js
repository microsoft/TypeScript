...
//// [lambdaParamTypes.js]
var thing = create([{ name: "bob", id: 24 }, { name: "doug", id: 32 }]);
thing.doSomething((x, y) => x.name.charAt(0));
thing.doSomething((x, y) => x.id.toExponential(0));
thing.doSomething((x, y) => y.name.charAt(0));
thing.doSomething((x, y) => y.id.toExponential(0));
thing.doSomething((x, y) => x.foo);
thing.doSomething((x, y) => y.foo);
thing.doSomething((x, y) => x.id.charAt(0));
thing.doSomething((x, y) => x.name.toExponential(0));
thing.doSomething((x, y) => y.id.charAt(0));
thing.doSomething((x, y) => y.name.toExponential(0));
