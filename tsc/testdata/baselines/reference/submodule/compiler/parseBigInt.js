...
//// [parseBigInt.js]
const bin = 0b101, binBig = 0b101n;
const oct = 0o567, octBig = 0o567n;
const hex = 0xC0B, hexBig = 0xc0bn;
const dec = 123, decBig = 123n;
const largeBin = 0b10101010101010101010101010101010101010101010101010101010101n;
const largeOct = 0o123456712345671234567n;
const largeDec = 12345678091234567890n;
const largeHex = 0x1234567890abcdefn;
const separatedBin = 0b010101n;
const separatedOct = 0o1234567n;
const separatedDec = 123456789n;
const separatedHex = 0x0abcdefn;
const zero = 0b0n;
const oneBit = 0b1n;
const twoBit = 0b11n;
const threeBit = 0b111n;
const fourBit = 0b1111n;
const fiveBit = 0b11111n;
const sixBit = 0b111111n;
const sevenBit = 0b1111111n;
const eightBit = 0b11111111n;
const nineBit = 0b111111111n;
const tenBit = 0b1111111111n;
const elevenBit = 0b11111111111n;
const twelveBit = 0b111111111111n;
const thirteenBit = 0b1111111111111n;
const fourteenBit = 0b11111111111111n;
const fifteenBit = 0b111111111111111n;
const sixteenBit = 0b1111111111111111n;
const seventeenBit = 0b11111111111111111n;
const neg = -123n;
const negHex = -0x10n;
const negZero = -0n;
