...
const x11 = f10(42, "hello");
const x12 = f10(42);
const x13 = f10();
const x14 = f10(...t3);
const x15 = f10(42, ...t2);
const x16 = f10(42, "hello", ...t1);
const x17 = f10(42, "hello", true, ...t0);
const x18 = f10(...ns, true);
function g10(u, v) {
    let x1 = f10(...u);
    let x2 = f10(...v);
    let x3 = f10(1, ...u);
...
const z10 = f11(42, "hello", true);
const z11 = f11(42, "hello");
const z12 = f11(42);
const z13 = f11();
const z14 = f11(...t3);
const z15 = f11(42, ...t2);
const z16 = f11(42, "hello", ...t1);
const z17 = f11(42, "hello", true, ...t0);
const z18 = f11(...ns, true);
function g11(u, v) {
    let x1 = f11(...u);
    let x2 = f11(...v);
    let x3 = f11(1, ...u);
...
const f21 = bind(f20, 42);
const f22 = bind(f21, "hello");
const f23 = bind(f22, true);
f20(42, "hello", true);
f21("hello", true);
f22(true);
f23();
const g21 = bind(g20, 42);
const g22 = bind(g21, "hello");
const g23 = bind(g22, true);
g20(42, "hello", true);
g20(42, "hello");
g20(42);
g21("hello", true);
