...
numOrDate = unionOfDifferentReturnType(10);
strOrBoolean = unionOfDifferentReturnType("hello");
...
unionOfDifferentParameterTypes(10);
unionOfDifferentParameterTypes("hello");
unionOfDifferentParameterTypes();
var unionOfDifferentNumberOfSignatures;
unionOfDifferentNumberOfSignatures();
unionOfDifferentNumberOfSignatures(10);
unionOfDifferentNumberOfSignatures("hello");
var unionWithDifferentParameterCount;
unionWithDifferentParameterCount();
unionWithDifferentParameterCount("hello");
unionWithDifferentParameterCount("hello", 10);
var unionWithOptionalParameter1;
strOrNum = unionWithOptionalParameter1('hello');
strOrNum = unionWithOptionalParameter1('hello', 10);
strOrNum = unionWithOptionalParameter1('hello', "hello");
strOrNum = unionWithOptionalParameter1();
var unionWithOptionalParameter2;
strOrNum = unionWithOptionalParameter2('hello');
strOrNum = unionWithOptionalParameter2('hello', 10);
strOrNum = unionWithOptionalParameter2('hello', "hello");
strOrNum = unionWithOptionalParameter2();
var unionWithOptionalParameter3;
strOrNum = unionWithOptionalParameter3('hello');
strOrNum = unionWithOptionalParameter3('hello', 10);
strOrNum = unionWithOptionalParameter3('hello', "hello");
strOrNum = unionWithOptionalParameter3();
var unionWithRestParameter1;
strOrNum = unionWithRestParameter1('hello');
strOrNum = unionWithRestParameter1('hello', 10);
strOrNum = unionWithRestParameter1('hello', 10, 11);
strOrNum = unionWithRestParameter1('hello', "hello");
strOrNum = unionWithRestParameter1();
var unionWithRestParameter2;
strOrNum = unionWithRestParameter2('hello');
strOrNum = unionWithRestParameter2('hello', 10);
strOrNum = unionWithRestParameter2('hello', 10, 11);
strOrNum = unionWithRestParameter2('hello', "hello");
strOrNum = unionWithRestParameter2();
var unionWithRestParameter3;
strOrNum = unionWithRestParameter3('hello');
strOrNum = unionWithRestParameter3('hello', 10);
strOrNum = unionWithRestParameter3('hello', 10, 11);
strOrNum = unionWithRestParameter3('hello', "hello");
strOrNum = unionWithRestParameter3();
var unionWithRestParameter4;
strOrNum = unionWithRestParameter4("hello");
strOrNum = unionWithRestParameter4("hello", "world");
