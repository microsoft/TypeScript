...
function f() {
    ...
    try {
        const d2 = __addDisposableResource(env_18, { [Symbol.dispose]() { } }, false);
    }
    catch (e_18) {
        env_18.error = e_18;
...
function* g() {
    ...
    try {
        const d4 = __addDisposableResource(env_20, { [Symbol.dispose]() { } }, false);
        yield;
    }
    catch (e_20) {
        env_20.error = e_20;
...
try {
    ...
    a = () => {
        ...
        try {
            const d6 = __addDisposableResource(env_22, { [Symbol.dispose]() { } }, false);
        }
        catch (e_22) {
            env_22.error = e_22;
    ...
    C1 = class C1 {
        a = () => {
            ...
            try {
                const d7 = __addDisposableResource(env_23, { [Symbol.dispose]() { } }, false);
            }
            catch (e_23) {
                env_23.error = e_23;
        ...
        constructor() {
            ...
            try {
                const d8 = __addDisposableResource(env_24, { [Symbol.dispose]() { } }, false);
            }
            catch (e_24) {
                env_24.error = e_24;
        ...
        static {
            ...
            try {
                const d9 = __addDisposableResource(env_25, { [Symbol.dispose]() { } }, false);
            }
            catch (e_25) {
                env_25.error = e_25;
        ...
        m() {
            ...
            try {
                const d10 = __addDisposableResource(env_26, { [Symbol.dispose]() { } }, false);
            }
            catch (e_26) {
                env_26.error = e_26;
        ...
        get x() {
            ...
            try {
                const d11 = __addDisposableResource(env_27, { [Symbol.dispose]() { } }, false);
                return 0;
            }
            catch (e_27) {
                env_27.error = e_27;
        ...
        set x(v) {
            ...
            try {
                const d12 = __addDisposableResource(env_28, { [Symbol.dispose]() { } }, false);
            }
            catch (e_28) {
                env_28.error = e_28;
        ...
        *g() {
            ...
            try {
                const d14 = __addDisposableResource(env_30, { [Symbol.dispose]() { } }, false);
                yield;
            }
            catch (e_30) {
                env_30.error = e_30;
    ...
    C2 = class C2 extends C1 {
        constructor() {
            ...
            try {
                const d16 = __addDisposableResource(env_32, { [Symbol.dispose]() { } }, false);
                super();
            }
            catch (e_32) {
                env_32.error = e_32;
    ...
    C3 = class C3 extends C1 {
        ...
        constructor() {
            ...
            try {
                const d17 = __addDisposableResource(env_33, { [Symbol.dispose]() { } }, false);
                super();
            }
            catch (e_33) {
                env_33.error = e_33;
    ...
    (function (N) {
        ...
        try {
            const d18 = __addDisposableResource(env_34, { [Symbol.dispose]() { } }, false);
        }
        catch (e_34) {
            env_34.error = e_34;
    ...
    })(N || (N = {}));
    {
        ...
        try {
            const d19 = __addDisposableResource(env_2, { [Symbol.dispose]() { } }, false);
        }
        catch (e_1) {
            env_2.error = e_1;
            env_2.hasError = true;
    ...
    switch (Math.random()) {
        case 0: {
            ...
            try {
                const d20 = __addDisposableResource(env_3, { [Symbol.dispose]() { } }, false);
                break;
            }
            catch (e_2) {
                env_3.error = e_2;
        ...
        case 1: {
            ...
            try {
                const d21 = __addDisposableResource(env_4, { [Symbol.dispose]() { } }, false);
                break;
            }
            catch (e_3) {
                env_4.error = e_3;
        ...
        default: {
            ...
            try {
                const d22 = __addDisposableResource(env_5, { [Symbol.dispose]() { } }, false);
            }
            catch (e_4) {
                env_5.error = e_4;
                env_5.hasError = true;
    ...
    if (true)
        switch (0) {
            case 0: {
                ...
                try {
                    const d23 = __addDisposableResource(env_6, { [Symbol.dispose]() { } }, false);
                    break;
                }
                catch (e_5) {
                    env_6.error = e_5;
            ...
            default: {
                ...
                try {
                    const d24 = __addDisposableResource(env_7, { [Symbol.dispose]() { } }, false);
                }
                catch (e_6) {
                    env_7.error = e_6;
                    env_7.hasError = true;
    ...
    try {
        ...
        try {
            const d25 = __addDisposableResource(env_8, { [Symbol.dispose]() { } }, false);
        }
        catch (e_7) {
            env_8.error = e_7;
            env_8.hasError = true;
        ...
        try {
            const d26 = __addDisposableResource(env_9, { [Symbol.dispose]() { } }, false);
        }
        catch (e_8) {
            env_9.error = e_8;
            env_9.hasError = true;
        ...
        try {
            const d27 = __addDisposableResource(env_10, { [Symbol.dispose]() { } }, false);
        }
        catch (e_9) {
            env_10.error = e_9;
    ...
    if (true) {
        ...
        try {
            const d28 = __addDisposableResource(env_11, { [Symbol.dispose]() { } }, false);
        }
        catch (e_10) {
            env_11.error = e_10;
        ...
        try {
            const d29 = __addDisposableResource(env_12, { [Symbol.dispose]() { } }, false);
        }
        catch (e_11) {
            env_12.error = e_11;
    ...
    while (true) {
        ...
        try {
            const d30 = __addDisposableResource(env_13, { [Symbol.dispose]() { } }, false);
            break;
        }
        catch (e_12) {
            env_13.error = e_12;
    ...
    do {
        ...
        try {
            const d31 = __addDisposableResource(env_14, { [Symbol.dispose]() { } }, false);
            break;
        }
        catch (e_13) {
            env_14.error = e_13;
    ...
    for (;;) {
        ...
        try {
            const d32 = __addDisposableResource(env_15, { [Symbol.dispose]() { } }, false);
            break;
        }
        catch (e_14) {
            env_15.error = e_14;
    ...
    for (const x in {}) {
        ...
        try {
            const d33 = __addDisposableResource(env_16, { [Symbol.dispose]() { } }, false);
        }
        catch (e_15) {
            env_16.error = e_15;
    ...
    for (const x of []) {
        ...
        try {
            const d34 = __addDisposableResource(env_17, { [Symbol.dispose]() { } }, false);
        }
        catch (e_16) {
            env_17.error = e_16;
