...
const tc2 = concat(['hello'], [42]);
const tc3 = concat([1, 2, 3], sa);
const tc4 = concat(sa, [1, 2, 3]);
function concat2(t, u) {
    return [...t, ...u];
}
const tc5 = concat2([1, 2, 3], [4, 5, 6]);
...
const fn1 = (a, b, c, d) => 0;
const c0 = curry(fn1);
const c1 = curry(fn1, 1);
const c2 = curry(fn1, 1, 'abc');
const c3 = curry(fn1, 1, 'abc', true);
const c4 = curry(fn1, 1, 'abc', true, ['x', 'y']);
const fn2 = (x, b, ...args) => 0;
const c10 = curry(fn2);
const c11 = curry(fn2, 1);
const c12 = curry(fn2, 1, true);
const c13 = curry(fn2, 1, true, 'abc', 'def');
const fn3 = (...args) => 0;
const c20 = curry(fn3);
const c21 = curry(fn3, 'abc', 'def');
const c22 = curry(fn3, ...sa);
