...
//// [/user/username/projects/sample1/core/anotherModule.d.ts] *rewrite with same content*
//// [/user/username/projects/sample1/core/anotherModule.d.ts.map] *rewrite with same content*
//// [/user/username/projects/sample1/core/anotherModule.js] *rewrite with same content*
//// [/user/username/projects/sample1/core/index.d.ts] *rewrite with same content*
...
//// [/user/username/projects/sample1/core/tsconfig.tsbuildinfo] *rewrite with same content*
//// [/user/username/projects/sample1/core/tsconfig.tsbuildinfo.readable.baseline.txt] *rewrite with same content*
...
//// [/user/username/projects/sample1/logic/tsconfig.tsbuildinfo] *rewrite with same content*
//// [/user/username/projects/sample1/logic/tsconfig.tsbuildinfo.readable.baseline.txt] *rewrite with same content*
//// [/user/username/projects/sample1/tests/index.d.ts] *rewrite with same content*
//// [/user/username/projects/sample1/tests/index.js] *rewrite with same content*
//// [/user/username/projects/sample1/tests/tsconfig.tsbuildinfo] *rewrite with same content*
//// [/user/username/projects/sample1/tests/tsconfig.tsbuildinfo.readable.baseline.txt] *rewrite with same content*
